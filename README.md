...
This repository provides currently 2 x 3758 code files (1 x R, 1 x Python) for all data sets (*«packages»*) that are available on [opendata.swiss](https://opendata.swiss/) and that contain one or several CSV distributions.
...
<sub>Latest update: **2025-04-19 03:42:43**</sub><br>
