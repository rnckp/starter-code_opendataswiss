...
This repository provides currently 2 x 3802 code files (1 x R, 1 x Python) for all data sets (*«packages»*) that are available on [opendata.swiss](https://opendata.swiss/) and that contain one or several CSV distributions.
...
<sub>Latest update: **2025-07-23 03:54:32**</sub><br>
