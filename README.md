...
This repository provides currently 2 x 2564 code files (1 x R, 1 x Python) for all data sets (*«packages»*) that are available on [opendata.swiss](https://opendata.swiss/) and that contain one or several CSV distributions.
...
<sub>Latest update: **2023-01-17 07:14:06**</sub><br>
