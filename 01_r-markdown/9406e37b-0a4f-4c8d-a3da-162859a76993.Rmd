...
- **Keywords.de** `['geoportal', 'stzh', 'vbg', 'bus', 'geodaten', 'buslinien', 'punktdaten', 'tramlinien', 'vbz', 'tram', 'verkauf', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-11T01:24:03.574986`
