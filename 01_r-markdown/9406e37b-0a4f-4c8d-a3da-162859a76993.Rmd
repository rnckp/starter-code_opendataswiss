...
- **Keywords.de** `['geoportal', 'buslinien', 'bus', 'tramlinien', 'postauto', 'vbz', 'strassenbahn', 'punktdaten', 'offentlicher-verkehr', 'vbg', 'vektordaten', 'verkauf', 'geodaten', 'tram', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-12T01:19:27.099126`
