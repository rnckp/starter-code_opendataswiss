...
- **Keywords.de** `['vbg', 'strassenbahn', 'bus', 'vbz', 'postauto', 'vektordaten', 'tramlinien', 'punktdaten', 'geoportal', 'tram', 'geodaten', 'stzh', 'buslinien', 'offentlicher-verkehr', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-27T01:37:03.980167`
