...
- **Keywords.de** `['tramlinien', 'geoportal', 'postauto', 'bus', 'vbg', 'verkauf', 'vektordaten', 'stzh', 'offentlicher-verkehr', 'strassenbahn', 'geodaten', 'tram', 'vbz', 'buslinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-05T01:09:07.221264`
