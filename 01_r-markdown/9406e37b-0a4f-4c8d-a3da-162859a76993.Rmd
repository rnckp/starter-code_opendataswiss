...
- **Keywords.de** `['bus', 'geodaten', 'offentlicher-verkehr', 'geoportal', 'vbz', 'verkauf', 'vbg', 'strassenbahn', 'postauto', 'stzh', 'tramlinien', 'vektordaten', 'tram', 'punktdaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-10T01:35:14.204189`
