...
- **Keywords.de** `['vektordaten', 'geodaten', 'vbz', 'bus', 'stzh', 'vbg', 'geoportal', 'strassenbahn', 'postauto', 'verkauf', 'tram', 'offentlicher-verkehr', 'punktdaten', 'tramlinien', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-09T00:55:04.804532`
