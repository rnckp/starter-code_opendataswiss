...
- **Keywords.de** `['buslinien', 'verkauf', 'vbz', 'strassenbahn', 'geodaten', 'punktdaten', 'geoportal', 'tram', 'postauto', 'vektordaten', 'tramlinien', 'offentlicher-verkehr', 'stzh', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-22T01:08:00.312814`
