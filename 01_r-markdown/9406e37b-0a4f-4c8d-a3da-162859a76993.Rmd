...
- **Keywords.de** `['stzh', 'vbz', 'offentlicher-verkehr', 'tramlinien', 'geoportal', 'strassenbahn', 'vbg', 'punktdaten', 'geodaten', 'vektordaten', 'postauto', 'tram', 'bus', 'verkauf', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-04T01:29:37.529209`
