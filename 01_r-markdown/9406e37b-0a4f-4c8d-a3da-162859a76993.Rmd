...
- **Keywords.de** `['stzh', 'buslinien', 'vbz', 'bus', 'strassenbahn', 'punktdaten', 'postauto', 'vbg', 'geoportal', 'tram', 'geodaten', 'vektordaten', 'tramlinien', 'verkauf', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-06T01:45:00.241253`
