...
- **Keywords.de** `['postauto', 'verkauf', 'geoportal', 'vektordaten', 'offentlicher-verkehr', 'buslinien', 'stzh', 'tram', 'strassenbahn', 'vbz', 'punktdaten', 'tramlinien', 'bus', 'geodaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-26T01:14:20.644346`
