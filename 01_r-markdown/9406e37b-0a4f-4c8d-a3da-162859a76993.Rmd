...
- **Keywords.de** `['verkauf', 'tram', 'vbz', 'bus', 'stzh', 'strassenbahn', 'vbg', 'buslinien', 'vektordaten', 'postauto', 'geodaten', 'offentlicher-verkehr', 'tramlinien', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-22T01:10:22.410913`
