...
- **Keywords.de** `['tram', 'vbz', 'postauto', 'vektordaten', 'stzh', 'verkauf', 'offentlicher-verkehr', 'buslinien', 'bus', 'tramlinien', 'vbg', 'geoportal', 'geodaten', 'strassenbahn', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-08T01:10:03.357379`
