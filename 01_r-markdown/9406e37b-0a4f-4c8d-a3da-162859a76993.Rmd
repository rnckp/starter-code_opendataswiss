...
- **Keywords.de** `['strassenbahn', 'geodaten', 'tramlinien', 'punktdaten', 'offentlicher-verkehr', 'bus', 'geoportal', 'stzh', 'buslinien', 'tram', 'postauto', 'vektordaten', 'vbg', 'vbz', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-02T01:16:46.427720`
