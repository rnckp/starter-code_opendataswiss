...
- **Keywords.de** `['geoportal', 'tramlinien', 'strassenbahn', 'bus', 'stzh', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'vbg', 'postauto', 'verkauf', 'vektordaten', 'buslinien', 'tram', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-21T00:57:46.033053`
