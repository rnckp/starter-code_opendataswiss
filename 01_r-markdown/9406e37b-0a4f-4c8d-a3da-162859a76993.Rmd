...
- **Keywords.de** `['tramlinien', 'bus', 'tram', 'vbz', 'stzh', 'postauto', 'vbg', 'geodaten', 'buslinien', 'geoportal', 'verkauf', 'offentlicher-verkehr', 'vektordaten', 'punktdaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-17T01:24:40.777952`
