...
- **Keywords.de** `['verkauf', 'postauto', 'vektordaten', 'punktdaten', 'strassenbahn', 'buslinien', 'stzh', 'vbg', 'bus', 'vbz', 'geoportal', 'geodaten', 'tram', 'tramlinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-20T01:22:37.409692`
