...
- **Keywords.de** `['postauto', 'strassenbahn', 'verkauf', 'punktdaten', 'geodaten', 'geoportal', 'vbz', 'stzh', 'tramlinien', 'vektordaten', 'offentlicher-verkehr', 'bus', 'vbg', 'tram', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-18T01:23:13.201105`
