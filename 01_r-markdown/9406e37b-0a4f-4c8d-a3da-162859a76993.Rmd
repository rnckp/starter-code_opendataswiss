...
- **Keywords.de** `['geodaten', 'vbg', 'bus', 'buslinien', 'verkauf', 'stzh', 'vbz', 'vektordaten', 'punktdaten', 'offentlicher-verkehr', 'tramlinien', 'geoportal', 'postauto', 'strassenbahn', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-15T01:13:31.056941`
