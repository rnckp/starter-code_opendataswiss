...
- **Keywords.de** `['bus', 'vbz', 'strassenbahn', 'vektordaten', 'geodaten', 'postauto', 'tram', 'tramlinien', 'verkauf', 'vbg', 'offentlicher-verkehr', 'buslinien', 'stzh', 'punktdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-24T01:06:48.367625`
