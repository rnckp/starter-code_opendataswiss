...
- **Keywords.de** `['geoportal', 'punktdaten', 'tramlinien', 'vbg', 'postauto', 'strassenbahn', 'verkauf', 'stzh', 'vektordaten', 'tram', 'vbz', 'bus', 'buslinien', 'geodaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-21T01:04:50.499878`
