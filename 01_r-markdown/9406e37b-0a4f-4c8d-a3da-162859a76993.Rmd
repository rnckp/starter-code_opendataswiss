...
- **Keywords.de** `['buslinien', 'bus', 'strassenbahn', 'tram', 'vbg', 'verkauf', 'punktdaten', 'geodaten', 'vbz', 'vektordaten', 'postauto', 'offentlicher-verkehr', 'stzh', 'tramlinien', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-13T01:16:51.187569`
