...
- **Keywords.de** `['geodaten', 'geoportal', 'tram', 'postauto', 'vbz', 'vektordaten', 'buslinien', 'strassenbahn', 'vbg', 'offentlicher-verkehr', 'tramlinien', 'verkauf', 'bus', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-29T01:11:47.965068`
