...
- **Keywords.de** `['tramlinien', 'verkauf', 'offentlicher-verkehr', 'vbz', 'geoportal', 'tram', 'vektordaten', 'strassenbahn', 'buslinien', 'punktdaten', 'postauto', 'geodaten', 'stzh', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-13T01:10:18.071513`
