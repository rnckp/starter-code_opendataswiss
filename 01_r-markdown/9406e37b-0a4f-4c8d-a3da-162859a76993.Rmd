...
- **Keywords.de** `['punktdaten', 'geoportal', 'offentlicher-verkehr', 'geodaten', 'strassenbahn', 'bus', 'buslinien', 'verkauf', 'vbg', 'vektordaten', 'postauto', 'vbz', 'tram', 'stzh', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-12T01:11:38.740631`
