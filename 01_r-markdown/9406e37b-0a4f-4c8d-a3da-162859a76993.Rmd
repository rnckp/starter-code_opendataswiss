...
- **Keywords.de** `['vektordaten', 'bus', 'strassenbahn', 'vbz', 'punktdaten', 'stzh', 'geoportal', 'tramlinien', 'geodaten', 'tram', 'offentlicher-verkehr', 'vbg', 'postauto', 'buslinien', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-02T01:46:08.308725`
