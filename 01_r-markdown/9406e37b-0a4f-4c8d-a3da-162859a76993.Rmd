...
- **Keywords.de** `['vektordaten', 'geoportal', 'tram', 'tramlinien', 'vbg', 'punktdaten', 'buslinien', 'verkauf', 'postauto', 'offentlicher-verkehr', 'bus', 'geodaten', 'strassenbahn', 'vbz', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-05T01:36:07.222473`
