...
- **Keywords.de** `['strassenbahn', 'tramlinien', 'vektordaten', 'stzh', 'offentlicher-verkehr', 'vbg', 'vbz', 'tram', 'verkauf', 'punktdaten', 'bus', 'postauto', 'geodaten', 'geoportal', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-27T01:23:50.635474`
