...
- **Keywords.de** `['vbg', 'tramlinien', 'stzh', 'strassenbahn', 'bus', 'geoportal', 'tram', 'vbz', 'vektordaten', 'geodaten', 'offentlicher-verkehr', 'punktdaten', 'verkauf', 'buslinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-28T01:44:50.564257`
