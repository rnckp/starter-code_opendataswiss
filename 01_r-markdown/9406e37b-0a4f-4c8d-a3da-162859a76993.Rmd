...
- **Keywords.de** `['vbg', 'vbz', 'postauto', 'vektordaten', 'geodaten', 'tramlinien', 'stzh', 'verkauf', 'tram', 'offentlicher-verkehr', 'geoportal', 'bus', 'strassenbahn', 'buslinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-07T01:09:31.826888`
