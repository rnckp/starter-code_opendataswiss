...
- **Keywords.de** `['geoportal', 'postauto', 'vbg', 'verkauf', 'tram', 'buslinien', 'stzh', 'geodaten', 'offentlicher-verkehr', 'vbz', 'strassenbahn', 'vektordaten', 'punktdaten', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-07T00:58:14.773867`
