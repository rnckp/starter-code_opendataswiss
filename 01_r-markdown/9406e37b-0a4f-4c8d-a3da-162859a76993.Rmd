...
- **Keywords.de** `['punktdaten', 'vektordaten', 'tramlinien', 'strassenbahn', 'bus', 'offentlicher-verkehr', 'vbz', 'postauto', 'vbg', 'geodaten', 'tram', 'stzh', 'buslinien', 'verkauf', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-28T01:29:39.477918`
