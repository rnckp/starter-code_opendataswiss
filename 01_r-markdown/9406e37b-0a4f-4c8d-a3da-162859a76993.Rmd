...
- **Keywords.de** `['stzh', 'geoportal', 'buslinien', 'vektordaten', 'postauto', 'tramlinien', 'vbz', 'bus', 'strassenbahn', 'vbg', 'punktdaten', 'tram', 'verkauf', 'geodaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-25T01:07:15.951638`
