...
- **Keywords.de** `['offentlicher-verkehr', 'vbz', 'vektordaten', 'geodaten', 'postauto', 'verkauf', 'tramlinien', 'punktdaten', 'stzh', 'vbg', 'strassenbahn', 'bus', 'buslinien', 'geoportal', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-02T01:17:03.333312`
