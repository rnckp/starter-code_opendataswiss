...
- **Keywords.de** `['punktdaten', 'buslinien', 'vbz', 'vektordaten', 'postauto', 'tram', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'stzh', 'tramlinien', 'bus', 'verkauf', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-12T01:58:08.943741`
