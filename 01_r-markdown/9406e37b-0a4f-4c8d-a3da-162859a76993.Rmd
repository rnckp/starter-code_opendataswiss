...
- **Keywords.de** `['tramlinien', 'offentlicher-verkehr', 'stzh', 'bus', 'vektordaten', 'buslinien', 'tram', 'postauto', 'verkauf', 'geoportal', 'vbg', 'strassenbahn', 'punktdaten', 'vbz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-09T01:33:35.529808`
