...
- **Keywords.de** `['strassenbahn', 'punktdaten', 'tram', 'postauto', 'buslinien', 'vbz', 'geoportal', 'vektordaten', 'geodaten', 'vbg', 'verkauf', 'stzh', 'offentlicher-verkehr', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-03T01:15:54.205826`
