...
- **Keywords.de** `['stzh', 'offentlicher-verkehr', 'vektordaten', 'punktdaten', 'postauto', 'geodaten', 'geoportal', 'bus', 'tramlinien', 'tram', 'strassenbahn', 'verkauf', 'buslinien', 'vbz', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-04T01:06:49.541017`
