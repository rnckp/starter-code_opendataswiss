...
- **Keywords.de** `['tram', 'offentlicher-verkehr', 'stzh', 'buslinien', 'vbg', 'postauto', 'punktdaten', 'verkauf', 'tramlinien', 'bus', 'strassenbahn', 'vbz', 'geodaten', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-19T01:19:04.119297`
