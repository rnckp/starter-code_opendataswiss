...
- **Keywords.de** `['offentlicher-verkehr', 'buslinien', 'tram', 'vbg', 'strassenbahn', 'stzh', 'geodaten', 'tramlinien', 'postauto', 'geoportal', 'verkauf', 'bus', 'vbz', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-07T01:12:33.924675`
