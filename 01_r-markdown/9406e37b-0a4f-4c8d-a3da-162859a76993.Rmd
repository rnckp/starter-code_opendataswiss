...
- **Keywords.de** `['bus', 'offentlicher-verkehr', 'vektordaten', 'vbz', 'geodaten', 'stzh', 'buslinien', 'postauto', 'vbg', 'tram', 'strassenbahn', 'geoportal', 'tramlinien', 'verkauf', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-09T01:17:57.017911`
