...
- **Keywords.de** `['offentlicher-verkehr', 'tramlinien', 'vbz', 'tram', 'geoportal', 'punktdaten', 'strassenbahn', 'vbg', 'bus', 'stzh', 'buslinien', 'vektordaten', 'verkauf', 'postauto', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-14T00:57:17.454753`
