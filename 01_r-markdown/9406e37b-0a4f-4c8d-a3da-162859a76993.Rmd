...
- **Keywords.de** `['vbg', 'verkauf', 'bus', 'strassenbahn', 'tram', 'buslinien', 'vektordaten', 'punktdaten', 'vbz', 'offentlicher-verkehr', 'stzh', 'geoportal', 'postauto', 'geodaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-15T01:32:48.367951`
