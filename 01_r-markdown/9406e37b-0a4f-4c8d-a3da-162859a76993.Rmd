...
- **Keywords.de** `['vektordaten', 'tram', 'punktdaten', 'bus', 'stzh', 'strassenbahn', 'tramlinien', 'vbg', 'geoportal', 'geodaten', 'postauto', 'verkauf', 'vbz', 'buslinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-23T01:12:42.423263`
