...
- **Keywords.de** `['geodaten', 'geoportal', 'punktdaten', 'tramlinien', 'strassenbahn', 'vbg', 'offentlicher-verkehr', 'vbz', 'verkauf', 'stzh', 'tram', 'bus', 'postauto', 'vektordaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-16T01:06:33.950591`
