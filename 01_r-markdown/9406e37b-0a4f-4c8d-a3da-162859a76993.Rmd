...
- **Keywords.de** `['verkauf', 'vbz', 'offentlicher-verkehr', 'buslinien', 'punktdaten', 'geodaten', 'stzh', 'geoportal', 'tramlinien', 'bus', 'postauto', 'vektordaten', 'vbg', 'tram', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-10T01:07:58.439666`
