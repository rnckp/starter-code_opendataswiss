...
- **Keywords.de** `['buslinien', 'strassenbahn', 'stzh', 'verkauf', 'geodaten', 'tram', 'postauto', 'vektordaten', 'vbz', 'tramlinien', 'geoportal', 'bus', 'punktdaten', 'offentlicher-verkehr', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-22T01:13:45.982591`
