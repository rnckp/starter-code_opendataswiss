...
- **Keywords.de** `['postauto', 'tramlinien', 'buslinien', 'verkauf', 'bus', 'vbg', 'strassenbahn', 'tram', 'offentlicher-verkehr', 'vbz', 'vektordaten', 'geoportal', 'geodaten', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-19T01:24:46.346907`
