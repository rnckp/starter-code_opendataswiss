...
- **Keywords.de** `['postauto', 'punktdaten', 'strassenbahn', 'verkauf', 'stzh', 'bus', 'tramlinien', 'geoportal', 'vbg', 'buslinien', 'vbz', 'vektordaten', 'geodaten', 'tram', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-22T01:11:49.795202`
