...
- **Keywords.de** `['postauto', 'geoportal', 'punktdaten', 'geodaten', 'offentlicher-verkehr', 'vektordaten', 'vbg', 'bus', 'tram', 'verkauf', 'tramlinien', 'stzh', 'vbz', 'strassenbahn', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-07T02:01:49.154966`
