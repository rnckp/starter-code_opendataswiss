...
- **Keywords.de** `['vbz', 'strassenbahn', 'tramlinien', 'punktdaten', 'vektordaten', 'tram', 'geodaten', 'vbg', 'bus', 'offentlicher-verkehr', 'buslinien', 'postauto', 'verkauf', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-05T01:19:48.466735`
