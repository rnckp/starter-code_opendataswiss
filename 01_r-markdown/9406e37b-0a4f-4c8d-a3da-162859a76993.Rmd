...
- **Keywords.de** `['stzh', 'punktdaten', 'geodaten', 'bus', 'offentlicher-verkehr', 'vbz', 'postauto', 'strassenbahn', 'geoportal', 'buslinien', 'tramlinien', 'vektordaten', 'vbg', 'verkauf', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-30T01:50:30.819341`
