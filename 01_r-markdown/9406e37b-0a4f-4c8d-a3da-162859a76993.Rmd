...
- **Keywords.de** `['bus', 'stzh', 'offentlicher-verkehr', 'geodaten', 'buslinien', 'verkauf', 'geoportal', 'strassenbahn', 'tram', 'postauto', 'tramlinien', 'vbz', 'vbg', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-06T01:19:49.251477`
