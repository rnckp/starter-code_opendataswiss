...
- **Keywords.de** `['geoportal', 'geodaten', 'strassenbahn', 'tram', 'verkauf', 'bus', 'stzh', 'offentlicher-verkehr', 'buslinien', 'punktdaten', 'postauto', 'vbz', 'tramlinien', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-29T01:13:32.831500`
