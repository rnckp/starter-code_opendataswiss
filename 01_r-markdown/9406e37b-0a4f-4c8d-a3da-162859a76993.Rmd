...
- **Keywords.de** `['tramlinien', 'bus', 'stzh', 'postauto', 'vbz', 'vektordaten', 'buslinien', 'verkauf', 'geodaten', 'punktdaten', 'vbg', 'geoportal', 'offentlicher-verkehr', 'tram', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-30T01:31:04.605127`
