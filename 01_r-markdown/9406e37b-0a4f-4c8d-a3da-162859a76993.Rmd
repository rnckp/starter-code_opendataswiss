...
- **Keywords.de** `['tramlinien', 'stzh', 'vektordaten', 'strassenbahn', 'geoportal', 'geodaten', 'postauto', 'verkauf', 'offentlicher-verkehr', 'punktdaten', 'buslinien', 'tram', 'vbz', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-27T01:04:00.305632`
