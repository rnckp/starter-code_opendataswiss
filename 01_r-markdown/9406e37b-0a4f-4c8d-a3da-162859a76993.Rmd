...
- **Keywords.de** `['verkauf', 'postauto', 'bus', 'punktdaten', 'tram', 'offentlicher-verkehr', 'vbz', 'stzh', 'vektordaten', 'vbg', 'strassenbahn', 'buslinien', 'geodaten', 'geoportal', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-27T01:20:10.106213`
