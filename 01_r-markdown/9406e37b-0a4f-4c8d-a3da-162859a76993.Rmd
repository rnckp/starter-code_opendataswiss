...
- **Keywords.de** `['verkauf', 'offentlicher-verkehr', 'punktdaten', 'vektordaten', 'stzh', 'vbg', 'geodaten', 'bus', 'vbz', 'buslinien', 'postauto', 'geoportal', 'strassenbahn', 'tramlinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-30T01:15:57.496428`
