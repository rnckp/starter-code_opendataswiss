...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'vbg', 'stzh', 'geodaten', 'vbz', 'tram', 'geoportal', 'punktdaten', 'postauto', 'tramlinien', 'verkauf', 'bus', 'buslinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-03T01:16:31.076823`
