...
- **Keywords.de** `['vbg', 'bus', 'buslinien', 'tram', 'geodaten', 'postauto', 'geoportal', 'strassenbahn', 'offentlicher-verkehr', 'stzh', 'punktdaten', 'vektordaten', 'verkauf', 'tramlinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-23T01:12:56.292627`
