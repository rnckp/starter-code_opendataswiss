...
- **Keywords.de** `['offentlicher-verkehr', 'vbg', 'geodaten', 'verkauf', 'stzh', 'buslinien', 'bus', 'punktdaten', 'vbz', 'tram', 'vektordaten', 'tramlinien', 'postauto', 'geoportal', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-10T01:07:25.016756`
