...
- **Keywords.de** `['stzh', 'verkauf', 'tram', 'vbz', 'vbg', 'punktdaten', 'bus', 'geodaten', 'strassenbahn', 'geoportal', 'vektordaten', 'tramlinien', 'offentlicher-verkehr', 'buslinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-10T01:16:50.120307`
