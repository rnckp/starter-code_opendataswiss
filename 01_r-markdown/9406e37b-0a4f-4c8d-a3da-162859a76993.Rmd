...
- **Keywords.de** `['tram', 'vbg', 'geodaten', 'bus', 'geoportal', 'tramlinien', 'stzh', 'vbz', 'punktdaten', 'offentlicher-verkehr', 'buslinien', 'postauto', 'verkauf', 'vektordaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-08T01:19:48.330740`
