...
- **Keywords.de** `['geodaten', 'vektordaten', 'tram', 'punktdaten', 'vbg', 'stzh', 'verkauf', 'vbz', 'geoportal', 'postauto', 'strassenbahn', 'tramlinien', 'bus', 'buslinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-23T01:00:57.932027`
