...
- **Keywords.de** `['tram', 'vbz', 'geoportal', 'bus', 'offentlicher-verkehr', 'strassenbahn', 'verkauf', 'vbg', 'geodaten', 'tramlinien', 'stzh', 'vektordaten', 'buslinien', 'punktdaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-16T00:59:14.336928`
