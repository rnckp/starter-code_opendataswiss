...
- **Keywords.de** `['buslinien', 'strassenbahn', 'stzh', 'punktdaten', 'vbg', 'tram', 'tramlinien', 'geoportal', 'vbz', 'offentlicher-verkehr', 'postauto', 'vektordaten', 'bus', 'geodaten', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-06T01:15:18.237021`
