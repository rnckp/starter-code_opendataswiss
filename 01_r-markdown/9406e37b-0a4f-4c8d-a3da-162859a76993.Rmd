...
- **Keywords.de** `['geoportal', 'offentlicher-verkehr', 'vektordaten', 'vbg', 'verkauf', 'stzh', 'punktdaten', 'buslinien', 'strassenbahn', 'postauto', 'bus', 'tram', 'geodaten', 'tramlinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-05T01:22:04.250315`
