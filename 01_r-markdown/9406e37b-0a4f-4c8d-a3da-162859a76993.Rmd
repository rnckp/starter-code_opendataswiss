...
- **Keywords.de** `['strassenbahn', 'offentlicher-verkehr', 'geoportal', 'geodaten', 'tramlinien', 'vbg', 'stzh', 'buslinien', 'vektordaten', 'bus', 'punktdaten', 'postauto', 'tram', 'vbz', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-27T01:33:53.719748`
