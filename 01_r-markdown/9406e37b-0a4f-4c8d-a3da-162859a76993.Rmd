...
- **Keywords.de** `['postauto', 'tram', 'offentlicher-verkehr', 'tramlinien', 'vbg', 'verkauf', 'punktdaten', 'vbz', 'geoportal', 'strassenbahn', 'vektordaten', 'buslinien', 'stzh', 'geodaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-03T01:14:19.630814`
