...
- **Keywords.de** `['postauto', 'geodaten', 'geoportal', 'vektordaten', 'strassenbahn', 'tram', 'vbg', 'buslinien', 'verkauf', 'punktdaten', 'vbz', 'offentlicher-verkehr', 'stzh', 'bus', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-14T01:04:46.248374`
