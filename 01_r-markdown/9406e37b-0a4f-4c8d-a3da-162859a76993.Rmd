...
- **Keywords.de** `['postauto', 'tramlinien', 'vbg', 'offentlicher-verkehr', 'vektordaten', 'verkauf', 'tram', 'geoportal', 'buslinien', 'vbz', 'punktdaten', 'bus', 'geodaten', 'strassenbahn', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-30T01:07:47.020084`
