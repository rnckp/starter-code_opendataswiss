...
- **Keywords.de** `['buslinien', 'postauto', 'geodaten', 'vbz', 'verkauf', 'strassenbahn', 'vbg', 'bus', 'stzh', 'offentlicher-verkehr', 'punktdaten', 'tram', 'tramlinien', 'vektordaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-31T01:06:45.941029`
