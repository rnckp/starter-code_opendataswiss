...
- **Keywords.de** `['buslinien', 'vektordaten', 'bus', 'stzh', 'geodaten', 'vbg', 'strassenbahn', 'punktdaten', 'tramlinien', 'offentlicher-verkehr', 'geoportal', 'vbz', 'tram', 'postauto', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-26T01:49:00.604910`
