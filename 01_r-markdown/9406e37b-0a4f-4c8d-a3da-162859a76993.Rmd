...
- **Keywords.de** `['buslinien', 'punktdaten', 'verkauf', 'geoportal', 'postauto', 'vbz', 'geodaten', 'bus', 'stzh', 'vektordaten', 'tram', 'strassenbahn', 'vbg', 'tramlinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-19T01:03:34.370489`
