...
- **Keywords.de** `['offentlicher-verkehr', 'strassenbahn', 'bus', 'stzh', 'vbz', 'vbg', 'tram', 'vektordaten', 'verkauf', 'punktdaten', 'geoportal', 'postauto', 'tramlinien', 'geodaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-03T01:17:56.751829`
