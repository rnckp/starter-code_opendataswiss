...
- **Keywords.de** `['bus', 'geodaten', 'geoportal', 'buslinien', 'vektordaten', 'offentlicher-verkehr', 'vbg', 'strassenbahn', 'tramlinien', 'stzh', 'vbz', 'verkauf', 'punktdaten', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-03T01:00:30.921996`
