...
- **Keywords.de** `['tramlinien', 'geoportal', 'offentlicher-verkehr', 'bus', 'strassenbahn', 'postauto', 'verkauf', 'geodaten', 'buslinien', 'vektordaten', 'vbg', 'vbz', 'punktdaten', 'stzh', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-31T01:28:36.749928`
