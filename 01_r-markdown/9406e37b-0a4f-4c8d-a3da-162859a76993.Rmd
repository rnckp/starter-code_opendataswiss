...
- **Keywords.de** `['buslinien', 'geoportal', 'verkauf', 'vbg', 'postauto', 'vbz', 'tramlinien', 'tram', 'bus', 'punktdaten', 'vektordaten', 'offentlicher-verkehr', 'geodaten', 'strassenbahn', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-18T01:39:37.883642`
