...
- **Keywords.de** `['geodaten', 'buslinien', 'strassenbahn', 'verkauf', 'punktdaten', 'geoportal', 'vbg', 'vbz', 'tramlinien', 'vektordaten', 'stzh', 'bus', 'offentlicher-verkehr', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-09T01:07:47.959846`
