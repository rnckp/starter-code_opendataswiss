...
- **Keywords.de** `['postauto', 'tram', 'vektordaten', 'punktdaten', 'offentlicher-verkehr', 'geoportal', 'tramlinien', 'geodaten', 'verkauf', 'bus', 'strassenbahn', 'buslinien', 'vbz', 'stzh', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-29T01:36:43.337089`
