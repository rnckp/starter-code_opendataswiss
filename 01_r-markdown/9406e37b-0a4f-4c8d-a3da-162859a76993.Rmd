...
- **Keywords.de** `['tramlinien', 'stzh', 'geoportal', 'offentlicher-verkehr', 'vbg', 'vektordaten', 'strassenbahn', 'vbz', 'buslinien', 'geodaten', 'postauto', 'bus', 'punktdaten', 'verkauf', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-11T01:46:17.224072`
