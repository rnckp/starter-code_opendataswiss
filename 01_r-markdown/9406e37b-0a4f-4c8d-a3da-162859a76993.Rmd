...
- **Keywords.de** `['offentlicher-verkehr', 'postauto', 'vbz', 'bus', 'punktdaten', 'geodaten', 'stzh', 'verkauf', 'tramlinien', 'vektordaten', 'vbg', 'strassenbahn', 'buslinien', 'geoportal', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-06T01:25:27.814081`
