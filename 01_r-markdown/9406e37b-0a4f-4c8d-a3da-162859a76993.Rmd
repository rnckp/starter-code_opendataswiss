...
- **Keywords.de** `['buslinien', 'offentlicher-verkehr', 'geoportal', 'postauto', 'vbz', 'vektordaten', 'punktdaten', 'bus', 'tramlinien', 'strassenbahn', 'tram', 'stzh', 'geodaten', 'verkauf', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-11-02T02:40:26.249237`
