...
- **Keywords.de** `['bus', 'verkauf', 'strassenbahn', 'vektordaten', 'buslinien', 'geodaten', 'tram', 'vbg', 'geoportal', 'offentlicher-verkehr', 'vbz', 'stzh', 'postauto', 'tramlinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-24T01:05:11.302997`
