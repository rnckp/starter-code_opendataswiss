...
- **Keywords.de** `['stzh', 'strassenbahn', 'tram', 'bus', 'postauto', 'buslinien', 'tramlinien', 'geodaten', 'offentlicher-verkehr', 'punktdaten', 'vektordaten', 'geoportal', 'verkauf', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-02T01:10:31.975165`
