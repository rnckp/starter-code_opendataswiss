...
- **Keywords.de** `['tramlinien', 'geodaten', 'bus', 'vbg', 'stzh', 'vektordaten', 'tram', 'offentlicher-verkehr', 'punktdaten', 'buslinien', 'postauto', 'geoportal', 'vbz', 'strassenbahn', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-23T01:17:15.241839`
