...
- **Keywords.de** `['geodaten', 'postauto', 'tramlinien', 'strassenbahn', 'vbg', 'vbz', 'geoportal', 'bus', 'vektordaten', 'buslinien', 'tram', 'verkauf', 'offentlicher-verkehr', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-11-05T02:46:53.230100`
