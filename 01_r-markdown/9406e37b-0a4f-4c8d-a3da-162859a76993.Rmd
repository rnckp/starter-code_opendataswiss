...
- **Keywords.de** `['tram', 'postauto', 'tramlinien', 'stzh', 'punktdaten', 'strassenbahn', 'vektordaten', 'bus', 'vbz', 'buslinien', 'offentlicher-verkehr', 'geoportal', 'geodaten', 'verkauf', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-10T01:23:13.167238`
