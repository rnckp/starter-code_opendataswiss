...
- **Keywords.de** `['verkauf', 'geoportal', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr', 'buslinien', 'tram', 'vbz', 'tramlinien', 'geodaten', 'punktdaten', 'stzh', 'bus', 'postauto', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-05T01:04:43.948195`
