...
- **Keywords.de** `['vbg', 'punktdaten', 'tramlinien', 'geodaten', 'stzh', 'strassenbahn', 'offentlicher-verkehr', 'bus', 'tram', 'vbz', 'verkauf', 'postauto', 'vektordaten', 'buslinien', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-15T01:08:36.174499`
