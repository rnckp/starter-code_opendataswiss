...
- **Keywords.de** `['buslinien', 'vbz', 'geoportal', 'postauto', 'bus', 'punktdaten', 'vbg', 'strassenbahn', 'vektordaten', 'geodaten', 'tramlinien', 'verkauf', 'tram', 'stzh', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-27T01:37:34.486830`
