...
- **Keywords.de** `['geodaten', 'strassenbahn', 'vbg', 'punktdaten', 'bus', 'tramlinien', 'offentlicher-verkehr', 'vbz', 'geoportal', 'verkauf', 'postauto', 'tram', 'stzh', 'buslinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-26T01:16:58.396978`
