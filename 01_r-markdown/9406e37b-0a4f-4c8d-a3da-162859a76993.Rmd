...
- **Keywords.de** `['vbz', 'vektordaten', 'stzh', 'geoportal', 'geodaten', 'tramlinien', 'vbg', 'offentlicher-verkehr', 'postauto', 'bus', 'strassenbahn', 'punktdaten', 'verkauf', 'tram', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-21T01:17:37.422350`
