...
- **Keywords.de** `['stzh', 'postauto', 'punktdaten', 'tram', 'tramlinien', 'strassenbahn', 'geodaten', 'vbg', 'verkauf', 'buslinien', 'vektordaten', 'geoportal', 'bus', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-09T01:46:43.753578`
