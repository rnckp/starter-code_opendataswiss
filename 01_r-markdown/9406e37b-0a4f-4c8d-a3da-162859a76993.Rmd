...
- **Keywords.de** `['vbz', 'vbg', 'vektordaten', 'offentlicher-verkehr', 'verkauf', 'postauto', 'geodaten', 'geoportal', 'strassenbahn', 'buslinien', 'tram', 'bus', 'punktdaten', 'stzh', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-17T01:29:10.842981`
