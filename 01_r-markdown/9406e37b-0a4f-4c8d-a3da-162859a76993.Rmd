...
- **Keywords.de** `['stzh', 'bus', 'verkauf', 'offentlicher-verkehr', 'geodaten', 'vbz', 'vektordaten', 'buslinien', 'strassenbahn', 'vbg', 'tramlinien', 'punktdaten', 'postauto', 'geoportal', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-18T00:59:43.489592`
