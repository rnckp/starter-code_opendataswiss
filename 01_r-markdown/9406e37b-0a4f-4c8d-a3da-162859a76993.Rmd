...
- **Keywords.de** `['offentlicher-verkehr', 'strassenbahn', 'vbg', 'bus', 'tramlinien', 'tram', 'geoportal', 'vbz', 'postauto', 'buslinien', 'punktdaten', 'vektordaten', 'verkauf', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-23T01:17:46.650838`
