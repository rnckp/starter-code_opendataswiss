...
- **Keywords.de** `['tram', 'vbg', 'geoportal', 'verkauf', 'vbz', 'geodaten', 'tramlinien', 'bus', 'vektordaten', 'offentlicher-verkehr', 'strassenbahn', 'punktdaten', 'buslinien', 'stzh', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-07T01:19:23.976608`
