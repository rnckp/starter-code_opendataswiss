...
- **Keywords.de** `['vektordaten', 'tramlinien', 'verkauf', 'punktdaten', 'tram', 'strassenbahn', 'stzh', 'postauto', 'geodaten', 'vbg', 'offentlicher-verkehr', 'geoportal', 'vbz', 'buslinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-28T01:44:23.481137`
