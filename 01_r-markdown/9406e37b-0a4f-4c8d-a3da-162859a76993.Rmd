...
- **Keywords.de** `['vbz', 'vektordaten', 'tramlinien', 'geoportal', 'bus', 'buslinien', 'tram', 'geodaten', 'offentlicher-verkehr', 'postauto', 'strassenbahn', 'stzh', 'punktdaten', 'verkauf', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-17T01:36:04.561887`
