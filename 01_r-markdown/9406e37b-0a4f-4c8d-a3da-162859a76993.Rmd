...
- **Keywords.de** `['punktdaten', 'stzh', 'vbz', 'tramlinien', 'postauto', 'tram', 'verkauf', 'geoportal', 'geodaten', 'strassenbahn', 'vbg', 'offentlicher-verkehr', 'buslinien', 'vektordaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-30T01:06:31.341285`
