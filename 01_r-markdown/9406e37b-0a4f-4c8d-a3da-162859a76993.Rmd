...
- **Keywords.de** `['verkauf', 'bus', 'strassenbahn', 'vektordaten', 'tramlinien', 'punktdaten', 'geodaten', 'tram', 'vbg', 'geoportal', 'vbz', 'offentlicher-verkehr', 'buslinien', 'stzh', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-29T01:43:54.277529`
