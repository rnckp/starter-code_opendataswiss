...
- **Keywords.de** `['verkauf', 'stzh', 'bus', 'tram', 'offentlicher-verkehr', 'vbg', 'geoportal', 'tramlinien', 'geodaten', 'punktdaten', 'strassenbahn', 'postauto', 'vektordaten', 'buslinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-07T01:30:57.863436`
