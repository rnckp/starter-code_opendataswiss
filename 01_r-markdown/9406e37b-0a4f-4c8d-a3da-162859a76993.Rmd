...
- **Keywords.de** `['stzh', 'vbg', 'tramlinien', 'bus', 'tram', 'postauto', 'strassenbahn', 'buslinien', 'offentlicher-verkehr', 'punktdaten', 'vbz', 'vektordaten', 'geodaten', 'verkauf', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-24T01:23:42.847818`
