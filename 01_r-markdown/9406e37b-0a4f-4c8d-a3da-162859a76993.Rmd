...
- **Keywords.de** `['postauto', 'vbg', 'tramlinien', 'verkauf', 'strassenbahn', 'geoportal', 'geodaten', 'punktdaten', 'offentlicher-verkehr', 'vektordaten', 'buslinien', 'stzh', 'tram', 'bus', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-24T01:29:28.531302`
