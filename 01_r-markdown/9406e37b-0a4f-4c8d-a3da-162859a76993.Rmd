...
- **Keywords.de** `['verkauf', 'geodaten', 'vektordaten', 'vbz', 'offentlicher-verkehr', 'postauto', 'strassenbahn', 'punktdaten', 'bus', 'geoportal', 'vbg', 'stzh', 'buslinien', 'tramlinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-13T01:16:08.719762`
