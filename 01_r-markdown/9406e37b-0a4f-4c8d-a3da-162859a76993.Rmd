...
- **Keywords.de** `['offentlicher-verkehr', 'geodaten', 'verkauf', 'bus', 'tram', 'buslinien', 'vbz', 'vbg', 'stzh', 'geoportal', 'punktdaten', 'postauto', 'strassenbahn', 'vektordaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-03T01:17:09.945000`
