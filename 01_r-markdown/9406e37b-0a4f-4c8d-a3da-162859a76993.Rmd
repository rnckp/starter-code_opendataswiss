...
- **Keywords.de** `['stzh', 'bus', 'vbz', 'tram', 'tramlinien', 'vbg', 'buslinien', 'vektordaten', 'geodaten', 'postauto', 'strassenbahn', 'punktdaten', 'verkauf', 'geoportal', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-12T01:12:00.768009`
