...
- **Keywords.de** `['geoportal', 'geodaten', 'verkauf', 'vbg', 'postauto', 'tram', 'tramlinien', 'punktdaten', 'stzh', 'offentlicher-verkehr', 'vektordaten', 'vbz', 'bus', 'strassenbahn', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-17T00:53:27.805617`
