...
- **Keywords.de** `['stzh', 'strassenbahn', 'geoportal', 'tramlinien', 'tram', 'bus', 'offentlicher-verkehr', 'verkauf', 'buslinien', 'vbz', 'vektordaten', 'geodaten', 'postauto', 'vbg', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-14T00:58:31.206103`
