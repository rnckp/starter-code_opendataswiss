...
- **Keywords.de** `['buslinien', 'strassenbahn', 'offentlicher-verkehr', 'punktdaten', 'verkauf', 'geoportal', 'bus', 'geodaten', 'tramlinien', 'vektordaten', 'postauto', 'vbz', 'tram', 'stzh', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-05T01:17:39.510617`
