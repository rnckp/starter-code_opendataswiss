...
- **Keywords.de** `['geodaten', 'verkauf', 'bus', 'vbz', 'tramlinien', 'geoportal', 'tram', 'offentlicher-verkehr', 'vektordaten', 'punktdaten', 'postauto', 'stzh', 'vbg', 'strassenbahn', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-23T01:53:48.241641`
