...
- **Keywords.de** `['punktdaten', 'offentlicher-verkehr', 'tram', 'vbz', 'vbg', 'verkauf', 'geoportal', 'bus', 'tramlinien', 'postauto', 'vektordaten', 'geodaten', 'strassenbahn', 'buslinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-19T01:33:49.579299`
