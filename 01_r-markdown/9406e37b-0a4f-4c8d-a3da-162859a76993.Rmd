...
- **Keywords.de** `['vektordaten', 'stzh', 'tramlinien', 'buslinien', 'geoportal', 'punktdaten', 'offentlicher-verkehr', 'geodaten', 'tram', 'strassenbahn', 'postauto', 'vbz', 'verkauf', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-25T01:20:14.349367`
