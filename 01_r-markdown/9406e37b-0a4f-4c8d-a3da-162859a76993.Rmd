...
- **Keywords.de** `['vbg', 'postauto', 'tram', 'vbz', 'verkauf', 'punktdaten', 'stzh', 'offentlicher-verkehr', 'bus', 'vektordaten', 'strassenbahn', 'geoportal', 'geodaten', 'buslinien', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-20T01:16:16.316449`
