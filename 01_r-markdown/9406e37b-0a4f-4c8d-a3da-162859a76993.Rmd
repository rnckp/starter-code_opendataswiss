...
- **Keywords.de** `['verkauf', 'tramlinien', 'tram', 'vbg', 'stzh', 'strassenbahn', 'geoportal', 'geodaten', 'offentlicher-verkehr', 'buslinien', 'postauto', 'punktdaten', 'vbz', 'vektordaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-04T01:00:45.213079`
