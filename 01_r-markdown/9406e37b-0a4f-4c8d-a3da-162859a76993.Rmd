...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'bus', 'tramlinien', 'vbz', 'geodaten', 'verkauf', 'vbg', 'punktdaten', 'tram', 'postauto', 'buslinien', 'strassenbahn', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-08T00:58:25.303641`
