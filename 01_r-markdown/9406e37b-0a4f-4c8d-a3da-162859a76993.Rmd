...
- **Keywords.de** `['tramlinien', 'bus', 'tram', 'geodaten', 'punktdaten', 'stzh', 'vektordaten', 'geoportal', 'vbg', 'vbz', 'offentlicher-verkehr', 'verkauf', 'strassenbahn', 'postauto', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-28T01:03:58.441557`
