...
- **Keywords.de** `['geoportal', 'punktdaten', 'buslinien', 'postauto', 'stzh', 'bus', 'vbg', 'vektordaten', 'tramlinien', 'tram', 'verkauf', 'offentlicher-verkehr', 'strassenbahn', 'geodaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-30T01:44:58.252811`
