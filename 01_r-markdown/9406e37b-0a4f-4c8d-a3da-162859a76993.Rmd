...
- **Keywords.de** `['tram', 'punktdaten', 'postauto', 'buslinien', 'verkauf', 'geoportal', 'vbz', 'bus', 'vektordaten', 'geodaten', 'offentlicher-verkehr', 'strassenbahn', 'vbg', 'tramlinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-05T01:17:33.615101`
