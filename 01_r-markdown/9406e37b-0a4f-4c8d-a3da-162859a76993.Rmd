...
- **Keywords.de** `['verkauf', 'geodaten', 'tram', 'vbz', 'tramlinien', 'stzh', 'buslinien', 'punktdaten', 'vektordaten', 'vbg', 'bus', 'strassenbahn', 'geoportal', 'postauto', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-14T01:36:23.476069`
