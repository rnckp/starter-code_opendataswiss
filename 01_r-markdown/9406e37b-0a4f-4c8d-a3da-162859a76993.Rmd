...
- **Keywords.de** `['postauto', 'punktdaten', 'strassenbahn', 'stzh', 'vbz', 'bus', 'vbg', 'vektordaten', 'tramlinien', 'tram', 'offentlicher-verkehr', 'geoportal', 'buslinien', 'verkauf', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-20T01:10:37.038274`
