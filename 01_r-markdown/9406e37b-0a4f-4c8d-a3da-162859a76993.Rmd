...
- **Keywords.de** `['vbg', 'geodaten', 'vektordaten', 'buslinien', 'punktdaten', 'postauto', 'tramlinien', 'offentlicher-verkehr', 'bus', 'stzh', 'strassenbahn', 'geoportal', 'vbz', 'tram', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-15T01:18:46.461787`
