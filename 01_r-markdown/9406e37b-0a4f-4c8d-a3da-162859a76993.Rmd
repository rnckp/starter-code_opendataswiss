...
- **Keywords.de** `['geodaten', 'stzh', 'verkauf', 'punktdaten', 'vektordaten', 'vbg', 'buslinien', 'tramlinien', 'geoportal', 'offentlicher-verkehr', 'strassenbahn', 'vbz', 'postauto', 'bus', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-01T01:31:13.870645`
