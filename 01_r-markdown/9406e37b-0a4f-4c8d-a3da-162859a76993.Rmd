...
- **Keywords.de** `['verkauf', 'vbz', 'vbg', 'tram', 'geodaten', 'bus', 'geoportal', 'postauto', 'strassenbahn', 'stzh', 'buslinien', 'vektordaten', 'tramlinien', 'offentlicher-verkehr', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-19T01:31:10.977391`
