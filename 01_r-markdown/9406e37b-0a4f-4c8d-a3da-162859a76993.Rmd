...
- **Keywords.de** `['stzh', 'buslinien', 'geoportal', 'vektordaten', 'vbg', 'punktdaten', 'tram', 'geodaten', 'strassenbahn', 'offentlicher-verkehr', 'vbz', 'verkauf', 'tramlinien', 'bus', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-14T01:21:32.573508`
