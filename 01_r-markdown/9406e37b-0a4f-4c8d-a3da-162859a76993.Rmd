...
- **Keywords.de** `['geodaten', 'strassenbahn', 'vektordaten', 'punktdaten', 'tram', 'vbg', 'tramlinien', 'buslinien', 'verkauf', 'vbz', 'offentlicher-verkehr', 'bus', 'stzh', 'postauto', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-28T01:43:00.555798`
