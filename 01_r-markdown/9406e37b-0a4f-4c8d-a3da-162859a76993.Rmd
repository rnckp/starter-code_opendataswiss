...
- **Keywords.de** `['verkauf', 'vbg', 'vektordaten', 'vbz', 'postauto', 'strassenbahn', 'punktdaten', 'tramlinien', 'offentlicher-verkehr', 'geodaten', 'geoportal', 'tram', 'stzh', 'buslinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-11T01:45:15.946655`
