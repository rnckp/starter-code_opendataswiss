...
- **Keywords.de** `['vbg', 'tram', 'offentlicher-verkehr', 'geodaten', 'verkauf', 'tramlinien', 'strassenbahn', 'bus', 'vektordaten', 'postauto', 'geoportal', 'stzh', 'punktdaten', 'vbz', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-13T01:06:11.816530`
