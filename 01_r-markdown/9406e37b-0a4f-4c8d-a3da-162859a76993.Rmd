...
- **Keywords.de** `['punktdaten', 'buslinien', 'tram', 'vbg', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien', 'postauto', 'geoportal', 'bus', 'vektordaten', 'geodaten', 'verkauf', 'stzh', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-11T01:15:15.468653`
