...
- **Keywords.de** `['punktdaten', 'verkauf', 'stzh', 'offentlicher-verkehr', 'geoportal', 'strassenbahn', 'postauto', 'bus', 'vbz', 'tramlinien', 'geodaten', 'buslinien', 'vektordaten', 'tram', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-28T00:58:44.555855`
