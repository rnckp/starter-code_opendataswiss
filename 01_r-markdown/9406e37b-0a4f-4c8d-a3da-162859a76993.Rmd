...
- **Keywords.de** `['geoportal', 'verkauf', 'tramlinien', 'bus', 'buslinien', 'vbz', 'tram', 'punktdaten', 'strassenbahn', 'vbg', 'vektordaten', 'postauto', 'offentlicher-verkehr', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-24T01:18:06.687018`
