...
- **Keywords.de** `['punktdaten', 'postauto', 'buslinien', 'strassenbahn', 'vbz', 'geoportal', 'offentlicher-verkehr', 'stzh', 'geodaten', 'verkauf', 'bus', 'vbg', 'tramlinien', 'tram', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-07T01:12:52.087939`
