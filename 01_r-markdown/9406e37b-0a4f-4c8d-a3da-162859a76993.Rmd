...
- **Keywords.de** `['punktdaten', 'vbz', 'strassenbahn', 'vektordaten', 'stzh', 'tramlinien', 'buslinien', 'vbg', 'offentlicher-verkehr', 'verkauf', 'bus', 'geoportal', 'geodaten', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-02T01:18:51.624338`
