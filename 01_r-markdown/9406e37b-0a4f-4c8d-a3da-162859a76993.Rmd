...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'vbz', 'vbg', 'geodaten', 'stzh', 'tramlinien', 'strassenbahn', 'buslinien', 'tram', 'postauto', 'geoportal', 'punktdaten', 'verkauf', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-25T01:10:50.623620`
