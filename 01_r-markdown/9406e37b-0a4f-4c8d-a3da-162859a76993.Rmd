...
- **Keywords.de** `['punktdaten', 'bus', 'vektordaten', 'buslinien', 'vbg', 'verkauf', 'geodaten', 'strassenbahn', 'geoportal', 'offentlicher-verkehr', 'tram', 'tramlinien', 'vbz', 'postauto', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-12T01:33:09.272875`
