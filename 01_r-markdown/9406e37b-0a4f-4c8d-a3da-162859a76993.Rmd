...
- **Keywords.de** `['tramlinien', 'vektordaten', 'tram', 'offentlicher-verkehr', 'vbz', 'geodaten', 'stzh', 'geoportal', 'strassenbahn', 'punktdaten', 'bus', 'verkauf', 'vbg', 'postauto', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-12T01:49:32.102592`
