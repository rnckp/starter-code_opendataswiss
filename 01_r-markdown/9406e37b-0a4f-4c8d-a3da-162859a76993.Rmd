...
- **Keywords.de** `['postauto', 'strassenbahn', 'stzh', 'tram', 'geoportal', 'vbg', 'tramlinien', 'geodaten', 'verkauf', 'bus', 'buslinien', 'punktdaten', 'offentlicher-verkehr', 'vbz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-09T01:15:40.242532`
