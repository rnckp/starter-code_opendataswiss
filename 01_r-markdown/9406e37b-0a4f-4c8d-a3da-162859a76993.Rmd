...
- **Keywords.de** `['vbg', 'punktdaten', 'tram', 'strassenbahn', 'geoportal', 'postauto', 'verkauf', 'geodaten', 'tramlinien', 'bus', 'stzh', 'offentlicher-verkehr', 'vbz', 'buslinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-28T01:03:34.706640`
