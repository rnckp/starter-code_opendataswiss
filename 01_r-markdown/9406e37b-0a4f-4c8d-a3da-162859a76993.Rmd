...
- **Keywords.de** `['geodaten', 'vbg', 'postauto', 'stzh', 'offentlicher-verkehr', 'geoportal', 'tram', 'vektordaten', 'vbz', 'bus', 'tramlinien', 'strassenbahn', 'punktdaten', 'verkauf', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-04T01:13:45.610095`
