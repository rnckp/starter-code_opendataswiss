...
- **Keywords.de** `['bus', 'vbg', 'buslinien', 'vektordaten', 'tram', 'verkauf', 'geoportal', 'stzh', 'postauto', 'offentlicher-verkehr', 'vbz', 'geodaten', 'strassenbahn', 'tramlinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-28T01:16:54.359627`
