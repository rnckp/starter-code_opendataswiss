...
- **Keywords.de** `['bus', 'postauto', 'vbz', 'tramlinien', 'stzh', 'geodaten', 'tram', 'strassenbahn', 'vbg', 'punktdaten', 'buslinien', 'geoportal', 'offentlicher-verkehr', 'verkauf', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-01T01:16:55.256847`
