...
- **Keywords.de** `['postauto', 'verkauf', 'tramlinien', 'punktdaten', 'stzh', 'tram', 'geodaten', 'offentlicher-verkehr', 'vbz', 'bus', 'buslinien', 'vbg', 'geoportal', 'vektordaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-28T01:21:00.805676`
