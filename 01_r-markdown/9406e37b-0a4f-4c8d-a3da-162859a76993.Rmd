...
- **Keywords.de** `['offentlicher-verkehr', 'vbz', 'geoportal', 'buslinien', 'stzh', 'strassenbahn', 'bus', 'tram', 'vektordaten', 'tramlinien', 'verkauf', 'geodaten', 'vbg', 'postauto', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-27T01:16:33.835933`
