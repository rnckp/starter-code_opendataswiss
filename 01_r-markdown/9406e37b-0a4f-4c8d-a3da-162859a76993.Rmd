...
- **Keywords.de** `['tram', 'vbz', 'verkauf', 'strassenbahn', 'stzh', 'buslinien', 'tramlinien', 'postauto', 'geodaten', 'vbg', 'punktdaten', 'bus', 'vektordaten', 'offentlicher-verkehr', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-21T01:12:04.713843`
