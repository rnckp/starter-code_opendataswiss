...
- **Keywords.de** `['geoportal', 'geodaten', 'postauto', 'stzh', 'bus', 'offentlicher-verkehr', 'vbz', 'strassenbahn', 'tramlinien', 'tram', 'verkauf', 'vbg', 'buslinien', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-29T01:19:21.570975`
