...
- **Keywords.de** `['vbg', 'verkauf', 'tramlinien', 'tram', 'punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'bus', 'buslinien', 'geodaten', 'postauto', 'vektordaten', 'stzh', 'geoportal', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-25T01:18:29.174247`
