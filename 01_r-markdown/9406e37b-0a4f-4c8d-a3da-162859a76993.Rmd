...
- **Keywords.de** `['tramlinien', 'geodaten', 'offentlicher-verkehr', 'verkauf', 'buslinien', 'tram', 'bus', 'geoportal', 'punktdaten', 'strassenbahn', 'vbg', 'vektordaten', 'vbz', 'stzh', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-29T01:00:23.893637`
