...
- **Keywords.de** `['buslinien', 'punktdaten', 'postauto', 'offentlicher-verkehr', 'geodaten', 'bus', 'stzh', 'strassenbahn', 'tram', 'tramlinien', 'vbg', 'verkauf', 'vektordaten', 'geoportal', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-01T01:32:06.840052`
