...
- **Keywords.de** `['postauto', 'offentlicher-verkehr', 'vektordaten', 'geodaten', 'punktdaten', 'tramlinien', 'verkauf', 'geoportal', 'stzh', 'strassenbahn', 'bus', 'buslinien', 'vbg', 'tram', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-30T02:22:23.308253`
