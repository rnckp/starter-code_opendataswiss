...
- **Keywords.de** `['vbg', 'stzh', 'buslinien', 'strassenbahn', 'vbz', 'geodaten', 'offentlicher-verkehr', 'geoportal', 'postauto', 'punktdaten', 'bus', 'tramlinien', 'vektordaten', 'tram', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-25T00:54:27.817898`
