...
- **Keywords.de** `['vbg', 'offentlicher-verkehr', 'punktdaten', 'stzh', 'buslinien', 'bus', 'vektordaten', 'vbz', 'verkauf', 'strassenbahn', 'tramlinien', 'geoportal', 'tram', 'geodaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-18T01:12:35.084749`
