...
- **Keywords.de** `['vektordaten', 'tramlinien', 'punktdaten', 'geodaten', 'tram', 'postauto', 'vbg', 'offentlicher-verkehr', 'stzh', 'strassenbahn', 'buslinien', 'verkauf', 'bus', 'geoportal', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-15T01:13:16.396776`
