...
- **Keywords.de** `['stzh', 'strassenbahn', 'geoportal', 'bus', 'postauto', 'buslinien', 'vbg', 'vektordaten', 'offentlicher-verkehr', 'tram', 'tramlinien', 'vbz', 'geodaten', 'punktdaten', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-01T02:16:12.332145`
