...
- **Keywords.de** `['stzh', 'vektordaten', 'tram', 'punktdaten', 'geoportal', 'vbz', 'verkauf', 'vbg', 'geodaten', 'postauto', 'offentlicher-verkehr', 'tramlinien', 'buslinien', 'bus', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-10T00:58:40.470347`
