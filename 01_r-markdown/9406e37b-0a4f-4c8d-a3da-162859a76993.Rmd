...
- **Keywords.de** `['geoportal', 'bus', 'stzh', 'tram', 'punktdaten', 'verkauf', 'tramlinien', 'buslinien', 'vbg', 'offentlicher-verkehr', 'strassenbahn', 'postauto', 'geodaten', 'vektordaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-03T00:57:09.269744`
