...
- **Keywords.de** `['postauto', 'vektordaten', 'geodaten', 'stzh', 'offentlicher-verkehr', 'punktdaten', 'vbz', 'vbg', 'buslinien', 'tram', 'geoportal', 'strassenbahn', 'verkauf', 'bus', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-17T01:04:14.892878`
