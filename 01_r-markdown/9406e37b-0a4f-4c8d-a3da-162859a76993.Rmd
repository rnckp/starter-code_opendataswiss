...
- **Keywords.de** `['vbz', 'tramlinien', 'postauto', 'strassenbahn', 'punktdaten', 'verkauf', 'stzh', 'vbg', 'buslinien', 'geodaten', 'geoportal', 'tram', 'vektordaten', 'offentlicher-verkehr', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-21T01:00:52.479563`
