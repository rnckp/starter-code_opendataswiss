...
- **Keywords.de** `['strassenbahn', 'vbg', 'vbz', 'vektordaten', 'geodaten', 'buslinien', 'stzh', 'verkauf', 'postauto', 'tram', 'offentlicher-verkehr', 'bus', 'tramlinien', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-25T01:34:07.253156`
