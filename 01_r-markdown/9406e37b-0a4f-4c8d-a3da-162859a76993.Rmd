...
- **Keywords.de** `['geodaten', 'strassenbahn', 'buslinien', 'tramlinien', 'stzh', 'geoportal', 'postauto', 'vektordaten', 'punktdaten', 'tram', 'vbz', 'verkauf', 'offentlicher-verkehr', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-06T01:30:51.447767`
