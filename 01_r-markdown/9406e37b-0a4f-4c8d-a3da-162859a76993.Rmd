...
- **Keywords.de** `['stzh', 'offentlicher-verkehr', 'vbg', 'geoportal', 'tram', 'vektordaten', 'tramlinien', 'buslinien', 'bus', 'vbz', 'strassenbahn', 'punktdaten', 'postauto', 'verkauf', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-24T01:01:06.539401`
