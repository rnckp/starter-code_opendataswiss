...
- **Keywords.de** `['bus', 'buslinien', 'geodaten', 'stzh', 'vbz', 'tramlinien', 'geoportal', 'tram', 'postauto', 'offentlicher-verkehr', 'punktdaten', 'verkauf', 'strassenbahn', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-09T01:22:16.547391`
