...
- **Keywords.de** `['tramlinien', 'geodaten', 'bus', 'geoportal', 'offentlicher-verkehr', 'vbg', 'buslinien', 'strassenbahn', 'tram', 'punktdaten', 'vbz', 'vektordaten', 'stzh', 'postauto', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-06T01:41:05.876898`
