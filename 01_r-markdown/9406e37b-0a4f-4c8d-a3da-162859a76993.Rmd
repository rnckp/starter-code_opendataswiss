...
- **Keywords.de** `['verkauf', 'postauto', 'tram', 'offentlicher-verkehr', 'vektordaten', 'punktdaten', 'vbz', 'buslinien', 'geoportal', 'tramlinien', 'bus', 'strassenbahn', 'vbg', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-22T01:13:42.038771`
