...
- **Keywords.de** `['strassenbahn', 'bus', 'tramlinien', 'verkauf', 'stzh', 'vektordaten', 'vbg', 'postauto', 'geoportal', 'geodaten', 'buslinien', 'punktdaten', 'tram', 'vbz', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-16T01:01:55.516167`
