...
- **Keywords.de** `['geoportal', 'tram', 'punktdaten', 'tramlinien', 'vektordaten', 'bus', 'stzh', 'offentlicher-verkehr', 'postauto', 'strassenbahn', 'verkauf', 'geodaten', 'vbz', 'buslinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-17T02:24:39.760736`
