...
- **Keywords.de** `['tram', 'offentlicher-verkehr', 'vbz', 'stzh', 'verkauf', 'bus', 'postauto', 'strassenbahn', 'buslinien', 'vektordaten', 'geoportal', 'punktdaten', 'geodaten', 'tramlinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-28T01:30:30.627576`
