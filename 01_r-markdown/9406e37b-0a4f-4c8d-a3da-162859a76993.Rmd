...
- **Keywords.de** `['stzh', 'buslinien', 'vbz', 'vektordaten', 'tramlinien', 'verkauf', 'geodaten', 'strassenbahn', 'bus', 'offentlicher-verkehr', 'tram', 'postauto', 'punktdaten', 'geoportal', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-21T01:31:11.868650`
