...
- **Keywords.de** `['geoportal', 'punktdaten', 'strassenbahn', 'vbg', 'vektordaten', 'buslinien', 'bus', 'offentlicher-verkehr', 'geodaten', 'tramlinien', 'postauto', 'stzh', 'vbz', 'verkauf', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-02T01:17:08.575216`
