...
- **Keywords.de** `['tram', 'strassenbahn', 'verkauf', 'geoportal', 'vbg', 'vektordaten', 'bus', 'buslinien', 'stzh', 'punktdaten', 'geodaten', 'vbz', 'postauto', 'tramlinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-26T01:42:10.480088`
