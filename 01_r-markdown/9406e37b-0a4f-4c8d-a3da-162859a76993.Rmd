...
- **Keywords.de** `['offentlicher-verkehr', 'postauto', 'geoportal', 'geodaten', 'vektordaten', 'buslinien', 'vbg', 'bus', 'verkauf', 'strassenbahn', 'tram', 'punktdaten', 'tramlinien', 'stzh', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-07T01:24:58.522828`
