...
- **Keywords.de** `['geoportal', 'vbg', 'offentlicher-verkehr', 'postauto', 'vektordaten', 'vbz', 'tramlinien', 'strassenbahn', 'stzh', 'verkauf', 'punktdaten', 'buslinien', 'bus', 'geodaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-18T01:11:10.152791`
