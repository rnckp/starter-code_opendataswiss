...
- **Keywords.de** `['tram', 'strassenbahn', 'verkauf', 'tramlinien', 'vbg', 'postauto', 'geoportal', 'bus', 'buslinien', 'stzh', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'vbz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-14T00:58:56.598259`
