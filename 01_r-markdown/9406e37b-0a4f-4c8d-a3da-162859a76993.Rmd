...
- **Keywords.de** `['punktdaten', 'strassenbahn', 'vbg', 'verkauf', 'bus', 'tram', 'vektordaten', 'geoportal', 'buslinien', 'postauto', 'tramlinien', 'offentlicher-verkehr', 'vbz', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-14T01:15:00.454145`
