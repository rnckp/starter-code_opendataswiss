...
- **Keywords.de** `['vbz', 'verkauf', 'vektordaten', 'tram', 'bus', 'punktdaten', 'geoportal', 'tramlinien', 'buslinien', 'geodaten', 'vbg', 'offentlicher-verkehr', 'strassenbahn', 'postauto', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-18T01:34:51.569639`
