...
- **Keywords.de** `['vbz', 'buslinien', 'postauto', 'strassenbahn', 'geoportal', 'tram', 'offentlicher-verkehr', 'verkauf', 'tramlinien', 'vbg', 'bus', 'stzh', 'vektordaten', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-02T01:23:07.113538`
