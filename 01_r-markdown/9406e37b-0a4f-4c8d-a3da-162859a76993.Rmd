...
- **Keywords.de** `['tramlinien', 'verkauf', 'geodaten', 'vektordaten', 'vbg', 'postauto', 'bus', 'offentlicher-verkehr', 'buslinien', 'strassenbahn', 'vbz', 'stzh', 'geoportal', 'tram', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-10T01:07:37.601477`
