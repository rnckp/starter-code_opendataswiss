...
- **Keywords.de** `['tramlinien', 'buslinien', 'stzh', 'geoportal', 'vektordaten', 'geodaten', 'strassenbahn', 'verkauf', 'tram', 'punktdaten', 'postauto', 'bus', 'vbz', 'offentlicher-verkehr', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-19T01:22:57.292116`
