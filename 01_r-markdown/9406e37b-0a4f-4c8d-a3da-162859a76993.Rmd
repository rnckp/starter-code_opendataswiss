...
- **Keywords.de** `['offentlicher-verkehr', 'postauto', 'tramlinien', 'vektordaten', 'strassenbahn', 'punktdaten', 'bus', 'geoportal', 'stzh', 'buslinien', 'vbz', 'verkauf', 'geodaten', 'tram', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-15T01:30:36.465349`
