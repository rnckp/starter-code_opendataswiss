...
- **Keywords.de** `['geodaten', 'offentlicher-verkehr', 'strassenbahn', 'vbz', 'tram', 'vbg', 'punktdaten', 'geoportal', 'vektordaten', 'stzh', 'tramlinien', 'postauto', 'bus', 'verkauf', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-08T01:44:56.859187`
