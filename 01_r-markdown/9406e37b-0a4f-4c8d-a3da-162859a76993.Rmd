...
- **Keywords.de** `['geodaten', 'postauto', 'verkauf', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien', 'vektordaten', 'vbg', 'geoportal', 'bus', 'punktdaten', 'tram', 'stzh', 'buslinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-26T01:17:32.470086`
