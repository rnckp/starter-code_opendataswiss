...
- **Keywords.de** `['postauto', 'vektordaten', 'offentlicher-verkehr', 'geoportal', 'tramlinien', 'vbz', 'buslinien', 'verkauf', 'geodaten', 'punktdaten', 'tram', 'strassenbahn', 'stzh', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-19T01:47:38.451135`
