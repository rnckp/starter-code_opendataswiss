...
- **Keywords.de** `['postauto', 'vbg', 'strassenbahn', 'verkauf', 'bus', 'geodaten', 'stzh', 'tram', 'buslinien', 'geoportal', 'tramlinien', 'punktdaten', 'vbz', 'vektordaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-05T01:17:51.052739`
