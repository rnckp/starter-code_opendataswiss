...
- **Keywords.de** `['geodaten', 'vbz', 'tramlinien', 'geoportal', 'punktdaten', 'tram', 'strassenbahn', 'verkauf', 'buslinien', 'vektordaten', 'offentlicher-verkehr', 'bus', 'vbg', 'postauto', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-27T01:36:16.765359`
