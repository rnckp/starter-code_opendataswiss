...
- **Keywords.de** `['verkauf', 'geodaten', 'vbg', 'vektordaten', 'offentlicher-verkehr', 'geoportal', 'tram', 'vbz', 'postauto', 'strassenbahn', 'buslinien', 'stzh', 'tramlinien', 'bus', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-04T01:19:04.019718`
