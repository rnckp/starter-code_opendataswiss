...
- **Keywords.de** `['strassenbahn', 'geoportal', 'verkauf', 'bus', 'offentlicher-verkehr', 'tramlinien', 'postauto', 'buslinien', 'geodaten', 'vektordaten', 'punktdaten', 'vbz', 'tram', 'vbg', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-04T01:10:54.376584`
