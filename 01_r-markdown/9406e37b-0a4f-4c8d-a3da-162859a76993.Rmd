...
- **Keywords.de** `['verkauf', 'vbz', 'stzh', 'vektordaten', 'tramlinien', 'geodaten', 'postauto', 'strassenbahn', 'vbg', 'punktdaten', 'geoportal', 'tram', 'buslinien', 'bus', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-11T01:12:34.748822`
