...
- **Keywords.de** `['verkauf', 'strassenbahn', 'geodaten', 'vbz', 'geoportal', 'bus', 'postauto', 'stzh', 'punktdaten', 'buslinien', 'offentlicher-verkehr', 'vektordaten', 'tramlinien', 'tram', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-22T01:08:03.935207`
