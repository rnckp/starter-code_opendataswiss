...
- **Keywords.de** `['buslinien', 'bus', 'offentlicher-verkehr', 'tram', 'vbz', 'punktdaten', 'vektordaten', 'stzh', 'verkauf', 'geoportal', 'vbg', 'geodaten', 'tramlinien', 'strassenbahn', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-11-01T01:41:27.125690`
