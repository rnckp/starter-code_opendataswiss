...
- **Keywords.de** `['vbg', 'punktdaten', 'tramlinien', 'stzh', 'verkauf', 'geoportal', 'postauto', 'vbz', 'bus', 'buslinien', 'strassenbahn', 'vektordaten', 'geodaten', 'tram', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-02T01:16:05.677840`
