...
- **Keywords.de** `['vbg', 'tramlinien', 'geodaten', 'verkauf', 'bus', 'strassenbahn', 'stzh', 'geoportal', 'offentlicher-verkehr', 'postauto', 'vektordaten', 'vbz', 'punktdaten', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-21T00:54:32.496076`
