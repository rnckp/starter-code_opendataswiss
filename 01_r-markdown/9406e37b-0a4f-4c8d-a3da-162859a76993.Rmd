...
- **Keywords.de** `['verkauf', 'strassenbahn', 'tram', 'tramlinien', 'geodaten', 'bus', 'buslinien', 'offentlicher-verkehr', 'punktdaten', 'vbg', 'stzh', 'vektordaten', 'geoportal', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-25T01:11:09.459764`
