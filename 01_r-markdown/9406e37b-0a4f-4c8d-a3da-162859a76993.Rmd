...
- **Keywords.de** `['tram', 'postauto', 'punktdaten', 'vektordaten', 'strassenbahn', 'vbz', 'bus', 'geodaten', 'buslinien', 'tramlinien', 'offentlicher-verkehr', 'stzh', 'geoportal', 'verkauf', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-05T01:32:04.671324`
