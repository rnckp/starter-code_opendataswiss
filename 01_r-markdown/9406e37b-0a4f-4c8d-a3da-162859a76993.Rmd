...
- **Keywords.de** `['punktdaten', 'tramlinien', 'tram', 'vektordaten', 'postauto', 'verkauf', 'vbz', 'strassenbahn', 'offentlicher-verkehr', 'buslinien', 'vbg', 'geoportal', 'geodaten', 'stzh', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-23T01:12:51.073165`
