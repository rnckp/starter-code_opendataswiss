...
- **Keywords.de** `['vbg', 'verkauf', 'tramlinien', 'postauto', 'strassenbahn', 'geodaten', 'offentlicher-verkehr', 'buslinien', 'stzh', 'vbz', 'punktdaten', 'geoportal', 'vektordaten', 'bus', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-20T02:01:55.458593`
