...
- **Keywords.de** `['verkauf', 'geoportal', 'stzh', 'punktdaten', 'vbg', 'tramlinien', 'strassenbahn', 'buslinien', 'tram', 'vbz', 'bus', 'vektordaten', 'geodaten', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-26T01:43:04.360088`
