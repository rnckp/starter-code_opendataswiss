...
- **Keywords.de** `['postauto', 'stzh', 'geodaten', 'punktdaten', 'tramlinien', 'tram', 'vbg', 'bus', 'buslinien', 'geoportal', 'strassenbahn', 'vbz', 'vektordaten', 'offentlicher-verkehr', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-04T01:03:24.460249`
