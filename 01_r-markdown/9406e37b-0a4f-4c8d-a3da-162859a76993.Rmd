...
- **Keywords.de** `['vektordaten', 'offentlicher-verkehr', 'buslinien', 'verkauf', 'stzh', 'vbg', 'postauto', 'vbz', 'bus', 'geoportal', 'tram', 'strassenbahn', 'geodaten', 'punktdaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-16T01:16:04.959329`
