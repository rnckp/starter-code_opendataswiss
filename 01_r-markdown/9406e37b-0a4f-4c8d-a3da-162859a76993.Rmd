...
- **Keywords.de** `['tram', 'postauto', 'vbz', 'strassenbahn', 'stzh', 'geoportal', 'tramlinien', 'verkauf', 'geodaten', 'vbg', 'vektordaten', 'punktdaten', 'bus', 'offentlicher-verkehr', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-31T01:14:05.209065`
