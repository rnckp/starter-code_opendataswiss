...
- **Keywords.de** `['geodaten', 'strassenbahn', 'offentlicher-verkehr', 'bus', 'vektordaten', 'geoportal', 'vbg', 'tram', 'vbz', 'buslinien', 'postauto', 'punktdaten', 'verkauf', 'tramlinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-17T01:21:43.091513`
