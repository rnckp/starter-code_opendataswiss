...
- **Keywords.de** `['tramlinien', 'tram', 'stzh', 'postauto', 'vbg', 'strassenbahn', 'buslinien', 'geodaten', 'geoportal', 'offentlicher-verkehr', 'punktdaten', 'bus', 'vbz', 'verkauf', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-22T00:53:23.669953`
