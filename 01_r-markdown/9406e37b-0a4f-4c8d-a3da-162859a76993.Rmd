...
- **Keywords.de** `['tram', 'vbg', 'offentlicher-verkehr', 'bus', 'punktdaten', 'verkauf', 'postauto', 'geoportal', 'buslinien', 'vektordaten', 'vbz', 'strassenbahn', 'geodaten', 'stzh', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-09T01:10:25.549509`
