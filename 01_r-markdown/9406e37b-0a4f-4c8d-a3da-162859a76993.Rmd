...
- **Keywords.de** `['offentlicher-verkehr', 'geodaten', 'buslinien', 'stzh', 'vbz', 'verkauf', 'bus', 'geoportal', 'vbg', 'postauto', 'punktdaten', 'tramlinien', 'strassenbahn', 'vektordaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-29T01:12:16.385795`
