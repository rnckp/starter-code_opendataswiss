...
- **Keywords.de** `['vbz', 'geodaten', 'offentlicher-verkehr', 'strassenbahn', 'stzh', 'punktdaten', 'vbg', 'tram', 'vektordaten', 'tramlinien', 'geoportal', 'bus', 'verkauf', 'postauto', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-21T01:19:36.825164`
