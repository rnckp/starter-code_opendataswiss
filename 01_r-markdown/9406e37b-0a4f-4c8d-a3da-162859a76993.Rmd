...
- **Keywords.de** `['tramlinien', 'geoportal', 'vektordaten', 'vbg', 'postauto', 'stzh', 'bus', 'geodaten', 'offentlicher-verkehr', 'vbz', 'tram', 'strassenbahn', 'punktdaten', 'verkauf', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-19T01:46:15.049044`
