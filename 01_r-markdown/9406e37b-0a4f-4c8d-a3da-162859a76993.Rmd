...
- **Keywords.de** `['verkauf', 'tram', 'stzh', 'strassenbahn', 'postauto', 'geodaten', 'punktdaten', 'bus', 'vbz', 'offentlicher-verkehr', 'vbg', 'tramlinien', 'buslinien', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-20T01:20:02.718105`
