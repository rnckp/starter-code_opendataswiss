...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'bus', 'geoportal', 'vektordaten', 'postauto', 'tramlinien', 'punktdaten', 'verkauf', 'vbg', 'tram', 'vbz', 'strassenbahn', 'geodaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-16T01:13:39.611346`
