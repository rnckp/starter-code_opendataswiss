...
- **Keywords.de** `['offentlicher-verkehr', 'geodaten', 'strassenbahn', 'verkauf', 'buslinien', 'tramlinien', 'stzh', 'geoportal', 'postauto', 'tram', 'vbz', 'punktdaten', 'vbg', 'vektordaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-01T01:27:08.112926`
