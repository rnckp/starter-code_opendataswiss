...
- **Keywords.de** `['stzh', 'offentlicher-verkehr', 'tramlinien', 'geoportal', 'tram', 'strassenbahn', 'vektordaten', 'buslinien', 'vbz', 'vbg', 'bus', 'geodaten', 'verkauf', 'postauto', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-15T01:19:04.664038`
