...
- **Keywords.de** `['postauto', 'tram', 'geoportal', 'vbz', 'strassenbahn', 'verkauf', 'punktdaten', 'stzh', 'buslinien', 'tramlinien', 'geodaten', 'vektordaten', 'offentlicher-verkehr', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-02T01:14:24.025968`
