...
- **Keywords.de** `['vektordaten', 'geodaten', 'vbz', 'postauto', 'vbg', 'stzh', 'tram', 'buslinien', 'tramlinien', 'offentlicher-verkehr', 'punktdaten', 'strassenbahn', 'verkauf', 'geoportal', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-03T01:12:42.063083`
