...
- **Keywords.de** `['tramlinien', 'strassenbahn', 'vbz', 'vbg', 'stzh', 'offentlicher-verkehr', 'verkauf', 'tram', 'buslinien', 'geoportal', 'bus', 'vektordaten', 'punktdaten', 'geodaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-08T02:42:37.320261`
