...
- **Keywords.de** `['stzh', 'tramlinien', 'strassenbahn', 'tram', 'verkauf', 'bus', 'geoportal', 'postauto', 'punktdaten', 'vbg', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'geodaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-18T01:20:23.529288`
