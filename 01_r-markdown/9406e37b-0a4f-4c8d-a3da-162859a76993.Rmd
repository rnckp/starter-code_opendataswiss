...
- **Keywords.de** `['bus', 'vektordaten', 'verkauf', 'vbz', 'geoportal', 'buslinien', 'punktdaten', 'offentlicher-verkehr', 'vbg', 'stzh', 'tram', 'strassenbahn', 'postauto', 'geodaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-19T01:33:39.101872`
