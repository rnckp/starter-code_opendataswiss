...
- **Keywords.de** `['stzh', 'geoportal', 'punktdaten', 'bus', 'vbg', 'vektordaten', 'postauto', 'geodaten', 'tram', 'verkauf', 'tramlinien', 'strassenbahn', 'vbz', 'buslinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-23T01:16:38.143325`
