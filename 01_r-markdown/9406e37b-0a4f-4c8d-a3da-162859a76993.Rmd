...
- **Keywords.de** `['offentlicher-verkehr', 'tram', 'strassenbahn', 'verkauf', 'geoportal', 'stzh', 'vektordaten', 'vbz', 'vbg', 'punktdaten', 'geodaten', 'bus', 'buslinien', 'postauto', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-01T01:20:46.883993`
