...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'verkauf', 'geodaten', 'vbg', 'bus', 'geoportal', 'tramlinien', 'tram', 'vektordaten', 'punktdaten', 'vbz', 'strassenbahn', 'postauto', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-01T01:04:15.016994`
