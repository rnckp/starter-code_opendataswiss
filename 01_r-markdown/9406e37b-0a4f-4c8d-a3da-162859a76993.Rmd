...
- **Keywords.de** `['punktdaten', 'strassenbahn', 'offentlicher-verkehr', 'geodaten', 'tram', 'postauto', 'tramlinien', 'vbg', 'vbz', 'buslinien', 'bus', 'vektordaten', 'verkauf', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-31T01:07:17.261072`
