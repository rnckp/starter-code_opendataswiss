...
- **Keywords.de** `['vbg', 'geoportal', 'tramlinien', 'vektordaten', 'offentlicher-verkehr', 'stzh', 'postauto', 'punktdaten', 'bus', 'verkauf', 'strassenbahn', 'vbz', 'tram', 'buslinien', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-16T01:17:05.018764`
