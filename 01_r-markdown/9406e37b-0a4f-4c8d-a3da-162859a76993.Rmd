...
- **Keywords.de** `['postauto', 'buslinien', 'geoportal', 'offentlicher-verkehr', 'verkauf', 'tram', 'strassenbahn', 'vektordaten', 'bus', 'vbg', 'punktdaten', 'geodaten', 'stzh', 'vbz', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-08T01:16:26.506984`
