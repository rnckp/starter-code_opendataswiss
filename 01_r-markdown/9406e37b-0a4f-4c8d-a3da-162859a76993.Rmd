...
- **Keywords.de** `['vektordaten', 'postauto', 'geoportal', 'tram', 'offentlicher-verkehr', 'bus', 'vbg', 'vbz', 'strassenbahn', 'buslinien', 'geodaten', 'stzh', 'tramlinien', 'verkauf', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-22T02:31:21.618551`
