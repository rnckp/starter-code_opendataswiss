...
- **Keywords.de** `['strassenbahn', 'postauto', 'tramlinien', 'bus', 'verkauf', 'tram', 'vektordaten', 'vbg', 'stzh', 'buslinien', 'geoportal', 'vbz', 'punktdaten', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-08T01:35:38.914383`
