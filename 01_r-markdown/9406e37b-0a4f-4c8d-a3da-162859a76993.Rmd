...
- **Keywords.de** `['punktdaten', 'offentlicher-verkehr', 'geoportal', 'tram', 'postauto', 'verkauf', 'vbg', 'geodaten', 'tramlinien', 'stzh', 'strassenbahn', 'vektordaten', 'vbz', 'bus', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-06T01:28:09.207645`
