...
- **Keywords.de** `['geoportal', 'punktdaten', 'postauto', 'vektordaten', 'strassenbahn', 'stzh', 'vbg', 'buslinien', 'bus', 'offentlicher-verkehr', 'vbz', 'tram', 'verkauf', 'geodaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-13T01:22:45.363202`
