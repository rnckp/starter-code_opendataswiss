...
- **Keywords.de** `['tramlinien', 'vbz', 'vektordaten', 'punktdaten', 'offentlicher-verkehr', 'stzh', 'tram', 'strassenbahn', 'postauto', 'geodaten', 'buslinien', 'vbg', 'geoportal', 'verkauf', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-26T01:16:20.724885`
