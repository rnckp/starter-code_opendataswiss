...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'verkauf', 'stzh', 'tramlinien', 'postauto', 'geoportal', 'bus', 'punktdaten', 'buslinien', 'strassenbahn', 'vbz', 'vbg', 'geodaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-06T01:12:38.933315`
