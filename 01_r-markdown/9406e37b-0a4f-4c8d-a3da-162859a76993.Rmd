...
- **Keywords.de** `['geoportal', 'vbg', 'buslinien', 'tram', 'punktdaten', 'offentlicher-verkehr', 'stzh', 'postauto', 'tramlinien', 'strassenbahn', 'vektordaten', 'geodaten', 'bus', 'verkauf', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-17T01:14:55.091300`
