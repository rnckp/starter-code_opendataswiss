...
- **Keywords.de** `['geoportal', 'buslinien', 'verkauf', 'vbg', 'vbz', 'stzh', 'bus', 'postauto', 'tram', 'offentlicher-verkehr', 'vektordaten', 'punktdaten', 'geodaten', 'tramlinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-17T01:11:37.220744`
