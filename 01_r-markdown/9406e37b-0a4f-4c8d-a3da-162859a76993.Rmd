...
- **Keywords.de** `['stzh', 'tram', 'strassenbahn', 'verkauf', 'vbz', 'bus', 'geodaten', 'punktdaten', 'vektordaten', 'postauto', 'buslinien', 'tramlinien', 'geoportal', 'offentlicher-verkehr', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-26T01:15:56.331576`
