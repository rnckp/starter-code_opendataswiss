...
- **Keywords.de** `['punktdaten', 'bus', 'strassenbahn', 'tram', 'buslinien', 'verkauf', 'offentlicher-verkehr', 'stzh', 'vbz', 'geoportal', 'vbg', 'postauto', 'geodaten', 'vektordaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-13T00:54:06.712552`
