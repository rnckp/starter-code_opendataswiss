...
- **Keywords.de** `['vbz', 'vbg', 'postauto', 'geodaten', 'punktdaten', 'tramlinien', 'buslinien', 'stzh', 'geoportal', 'vektordaten', 'strassenbahn', 'bus', 'tram', 'offentlicher-verkehr', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-03T01:59:29.118238`
