...
- **Keywords.de** `['tram', 'postauto', 'vektordaten', 'verkauf', 'offentlicher-verkehr', 'vbg', 'tramlinien', 'punktdaten', 'stzh', 'strassenbahn', 'vbz', 'bus', 'geodaten', 'geoportal', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-31T02:39:17.266359`
