...
- **Keywords.de** `['tramlinien', 'buslinien', 'vbz', 'geoportal', 'stzh', 'strassenbahn', 'punktdaten', 'tram', 'geodaten', 'vektordaten', 'postauto', 'offentlicher-verkehr', 'verkauf', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-16T01:27:16.695041`
