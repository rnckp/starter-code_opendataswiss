...
- **Keywords.de** `['postauto', 'verkauf', 'vbz', 'vektordaten', 'stzh', 'tramlinien', 'geoportal', 'punktdaten', 'offentlicher-verkehr', 'bus', 'strassenbahn', 'vbg', 'tram', 'geodaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-16T01:14:29.778100`
