...
- **Keywords.de** `['geodaten', 'vektordaten', 'vbg', 'tram', 'offentlicher-verkehr', 'punktdaten', 'strassenbahn', 'vbz', 'buslinien', 'tramlinien', 'postauto', 'geoportal', 'verkauf', 'bus', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-27T01:25:52.432861`
