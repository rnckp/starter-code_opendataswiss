...
- **Keywords.de** `['verkauf', 'geodaten', 'vbg', 'vektordaten', 'buslinien', 'stzh', 'geoportal', 'bus', 'tramlinien', 'punktdaten', 'strassenbahn', 'tram', 'offentlicher-verkehr', 'postauto', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-11T01:30:44.286591`
