...
- **Keywords.de** `['stzh', 'postauto', 'geoportal', 'bus', 'tram', 'punktdaten', 'strassenbahn', 'vbg', 'tramlinien', 'vektordaten', 'vbz', 'buslinien', 'verkauf', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-23T00:53:32.626877`
