...
- **Keywords.de** `['vbg', 'strassenbahn', 'geoportal', 'vektordaten', 'geodaten', 'buslinien', 'verkauf', 'bus', 'punktdaten', 'tramlinien', 'tram', 'stzh', 'vbz', 'postauto', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-30T01:30:11.988538`
