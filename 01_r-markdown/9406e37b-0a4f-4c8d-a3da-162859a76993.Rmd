...
- **Keywords.de** `['vektordaten', 'stzh', 'verkauf', 'offentlicher-verkehr', 'tramlinien', 'buslinien', 'punktdaten', 'tram', 'strassenbahn', 'geoportal', 'geodaten', 'bus', 'postauto', 'vbz', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-10T01:10:14.325598`
