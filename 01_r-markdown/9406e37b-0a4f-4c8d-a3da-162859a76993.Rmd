...
- **Keywords.de** `['tram', 'postauto', 'geodaten', 'tramlinien', 'bus', 'geoportal', 'verkauf', 'stzh', 'offentlicher-verkehr', 'vektordaten', 'strassenbahn', 'vbz', 'buslinien', 'vbg', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-24T01:39:07.183412`
