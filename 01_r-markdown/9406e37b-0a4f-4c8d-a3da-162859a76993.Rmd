...
- **Keywords.de** `['verkauf', 'stzh', 'vbg', 'buslinien', 'punktdaten', 'strassenbahn', 'postauto', 'bus', 'tramlinien', 'geoportal', 'geodaten', 'offentlicher-verkehr', 'vektordaten', 'tram', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-23T01:11:41.475784`
