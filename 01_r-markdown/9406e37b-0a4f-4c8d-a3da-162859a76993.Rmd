...
- **Keywords.de** `['punktdaten', 'offentlicher-verkehr', 'tramlinien', 'geoportal', 'postauto', 'geodaten', 'bus', 'vektordaten', 'vbz', 'strassenbahn', 'verkauf', 'tram', 'buslinien', 'vbg', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-29T01:15:20.128851`
