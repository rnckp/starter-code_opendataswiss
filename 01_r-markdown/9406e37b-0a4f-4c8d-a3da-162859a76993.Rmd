...
- **Keywords.de** `['bus', 'geodaten', 'vbg', 'tram', 'verkauf', 'vektordaten', 'geoportal', 'buslinien', 'tramlinien', 'postauto', 'punktdaten', 'vbz', 'stzh', 'strassenbahn', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-04T01:14:20.057805`
