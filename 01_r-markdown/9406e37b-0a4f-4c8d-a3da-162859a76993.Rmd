...
- **Keywords.de** `['buslinien', 'tram', 'vektordaten', 'geoportal', 'vbz', 'geodaten', 'strassenbahn', 'punktdaten', 'stzh', 'offentlicher-verkehr', 'tramlinien', 'verkauf', 'vbg', 'bus', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-30T01:20:14.099887`
