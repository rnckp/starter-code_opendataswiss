...
- **Keywords.de** `['vbz', 'punktdaten', 'tramlinien', 'vbg', 'tram', 'offentlicher-verkehr', 'postauto', 'stzh', 'bus', 'buslinien', 'strassenbahn', 'vektordaten', 'geodaten', 'geoportal', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-26T01:17:56.041017`
