...
- **Keywords.de** `['vbg', 'strassenbahn', 'postauto', 'punktdaten', 'stzh', 'tramlinien', 'buslinien', 'vektordaten', 'verkauf', 'geoportal', 'tram', 'vbz', 'offentlicher-verkehr', 'geodaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-29T02:07:14.724918`
