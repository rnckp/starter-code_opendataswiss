...
- **Keywords.de** `['geodaten', 'bus', 'vektordaten', 'geoportal', 'verkauf', 'vbz', 'postauto', 'vbg', 'strassenbahn', 'buslinien', 'tramlinien', 'punktdaten', 'tram', 'stzh', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-24T00:52:30.005448`
