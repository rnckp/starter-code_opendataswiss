...
- **Keywords.de** `['vbg', 'geoportal', 'stzh', 'strassenbahn', 'tram', 'punktdaten', 'vektordaten', 'postauto', 'vbz', 'tramlinien', 'bus', 'buslinien', 'verkauf', 'geodaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-01T01:06:34.403180`
