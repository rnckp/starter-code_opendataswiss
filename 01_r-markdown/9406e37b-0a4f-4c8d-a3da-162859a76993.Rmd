...
- **Keywords.de** `['stzh', 'geodaten', 'bus', 'geoportal', 'postauto', 'tram', 'vbg', 'punktdaten', 'vbz', 'strassenbahn', 'buslinien', 'tramlinien', 'verkauf', 'vektordaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-24T01:43:34.494100`
