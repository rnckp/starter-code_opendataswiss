...
- **Keywords.de** `['tramlinien', 'geodaten', 'verkauf', 'tram', 'punktdaten', 'vektordaten', 'strassenbahn', 'stzh', 'bus', 'postauto', 'vbz', 'geoportal', 'offentlicher-verkehr', 'vbg', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-02-20T01:21:28.515797`
