...
- **Keywords.de** `['vbz', 'punktdaten', 'verkauf', 'geodaten', 'vektordaten', 'postauto', 'bus', 'buslinien', 'tramlinien', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'tram', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-20T01:27:32.989936`
