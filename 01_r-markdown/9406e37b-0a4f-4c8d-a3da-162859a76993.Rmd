...
- **Keywords.de** `['strassenbahn', 'tram', 'buslinien', 'stzh', 'offentlicher-verkehr', 'verkauf', 'postauto', 'geodaten', 'tramlinien', 'geoportal', 'bus', 'vbz', 'vektordaten', 'punktdaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-25T01:20:16.277801`
