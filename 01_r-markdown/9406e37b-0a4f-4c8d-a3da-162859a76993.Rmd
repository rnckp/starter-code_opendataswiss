...
- **Keywords.de** `['vbg', 'tramlinien', 'geoportal', 'vbz', 'offentlicher-verkehr', 'stzh', 'postauto', 'bus', 'geodaten', 'buslinien', 'verkauf', 'punktdaten', 'tram', 'vektordaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-06-11T01:29:09.813676`
