...
- **Keywords.de** `['strassenbahn', 'stzh', 'verkauf', 'offentlicher-verkehr', 'tram', 'geoportal', 'bus', 'postauto', 'geodaten', 'vbg', 'vektordaten', 'buslinien', 'tramlinien', 'vbz', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-11T01:23:43.766414`
