...
- **Keywords.de** `['bus', 'vektordaten', 'punktdaten', 'stzh', 'buslinien', 'strassenbahn', 'geodaten', 'geoportal', 'offentlicher-verkehr', 'vbz', 'tram', 'verkauf', 'tramlinien', 'vbg', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-12T01:06:31.753720`
