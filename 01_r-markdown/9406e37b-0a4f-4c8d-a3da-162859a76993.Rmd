...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'geoportal', 'bus', 'buslinien', 'tramlinien', 'vbz', 'strassenbahn', 'vbg', 'verkauf', 'tram', 'punktdaten', 'postauto', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-10T01:35:30.380300`
