...
- **Keywords.de** `['bus', 'vbg', 'verkauf', 'geoportal', 'vbz', 'tram', 'offentlicher-verkehr', 'buslinien', 'punktdaten', 'postauto', 'strassenbahn', 'tramlinien', 'stzh', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-13T01:18:46.227978`
