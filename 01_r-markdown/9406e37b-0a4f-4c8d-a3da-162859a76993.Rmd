...
- **Keywords.de** `['offentlicher-verkehr', 'verkauf', 'geodaten', 'geoportal', 'bus', 'tramlinien', 'strassenbahn', 'postauto', 'punktdaten', 'stzh', 'vbg', 'vektordaten', 'tram', 'buslinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-20T01:10:32.716064`
