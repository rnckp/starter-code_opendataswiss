...
- **Keywords.de** `['vektordaten', 'strassenbahn', 'verkauf', 'tram', 'vbz', 'offentlicher-verkehr', 'postauto', 'vbg', 'tramlinien', 'stzh', 'punktdaten', 'buslinien', 'geoportal', 'geodaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-08-21T01:11:02.051388`
