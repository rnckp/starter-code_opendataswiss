...
- **Keywords.de** `['punktdaten', 'bus', 'offentlicher-verkehr', 'postauto', 'geodaten', 'vbg', 'buslinien', 'vbz', 'tramlinien', 'vektordaten', 'strassenbahn', 'geoportal', 'verkauf', 'tram', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-13T01:04:12.667303`
