...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'strassenbahn', 'tramlinien', 'bus', 'buslinien', 'tram', 'stzh', 'geoportal', 'punktdaten', 'verkauf', 'vbz', 'vbg', 'postauto', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-12T01:24:29.252471`
