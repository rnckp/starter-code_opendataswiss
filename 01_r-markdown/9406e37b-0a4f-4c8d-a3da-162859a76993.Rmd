...
- **Keywords.de** `['geoportal', 'buslinien', 'tram', 'bus', 'geodaten', 'offentlicher-verkehr', 'vbg', 'punktdaten', 'vektordaten', 'vbz', 'stzh', 'tramlinien', 'strassenbahn', 'verkauf', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-26T01:12:43.645225`
