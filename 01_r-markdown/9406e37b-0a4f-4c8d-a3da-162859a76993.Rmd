...
- **Keywords.de** `['buslinien', 'tramlinien', 'vbg', 'geoportal', 'punktdaten', 'vektordaten', 'stzh', 'verkauf', 'offentlicher-verkehr', 'bus', 'tram', 'strassenbahn', 'geodaten', 'postauto', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-11-03T02:32:03.637505`
