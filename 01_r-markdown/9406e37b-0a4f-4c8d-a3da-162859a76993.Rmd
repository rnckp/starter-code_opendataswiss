...
- **Keywords.de** `['bus', 'postauto', 'verkauf', 'buslinien', 'strassenbahn', 'geodaten', 'tram', 'geoportal', 'punktdaten', 'tramlinien', 'vbz', 'vektordaten', 'vbg', 'stzh', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-20T01:10:09.433810`
