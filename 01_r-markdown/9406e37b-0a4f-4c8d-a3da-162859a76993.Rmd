...
- **Keywords.de** `['vbg', 'postauto', 'vektordaten', 'geoportal', 'bus', 'geodaten', 'punktdaten', 'stzh', 'strassenbahn', 'vbz', 'tramlinien', 'tram', 'offentlicher-verkehr', 'verkauf', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-22T01:23:05.154467`
