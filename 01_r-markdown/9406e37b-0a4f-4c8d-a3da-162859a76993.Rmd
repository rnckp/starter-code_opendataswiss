...
- **Keywords.de** `['vbg', 'geoportal', 'bus', 'buslinien', 'offentlicher-verkehr', 'vektordaten', 'tramlinien', 'punktdaten', 'geodaten', 'tram', 'verkauf', 'vbz', 'stzh', 'postauto', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-31T01:21:06.934049`
