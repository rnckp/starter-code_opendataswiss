...
- **Keywords.de** `['offentlicher-verkehr', 'geodaten', 'tram', 'postauto', 'vbz', 'stzh', 'geoportal', 'tramlinien', 'buslinien', 'bus', 'vbg', 'strassenbahn', 'verkauf', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-07-25T01:36:06.566935`
