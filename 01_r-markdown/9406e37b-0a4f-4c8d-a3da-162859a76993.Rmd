...
- **Keywords.de** `['geoportal', 'geodaten', 'bus', 'offentlicher-verkehr', 'vbg', 'vektordaten', 'strassenbahn', 'tram', 'verkauf', 'punktdaten', 'buslinien', 'stzh', 'vbz', 'postauto', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-01-18T01:00:55.434336`
