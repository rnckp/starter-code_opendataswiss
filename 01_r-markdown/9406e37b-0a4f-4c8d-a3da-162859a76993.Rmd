...
- **Keywords.de** `['bus', 'tramlinien', 'vbg', 'punktdaten', 'geoportal', 'postauto', 'vektordaten', 'geodaten', 'verkauf', 'vbz', 'stzh', 'strassenbahn', 'tram', 'offentlicher-verkehr', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-24T01:49:34.631767`
