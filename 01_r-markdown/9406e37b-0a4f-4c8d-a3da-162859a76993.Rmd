...
- **Keywords.de** `['strassenbahn', 'verkauf', 'geodaten', 'vektordaten', 'stzh', 'punktdaten', 'offentlicher-verkehr', 'tram', 'vbg', 'postauto', 'vbz', 'tramlinien', 'geoportal', 'bus', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-01T01:12:30.315383`
