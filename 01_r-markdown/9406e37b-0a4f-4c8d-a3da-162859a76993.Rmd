...
- **Keywords.de** `['verkauf', 'geodaten', 'bus', 'buslinien', 'geoportal', 'postauto', 'tram', 'tramlinien', 'strassenbahn', 'stzh', 'vektordaten', 'vbg', 'vbz', 'punktdaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-10-08T01:17:51.559764`
