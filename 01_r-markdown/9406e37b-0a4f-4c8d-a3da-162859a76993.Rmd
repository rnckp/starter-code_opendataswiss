...
- **Keywords.de** `['geodaten', 'buslinien', 'tramlinien', 'punktdaten', 'vbg', 'vektordaten', 'postauto', 'offentlicher-verkehr', 'strassenbahn', 'stzh', 'tram', 'bus', 'vbz', 'verkauf', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-05-27T01:16:13.013386`
