...
- **Keywords.de** `['verkauf', 'punktdaten', 'bus', 'tram', 'tramlinien', 'vbz', 'vbg', 'buslinien', 'postauto', 'stzh', 'offentlicher-verkehr', 'vektordaten', 'geoportal', 'strassenbahn', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-15T01:23:43.274245`
