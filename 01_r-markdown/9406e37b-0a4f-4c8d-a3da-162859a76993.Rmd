...
- **Keywords.de** `['postauto', 'tramlinien', 'vektordaten', 'strassenbahn', 'buslinien', 'punktdaten', 'offentlicher-verkehr', 'vbg', 'geodaten', 'verkauf', 'stzh', 'geoportal', 'vbz', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-03-07T01:02:19.902755`
