...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'buslinien', 'geoportal', 'geodaten', 'tramlinien', 'tram', 'postauto', 'strassenbahn', 'verkauf', 'stzh', 'bus', 'vbg', 'vbz', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-06T01:33:25.242802`
