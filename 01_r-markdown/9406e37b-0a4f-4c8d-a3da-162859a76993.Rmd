...
- **Keywords.de** `['punktdaten', 'postauto', 'vbg', 'vbz', 'vektordaten', 'tram', 'geoportal', 'bus', 'stzh', 'verkauf', 'strassenbahn', 'buslinien', 'offentlicher-verkehr', 'geodaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-09-04T01:35:20.665776`
