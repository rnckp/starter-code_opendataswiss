...
- **Keywords.de** `['tram', 'geodaten', 'postauto', 'vektordaten', 'verkauf', 'strassenbahn', 'tramlinien', 'vbg', 'punktdaten', 'bus', 'stzh', 'vbz', 'offentlicher-verkehr', 'geoportal', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:33.726075`
- **Metadata_modified** `2023-04-09T01:14:10.374814`
