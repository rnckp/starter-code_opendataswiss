...
- **Keywords.de** `['abstimmungsgerat', 'tabelle', 'abstimmungen', 'sachdaten', 'nutzung', 'stzh', 'punktdaten', 'bedurfnisse', 'stimmungsbilder', 'geoportal', 'einzeldaten', 'geodaten', 'bevolkerung', 'lora', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-12T03:07:42.352773`
