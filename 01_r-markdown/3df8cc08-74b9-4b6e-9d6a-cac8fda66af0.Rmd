...
- **Keywords.de** `['stzh', 'abstimmungsgerat', 'punktdaten', 'zufriedenheit', 'bedurfnisse', 'geodaten', 'tabelle', 'einzeldaten', 'lora', 'geoportal', 'sachdaten', 'stimmungsbilder', 'nutzung', 'bevolkerung', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-01T08:48:56.520572`
