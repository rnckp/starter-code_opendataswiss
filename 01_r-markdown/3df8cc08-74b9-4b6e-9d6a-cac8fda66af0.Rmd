...
- **Keywords.de** `['geoportal', 'bevolkerung', 'abstimmungsgerat', 'abstimmungen', 'tabelle', 'nutzung', 'lora', 'bedurfnisse', 'zufriedenheit', 'einzeldaten', 'sachdaten', 'stimmungsbilder', 'geodaten', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-02T02:39:54.715674`
