...
- **Keywords.de** `['lora', 'sachdaten', 'stimmungsbilder', 'abstimmungsgerat', 'nutzung', 'stzh', 'bedurfnisse', 'geoportal', 'bevolkerung', 'punktdaten', 'einzeldaten', 'geodaten', 'tabelle', 'abstimmungen', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-15T02:55:28.946347`
