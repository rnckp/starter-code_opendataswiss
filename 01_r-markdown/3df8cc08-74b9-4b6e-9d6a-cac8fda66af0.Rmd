...
- **Keywords.de** `['tabelle', 'nutzung', 'einzeldaten', 'stimmungsbilder', 'geoportal', 'bedurfnisse', 'lora', 'zufriedenheit', 'bevolkerung', 'geodaten', 'stzh', 'sachdaten', 'abstimmungen', 'punktdaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-12T03:13:26.442428`
