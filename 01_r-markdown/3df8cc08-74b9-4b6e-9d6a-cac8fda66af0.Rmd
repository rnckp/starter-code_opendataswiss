...
- **Keywords.de** `['geodaten', 'stzh', 'punktdaten', 'lora', 'geoportal', 'sachdaten', 'tabelle', 'zufriedenheit', 'stimmungsbilder', 'bevolkerung', 'bedurfnisse', 'nutzung', 'abstimmungsgerat', 'abstimmungen', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-03T08:09:57.959050`
