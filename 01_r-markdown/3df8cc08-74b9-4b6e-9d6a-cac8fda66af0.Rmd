...
- **Keywords.de** `['stzh', 'bevolkerung', 'lora', 'geoportal', 'bedurfnisse', 'zufriedenheit', 'tabelle', 'sachdaten', 'abstimmungen', 'abstimmungsgerat', 'einzeldaten', 'nutzung', 'stimmungsbilder', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-21T03:15:18.029978`
