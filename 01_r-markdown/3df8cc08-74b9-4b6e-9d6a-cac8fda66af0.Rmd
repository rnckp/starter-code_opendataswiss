...
- **Keywords.de** `['zufriedenheit', 'einzeldaten', 'punktdaten', 'abstimmungsgerat', 'stzh', 'tabelle', 'bevolkerung', 'sachdaten', 'abstimmungen', 'geoportal', 'stimmungsbilder', 'bedurfnisse', 'lora', 'geodaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-02T03:03:42.173109`
