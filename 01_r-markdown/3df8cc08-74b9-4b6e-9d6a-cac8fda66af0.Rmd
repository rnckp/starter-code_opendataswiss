...
- **Keywords.de** `['bevolkerung', 'geodaten', 'sachdaten', 'punktdaten', 'lora', 'stzh', 'nutzung', 'stimmungsbilder', 'zufriedenheit', 'bedurfnisse', 'einzeldaten', 'abstimmungen', 'tabelle', 'abstimmungsgerat', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-17T02:17:28.818526`
