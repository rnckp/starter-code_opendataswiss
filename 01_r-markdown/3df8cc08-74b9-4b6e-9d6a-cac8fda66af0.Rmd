...
- **Keywords.de** `['stzh', 'geodaten', 'einzeldaten', 'bedurfnisse', 'lora', 'abstimmungen', 'nutzung', 'tabelle', 'bevolkerung', 'abstimmungsgerat', 'geoportal', 'zufriedenheit', 'stimmungsbilder', 'sachdaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-04T03:54:02.755952`
