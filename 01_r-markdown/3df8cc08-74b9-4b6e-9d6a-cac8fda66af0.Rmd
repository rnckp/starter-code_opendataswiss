...
- **Keywords.de** `['lora', 'stzh', 'zufriedenheit', 'geoportal', 'punktdaten', 'bevolkerung', 'nutzung', 'sachdaten', 'tabelle', 'abstimmungen', 'geodaten', 'einzeldaten', 'stimmungsbilder', 'abstimmungsgerat', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-08T03:28:21.340001`
