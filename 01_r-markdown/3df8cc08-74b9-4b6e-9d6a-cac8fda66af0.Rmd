...
- **Keywords.de** `['bedurfnisse', 'nutzung', 'punktdaten', 'tabelle', 'zufriedenheit', 'stzh', 'geodaten', 'lora', 'sachdaten', 'abstimmungen', 'bevolkerung', 'geoportal', 'stimmungsbilder', 'abstimmungsgerat', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-04T04:04:24.312413`
