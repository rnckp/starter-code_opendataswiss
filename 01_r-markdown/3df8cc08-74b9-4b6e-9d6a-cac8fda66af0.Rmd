...
- **Keywords.de** `['stzh', 'tabelle', 'abstimmungsgerat', 'bevolkerung', 'einzeldaten', 'geodaten', 'stimmungsbilder', 'abstimmungen', 'geoportal', 'punktdaten', 'nutzung', 'bedurfnisse', 'zufriedenheit', 'sachdaten', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-15T02:49:41.760572`
