...
- **Keywords.de** `['abstimmungsgerat', 'einzeldaten', 'abstimmungen', 'stimmungsbilder', 'zufriedenheit', 'bedurfnisse', 'stzh', 'lora', 'tabelle', 'punktdaten', 'nutzung', 'geoportal', 'bevolkerung', 'geodaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-03T04:03:55.243731`
