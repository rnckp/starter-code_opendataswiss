...
- **Keywords.de** `['bedurfnisse', 'geodaten', 'stimmungsbilder', 'punktdaten', 'sachdaten', 'zufriedenheit', 'nutzung', 'tabelle', 'einzeldaten', 'geoportal', 'abstimmungsgerat', 'abstimmungen', 'lora', 'bevolkerung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-08T03:34:38.065068`
