...
- **Keywords.de** `['stzh', 'abstimmungsgerat', 'sachdaten', 'tabelle', 'zufriedenheit', 'abstimmungen', 'punktdaten', 'bevolkerung', 'einzeldaten', 'stimmungsbilder', 'geoportal', 'geodaten', 'nutzung', 'lora', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-20T04:53:33.993360`
