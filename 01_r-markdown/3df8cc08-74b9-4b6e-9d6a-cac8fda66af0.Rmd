...
- **Keywords.de** `['bedurfnisse', 'nutzung', 'bevolkerung', 'einzeldaten', 'sachdaten', 'punktdaten', 'stimmungsbilder', 'tabelle', 'geoportal', 'stzh', 'abstimmungen', 'abstimmungsgerat', 'lora', 'zufriedenheit', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-30T03:21:00.050972`
