...
- **Keywords.de** `['stzh', 'einzeldaten', 'lora', 'nutzung', 'punktdaten', 'bedurfnisse', 'abstimmungsgerat', 'zufriedenheit', 'sachdaten', 'geoportal', 'bevolkerung', 'tabelle', 'stimmungsbilder', 'abstimmungen', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-04T03:28:23.313257`
