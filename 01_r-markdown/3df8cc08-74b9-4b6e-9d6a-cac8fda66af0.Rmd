...
- **Keywords.de** `['punktdaten', 'nutzung', 'bedurfnisse', 'lora', 'abstimmungen', 'bevolkerung', 'tabelle', 'abstimmungsgerat', 'einzeldaten', 'geodaten', 'geoportal', 'stzh', 'sachdaten', 'zufriedenheit', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-21T03:21:12.770420`
