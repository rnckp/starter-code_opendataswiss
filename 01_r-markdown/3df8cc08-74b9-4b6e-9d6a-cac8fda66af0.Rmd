...
- **Keywords.de** `['punktdaten', 'nutzung', 'tabelle', 'einzeldaten', 'bedurfnisse', 'abstimmungen', 'abstimmungsgerat', 'bevolkerung', 'stzh', 'stimmungsbilder', 'zufriedenheit', 'sachdaten', 'lora', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-07T03:24:39.260005`
