...
- **Keywords.de** `['zufriedenheit', 'geodaten', 'bevolkerung', 'einzeldaten', 'bedurfnisse', 'stzh', 'stimmungsbilder', 'lora', 'abstimmungen', 'geoportal', 'punktdaten', 'nutzung', 'tabelle', 'sachdaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-13T04:01:46.155811`
