...
- **Keywords.de** `['sachdaten', 'stimmungsbilder', 'geoportal', 'abstimmungsgerat', 'einzeldaten', 'lora', 'bedurfnisse', 'bevolkerung', 'punktdaten', 'nutzung', 'stzh', 'zufriedenheit', 'abstimmungen', 'geodaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-04T07:01:29.779376`
