...
- **Keywords.de** `['abstimmungsgerat', 'stimmungsbilder', 'bedurfnisse', 'geodaten', 'zufriedenheit', 'sachdaten', 'nutzung', 'lora', 'punktdaten', 'bevolkerung', 'tabelle', 'einzeldaten', 'abstimmungen', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-15T03:02:06.472869`
