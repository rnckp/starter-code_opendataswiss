...
- **Keywords.de** `['einzeldaten', 'punktdaten', 'bedurfnisse', 'geoportal', 'nutzung', 'stzh', 'tabelle', 'abstimmungsgerat', 'geodaten', 'zufriedenheit', 'stimmungsbilder', 'bevolkerung', 'lora', 'abstimmungen', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-02T03:06:03.799445`
