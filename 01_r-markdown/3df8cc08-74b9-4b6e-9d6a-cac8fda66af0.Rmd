...
- **Keywords.de** `['einzeldaten', 'punktdaten', 'geodaten', 'bedurfnisse', 'nutzung', 'stimmungsbilder', 'geoportal', 'bevolkerung', 'abstimmungen', 'stzh', 'zufriedenheit', 'sachdaten', 'abstimmungsgerat', 'tabelle', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-28T03:28:55.134029`
