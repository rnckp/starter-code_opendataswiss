...
- **Keywords.de** `['zufriedenheit', 'sachdaten', 'bevolkerung', 'nutzung', 'abstimmungsgerat', 'bedurfnisse', 'abstimmungen', 'einzeldaten', 'punktdaten', 'tabelle', 'geodaten', 'geoportal', 'lora', 'stimmungsbilder', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-01T03:05:04.944386`
