...
- **Keywords.de** `['einzeldaten', 'geoportal', 'abstimmungen', 'lora', 'zufriedenheit', 'bedurfnisse', 'punktdaten', 'sachdaten', 'abstimmungsgerat', 'nutzung', 'stzh', 'bevolkerung', 'stimmungsbilder', 'tabelle', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-05T03:22:02.942131`
