...
- **Keywords.de** `['einzeldaten', 'punktdaten', 'bedurfnisse', 'nutzung', 'bevolkerung', 'tabelle', 'geoportal', 'stimmungsbilder', 'abstimmungen', 'sachdaten', 'lora', 'zufriedenheit', 'stzh', 'geodaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-25T03:08:48.858011`
