...
- **Keywords.de** `['bedurfnisse', 'geoportal', 'nutzung', 'geodaten', 'zufriedenheit', 'tabelle', 'punktdaten', 'sachdaten', 'abstimmungen', 'lora', 'abstimmungsgerat', 'stimmungsbilder', 'einzeldaten', 'stzh', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-20T02:55:32.166165`
