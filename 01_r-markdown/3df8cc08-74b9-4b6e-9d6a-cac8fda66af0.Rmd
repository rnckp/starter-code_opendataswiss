...
- **Keywords.de** `['sachdaten', 'lora', 'bevolkerung', 'stimmungsbilder', 'einzeldaten', 'geoportal', 'abstimmungsgerat', 'geodaten', 'bedurfnisse', 'punktdaten', 'stzh', 'tabelle', 'nutzung', 'abstimmungen', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-28T02:45:41.532757`
