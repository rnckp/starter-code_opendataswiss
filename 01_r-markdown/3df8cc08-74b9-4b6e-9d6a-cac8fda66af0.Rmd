...
- **Keywords.de** `['bevolkerung', 'sachdaten', 'einzeldaten', 'geodaten', 'lora', 'stimmungsbilder', 'zufriedenheit', 'tabelle', 'abstimmungen', 'geoportal', 'stzh', 'punktdaten', 'nutzung', 'abstimmungsgerat', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-08T03:39:15.750843`
