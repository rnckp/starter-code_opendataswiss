...
- **Keywords.de** `['lora', 'sachdaten', 'einzeldaten', 'stimmungsbilder', 'abstimmungen', 'geoportal', 'bevolkerung', 'nutzung', 'stzh', 'bedurfnisse', 'zufriedenheit', 'tabelle', 'geodaten', 'punktdaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-08T03:04:38.971084`
