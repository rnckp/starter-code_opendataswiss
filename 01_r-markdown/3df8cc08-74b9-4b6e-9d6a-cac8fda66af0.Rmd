...
- **Keywords.de** `['abstimmungen', 'sachdaten', 'bevolkerung', 'lora', 'nutzung', 'zufriedenheit', 'bedurfnisse', 'stzh', 'geodaten', 'punktdaten', 'einzeldaten', 'geoportal', 'abstimmungsgerat', 'stimmungsbilder', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-07T02:45:43.935689`
