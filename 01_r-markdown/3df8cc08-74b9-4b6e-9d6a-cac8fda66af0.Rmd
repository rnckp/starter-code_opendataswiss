...
- **Keywords.de** `['abstimmungen', 'tabelle', 'einzeldaten', 'bevolkerung', 'geodaten', 'punktdaten', 'stimmungsbilder', 'stzh', 'abstimmungsgerat', 'nutzung', 'lora', 'geoportal', 'bedurfnisse', 'sachdaten', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-06T03:10:24.562342`
