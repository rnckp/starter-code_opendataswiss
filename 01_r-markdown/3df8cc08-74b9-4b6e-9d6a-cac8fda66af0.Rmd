...
- **Keywords.de** `['abstimmungen', 'geodaten', 'einzeldaten', 'zufriedenheit', 'stzh', 'bevolkerung', 'lora', 'geoportal', 'punktdaten', 'abstimmungsgerat', 'bedurfnisse', 'stimmungsbilder', 'sachdaten', 'tabelle', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-15T05:08:44.248421`
