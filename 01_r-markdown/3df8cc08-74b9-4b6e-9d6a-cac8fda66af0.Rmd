...
- **Keywords.de** `['bevolkerung', 'geodaten', 'bedurfnisse', 'tabelle', 'geoportal', 'lora', 'zufriedenheit', 'sachdaten', 'stimmungsbilder', 'nutzung', 'einzeldaten', 'punktdaten', 'stzh', 'abstimmungen', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-29T02:39:35.390591`
