...
- **Keywords.de** `['einzeldaten', 'bevolkerung', 'sachdaten', 'stimmungsbilder', 'abstimmungsgerat', 'stzh', 'nutzung', 'bedurfnisse', 'lora', 'tabelle', 'punktdaten', 'geodaten', 'abstimmungen', 'zufriedenheit', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-23T03:27:16.926945`
