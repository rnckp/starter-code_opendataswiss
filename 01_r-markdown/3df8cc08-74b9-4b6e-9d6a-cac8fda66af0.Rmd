...
- **Keywords.de** `['geodaten', 'einzeldaten', 'abstimmungen', 'punktdaten', 'lora', 'bedurfnisse', 'sachdaten', 'stimmungsbilder', 'zufriedenheit', 'abstimmungsgerat', 'geoportal', 'nutzung', 'bevolkerung', 'tabelle', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-15T03:33:00.784338`
