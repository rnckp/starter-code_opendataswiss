...
- **Keywords.de** `['sachdaten', 'abstimmungen', 'geoportal', 'stzh', 'zufriedenheit', 'abstimmungsgerat', 'geodaten', 'punktdaten', 'tabelle', 'lora', 'bedurfnisse', 'bevolkerung', 'einzeldaten', 'nutzung', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-23T03:04:53.369782`
