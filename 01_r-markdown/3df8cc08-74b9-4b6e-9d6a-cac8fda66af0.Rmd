...
- **Keywords.de** `['sachdaten', 'nutzung', 'abstimmungsgerat', 'tabelle', 'bedurfnisse', 'punktdaten', 'stimmungsbilder', 'zufriedenheit', 'bevolkerung', 'stzh', 'lora', 'einzeldaten', 'geoportal', 'abstimmungen', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-17T02:26:35.052213`
