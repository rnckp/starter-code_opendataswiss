...
- **Keywords.de** `['zufriedenheit', 'punktdaten', 'nutzung', 'bevolkerung', 'stzh', 'bedurfnisse', 'abstimmungen', 'stimmungsbilder', 'einzeldaten', 'sachdaten', 'geoportal', 'lora', 'tabelle', 'geodaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-11T03:33:15.377173`
