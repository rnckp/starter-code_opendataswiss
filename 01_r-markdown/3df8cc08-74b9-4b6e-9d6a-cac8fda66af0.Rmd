...
- **Keywords.de** `['nutzung', 'stzh', 'punktdaten', 'geodaten', 'abstimmungen', 'bevolkerung', 'tabelle', 'geoportal', 'sachdaten', 'stimmungsbilder', 'lora', 'bedurfnisse', 'abstimmungsgerat', 'zufriedenheit', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-11T03:12:05.994538`
