...
- **Keywords.de** `['stimmungsbilder', 'punktdaten', 'sachdaten', 'bevolkerung', 'geoportal', 'einzeldaten', 'tabelle', 'stzh', 'bedurfnisse', 'lora', 'abstimmungsgerat', 'nutzung', 'abstimmungen', 'geodaten', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-30T03:15:04.234380`
