...
- **Keywords.de** `['abstimmungen', 'nutzung', 'zufriedenheit', 'tabelle', 'bedurfnisse', 'lora', 'abstimmungsgerat', 'bevolkerung', 'geodaten', 'sachdaten', 'stimmungsbilder', 'stzh', 'geoportal', 'punktdaten', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-15T02:56:24.093146`
