...
- **Keywords.de** `['stimmungsbilder', 'einzeldaten', 'bevolkerung', 'abstimmungsgerat', 'zufriedenheit', 'geoportal', 'stzh', 'tabelle', 'bedurfnisse', 'nutzung', 'punktdaten', 'sachdaten', 'lora', 'abstimmungen', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-08T02:50:06.270581`
