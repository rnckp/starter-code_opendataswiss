...
- **Keywords.de** `['sachdaten', 'bedurfnisse', 'nutzung', 'geoportal', 'einzeldaten', 'stimmungsbilder', 'punktdaten', 'stzh', 'abstimmungsgerat', 'abstimmungen', 'lora', 'zufriedenheit', 'geodaten', 'bevolkerung', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-06T03:22:31.700799`
