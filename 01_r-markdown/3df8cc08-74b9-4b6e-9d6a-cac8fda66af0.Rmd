...
- **Keywords.de** `['sachdaten', 'geodaten', 'geoportal', 'bevolkerung', 'zufriedenheit', 'abstimmungsgerat', 'tabelle', 'stzh', 'abstimmungen', 'nutzung', 'bedurfnisse', 'einzeldaten', 'punktdaten', 'stimmungsbilder', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-21T03:59:23.974317`
