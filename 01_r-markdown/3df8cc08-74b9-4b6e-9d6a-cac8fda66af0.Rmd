...
- **Keywords.de** `['abstimmungen', 'punktdaten', 'lora', 'bevolkerung', 'tabelle', 'nutzung', 'geoportal', 'zufriedenheit', 'abstimmungsgerat', 'geodaten', 'bedurfnisse', 'stzh', 'einzeldaten', 'sachdaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-26T03:45:45.874821`
