...
- **Keywords.de** `['abstimmungsgerat', 'abstimmungen', 'geodaten', 'zufriedenheit', 'sachdaten', 'bedurfnisse', 'tabelle', 'lora', 'stzh', 'geoportal', 'bevolkerung', 'stimmungsbilder', 'einzeldaten', 'punktdaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-23T04:49:16.292022`
