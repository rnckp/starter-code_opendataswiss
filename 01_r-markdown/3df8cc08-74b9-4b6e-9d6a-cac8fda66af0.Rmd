...
- **Keywords.de** `['stzh', 'nutzung', 'bevolkerung', 'geodaten', 'geoportal', 'sachdaten', 'tabelle', 'einzeldaten', 'bedurfnisse', 'punktdaten', 'lora', 'zufriedenheit', 'stimmungsbilder', 'abstimmungsgerat', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-13T02:38:05.423287`
