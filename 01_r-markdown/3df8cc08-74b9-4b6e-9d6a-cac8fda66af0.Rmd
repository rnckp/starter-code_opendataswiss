...
- **Keywords.de** `['einzeldaten', 'stzh', 'nutzung', 'geodaten', 'abstimmungen', 'lora', 'abstimmungsgerat', 'bedurfnisse', 'punktdaten', 'sachdaten', 'geoportal', 'zufriedenheit', 'tabelle', 'bevolkerung', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-26T05:27:31.857896`
