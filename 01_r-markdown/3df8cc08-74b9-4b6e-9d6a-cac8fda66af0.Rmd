...
- **Keywords.de** `['tabelle', 'lora', 'nutzung', 'abstimmungen', 'punktdaten', 'zufriedenheit', 'bedurfnisse', 'einzeldaten', 'bevolkerung', 'geodaten', 'geoportal', 'stzh', 'sachdaten', 'stimmungsbilder', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-29T02:46:29.550660`
