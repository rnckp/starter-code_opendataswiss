...
- **Keywords.de** `['tabelle', 'abstimmungen', 'geoportal', 'lora', 'stimmungsbilder', 'bedurfnisse', 'nutzung', 'einzeldaten', 'sachdaten', 'stzh', 'zufriedenheit', 'abstimmungsgerat', 'punktdaten', 'bevolkerung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-03T03:28:41.618083`
