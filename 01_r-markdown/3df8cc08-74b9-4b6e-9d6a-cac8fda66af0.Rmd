...
- **Keywords.de** `['abstimmungen', 'lora', 'einzeldaten', 'stzh', 'nutzung', 'tabelle', 'geoportal', 'stimmungsbilder', 'sachdaten', 'geodaten', 'abstimmungsgerat', 'zufriedenheit', 'punktdaten', 'bedurfnisse', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-20T02:57:31.676154`
