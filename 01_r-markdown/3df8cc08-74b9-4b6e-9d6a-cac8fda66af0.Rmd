...
- **Keywords.de** `['stzh', 'punktdaten', 'nutzung', 'zufriedenheit', 'sachdaten', 'lora', 'abstimmungsgerat', 'stimmungsbilder', 'abstimmungen', 'bedurfnisse', 'einzeldaten', 'geodaten', 'geoportal', 'tabelle', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-30T03:12:17.935383`
