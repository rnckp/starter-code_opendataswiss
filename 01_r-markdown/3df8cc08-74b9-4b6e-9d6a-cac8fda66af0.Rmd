...
- **Keywords.de** `['sachdaten', 'geodaten', 'bevolkerung', 'lora', 'nutzung', 'stimmungsbilder', 'stzh', 'tabelle', 'einzeldaten', 'zufriedenheit', 'abstimmungsgerat', 'abstimmungen', 'geoportal', 'punktdaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-28T03:30:18.026243`
