...
- **Keywords.de** `['bevolkerung', 'lora', 'nutzung', 'einzeldaten', 'tabelle', 'abstimmungen', 'stzh', 'sachdaten', 'abstimmungsgerat', 'geoportal', 'punktdaten', 'geodaten', 'zufriedenheit', 'stimmungsbilder', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-17T02:54:23.162819`
