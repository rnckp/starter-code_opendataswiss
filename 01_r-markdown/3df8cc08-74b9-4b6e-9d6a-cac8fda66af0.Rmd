...
- **Keywords.de** `['lora', 'zufriedenheit', 'stzh', 'sachdaten', 'tabelle', 'abstimmungen', 'bedurfnisse', 'stimmungsbilder', 'geodaten', 'punktdaten', 'geoportal', 'bevolkerung', 'einzeldaten', 'abstimmungsgerat', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-05T03:21:29.824048`
