...
- **Keywords.de** `['punktdaten', 'geodaten', 'geoportal', 'abstimmungen', 'abstimmungsgerat', 'nutzung', 'einzeldaten', 'sachdaten', 'lora', 'tabelle', 'bevolkerung', 'zufriedenheit', 'bedurfnisse', 'stimmungsbilder', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-23T03:20:32.324183`
