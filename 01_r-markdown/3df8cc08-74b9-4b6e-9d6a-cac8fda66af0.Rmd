...
- **Keywords.de** `['zufriedenheit', 'stimmungsbilder', 'stzh', 'nutzung', 'lora', 'einzeldaten', 'punktdaten', 'sachdaten', 'abstimmungsgerat', 'tabelle', 'bevolkerung', 'geoportal', 'bedurfnisse', 'abstimmungen', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-02T10:16:13.688846`
