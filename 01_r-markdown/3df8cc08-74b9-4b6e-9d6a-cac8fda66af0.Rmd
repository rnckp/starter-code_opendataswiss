...
- **Keywords.de** `['sachdaten', 'stimmungsbilder', 'zufriedenheit', 'bevolkerung', 'stzh', 'punktdaten', 'abstimmungsgerat', 'einzeldaten', 'abstimmungen', 'tabelle', 'geodaten', 'lora', 'bedurfnisse', 'nutzung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-14T03:10:32.781010`
