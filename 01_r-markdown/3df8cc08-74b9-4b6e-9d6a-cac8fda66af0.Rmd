...
- **Keywords.de** `['stimmungsbilder', 'nutzung', 'einzeldaten', 'abstimmungsgerat', 'geoportal', 'tabelle', 'bevolkerung', 'stzh', 'abstimmungen', 'sachdaten', 'bedurfnisse', 'geodaten', 'punktdaten', 'zufriedenheit', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-24T03:30:02.864696`
