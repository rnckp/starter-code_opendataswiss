...
- **Keywords.de** `['geoportal', 'zufriedenheit', 'punktdaten', 'geodaten', 'lora', 'tabelle', 'bevolkerung', 'stimmungsbilder', 'abstimmungsgerat', 'stzh', 'nutzung', 'sachdaten', 'abstimmungen', 'bedurfnisse', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-30T03:25:03.381494`
