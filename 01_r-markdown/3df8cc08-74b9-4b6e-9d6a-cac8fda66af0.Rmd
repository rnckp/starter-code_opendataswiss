...
- **Keywords.de** `['bedurfnisse', 'zufriedenheit', 'geoportal', 'punktdaten', 'abstimmungen', 'abstimmungsgerat', 'geodaten', 'sachdaten', 'nutzung', 'einzeldaten', 'stimmungsbilder', 'stzh', 'tabelle', 'lora', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-10T04:10:38.274445`
