...
- **Keywords.de** `['geoportal', 'abstimmungen', 'nutzung', 'punktdaten', 'stimmungsbilder', 'geodaten', 'bevolkerung', 'einzeldaten', 'tabelle', 'zufriedenheit', 'stzh', 'lora', 'sachdaten', 'bedurfnisse', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-07T04:22:55.354357`
