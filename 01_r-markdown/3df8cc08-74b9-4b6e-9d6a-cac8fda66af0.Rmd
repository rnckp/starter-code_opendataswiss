...
- **Keywords.de** `['stzh', 'geoportal', 'geodaten', 'lora', 'tabelle', 'nutzung', 'bevolkerung', 'abstimmungen', 'zufriedenheit', 'stimmungsbilder', 'punktdaten', 'abstimmungsgerat', 'einzeldaten', 'sachdaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-31T03:42:09.405546`
