...
- **Keywords.de** `['stzh', 'stimmungsbilder', 'bevolkerung', 'abstimmungsgerat', 'sachdaten', 'einzeldaten', 'tabelle', 'zufriedenheit', 'geoportal', 'nutzung', 'lora', 'punktdaten', 'abstimmungen', 'geodaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-28T03:27:28.301979`
