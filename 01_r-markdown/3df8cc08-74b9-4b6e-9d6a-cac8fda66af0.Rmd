...
- **Keywords.de** `['bevolkerung', 'bedurfnisse', 'punktdaten', 'geodaten', 'sachdaten', 'geoportal', 'abstimmungsgerat', 'tabelle', 'nutzung', 'stzh', 'abstimmungen', 'einzeldaten', 'lora', 'stimmungsbilder', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-20T03:44:30.323872`
