...
- **Keywords.de** `['bedurfnisse', 'zufriedenheit', 'nutzung', 'geodaten', 'abstimmungsgerat', 'lora', 'punktdaten', 'abstimmungen', 'einzeldaten', 'sachdaten', 'bevolkerung', 'tabelle', 'stzh', 'stimmungsbilder', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-27T03:11:20.362919`
