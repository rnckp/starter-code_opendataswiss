...
- **Keywords.de** `['punktdaten', 'geodaten', 'abstimmungen', 'sachdaten', 'tabelle', 'geoportal', 'bevolkerung', 'zufriedenheit', 'stzh', 'bedurfnisse', 'lora', 'abstimmungsgerat', 'stimmungsbilder', 'nutzung', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-22T02:54:34.110606`
