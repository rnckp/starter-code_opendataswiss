...
- **Keywords.de** `['abstimmungen', 'stimmungsbilder', 'einzeldaten', 'stzh', 'bedurfnisse', 'geodaten', 'sachdaten', 'bevolkerung', 'tabelle', 'punktdaten', 'geoportal', 'nutzung', 'zufriedenheit', 'lora', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-21T03:43:48.160743`
