...
- **Keywords.de** `['lora', 'punktdaten', 'abstimmungsgerat', 'tabelle', 'nutzung', 'zufriedenheit', 'abstimmungen', 'stzh', 'sachdaten', 'stimmungsbilder', 'einzeldaten', 'geoportal', 'bedurfnisse', 'geodaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-13T04:27:41.007567`
