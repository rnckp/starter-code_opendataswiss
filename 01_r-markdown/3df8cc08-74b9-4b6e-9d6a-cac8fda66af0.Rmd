...
- **Keywords.de** `['abstimmungen', 'stimmungsbilder', 'stzh', 'sachdaten', 'bedurfnisse', 'geoportal', 'lora', 'einzeldaten', 'bevolkerung', 'nutzung', 'tabelle', 'zufriedenheit', 'abstimmungsgerat', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-20T02:46:25.637111`
