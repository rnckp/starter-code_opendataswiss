...
- **Keywords.de** `['abstimmungsgerat', 'tabelle', 'bevolkerung', 'geodaten', 'stimmungsbilder', 'sachdaten', 'abstimmungen', 'einzeldaten', 'stzh', 'punktdaten', 'zufriedenheit', 'nutzung', 'geoportal', 'bedurfnisse', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-04T03:50:14.081149`
