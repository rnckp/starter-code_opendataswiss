...
- **Keywords.de** `['bedurfnisse', 'stimmungsbilder', 'geodaten', 'abstimmungen', 'abstimmungsgerat', 'nutzung', 'bevolkerung', 'tabelle', 'zufriedenheit', 'geoportal', 'punktdaten', 'einzeldaten', 'stzh', 'lora', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-18T03:28:17.786339`
