...
- **Keywords.de** `['punktdaten', 'bedurfnisse', 'stimmungsbilder', 'einzeldaten', 'abstimmungen', 'geoportal', 'geodaten', 'sachdaten', 'tabelle', 'lora', 'nutzung', 'bevolkerung', 'zufriedenheit', 'stzh', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-09T02:20:31.951774`
