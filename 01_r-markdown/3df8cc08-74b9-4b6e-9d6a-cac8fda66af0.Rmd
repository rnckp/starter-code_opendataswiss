...
- **Keywords.de** `['sachdaten', 'abstimmungsgerat', 'punktdaten', 'stzh', 'zufriedenheit', 'stimmungsbilder', 'bevolkerung', 'tabelle', 'nutzung', 'geoportal', 'geodaten', 'bedurfnisse', 'einzeldaten', 'abstimmungen', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-11T03:00:02.560002`
