...
- **Keywords.de** `['bevolkerung', 'zufriedenheit', 'tabelle', 'stzh', 'nutzung', 'punktdaten', 'einzeldaten', 'bedurfnisse', 'geoportal', 'sachdaten', 'abstimmungen', 'stimmungsbilder', 'lora', 'abstimmungsgerat', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-30T04:03:28.234648`
