...
- **Keywords.de** `['punktdaten', 'nutzung', 'abstimmungen', 'bedurfnisse', 'stimmungsbilder', 'geodaten', 'stzh', 'abstimmungsgerat', 'bevolkerung', 'zufriedenheit', 'lora', 'tabelle', 'einzeldaten', 'sachdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-02T04:20:00.240918`
