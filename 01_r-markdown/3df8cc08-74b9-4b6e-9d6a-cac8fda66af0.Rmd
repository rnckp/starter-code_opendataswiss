...
- **Keywords.de** `['nutzung', 'geodaten', 'einzeldaten', 'bevolkerung', 'geoportal', 'zufriedenheit', 'punktdaten', 'bedurfnisse', 'lora', 'sachdaten', 'tabelle', 'stzh', 'stimmungsbilder', 'abstimmungen', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-12T03:15:15.978359`
