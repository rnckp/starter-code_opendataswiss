...
- **Keywords.de** `['abstimmungsgerat', 'punktdaten', 'zufriedenheit', 'tabelle', 'bevolkerung', 'abstimmungen', 'bedurfnisse', 'einzeldaten', 'lora', 'nutzung', 'geodaten', 'sachdaten', 'stzh', 'stimmungsbilder', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-24T02:49:59.296433`
