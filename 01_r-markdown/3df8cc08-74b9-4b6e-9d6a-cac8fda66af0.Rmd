...
- **Keywords.de** `['nutzung', 'geodaten', 'bevolkerung', 'tabelle', 'punktdaten', 'stzh', 'abstimmungsgerat', 'abstimmungen', 'stimmungsbilder', 'geoportal', 'einzeldaten', 'bedurfnisse', 'lora', 'sachdaten', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-19T04:18:01.471552`
