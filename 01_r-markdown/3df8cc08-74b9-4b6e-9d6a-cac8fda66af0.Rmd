...
- **Keywords.de** `['geodaten', 'bedurfnisse', 'punktdaten', 'einzeldaten', 'abstimmungen', 'geoportal', 'lora', 'bevolkerung', 'stzh', 'tabelle', 'abstimmungsgerat', 'zufriedenheit', 'stimmungsbilder', 'sachdaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-26T03:18:20.349854`
