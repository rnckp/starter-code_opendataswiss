...
- **Keywords.de** `['bedurfnisse', 'sachdaten', 'bevolkerung', 'zufriedenheit', 'einzeldaten', 'abstimmungsgerat', 'abstimmungen', 'geodaten', 'lora', 'punktdaten', 'stzh', 'tabelle', 'stimmungsbilder', 'nutzung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-30T03:05:22.260939`
