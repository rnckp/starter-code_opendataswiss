...
- **Keywords.de** `['abstimmungsgerat', 'nutzung', 'punktdaten', 'bedurfnisse', 'tabelle', 'stzh', 'lora', 'sachdaten', 'zufriedenheit', 'geodaten', 'einzeldaten', 'abstimmungen', 'geoportal', 'stimmungsbilder', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-26T03:15:47.516893`
