...
- **Keywords.de** `['tabelle', 'nutzung', 'abstimmungen', 'lora', 'sachdaten', 'geoportal', 'punktdaten', 'geodaten', 'abstimmungsgerat', 'zufriedenheit', 'stzh', 'einzeldaten', 'bevolkerung', 'bedurfnisse', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-17T03:23:37.713423`
