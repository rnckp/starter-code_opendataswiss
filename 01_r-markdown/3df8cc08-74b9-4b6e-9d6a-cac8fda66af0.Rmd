...
- **Keywords.de** `['lora', 'punktdaten', 'abstimmungsgerat', 'abstimmungen', 'geodaten', 'geoportal', 'stzh', 'sachdaten', 'zufriedenheit', 'stimmungsbilder', 'nutzung', 'einzeldaten', 'bevolkerung', 'bedurfnisse', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-13T03:31:54.550927`
