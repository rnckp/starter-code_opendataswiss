...
- **Keywords.de** `['einzeldaten', 'sachdaten', 'geoportal', 'punktdaten', 'bevolkerung', 'bedurfnisse', 'abstimmungen', 'nutzung', 'abstimmungsgerat', 'lora', 'zufriedenheit', 'tabelle', 'geodaten', 'stzh', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-14T03:14:31.413735`
