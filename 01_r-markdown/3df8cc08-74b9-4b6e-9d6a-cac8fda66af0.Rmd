...
- **Keywords.de** `['stzh', 'stimmungsbilder', 'abstimmungen', 'punktdaten', 'sachdaten', 'tabelle', 'zufriedenheit', 'einzeldaten', 'geodaten', 'lora', 'bedurfnisse', 'bevolkerung', 'geoportal', 'abstimmungsgerat', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-24T02:59:47.341620`
