...
- **Keywords.de** `['punktdaten', 'geodaten', 'zufriedenheit', 'abstimmungsgerat', 'abstimmungen', 'stimmungsbilder', 'geoportal', 'bevolkerung', 'sachdaten', 'einzeldaten', 'bedurfnisse', 'lora', 'tabelle', 'nutzung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-18T02:52:36.656086`
