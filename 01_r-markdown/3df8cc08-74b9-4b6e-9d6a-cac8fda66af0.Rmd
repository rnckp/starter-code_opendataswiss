...
- **Keywords.de** `['nutzung', 'abstimmungsgerat', 'abstimmungen', 'punktdaten', 'lora', 'stzh', 'sachdaten', 'geodaten', 'stimmungsbilder', 'bevolkerung', 'geoportal', 'einzeldaten', 'bedurfnisse', 'zufriedenheit', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-18T03:38:50.944967`
