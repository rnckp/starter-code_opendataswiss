...
- **Keywords.de** `['lora', 'stzh', 'geoportal', 'stimmungsbilder', 'einzeldaten', 'nutzung', 'bedurfnisse', 'tabelle', 'sachdaten', 'abstimmungen', 'abstimmungsgerat', 'zufriedenheit', 'geodaten', 'bevolkerung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-22T02:04:26.051606`
