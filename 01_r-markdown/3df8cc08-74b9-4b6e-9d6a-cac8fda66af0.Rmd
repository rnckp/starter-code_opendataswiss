...
- **Keywords.de** `['stimmungsbilder', 'zufriedenheit', 'bevolkerung', 'einzeldaten', 'abstimmungen', 'abstimmungsgerat', 'punktdaten', 'lora', 'tabelle', 'geodaten', 'geoportal', 'sachdaten', 'nutzung', 'stzh', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-18T03:27:13.275784`
