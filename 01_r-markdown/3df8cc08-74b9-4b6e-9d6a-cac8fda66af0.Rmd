...
- **Keywords.de** `['stimmungsbilder', 'punktdaten', 'bevolkerung', 'einzeldaten', 'geodaten', 'sachdaten', 'abstimmungsgerat', 'nutzung', 'lora', 'abstimmungen', 'bedurfnisse', 'stzh', 'geoportal', 'tabelle', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-05T02:45:21.331231`
