...
- **Keywords.de** `['lora', 'geoportal', 'stzh', 'geodaten', 'nutzung', 'stimmungsbilder', 'bedurfnisse', 'punktdaten', 'tabelle', 'sachdaten', 'einzeldaten', 'abstimmungsgerat', 'zufriedenheit', 'abstimmungen', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-16T03:19:37.763677`
