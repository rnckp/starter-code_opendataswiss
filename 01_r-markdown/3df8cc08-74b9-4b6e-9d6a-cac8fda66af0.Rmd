...
- **Keywords.de** `['nutzung', 'abstimmungsgerat', 'zufriedenheit', 'lora', 'tabelle', 'bedurfnisse', 'stzh', 'geodaten', 'stimmungsbilder', 'einzeldaten', 'punktdaten', 'bevolkerung', 'geoportal', 'abstimmungen', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-20T03:17:49.641541`
