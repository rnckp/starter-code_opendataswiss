...
- **Keywords.de** `['zufriedenheit', 'abstimmungen', 'stimmungsbilder', 'einzeldaten', 'abstimmungsgerat', 'tabelle', 'geodaten', 'nutzung', 'stzh', 'punktdaten', 'lora', 'geoportal', 'sachdaten', 'bevolkerung', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-15T03:23:09.150823`
