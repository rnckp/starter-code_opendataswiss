...
- **Keywords.de** `['geoportal', 'nutzung', 'stzh', 'punktdaten', 'zufriedenheit', 'abstimmungen', 'bedurfnisse', 'lora', 'einzeldaten', 'tabelle', 'geodaten', 'sachdaten', 'bevolkerung', 'abstimmungsgerat', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-25T03:18:10.210980`
