...
- **Keywords.de** `['tabelle', 'lora', 'stzh', 'geoportal', 'abstimmungsgerat', 'nutzung', 'bevolkerung', 'punktdaten', 'bedurfnisse', 'geodaten', 'sachdaten', 'stimmungsbilder', 'einzeldaten', 'abstimmungen', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-02T03:18:32.769731`
