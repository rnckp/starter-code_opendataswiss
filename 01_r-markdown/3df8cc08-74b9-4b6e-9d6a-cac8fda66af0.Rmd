...
- **Keywords.de** `['tabelle', 'geodaten', 'nutzung', 'geoportal', 'abstimmungsgerat', 'stimmungsbilder', 'einzeldaten', 'lora', 'stzh', 'bevolkerung', 'sachdaten', 'zufriedenheit', 'abstimmungen', 'bedurfnisse', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-22T03:17:03.003172`
