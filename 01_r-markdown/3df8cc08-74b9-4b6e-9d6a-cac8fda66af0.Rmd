...
- **Keywords.de** `['stimmungsbilder', 'tabelle', 'abstimmungen', 'bevolkerung', 'zufriedenheit', 'punktdaten', 'geodaten', 'sachdaten', 'nutzung', 'stzh', 'bedurfnisse', 'lora', 'geoportal', 'einzeldaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-17T03:00:10.275008`
