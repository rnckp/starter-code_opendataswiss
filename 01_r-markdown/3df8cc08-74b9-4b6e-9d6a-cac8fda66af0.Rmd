...
- **Keywords.de** `['zufriedenheit', 'einzeldaten', 'nutzung', 'lora', 'tabelle', 'bedurfnisse', 'stzh', 'bevolkerung', 'stimmungsbilder', 'sachdaten', 'abstimmungsgerat', 'geodaten', 'geoportal', 'abstimmungen', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-16T02:54:27.925047`
