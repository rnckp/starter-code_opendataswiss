...
- **Keywords.de** `['bedurfnisse', 'stzh', 'bevolkerung', 'tabelle', 'einzeldaten', 'abstimmungsgerat', 'abstimmungen', 'geodaten', 'lora', 'nutzung', 'punktdaten', 'stimmungsbilder', 'sachdaten', 'geoportal', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-29T02:50:06.246039`
