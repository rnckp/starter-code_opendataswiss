...
- **Keywords.de** `['geodaten', 'abstimmungsgerat', 'nutzung', 'geoportal', 'sachdaten', 'bevolkerung', 'abstimmungen', 'einzeldaten', 'stzh', 'stimmungsbilder', 'punktdaten', 'tabelle', 'bedurfnisse', 'zufriedenheit', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-15T03:33:48.635921`
