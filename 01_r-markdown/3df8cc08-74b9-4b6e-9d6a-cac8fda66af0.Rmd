...
- **Keywords.de** `['sachdaten', 'punktdaten', 'tabelle', 'lora', 'geodaten', 'zufriedenheit', 'einzeldaten', 'bedurfnisse', 'abstimmungsgerat', 'geoportal', 'abstimmungen', 'stimmungsbilder', 'nutzung', 'bevolkerung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-20T02:40:58.126526`
