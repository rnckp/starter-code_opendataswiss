...
- **Keywords.de** `['stzh', 'bevolkerung', 'zufriedenheit', 'punktdaten', 'bedurfnisse', 'sachdaten', 'geoportal', 'abstimmungsgerat', 'abstimmungen', 'lora', 'tabelle', 'einzeldaten', 'stimmungsbilder', 'geodaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-24T03:09:28.645198`
