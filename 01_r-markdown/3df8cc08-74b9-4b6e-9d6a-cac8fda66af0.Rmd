...
- **Keywords.de** `['abstimmungen', 'zufriedenheit', 'lora', 'bedurfnisse', 'abstimmungsgerat', 'bevolkerung', 'einzeldaten', 'tabelle', 'nutzung', 'geoportal', 'sachdaten', 'geodaten', 'stzh', 'punktdaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-27T03:28:42.150288`
