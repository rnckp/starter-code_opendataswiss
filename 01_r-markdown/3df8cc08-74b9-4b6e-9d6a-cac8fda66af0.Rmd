...
- **Keywords.de** `['geoportal', 'abstimmungen', 'sachdaten', 'lora', 'tabelle', 'bedurfnisse', 'nutzung', 'einzeldaten', 'abstimmungsgerat', 'stimmungsbilder', 'zufriedenheit', 'geodaten', 'bevolkerung', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-23T03:18:17.179531`
