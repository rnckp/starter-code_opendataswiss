...
- **Keywords.de** `['stimmungsbilder', 'abstimmungen', 'sachdaten', 'lora', 'geodaten', 'stzh', 'geoportal', 'bevolkerung', 'abstimmungsgerat', 'nutzung', 'zufriedenheit', 'punktdaten', 'tabelle', 'bedurfnisse', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-02T05:14:16.989360`
