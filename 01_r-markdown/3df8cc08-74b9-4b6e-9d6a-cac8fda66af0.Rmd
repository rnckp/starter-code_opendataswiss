...
- **Keywords.de** `['zufriedenheit', 'nutzung', 'lora', 'punktdaten', 'abstimmungsgerat', 'stzh', 'sachdaten', 'tabelle', 'bedurfnisse', 'stimmungsbilder', 'geodaten', 'abstimmungen', 'bevolkerung', 'geoportal', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-07T02:58:45.085890`
