...
- **Keywords.de** `['abstimmungsgerat', 'lora', 'bedurfnisse', 'geodaten', 'geoportal', 'tabelle', 'stzh', 'zufriedenheit', 'stimmungsbilder', 'bevolkerung', 'abstimmungen', 'nutzung', 'einzeldaten', 'punktdaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-27T03:18:57.281387`
