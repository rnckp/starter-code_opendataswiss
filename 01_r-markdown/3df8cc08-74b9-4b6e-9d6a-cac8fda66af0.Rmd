...
- **Keywords.de** `['abstimmungen', 'einzeldaten', 'bevolkerung', 'tabelle', 'geoportal', 'lora', 'abstimmungsgerat', 'nutzung', 'punktdaten', 'sachdaten', 'stzh', 'geodaten', 'stimmungsbilder', 'zufriedenheit', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-22T03:08:44.135903`
