...
- **Keywords.de** `['einzeldaten', 'punktdaten', 'stimmungsbilder', 'geodaten', 'stzh', 'geoportal', 'lora', 'abstimmungen', 'tabelle', 'bedurfnisse', 'nutzung', 'zufriedenheit', 'bevolkerung', 'sachdaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-04T03:17:11.632486`
