...
- **Keywords.de** `['sachdaten', 'tabelle', 'einzeldaten', 'nutzung', 'abstimmungsgerat', 'stzh', 'abstimmungen', 'stimmungsbilder', 'bevolkerung', 'punktdaten', 'zufriedenheit', 'bedurfnisse', 'lora', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-08T03:50:59.516208`
