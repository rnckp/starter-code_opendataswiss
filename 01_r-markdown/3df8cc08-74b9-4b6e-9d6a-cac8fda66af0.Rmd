...
- **Keywords.de** `['einzeldaten', 'bevolkerung', 'nutzung', 'stzh', 'punktdaten', 'geodaten', 'abstimmungsgerat', 'tabelle', 'sachdaten', 'stimmungsbilder', 'geoportal', 'lora', 'abstimmungen', 'bedurfnisse', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-18T03:29:05.472473`
