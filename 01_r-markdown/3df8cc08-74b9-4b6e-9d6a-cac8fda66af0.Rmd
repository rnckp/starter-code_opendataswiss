...
- **Keywords.de** `['stimmungsbilder', 'stzh', 'punktdaten', 'geodaten', 'abstimmungen', 'nutzung', 'sachdaten', 'tabelle', 'einzeldaten', 'lora', 'abstimmungsgerat', 'bevolkerung', 'geoportal', 'bedurfnisse', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-22T03:07:52.342437`
