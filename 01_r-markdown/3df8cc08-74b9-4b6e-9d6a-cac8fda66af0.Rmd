...
- **Keywords.de** `['geoportal', 'zufriedenheit', 'lora', 'punktdaten', 'abstimmungsgerat', 'abstimmungen', 'bevolkerung', 'geodaten', 'sachdaten', 'bedurfnisse', 'einzeldaten', 'tabelle', 'stzh', 'nutzung', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-25T02:47:20.540338`
