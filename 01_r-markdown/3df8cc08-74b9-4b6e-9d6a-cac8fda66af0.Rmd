...
- **Keywords.de** `['stimmungsbilder', 'stzh', 'bevolkerung', 'zufriedenheit', 'punktdaten', 'lora', 'einzeldaten', 'tabelle', 'abstimmungsgerat', 'bedurfnisse', 'geodaten', 'nutzung', 'sachdaten', 'geoportal', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-04T03:08:26.717823`
