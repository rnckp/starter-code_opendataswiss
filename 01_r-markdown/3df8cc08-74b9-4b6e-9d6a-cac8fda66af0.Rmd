...
- **Keywords.de** `['bevolkerung', 'abstimmungen', 'geodaten', 'stzh', 'tabelle', 'punktdaten', 'stimmungsbilder', 'einzeldaten', 'geoportal', 'zufriedenheit', 'bedurfnisse', 'abstimmungsgerat', 'sachdaten', 'nutzung', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-23T02:53:36.862914`
