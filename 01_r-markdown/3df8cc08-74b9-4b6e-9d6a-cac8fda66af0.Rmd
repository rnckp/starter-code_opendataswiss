...
- **Keywords.de** `['stzh', 'punktdaten', 'zufriedenheit', 'abstimmungen', 'geoportal', 'tabelle', 'nutzung', 'bevolkerung', 'stimmungsbilder', 'geodaten', 'sachdaten', 'bedurfnisse', 'lora', 'einzeldaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-20T03:17:12.788803`
