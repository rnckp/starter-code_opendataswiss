...
- **Keywords.de** `['tabelle', 'einzeldaten', 'sachdaten', 'abstimmungsgerat', 'abstimmungen', 'lora', 'bevolkerung', 'geoportal', 'zufriedenheit', 'nutzung', 'stzh', 'punktdaten', 'stimmungsbilder', 'geodaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-09T04:19:26.013505`
