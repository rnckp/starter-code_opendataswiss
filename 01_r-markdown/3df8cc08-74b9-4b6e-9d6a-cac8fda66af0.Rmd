...
- **Keywords.de** `['lora', 'sachdaten', 'stimmungsbilder', 'bedurfnisse', 'abstimmungsgerat', 'zufriedenheit', 'tabelle', 'bevolkerung', 'punktdaten', 'stzh', 'einzeldaten', 'nutzung', 'abstimmungen', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-18T03:34:56.118259`
