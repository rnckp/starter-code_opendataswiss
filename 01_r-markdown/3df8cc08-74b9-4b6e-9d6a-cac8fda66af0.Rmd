...
- **Keywords.de** `['punktdaten', 'sachdaten', 'lora', 'abstimmungen', 'zufriedenheit', 'stzh', 'stimmungsbilder', 'abstimmungsgerat', 'nutzung', 'geoportal', 'bevolkerung', 'bedurfnisse', 'tabelle', 'einzeldaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-13T03:53:54.027384`
