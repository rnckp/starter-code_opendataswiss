...
- **Keywords.de** `['einzeldaten', 'abstimmungen', 'stzh', 'geodaten', 'zufriedenheit', 'stimmungsbilder', 'bedurfnisse', 'sachdaten', 'nutzung', 'abstimmungsgerat', 'lora', 'punktdaten', 'tabelle', 'geoportal', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-08T05:33:09.157574`
