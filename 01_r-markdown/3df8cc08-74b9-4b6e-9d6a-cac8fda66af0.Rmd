...
- **Keywords.de** `['nutzung', 'punktdaten', 'sachdaten', 'bevolkerung', 'abstimmungsgerat', 'lora', 'tabelle', 'abstimmungen', 'einzeldaten', 'zufriedenheit', 'geodaten', 'stimmungsbilder', 'bedurfnisse', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-06T03:18:44.672584`
