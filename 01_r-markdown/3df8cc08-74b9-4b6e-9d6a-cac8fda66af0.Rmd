...
- **Keywords.de** `['punktdaten', 'sachdaten', 'tabelle', 'zufriedenheit', 'lora', 'stimmungsbilder', 'geoportal', 'stzh', 'bedurfnisse', 'einzeldaten', 'bevolkerung', 'nutzung', 'abstimmungen', 'geodaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-29T03:19:27.626358`
