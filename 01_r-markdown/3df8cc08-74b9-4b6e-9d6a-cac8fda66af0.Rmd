...
- **Keywords.de** `['nutzung', 'abstimmungsgerat', 'punktdaten', 'stimmungsbilder', 'zufriedenheit', 'stzh', 'bedurfnisse', 'tabelle', 'geodaten', 'sachdaten', 'geoportal', 'einzeldaten', 'abstimmungen', 'lora', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-18T03:25:09.588468`
