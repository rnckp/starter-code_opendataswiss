...
- **Keywords.de** `['stimmungsbilder', 'bedurfnisse', 'bevolkerung', 'stzh', 'lora', 'abstimmungsgerat', 'nutzung', 'einzeldaten', 'abstimmungen', 'zufriedenheit', 'punktdaten', 'geodaten', 'geoportal', 'sachdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-24T03:41:38.684144`
