...
- **Keywords.de** `['abstimmungen', 'sachdaten', 'einzeldaten', 'stimmungsbilder', 'bedurfnisse', 'geoportal', 'nutzung', 'lora', 'stzh', 'geodaten', 'zufriedenheit', 'bevolkerung', 'punktdaten', 'tabelle', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-24T02:49:51.725858`
