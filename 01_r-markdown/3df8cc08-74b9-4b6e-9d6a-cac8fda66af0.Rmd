...
- **Keywords.de** `['einzeldaten', 'stimmungsbilder', 'zufriedenheit', 'lora', 'abstimmungen', 'punktdaten', 'nutzung', 'geoportal', 'geodaten', 'bedurfnisse', 'tabelle', 'stzh', 'abstimmungsgerat', 'bevolkerung', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-03T03:07:29.043211`
