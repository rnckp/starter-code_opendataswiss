...
- **Keywords.de** `['geoportal', 'lora', 'einzeldaten', 'geodaten', 'stzh', 'sachdaten', 'bevolkerung', 'zufriedenheit', 'nutzung', 'punktdaten', 'abstimmungsgerat', 'abstimmungen', 'bedurfnisse', 'tabelle', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-31T03:11:21.165794`
