...
- **Keywords.de** `['bevolkerung', 'abstimmungen', 'lora', 'geodaten', 'einzeldaten', 'punktdaten', 'geoportal', 'stimmungsbilder', 'stzh', 'sachdaten', 'tabelle', 'bedurfnisse', 'abstimmungsgerat', 'zufriedenheit', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-09T04:11:37.736047`
