...
- **Keywords.de** `['abstimmungen', 'zufriedenheit', 'bevolkerung', 'punktdaten', 'nutzung', 'abstimmungsgerat', 'tabelle', 'lora', 'stzh', 'bedurfnisse', 'geoportal', 'sachdaten', 'geodaten', 'stimmungsbilder', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-16T04:13:47.268972`
