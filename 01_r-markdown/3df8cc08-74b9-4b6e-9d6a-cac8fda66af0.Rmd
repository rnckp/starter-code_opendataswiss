...
- **Keywords.de** `['lora', 'einzeldaten', 'abstimmungsgerat', 'abstimmungen', 'stimmungsbilder', 'geoportal', 'stzh', 'sachdaten', 'punktdaten', 'nutzung', 'bevolkerung', 'geodaten', 'tabelle', 'zufriedenheit', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-04T04:38:31.476941`
