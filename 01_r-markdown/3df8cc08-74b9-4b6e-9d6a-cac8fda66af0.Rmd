...
- **Keywords.de** `['lora', 'einzeldaten', 'zufriedenheit', 'geodaten', 'nutzung', 'bedurfnisse', 'geoportal', 'abstimmungsgerat', 'stzh', 'stimmungsbilder', 'punktdaten', 'tabelle', 'bevolkerung', 'abstimmungen', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-26T03:42:04.227223`
