...
- **Keywords.de** `['geodaten', 'stzh', 'abstimmungsgerat', 'punktdaten', 'geoportal', 'bevolkerung', 'stimmungsbilder', 'abstimmungen', 'einzeldaten', 'zufriedenheit', 'nutzung', 'sachdaten', 'lora', 'bedurfnisse', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-15T03:52:33.194062`
