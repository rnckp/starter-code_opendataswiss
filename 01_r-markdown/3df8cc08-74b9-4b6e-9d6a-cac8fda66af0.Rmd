...
- **Keywords.de** `['punktdaten', 'abstimmungsgerat', 'stzh', 'abstimmungen', 'geodaten', 'lora', 'stimmungsbilder', 'zufriedenheit', 'nutzung', 'einzeldaten', 'geoportal', 'sachdaten', 'tabelle', 'bevolkerung', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-19T04:17:02.950341`
