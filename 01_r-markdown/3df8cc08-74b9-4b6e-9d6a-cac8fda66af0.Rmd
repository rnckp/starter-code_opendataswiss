...
- **Keywords.de** `['zufriedenheit', 'einzeldaten', 'nutzung', 'abstimmungsgerat', 'stzh', 'sachdaten', 'lora', 'stimmungsbilder', 'bevolkerung', 'abstimmungen', 'punktdaten', 'geodaten', 'tabelle', 'bedurfnisse', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-16T03:21:03.818353`
