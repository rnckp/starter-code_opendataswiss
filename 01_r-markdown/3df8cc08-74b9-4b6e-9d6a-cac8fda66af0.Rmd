...
- **Keywords.de** `['abstimmungen', 'stimmungsbilder', 'bevolkerung', 'bedurfnisse', 'geodaten', 'lora', 'abstimmungsgerat', 'geoportal', 'nutzung', 'tabelle', 'zufriedenheit', 'einzeldaten', 'punktdaten', 'sachdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-12T02:50:36.216333`
