...
- **Keywords.de** `['nutzung', 'zufriedenheit', 'einzeldaten', 'stzh', 'lora', 'geodaten', 'abstimmungen', 'punktdaten', 'bevolkerung', 'bedurfnisse', 'abstimmungsgerat', 'sachdaten', 'geoportal', 'tabelle', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-09T03:21:01.961854`
