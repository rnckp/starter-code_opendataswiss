...
- **Keywords.de** `['abstimmungen', 'einzeldaten', 'stimmungsbilder', 'bevolkerung', 'punktdaten', 'nutzung', 'stzh', 'geoportal', 'tabelle', 'geodaten', 'abstimmungsgerat', 'sachdaten', 'zufriedenheit', 'lora', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-17T02:49:12.648010`
