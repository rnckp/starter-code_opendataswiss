...
- **Keywords.de** `['nutzung', 'bedurfnisse', 'geodaten', 'geoportal', 'stimmungsbilder', 'bevolkerung', 'punktdaten', 'stzh', 'abstimmungen', 'abstimmungsgerat', 'sachdaten', 'lora', 'zufriedenheit', 'tabelle', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-08T03:08:26.521072`
