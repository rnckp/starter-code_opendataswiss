...
- **Keywords.de** `['stimmungsbilder', 'punktdaten', 'sachdaten', 'stzh', 'bevolkerung', 'einzeldaten', 'geodaten', 'bedurfnisse', 'lora', 'zufriedenheit', 'geoportal', 'abstimmungsgerat', 'nutzung', 'tabelle', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-13T03:29:20.019071`
