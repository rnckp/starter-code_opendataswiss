...
- **Keywords.de** `['bevolkerung', 'abstimmungen', 'zufriedenheit', 'geoportal', 'stimmungsbilder', 'einzeldaten', 'punktdaten', 'lora', 'stzh', 'geodaten', 'nutzung', 'sachdaten', 'bedurfnisse', 'tabelle', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-21T02:43:51.715725`
