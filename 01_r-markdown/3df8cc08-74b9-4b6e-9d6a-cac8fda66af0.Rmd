...
- **Keywords.de** `['stzh', 'lora', 'tabelle', 'einzeldaten', 'abstimmungen', 'abstimmungsgerat', 'nutzung', 'bevolkerung', 'zufriedenheit', 'punktdaten', 'geoportal', 'bedurfnisse', 'stimmungsbilder', 'geodaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-17T03:16:32.013499`
