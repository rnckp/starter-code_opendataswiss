...
- **Keywords.de** `['stzh', 'geodaten', 'abstimmungsgerat', 'lora', 'stimmungsbilder', 'zufriedenheit', 'einzeldaten', 'sachdaten', 'punktdaten', 'abstimmungen', 'bedurfnisse', 'bevolkerung', 'geoportal', 'tabelle', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-21T02:55:21.560850`
