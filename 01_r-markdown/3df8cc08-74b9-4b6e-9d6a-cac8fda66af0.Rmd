...
- **Keywords.de** `['stimmungsbilder', 'tabelle', 'lora', 'abstimmungsgerat', 'stzh', 'bevolkerung', 'sachdaten', 'abstimmungen', 'punktdaten', 'bedurfnisse', 'nutzung', 'geodaten', 'einzeldaten', 'zufriedenheit', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-25T03:27:33.221452`
