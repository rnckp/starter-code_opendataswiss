...
- **Keywords.de** `['lora', 'zufriedenheit', 'tabelle', 'abstimmungen', 'einzeldaten', 'sachdaten', 'stzh', 'stimmungsbilder', 'abstimmungsgerat', 'bedurfnisse', 'nutzung', 'bevolkerung', 'punktdaten', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-06T02:53:06.412294`
