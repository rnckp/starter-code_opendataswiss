...
- **Keywords.de** `['geoportal', 'bedurfnisse', 'geodaten', 'punktdaten', 'zufriedenheit', 'bevolkerung', 'stimmungsbilder', 'stzh', 'nutzung', 'einzeldaten', 'abstimmungen', 'lora', 'tabelle', 'abstimmungsgerat', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-09T03:11:16.218155`
