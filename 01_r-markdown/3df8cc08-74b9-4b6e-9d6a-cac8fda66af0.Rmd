...
- **Keywords.de** `['tabelle', 'geodaten', 'lora', 'zufriedenheit', 'sachdaten', 'bedurfnisse', 'nutzung', 'punktdaten', 'abstimmungen', 'bevolkerung', 'stimmungsbilder', 'einzeldaten', 'stzh', 'geoportal', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-28T02:50:45.903475`
