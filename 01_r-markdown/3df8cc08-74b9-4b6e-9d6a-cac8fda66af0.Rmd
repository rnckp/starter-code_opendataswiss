...
- **Keywords.de** `['geoportal', 'stzh', 'zufriedenheit', 'stimmungsbilder', 'tabelle', 'lora', 'bevolkerung', 'nutzung', 'einzeldaten', 'sachdaten', 'bedurfnisse', 'abstimmungen', 'punktdaten', 'abstimmungsgerat', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-07T03:32:01.218285`
