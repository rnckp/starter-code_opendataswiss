...
- **Keywords.de** `['tabelle', 'zufriedenheit', 'abstimmungsgerat', 'abstimmungen', 'einzeldaten', 'lora', 'geoportal', 'stzh', 'bedurfnisse', 'sachdaten', 'geodaten', 'punktdaten', 'bevolkerung', 'stimmungsbilder', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-21T03:24:54.430507`
