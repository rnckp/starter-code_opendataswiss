...
- **Keywords.de** `['bevolkerung', 'punktdaten', 'stzh', 'abstimmungen', 'bedurfnisse', 'einzeldaten', 'zufriedenheit', 'geodaten', 'abstimmungsgerat', 'nutzung', 'lora', 'geoportal', 'stimmungsbilder', 'sachdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-23T02:40:15.945047`
