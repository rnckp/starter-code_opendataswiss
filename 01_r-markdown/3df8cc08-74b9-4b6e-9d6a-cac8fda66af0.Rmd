...
- **Keywords.de** `['geoportal', 'abstimmungen', 'tabelle', 'geodaten', 'bevolkerung', 'einzeldaten', 'nutzung', 'abstimmungsgerat', 'punktdaten', 'stzh', 'zufriedenheit', 'sachdaten', 'bedurfnisse', 'lora', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-19T03:21:50.798275`
