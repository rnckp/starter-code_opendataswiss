...
- **Keywords.de** `['abstimmungsgerat', 'punktdaten', 'lora', 'sachdaten', 'bevolkerung', 'geodaten', 'tabelle', 'abstimmungen', 'zufriedenheit', 'bedurfnisse', 'nutzung', 'stzh', 'einzeldaten', 'stimmungsbilder', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-24T03:34:33.654242`
