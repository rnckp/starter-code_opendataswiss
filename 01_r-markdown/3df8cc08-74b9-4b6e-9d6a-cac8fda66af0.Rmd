...
- **Keywords.de** `['stzh', 'sachdaten', 'tabelle', 'bevolkerung', 'abstimmungen', 'nutzung', 'stimmungsbilder', 'zufriedenheit', 'geoportal', 'geodaten', 'einzeldaten', 'bedurfnisse', 'lora', 'abstimmungsgerat', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-25T03:28:27.661295`
