...
- **Keywords.de** `['abstimmungsgerat', 'geodaten', 'bevolkerung', 'einzeldaten', 'zufriedenheit', 'stimmungsbilder', 'lora', 'sachdaten', 'punktdaten', 'stzh', 'abstimmungen', 'tabelle', 'geoportal', 'bedurfnisse', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-17T01:40:54.493027`
