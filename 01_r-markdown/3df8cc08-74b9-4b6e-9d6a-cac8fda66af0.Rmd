...
- **Keywords.de** `['nutzung', 'geodaten', 'stimmungsbilder', 'abstimmungsgerat', 'punktdaten', 'stzh', 'lora', 'tabelle', 'zufriedenheit', 'sachdaten', 'bevolkerung', 'geoportal', 'abstimmungen', 'bedurfnisse', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-03T03:28:26.151051`
