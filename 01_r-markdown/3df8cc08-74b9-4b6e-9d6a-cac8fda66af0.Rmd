...
- **Keywords.de** `['nutzung', 'lora', 'bedurfnisse', 'einzeldaten', 'sachdaten', 'stzh', 'geodaten', 'punktdaten', 'tabelle', 'geoportal', 'abstimmungen', 'abstimmungsgerat', 'zufriedenheit', 'bevolkerung', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-14T04:04:46.929726`
