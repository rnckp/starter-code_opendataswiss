...
- **Keywords.de** `['tabelle', 'nutzung', 'geoportal', 'punktdaten', 'geodaten', 'abstimmungen', 'stimmungsbilder', 'bedurfnisse', 'bevolkerung', 'einzeldaten', 'lora', 'sachdaten', 'zufriedenheit', 'abstimmungsgerat', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-09T02:27:28.853513`
