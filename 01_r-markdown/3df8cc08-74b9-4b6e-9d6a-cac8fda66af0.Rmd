...
- **Keywords.de** `['abstimmungen', 'einzeldaten', 'sachdaten', 'stimmungsbilder', 'stzh', 'bevolkerung', 'abstimmungsgerat', 'lora', 'punktdaten', 'bedurfnisse', 'tabelle', 'geodaten', 'zufriedenheit', 'geoportal', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-18T04:00:36.732732`
