...
- **Keywords.de** `['zufriedenheit', 'abstimmungen', 'lora', 'nutzung', 'bevolkerung', 'geodaten', 'sachdaten', 'stimmungsbilder', 'abstimmungsgerat', 'punktdaten', 'stzh', 'geoportal', 'einzeldaten', 'bedurfnisse', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-14T03:13:32.036602`
