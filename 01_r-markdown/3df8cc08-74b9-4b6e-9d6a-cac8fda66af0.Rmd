...
- **Keywords.de** `['bedurfnisse', 'abstimmungsgerat', 'zufriedenheit', 'punktdaten', 'lora', 'nutzung', 'stzh', 'einzeldaten', 'geoportal', 'bevolkerung', 'tabelle', 'abstimmungen', 'geodaten', 'sachdaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-12T02:57:28.782176`
