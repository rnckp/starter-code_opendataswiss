...
- **Keywords.de** `['einzeldaten', 'geoportal', 'punktdaten', 'tabelle', 'bedurfnisse', 'abstimmungen', 'stimmungsbilder', 'stzh', 'geodaten', 'bevolkerung', 'abstimmungsgerat', 'lora', 'nutzung', 'zufriedenheit', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-01T04:05:42.241262`
