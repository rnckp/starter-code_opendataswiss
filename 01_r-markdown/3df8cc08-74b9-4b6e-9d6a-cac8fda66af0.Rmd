...
- **Keywords.de** `['bedurfnisse', 'bevolkerung', 'sachdaten', 'einzeldaten', 'abstimmungen', 'abstimmungsgerat', 'nutzung', 'geodaten', 'geoportal', 'stimmungsbilder', 'tabelle', 'stzh', 'punktdaten', 'lora', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-23T03:21:04.161465`
