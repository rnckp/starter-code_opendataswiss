...
- **Keywords.de** `['geodaten', 'abstimmungen', 'einzeldaten', 'geoportal', 'sachdaten', 'stzh', 'abstimmungsgerat', 'stimmungsbilder', 'tabelle', 'zufriedenheit', 'lora', 'bedurfnisse', 'bevolkerung', 'nutzung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-31T03:29:41.937360`
