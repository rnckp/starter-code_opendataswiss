...
- **Keywords.de** `['punktdaten', 'abstimmungen', 'einzeldaten', 'sachdaten', 'tabelle', 'bedurfnisse', 'zufriedenheit', 'abstimmungsgerat', 'nutzung', 'geodaten', 'stimmungsbilder', 'stzh', 'lora', 'bevolkerung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-28T03:11:12.877660`
