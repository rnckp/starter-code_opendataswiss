...
- **Keywords.de** `['lora', 'stzh', 'abstimmungen', 'abstimmungsgerat', 'zufriedenheit', 'sachdaten', 'geoportal', 'punktdaten', 'bevolkerung', 'tabelle', 'stimmungsbilder', 'nutzung', 'bedurfnisse', 'geodaten', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-26T03:24:19.652516`
