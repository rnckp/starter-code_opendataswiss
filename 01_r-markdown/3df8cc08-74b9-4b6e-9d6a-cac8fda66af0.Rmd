...
- **Keywords.de** `['abstimmungsgerat', 'stimmungsbilder', 'bevolkerung', 'stzh', 'geoportal', 'abstimmungen', 'zufriedenheit', 'sachdaten', 'punktdaten', 'tabelle', 'geodaten', 'einzeldaten', 'lora', 'nutzung', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-12T03:10:34.123172`
