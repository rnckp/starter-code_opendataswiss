...
- **Keywords.de** `['bevolkerung', 'einzeldaten', 'zufriedenheit', 'sachdaten', 'tabelle', 'geoportal', 'geodaten', 'stimmungsbilder', 'abstimmungen', 'abstimmungsgerat', 'nutzung', 'bedurfnisse', 'lora', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-20T03:23:06.934273`
