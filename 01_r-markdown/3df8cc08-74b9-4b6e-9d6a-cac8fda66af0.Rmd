...
- **Keywords.de** `['zufriedenheit', 'bevolkerung', 'lora', 'nutzung', 'tabelle', 'stimmungsbilder', 'einzeldaten', 'sachdaten', 'abstimmungen', 'bedurfnisse', 'geoportal', 'punktdaten', 'stzh', 'geodaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-03T03:18:15.911057`
