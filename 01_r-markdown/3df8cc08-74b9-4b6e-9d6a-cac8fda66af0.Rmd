...
- **Keywords.de** `['lora', 'bevolkerung', 'bedurfnisse', 'tabelle', 'abstimmungen', 'stimmungsbilder', 'sachdaten', 'einzeldaten', 'abstimmungsgerat', 'geodaten', 'geoportal', 'stzh', 'zufriedenheit', 'punktdaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-17T03:18:22.376071`
