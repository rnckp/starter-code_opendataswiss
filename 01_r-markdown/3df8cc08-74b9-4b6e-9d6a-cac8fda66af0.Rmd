...
- **Keywords.de** `['geoportal', 'stzh', 'abstimmungsgerat', 'sachdaten', 'lora', 'punktdaten', 'tabelle', 'zufriedenheit', 'geodaten', 'nutzung', 'stimmungsbilder', 'bevolkerung', 'abstimmungen', 'bedurfnisse', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-01T03:21:49.086639`
