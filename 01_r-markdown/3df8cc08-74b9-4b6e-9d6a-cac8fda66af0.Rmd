...
- **Keywords.de** `['geodaten', 'abstimmungsgerat', 'tabelle', 'zufriedenheit', 'bevolkerung', 'einzeldaten', 'abstimmungen', 'punktdaten', 'nutzung', 'sachdaten', 'geoportal', 'lora', 'bedurfnisse', 'stzh', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-14T03:39:21.362950`
