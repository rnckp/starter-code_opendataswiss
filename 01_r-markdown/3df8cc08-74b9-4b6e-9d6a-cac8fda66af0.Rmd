...
- **Keywords.de** `['sachdaten', 'stzh', 'stimmungsbilder', 'tabelle', 'punktdaten', 'lora', 'bedurfnisse', 'geodaten', 'nutzung', 'zufriedenheit', 'abstimmungen', 'geoportal', 'bevolkerung', 'einzeldaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-20T03:27:54.219210`
