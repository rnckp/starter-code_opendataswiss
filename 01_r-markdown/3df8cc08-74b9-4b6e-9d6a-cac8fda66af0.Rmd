...
- **Keywords.de** `['geodaten', 'bevolkerung', 'lora', 'einzeldaten', 'abstimmungen', 'geoportal', 'stimmungsbilder', 'stzh', 'nutzung', 'bedurfnisse', 'punktdaten', 'sachdaten', 'tabelle', 'zufriedenheit', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-31T08:12:54.055797`
