...
- **Keywords.de** `['bevolkerung', 'geodaten', 'lora', 'tabelle', 'zufriedenheit', 'punktdaten', 'geoportal', 'einzeldaten', 'sachdaten', 'stzh', 'abstimmungsgerat', 'stimmungsbilder', 'abstimmungen', 'nutzung', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-30T02:57:57.823531`
