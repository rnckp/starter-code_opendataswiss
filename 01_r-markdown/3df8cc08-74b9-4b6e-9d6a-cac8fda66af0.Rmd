...
- **Keywords.de** `['lora', 'bevolkerung', 'bedurfnisse', 'einzeldaten', 'geodaten', 'sachdaten', 'zufriedenheit', 'stzh', 'abstimmungsgerat', 'stimmungsbilder', 'abstimmungen', 'geoportal', 'punktdaten', 'tabelle', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-14T02:54:29.085384`
