...
- **Keywords.de** `['bevolkerung', 'tabelle', 'zufriedenheit', 'nutzung', 'sachdaten', 'abstimmungen', 'geoportal', 'punktdaten', 'stimmungsbilder', 'bedurfnisse', 'stzh', 'geodaten', 'einzeldaten', 'lora', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-10T03:26:29.737440`
