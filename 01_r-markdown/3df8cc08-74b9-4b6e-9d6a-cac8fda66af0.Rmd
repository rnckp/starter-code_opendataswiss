...
- **Keywords.de** `['lora', 'geodaten', 'bedurfnisse', 'abstimmungsgerat', 'abstimmungen', 'sachdaten', 'nutzung', 'stimmungsbilder', 'zufriedenheit', 'einzeldaten', 'tabelle', 'bevolkerung', 'punktdaten', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-15T02:36:48.455727`
