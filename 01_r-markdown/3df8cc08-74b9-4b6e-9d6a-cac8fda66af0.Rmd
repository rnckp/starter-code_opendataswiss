...
- **Keywords.de** `['lora', 'geodaten', 'tabelle', 'bedurfnisse', 'geoportal', 'sachdaten', 'stimmungsbilder', 'nutzung', 'punktdaten', 'einzeldaten', 'abstimmungen', 'stzh', 'bevolkerung', 'zufriedenheit', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-29T03:22:14.734953`
