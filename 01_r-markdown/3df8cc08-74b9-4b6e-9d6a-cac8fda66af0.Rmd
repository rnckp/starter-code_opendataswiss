...
- **Keywords.de** `['bedurfnisse', 'tabelle', 'bevolkerung', 'zufriedenheit', 'einzeldaten', 'geoportal', 'nutzung', 'stzh', 'abstimmungen', 'geodaten', 'sachdaten', 'punktdaten', 'stimmungsbilder', 'abstimmungsgerat', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-26T03:27:18.903559`
