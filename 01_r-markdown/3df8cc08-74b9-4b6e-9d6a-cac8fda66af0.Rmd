...
- **Keywords.de** `['bevolkerung', 'lora', 'stzh', 'geodaten', 'stimmungsbilder', 'tabelle', 'zufriedenheit', 'einzeldaten', 'punktdaten', 'abstimmungsgerat', 'bedurfnisse', 'nutzung', 'geoportal', 'sachdaten', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-27T03:32:33.847850`
