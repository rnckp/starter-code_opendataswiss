...
- **Keywords.de** `['geoportal', 'bedurfnisse', 'einzeldaten', 'geodaten', 'sachdaten', 'punktdaten', 'abstimmungen', 'lora', 'abstimmungsgerat', 'bevolkerung', 'zufriedenheit', 'nutzung', 'stzh', 'stimmungsbilder', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-17T03:25:53.348900`
