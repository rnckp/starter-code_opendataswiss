...
- **Keywords.de** `['punktdaten', 'geoportal', 'abstimmungen', 'zufriedenheit', 'bevolkerung', 'einzeldaten', 'geodaten', 'tabelle', 'stimmungsbilder', 'abstimmungsgerat', 'nutzung', 'sachdaten', 'bedurfnisse', 'stzh', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-06T04:33:45.905818`
