...
- **Keywords.de** `['geodaten', 'stzh', 'bevolkerung', 'nutzung', 'bedurfnisse', 'punktdaten', 'abstimmungsgerat', 'sachdaten', 'einzeldaten', 'zufriedenheit', 'stimmungsbilder', 'abstimmungen', 'geoportal', 'tabelle', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-17T02:45:38.345221`
