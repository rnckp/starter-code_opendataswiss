...
- **Keywords.de** `['tabelle', 'stimmungsbilder', 'nutzung', 'stzh', 'punktdaten', 'bedurfnisse', 'geoportal', 'geodaten', 'zufriedenheit', 'lora', 'abstimmungsgerat', 'abstimmungen', 'bevolkerung', 'einzeldaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-13T02:57:36.249135`
