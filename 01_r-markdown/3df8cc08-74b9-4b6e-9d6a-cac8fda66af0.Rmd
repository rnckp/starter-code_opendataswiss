...
- **Keywords.de** `['lora', 'einzeldaten', 'geoportal', 'tabelle', 'punktdaten', 'bedurfnisse', 'abstimmungen', 'bevolkerung', 'stzh', 'geodaten', 'sachdaten', 'nutzung', 'stimmungsbilder', 'zufriedenheit', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-11T03:22:34.920352`
