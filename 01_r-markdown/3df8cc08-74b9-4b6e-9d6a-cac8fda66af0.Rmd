...
- **Keywords.de** `['sachdaten', 'stimmungsbilder', 'abstimmungsgerat', 'tabelle', 'geoportal', 'punktdaten', 'bevolkerung', 'einzeldaten', 'abstimmungen', 'zufriedenheit', 'lora', 'nutzung', 'stzh', 'geodaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-09T03:28:41.172505`
