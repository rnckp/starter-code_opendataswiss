...
- **Keywords.de** `['abstimmungsgerat', 'bedurfnisse', 'geodaten', 'stimmungsbilder', 'tabelle', 'zufriedenheit', 'einzeldaten', 'punktdaten', 'lora', 'geoportal', 'nutzung', 'abstimmungen', 'stzh', 'sachdaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-23T02:28:17.995460`
