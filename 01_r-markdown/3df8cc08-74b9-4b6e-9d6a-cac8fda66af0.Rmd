...
- **Keywords.de** `['abstimmungen', 'geodaten', 'bevolkerung', 'tabelle', 'stzh', 'abstimmungsgerat', 'bedurfnisse', 'nutzung', 'lora', 'punktdaten', 'einzeldaten', 'zufriedenheit', 'sachdaten', 'geoportal', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-07T03:41:34.025751`
