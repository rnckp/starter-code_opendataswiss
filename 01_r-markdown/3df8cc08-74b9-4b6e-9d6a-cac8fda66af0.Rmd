...
- **Keywords.de** `['stzh', 'abstimmungsgerat', 'stimmungsbilder', 'punktdaten', 'abstimmungen', 'tabelle', 'geodaten', 'bedurfnisse', 'bevolkerung', 'zufriedenheit', 'sachdaten', 'nutzung', 'geoportal', 'lora', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-03T03:27:23.720341`
