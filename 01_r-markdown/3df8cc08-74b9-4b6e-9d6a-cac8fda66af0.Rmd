...
- **Keywords.de** `['geodaten', 'lora', 'nutzung', 'stimmungsbilder', 'zufriedenheit', 'abstimmungsgerat', 'einzeldaten', 'stzh', 'geoportal', 'bevolkerung', 'abstimmungen', 'bedurfnisse', 'punktdaten', 'tabelle', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-17T03:14:56.921564`
