...
- **Keywords.de** `['geoportal', 'bevolkerung', 'nutzung', 'sachdaten', 'geodaten', 'bedurfnisse', 'abstimmungen', 'abstimmungsgerat', 'einzeldaten', 'punktdaten', 'tabelle', 'zufriedenheit', 'stzh', 'lora', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-14T03:04:21.649109`
