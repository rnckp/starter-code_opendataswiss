...
- **Keywords.de** `['zufriedenheit', 'nutzung', 'sachdaten', 'bevolkerung', 'bedurfnisse', 'stimmungsbilder', 'lora', 'einzeldaten', 'punktdaten', 'stzh', 'geoportal', 'tabelle', 'abstimmungsgerat', 'geodaten', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-17T02:42:15.756664`
