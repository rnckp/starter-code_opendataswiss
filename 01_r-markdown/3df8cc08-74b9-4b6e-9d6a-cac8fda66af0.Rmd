...
- **Keywords.de** `['stimmungsbilder', 'lora', 'bedurfnisse', 'sachdaten', 'stzh', 'abstimmungen', 'abstimmungsgerat', 'bevolkerung', 'zufriedenheit', 'tabelle', 'geoportal', 'einzeldaten', 'nutzung', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-22T03:18:00.526796`
