...
- **Keywords.de** `['abstimmungen', 'stzh', 'einzeldaten', 'nutzung', 'zufriedenheit', 'bevolkerung', 'lora', 'sachdaten', 'bedurfnisse', 'geoportal', 'tabelle', 'stimmungsbilder', 'abstimmungsgerat', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-16T03:37:22.076066`
