...
- **Keywords.de** `['einzeldaten', 'bevolkerung', 'zufriedenheit', 'tabelle', 'geoportal', 'sachdaten', 'geodaten', 'lora', 'stzh', 'stimmungsbilder', 'abstimmungsgerat', 'bedurfnisse', 'nutzung', 'punktdaten', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-03T02:56:35.764715`
