...
- **Keywords.de** `['bevolkerung', 'abstimmungen', 'geoportal', 'punktdaten', 'bedurfnisse', 'stzh', 'lora', 'einzeldaten', 'zufriedenheit', 'geodaten', 'abstimmungsgerat', 'tabelle', 'stimmungsbilder', 'nutzung', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-16T04:45:23.949817`
