...
- **Keywords.de** `['einzeldaten', 'sachdaten', 'stimmungsbilder', 'geoportal', 'bevolkerung', 'tabelle', 'zufriedenheit', 'punktdaten', 'abstimmungen', 'nutzung', 'bedurfnisse', 'stzh', 'abstimmungsgerat', 'geodaten', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-03T04:58:57.560742`
