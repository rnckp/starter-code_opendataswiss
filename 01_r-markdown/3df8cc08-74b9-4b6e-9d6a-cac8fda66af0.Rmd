...
- **Keywords.de** `['sachdaten', 'abstimmungsgerat', 'punktdaten', 'lora', 'bevolkerung', 'einzeldaten', 'abstimmungen', 'geodaten', 'geoportal', 'nutzung', 'zufriedenheit', 'stzh', 'stimmungsbilder', 'bedurfnisse', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-21T02:31:45.724524`
