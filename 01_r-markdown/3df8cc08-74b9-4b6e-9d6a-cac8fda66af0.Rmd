...
- **Keywords.de** `['abstimmungsgerat', 'nutzung', 'stimmungsbilder', 'abstimmungen', 'sachdaten', 'lora', 'einzeldaten', 'stzh', 'geoportal', 'zufriedenheit', 'punktdaten', 'bedurfnisse', 'bevolkerung', 'tabelle', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-05T02:55:56.040320`
