...
- **Keywords.de** `['sachdaten', 'abstimmungen', 'bevolkerung', 'tabelle', 'geodaten', 'abstimmungsgerat', 'stimmungsbilder', 'stzh', 'punktdaten', 'zufriedenheit', 'lora', 'nutzung', 'bedurfnisse', 'geoportal', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-22T05:15:42.047815`
