...
- **Keywords.de** `['sachdaten', 'zufriedenheit', 'tabelle', 'einzeldaten', 'geoportal', 'punktdaten', 'stzh', 'bedurfnisse', 'abstimmungen', 'geodaten', 'stimmungsbilder', 'nutzung', 'abstimmungsgerat', 'lora', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-04T04:04:40.022346`
