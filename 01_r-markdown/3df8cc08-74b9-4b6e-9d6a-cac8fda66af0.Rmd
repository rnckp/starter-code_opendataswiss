...
- **Keywords.de** `['stimmungsbilder', 'lora', 'geoportal', 'nutzung', 'stzh', 'abstimmungen', 'punktdaten', 'abstimmungsgerat', 'bevolkerung', 'bedurfnisse', 'einzeldaten', 'sachdaten', 'zufriedenheit', 'geodaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-19T03:58:02.245987`
