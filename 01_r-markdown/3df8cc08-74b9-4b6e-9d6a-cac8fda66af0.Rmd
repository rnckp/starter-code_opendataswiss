...
- **Keywords.de** `['nutzung', 'lora', 'stimmungsbilder', 'punktdaten', 'einzeldaten', 'sachdaten', 'stzh', 'zufriedenheit', 'abstimmungen', 'abstimmungsgerat', 'tabelle', 'geodaten', 'geoportal', 'bedurfnisse', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-27T03:30:50.295735`
