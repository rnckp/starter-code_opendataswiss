...
- **Keywords.de** `['geoportal', 'einzeldaten', 'abstimmungen', 'nutzung', 'tabelle', 'stzh', 'bedurfnisse', 'abstimmungsgerat', 'stimmungsbilder', 'lora', 'punktdaten', 'zufriedenheit', 'bevolkerung', 'sachdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-07T03:03:17.262756`
