...
- **Keywords.de** `['lora', 'einzeldaten', 'geodaten', 'bedurfnisse', 'stimmungsbilder', 'nutzung', 'stzh', 'bevolkerung', 'tabelle', 'zufriedenheit', 'punktdaten', 'abstimmungen', 'abstimmungsgerat', 'geoportal', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-10T03:12:54.884619`
