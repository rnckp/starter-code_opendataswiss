...
- **Keywords.de** `['sachdaten', 'lora', 'punktdaten', 'einzeldaten', 'abstimmungsgerat', 'abstimmungen', 'bedurfnisse', 'stimmungsbilder', 'tabelle', 'stzh', 'geodaten', 'geoportal', 'nutzung', 'bevolkerung', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-08T04:40:42.946058`
