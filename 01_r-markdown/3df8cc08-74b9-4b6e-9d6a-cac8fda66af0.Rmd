...
- **Keywords.de** `['einzeldaten', 'abstimmungsgerat', 'tabelle', 'stimmungsbilder', 'stzh', 'zufriedenheit', 'lora', 'bevolkerung', 'geodaten', 'bedurfnisse', 'sachdaten', 'nutzung', 'abstimmungen', 'punktdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-05T02:41:21.647966`
