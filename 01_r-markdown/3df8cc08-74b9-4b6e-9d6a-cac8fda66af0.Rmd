...
- **Keywords.de** `['einzeldaten', 'stimmungsbilder', 'geoportal', 'punktdaten', 'tabelle', 'abstimmungsgerat', 'nutzung', 'sachdaten', 'geodaten', 'bevolkerung', 'stzh', 'abstimmungen', 'lora', 'zufriedenheit', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-17T03:07:42.652526`
