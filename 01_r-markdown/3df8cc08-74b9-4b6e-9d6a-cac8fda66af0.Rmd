...
- **Keywords.de** `['tabelle', 'sachdaten', 'abstimmungen', 'geoportal', 'abstimmungsgerat', 'bevolkerung', 'stimmungsbilder', 'stzh', 'punktdaten', 'bedurfnisse', 'geodaten', 'nutzung', 'zufriedenheit', 'lora', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-19T03:19:46.119781`
