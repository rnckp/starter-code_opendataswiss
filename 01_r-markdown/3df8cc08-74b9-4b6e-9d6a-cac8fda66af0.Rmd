...
- **Keywords.de** `['lora', 'zufriedenheit', 'geodaten', 'geoportal', 'nutzung', 'bevolkerung', 'stimmungsbilder', 'abstimmungen', 'abstimmungsgerat', 'tabelle', 'punktdaten', 'bedurfnisse', 'stzh', 'sachdaten', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-02T03:02:40.663120`
