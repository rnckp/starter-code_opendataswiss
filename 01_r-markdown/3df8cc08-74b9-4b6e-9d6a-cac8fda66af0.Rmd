...
- **Keywords.de** `['tabelle', 'zufriedenheit', 'lora', 'einzeldaten', 'bevolkerung', 'abstimmungen', 'punktdaten', 'abstimmungsgerat', 'bedurfnisse', 'stzh', 'stimmungsbilder', 'geoportal', 'nutzung', 'geodaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-11T05:29:50.314825`
