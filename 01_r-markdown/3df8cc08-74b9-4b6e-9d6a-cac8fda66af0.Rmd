...
- **Keywords.de** `['zufriedenheit', 'bedurfnisse', 'geodaten', 'bevolkerung', 'einzeldaten', 'stimmungsbilder', 'geoportal', 'abstimmungsgerat', 'nutzung', 'lora', 'punktdaten', 'abstimmungen', 'stzh', 'sachdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-23T02:47:59.267334`
