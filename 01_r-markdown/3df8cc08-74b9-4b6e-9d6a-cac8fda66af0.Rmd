...
- **Keywords.de** `['lora', 'sachdaten', 'abstimmungsgerat', 'stzh', 'tabelle', 'abstimmungen', 'nutzung', 'bedurfnisse', 'geodaten', 'stimmungsbilder', 'geoportal', 'bevolkerung', 'einzeldaten', 'punktdaten', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-25T03:08:15.818691`
