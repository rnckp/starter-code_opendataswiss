...
- **Keywords.de** `['tabelle', 'abstimmungsgerat', 'bedurfnisse', 'stzh', 'nutzung', 'stimmungsbilder', 'geodaten', 'lora', 'zufriedenheit', 'geoportal', 'abstimmungen', 'einzeldaten', 'punktdaten', 'sachdaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-11T03:32:01.352000`
