...
- **Keywords.de** `['geodaten', 'abstimmungen', 'tabelle', 'sachdaten', 'zufriedenheit', 'stzh', 'bedurfnisse', 'geoportal', 'punktdaten', 'bevolkerung', 'lora', 'stimmungsbilder', 'nutzung', 'einzeldaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-02T03:18:45.032611`
