...
- **Keywords.de** `['sachdaten', 'einzeldaten', 'geoportal', 'nutzung', 'geodaten', 'abstimmungen', 'abstimmungsgerat', 'stzh', 'punktdaten', 'stimmungsbilder', 'lora', 'zufriedenheit', 'bedurfnisse', 'bevolkerung', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-27T03:07:45.874642`
