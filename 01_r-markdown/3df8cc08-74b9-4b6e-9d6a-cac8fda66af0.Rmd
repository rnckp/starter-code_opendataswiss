...
- **Keywords.de** `['geodaten', 'abstimmungsgerat', 'bevolkerung', 'nutzung', 'lora', 'einzeldaten', 'tabelle', 'sachdaten', 'stzh', 'abstimmungen', 'bedurfnisse', 'geoportal', 'punktdaten', 'zufriedenheit', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-01T03:40:33.836010`
