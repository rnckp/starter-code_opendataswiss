...
- **Keywords.de** `['geodaten', 'tabelle', 'nutzung', 'zufriedenheit', 'stimmungsbilder', 'punktdaten', 'bedurfnisse', 'abstimmungen', 'stzh', 'lora', 'bevolkerung', 'abstimmungsgerat', 'einzeldaten', 'geoportal', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-20T03:43:09.843439`
