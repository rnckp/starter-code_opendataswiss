...
- **Keywords.de** `['punktdaten', 'abstimmungen', 'stzh', 'nutzung', 'geoportal', 'bedurfnisse', 'stimmungsbilder', 'zufriedenheit', 'lora', 'abstimmungsgerat', 'einzeldaten', 'tabelle', 'bevolkerung', 'geodaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-25T03:27:34.577278`
