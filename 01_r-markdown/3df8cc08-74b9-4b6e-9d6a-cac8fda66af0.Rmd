...
- **Keywords.de** `['stimmungsbilder', 'bedurfnisse', 'geoportal', 'nutzung', 'abstimmungen', 'stzh', 'geodaten', 'lora', 'bevolkerung', 'sachdaten', 'einzeldaten', 'zufriedenheit', 'abstimmungsgerat', 'tabelle', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-02T03:32:19.914787`
