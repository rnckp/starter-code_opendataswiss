...
- **Keywords.de** `['tabelle', 'geodaten', 'geoportal', 'sachdaten', 'abstimmungsgerat', 'nutzung', 'abstimmungen', 'lora', 'bedurfnisse', 'stzh', 'bevolkerung', 'punktdaten', 'zufriedenheit', 'stimmungsbilder', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-03T02:42:07.288701`
