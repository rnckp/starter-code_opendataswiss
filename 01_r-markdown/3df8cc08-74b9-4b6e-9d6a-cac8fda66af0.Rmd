...
- **Keywords.de** `['tabelle', 'sachdaten', 'geoportal', 'nutzung', 'einzeldaten', 'stzh', 'abstimmungsgerat', 'punktdaten', 'bevolkerung', 'stimmungsbilder', 'zufriedenheit', 'lora', 'geodaten', 'abstimmungen', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-07T03:28:04.422332`
