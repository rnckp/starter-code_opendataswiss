...
- **Keywords.de** `['abstimmungen', 'tabelle', 'nutzung', 'sachdaten', 'geoportal', 'einzeldaten', 'lora', 'bevolkerung', 'abstimmungsgerat', 'geodaten', 'punktdaten', 'zufriedenheit', 'stimmungsbilder', 'bedurfnisse', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-27T03:11:05.932669`
