...
- **Keywords.de** `['tabelle', 'nutzung', 'lora', 'stzh', 'einzeldaten', 'bevolkerung', 'abstimmungen', 'stimmungsbilder', 'geodaten', 'sachdaten', 'punktdaten', 'zufriedenheit', 'abstimmungsgerat', 'geoportal', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-01T03:02:49.931620`
