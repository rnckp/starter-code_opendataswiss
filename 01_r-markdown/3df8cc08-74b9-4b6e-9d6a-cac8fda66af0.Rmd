...
- **Keywords.de** `['bevolkerung', 'abstimmungen', 'einzeldaten', 'tabelle', 'abstimmungsgerat', 'stzh', 'zufriedenheit', 'geoportal', 'bedurfnisse', 'punktdaten', 'geodaten', 'lora', 'sachdaten', 'nutzung', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-10T05:44:25.859616`
