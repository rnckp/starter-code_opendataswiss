...
- **Keywords.de** `['abstimmungen', 'lora', 'nutzung', 'sachdaten', 'stimmungsbilder', 'bevolkerung', 'punktdaten', 'stzh', 'abstimmungsgerat', 'tabelle', 'geodaten', 'zufriedenheit', 'bedurfnisse', 'geoportal', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-26T03:11:09.437220`
