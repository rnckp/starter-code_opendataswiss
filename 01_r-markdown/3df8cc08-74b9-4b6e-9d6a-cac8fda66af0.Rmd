...
- **Keywords.de** `['einzeldaten', 'abstimmungsgerat', 'bevolkerung', 'geoportal', 'stimmungsbilder', 'lora', 'bedurfnisse', 'sachdaten', 'stzh', 'tabelle', 'punktdaten', 'geodaten', 'nutzung', 'abstimmungen', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-04T02:57:47.622181`
