...
- **Keywords.de** `['stzh', 'tabelle', 'geodaten', 'nutzung', 'bevolkerung', 'abstimmungen', 'punktdaten', 'stimmungsbilder', 'lora', 'zufriedenheit', 'geoportal', 'abstimmungsgerat', 'einzeldaten', 'sachdaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-22T03:20:11.556395`
