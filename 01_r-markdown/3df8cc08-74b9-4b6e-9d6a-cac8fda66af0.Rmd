...
- **Keywords.de** `['einzeldaten', 'bevolkerung', 'abstimmungsgerat', 'nutzung', 'zufriedenheit', 'bedurfnisse', 'stzh', 'sachdaten', 'geoportal', 'lora', 'abstimmungen', 'geodaten', 'stimmungsbilder', 'punktdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-04T03:32:52.867642`
