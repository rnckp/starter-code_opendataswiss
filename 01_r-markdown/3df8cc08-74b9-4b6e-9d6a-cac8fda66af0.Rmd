...
- **Keywords.de** `['tabelle', 'einzeldaten', 'bevolkerung', 'sachdaten', 'lora', 'stzh', 'abstimmungsgerat', 'nutzung', 'geodaten', 'abstimmungen', 'geoportal', 'punktdaten', 'zufriedenheit', 'bedurfnisse', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-21T03:29:27.765595`
