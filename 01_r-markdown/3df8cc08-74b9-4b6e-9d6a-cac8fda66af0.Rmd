...
- **Keywords.de** `['punktdaten', 'sachdaten', 'bedurfnisse', 'lora', 'abstimmungen', 'einzeldaten', 'zufriedenheit', 'nutzung', 'stimmungsbilder', 'bevolkerung', 'geoportal', 'stzh', 'tabelle', 'abstimmungsgerat', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-28T03:41:58.906537`
