...
- **Keywords.de** `['abstimmungsgerat', 'sachdaten', 'einzeldaten', 'zufriedenheit', 'punktdaten', 'stimmungsbilder', 'nutzung', 'tabelle', 'geodaten', 'abstimmungen', 'bevolkerung', 'bedurfnisse', 'lora', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-06T03:30:51.719827`
