...
- **Keywords.de** `['tabelle', 'sachdaten', 'abstimmungsgerat', 'geoportal', 'geodaten', 'bevolkerung', 'nutzung', 'zufriedenheit', 'stzh', 'stimmungsbilder', 'lora', 'einzeldaten', 'punktdaten', 'abstimmungen', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-17T02:55:12.735417`
