...
- **Keywords.de** `['stimmungsbilder', 'abstimmungsgerat', 'punktdaten', 'zufriedenheit', 'lora', 'einzeldaten', 'tabelle', 'geodaten', 'sachdaten', 'geoportal', 'stzh', 'bedurfnisse', 'nutzung', 'abstimmungen', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-14T03:21:24.528949`
