...
- **Keywords.de** `['tabelle', 'abstimmungsgerat', 'abstimmungen', 'sachdaten', 'zufriedenheit', 'stzh', 'stimmungsbilder', 'geodaten', 'geoportal', 'bevolkerung', 'bedurfnisse', 'punktdaten', 'einzeldaten', 'lora', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-21T03:17:02.447188`
