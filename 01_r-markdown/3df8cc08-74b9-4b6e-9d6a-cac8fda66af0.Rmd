...
- **Keywords.de** `['geoportal', 'abstimmungen', 'lora', 'abstimmungsgerat', 'bedurfnisse', 'sachdaten', 'bevolkerung', 'stzh', 'nutzung', 'punktdaten', 'tabelle', 'zufriedenheit', 'geodaten', 'stimmungsbilder', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-09T03:24:15.577430`
