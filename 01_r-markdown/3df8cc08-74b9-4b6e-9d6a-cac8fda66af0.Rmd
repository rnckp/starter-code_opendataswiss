...
- **Keywords.de** `['einzeldaten', 'stzh', 'punktdaten', 'geodaten', 'lora', 'geoportal', 'abstimmungen', 'nutzung', 'tabelle', 'sachdaten', 'zufriedenheit', 'bevolkerung', 'stimmungsbilder', 'abstimmungsgerat', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-02T03:24:22.811621`
