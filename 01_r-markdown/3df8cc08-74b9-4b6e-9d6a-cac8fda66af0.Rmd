...
- **Keywords.de** `['stimmungsbilder', 'stzh', 'punktdaten', 'sachdaten', 'bevolkerung', 'bedurfnisse', 'abstimmungsgerat', 'abstimmungen', 'einzeldaten', 'lora', 'zufriedenheit', 'tabelle', 'geodaten', 'nutzung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-15T03:32:56.793187`
