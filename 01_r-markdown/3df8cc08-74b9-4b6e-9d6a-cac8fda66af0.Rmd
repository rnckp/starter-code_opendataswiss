...
- **Keywords.de** `['zufriedenheit', 'bevolkerung', 'lora', 'abstimmungsgerat', 'geodaten', 'nutzung', 'einzeldaten', 'sachdaten', 'geoportal', 'tabelle', 'stimmungsbilder', 'abstimmungen', 'stzh', 'bedurfnisse', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-26T02:37:11.960271`
