...
- **Keywords.de** `['einzeldaten', 'geodaten', 'geoportal', 'nutzung', 'sachdaten', 'abstimmungen', 'stimmungsbilder', 'tabelle', 'abstimmungsgerat', 'lora', 'bevolkerung', 'stzh', 'punktdaten', 'bedurfnisse', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-24T03:27:37.482348`
