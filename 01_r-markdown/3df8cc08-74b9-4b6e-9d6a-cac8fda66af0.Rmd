...
- **Keywords.de** `['stimmungsbilder', 'stzh', 'geodaten', 'abstimmungsgerat', 'zufriedenheit', 'sachdaten', 'lora', 'nutzung', 'bedurfnisse', 'abstimmungen', 'einzeldaten', 'bevolkerung', 'punktdaten', 'geoportal', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-13T03:23:00.301313`
