...
- **Keywords.de** `['bevolkerung', 'einzeldaten', 'sachdaten', 'geoportal', 'bedurfnisse', 'abstimmungsgerat', 'stzh', 'stimmungsbilder', 'abstimmungen', 'lora', 'nutzung', 'geodaten', 'punktdaten', 'zufriedenheit', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-28T03:08:24.256997`
