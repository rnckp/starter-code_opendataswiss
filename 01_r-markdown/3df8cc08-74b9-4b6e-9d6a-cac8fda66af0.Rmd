...
- **Keywords.de** `['bevolkerung', 'abstimmungen', 'zufriedenheit', 'geodaten', 'einzeldaten', 'geoportal', 'stimmungsbilder', 'stzh', 'lora', 'abstimmungsgerat', 'nutzung', 'tabelle', 'bedurfnisse', 'punktdaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-24T03:39:03.545937`
