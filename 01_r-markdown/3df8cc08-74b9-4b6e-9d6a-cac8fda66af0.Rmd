...
- **Keywords.de** `['lora', 'stimmungsbilder', 'stzh', 'geodaten', 'punktdaten', 'bedurfnisse', 'geoportal', 'einzeldaten', 'bevolkerung', 'abstimmungen', 'abstimmungsgerat', 'zufriedenheit', 'sachdaten', 'tabelle', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-09T03:28:37.438091`
