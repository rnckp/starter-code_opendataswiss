...
- **Keywords.de** `['geodaten', 'abstimmungsgerat', 'einzeldaten', 'stzh', 'zufriedenheit', 'bevolkerung', 'abstimmungen', 'tabelle', 'bedurfnisse', 'punktdaten', 'lora', 'stimmungsbilder', 'geoportal', 'sachdaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-16T03:17:44.252434`
