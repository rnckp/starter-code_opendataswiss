...
- **Keywords.de** `['einzeldaten', 'geoportal', 'geodaten', 'abstimmungsgerat', 'stzh', 'nutzung', 'bedurfnisse', 'punktdaten', 'sachdaten', 'tabelle', 'stimmungsbilder', 'abstimmungen', 'zufriedenheit', 'lora', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-08T02:52:07.086080`
