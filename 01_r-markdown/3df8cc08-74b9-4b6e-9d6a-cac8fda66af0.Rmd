...
- **Keywords.de** `['nutzung', 'stzh', 'abstimmungen', 'geoportal', 'punktdaten', 'geodaten', 'bedurfnisse', 'abstimmungsgerat', 'bevolkerung', 'stimmungsbilder', 'lora', 'einzeldaten', 'tabelle', 'zufriedenheit', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-20T02:14:43.353659`
