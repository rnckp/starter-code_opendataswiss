...
- **Keywords.de** `['tabelle', 'zufriedenheit', 'nutzung', 'sachdaten', 'bedurfnisse', 'geodaten', 'punktdaten', 'stimmungsbilder', 'abstimmungen', 'bevolkerung', 'einzeldaten', 'geoportal', 'lora', 'stzh', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-01T03:48:44.172642`
