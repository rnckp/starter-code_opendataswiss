...
- **Keywords.de** `['stzh', 'bedurfnisse', 'sachdaten', 'zufriedenheit', 'geodaten', 'stimmungsbilder', 'abstimmungen', 'abstimmungsgerat', 'einzeldaten', 'geoportal', 'nutzung', 'punktdaten', 'tabelle', 'bevolkerung', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-19T04:01:46.260202`
