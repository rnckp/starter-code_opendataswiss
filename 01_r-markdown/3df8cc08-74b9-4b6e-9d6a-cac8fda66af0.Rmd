...
- **Keywords.de** `['zufriedenheit', 'bevolkerung', 'tabelle', 'punktdaten', 'nutzung', 'sachdaten', 'geodaten', 'abstimmungsgerat', 'einzeldaten', 'lora', 'stimmungsbilder', 'geoportal', 'stzh', 'abstimmungen', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-17T03:12:44.306053`
