...
- **Keywords.de** `['nutzung', 'bedurfnisse', 'stzh', 'lora', 'bevolkerung', 'geoportal', 'einzeldaten', 'sachdaten', 'zufriedenheit', 'tabelle', 'stimmungsbilder', 'punktdaten', 'abstimmungen', 'abstimmungsgerat', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-27T04:45:51.762163`
