...
- **Keywords.de** `['nutzung', 'sachdaten', 'geoportal', 'abstimmungsgerat', 'bevolkerung', 'stzh', 'lora', 'zufriedenheit', 'geodaten', 'tabelle', 'einzeldaten', 'bedurfnisse', 'punktdaten', 'stimmungsbilder', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-26T03:47:54.284109`
