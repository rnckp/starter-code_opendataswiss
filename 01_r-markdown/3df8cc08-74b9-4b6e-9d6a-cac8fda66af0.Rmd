...
- **Keywords.de** `['nutzung', 'stzh', 'geodaten', 'zufriedenheit', 'bevolkerung', 'bedurfnisse', 'abstimmungsgerat', 'geoportal', 'stimmungsbilder', 'abstimmungen', 'sachdaten', 'tabelle', 'lora', 'einzeldaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-13T04:02:31.993602`
