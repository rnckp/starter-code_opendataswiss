...
- **Keywords.de** `['nutzung', 'bedurfnisse', 'geodaten', 'tabelle', 'punktdaten', 'abstimmungsgerat', 'sachdaten', 'lora', 'abstimmungen', 'stzh', 'einzeldaten', 'geoportal', 'zufriedenheit', 'bevolkerung', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-12T02:56:20.300856`
