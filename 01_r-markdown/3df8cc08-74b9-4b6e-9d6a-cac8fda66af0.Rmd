...
- **Keywords.de** `['zufriedenheit', 'bedurfnisse', 'tabelle', 'abstimmungen', 'geoportal', 'lora', 'geodaten', 'bevolkerung', 'stimmungsbilder', 'stzh', 'abstimmungsgerat', 'nutzung', 'punktdaten', 'einzeldaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-28T04:03:38.342210`
