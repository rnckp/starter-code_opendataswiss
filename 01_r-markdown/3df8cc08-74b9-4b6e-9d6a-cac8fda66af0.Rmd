...
- **Keywords.de** `['stimmungsbilder', 'nutzung', 'sachdaten', 'abstimmungen', 'einzeldaten', 'tabelle', 'bevolkerung', 'lora', 'bedurfnisse', 'geoportal', 'punktdaten', 'abstimmungsgerat', 'stzh', 'zufriedenheit', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-14T02:56:45.514807`
