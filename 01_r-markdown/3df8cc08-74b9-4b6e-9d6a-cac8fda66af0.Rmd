...
- **Keywords.de** `['punktdaten', 'einzeldaten', 'geoportal', 'bevolkerung', 'tabelle', 'bedurfnisse', 'lora', 'nutzung', 'abstimmungsgerat', 'geodaten', 'zufriedenheit', 'stzh', 'stimmungsbilder', 'sachdaten', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-10T03:07:32.967438`
