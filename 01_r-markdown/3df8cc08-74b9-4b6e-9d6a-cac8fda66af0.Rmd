...
- **Keywords.de** `['lora', 'bevolkerung', 'bedurfnisse', 'nutzung', 'abstimmungsgerat', 'geoportal', 'punktdaten', 'abstimmungen', 'sachdaten', 'geodaten', 'stzh', 'zufriedenheit', 'tabelle', 'stimmungsbilder', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-28T03:08:38.868622`
