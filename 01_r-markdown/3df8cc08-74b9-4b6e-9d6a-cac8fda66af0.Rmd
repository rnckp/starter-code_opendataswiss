...
- **Keywords.de** `['zufriedenheit', 'stimmungsbilder', 'lora', 'sachdaten', 'nutzung', 'geodaten', 'geoportal', 'abstimmungsgerat', 'tabelle', 'stzh', 'einzeldaten', 'punktdaten', 'bedurfnisse', 'abstimmungen', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-22T03:37:08.054866`
