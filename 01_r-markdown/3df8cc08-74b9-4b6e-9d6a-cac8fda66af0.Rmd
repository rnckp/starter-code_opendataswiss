...
- **Keywords.de** `['sachdaten', 'bedurfnisse', 'einzeldaten', 'stzh', 'tabelle', 'nutzung', 'bevolkerung', 'zufriedenheit', 'geoportal', 'abstimmungen', 'abstimmungsgerat', 'lora', 'stimmungsbilder', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-18T03:55:39.463972`
