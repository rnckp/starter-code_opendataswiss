...
- **Keywords.de** `['tabelle', 'bedurfnisse', 'abstimmungen', 'einzeldaten', 'geoportal', 'stzh', 'punktdaten', 'abstimmungsgerat', 'geodaten', 'bevolkerung', 'sachdaten', 'zufriedenheit', 'stimmungsbilder', 'lora', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-20T03:45:48.451863`
