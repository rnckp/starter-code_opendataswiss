...
- **Keywords.de** `['stzh', 'zufriedenheit', 'tabelle', 'geoportal', 'einzeldaten', 'stimmungsbilder', 'lora', 'geodaten', 'abstimmungen', 'nutzung', 'bedurfnisse', 'abstimmungsgerat', 'bevolkerung', 'punktdaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-29T04:05:13.275895`
