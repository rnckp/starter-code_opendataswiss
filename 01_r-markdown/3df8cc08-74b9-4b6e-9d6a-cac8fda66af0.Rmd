...
- **Keywords.de** `['abstimmungsgerat', 'abstimmungen', 'tabelle', 'stzh', 'geodaten', 'sachdaten', 'geoportal', 'einzeldaten', 'bevolkerung', 'punktdaten', 'stimmungsbilder', 'nutzung', 'zufriedenheit', 'bedurfnisse', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-26T02:53:14.621285`
