...
- **Keywords.de** `['geoportal', 'stzh', 'sachdaten', 'punktdaten', 'zufriedenheit', 'tabelle', 'einzeldaten', 'abstimmungsgerat', 'geodaten', 'bedurfnisse', 'abstimmungen', 'bevolkerung', 'stimmungsbilder', 'nutzung', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-08T03:08:53.182309`
