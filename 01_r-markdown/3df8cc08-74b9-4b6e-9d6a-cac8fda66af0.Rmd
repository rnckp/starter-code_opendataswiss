...
- **Keywords.de** `['stzh', 'geoportal', 'bedurfnisse', 'stimmungsbilder', 'geodaten', 'einzeldaten', 'lora', 'tabelle', 'bevolkerung', 'abstimmungen', 'abstimmungsgerat', 'sachdaten', 'nutzung', 'punktdaten', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-12T03:36:36.531994`
