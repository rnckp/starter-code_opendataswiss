...
- **Keywords.de** `['stimmungsbilder', 'nutzung', 'einzeldaten', 'bedurfnisse', 'lora', 'punktdaten', 'sachdaten', 'zufriedenheit', 'geodaten', 'abstimmungsgerat', 'stzh', 'bevolkerung', 'geoportal', 'abstimmungen', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-03T02:51:55.778810`
