...
- **Keywords.de** `['bevolkerung', 'lora', 'geodaten', 'stimmungsbilder', 'stzh', 'einzeldaten', 'abstimmungen', 'punktdaten', 'abstimmungsgerat', 'sachdaten', 'zufriedenheit', 'bedurfnisse', 'nutzung', 'geoportal', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-27T03:06:37.113059`
