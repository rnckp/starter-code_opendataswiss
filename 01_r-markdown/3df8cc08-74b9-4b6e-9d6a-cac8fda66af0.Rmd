...
- **Keywords.de** `['einzeldaten', 'sachdaten', 'tabelle', 'abstimmungen', 'geoportal', 'stzh', 'abstimmungsgerat', 'geodaten', 'bedurfnisse', 'nutzung', 'zufriedenheit', 'punktdaten', 'lora', 'stimmungsbilder', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-06T05:55:45.051290`
