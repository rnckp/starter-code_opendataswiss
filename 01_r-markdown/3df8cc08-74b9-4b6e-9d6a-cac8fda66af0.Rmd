...
- **Keywords.de** `['geodaten', 'nutzung', 'abstimmungsgerat', 'geoportal', 'tabelle', 'sachdaten', 'einzeldaten', 'zufriedenheit', 'abstimmungen', 'lora', 'stzh', 'bevolkerung', 'punktdaten', 'stimmungsbilder', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-03T03:18:04.657027`
