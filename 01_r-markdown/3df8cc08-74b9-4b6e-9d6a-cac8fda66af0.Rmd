...
- **Keywords.de** `['stzh', 'bedurfnisse', 'abstimmungsgerat', 'lora', 'geoportal', 'abstimmungen', 'tabelle', 'nutzung', 'punktdaten', 'geodaten', 'sachdaten', 'stimmungsbilder', 'bevolkerung', 'zufriedenheit', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-31T03:24:16.118854`
