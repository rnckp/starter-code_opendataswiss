...
- **Keywords.de** `['stzh', 'einzeldaten', 'geodaten', 'bedurfnisse', 'abstimmungen', 'nutzung', 'lora', 'abstimmungsgerat', 'stimmungsbilder', 'bevolkerung', 'zufriedenheit', 'sachdaten', 'tabelle', 'punktdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-31T03:25:03.475159`
