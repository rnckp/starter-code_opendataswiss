...
- **Keywords.de** `['lora', 'zufriedenheit', 'geodaten', 'abstimmungsgerat', 'nutzung', 'bevolkerung', 'sachdaten', 'punktdaten', 'geoportal', 'stimmungsbilder', 'bedurfnisse', 'einzeldaten', 'stzh', 'tabelle', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-16T03:46:36.568765`
