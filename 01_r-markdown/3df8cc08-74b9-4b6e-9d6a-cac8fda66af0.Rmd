...
- **Keywords.de** `['geodaten', 'geoportal', 'sachdaten', 'abstimmungen', 'punktdaten', 'bedurfnisse', 'lora', 'nutzung', 'bevolkerung', 'einzeldaten', 'zufriedenheit', 'stzh', 'stimmungsbilder', 'abstimmungsgerat', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-09T03:44:57.817461`
