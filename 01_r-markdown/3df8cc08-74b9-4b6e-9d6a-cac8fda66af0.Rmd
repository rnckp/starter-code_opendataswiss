...
- **Keywords.de** `['geoportal', 'lora', 'tabelle', 'abstimmungen', 'punktdaten', 'sachdaten', 'zufriedenheit', 'abstimmungsgerat', 'bedurfnisse', 'stimmungsbilder', 'bevolkerung', 'geodaten', 'einzeldaten', 'nutzung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-26T03:23:49.116681`
