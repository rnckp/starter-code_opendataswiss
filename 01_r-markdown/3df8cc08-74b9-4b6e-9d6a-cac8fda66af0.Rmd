...
- **Keywords.de** `['bevolkerung', 'lora', 'sachdaten', 'geoportal', 'nutzung', 'bedurfnisse', 'abstimmungsgerat', 'zufriedenheit', 'abstimmungen', 'punktdaten', 'tabelle', 'einzeldaten', 'stimmungsbilder', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-15T03:33:42.029768`
