...
- **Keywords.de** `['geoportal', 'sachdaten', 'tabelle', 'stzh', 'lora', 'einzeldaten', 'bedurfnisse', 'punktdaten', 'bevolkerung', 'abstimmungsgerat', 'geodaten', 'zufriedenheit', 'nutzung', 'stimmungsbilder', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-22T02:52:03.072178`
