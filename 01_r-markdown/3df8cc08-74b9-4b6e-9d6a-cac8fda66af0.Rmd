...
- **Keywords.de** `['geodaten', 'tabelle', 'stzh', 'zufriedenheit', 'stimmungsbilder', 'geoportal', 'sachdaten', 'nutzung', 'abstimmungsgerat', 'bedurfnisse', 'einzeldaten', 'punktdaten', 'bevolkerung', 'lora', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-22T02:55:49.865548`
