...
- **Keywords.de** `['stimmungsbilder', 'geodaten', 'lora', 'abstimmungsgerat', 'sachdaten', 'einzeldaten', 'stzh', 'tabelle', 'abstimmungen', 'geoportal', 'bevolkerung', 'zufriedenheit', 'nutzung', 'bedurfnisse', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-13T04:01:35.482265`
