...
- **Keywords.de** `['abstimmungsgerat', 'zufriedenheit', 'punktdaten', 'sachdaten', 'tabelle', 'stzh', 'nutzung', 'bedurfnisse', 'geodaten', 'einzeldaten', 'bevolkerung', 'stimmungsbilder', 'lora', 'abstimmungen', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-06T03:51:05.332891`
