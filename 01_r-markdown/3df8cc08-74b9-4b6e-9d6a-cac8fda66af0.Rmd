...
- **Keywords.de** `['stimmungsbilder', 'tabelle', 'abstimmungsgerat', 'einzeldaten', 'geodaten', 'stzh', 'bedurfnisse', 'lora', 'nutzung', 'geoportal', 'abstimmungen', 'punktdaten', 'zufriedenheit', 'sachdaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-03T03:55:08.866505`
