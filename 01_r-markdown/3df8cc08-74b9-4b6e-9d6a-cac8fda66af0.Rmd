...
- **Keywords.de** `['stzh', 'bedurfnisse', 'zufriedenheit', 'geoportal', 'bevolkerung', 'lora', 'stimmungsbilder', 'nutzung', 'abstimmungen', 'einzeldaten', 'tabelle', 'geodaten', 'punktdaten', 'abstimmungsgerat', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-19T02:07:08.409611`
