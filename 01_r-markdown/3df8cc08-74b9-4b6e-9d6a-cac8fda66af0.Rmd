...
- **Keywords.de** `['stzh', 'zufriedenheit', 'abstimmungen', 'einzeldaten', 'geoportal', 'nutzung', 'stimmungsbilder', 'bedurfnisse', 'abstimmungsgerat', 'bevolkerung', 'lora', 'geodaten', 'tabelle', 'punktdaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-14T03:27:11.662446`
