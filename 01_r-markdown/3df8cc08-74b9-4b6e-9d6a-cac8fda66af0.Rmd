...
- **Keywords.de** `['zufriedenheit', 'abstimmungsgerat', 'punktdaten', 'sachdaten', 'bevolkerung', 'geoportal', 'lora', 'tabelle', 'abstimmungen', 'stimmungsbilder', 'einzeldaten', 'nutzung', 'geodaten', 'stzh', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-26T02:58:43.467746`
