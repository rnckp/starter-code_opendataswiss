...
- **Keywords.de** `['nutzung', 'bevolkerung', 'zufriedenheit', 'abstimmungsgerat', 'lora', 'geoportal', 'stimmungsbilder', 'abstimmungen', 'stzh', 'einzeldaten', 'punktdaten', 'bedurfnisse', 'geodaten', 'sachdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-03T03:06:36.474532`
