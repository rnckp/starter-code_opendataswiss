...
- **Keywords.de** `['sachdaten', 'tabelle', 'abstimmungsgerat', 'nutzung', 'lora', 'bedurfnisse', 'einzeldaten', 'zufriedenheit', 'bevolkerung', 'geodaten', 'abstimmungen', 'stzh', 'stimmungsbilder', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-17T04:28:44.825769`
