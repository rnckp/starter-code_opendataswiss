...
- **Keywords.de** `['zufriedenheit', 'bedurfnisse', 'stzh', 'lora', 'abstimmungsgerat', 'bevolkerung', 'geodaten', 'tabelle', 'sachdaten', 'geoportal', 'abstimmungen', 'punktdaten', 'stimmungsbilder', 'nutzung', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-26T02:54:30.098465`
