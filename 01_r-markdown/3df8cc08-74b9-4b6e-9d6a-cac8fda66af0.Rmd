...
- **Keywords.de** `['einzeldaten', 'nutzung', 'bedurfnisse', 'geoportal', 'geodaten', 'lora', 'punktdaten', 'stimmungsbilder', 'abstimmungen', 'sachdaten', 'tabelle', 'stzh', 'abstimmungsgerat', 'zufriedenheit', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-29T03:25:03.662110`
