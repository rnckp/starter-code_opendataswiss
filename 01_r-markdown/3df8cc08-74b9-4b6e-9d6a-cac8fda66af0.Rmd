...
- **Keywords.de** `['abstimmungen', 'nutzung', 'zufriedenheit', 'lora', 'punktdaten', 'geoportal', 'stzh', 'einzeldaten', 'geodaten', 'sachdaten', 'stimmungsbilder', 'bedurfnisse', 'abstimmungsgerat', 'bevolkerung', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-12T05:23:50.692915`
