...
- **Keywords.de** `['bevolkerung', 'einzeldaten', 'punktdaten', 'nutzung', 'lora', 'zufriedenheit', 'tabelle', 'stzh', 'abstimmungsgerat', 'geoportal', 'geodaten', 'abstimmungen', 'bedurfnisse', 'sachdaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-02T04:19:32.675018`
