...
- **Keywords.de** `['geodaten', 'stzh', 'nutzung', 'stimmungsbilder', 'bedurfnisse', 'geoportal', 'zufriedenheit', 'bevolkerung', 'punktdaten', 'abstimmungsgerat', 'tabelle', 'lora', 'sachdaten', 'abstimmungen', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-08T04:58:41.038892`
