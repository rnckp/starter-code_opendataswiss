...
- **Keywords.de** `['abstimmungen', 'geoportal', 'stimmungsbilder', 'tabelle', 'bevolkerung', 'punktdaten', 'zufriedenheit', 'bedurfnisse', 'lora', 'einzeldaten', 'abstimmungsgerat', 'nutzung', 'stzh', 'sachdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-28T03:44:51.866772`
