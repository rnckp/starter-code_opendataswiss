...
- **Keywords.de** `['punktdaten', 'sachdaten', 'geodaten', 'einzeldaten', 'geoportal', 'zufriedenheit', 'stzh', 'stimmungsbilder', 'tabelle', 'bevolkerung', 'abstimmungsgerat', 'bedurfnisse', 'lora', 'abstimmungen', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-29T02:53:46.362514`
