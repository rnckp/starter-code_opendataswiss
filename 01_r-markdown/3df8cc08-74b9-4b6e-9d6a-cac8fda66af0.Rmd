...
- **Keywords.de** `['abstimmungsgerat', 'einzeldaten', 'lora', 'sachdaten', 'stzh', 'nutzung', 'tabelle', 'bevolkerung', 'zufriedenheit', 'geodaten', 'bedurfnisse', 'punktdaten', 'abstimmungen', 'stimmungsbilder', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-30T03:41:32.236385`
