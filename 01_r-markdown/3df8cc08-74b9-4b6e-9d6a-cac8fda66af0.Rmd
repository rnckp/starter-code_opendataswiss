...
- **Keywords.de** `['lora', 'stimmungsbilder', 'punktdaten', 'abstimmungen', 'geodaten', 'sachdaten', 'bedurfnisse', 'nutzung', 'abstimmungsgerat', 'geoportal', 'tabelle', 'stzh', 'zufriedenheit', 'einzeldaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-25T03:21:40.361838`
