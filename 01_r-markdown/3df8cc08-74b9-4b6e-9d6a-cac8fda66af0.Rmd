...
- **Keywords.de** `['zufriedenheit', 'stzh', 'bevolkerung', 'einzeldaten', 'sachdaten', 'abstimmungsgerat', 'lora', 'geoportal', 'tabelle', 'abstimmungen', 'stimmungsbilder', 'punktdaten', 'bedurfnisse', 'geodaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-31T03:25:42.387791`
