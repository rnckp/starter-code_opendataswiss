...
- **Keywords.de** `['geoportal', 'stimmungsbilder', 'abstimmungen', 'zufriedenheit', 'punktdaten', 'bevolkerung', 'nutzung', 'abstimmungsgerat', 'tabelle', 'geodaten', 'sachdaten', 'lora', 'einzeldaten', 'stzh', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-24T02:16:28.700578`
