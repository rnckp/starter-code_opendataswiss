...
- **Keywords.de** `['bevolkerung', 'punktdaten', 'sachdaten', 'abstimmungen', 'nutzung', 'zufriedenheit', 'geoportal', 'abstimmungsgerat', 'bedurfnisse', 'stimmungsbilder', 'einzeldaten', 'tabelle', 'geodaten', 'lora', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-19T02:58:42.700856`
