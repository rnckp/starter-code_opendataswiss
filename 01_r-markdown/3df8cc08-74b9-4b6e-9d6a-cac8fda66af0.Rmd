...
- **Keywords.de** `['abstimmungen', 'stzh', 'nutzung', 'punktdaten', 'sachdaten', 'bedurfnisse', 'bevolkerung', 'tabelle', 'stimmungsbilder', 'zufriedenheit', 'geodaten', 'geoportal', 'abstimmungsgerat', 'lora', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-21T03:54:42.281745`
