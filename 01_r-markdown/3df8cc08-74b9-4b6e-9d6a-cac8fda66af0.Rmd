...
- **Keywords.de** `['lora', 'geoportal', 'einzeldaten', 'tabelle', 'zufriedenheit', 'punktdaten', 'bevolkerung', 'sachdaten', 'stimmungsbilder', 'stzh', 'bedurfnisse', 'nutzung', 'abstimmungsgerat', 'abstimmungen', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-14T03:15:43.025594`
