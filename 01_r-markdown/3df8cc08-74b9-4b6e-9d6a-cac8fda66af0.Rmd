...
- **Keywords.de** `['nutzung', 'einzeldaten', 'punktdaten', 'abstimmungsgerat', 'tabelle', 'stzh', 'stimmungsbilder', 'sachdaten', 'zufriedenheit', 'abstimmungen', 'bedurfnisse', 'geoportal', 'bevolkerung', 'geodaten', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-14T03:49:31.004886`
