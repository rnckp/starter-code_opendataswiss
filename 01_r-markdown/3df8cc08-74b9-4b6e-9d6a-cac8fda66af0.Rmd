...
- **Keywords.de** `['einzeldaten', 'nutzung', 'abstimmungsgerat', 'lora', 'sachdaten', 'zufriedenheit', 'punktdaten', 'bevolkerung', 'tabelle', 'stimmungsbilder', 'geodaten', 'geoportal', 'stzh', 'bedurfnisse', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-23T04:09:35.110632`
