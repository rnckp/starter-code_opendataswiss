...
- **Keywords.de** `['punktdaten', 'lora', 'einzeldaten', 'stzh', 'abstimmungen', 'sachdaten', 'geodaten', 'zufriedenheit', 'geoportal', 'nutzung', 'abstimmungsgerat', 'bevolkerung', 'tabelle', 'bedurfnisse', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-07T03:22:48.467773`
