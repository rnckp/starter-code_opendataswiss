...
- **Keywords.de** `['stimmungsbilder', 'abstimmungsgerat', 'geodaten', 'lora', 'abstimmungen', 'stzh', 'nutzung', 'sachdaten', 'punktdaten', 'bedurfnisse', 'einzeldaten', 'tabelle', 'zufriedenheit', 'geoportal', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-16T03:19:11.102220`
