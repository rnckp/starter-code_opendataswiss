...
- **Keywords.de** `['bevolkerung', 'sachdaten', 'geoportal', 'abstimmungen', 'stimmungsbilder', 'nutzung', 'lora', 'geodaten', 'bedurfnisse', 'stzh', 'zufriedenheit', 'einzeldaten', 'tabelle', 'abstimmungsgerat', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-15T03:48:31.383978`
