...
- **Keywords.de** `['bevolkerung', 'lora', 'geoportal', 'stimmungsbilder', 'sachdaten', 'bedurfnisse', 'stzh', 'zufriedenheit', 'einzeldaten', 'punktdaten', 'abstimmungsgerat', 'nutzung', 'tabelle', 'geodaten', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-11T03:29:32.584056`
