...
- **Keywords.de** `['geodaten', 'punktdaten', 'abstimmungen', 'tabelle', 'nutzung', 'geoportal', 'abstimmungsgerat', 'stzh', 'zufriedenheit', 'stimmungsbilder', 'bedurfnisse', 'bevolkerung', 'sachdaten', 'lora', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-30T03:06:50.345420`
