...
- **Keywords.de** `['bedurfnisse', 'abstimmungen', 'zufriedenheit', 'stzh', 'punktdaten', 'tabelle', 'abstimmungsgerat', 'lora', 'nutzung', 'einzeldaten', 'sachdaten', 'geodaten', 'bevolkerung', 'stimmungsbilder', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-01T02:53:15.047815`
