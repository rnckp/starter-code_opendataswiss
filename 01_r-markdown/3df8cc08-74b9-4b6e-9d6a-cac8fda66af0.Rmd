...
- **Keywords.de** `['zufriedenheit', 'sachdaten', 'punktdaten', 'einzeldaten', 'lora', 'abstimmungen', 'geoportal', 'nutzung', 'tabelle', 'bevolkerung', 'geodaten', 'stimmungsbilder', 'bedurfnisse', 'stzh', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-04T03:23:31.693140`
