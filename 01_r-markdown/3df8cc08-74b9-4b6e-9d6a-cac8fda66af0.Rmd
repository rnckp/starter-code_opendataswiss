...
- **Keywords.de** `['lora', 'sachdaten', 'punktdaten', 'nutzung', 'stimmungsbilder', 'stzh', 'geoportal', 'abstimmungen', 'zufriedenheit', 'bevolkerung', 'bedurfnisse', 'geodaten', 'einzeldaten', 'tabelle', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-12T03:35:49.647802`
