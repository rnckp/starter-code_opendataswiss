...
- **Keywords.de** `['einzeldaten', 'bedurfnisse', 'geoportal', 'nutzung', 'stimmungsbilder', 'tabelle', 'stzh', 'punktdaten', 'geodaten', 'bevolkerung', 'abstimmungsgerat', 'sachdaten', 'zufriedenheit', 'abstimmungen', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-02T03:28:58.646144`
