...
- **Keywords.de** `['tabelle', 'geodaten', 'sachdaten', 'bevolkerung', 'lora', 'bedurfnisse', 'stimmungsbilder', 'zufriedenheit', 'abstimmungen', 'abstimmungsgerat', 'nutzung', 'einzeldaten', 'stzh', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-22T02:50:32.247126`
