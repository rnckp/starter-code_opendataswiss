...
- **Keywords.de** `['stzh', 'abstimmungsgerat', 'stimmungsbilder', 'geoportal', 'punktdaten', 'tabelle', 'sachdaten', 'geodaten', 'zufriedenheit', 'bevolkerung', 'lora', 'bedurfnisse', 'abstimmungen', 'nutzung', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-02T02:36:16.268665`
