...
- **Keywords.de** `['geoportal', 'lora', 'bevolkerung', 'bedurfnisse', 'stimmungsbilder', 'sachdaten', 'einzeldaten', 'tabelle', 'punktdaten', 'zufriedenheit', 'abstimmungsgerat', 'stzh', 'abstimmungen', 'geodaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-11T03:20:30.141193`
