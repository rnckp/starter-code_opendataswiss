...
- **Keywords.de** `['sachdaten', 'stzh', 'zufriedenheit', 'stimmungsbilder', 'einzeldaten', 'tabelle', 'bedurfnisse', 'abstimmungsgerat', 'abstimmungen', 'lora', 'bevolkerung', 'geodaten', 'geoportal', 'punktdaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-21T03:11:40.264204`
