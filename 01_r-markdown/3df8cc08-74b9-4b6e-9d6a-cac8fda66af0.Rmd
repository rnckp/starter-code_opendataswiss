...
- **Keywords.de** `['tabelle', 'geoportal', 'punktdaten', 'abstimmungen', 'stzh', 'abstimmungsgerat', 'geodaten', 'sachdaten', 'zufriedenheit', 'lora', 'bedurfnisse', 'stimmungsbilder', 'nutzung', 'einzeldaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-08T03:11:16.681897`
