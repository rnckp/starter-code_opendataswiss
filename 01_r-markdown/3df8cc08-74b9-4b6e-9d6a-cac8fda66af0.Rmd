...
- **Keywords.de** `['punktdaten', 'sachdaten', 'abstimmungsgerat', 'geodaten', 'tabelle', 'bevolkerung', 'stzh', 'lora', 'geoportal', 'stimmungsbilder', 'nutzung', 'bedurfnisse', 'einzeldaten', 'abstimmungen', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-27T03:11:30.275175`
