...
- **Keywords.de** `['abstimmungsgerat', 'geoportal', 'lora', 'tabelle', 'abstimmungen', 'stzh', 'punktdaten', 'geodaten', 'zufriedenheit', 'bevolkerung', 'einzeldaten', 'nutzung', 'stimmungsbilder', 'bedurfnisse', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-04T03:36:23.020943`
