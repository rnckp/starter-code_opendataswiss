...
- **Keywords.de** `['sachdaten', 'abstimmungsgerat', 'bevolkerung', 'bedurfnisse', 'stimmungsbilder', 'nutzung', 'einzeldaten', 'geodaten', 'abstimmungen', 'lora', 'stzh', 'geoportal', 'tabelle', 'punktdaten', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-27T03:25:16.323635`
