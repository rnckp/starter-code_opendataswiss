...
- **Keywords.de** `['geoportal', 'abstimmungsgerat', 'abstimmungen', 'lora', 'bedurfnisse', 'punktdaten', 'einzeldaten', 'geodaten', 'bevolkerung', 'zufriedenheit', 'sachdaten', 'nutzung', 'tabelle', 'stimmungsbilder', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-26T03:16:24.490910`
