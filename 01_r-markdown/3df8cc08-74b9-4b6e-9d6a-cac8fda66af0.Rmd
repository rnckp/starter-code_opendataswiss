...
- **Keywords.de** `['geoportal', 'stzh', 'stimmungsbilder', 'zufriedenheit', 'abstimmungsgerat', 'sachdaten', 'nutzung', 'bedurfnisse', 'abstimmungen', 'tabelle', 'bevolkerung', 'einzeldaten', 'punktdaten', 'lora', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-13T03:44:44.069284`
