...
- **Keywords.de** `['bevolkerung', 'einzeldaten', 'bedurfnisse', 'nutzung', 'geodaten', 'sachdaten', 'abstimmungen', 'geoportal', 'lora', 'stzh', 'abstimmungsgerat', 'punktdaten', 'tabelle', 'zufriedenheit', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-05T03:06:16.216055`
