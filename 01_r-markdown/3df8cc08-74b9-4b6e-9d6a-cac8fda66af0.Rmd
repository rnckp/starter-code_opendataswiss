...
- **Keywords.de** `['stimmungsbilder', 'lora', 'sachdaten', 'abstimmungen', 'stzh', 'zufriedenheit', 'punktdaten', 'bevolkerung', 'nutzung', 'einzeldaten', 'abstimmungsgerat', 'geodaten', 'tabelle', 'geoportal', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-27T02:59:50.050751`
