...
- **Keywords.de** `['stzh', 'geodaten', 'lora', 'geoportal', 'bevolkerung', 'stimmungsbilder', 'nutzung', 'abstimmungsgerat', 'abstimmungen', 'tabelle', 'sachdaten', 'einzeldaten', 'zufriedenheit', 'punktdaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-03T02:31:38.389461`
