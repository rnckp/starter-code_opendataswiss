...
- **Keywords.de** `['lora', 'geodaten', 'stzh', 'abstimmungen', 'sachdaten', 'stimmungsbilder', 'einzeldaten', 'bedurfnisse', 'tabelle', 'zufriedenheit', 'nutzung', 'abstimmungsgerat', 'geoportal', 'punktdaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-09T03:20:01.060795`
