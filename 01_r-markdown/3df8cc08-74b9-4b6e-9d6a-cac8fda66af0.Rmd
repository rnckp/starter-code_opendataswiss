...
- **Keywords.de** `['sachdaten', 'nutzung', 'geoportal', 'lora', 'geodaten', 'bedurfnisse', 'tabelle', 'zufriedenheit', 'einzeldaten', 'bevolkerung', 'abstimmungsgerat', 'stimmungsbilder', 'abstimmungen', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-19T02:55:46.903861`
