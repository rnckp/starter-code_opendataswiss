...
- **Keywords.de** `['stzh', 'stimmungsbilder', 'abstimmungen', 'bedurfnisse', 'einzeldaten', 'geoportal', 'geodaten', 'sachdaten', 'bevolkerung', 'lora', 'zufriedenheit', 'abstimmungsgerat', 'punktdaten', 'nutzung', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-12T03:45:06.978207`
