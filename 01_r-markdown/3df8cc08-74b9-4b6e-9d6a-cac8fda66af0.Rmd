...
- **Keywords.de** `['stzh', 'bedurfnisse', 'abstimmungsgerat', 'tabelle', 'bevolkerung', 'geoportal', 'geodaten', 'punktdaten', 'stimmungsbilder', 'einzeldaten', 'zufriedenheit', 'lora', 'sachdaten', 'abstimmungen', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-04T02:56:38.430195`
