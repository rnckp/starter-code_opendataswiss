...
- **Keywords.de** `['abstimmungsgerat', 'sachdaten', 'lora', 'punktdaten', 'geoportal', 'stimmungsbilder', 'bevolkerung', 'nutzung', 'einzeldaten', 'abstimmungen', 'stzh', 'zufriedenheit', 'geodaten', 'tabelle', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-27T03:56:09.036513`
