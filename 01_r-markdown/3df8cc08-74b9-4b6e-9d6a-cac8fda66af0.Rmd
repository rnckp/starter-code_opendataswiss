...
- **Keywords.de** `['punktdaten', 'tabelle', 'abstimmungen', 'stzh', 'nutzung', 'bedurfnisse', 'zufriedenheit', 'geoportal', 'sachdaten', 'lora', 'einzeldaten', 'abstimmungsgerat', 'stimmungsbilder', 'bevolkerung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-28T03:23:09.736996`
