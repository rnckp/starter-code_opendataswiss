...
- **Keywords.de** `['geoportal', 'tabelle', 'lora', 'bevolkerung', 'stzh', 'punktdaten', 'geodaten', 'einzeldaten', 'zufriedenheit', 'abstimmungsgerat', 'abstimmungen', 'bedurfnisse', 'nutzung', 'sachdaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-12T03:28:07.769206`
