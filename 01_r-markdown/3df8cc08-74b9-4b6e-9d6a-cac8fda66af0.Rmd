...
- **Keywords.de** `['stzh', 'lora', 'geodaten', 'einzeldaten', 'sachdaten', 'bevolkerung', 'abstimmungsgerat', 'geoportal', 'bedurfnisse', 'nutzung', 'stimmungsbilder', 'abstimmungen', 'tabelle', 'punktdaten', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-18T03:19:57.480717`
