...
- **Keywords.de** `['punktdaten', 'tabelle', 'bedurfnisse', 'nutzung', 'abstimmungen', 'sachdaten', 'lora', 'einzeldaten', 'geodaten', 'stimmungsbilder', 'bevolkerung', 'geoportal', 'stzh', 'zufriedenheit', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-18T02:14:54.207366`
