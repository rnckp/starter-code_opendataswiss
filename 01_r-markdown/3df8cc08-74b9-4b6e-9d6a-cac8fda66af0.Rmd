...
- **Keywords.de** `['lora', 'zufriedenheit', 'abstimmungsgerat', 'abstimmungen', 'bevolkerung', 'geodaten', 'stimmungsbilder', 'bedurfnisse', 'einzeldaten', 'punktdaten', 'stzh', 'tabelle', 'nutzung', 'sachdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-25T03:48:56.119746`
