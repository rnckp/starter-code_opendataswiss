...
- **Keywords.de** `['abstimmungen', 'stzh', 'tabelle', 'bedurfnisse', 'stimmungsbilder', 'lora', 'zufriedenheit', 'abstimmungsgerat', 'nutzung', 'bevolkerung', 'sachdaten', 'punktdaten', 'einzeldaten', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-09T03:11:05.829465`
