...
- **Keywords.de** `['abstimmungen', 'bedurfnisse', 'nutzung', 'zufriedenheit', 'punktdaten', 'lora', 'bevolkerung', 'abstimmungsgerat', 'tabelle', 'stzh', 'einzeldaten', 'sachdaten', 'stimmungsbilder', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-29T03:38:43.841289`
