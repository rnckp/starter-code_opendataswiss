...
- **Keywords.de** `['tabelle', 'lora', 'geodaten', 'abstimmungsgerat', 'punktdaten', 'abstimmungen', 'bevolkerung', 'zufriedenheit', 'stzh', 'stimmungsbilder', 'sachdaten', 'nutzung', 'einzeldaten', 'geoportal', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-13T03:02:15.343900`
