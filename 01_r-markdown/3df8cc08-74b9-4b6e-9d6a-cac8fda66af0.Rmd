...
- **Keywords.de** `['einzeldaten', 'abstimmungsgerat', 'geoportal', 'nutzung', 'geodaten', 'sachdaten', 'lora', 'bevolkerung', 'bedurfnisse', 'stzh', 'zufriedenheit', 'punktdaten', 'stimmungsbilder', 'abstimmungen', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-05T04:17:46.557944`
