...
- **Keywords.de** `['abstimmungsgerat', 'geodaten', 'einzeldaten', 'punktdaten', 'bevolkerung', 'bedurfnisse', 'stzh', 'sachdaten', 'geoportal', 'zufriedenheit', 'abstimmungen', 'lora', 'stimmungsbilder', 'nutzung', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-22T03:30:12.043559`
