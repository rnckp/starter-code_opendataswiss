...
- **Keywords.de** `['zufriedenheit', 'lora', 'bedurfnisse', 'stimmungsbilder', 'abstimmungen', 'geodaten', 'stzh', 'bevolkerung', 'einzeldaten', 'tabelle', 'sachdaten', 'abstimmungsgerat', 'geoportal', 'nutzung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-11T03:30:16.128222`
