...
- **Keywords.de** `['stzh', 'stimmungsbilder', 'einzeldaten', 'nutzung', 'geoportal', 'bedurfnisse', 'abstimmungsgerat', 'lora', 'tabelle', 'sachdaten', 'zufriedenheit', 'bevolkerung', 'punktdaten', 'geodaten', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-19T03:32:36.839259`
