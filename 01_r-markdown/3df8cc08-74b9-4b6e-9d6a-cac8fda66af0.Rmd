...
- **Keywords.de** `['abstimmungsgerat', 'punktdaten', 'zufriedenheit', 'lora', 'stimmungsbilder', 'abstimmungen', 'bevolkerung', 'tabelle', 'einzeldaten', 'bedurfnisse', 'geoportal', 'stzh', 'nutzung', 'sachdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-28T02:48:28.512123`
