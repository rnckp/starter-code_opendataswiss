...
- **Keywords.de** `['bedurfnisse', 'stimmungsbilder', 'zufriedenheit', 'abstimmungsgerat', 'lora', 'abstimmungen', 'sachdaten', 'nutzung', 'stzh', 'geodaten', 'tabelle', 'punktdaten', 'einzeldaten', 'geoportal', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-30T03:48:35.257617`
