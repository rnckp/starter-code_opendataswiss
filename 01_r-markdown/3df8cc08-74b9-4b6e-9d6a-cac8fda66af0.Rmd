...
- **Keywords.de** `['punktdaten', 'nutzung', 'stimmungsbilder', 'abstimmungen', 'geodaten', 'lora', 'stzh', 'bedurfnisse', 'zufriedenheit', 'bevolkerung', 'tabelle', 'geoportal', 'sachdaten', 'einzeldaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-24T03:31:32.527163`
