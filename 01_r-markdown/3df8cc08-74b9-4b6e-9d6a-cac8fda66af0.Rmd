...
- **Keywords.de** `['punktdaten', 'abstimmungen', 'sachdaten', 'einzeldaten', 'abstimmungsgerat', 'bevolkerung', 'geoportal', 'tabelle', 'geodaten', 'lora', 'zufriedenheit', 'nutzung', 'bedurfnisse', 'stimmungsbilder', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-04T03:16:07.133694`
