...
- **Keywords.de** `['bedurfnisse', 'abstimmungen', 'bevolkerung', 'stzh', 'einzeldaten', 'sachdaten', 'geodaten', 'stimmungsbilder', 'nutzung', 'zufriedenheit', 'geoportal', 'lora', 'tabelle', 'abstimmungsgerat', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-15T02:55:02.541387`
