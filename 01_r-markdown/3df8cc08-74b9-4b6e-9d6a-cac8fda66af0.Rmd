...
- **Keywords.de** `['nutzung', 'stimmungsbilder', 'lora', 'geoportal', 'sachdaten', 'bedurfnisse', 'abstimmungsgerat', 'stzh', 'geodaten', 'zufriedenheit', 'einzeldaten', 'punktdaten', 'tabelle', 'bevolkerung', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-27T02:55:02.439592`
