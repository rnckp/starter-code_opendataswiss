...
- **Keywords.de** `['stimmungsbilder', 'lora', 'geoportal', 'zufriedenheit', 'geodaten', 'abstimmungen', 'sachdaten', 'nutzung', 'einzeldaten', 'abstimmungsgerat', 'stzh', 'bedurfnisse', 'bevolkerung', 'punktdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-23T03:06:02.862573`
