...
- **Keywords.de** `['lora', 'abstimmungen', 'sachdaten', 'nutzung', 'geoportal', 'zufriedenheit', 'abstimmungsgerat', 'bevolkerung', 'einzeldaten', 'tabelle', 'stzh', 'bedurfnisse', 'geodaten', 'stimmungsbilder', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-26T02:52:56.421303`
