...
- **Keywords.de** `['zufriedenheit', 'sachdaten', 'tabelle', 'abstimmungen', 'bedurfnisse', 'lora', 'geoportal', 'bevolkerung', 'nutzung', 'punktdaten', 'stimmungsbilder', 'geodaten', 'abstimmungsgerat', 'stzh', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-01T03:44:24.869815`
