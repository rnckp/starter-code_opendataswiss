...
- **Keywords.de** `['punktdaten', 'stimmungsbilder', 'lora', 'stzh', 'nutzung', 'einzeldaten', 'abstimmungsgerat', 'bedurfnisse', 'bevolkerung', 'zufriedenheit', 'geodaten', 'geoportal', 'sachdaten', 'tabelle', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-26T02:52:01.937755`
