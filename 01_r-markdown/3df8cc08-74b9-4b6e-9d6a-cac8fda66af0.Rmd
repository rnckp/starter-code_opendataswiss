...
- **Keywords.de** `['stimmungsbilder', 'lora', 'abstimmungsgerat', 'bevolkerung', 'einzeldaten', 'nutzung', 'zufriedenheit', 'sachdaten', 'tabelle', 'abstimmungen', 'punktdaten', 'stzh', 'bedurfnisse', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-18T03:32:38.904011`
