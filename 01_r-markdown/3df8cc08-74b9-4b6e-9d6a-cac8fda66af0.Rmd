...
- **Keywords.de** `['sachdaten', 'punktdaten', 'stzh', 'nutzung', 'einzeldaten', 'tabelle', 'zufriedenheit', 'abstimmungsgerat', 'geoportal', 'geodaten', 'abstimmungen', 'bedurfnisse', 'lora', 'bevolkerung', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-16T03:00:00.287636`
