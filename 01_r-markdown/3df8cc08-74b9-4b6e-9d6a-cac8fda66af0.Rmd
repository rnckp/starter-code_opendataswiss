...
- **Keywords.de** `['punktdaten', 'stimmungsbilder', 'bevolkerung', 'bedurfnisse', 'geoportal', 'zufriedenheit', 'abstimmungsgerat', 'tabelle', 'nutzung', 'stzh', 'abstimmungen', 'sachdaten', 'lora', 'einzeldaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-04T04:04:40.657083`
