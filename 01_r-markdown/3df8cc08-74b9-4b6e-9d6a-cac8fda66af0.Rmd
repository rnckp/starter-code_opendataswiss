...
- **Keywords.de** `['geoportal', 'bedurfnisse', 'sachdaten', 'zufriedenheit', 'geodaten', 'bevolkerung', 'abstimmungsgerat', 'nutzung', 'stimmungsbilder', 'punktdaten', 'tabelle', 'lora', 'einzeldaten', 'abstimmungen', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-10T03:30:25.027848`
