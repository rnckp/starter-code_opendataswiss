...
- **Keywords.de** `['bevolkerung', 'geoportal', 'punktdaten', 'stimmungsbilder', 'stzh', 'nutzung', 'lora', 'bedurfnisse', 'geodaten', 'zufriedenheit', 'einzeldaten', 'abstimmungsgerat', 'abstimmungen', 'sachdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-21T03:36:23.964214`
