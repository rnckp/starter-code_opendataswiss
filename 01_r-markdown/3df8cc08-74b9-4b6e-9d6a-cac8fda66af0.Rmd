...
- **Keywords.de** `['zufriedenheit', 'abstimmungen', 'tabelle', 'punktdaten', 'bevolkerung', 'einzeldaten', 'lora', 'nutzung', 'bedurfnisse', 'sachdaten', 'geodaten', 'stzh', 'abstimmungsgerat', 'geoportal', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-30T03:29:11.732035`
