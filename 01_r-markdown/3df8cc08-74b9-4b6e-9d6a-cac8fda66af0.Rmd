...
- **Keywords.de** `['geodaten', 'stimmungsbilder', 'bevolkerung', 'stzh', 'abstimmungsgerat', 'geoportal', 'abstimmungen', 'lora', 'nutzung', 'sachdaten', 'punktdaten', 'bedurfnisse', 'tabelle', 'zufriedenheit', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-08T02:32:02.052694`
