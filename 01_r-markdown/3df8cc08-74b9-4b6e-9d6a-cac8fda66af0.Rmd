...
- **Keywords.de** `['stzh', 'sachdaten', 'einzeldaten', 'geodaten', 'stimmungsbilder', 'abstimmungen', 'abstimmungsgerat', 'zufriedenheit', 'lora', 'geoportal', 'nutzung', 'bevolkerung', 'bedurfnisse', 'tabelle', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-26T03:31:30.869301`
