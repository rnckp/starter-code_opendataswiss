...
- **Keywords.de** `['geodaten', 'zufriedenheit', 'bevolkerung', 'sachdaten', 'geoportal', 'abstimmungsgerat', 'stimmungsbilder', 'abstimmungen', 'tabelle', 'punktdaten', 'bedurfnisse', 'einzeldaten', 'stzh', 'lora', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-10T03:41:05.322459`
