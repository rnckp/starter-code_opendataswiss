...
- **Keywords.de** `['lora', 'einzeldaten', 'zufriedenheit', 'bevolkerung', 'abstimmungen', 'geodaten', 'tabelle', 'sachdaten', 'bedurfnisse', 'stzh', 'nutzung', 'abstimmungsgerat', 'geoportal', 'punktdaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-20T02:51:16.934183`
