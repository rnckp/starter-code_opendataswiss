...
- **Keywords.de** `['stzh', 'stimmungsbilder', 'abstimmungen', 'lora', 'bevolkerung', 'abstimmungsgerat', 'zufriedenheit', 'tabelle', 'nutzung', 'punktdaten', 'geoportal', 'einzeldaten', 'geodaten', 'sachdaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-06T03:42:46.938197`
