...
- **Keywords.de** `['bevolkerung', 'zufriedenheit', 'sachdaten', 'einzeldaten', 'bedurfnisse', 'abstimmungen', 'stzh', 'lora', 'geoportal', 'stimmungsbilder', 'geodaten', 'nutzung', 'tabelle', 'punktdaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-10T05:12:45.488214`
