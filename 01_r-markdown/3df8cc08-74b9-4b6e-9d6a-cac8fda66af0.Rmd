...
- **Keywords.de** `['abstimmungsgerat', 'tabelle', 'stimmungsbilder', 'bedurfnisse', 'einzeldaten', 'geodaten', 'lora', 'nutzung', 'stzh', 'sachdaten', 'bevolkerung', 'punktdaten', 'zufriedenheit', 'abstimmungen', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-14T03:52:45.167406`
