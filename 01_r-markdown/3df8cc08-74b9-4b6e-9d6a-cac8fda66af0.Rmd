...
- **Keywords.de** `['bedurfnisse', 'abstimmungsgerat', 'bevolkerung', 'geoportal', 'abstimmungen', 'nutzung', 'zufriedenheit', 'lora', 'geodaten', 'sachdaten', 'einzeldaten', 'tabelle', 'stimmungsbilder', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-03T03:14:29.316770`
