...
- **Keywords.de** `['lora', 'stzh', 'geodaten', 'tabelle', 'sachdaten', 'abstimmungsgerat', 'einzeldaten', 'bevolkerung', 'geoportal', 'bedurfnisse', 'zufriedenheit', 'nutzung', 'stimmungsbilder', 'punktdaten', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-25T02:53:33.865729`
