...
- **Keywords.de** `['lora', 'zufriedenheit', 'geoportal', 'tabelle', 'stzh', 'einzeldaten', 'abstimmungen', 'sachdaten', 'punktdaten', 'bevolkerung', 'abstimmungsgerat', 'stimmungsbilder', 'geodaten', 'bedurfnisse', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-24T04:11:31.521875`
