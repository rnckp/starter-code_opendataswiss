...
- **Keywords.de** `['abstimmungen', 'zufriedenheit', 'stzh', 'sachdaten', 'bevolkerung', 'einzeldaten', 'geoportal', 'abstimmungsgerat', 'stimmungsbilder', 'bedurfnisse', 'tabelle', 'geodaten', 'punktdaten', 'lora', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-21T03:26:44.353633`
