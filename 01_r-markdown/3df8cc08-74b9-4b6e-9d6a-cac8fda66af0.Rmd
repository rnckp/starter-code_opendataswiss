...
- **Keywords.de** `['tabelle', 'lora', 'bedurfnisse', 'stimmungsbilder', 'punktdaten', 'nutzung', 'einzeldaten', 'abstimmungen', 'abstimmungsgerat', 'bevolkerung', 'sachdaten', 'stzh', 'geodaten', 'zufriedenheit', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-06T02:43:41.760720`
