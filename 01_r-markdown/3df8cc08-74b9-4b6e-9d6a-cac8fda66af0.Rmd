...
- **Keywords.de** `['stimmungsbilder', 'bedurfnisse', 'sachdaten', 'einzeldaten', 'geoportal', 'tabelle', 'punktdaten', 'geodaten', 'abstimmungen', 'lora', 'zufriedenheit', 'bevolkerung', 'stzh', 'nutzung', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-20T03:03:36.088359`
