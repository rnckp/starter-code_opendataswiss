...
- **Keywords.de** `['abstimmungsgerat', 'geodaten', 'einzeldaten', 'bedurfnisse', 'sachdaten', 'abstimmungen', 'bevolkerung', 'tabelle', 'lora', 'nutzung', 'stimmungsbilder', 'zufriedenheit', 'punktdaten', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-25T03:41:44.430320`
