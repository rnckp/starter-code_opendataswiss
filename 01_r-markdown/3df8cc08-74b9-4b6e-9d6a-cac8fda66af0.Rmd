...
- **Keywords.de** `['abstimmungen', 'bevolkerung', 'einzeldaten', 'sachdaten', 'lora', 'zufriedenheit', 'tabelle', 'bedurfnisse', 'geoportal', 'nutzung', 'stzh', 'punktdaten', 'geodaten', 'stimmungsbilder', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-10T02:58:23.127248`
