...
- **Keywords.de** `['abstimmungsgerat', 'einzeldaten', 'bevolkerung', 'sachdaten', 'lora', 'stzh', 'tabelle', 'abstimmungen', 'geoportal', 'stimmungsbilder', 'punktdaten', 'bedurfnisse', 'zufriedenheit', 'nutzung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-26T03:08:06.396684`
