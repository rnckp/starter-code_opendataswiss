...
- **Keywords.de** `['sachdaten', 'zufriedenheit', 'stimmungsbilder', 'lora', 'punktdaten', 'tabelle', 'bedurfnisse', 'abstimmungsgerat', 'nutzung', 'geodaten', 'einzeldaten', 'bevolkerung', 'stzh', 'abstimmungen', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-14T03:43:07.340722`
