...
- **Keywords.de** `['abstimmungsgerat', 'geodaten', 'bedurfnisse', 'lora', 'einzeldaten', 'bevolkerung', 'punktdaten', 'abstimmungen', 'nutzung', 'stimmungsbilder', 'geoportal', 'zufriedenheit', 'sachdaten', 'tabelle', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-05T03:00:19.686876`
