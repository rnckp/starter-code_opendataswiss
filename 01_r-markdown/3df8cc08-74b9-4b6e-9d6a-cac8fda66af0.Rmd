...
- **Keywords.de** `['einzeldaten', 'lora', 'geodaten', 'tabelle', 'nutzung', 'punktdaten', 'sachdaten', 'stzh', 'abstimmungen', 'geoportal', 'abstimmungsgerat', 'bevolkerung', 'stimmungsbilder', 'zufriedenheit', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-01T03:07:18.406956`
