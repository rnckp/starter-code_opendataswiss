...
- **Keywords.de** `['einzeldaten', 'zufriedenheit', 'bevolkerung', 'lora', 'bedurfnisse', 'punktdaten', 'geodaten', 'stimmungsbilder', 'abstimmungen', 'tabelle', 'sachdaten', 'abstimmungsgerat', 'stzh', 'nutzung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-27T03:01:59.525158`
