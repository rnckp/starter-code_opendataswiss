...
- **Keywords.de** `['punktdaten', 'stzh', 'abstimmungsgerat', 'lora', 'bevolkerung', 'nutzung', 'geoportal', 'bedurfnisse', 'abstimmungen', 'geodaten', 'zufriedenheit', 'sachdaten', 'tabelle', 'einzeldaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-19T02:50:37.342922`
