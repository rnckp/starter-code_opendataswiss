...
- **Keywords.de** `['stzh', 'punktdaten', 'geodaten', 'lora', 'stimmungsbilder', 'tabelle', 'nutzung', 'einzeldaten', 'abstimmungen', 'zufriedenheit', 'abstimmungsgerat', 'sachdaten', 'bevolkerung', 'geoportal', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-23T03:30:42.387163`
