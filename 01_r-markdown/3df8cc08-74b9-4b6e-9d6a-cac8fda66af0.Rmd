...
- **Keywords.de** `['stzh', 'geodaten', 'zufriedenheit', 'bevolkerung', 'abstimmungen', 'geoportal', 'abstimmungsgerat', 'punktdaten', 'nutzung', 'lora', 'bedurfnisse', 'sachdaten', 'stimmungsbilder', 'tabelle', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-07T03:18:44.034985`
