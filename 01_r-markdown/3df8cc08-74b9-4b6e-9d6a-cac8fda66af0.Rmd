...
- **Keywords.de** `['abstimmungen', 'bevolkerung', 'sachdaten', 'tabelle', 'punktdaten', 'zufriedenheit', 'bedurfnisse', 'nutzung', 'stzh', 'geodaten', 'einzeldaten', 'stimmungsbilder', 'geoportal', 'abstimmungsgerat', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-06T03:25:40.031753`
