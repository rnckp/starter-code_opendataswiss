...
- **Keywords.de** `['lora', 'tabelle', 'zufriedenheit', 'nutzung', 'einzeldaten', 'abstimmungsgerat', 'geodaten', 'bedurfnisse', 'punktdaten', 'bevolkerung', 'sachdaten', 'stimmungsbilder', 'abstimmungen', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-21T03:21:30.928075`
