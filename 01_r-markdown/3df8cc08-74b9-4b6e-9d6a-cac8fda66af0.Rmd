...
- **Keywords.de** `['sachdaten', 'bevolkerung', 'stzh', 'geoportal', 'nutzung', 'tabelle', 'zufriedenheit', 'abstimmungen', 'abstimmungsgerat', 'lora', 'bedurfnisse', 'punktdaten', 'stimmungsbilder', 'geodaten', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-19T03:17:39.589576`
