...
- **Keywords.de** `['abstimmungsgerat', 'punktdaten', 'sachdaten', 'bedurfnisse', 'stzh', 'bevolkerung', 'abstimmungen', 'tabelle', 'zufriedenheit', 'nutzung', 'einzeldaten', 'stimmungsbilder', 'lora', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-19T03:11:35.329945`
