...
- **Keywords.de** `['stzh', 'lora', 'zufriedenheit', 'geoportal', 'geodaten', 'abstimmungen', 'abstimmungsgerat', 'nutzung', 'bevolkerung', 'stimmungsbilder', 'punktdaten', 'einzeldaten', 'tabelle', 'sachdaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-05T03:28:05.182501`
