...
- **Keywords.de** `['stzh', 'lora', 'stimmungsbilder', 'zufriedenheit', 'geoportal', 'punktdaten', 'sachdaten', 'abstimmungsgerat', 'bedurfnisse', 'bevolkerung', 'tabelle', 'einzeldaten', 'geodaten', 'nutzung', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-09T03:13:47.000881`
