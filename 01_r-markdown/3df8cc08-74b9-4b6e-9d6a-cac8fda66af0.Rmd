...
- **Keywords.de** `['tabelle', 'sachdaten', 'stzh', 'lora', 'geodaten', 'abstimmungsgerat', 'bedurfnisse', 'zufriedenheit', 'einzeldaten', 'geoportal', 'nutzung', 'stimmungsbilder', 'bevolkerung', 'abstimmungen', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-10T03:25:45.334010`
