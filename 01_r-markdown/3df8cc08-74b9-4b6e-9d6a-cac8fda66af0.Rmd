...
- **Keywords.de** `['stimmungsbilder', 'abstimmungsgerat', 'lora', 'abstimmungen', 'tabelle', 'zufriedenheit', 'bedurfnisse', 'geoportal', 'einzeldaten', 'punktdaten', 'geodaten', 'nutzung', 'sachdaten', 'stzh', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-30T03:04:12.085726`
