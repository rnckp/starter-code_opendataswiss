...
- **Keywords.de** `['bevolkerung', 'nutzung', 'sachdaten', 'abstimmungsgerat', 'geoportal', 'geodaten', 'bedurfnisse', 'stzh', 'lora', 'einzeldaten', 'zufriedenheit', 'abstimmungen', 'punktdaten', 'tabelle', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-01T03:32:48.913052`
