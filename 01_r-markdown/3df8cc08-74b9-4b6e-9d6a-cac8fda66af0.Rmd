...
- **Keywords.de** `['tabelle', 'geoportal', 'lora', 'stzh', 'nutzung', 'einzeldaten', 'stimmungsbilder', 'zufriedenheit', 'geodaten', 'bevolkerung', 'sachdaten', 'punktdaten', 'bedurfnisse', 'abstimmungen', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-06-21T03:57:37.914838`
