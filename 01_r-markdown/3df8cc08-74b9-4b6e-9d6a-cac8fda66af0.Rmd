...
- **Keywords.de** `['bedurfnisse', 'abstimmungsgerat', 'stzh', 'tabelle', 'geoportal', 'punktdaten', 'abstimmungen', 'sachdaten', 'lora', 'geodaten', 'nutzung', 'zufriedenheit', 'stimmungsbilder', 'bevolkerung', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-02T02:30:07.385927`
