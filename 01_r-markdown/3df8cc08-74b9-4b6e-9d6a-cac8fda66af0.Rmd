...
- **Keywords.de** `['abstimmungsgerat', 'nutzung', 'stzh', 'geoportal', 'bevolkerung', 'stimmungsbilder', 'bedurfnisse', 'tabelle', 'punktdaten', 'geodaten', 'abstimmungen', 'zufriedenheit', 'einzeldaten', 'lora', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-30T03:04:45.990916`
