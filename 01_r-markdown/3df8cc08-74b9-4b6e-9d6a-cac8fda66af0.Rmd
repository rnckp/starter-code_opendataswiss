...
- **Keywords.de** `['punktdaten', 'geodaten', 'tabelle', 'zufriedenheit', 'stimmungsbilder', 'sachdaten', 'abstimmungsgerat', 'einzeldaten', 'bevolkerung', 'geoportal', 'lora', 'stzh', 'bedurfnisse', 'abstimmungen', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-19T03:11:50.124192`
