...
- **Keywords.de** `['punktdaten', 'stimmungsbilder', 'bevolkerung', 'abstimmungen', 'bedurfnisse', 'zufriedenheit', 'stzh', 'geodaten', 'tabelle', 'einzeldaten', 'abstimmungsgerat', 'geoportal', 'sachdaten', 'lora', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-31T03:28:54.315418`
