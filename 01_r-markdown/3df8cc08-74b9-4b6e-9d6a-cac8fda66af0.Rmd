...
- **Keywords.de** `['punktdaten', 'bedurfnisse', 'bevolkerung', 'abstimmungsgerat', 'einzeldaten', 'lora', 'zufriedenheit', 'geoportal', 'tabelle', 'stimmungsbilder', 'nutzung', 'stzh', 'abstimmungen', 'sachdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-08T03:21:39.130618`
