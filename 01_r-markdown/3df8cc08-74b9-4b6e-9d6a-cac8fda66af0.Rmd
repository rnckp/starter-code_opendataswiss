...
- **Keywords.de** `['stimmungsbilder', 'bedurfnisse', 'einzeldaten', 'lora', 'geoportal', 'bevolkerung', 'tabelle', 'nutzung', 'geodaten', 'sachdaten', 'abstimmungsgerat', 'zufriedenheit', 'punktdaten', 'stzh', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-03T05:28:46.826134`
