...
- **Keywords.de** `['stzh', 'punktdaten', 'lora', 'geodaten', 'nutzung', 'zufriedenheit', 'bedurfnisse', 'bevolkerung', 'abstimmungen', 'tabelle', 'abstimmungsgerat', 'einzeldaten', 'stimmungsbilder', 'sachdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-02T03:13:11.260045`
