...
- **Keywords.de** `['abstimmungen', 'punktdaten', 'stzh', 'abstimmungsgerat', 'einzeldaten', 'sachdaten', 'nutzung', 'tabelle', 'geodaten', 'bedurfnisse', 'stimmungsbilder', 'lora', 'bevolkerung', 'geoportal', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-30T03:29:04.274118`
