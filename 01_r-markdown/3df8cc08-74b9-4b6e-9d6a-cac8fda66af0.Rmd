...
- **Keywords.de** `['punktdaten', 'bedurfnisse', 'geoportal', 'abstimmungsgerat', 'einzeldaten', 'sachdaten', 'stimmungsbilder', 'zufriedenheit', 'stzh', 'bevolkerung', 'geodaten', 'nutzung', 'abstimmungen', 'tabelle', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-22T02:46:56.283745`
