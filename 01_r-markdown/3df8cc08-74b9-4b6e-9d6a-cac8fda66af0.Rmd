...
- **Keywords.de** `['geodaten', 'nutzung', 'bevolkerung', 'einzeldaten', 'abstimmungsgerat', 'lora', 'geoportal', 'zufriedenheit', 'punktdaten', 'bedurfnisse', 'stimmungsbilder', 'sachdaten', 'abstimmungen', 'stzh', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-06T02:51:05.116575`
