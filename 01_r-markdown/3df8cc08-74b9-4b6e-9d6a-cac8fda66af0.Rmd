...
- **Keywords.de** `['stimmungsbilder', 'sachdaten', 'punktdaten', 'bedurfnisse', 'geoportal', 'stzh', 'abstimmungsgerat', 'bevolkerung', 'geodaten', 'einzeldaten', 'tabelle', 'zufriedenheit', 'lora', 'nutzung', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-16T03:09:33.023571`
