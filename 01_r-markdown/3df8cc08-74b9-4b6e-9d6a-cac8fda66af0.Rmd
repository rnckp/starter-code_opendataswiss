...
- **Keywords.de** `['sachdaten', 'stimmungsbilder', 'stzh', 'einzeldaten', 'zufriedenheit', 'nutzung', 'abstimmungen', 'abstimmungsgerat', 'punktdaten', 'tabelle', 'lora', 'geoportal', 'bevolkerung', 'geodaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-11T03:14:07.739884`
