...
- **Keywords.de** `['abstimmungen', 'punktdaten', 'stimmungsbilder', 'tabelle', 'bevolkerung', 'stzh', 'sachdaten', 'geodaten', 'einzeldaten', 'bedurfnisse', 'geoportal', 'abstimmungsgerat', 'zufriedenheit', 'nutzung', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-11T03:42:19.685566`
