...
- **Keywords.de** `['lora', 'abstimmungen', 'zufriedenheit', 'nutzung', 'geodaten', 'punktdaten', 'bedurfnisse', 'stimmungsbilder', 'stzh', 'abstimmungsgerat', 'geoportal', 'bevolkerung', 'einzeldaten', 'sachdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-29T03:07:13.009930`
