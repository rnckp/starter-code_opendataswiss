...
- **Keywords.de** `['bedurfnisse', 'abstimmungen', 'tabelle', 'einzeldaten', 'geoportal', 'geodaten', 'zufriedenheit', 'nutzung', 'stimmungsbilder', 'lora', 'abstimmungsgerat', 'sachdaten', 'bevolkerung', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-01T02:48:31.988029`
