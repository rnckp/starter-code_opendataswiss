...
- **Keywords.de** `['punktdaten', 'abstimmungsgerat', 'stzh', 'nutzung', 'lora', 'einzeldaten', 'abstimmungen', 'sachdaten', 'bedurfnisse', 'geoportal', 'geodaten', 'bevolkerung', 'tabelle', 'zufriedenheit', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-25T03:21:14.147188`
