...
- **Keywords.de** `['stimmungsbilder', 'punktdaten', 'lora', 'einzeldaten', 'abstimmungsgerat', 'sachdaten', 'stzh', 'bedurfnisse', 'abstimmungen', 'geoportal', 'zufriedenheit', 'tabelle', 'bevolkerung', 'geodaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-24T03:27:25.904924`
