...
- **Keywords.de** `['abstimmungsgerat', 'einzeldaten', 'punktdaten', 'nutzung', 'tabelle', 'lora', 'bevolkerung', 'zufriedenheit', 'geodaten', 'stzh', 'abstimmungen', 'bedurfnisse', 'sachdaten', 'geoportal', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-16T03:24:08.523040`
