...
- **Keywords.de** `['lora', 'bevolkerung', 'geoportal', 'geodaten', 'abstimmungen', 'stimmungsbilder', 'abstimmungsgerat', 'punktdaten', 'nutzung', 'zufriedenheit', 'sachdaten', 'stzh', 'einzeldaten', 'tabelle', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-01T03:55:00.981138`
