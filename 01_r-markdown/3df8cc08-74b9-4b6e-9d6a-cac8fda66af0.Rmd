...
- **Keywords.de** `['zufriedenheit', 'bedurfnisse', 'punktdaten', 'stzh', 'nutzung', 'stimmungsbilder', 'abstimmungsgerat', 'tabelle', 'bevolkerung', 'abstimmungen', 'einzeldaten', 'geoportal', 'sachdaten', 'lora', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-19T02:43:54.480711`
