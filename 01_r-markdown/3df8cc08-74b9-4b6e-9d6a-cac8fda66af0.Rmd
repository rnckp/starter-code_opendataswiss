...
- **Keywords.de** `['sachdaten', 'bevolkerung', 'geodaten', 'stimmungsbilder', 'lora', 'stzh', 'abstimmungen', 'tabelle', 'punktdaten', 'geoportal', 'abstimmungsgerat', 'bedurfnisse', 'nutzung', 'einzeldaten', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-12T03:15:56.945769`
