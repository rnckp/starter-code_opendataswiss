...
- **Keywords.de** `['sachdaten', 'bevolkerung', 'bedurfnisse', 'punktdaten', 'stimmungsbilder', 'stzh', 'lora', 'abstimmungsgerat', 'geodaten', 'einzeldaten', 'nutzung', 'geoportal', 'abstimmungen', 'tabelle', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-20T02:42:25.733486`
