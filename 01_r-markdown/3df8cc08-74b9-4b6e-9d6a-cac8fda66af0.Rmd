...
- **Keywords.de** `['abstimmungsgerat', 'nutzung', 'stzh', 'geodaten', 'geoportal', 'bedurfnisse', 'tabelle', 'sachdaten', 'bevolkerung', 'stimmungsbilder', 'abstimmungen', 'lora', 'punktdaten', 'einzeldaten', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-24T03:09:48.236955`
