...
- **Keywords.de** `['abstimmungsgerat', 'stimmungsbilder', 'bevolkerung', 'bedurfnisse', 'nutzung', 'einzeldaten', 'tabelle', 'abstimmungen', 'punktdaten', 'stzh', 'lora', 'zufriedenheit', 'sachdaten', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-09T02:31:40.943806`
