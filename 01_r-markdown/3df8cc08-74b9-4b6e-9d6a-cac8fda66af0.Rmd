...
- **Keywords.de** `['lora', 'abstimmungsgerat', 'einzeldaten', 'geodaten', 'stimmungsbilder', 'stzh', 'bedurfnisse', 'zufriedenheit', 'punktdaten', 'sachdaten', 'abstimmungen', 'nutzung', 'tabelle', 'bevolkerung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-28T03:18:36.142365`
