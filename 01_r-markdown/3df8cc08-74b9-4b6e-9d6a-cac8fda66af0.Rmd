...
- **Keywords.de** `['geoportal', 'geodaten', 'lora', 'abstimmungsgerat', 'bevolkerung', 'zufriedenheit', 'abstimmungen', 'einzeldaten', 'stimmungsbilder', 'sachdaten', 'bedurfnisse', 'nutzung', 'stzh', 'punktdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-22T03:25:47.819230`
