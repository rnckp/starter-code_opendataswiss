...
- **Keywords.de** `['abstimmungsgerat', 'nutzung', 'abstimmungen', 'stimmungsbilder', 'stzh', 'bevolkerung', 'lora', 'sachdaten', 'einzeldaten', 'tabelle', 'geodaten', 'zufriedenheit', 'bedurfnisse', 'punktdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-14T02:52:04.270687`
