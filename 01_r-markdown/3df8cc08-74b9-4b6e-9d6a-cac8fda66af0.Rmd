...
- **Keywords.de** `['zufriedenheit', 'lora', 'abstimmungen', 'stzh', 'bedurfnisse', 'einzeldaten', 'stimmungsbilder', 'geodaten', 'tabelle', 'bevolkerung', 'nutzung', 'sachdaten', 'punktdaten', 'abstimmungsgerat', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-06T03:04:16.080973`
