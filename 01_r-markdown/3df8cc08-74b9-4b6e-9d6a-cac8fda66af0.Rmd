...
- **Keywords.de** `['sachdaten', 'bedurfnisse', 'geodaten', 'geoportal', 'nutzung', 'stimmungsbilder', 'tabelle', 'einzeldaten', 'stzh', 'bevolkerung', 'abstimmungen', 'abstimmungsgerat', 'zufriedenheit', 'lora', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-10-19T03:36:11.754006`
