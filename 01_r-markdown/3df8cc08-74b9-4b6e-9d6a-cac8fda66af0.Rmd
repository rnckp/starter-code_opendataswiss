...
- **Keywords.de** `['zufriedenheit', 'abstimmungsgerat', 'geoportal', 'geodaten', 'tabelle', 'lora', 'stzh', 'abstimmungen', 'nutzung', 'bedurfnisse', 'punktdaten', 'sachdaten', 'stimmungsbilder', 'einzeldaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-23T03:01:23.345851`
