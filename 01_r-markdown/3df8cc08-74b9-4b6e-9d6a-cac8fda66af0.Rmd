...
- **Keywords.de** `['lora', 'bevolkerung', 'zufriedenheit', 'abstimmungen', 'nutzung', 'einzeldaten', 'stzh', 'punktdaten', 'geoportal', 'stimmungsbilder', 'geodaten', 'sachdaten', 'abstimmungsgerat', 'bedurfnisse', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-21T02:43:12.255573`
