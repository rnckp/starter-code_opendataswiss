...
- **Keywords.de** `['stzh', 'einzeldaten', 'bedurfnisse', 'stimmungsbilder', 'nutzung', 'punktdaten', 'sachdaten', 'abstimmungsgerat', 'geodaten', 'tabelle', 'geoportal', 'zufriedenheit', 'abstimmungen', 'bevolkerung', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-31T02:53:24.439635`
