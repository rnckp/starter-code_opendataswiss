...
- **Keywords.de** `['tabelle', 'bevolkerung', 'zufriedenheit', 'geodaten', 'stzh', 'punktdaten', 'abstimmungsgerat', 'bedurfnisse', 'stimmungsbilder', 'nutzung', 'sachdaten', 'lora', 'abstimmungen', 'einzeldaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-06T04:02:13.049922`
