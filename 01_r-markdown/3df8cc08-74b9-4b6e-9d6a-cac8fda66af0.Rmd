...
- **Keywords.de** `['zufriedenheit', 'geoportal', 'tabelle', 'abstimmungen', 'abstimmungsgerat', 'stimmungsbilder', 'nutzung', 'bevolkerung', 'geodaten', 'einzeldaten', 'sachdaten', 'punktdaten', 'lora', 'stzh', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-17T02:52:20.076726`
