...
- **Keywords.de** `['einzeldaten', 'nutzung', 'bevolkerung', 'tabelle', 'abstimmungen', 'sachdaten', 'bedurfnisse', 'zufriedenheit', 'stzh', 'geodaten', 'abstimmungsgerat', 'geoportal', 'stimmungsbilder', 'lora', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-11T03:08:43.613277`
