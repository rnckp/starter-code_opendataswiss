...
- **Keywords.de** `['tabelle', 'abstimmungen', 'stzh', 'einzeldaten', 'nutzung', 'sachdaten', 'zufriedenheit', 'punktdaten', 'geodaten', 'bevolkerung', 'geoportal', 'bedurfnisse', 'stimmungsbilder', 'lora', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-06T03:11:08.937672`
