...
- **Keywords.de** `['nutzung', 'stimmungsbilder', 'lora', 'tabelle', 'punktdaten', 'geodaten', 'abstimmungsgerat', 'zufriedenheit', 'stzh', 'abstimmungen', 'geoportal', 'bevolkerung', 'sachdaten', 'einzeldaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-23T03:08:13.861084`
