...
- **Keywords.de** `['abstimmungen', 'sachdaten', 'geodaten', 'abstimmungsgerat', 'bedurfnisse', 'nutzung', 'tabelle', 'bevolkerung', 'stzh', 'zufriedenheit', 'lora', 'stimmungsbilder', 'punktdaten', 'geoportal', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-25T03:06:58.064159`
