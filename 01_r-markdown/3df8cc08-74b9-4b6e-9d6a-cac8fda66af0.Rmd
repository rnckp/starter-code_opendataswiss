...
- **Keywords.de** `['geoportal', 'geodaten', 'bedurfnisse', 'stimmungsbilder', 'nutzung', 'punktdaten', 'abstimmungsgerat', 'bevolkerung', 'lora', 'abstimmungen', 'tabelle', 'sachdaten', 'zufriedenheit', 'stzh', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-10T02:53:05.725942`
