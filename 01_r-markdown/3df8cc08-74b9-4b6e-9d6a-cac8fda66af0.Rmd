...
- **Keywords.de** `['abstimmungen', 'lora', 'nutzung', 'geodaten', 'abstimmungsgerat', 'zufriedenheit', 'stimmungsbilder', 'geoportal', 'sachdaten', 'stzh', 'tabelle', 'punktdaten', 'bevolkerung', 'bedurfnisse', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-01-02T03:55:03.838717`
