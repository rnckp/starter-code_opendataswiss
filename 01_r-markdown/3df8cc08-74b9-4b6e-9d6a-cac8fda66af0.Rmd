...
- **Keywords.de** `['abstimmungen', 'tabelle', 'sachdaten', 'geoportal', 'einzeldaten', 'stimmungsbilder', 'zufriedenheit', 'bedurfnisse', 'lora', 'stzh', 'punktdaten', 'abstimmungsgerat', 'geodaten', 'nutzung', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-07T03:10:21.302109`
