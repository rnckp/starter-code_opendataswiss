...
- **Keywords.de** `['punktdaten', 'stzh', 'lora', 'tabelle', 'bevolkerung', 'zufriedenheit', 'geoportal', 'geodaten', 'bedurfnisse', 'nutzung', 'abstimmungsgerat', 'einzeldaten', 'sachdaten', 'stimmungsbilder', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-25T03:13:14.821554`
