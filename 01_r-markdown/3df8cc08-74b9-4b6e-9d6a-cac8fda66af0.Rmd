...
- **Keywords.de** `['einzeldaten', 'abstimmungen', 'punktdaten', 'geoportal', 'stzh', 'stimmungsbilder', 'lora', 'geodaten', 'zufriedenheit', 'bedurfnisse', 'abstimmungsgerat', 'sachdaten', 'bevolkerung', 'nutzung', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-06T03:11:19.354714`
