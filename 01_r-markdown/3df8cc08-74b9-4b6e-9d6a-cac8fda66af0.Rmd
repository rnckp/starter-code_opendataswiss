...
- **Keywords.de** `['stzh', 'bedurfnisse', 'abstimmungen', 'stimmungsbilder', 'geodaten', 'punktdaten', 'lora', 'tabelle', 'bevolkerung', 'zufriedenheit', 'nutzung', 'sachdaten', 'abstimmungsgerat', 'einzeldaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-04T03:01:43.662892`
