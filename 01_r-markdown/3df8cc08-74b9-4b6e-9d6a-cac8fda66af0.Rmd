...
- **Keywords.de** `['abstimmungsgerat', 'sachdaten', 'stzh', 'abstimmungen', 'bevolkerung', 'geoportal', 'stimmungsbilder', 'punktdaten', 'zufriedenheit', 'nutzung', 'tabelle', 'lora', 'einzeldaten', 'geodaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-09T05:02:28.780139`
