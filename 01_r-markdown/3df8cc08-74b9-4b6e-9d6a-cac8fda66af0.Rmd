...
- **Keywords.de** `['geodaten', 'abstimmungsgerat', 'stzh', 'tabelle', 'bevolkerung', 'abstimmungen', 'lora', 'bedurfnisse', 'einzeldaten', 'nutzung', 'punktdaten', 'stimmungsbilder', 'geoportal', 'zufriedenheit', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-29T02:29:14.795927`
