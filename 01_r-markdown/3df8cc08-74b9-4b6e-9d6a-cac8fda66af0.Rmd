...
- **Keywords.de** `['bedurfnisse', 'geoportal', 'tabelle', 'lora', 'geodaten', 'bevolkerung', 'zufriedenheit', 'abstimmungsgerat', 'einzeldaten', 'stzh', 'sachdaten', 'nutzung', 'abstimmungen', 'punktdaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-19T03:24:37.886585`
