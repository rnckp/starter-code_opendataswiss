...
- **Keywords.de** `['bevolkerung', 'einzeldaten', 'abstimmungsgerat', 'geodaten', 'tabelle', 'bedurfnisse', 'abstimmungen', 'stzh', 'stimmungsbilder', 'lora', 'punktdaten', 'nutzung', 'sachdaten', 'zufriedenheit', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-06T03:24:09.337059`
