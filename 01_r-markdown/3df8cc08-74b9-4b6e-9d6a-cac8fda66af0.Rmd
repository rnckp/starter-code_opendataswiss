...
- **Keywords.de** `['einzeldaten', 'lora', 'geoportal', 'stimmungsbilder', 'abstimmungsgerat', 'sachdaten', 'zufriedenheit', 'bedurfnisse', 'nutzung', 'abstimmungen', 'stzh', 'geodaten', 'tabelle', 'bevolkerung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-30T08:40:13.872669`
