...
- **Keywords.de** `['lora', 'einzeldaten', 'abstimmungsgerat', 'sachdaten', 'tabelle', 'zufriedenheit', 'abstimmungen', 'geoportal', 'geodaten', 'bedurfnisse', 'stzh', 'bevolkerung', 'nutzung', 'punktdaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-16T03:27:10.042348`
