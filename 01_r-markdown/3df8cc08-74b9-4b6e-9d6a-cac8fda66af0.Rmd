...
- **Keywords.de** `['abstimmungsgerat', 'bevolkerung', 'zufriedenheit', 'sachdaten', 'geoportal', 'tabelle', 'einzeldaten', 'stzh', 'lora', 'bedurfnisse', 'nutzung', 'stimmungsbilder', 'abstimmungen', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-20T02:39:50.311467`
