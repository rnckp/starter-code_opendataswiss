...
- **Keywords.de** `['stzh', 'tabelle', 'sachdaten', 'abstimmungen', 'bedurfnisse', 'geodaten', 'punktdaten', 'zufriedenheit', 'einzeldaten', 'nutzung', 'lora', 'bevolkerung', 'stimmungsbilder', 'abstimmungsgerat', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-18T03:03:58.725052`
