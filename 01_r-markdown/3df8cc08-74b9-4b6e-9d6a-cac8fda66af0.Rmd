...
- **Keywords.de** `['sachdaten', 'lora', 'abstimmungsgerat', 'nutzung', 'einzeldaten', 'tabelle', 'zufriedenheit', 'abstimmungen', 'bevolkerung', 'bedurfnisse', 'punktdaten', 'geoportal', 'stzh', 'stimmungsbilder', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-02T03:23:17.357418`
