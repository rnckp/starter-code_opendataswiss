...
- **Keywords.de** `['sachdaten', 'punktdaten', 'geoportal', 'stzh', 'einzeldaten', 'geodaten', 'nutzung', 'lora', 'zufriedenheit', 'abstimmungsgerat', 'bedurfnisse', 'tabelle', 'stimmungsbilder', 'abstimmungen', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-14T03:47:58.041022`
