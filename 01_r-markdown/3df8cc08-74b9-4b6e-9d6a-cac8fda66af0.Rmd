...
- **Keywords.de** `['stimmungsbilder', 'abstimmungen', 'sachdaten', 'einzeldaten', 'geoportal', 'bevolkerung', 'bedurfnisse', 'lora', 'abstimmungsgerat', 'nutzung', 'stzh', 'zufriedenheit', 'tabelle', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-06T03:13:40.060503`
