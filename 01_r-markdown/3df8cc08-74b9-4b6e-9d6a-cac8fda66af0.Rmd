...
- **Keywords.de** `['punktdaten', 'tabelle', 'abstimmungsgerat', 'bedurfnisse', 'sachdaten', 'lora', 'bevolkerung', 'geodaten', 'stzh', 'nutzung', 'geoportal', 'zufriedenheit', 'abstimmungen', 'stimmungsbilder', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-06T01:36:14.093224`
