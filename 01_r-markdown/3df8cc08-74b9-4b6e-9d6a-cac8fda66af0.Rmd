...
- **Keywords.de** `['abstimmungsgerat', 'stimmungsbilder', 'zufriedenheit', 'geoportal', 'einzeldaten', 'lora', 'nutzung', 'sachdaten', 'bevolkerung', 'abstimmungen', 'geodaten', 'punktdaten', 'stzh', 'bedurfnisse', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-13T04:16:32.870037`
