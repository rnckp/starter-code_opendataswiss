...
- **Keywords.de** `['stimmungsbilder', 'nutzung', 'abstimmungsgerat', 'geoportal', 'sachdaten', 'einzeldaten', 'geodaten', 'punktdaten', 'bevolkerung', 'zufriedenheit', 'stzh', 'lora', 'tabelle', 'abstimmungen', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-23T03:00:48.352445`
