...
- **Keywords.de** `['abstimmungen', 'tabelle', 'einzeldaten', 'stzh', 'abstimmungsgerat', 'nutzung', 'sachdaten', 'lora', 'stimmungsbilder', 'zufriedenheit', 'bevolkerung', 'geodaten', 'bedurfnisse', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-11T03:22:12.767687`
