...
- **Keywords.de** `['stimmungsbilder', 'bedurfnisse', 'zufriedenheit', 'punktdaten', 'sachdaten', 'geoportal', 'stzh', 'tabelle', 'bevolkerung', 'lora', 'abstimmungen', 'einzeldaten', 'nutzung', 'abstimmungsgerat', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-20T03:11:51.338279`
