...
- **Keywords.de** `['geoportal', 'abstimmungen', 'sachdaten', 'einzeldaten', 'tabelle', 'punktdaten', 'geodaten', 'stimmungsbilder', 'bedurfnisse', 'nutzung', 'abstimmungsgerat', 'bevolkerung', 'lora', 'stzh', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-15T03:23:03.865870`
