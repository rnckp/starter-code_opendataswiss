...
- **Keywords.de** `['zufriedenheit', 'punktdaten', 'abstimmungsgerat', 'lora', 'bevolkerung', 'abstimmungen', 'bedurfnisse', 'stimmungsbilder', 'nutzung', 'geoportal', 'sachdaten', 'tabelle', 'einzeldaten', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-20T03:38:53.801360`
