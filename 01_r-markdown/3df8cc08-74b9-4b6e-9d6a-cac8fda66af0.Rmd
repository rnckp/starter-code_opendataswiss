...
- **Keywords.de** `['abstimmungsgerat', 'geoportal', 'nutzung', 'abstimmungen', 'stzh', 'bevolkerung', 'sachdaten', 'einzeldaten', 'bedurfnisse', 'stimmungsbilder', 'zufriedenheit', 'lora', 'geodaten', 'punktdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-16T02:55:58.015093`
