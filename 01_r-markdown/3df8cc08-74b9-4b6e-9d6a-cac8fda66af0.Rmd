...
- **Keywords.de** `['nutzung', 'einzeldaten', 'sachdaten', 'geoportal', 'lora', 'bevolkerung', 'bedurfnisse', 'stzh', 'abstimmungen', 'abstimmungsgerat', 'punktdaten', 'zufriedenheit', 'tabelle', 'stimmungsbilder', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-21T03:39:18.169779`
