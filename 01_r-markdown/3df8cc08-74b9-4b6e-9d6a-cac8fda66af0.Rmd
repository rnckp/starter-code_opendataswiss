...
- **Keywords.de** `['zufriedenheit', 'nutzung', 'geodaten', 'einzeldaten', 'sachdaten', 'bedurfnisse', 'geoportal', 'bevolkerung', 'abstimmungen', 'stimmungsbilder', 'abstimmungsgerat', 'stzh', 'punktdaten', 'lora', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-13T02:31:20.416247`
