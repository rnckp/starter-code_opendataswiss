...
- **Keywords.de** `['geodaten', 'punktdaten', 'bevolkerung', 'tabelle', 'geoportal', 'stimmungsbilder', 'abstimmungen', 'stzh', 'sachdaten', 'zufriedenheit', 'abstimmungsgerat', 'lora', 'bedurfnisse', 'nutzung', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-01T04:12:18.421885`
