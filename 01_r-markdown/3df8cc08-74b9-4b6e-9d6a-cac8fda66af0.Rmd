...
- **Keywords.de** `['geodaten', 'zufriedenheit', 'stzh', 'sachdaten', 'abstimmungsgerat', 'tabelle', 'bevolkerung', 'abstimmungen', 'nutzung', 'punktdaten', 'lora', 'geoportal', 'einzeldaten', 'bedurfnisse', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-29T03:04:45.703372`
