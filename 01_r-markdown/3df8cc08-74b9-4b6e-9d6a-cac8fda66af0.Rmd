...
- **Keywords.de** `['stzh', 'geodaten', 'abstimmungen', 'nutzung', 'lora', 'stimmungsbilder', 'bedurfnisse', 'abstimmungsgerat', 'bevolkerung', 'punktdaten', 'sachdaten', 'einzeldaten', 'zufriedenheit', 'tabelle', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-21T02:10:57.541836`
