...
- **Keywords.de** `['geoportal', 'stimmungsbilder', 'bedurfnisse', 'geodaten', 'stzh', 'nutzung', 'zufriedenheit', 'tabelle', 'bevolkerung', 'lora', 'punktdaten', 'abstimmungsgerat', 'abstimmungen', 'einzeldaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-10T03:12:30.333813`
