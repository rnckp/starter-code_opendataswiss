...
- **Keywords.de** `['punktdaten', 'nutzung', 'lora', 'bevolkerung', 'tabelle', 'zufriedenheit', 'bedurfnisse', 'stzh', 'geoportal', 'sachdaten', 'stimmungsbilder', 'geodaten', 'einzeldaten', 'abstimmungen', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-02-16T03:02:38.007336`
