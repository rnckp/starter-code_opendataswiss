...
- **Keywords.de** `['lora', 'stimmungsbilder', 'abstimmungsgerat', 'abstimmungen', 'bevolkerung', 'einzeldaten', 'nutzung', 'punktdaten', 'geodaten', 'geoportal', 'stzh', 'bedurfnisse', 'zufriedenheit', 'sachdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-05T05:05:36.807262`
