...
- **Keywords.de** `['einzeldaten', 'geoportal', 'abstimmungsgerat', 'lora', 'punktdaten', 'geodaten', 'nutzung', 'stimmungsbilder', 'abstimmungen', 'zufriedenheit', 'bevolkerung', 'tabelle', 'sachdaten', 'stzh', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-16T03:18:37.812234`
