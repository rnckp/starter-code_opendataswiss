...
- **Keywords.de** `['stzh', 'tabelle', 'zufriedenheit', 'einzeldaten', 'geodaten', 'geoportal', 'stimmungsbilder', 'abstimmungsgerat', 'abstimmungen', 'nutzung', 'punktdaten', 'sachdaten', 'lora', 'bevolkerung', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-08T02:54:37.570569`
