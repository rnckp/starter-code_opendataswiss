...
- **Keywords.de** `['sachdaten', 'punktdaten', 'geoportal', 'tabelle', 'stimmungsbilder', 'abstimmungen', 'bevolkerung', 'geodaten', 'lora', 'abstimmungsgerat', 'nutzung', 'zufriedenheit', 'bedurfnisse', 'einzeldaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-10T03:31:50.555175`
