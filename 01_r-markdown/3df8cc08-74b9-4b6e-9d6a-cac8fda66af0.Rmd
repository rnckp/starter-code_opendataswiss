...
- **Keywords.de** `['punktdaten', 'stzh', 'tabelle', 'sachdaten', 'bevolkerung', 'geodaten', 'einzeldaten', 'abstimmungen', 'stimmungsbilder', 'lora', 'abstimmungsgerat', 'geoportal', 'zufriedenheit', 'bedurfnisse', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-05T03:49:42.540003`
