...
- **Keywords.de** `['abstimmungsgerat', 'bevolkerung', 'lora', 'geodaten', 'nutzung', 'sachdaten', 'zufriedenheit', 'punktdaten', 'bedurfnisse', 'einzeldaten', 'tabelle', 'stimmungsbilder', 'abstimmungen', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-30T03:03:11.237582`
