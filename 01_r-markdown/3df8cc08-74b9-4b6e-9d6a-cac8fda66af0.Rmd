...
- **Keywords.de** `['geoportal', 'zufriedenheit', 'stzh', 'geodaten', 'bevolkerung', 'stimmungsbilder', 'bedurfnisse', 'punktdaten', 'sachdaten', 'abstimmungsgerat', 'nutzung', 'lora', 'einzeldaten', 'tabelle', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-12T03:46:44.425917`
