...
- **Keywords.de** `['stimmungsbilder', 'nutzung', 'lora', 'bevolkerung', 'bedurfnisse', 'abstimmungsgerat', 'geoportal', 'geodaten', 'stzh', 'abstimmungen', 'sachdaten', 'punktdaten', 'einzeldaten', 'zufriedenheit', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-11T03:23:39.515457`
