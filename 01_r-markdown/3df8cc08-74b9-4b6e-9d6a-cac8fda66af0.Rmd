...
- **Keywords.de** `['nutzung', 'tabelle', 'stimmungsbilder', 'geoportal', 'einzeldaten', 'abstimmungen', 'sachdaten', 'bevolkerung', 'punktdaten', 'abstimmungsgerat', 'lora', 'bedurfnisse', 'stzh', 'geodaten', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-14T02:34:25.617517`
