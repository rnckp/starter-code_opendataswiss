...
- **Keywords.de** `['abstimmungen', 'bevolkerung', 'sachdaten', 'einzeldaten', 'tabelle', 'nutzung', 'bedurfnisse', 'geodaten', 'geoportal', 'stimmungsbilder', 'stzh', 'abstimmungsgerat', 'punktdaten', 'zufriedenheit', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-18T02:58:26.250074`
