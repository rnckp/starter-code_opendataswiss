...
- **Keywords.de** `['stzh', 'lora', 'stimmungsbilder', 'zufriedenheit', 'bevolkerung', 'bedurfnisse', 'einzeldaten', 'nutzung', 'punktdaten', 'sachdaten', 'geoportal', 'abstimmungen', 'abstimmungsgerat', 'tabelle', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-04T03:18:01.134890`
