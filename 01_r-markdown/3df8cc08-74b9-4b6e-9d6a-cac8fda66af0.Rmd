...
- **Keywords.de** `['bedurfnisse', 'geoportal', 'zufriedenheit', 'bevolkerung', 'nutzung', 'geodaten', 'punktdaten', 'abstimmungsgerat', 'tabelle', 'abstimmungen', 'einzeldaten', 'stimmungsbilder', 'sachdaten', 'stzh', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-08-25T02:05:23.698941`
