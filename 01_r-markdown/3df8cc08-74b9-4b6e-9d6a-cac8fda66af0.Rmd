...
- **Keywords.de** `['abstimmungsgerat', 'einzeldaten', 'abstimmungen', 'stimmungsbilder', 'geoportal', 'lora', 'sachdaten', 'geodaten', 'bedurfnisse', 'zufriedenheit', 'bevolkerung', 'stzh', 'nutzung', 'tabelle', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-11T03:34:20.459482`
