...
- **Keywords.de** `['lora', 'abstimmungsgerat', 'einzeldaten', 'stimmungsbilder', 'geodaten', 'bevolkerung', 'punktdaten', 'abstimmungen', 'geoportal', 'sachdaten', 'zufriedenheit', 'stzh', 'nutzung', 'tabelle', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-16T03:06:31.781392`
