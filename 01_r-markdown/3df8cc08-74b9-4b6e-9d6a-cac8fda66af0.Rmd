...
- **Keywords.de** `['sachdaten', 'abstimmungsgerat', 'geodaten', 'bedurfnisse', 'stimmungsbilder', 'bevolkerung', 'zufriedenheit', 'stzh', 'punktdaten', 'tabelle', 'nutzung', 'einzeldaten', 'lora', 'geoportal', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-09T03:02:29.876627`
