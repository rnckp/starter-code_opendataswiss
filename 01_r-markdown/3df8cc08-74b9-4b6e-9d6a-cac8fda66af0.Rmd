...
- **Keywords.de** `['sachdaten', 'nutzung', 'einzeldaten', 'stzh', 'lora', 'zufriedenheit', 'stimmungsbilder', 'abstimmungen', 'tabelle', 'punktdaten', 'abstimmungsgerat', 'geodaten', 'geoportal', 'bedurfnisse', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-28T04:37:01.560892`
