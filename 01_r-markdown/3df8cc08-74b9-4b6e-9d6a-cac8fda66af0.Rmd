...
- **Keywords.de** `['tabelle', 'geodaten', 'sachdaten', 'abstimmungsgerat', 'abstimmungen', 'stzh', 'bevolkerung', 'lora', 'zufriedenheit', 'nutzung', 'einzeldaten', 'stimmungsbilder', 'punktdaten', 'geoportal', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-04-17T03:29:08.756780`
