...
- **Keywords.de** `['nutzung', 'geoportal', 'geodaten', 'bedurfnisse', 'einzeldaten', 'sachdaten', 'bevolkerung', 'lora', 'stzh', 'abstimmungen', 'abstimmungsgerat', 'zufriedenheit', 'tabelle', 'stimmungsbilder', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-04T04:16:08.091065`
