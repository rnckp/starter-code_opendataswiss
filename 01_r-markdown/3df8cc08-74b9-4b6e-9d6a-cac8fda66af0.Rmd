...
- **Keywords.de** `['bevolkerung', 'geodaten', 'zufriedenheit', 'punktdaten', 'lora', 'tabelle', 'stimmungsbilder', 'geoportal', 'abstimmungsgerat', 'sachdaten', 'nutzung', 'einzeldaten', 'abstimmungen', 'stzh', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-12T03:29:26.641148`
