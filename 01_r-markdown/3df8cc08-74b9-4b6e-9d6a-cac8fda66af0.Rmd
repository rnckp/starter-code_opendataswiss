...
- **Keywords.de** `['zufriedenheit', 'tabelle', 'punktdaten', 'abstimmungsgerat', 'geodaten', 'einzeldaten', 'bevolkerung', 'lora', 'sachdaten', 'nutzung', 'stzh', 'geoportal', 'bedurfnisse', 'stimmungsbilder', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-10T02:47:59.484472`
