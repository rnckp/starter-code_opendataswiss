...
- **Keywords.de** `['abstimmungsgerat', 'sachdaten', 'abstimmungen', 'geodaten', 'einzeldaten', 'stimmungsbilder', 'tabelle', 'lora', 'nutzung', 'zufriedenheit', 'stzh', 'bevolkerung', 'geoportal', 'punktdaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-26T03:12:58.209416`
