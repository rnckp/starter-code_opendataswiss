...
- **Keywords.de** `['lora', 'zufriedenheit', 'abstimmungsgerat', 'stimmungsbilder', 'sachdaten', 'bevolkerung', 'punktdaten', 'nutzung', 'geodaten', 'bedurfnisse', 'einzeldaten', 'tabelle', 'geoportal', 'stzh', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-12T03:16:52.377417`
