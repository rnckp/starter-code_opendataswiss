...
- **Keywords.de** `['bedurfnisse', 'tabelle', 'zufriedenheit', 'geoportal', 'sachdaten', 'abstimmungen', 'punktdaten', 'geodaten', 'bevolkerung', 'stimmungsbilder', 'stzh', 'abstimmungsgerat', 'nutzung', 'lora', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-12-27T03:16:54.930060`
