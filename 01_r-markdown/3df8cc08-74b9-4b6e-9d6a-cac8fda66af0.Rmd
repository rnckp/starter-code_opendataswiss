...
- **Keywords.de** `['stzh', 'bevolkerung', 'lora', 'tabelle', 'stimmungsbilder', 'punktdaten', 'abstimmungsgerat', 'geoportal', 'nutzung', 'einzeldaten', 'bedurfnisse', 'sachdaten', 'abstimmungen', 'zufriedenheit', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-08T03:42:20.892326`
