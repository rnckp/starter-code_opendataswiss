...
- **Keywords.de** `['sachdaten', 'bedurfnisse', 'abstimmungsgerat', 'bevolkerung', 'einzeldaten', 'geoportal', 'nutzung', 'stzh', 'geodaten', 'stimmungsbilder', 'lora', 'punktdaten', 'tabelle', 'abstimmungen', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-14T03:17:43.336418`
