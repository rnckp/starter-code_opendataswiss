...
- **Keywords.de** `['sachdaten', 'stimmungsbilder', 'bedurfnisse', 'punktdaten', 'nutzung', 'abstimmungen', 'abstimmungsgerat', 'zufriedenheit', 'stzh', 'lora', 'bevolkerung', 'geodaten', 'einzeldaten', 'geoportal', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-10T03:34:52.941015`
