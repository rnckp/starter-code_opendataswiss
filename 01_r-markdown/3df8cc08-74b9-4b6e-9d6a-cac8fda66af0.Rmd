...
- **Keywords.de** `['abstimmungen', 'stimmungsbilder', 'sachdaten', 'lora', 'bevolkerung', 'einzeldaten', 'bedurfnisse', 'geoportal', 'punktdaten', 'stzh', 'zufriedenheit', 'geodaten', 'nutzung', 'tabelle', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-09T06:01:30.450163`
