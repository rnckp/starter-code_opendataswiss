...
- **Keywords.de** `['abstimmungsgerat', 'lora', 'zufriedenheit', 'bevolkerung', 'stzh', 'geodaten', 'abstimmungen', 'einzeldaten', 'stimmungsbilder', 'sachdaten', 'bedurfnisse', 'punktdaten', 'nutzung', 'tabelle', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-24T03:07:24.268992`
