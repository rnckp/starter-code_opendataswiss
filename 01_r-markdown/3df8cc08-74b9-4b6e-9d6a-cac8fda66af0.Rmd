...
- **Keywords.de** `['bevolkerung', 'geoportal', 'punktdaten', 'stzh', 'lora', 'abstimmungsgerat', 'sachdaten', 'zufriedenheit', 'geodaten', 'stimmungsbilder', 'nutzung', 'einzeldaten', 'bedurfnisse', 'abstimmungen', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-11-13T02:53:07.906336`
