...
- **Keywords.de** `['geodaten', 'einzeldaten', 'punktdaten', 'bedurfnisse', 'stzh', 'stimmungsbilder', 'zufriedenheit', 'abstimmungen', 'tabelle', 'abstimmungsgerat', 'bevolkerung', 'sachdaten', 'geoportal', 'lora', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-07T02:33:09.453451`
