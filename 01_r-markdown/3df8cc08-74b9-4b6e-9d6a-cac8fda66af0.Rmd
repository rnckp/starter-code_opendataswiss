...
- **Keywords.de** `['abstimmungsgerat', 'nutzung', 'geoportal', 'lora', 'sachdaten', 'tabelle', 'geodaten', 'stzh', 'bedurfnisse', 'stimmungsbilder', 'abstimmungen', 'punktdaten', 'zufriedenheit', 'einzeldaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-17T04:05:47.862275`
