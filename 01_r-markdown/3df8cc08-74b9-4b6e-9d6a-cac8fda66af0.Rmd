...
- **Keywords.de** `['stzh', 'bevolkerung', 'tabelle', 'einzeldaten', 'stimmungsbilder', 'abstimmungsgerat', 'sachdaten', 'nutzung', 'zufriedenheit', 'geoportal', 'punktdaten', 'abstimmungen', 'bedurfnisse', 'lora', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-19T03:29:32.400784`
