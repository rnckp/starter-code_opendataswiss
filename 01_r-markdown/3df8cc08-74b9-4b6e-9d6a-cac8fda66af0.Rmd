...
- **Keywords.de** `['stimmungsbilder', 'stzh', 'bedurfnisse', 'einzeldaten', 'abstimmungsgerat', 'sachdaten', 'geoportal', 'tabelle', 'abstimmungen', 'lora', 'zufriedenheit', 'bevolkerung', 'geodaten', 'nutzung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-10T04:13:56.716661`
