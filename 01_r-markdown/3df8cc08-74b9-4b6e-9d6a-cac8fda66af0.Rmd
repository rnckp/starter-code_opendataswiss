...
- **Keywords.de** `['tabelle', 'abstimmungen', 'geodaten', 'zufriedenheit', 'geoportal', 'punktdaten', 'sachdaten', 'abstimmungsgerat', 'nutzung', 'einzeldaten', 'bevolkerung', 'lora', 'bedurfnisse', 'stimmungsbilder', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-05T02:49:07.643798`
