...
- **Keywords.de** `['einzeldaten', 'abstimmungsgerat', 'geodaten', 'zufriedenheit', 'stzh', 'sachdaten', 'abstimmungen', 'tabelle', 'geoportal', 'bevolkerung', 'lora', 'nutzung', 'stimmungsbilder', 'punktdaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-08-03T03:13:33.584672`
