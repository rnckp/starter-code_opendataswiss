...
- **Keywords.de** `['zufriedenheit', 'abstimmungen', 'stzh', 'lora', 'bevolkerung', 'tabelle', 'geoportal', 'punktdaten', 'sachdaten', 'einzeldaten', 'stimmungsbilder', 'abstimmungsgerat', 'nutzung', 'bedurfnisse', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-05-24T02:48:38.150902`
