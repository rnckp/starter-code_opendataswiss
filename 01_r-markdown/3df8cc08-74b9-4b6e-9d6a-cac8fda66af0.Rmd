...
- **Keywords.de** `['punktdaten', 'tabelle', 'stzh', 'stimmungsbilder', 'sachdaten', 'einzeldaten', 'bedurfnisse', 'abstimmungsgerat', 'geoportal', 'abstimmungen', 'bevolkerung', 'zufriedenheit', 'nutzung', 'geodaten', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-06-28T02:54:38.450117`
