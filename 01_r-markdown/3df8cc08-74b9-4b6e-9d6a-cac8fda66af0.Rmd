...
- **Keywords.de** `['punktdaten', 'nutzung', 'bevolkerung', 'abstimmungen', 'lora', 'tabelle', 'abstimmungsgerat', 'geodaten', 'sachdaten', 'einzeldaten', 'bedurfnisse', 'zufriedenheit', 'stimmungsbilder', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-24T03:27:53.455593`
