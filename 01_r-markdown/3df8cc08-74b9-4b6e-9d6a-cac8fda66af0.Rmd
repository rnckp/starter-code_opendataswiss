...
- **Keywords.de** `['stzh', 'zufriedenheit', 'lora', 'sachdaten', 'bevolkerung', 'bedurfnisse', 'abstimmungsgerat', 'nutzung', 'geoportal', 'tabelle', 'abstimmungen', 'einzeldaten', 'geodaten', 'punktdaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-01T03:19:13.086194`
