...
- **Keywords.de** `['lora', 'bedurfnisse', 'geodaten', 'geoportal', 'bevolkerung', 'abstimmungsgerat', 'punktdaten', 'sachdaten', 'stimmungsbilder', 'einzeldaten', 'abstimmungen', 'tabelle', 'nutzung', 'stzh', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-11-29T03:33:32.070216`
