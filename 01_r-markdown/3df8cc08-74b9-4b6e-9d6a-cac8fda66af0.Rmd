...
- **Keywords.de** `['punktdaten', 'abstimmungsgerat', 'abstimmungen', 'bevolkerung', 'geodaten', 'stzh', 'zufriedenheit', 'tabelle', 'stimmungsbilder', 'nutzung', 'bedurfnisse', 'lora', 'sachdaten', 'einzeldaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-04-07T04:27:05.564359`
