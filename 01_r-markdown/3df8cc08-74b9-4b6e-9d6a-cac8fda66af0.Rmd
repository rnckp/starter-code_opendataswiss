...
- **Keywords.de** `['geoportal', 'einzeldaten', 'abstimmungsgerat', 'abstimmungen', 'stimmungsbilder', 'tabelle', 'zufriedenheit', 'bevolkerung', 'geodaten', 'lora', 'sachdaten', 'bedurfnisse', 'nutzung', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-01T02:47:12.659396`
