...
- **Keywords.de** `['zufriedenheit', 'geodaten', 'stimmungsbilder', 'einzeldaten', 'bevolkerung', 'abstimmungen', 'geoportal', 'tabelle', 'nutzung', 'sachdaten', 'punktdaten', 'abstimmungsgerat', 'lora', 'stzh', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-01-13T02:31:58.950395`
