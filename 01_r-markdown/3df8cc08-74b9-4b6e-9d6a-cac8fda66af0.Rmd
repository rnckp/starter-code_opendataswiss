...
- **Keywords.de** `['abstimmungsgerat', 'einzeldaten', 'zufriedenheit', 'abstimmungen', 'stimmungsbilder', 'tabelle', 'stzh', 'nutzung', 'sachdaten', 'bedurfnisse', 'geoportal', 'lora', 'bevolkerung', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-11T03:32:14.057432`
