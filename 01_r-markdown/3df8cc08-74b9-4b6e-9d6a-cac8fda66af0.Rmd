...
- **Keywords.de** `['geodaten', 'bedurfnisse', 'stimmungsbilder', 'geoportal', 'punktdaten', 'bevolkerung', 'abstimmungsgerat', 'lora', 'einzeldaten', 'abstimmungen', 'tabelle', 'zufriedenheit', 'stzh', 'nutzung', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-02-08T03:28:56.301521`
