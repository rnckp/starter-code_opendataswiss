...
- **Keywords.de** `['zufriedenheit', 'punktdaten', 'lora', 'abstimmungen', 'abstimmungsgerat', 'stzh', 'tabelle', 'nutzung', 'einzeldaten', 'bevolkerung', 'geodaten', 'stimmungsbilder', 'geoportal', 'sachdaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-03-14T02:58:32.466835`
