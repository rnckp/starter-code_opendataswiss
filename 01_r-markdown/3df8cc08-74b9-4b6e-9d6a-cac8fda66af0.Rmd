...
- **Keywords.de** `['punktdaten', 'einzeldaten', 'bedurfnisse', 'geodaten', 'nutzung', 'stzh', 'bevolkerung', 'sachdaten', 'abstimmungsgerat', 'abstimmungen', 'tabelle', 'geoportal', 'zufriedenheit', 'stimmungsbilder', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-03-04T03:55:10.400193`
