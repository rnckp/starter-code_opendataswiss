...
- **Keywords.de** `['geodaten', 'stzh', 'stimmungsbilder', 'bedurfnisse', 'tabelle', 'einzeldaten', 'lora', 'bevolkerung', 'abstimmungen', 'nutzung', 'sachdaten', 'geoportal', 'punktdaten', 'abstimmungsgerat', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-26T03:44:46.876944`
