...
- **Keywords.de** `['geodaten', 'stimmungsbilder', 'stzh', 'nutzung', 'abstimmungsgerat', 'bevolkerung', 'lora', 'geoportal', 'punktdaten', 'zufriedenheit', 'einzeldaten', 'sachdaten', 'bedurfnisse', 'abstimmungen', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-06T03:16:11.885693`
