...
- **Keywords.de** `['punktdaten', 'stzh', 'abstimmungen', 'stimmungsbilder', 'abstimmungsgerat', 'nutzung', 'lora', 'tabelle', 'geoportal', 'einzeldaten', 'geodaten', 'zufriedenheit', 'bedurfnisse', 'sachdaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-09-05T04:12:17.728660`
