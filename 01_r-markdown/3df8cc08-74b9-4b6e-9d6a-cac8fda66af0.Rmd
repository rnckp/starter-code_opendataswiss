...
- **Keywords.de** `['stzh', 'zufriedenheit', 'nutzung', 'abstimmungsgerat', 'sachdaten', 'einzeldaten', 'abstimmungen', 'punktdaten', 'geoportal', 'bedurfnisse', 'bevolkerung', 'stimmungsbilder', 'geodaten', 'lora', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-07-09T03:46:12.916441`
