...
- **Keywords.de** `['nutzung', 'abstimmungen', 'abstimmungsgerat', 'sachdaten', 'stimmungsbilder', 'bedurfnisse', 'lora', 'bevolkerung', 'geodaten', 'tabelle', 'zufriedenheit', 'geoportal', 'stzh', 'punktdaten', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-07-18T03:12:31.022093`
