...
- **Keywords.de** `['lora', 'stzh', 'punktdaten', 'abstimmungsgerat', 'bevolkerung', 'geoportal', 'stimmungsbilder', 'tabelle', 'nutzung', 'geodaten', 'abstimmungen', 'zufriedenheit', 'sachdaten', 'bedurfnisse', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2025-05-13T03:42:15.973814`
