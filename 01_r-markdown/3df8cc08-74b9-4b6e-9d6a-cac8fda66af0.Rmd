...
- **Keywords.de** `['abstimmungen', 'bevolkerung', 'punktdaten', 'nutzung', 'tabelle', 'abstimmungsgerat', 'stzh', 'bedurfnisse', 'geoportal', 'geodaten', 'lora', 'stimmungsbilder', 'zufriedenheit', 'einzeldaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2024-09-18T03:07:16.259795`
