...
- **Keywords.de** `['zufriedenheit', 'geodaten', 'lora', 'punktdaten', 'bevolkerung', 'einzeldaten', 'geoportal', 'stimmungsbilder', 'abstimmungsgerat', 'tabelle', 'bedurfnisse', 'abstimmungen', 'sachdaten', 'stzh', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:27.686235`
- **Metadata_modified** `2023-12-29T04:14:27.151707`
