...
**Zweck**: Die Dienstabteilung Verkehr (DAV) der Stadt Zürich betreibt an fast 100 Standorten Zählstellen für die Erfassung des Motorisierten Individualverkehrs (MIV).
...
- **Keywords.de** `['stzh', 'punktdaten', 'geodaten', 'vektordaten', 'geoportal', 'verkehr']`
- **Issued** `nan`
- **Metadata_created** `2024-10-25T02:53:02.837663`
- **Metadata_modified** `2024-10-27T03:27:06.547561`
