...
Schutz und Intervention Winterthur pflegt seit 2019 sämtliche Feuerwehreinsätze und veröffentlicht diese auf der städtischen Website. Die Mehrheit der Einsätze finden auf städtischem Gebiet statt. Wird die Feuerwehr Winterthur zur Unterstützung in umliegende Gemeinden gerufen, sind diese Einsätze ebenfalls im API erfasst. Die Rohdaten sind als API verfügbar und können sowohl als JSON als auch als CSV bezogen werden. In den Rohdaten enthalten sind Angaben wie das Einsatzdatum, der Zeitpunkt des Alarms, die Dauer des Einsatzes, einen Titel, die verwendeten Fahrzeuge, sowohl die Anzahl der involvierten Personen der Feuerwehren und des Zivilschutzes. Die Einsätze werden regelmässig (meist täglich) nachgeführt. 
...
- **Keywords.de** `['sicherheit', 'feuerwehr', 'rettung']`
- **Issued** `2024-12-11T17:15:28+01:00`
- **Metadata_created** `2024-12-12T04:29:45.579616`
- **Metadata_modified** `2024-12-12T04:29:45.579623`
