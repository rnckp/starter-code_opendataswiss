...
- **Keywords.de** `['denkmalschutzobjekte', 'geodaten', 'geoportal', 'polygondaten', 'vektordaten', 'amt-fur-stadtebau', 'inventar', 'stzh', 'kanton-zurich', 'denkmalpflege', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-07T00:59:54.673929`
