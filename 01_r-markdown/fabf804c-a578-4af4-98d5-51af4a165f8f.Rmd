...
- **Keywords.de** `['zustandigkeit', 'kanton-zurich', 'denkmalpflege', 'amt-fur-stadtebau', 'inventar', 'stzh', 'vektordaten', 'denkmalschutzobjekte', 'polygondaten', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-15T01:31:56.903955`
