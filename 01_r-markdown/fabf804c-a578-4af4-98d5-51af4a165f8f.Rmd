...
- **Keywords.de** `['denkmalpflege', 'denkmalschutzobjekte', 'polygondaten', 'geoportal', 'zustandigkeit', 'inventar', 'geodaten', 'amt-fur-stadtebau', 'kanton-zurich', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-12T01:40:50.555507`
