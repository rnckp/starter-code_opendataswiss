...
- **Keywords.de** `['polygondaten', 'kanton-zurich', 'denkmalpflege', 'geoportal', 'zustandigkeit', 'vektordaten', 'inventar', 'geodaten', 'denkmalschutzobjekte', 'stzh', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-27T01:07:31.091177`
