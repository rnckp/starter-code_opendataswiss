...
- **Keywords.de** `['stzh', 'kanton-zurich', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'vektordaten', 'geoportal', 'inventar', 'geodaten', 'denkmalpflege', 'polygondaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-25T01:22:04.586568`
