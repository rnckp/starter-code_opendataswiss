...
- **Keywords.de** `['kanton-zurich', 'inventar', 'amt-fur-stadtebau', 'stzh', 'zustandigkeit', 'geodaten', 'vektordaten', 'denkmalschutzobjekte', 'denkmalpflege', 'geoportal', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-03T01:16:29.122240`
