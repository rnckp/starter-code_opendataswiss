...
- **Keywords.de** `['geodaten', 'kanton-zurich', 'zustandigkeit', 'vektordaten', 'inventar', 'geoportal', 'denkmalpflege', 'denkmalschutzobjekte', 'polygondaten', 'stzh', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-03-31T02:40:40.870948`
