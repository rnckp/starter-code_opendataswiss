...
- **Keywords.de** `['kanton-zurich', 'geodaten', 'geoportal', 'inventar', 'amt-fur-stadtebau', 'polygondaten', 'denkmalschutzobjekte', 'stzh', 'denkmalpflege', 'zustandigkeit', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-08T01:17:26.013935`
