...
- **Keywords.de** `['inventar', 'stzh', 'vektordaten', 'geodaten', 'kanton-zurich', 'denkmalpflege', 'polygondaten', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'geoportal', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-18T01:14:41.854494`
