...
- **Keywords.de** `['geodaten', 'vektordaten', 'stzh', 'polygondaten', 'kanton-zurich', 'inventar', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalpflege', 'denkmalschutzobjekte', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-24T00:55:58.660750`
