...
- **Keywords.de** `['inventar', 'geoportal', 'vektordaten', 'amt-fur-stadtebau', 'denkmalpflege', 'zustandigkeit', 'polygondaten', 'denkmalschutzobjekte', 'geodaten', 'kanton-zurich', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-14T01:00:33.551196`
