...
- **Keywords.de** `['geoportal', 'amt-fur-stadtebau', 'vektordaten', 'zustandigkeit', 'stzh', 'inventar', 'geodaten', 'denkmalpflege', 'denkmalschutzobjekte', 'kanton-zurich', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-02T01:19:17.857627`
