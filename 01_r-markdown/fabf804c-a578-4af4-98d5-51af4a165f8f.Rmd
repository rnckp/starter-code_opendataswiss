...
- **Keywords.de** `['zustandigkeit', 'denkmalpflege', 'polygondaten', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'kanton-zurich', 'vektordaten', 'geoportal', 'stzh', 'geodaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-21T01:05:13.619080`
