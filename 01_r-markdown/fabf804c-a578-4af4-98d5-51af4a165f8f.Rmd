...
- **Keywords.de** `['inventar', 'polygondaten', 'kanton-zurich', 'geoportal', 'zustandigkeit', 'denkmalschutzobjekte', 'vektordaten', 'stzh', 'denkmalpflege', 'geodaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-01-23T01:04:34.257999`
