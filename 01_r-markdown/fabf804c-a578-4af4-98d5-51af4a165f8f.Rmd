...
- **Keywords.de** `['inventar', 'kanton-zurich', 'stzh', 'geoportal', 'zustandigkeit', 'polygondaten', 'denkmalschutzobjekte', 'geodaten', 'amt-fur-stadtebau', 'denkmalpflege', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-03-23T01:15:18.262550`
