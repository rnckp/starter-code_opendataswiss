...
- **Keywords.de** `['zustandigkeit', 'amt-fur-stadtebau', 'geoportal', 'kanton-zurich', 'geodaten', 'polygondaten', 'inventar', 'denkmalpflege', 'stzh', 'denkmalschutzobjekte', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-19T01:19:39.563327`
