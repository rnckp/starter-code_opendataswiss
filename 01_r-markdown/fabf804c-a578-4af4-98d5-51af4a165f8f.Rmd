...
- **Keywords.de** `['kanton-zurich', 'zustandigkeit', 'inventar', 'polygondaten', 'amt-fur-stadtebau', 'geoportal', 'denkmalpflege', 'vektordaten', 'stzh', 'denkmalschutzobjekte', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-03-02T01:18:21.467843`
