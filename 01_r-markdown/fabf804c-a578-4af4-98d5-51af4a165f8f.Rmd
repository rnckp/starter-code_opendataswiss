...
- **Keywords.de** `['inventar', 'geodaten', 'polygondaten', 'vektordaten', 'kanton-zurich', 'amt-fur-stadtebau', 'zustandigkeit', 'denkmalschutzobjekte', 'denkmalpflege', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-03-19T01:07:52.223080`
