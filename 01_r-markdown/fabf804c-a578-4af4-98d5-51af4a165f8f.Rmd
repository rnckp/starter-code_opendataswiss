...
- **Keywords.de** `['vektordaten', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'geodaten', 'geoportal', 'inventar', 'kanton-zurich', 'stzh', 'denkmalpflege', 'zustandigkeit', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-26T01:18:42.595137`
