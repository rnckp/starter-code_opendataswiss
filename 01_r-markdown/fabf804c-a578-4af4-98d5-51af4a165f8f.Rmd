...
- **Keywords.de** `['polygondaten', 'amt-fur-stadtebau', 'inventar', 'geoportal', 'geodaten', 'vektordaten', 'denkmalschutzobjekte', 'zustandigkeit', 'kanton-zurich', 'stzh', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-01T01:23:22.715473`
