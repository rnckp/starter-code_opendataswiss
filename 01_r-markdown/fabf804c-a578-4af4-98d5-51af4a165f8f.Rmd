...
- **Keywords.de** `['inventar', 'amt-fur-stadtebau', 'geoportal', 'stzh', 'geodaten', 'denkmalschutzobjekte', 'zustandigkeit', 'denkmalpflege', 'polygondaten', 'kanton-zurich', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-24T01:07:17.751502`
