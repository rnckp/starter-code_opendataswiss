...
- **Keywords.de** `['amt-fur-stadtebau', 'zustandigkeit', 'polygondaten', 'kanton-zurich', 'geodaten', 'inventar', 'geoportal', 'stzh', 'vektordaten', 'denkmalschutzobjekte', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-01-27T01:18:59.343111`
