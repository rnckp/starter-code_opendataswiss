...
- **Keywords.de** `['kanton-zurich', 'denkmalpflege', 'denkmalschutzobjekte', 'zustandigkeit', 'polygondaten', 'amt-fur-stadtebau', 'stzh', 'vektordaten', 'inventar', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-05-03T00:59:15.313790`
