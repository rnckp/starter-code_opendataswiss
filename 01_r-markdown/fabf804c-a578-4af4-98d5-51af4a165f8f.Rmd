...
- **Keywords.de** `['polygondaten', 'denkmalschutzobjekte', 'zustandigkeit', 'denkmalpflege', 'geoportal', 'amt-fur-stadtebau', 'kanton-zurich', 'vektordaten', 'inventar', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-28T01:03:29.525388`
