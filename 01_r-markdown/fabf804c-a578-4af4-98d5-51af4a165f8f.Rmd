...
- **Keywords.de** `['denkmalpflege', 'inventar', 'geodaten', 'vektordaten', 'kanton-zurich', 'zustandigkeit', 'denkmalschutzobjekte', 'polygondaten', 'geoportal', 'stzh', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-28T01:31:36.686395`
