...
- **Keywords.de** `['denkmalpflege', 'denkmalschutzobjekte', 'geoportal', 'stzh', 'vektordaten', 'polygondaten', 'kanton-zurich', 'amt-fur-stadtebau', 'inventar', 'zustandigkeit', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-03-06T01:17:40.362050`
