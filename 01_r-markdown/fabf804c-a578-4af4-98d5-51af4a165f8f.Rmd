...
- **Keywords.de** `['geodaten', 'denkmalschutzobjekte', 'geoportal', 'denkmalpflege', 'inventar', 'polygondaten', 'stzh', 'amt-fur-stadtebau', 'zustandigkeit', 'kanton-zurich', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-03-17T01:06:45.397482`
