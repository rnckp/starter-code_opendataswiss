...
- **Keywords.de** `['amt-fur-stadtebau', 'zustandigkeit', 'denkmalpflege', 'kanton-zurich', 'vektordaten', 'stzh', 'polygondaten', 'denkmalschutzobjekte', 'geoportal', 'geodaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-05-05T01:24:46.185149`
