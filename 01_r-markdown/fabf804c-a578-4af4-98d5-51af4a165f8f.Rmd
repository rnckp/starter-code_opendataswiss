...
- **Keywords.de** `['amt-fur-stadtebau', 'vektordaten', 'inventar', 'stzh', 'zustandigkeit', 'geodaten', 'denkmalschutzobjekte', 'polygondaten', 'kanton-zurich', 'denkmalpflege', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-20T01:23:52.324452`
