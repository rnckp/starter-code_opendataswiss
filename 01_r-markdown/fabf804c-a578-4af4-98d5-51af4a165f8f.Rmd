...
- **Keywords.de** `['stzh', 'polygondaten', 'denkmalpflege', 'denkmalschutzobjekte', 'inventar', 'geoportal', 'kanton-zurich', 'amt-fur-stadtebau', 'vektordaten', 'geodaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-08T02:46:13.183260`
