...
- **Keywords.de** `['geodaten', 'geoportal', 'polygondaten', 'kanton-zurich', 'denkmalpflege', 'stzh', 'denkmalschutzobjekte', 'inventar', 'amt-fur-stadtebau', 'zustandigkeit', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-25T00:55:47.478860`
