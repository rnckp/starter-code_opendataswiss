...
- **Keywords.de** `['polygondaten', 'vektordaten', 'geodaten', 'denkmalschutzobjekte', 'geoportal', 'amt-fur-stadtebau', 'denkmalpflege', 'stzh', 'kanton-zurich', 'zustandigkeit', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-03-01T01:07:21.903845`
