...
- **Keywords.de** `['kanton-zurich', 'inventar', 'polygondaten', 'denkmalschutzobjekte', 'geoportal', 'amt-fur-stadtebau', 'stzh', 'denkmalpflege', 'zustandigkeit', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-23T00:56:59.559182`
