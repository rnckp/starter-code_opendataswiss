...
- **Keywords.de** `['inventar', 'geodaten', 'geoportal', 'polygondaten', 'stzh', 'denkmalpflege', 'denkmalschutzobjekte', 'vektordaten', 'kanton-zurich', 'zustandigkeit', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-03-24T01:18:54.786608`
