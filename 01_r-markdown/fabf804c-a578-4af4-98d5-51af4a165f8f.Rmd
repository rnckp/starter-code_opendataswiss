...
- **Keywords.de** `['stzh', 'denkmalschutzobjekte', 'denkmalpflege', 'geoportal', 'polygondaten', 'vektordaten', 'amt-fur-stadtebau', 'inventar', 'zustandigkeit', 'geodaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-04T01:10:25.033990`
