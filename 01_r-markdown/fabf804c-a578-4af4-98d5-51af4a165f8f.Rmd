...
- **Keywords.de** `['stzh', 'amt-fur-stadtebau', 'geodaten', 'kanton-zurich', 'inventar', 'denkmalschutzobjekte', 'vektordaten', 'zustandigkeit', 'geoportal', 'polygondaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-04-03T01:17:21.189701`
