...
- **Keywords.de** `['zustandigkeit', 'stzh', 'denkmalpflege', 'polygondaten', 'amt-fur-stadtebau', 'vektordaten', 'denkmalschutzobjekte', 'kanton-zurich', 'geoportal', 'geodaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-06T01:46:33.998707`
