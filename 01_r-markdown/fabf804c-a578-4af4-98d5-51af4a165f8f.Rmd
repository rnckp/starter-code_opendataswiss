...
- **Keywords.de** `['denkmalpflege', 'kanton-zurich', 'denkmalschutzobjekte', 'geoportal', 'zustandigkeit', 'stzh', 'geodaten', 'amt-fur-stadtebau', 'inventar', 'vektordaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-03-10T01:11:36.254868`
