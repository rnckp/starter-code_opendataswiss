...
- **Keywords.de** `['polygondaten', 'geoportal', 'amt-fur-stadtebau', 'vektordaten', 'kanton-zurich', 'denkmalpflege', 'zustandigkeit', 'denkmalschutzobjekte', 'stzh', 'geodaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2022-05-11T01:12:01.223846`
- **Metadata_modified** `2023-02-07T02:05:32.860343`
