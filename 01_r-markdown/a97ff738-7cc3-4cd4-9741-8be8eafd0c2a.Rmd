...
- **Publisher** `Erziehungsdepartement/Jugend, Familie und Sport/Abteilung Sport / Sportamt`
- **Organization.display_name.de** `Kanton Basel-Stadt`
- **Organization.url** `https://www.opendata.bs.ch`
- **Maintainer** `None`
- **Maintainer_email** `None`
- **Keywords.de** `['opensportdata', 'sportanlagen', 'sport']`
- **Issued** `2021-07-23T00:00:00`
- **Metadata_created** `2022-06-14T07:38:10.277650`
- **Metadata_modified** `2023-03-24T00:33:58.572246`
