...
Auto-generated R starter code for the dataset list-of-all-exhibitions-kunsthaus-zuerich@openglam.
...
df <- read_delim('https://github.com/KunsthausZuerich/exhibitions')
