...
- **Keywords.de** `['pneu', 'geoportal', 'druckluft', 'vektordaten', 'geodaten', 'punktdaten', 'velopumpstationen', 'velo', 'handpumpe', 'luft', 'zweirad', 'stzh', 'masterplan-velo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:21.319149`
- **Metadata_modified** `2023-04-26T01:16:09.662662`
