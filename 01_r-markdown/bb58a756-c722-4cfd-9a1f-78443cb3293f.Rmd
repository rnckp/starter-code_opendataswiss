...
- **Keywords.de** `['zweirad', 'pneu', 'geoportal', 'vektordaten', 'punktdaten', 'velopumpstationen', 'stzh', 'velo', 'luft', 'geodaten', 'druckluft', 'handpumpe', 'masterplan-velo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:21.319149`
- **Metadata_modified** `2023-02-23T00:51:57.270367`
