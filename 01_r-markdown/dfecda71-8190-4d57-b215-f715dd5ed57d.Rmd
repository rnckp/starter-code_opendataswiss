...
- **Keywords.de** `['feuchte', 'wv', 'regen', 'niederschlag', 'tabelle', 'sachdaten', 'hitze', 'p_', 'kalte', 'echtzeit', 'wd', 'luftdruck', 'luft', 'messwerte', 'umweltdaten', 'wind', 'wetter', 'hr', 'lufttemperatur', 'meteo', 'windrichtung', 'regendauer', 'luftfeuchte', 'temperatur', 'global-strahlung', 'windgeschwindigkeit', 'zeitreihe', 't_']`
- **Issued** `nan`
- **Metadata_created** `2024-11-28T02:49:35.069347`
- **Metadata_modified** `2025-02-04T03:10:47.818072`
