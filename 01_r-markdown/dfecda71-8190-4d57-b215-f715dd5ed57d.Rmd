...
- **Keywords.de** `['hitze', 'wind', 'regen', 'hr', 'sachdaten', 'luftdruck', 'umweltdaten', 'feuchte', 'tabelle', 't_', 'windgeschwindigkeit', 'meteo', 'kalte', 'zeitreihe', 'echtzeit', 'luft', 'global-strahlung', 'niederschlag', 'lufttemperatur', 'p_', 'wd', 'temperatur', 'wv', 'messwerte', 'luftfeuchte', 'wetter', 'windrichtung', 'regendauer']`
- **Issued** `nan`
- **Metadata_created** `2024-11-28T02:49:35.069347`
- **Metadata_modified** `2025-01-18T03:47:25.414348`
