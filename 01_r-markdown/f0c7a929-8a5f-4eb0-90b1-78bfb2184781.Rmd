...
- **Keywords.de** `['geodaten', 'punktdaten', 'baumstandorte', 'stadtbegrunung', 'geoportal', 'swisstlm3d', 'stzh', 'baumkataster', 'lidar', 'baumhohe', 'vektordaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:05.281858`
- **Metadata_modified** `2024-06-15T02:51:27.602905`
