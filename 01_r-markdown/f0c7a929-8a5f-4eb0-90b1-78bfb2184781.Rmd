...
- **Keywords.de** `['stadtbegrunung', 'baumstandorte', 'polygondaten', 'geodaten', 'lidar', 'stzh', 'punktdaten', 'geoportal', 'vektordaten', 'baumkataster', 'baumhohe', 'swisstlm3d']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:05.281858`
- **Metadata_modified** `2024-05-17T02:43:08.446815`
