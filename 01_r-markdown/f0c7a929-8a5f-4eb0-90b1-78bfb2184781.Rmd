...
- **Keywords.de** `['stadtbegrunung', 'baumkataster', 'lidar', 'punktdaten', 'baumstandorte', 'geodaten', 'vektordaten', 'polygondaten', 'swisstlm3d', 'stzh', 'baumhohe', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:05.281858`
- **Metadata_modified** `2024-12-30T03:25:05.569035`
