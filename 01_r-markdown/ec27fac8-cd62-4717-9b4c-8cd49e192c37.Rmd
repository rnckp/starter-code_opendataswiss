...
Auto-generated R starter code for the dataset fs-gfs-model@eidgenossische-finanzverwaltung-efv.
...
- **Metadata_modified** `2026-01-06T01:57:32.960560`
...
df <- read_delim('https://www.data.finance.admin.ch/static/assets/datasets/fs_dashboard/standardauswertung.csv')
...
df <- read_delim('https://www.data.finance.admin.ch/static/assets/datasets/fs_dashboard/standardauswertung_codelist.csv')
