...
Geografische Darstellung der Dichte von lebenden, registrierten Rindern pro Kanton und landwirtschaftliche Zonen gemäss Klassifikation BLW: Anzahl absolut, Anzahl pro Landfläche in km2 ohne Gewässer, Anzahl pro 100 Einwohner sowie die fünf beliebtesten Rassen und Namen. Bewegen Sie die «Maus» über die Karte, um die Ergebnisse anzuzeigen.
...
- **Keywords.de** `['rinder', 'kanton', 'nutztiere', 'karten']`
- **Issued** `nan`
- **Metadata_created** `2022-06-07T11:22:32.768579`
- **Metadata_modified** `2023-02-21T01:12:48.998209`
