...
Auto-generated R starter code for the dataset fir_art_funk@eidgenossische-finanzverwaltung-efv.
...
- **Metadata_modified** `2026-01-06T01:57:32.663659`
...
df <- read_delim('https://www.data.finance.admin.ch/static/assets/datasets/fs_dashboard/fir_art_funk_codelist.csv')
...
df <- read_delim('https://www.data.finance.admin.ch/static/assets/datasets/fs_dashboard/fir_art_funk.csv')
