...
- **Keywords.de** `['aldi', 'standortdaten', 'supermarkt', 'landi', 'denner', 'migrolino', 'volg', 'coop', 'verkaufsladen', 'shop', 'gewerbe', 'adressdaten', 'einkaufsladen', 'geodaten', 'dorfladen', 'detailhandel', 'adresse', 'schnaps', 'hochprozentig', 'alkohol', 'points-of-interest', 'lidl', 'grosshandel', 'firmenadresse']`
- **Issued** `2023-02-13T00:00:00`
- **Metadata_created** `2023-02-17T11:03:02.638686`
- **Metadata_modified** `2024-08-08T03:38:06.320881`
...
df <- read_delim('https://data.bl.ch/api/v2/catalog/datasets/10960/exports/csv?use_labels=false')
