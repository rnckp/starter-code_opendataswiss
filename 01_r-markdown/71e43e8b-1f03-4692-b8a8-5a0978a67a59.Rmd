...
- **Keywords.de** `['geschaftsregister', 'zug', 'echtzeit', 'proprietar', 'daten', 'geschaftsorganisation', 'bus', 'swiss-business-organisation-id', 'swiss-administration-id', 'on-demand-bus', 'verkehrsunternehmen', 'mobilitatsdienstleister', 'embag', 'transportunternehmen']`
- **Issued** `2016-12-01T12:00:00`
- **Metadata_created** `2017-03-02T09:12:37.744386`
- **Metadata_modified** `2025-06-06T02:19:51.127243`
...
# Description              : Die Liste umfasst alle Geschäftsorganisationen, für die Echtzeitdaten zur Verfügung stehen oder in Zukunft stehen werden. Letztes Update: 03.04.2025
# Issued                   : None
# Modified                 : None
