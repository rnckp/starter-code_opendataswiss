...
- **Keywords.de** `['mobilitatsdienstleister', 'echtzeit', 'zug', 'swiss-business-organisation-id', 'proprietar', 'embag', 'bus', 'daten', 'geschaftsregister', 'geschaftsorganisation', 'on-demand-bus', 'transportunternehmen', 'swiss-administration-id', 'verkehrsunternehmen']`
- **Issued** `2016-12-01T12:00:00`
- **Metadata_created** `2017-03-02T09:12:37.744386`
- **Metadata_modified** `2025-04-21T02:42:07.925838`
...
# Description              : Die Liste umfasst alle Geschäftsorganisationen, für die Echtzeitdaten zur Verfügung stehen oder in Zukunft stehen werden. Letztes Update: 14.01.2025
# Issued                   : None
# Modified                 : None
# Rights                   : https://opendata.swiss/terms-of-use#terms_by

df <- read_delim('https://data.opentransportdata.swiss/dataset/27aba9bd-59ed-4d7c-bc71-a3813d1d1799/resource/83b8b8d0-e345-453b-857e-1192d48c4c64/download/go-realtime.csv')
