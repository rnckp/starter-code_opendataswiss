...
Auto-generated R starter code for the dataset SNSF OpenAPC Data@schweizerischer-nationalfonds-zur-forderung-der-wissenschaftlichen-forschung-snf.
...
df <- read_delim('https://github.com/OpenAPC/openapc-de/tree/master/data/snsf')
