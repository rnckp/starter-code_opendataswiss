...
Covid-19:
Fallzahlen Basel-Stadt: https://data.bs.ch/explore/dataset/100073/
Tests Basel-Stadt:https://data.bs.ch/explore/dataset/100094/
Todesfälle Basel-Stadt nach Alter und Geschlecht: https://data.bs.ch/explore/dataset/100076/

Covid-19 Dashboard: https://data.bs.ch/pages/covid-19-dashboard/Änderungsprotokoll:Die Erhebung der Werte wurde per 30. Juni 2023 sistiert. Der Datensatz wird nicht mehr aktualisiert. Aktualisierungsintervall von 'DAILY' auf 'NEVER' geändert.
...
- **Keywords.de** `['krankheit', 'coronavirus', 'pandemie', 'lungenentzundung', 'covid-19', 'spital', 'virus', 'quarantane', 'corona']`
- **Issued** `2020-11-24T00:00:00`
- **Metadata_created** `2021-09-03T09:14:19.460303`
- **Metadata_modified** `2024-11-13T01:59:55.783668`
