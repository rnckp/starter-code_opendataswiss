...
- **Publisher** `Hochbaudepartement, Amt für Städtebau`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `None`
- **Maintainer_email** `None`
- **Keywords.de** `['tabelle', 'bevoelkerungsszenarien', 'zeitreihe', 'sasa', 'sachdaten']`
- **Issued** `2024-06-25T00:00:00`
- **Metadata_created** `2024-07-05T03:20:00.856973`
- **Metadata_modified** `2024-09-06T03:13:59.538892`
...
# Modified                 : 2024-05-09T20:48:42.598949
