...
- **Keywords.de** `['baum', 'obst', 'getreide', 'flache', 'gerste', 'kultur', 'nutzflache', 'weizen', 'wiese', 'dinkel', 'hafer', 'soja', 'landwirtschaft', 'rube', 'baume']`
- **Issued** `2024-07-16T14:25:34+00:00`
- **Metadata_created** `2024-07-27T11:01:22.691626`
- **Metadata_modified** `2024-07-29T11:52:35.101745`
...
df <- read_delim('https://data.tg.ch/api/v2/catalog/datasets/div-la-3/exports/csv')
