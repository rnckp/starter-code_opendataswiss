...
- **Publisher.name** `Freiraumberatung_1, Grün Stadt Zürich, Tiefbau- und Entsorgungsdepartement`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `Open Data Zürich`
- **Maintainer_email** `opendata@zuerich.ch`
- **Keywords.de** `['geoportal', 'freiraumberatung', 'polygondaten', 'gebietseinteilung', 'vektordaten', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:45:02.185109`
- **Metadata_modified** `2025-04-02T03:26:40.044379`
