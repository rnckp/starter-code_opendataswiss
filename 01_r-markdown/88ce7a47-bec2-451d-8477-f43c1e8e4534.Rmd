...
- **Keywords.de** `['holz', 'statistikdaten', 'elektrizitat', 'gas', 'erdgas', 'ol', 'gebaude', 'strom', 'warmepumpe', 'fernwarme', 'heizol']`
- **Issued** `2023-02-28T00:00:00`
- **Metadata_created** `2023-03-01T16:55:58.365302`
- **Metadata_modified** `2024-08-08T03:40:02.717263`
...
df <- read_delim('https://data.bl.ch/api/v2/catalog/datasets/11940/exports/csv?use_labels=false')
