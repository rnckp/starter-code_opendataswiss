...
- **Keywords.de** `['gemeindewahlen', 'kommunalwahlen', 'vorname', 'geschlecht', 'jahrgang', 'name']`
- **Issued** `2024-02-28T00:00:00`
- **Metadata_created** `2024-02-28T04:43:52.153720`
- **Metadata_modified** `2024-08-08T03:38:42.402042`
...
df <- read_delim('https://data.bl.ch/api/v2/catalog/datasets/10700/exports/csv?use_labels=false')
