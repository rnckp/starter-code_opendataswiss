...
- **Metadata_modified** `2023-12-08T11:41:13.599527`
...
df <- read_delim('https://dam-api.bfs.admin.ch/hub/api/dam/assets/27125925/master')
...
df <- read_delim('https://dam-api.bfs.admin.ch/hub/api/dam/assets/27125928/master')
...
df <- read_delim('https://dam-api.bfs.admin.ch/hub/api/dam/assets/27125922/master')
...
df <- read_delim('https://dam-api.bfs.admin.ch/hub/api/dam/assets/27125929/master')
