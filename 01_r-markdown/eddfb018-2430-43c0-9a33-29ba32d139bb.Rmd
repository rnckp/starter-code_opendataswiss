...
[Direct link by **Bundesamt für Raumentwicklung ARE** for dataset](https://doi.org/10.5281/zenodo.17086118)

Auto-generated R starter code for the dataset externeEffekte@bundesamt-fur-raumentwicklung-are.
...
- **Metadata_modified** `2025-10-28T09:51:12.866129`
...
# Modified                 : 2025-09-24T00:00:00
# Rights                   : None

df <- read_delim('https://zenodo.org/records/17086118/files/Haupttabelle_2021.csv?download=1')
...
df <- read_delim('https://zenodo.org/records/17086118/files/Haupttabelle_2010_2020.csv?download=1')
...
df <- read_delim('https://zenodo.org/records/17086118/files/Sensitivit%C3%A4ten_2021.csv?download=1')
...
df <- read_delim('https://zenodo.org/records/17086118/files/Durchschnittskosten.MitMengenger%C3%BCst_2021.csv?download=1')
...
df <- read_delim('https://zenodo.org/records/17086118/files/NachAntriebsart_2021.csv?download=1')
...
df <- read_delim('https://zenodo.org/records/17086118/files/NachKanton_2021.csv?download=1')
...
df <- read_delim('https://zenodo.org/records/17086118/files/NachRaumtyp_2021.csv?download=1')
...
df <- read_delim('https://zenodo.org/records/17086118/files/Haupttabelle_2022.csv?download=1')
...
df <- read_delim('https://zenodo.org/records/17086118/files/Sensitivit%C3%A4ten_2022.csv?download=1')
...
df <- read_delim('https://zenodo.org/records/17086118/files/Durchschnittskosten.MitMengenger%C3%BCst_2022.csv?download=1')
...
df <- read_delim('https://zenodo.org/records/17086118/files/NachAntriebsart_2022.csv?download=1')
...
df <- read_delim('https://zenodo.org/records/17086118/files/NachKanton_2022.csv?download=1')
