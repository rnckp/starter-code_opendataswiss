...
- **Publisher.name** `Fachstelle Zürich im Alter, Städtische Gesundheitsdienste, Gesundheits- und Umweltdepartement`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `Open Data Zürich`
- **Maintainer_email** `opendata@zuerich.ch`
- **Keywords.de** `['geodaten', 'geoportal', 'punktdaten', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:41:27.159922`
- **Metadata_modified** `2025-04-17T03:28:07.667225`
