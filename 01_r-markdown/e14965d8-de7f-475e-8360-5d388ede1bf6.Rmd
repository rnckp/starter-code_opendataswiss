...
- **Publisher** `Schulraumplanung, Schulamt, Schul- und Sportdepartement`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `None`
- **Maintainer_email** `None`
- **Keywords.de** `['bildung', 'schule', 'stzh', 'geoportal', 'geodaten', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:53:06.465793`
- **Metadata_modified** `2024-11-17T01:52:48.818842`
