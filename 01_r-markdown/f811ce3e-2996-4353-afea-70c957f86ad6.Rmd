...
- **Publisher** `Departement für Wirtschaft, Soziales und Umwelt/Amt für Umwelt und Energie/Abteilung Gewässer und Boden`
- **Organization.display_name.de** `Kanton Basel-Stadt`
- **Organization.url** `https://www.opendata.bs.ch`
- **Maintainer** `None`
- **Maintainer_email** `None`
- **Keywords.de** `['hydrogeologie', 'erdwarme', 'grundwasser']`
- **Issued** `2022-04-12T00:00:00`
- **Metadata_created** `2022-06-09T08:39:06.305595`
- **Metadata_modified** `2023-04-03T00:27:12.111469`
