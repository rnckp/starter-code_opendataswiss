...
- **Keywords.de** `['punktdaten', 'bedurfnisse', 'geodaten', 'stzh', 'einzeldaten', 'tabelle', 'zufriedenheit', 'abstimmungen', 'abstimmungsgerat', 'nutzung', 'sachdaten', 'geoportal', 'bevolkerung', 'lora', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-04T01:18:43.638590`
