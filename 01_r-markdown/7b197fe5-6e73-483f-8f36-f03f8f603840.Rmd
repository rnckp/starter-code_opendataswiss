...
- **Keywords.de** `['abstimmungsgerat', 'einzeldaten', 'lora', 'tabelle', 'geoportal', 'geodaten', 'punktdaten', 'nutzung', 'abstimmungen', 'stimmungsbilder', 'bedurfnisse', 'stzh', 'zufriedenheit', 'bevolkerung', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-03T01:18:44.927698`
