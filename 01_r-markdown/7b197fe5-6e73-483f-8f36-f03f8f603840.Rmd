...
- **Keywords.de** `['abstimmungen', 'punktdaten', 'tabelle', 'geoportal', 'nutzung', 'einzeldaten', 'lora', 'sachdaten', 'stimmungsbilder', 'stzh', 'zufriedenheit', 'geodaten', 'abstimmungsgerat', 'bedurfnisse', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-30T01:07:53.122348`
