...
- **Keywords.de** `['punktdaten', 'geoportal', 'stzh', 'abstimmungen', 'abstimmungsgerat', 'nutzung', 'bedurfnisse', 'geodaten', 'zufriedenheit', 'lora', 'sachdaten', 'bevolkerung', 'einzeldaten', 'stimmungsbilder', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-07T01:09:20.732431`
