...
- **Keywords.de** `['lora', 'sachdaten', 'einzeldaten', 'tabelle', 'zufriedenheit', 'bevolkerung', 'nutzung', 'abstimmungsgerat', 'geoportal', 'bedurfnisse', 'stzh', 'stimmungsbilder', 'punktdaten', 'geodaten', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-09T01:45:23.267286`
