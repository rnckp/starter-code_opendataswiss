...
- **Keywords.de** `['punktdaten', 'stimmungsbilder', 'geoportal', 'sachdaten', 'bevolkerung', 'zufriedenheit', 'geodaten', 'lora', 'einzeldaten', 'stzh', 'nutzung', 'abstimmungen', 'abstimmungsgerat', 'tabelle', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-10-09T01:32:41.806818`
