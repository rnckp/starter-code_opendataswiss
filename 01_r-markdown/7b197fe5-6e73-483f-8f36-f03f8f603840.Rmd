...
- **Keywords.de** `['abstimmungen', 'bevolkerung', 'lora', 'geodaten', 'sachdaten', 'stimmungsbilder', 'punktdaten', 'geoportal', 'einzeldaten', 'nutzung', 'stzh', 'tabelle', 'zufriedenheit', 'bedurfnisse', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-13T01:15:02.979333`
