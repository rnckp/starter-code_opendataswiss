...
- **Keywords.de** `['geodaten', 'lora', 'stzh', 'tabelle', 'punktdaten', 'abstimmungsgerat', 'bedurfnisse', 'nutzung', 'einzeldaten', 'stimmungsbilder', 'zufriedenheit', 'bevolkerung', 'geoportal', 'abstimmungen', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-18T01:11:46.529176`
