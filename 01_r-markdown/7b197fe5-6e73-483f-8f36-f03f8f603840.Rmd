...
- **Keywords.de** `['abstimmungsgerat', 'bedurfnisse', 'bevolkerung', 'lora', 'stimmungsbilder', 'stzh', 'geoportal', 'punktdaten', 'nutzung', 'abstimmungen', 'geodaten', 'sachdaten', 'einzeldaten', 'tabelle', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-17T01:03:08.454237`
