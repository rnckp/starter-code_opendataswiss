...
- **Keywords.de** `['zufriedenheit', 'bevolkerung', 'einzeldaten', 'abstimmungen', 'nutzung', 'geodaten', 'tabelle', 'punktdaten', 'bedurfnisse', 'sachdaten', 'geoportal', 'stzh', 'abstimmungsgerat', 'stimmungsbilder', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-13T01:09:59.642612`
