...
- **Keywords.de** `['bedurfnisse', 'punktdaten', 'bevolkerung', 'abstimmungen', 'stimmungsbilder', 'zufriedenheit', 'stzh', 'geodaten', 'nutzung', 'abstimmungsgerat', 'einzeldaten', 'lora', 'tabelle', 'geoportal', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-26T01:43:38.677369`
