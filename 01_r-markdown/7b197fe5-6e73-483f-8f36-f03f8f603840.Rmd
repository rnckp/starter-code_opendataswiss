...
- **Keywords.de** `['stimmungsbilder', 'abstimmungen', 'stzh', 'nutzung', 'punktdaten', 'lora', 'geoportal', 'einzeldaten', 'bedurfnisse', 'bevolkerung', 'sachdaten', 'tabelle', 'geodaten', 'zufriedenheit', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-26T01:41:17.981162`
