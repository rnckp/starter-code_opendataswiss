...
- **Keywords.de** `['stzh', 'bevolkerung', 'tabelle', 'nutzung', 'geoportal', 'stimmungsbilder', 'geodaten', 'abstimmungsgerat', 'lora', 'zufriedenheit', 'sachdaten', 'bedurfnisse', 'punktdaten', 'abstimmungen', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-26T01:17:39.198088`
