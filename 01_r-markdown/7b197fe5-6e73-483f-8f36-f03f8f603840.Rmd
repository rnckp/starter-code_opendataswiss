...
- **Keywords.de** `['bevolkerung', 'abstimmungen', 'bedurfnisse', 'geoportal', 'stzh', 'einzeldaten', 'lora', 'punktdaten', 'stimmungsbilder', 'abstimmungsgerat', 'sachdaten', 'nutzung', 'geodaten', 'zufriedenheit', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-21T01:20:02.237315`
