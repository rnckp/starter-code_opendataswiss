...
- **Keywords.de** `['zufriedenheit', 'abstimmungsgerat', 'geodaten', 'sachdaten', 'lora', 'stzh', 'geoportal', 'bevolkerung', 'stimmungsbilder', 'einzeldaten', 'punktdaten', 'tabelle', 'bedurfnisse', 'abstimmungen', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-19T01:32:38.961252`
