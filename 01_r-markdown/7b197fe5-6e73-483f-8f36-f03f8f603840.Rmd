...
- **Keywords.de** `['abstimmungsgerat', 'punktdaten', 'abstimmungen', 'einzeldaten', 'geodaten', 'nutzung', 'zufriedenheit', 'sachdaten', 'bevolkerung', 'stimmungsbilder', 'geoportal', 'lora', 'bedurfnisse', 'stzh', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-01T01:31:48.667194`
