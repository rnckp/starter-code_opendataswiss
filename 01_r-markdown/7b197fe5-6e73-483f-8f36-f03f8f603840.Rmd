...
- **Keywords.de** `['bevolkerung', 'geodaten', 'sachdaten', 'stimmungsbilder', 'zufriedenheit', 'bedurfnisse', 'abstimmungsgerat', 'abstimmungen', 'stzh', 'tabelle', 'einzeldaten', 'nutzung', 'lora', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-11-05T02:46:23.909687`
