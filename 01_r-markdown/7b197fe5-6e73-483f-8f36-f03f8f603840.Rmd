...
- **Keywords.de** `['geoportal', 'punktdaten', 'zufriedenheit', 'geodaten', 'einzeldaten', 'bedurfnisse', 'bevolkerung', 'nutzung', 'abstimmungsgerat', 'sachdaten', 'abstimmungen', 'stimmungsbilder', 'stzh', 'lora', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-20T01:13:34.309557`
