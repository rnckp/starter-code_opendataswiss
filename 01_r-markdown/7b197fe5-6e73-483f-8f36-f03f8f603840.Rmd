...
- **Keywords.de** `['lora', 'tabelle', 'bedurfnisse', 'bevolkerung', 'stzh', 'nutzung', 'abstimmungsgerat', 'abstimmungen', 'geodaten', 'einzeldaten', 'stimmungsbilder', 'sachdaten', 'punktdaten', 'zufriedenheit', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-21T00:59:46.613177`
