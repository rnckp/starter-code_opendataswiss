...
- **Keywords.de** `['abstimmungsgerat', 'lora', 'zufriedenheit', 'geodaten', 'nutzung', 'stzh', 'punktdaten', 'sachdaten', 'einzeldaten', 'abstimmungen', 'bevolkerung', 'geoportal', 'tabelle', 'bedurfnisse', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-13T01:06:08.719072`
