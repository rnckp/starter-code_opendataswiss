...
- **Keywords.de** `['sachdaten', 'tabelle', 'abstimmungen', 'bevolkerung', 'nutzung', 'stzh', 'zufriedenheit', 'einzeldaten', 'lora', 'stimmungsbilder', 'geoportal', 'abstimmungsgerat', 'punktdaten', 'bedurfnisse', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-11T01:29:29.493687`
