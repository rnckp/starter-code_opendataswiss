...
- **Keywords.de** `['abstimmungen', 'sachdaten', 'bevolkerung', 'stimmungsbilder', 'bedurfnisse', 'punktdaten', 'abstimmungsgerat', 'zufriedenheit', 'geodaten', 'tabelle', 'nutzung', 'lora', 'einzeldaten', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-08T00:57:46.553537`
