...
- **Keywords.de** `['sachdaten', 'stzh', 'zufriedenheit', 'geodaten', 'geoportal', 'abstimmungen', 'bedurfnisse', 'einzeldaten', 'nutzung', 'lora', 'tabelle', 'abstimmungsgerat', 'punktdaten', 'bevolkerung', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-11T01:46:39.611367`
