...
- **Keywords.de** `['geodaten', 'sachdaten', 'lora', 'abstimmungsgerat', 'bevolkerung', 'bedurfnisse', 'stzh', 'tabelle', 'stimmungsbilder', 'punktdaten', 'abstimmungen', 'zufriedenheit', 'geoportal', 'einzeldaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-21T01:33:09.973681`
