...
- **Keywords.de** `['tabelle', 'geodaten', 'lora', 'stimmungsbilder', 'abstimmungen', 'sachdaten', 'zufriedenheit', 'nutzung', 'punktdaten', 'stzh', 'geoportal', 'einzeldaten', 'abstimmungsgerat', 'bedurfnisse', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-15T01:15:16.894537`
