...
- **Keywords.de** `['geodaten', 'abstimmungen', 'stimmungsbilder', 'tabelle', 'sachdaten', 'geoportal', 'nutzung', 'bedurfnisse', 'zufriedenheit', 'lora', 'einzeldaten', 'punktdaten', 'stzh', 'abstimmungsgerat', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-07T01:12:49.817574`
