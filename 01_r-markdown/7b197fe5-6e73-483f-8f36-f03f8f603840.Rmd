...
- **Keywords.de** `['punktdaten', 'lora', 'bevolkerung', 'zufriedenheit', 'stimmungsbilder', 'einzeldaten', 'tabelle', 'geoportal', 'sachdaten', 'bedurfnisse', 'abstimmungen', 'stzh', 'abstimmungsgerat', 'geodaten', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-19T01:46:12.164678`
