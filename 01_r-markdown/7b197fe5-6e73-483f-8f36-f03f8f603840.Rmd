...
- **Keywords.de** `['geoportal', 'nutzung', 'tabelle', 'lora', 'einzeldaten', 'geodaten', 'bevolkerung', 'sachdaten', 'abstimmungen', 'bedurfnisse', 'abstimmungsgerat', 'stzh', 'punktdaten', 'zufriedenheit', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-11-02T02:40:49.782155`
