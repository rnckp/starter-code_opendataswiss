...
- **Keywords.de** `['zufriedenheit', 'stzh', 'lora', 'tabelle', 'abstimmungsgerat', 'abstimmungen', 'geoportal', 'bevolkerung', 'punktdaten', 'stimmungsbilder', 'nutzung', 'sachdaten', 'geodaten', 'einzeldaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-16T00:59:42.903814`
