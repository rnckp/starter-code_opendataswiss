...
- **Keywords.de** `['stimmungsbilder', 'stzh', 'tabelle', 'geoportal', 'bedurfnisse', 'nutzung', 'sachdaten', 'abstimmungsgerat', 'zufriedenheit', 'bevolkerung', 'abstimmungen', 'einzeldaten', 'lora', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-12T01:49:16.683376`
