...
- **Keywords.de** `['einzeldaten', 'geodaten', 'sachdaten', 'bedurfnisse', 'zufriedenheit', 'stimmungsbilder', 'tabelle', 'bevolkerung', 'nutzung', 'stzh', 'punktdaten', 'geoportal', 'lora', 'abstimmungsgerat', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-28T01:03:08.383139`
