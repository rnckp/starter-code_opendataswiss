...
- **Keywords.de** `['abstimmungsgerat', 'nutzung', 'punktdaten', 'lora', 'stzh', 'zufriedenheit', 'geoportal', 'geodaten', 'einzeldaten', 'abstimmungen', 'bedurfnisse', 'stimmungsbilder', 'tabelle', 'sachdaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-07T02:01:18.209588`
