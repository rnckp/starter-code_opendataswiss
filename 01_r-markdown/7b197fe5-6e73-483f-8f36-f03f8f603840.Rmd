...
- **Keywords.de** `['geodaten', 'einzeldaten', 'bevolkerung', 'bedurfnisse', 'abstimmungen', 'sachdaten', 'nutzung', 'zufriedenheit', 'tabelle', 'punktdaten', 'geoportal', 'stimmungsbilder', 'lora', 'abstimmungsgerat', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-24T00:53:09.570927`
