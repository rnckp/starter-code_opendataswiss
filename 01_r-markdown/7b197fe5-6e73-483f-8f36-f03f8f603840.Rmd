...
- **Keywords.de** `['sachdaten', 'stzh', 'zufriedenheit', 'lora', 'abstimmungen', 'bevolkerung', 'geoportal', 'stimmungsbilder', 'punktdaten', 'geodaten', 'tabelle', 'bedurfnisse', 'nutzung', 'einzeldaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-01-17T00:52:49.244145`
