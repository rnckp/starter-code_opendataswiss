...
- **Keywords.de** `['abstimmungsgerat', 'stimmungsbilder', 'tabelle', 'stzh', 'bevolkerung', 'einzeldaten', 'sachdaten', 'geoportal', 'geodaten', 'abstimmungen', 'bedurfnisse', 'zufriedenheit', 'nutzung', 'punktdaten', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-20T02:02:15.057658`
