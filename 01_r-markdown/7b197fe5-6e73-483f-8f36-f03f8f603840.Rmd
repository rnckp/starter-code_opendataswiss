...
- **Keywords.de** `['nutzung', 'einzeldaten', 'punktdaten', 'sachdaten', 'lora', 'bedurfnisse', 'geodaten', 'bevolkerung', 'tabelle', 'geoportal', 'abstimmungsgerat', 'stzh', 'stimmungsbilder', 'abstimmungen', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-25T00:54:19.931891`
