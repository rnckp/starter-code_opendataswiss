...
- **Keywords.de** `['stzh', 'abstimmungen', 'zufriedenheit', 'lora', 'geoportal', 'tabelle', 'bedurfnisse', 'einzeldaten', 'abstimmungsgerat', 'punktdaten', 'geodaten', 'sachdaten', 'nutzung', 'bevolkerung', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-21T01:03:04.580862`
