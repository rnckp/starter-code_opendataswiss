...
- **Keywords.de** `['abstimmungen', 'sachdaten', 'bedurfnisse', 'zufriedenheit', 'stimmungsbilder', 'geodaten', 'tabelle', 'geoportal', 'einzeldaten', 'stzh', 'lora', 'bevolkerung', 'punktdaten', 'abstimmungsgerat', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-27T01:24:06.757285`
