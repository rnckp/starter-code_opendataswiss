...
- **Keywords.de** `['abstimmungen', 'sachdaten', 'stimmungsbilder', 'bevolkerung', 'tabelle', 'abstimmungsgerat', 'zufriedenheit', 'punktdaten', 'lora', 'geodaten', 'bedurfnisse', 'geoportal', 'nutzung', 'einzeldaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-07T01:25:06.048355`
