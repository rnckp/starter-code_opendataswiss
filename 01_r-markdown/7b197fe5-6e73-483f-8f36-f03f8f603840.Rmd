...
- **Keywords.de** `['stimmungsbilder', 'abstimmungen', 'bedurfnisse', 'geoportal', 'lora', 'punktdaten', 'geodaten', 'stzh', 'zufriedenheit', 'sachdaten', 'tabelle', 'einzeldaten', 'abstimmungsgerat', 'nutzung', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-16T01:16:12.117463`
