...
- **Keywords.de** `['sachdaten', 'lora', 'zufriedenheit', 'geodaten', 'abstimmungsgerat', 'stimmungsbilder', 'bedurfnisse', 'nutzung', 'bevolkerung', 'tabelle', 'geoportal', 'einzeldaten', 'punktdaten', 'abstimmungen', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-02T01:15:48.814919`
