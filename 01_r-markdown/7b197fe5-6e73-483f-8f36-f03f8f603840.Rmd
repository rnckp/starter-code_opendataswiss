...
- **Keywords.de** `['bevolkerung', 'lora', 'zufriedenheit', 'bedurfnisse', 'sachdaten', 'geoportal', 'abstimmungsgerat', 'geodaten', 'abstimmungen', 'stimmungsbilder', 'einzeldaten', 'stzh', 'punktdaten', 'tabelle', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-31T01:12:33.552687`
