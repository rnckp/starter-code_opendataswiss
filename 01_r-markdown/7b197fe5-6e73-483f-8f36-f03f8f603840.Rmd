...
- **Keywords.de** `['einzeldaten', 'abstimmungen', 'bevolkerung', 'nutzung', 'abstimmungsgerat', 'stzh', 'punktdaten', 'geoportal', 'zufriedenheit', 'stimmungsbilder', 'lora', 'bedurfnisse', 'tabelle', 'geodaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-15T01:30:51.800494`
