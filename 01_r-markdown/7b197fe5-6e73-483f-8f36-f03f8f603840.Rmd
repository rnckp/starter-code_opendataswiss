...
- **Keywords.de** `['abstimmungsgerat', 'bevolkerung', 'einzeldaten', 'nutzung', 'geoportal', 'stzh', 'abstimmungen', 'stimmungsbilder', 'zufriedenheit', 'punktdaten', 'tabelle', 'lora', 'sachdaten', 'bedurfnisse', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-01-23T01:02:04.739501`
