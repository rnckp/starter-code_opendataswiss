...
- **Keywords.de** `['abstimmungsgerat', 'tabelle', 'lora', 'einzeldaten', 'stimmungsbilder', 'sachdaten', 'bedurfnisse', 'punktdaten', 'geodaten', 'abstimmungen', 'nutzung', 'geoportal', 'stzh', 'zufriedenheit', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-15T01:18:42.210852`
