...
- **Keywords.de** `['bedurfnisse', 'nutzung', 'geodaten', 'bevolkerung', 'stimmungsbilder', 'stzh', 'einzeldaten', 'zufriedenheit', 'geoportal', 'abstimmungen', 'sachdaten', 'punktdaten', 'abstimmungsgerat', 'tabelle', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-24T01:06:04.072863`
