...
- **Keywords.de** `['stzh', 'lora', 'stimmungsbilder', 'zufriedenheit', 'tabelle', 'bevolkerung', 'abstimmungen', 'sachdaten', 'nutzung', 'geoportal', 'geodaten', 'abstimmungsgerat', 'punktdaten', 'bedurfnisse', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-18T01:23:36.804190`
