...
- **Keywords.de** `['abstimmungsgerat', 'punktdaten', 'geoportal', 'lora', 'stzh', 'tabelle', 'abstimmungen', 'bedurfnisse', 'einzeldaten', 'zufriedenheit', 'stimmungsbilder', 'nutzung', 'bevolkerung', 'sachdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-07T01:01:34.851369`
