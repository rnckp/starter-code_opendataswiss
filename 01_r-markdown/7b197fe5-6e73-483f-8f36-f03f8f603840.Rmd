...
- **Keywords.de** `['bevolkerung', 'lora', 'einzeldaten', 'abstimmungen', 'zufriedenheit', 'geoportal', 'geodaten', 'tabelle', 'bedurfnisse', 'punktdaten', 'nutzung', 'stzh', 'sachdaten', 'stimmungsbilder', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-14T00:59:45.521574`
