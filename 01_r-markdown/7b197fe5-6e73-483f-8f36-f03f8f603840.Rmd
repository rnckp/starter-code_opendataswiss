...
- **Keywords.de** `['abstimmungsgerat', 'einzeldaten', 'sachdaten', 'punktdaten', 'zufriedenheit', 'nutzung', 'abstimmungen', 'geodaten', 'tabelle', 'bevolkerung', 'bedurfnisse', 'geoportal', 'stimmungsbilder', 'stzh', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-11T01:09:05.247978`
