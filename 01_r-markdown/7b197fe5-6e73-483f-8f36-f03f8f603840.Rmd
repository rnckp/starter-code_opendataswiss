...
- **Keywords.de** `['stimmungsbilder', 'lora', 'zufriedenheit', 'abstimmungsgerat', 'punktdaten', 'stzh', 'tabelle', 'nutzung', 'geodaten', 'sachdaten', 'abstimmungen', 'bevolkerung', 'einzeldaten', 'bedurfnisse', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-04T01:38:00.967115`
