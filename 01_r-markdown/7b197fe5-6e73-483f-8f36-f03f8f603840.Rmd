...
- **Keywords.de** `['abstimmungsgerat', 'sachdaten', 'zufriedenheit', 'einzeldaten', 'stimmungsbilder', 'bevolkerung', 'geodaten', 'stzh', 'bedurfnisse', 'geoportal', 'abstimmungen', 'tabelle', 'punktdaten', 'lora', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-04T01:03:12.658636`
