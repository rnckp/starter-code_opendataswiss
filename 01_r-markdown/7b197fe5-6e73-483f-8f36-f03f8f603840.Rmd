...
- **Keywords.de** `['geoportal', 'stzh', 'zufriedenheit', 'abstimmungsgerat', 'lora', 'bedurfnisse', 'nutzung', 'sachdaten', 'punktdaten', 'einzeldaten', 'bevolkerung', 'tabelle', 'abstimmungen', 'geodaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-03T01:59:11.835669`
