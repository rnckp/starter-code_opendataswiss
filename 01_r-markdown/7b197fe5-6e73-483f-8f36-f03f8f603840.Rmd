...
- **Keywords.de** `['geoportal', 'abstimmungen', 'nutzung', 'stzh', 'bevolkerung', 'lora', 'einzeldaten', 'punktdaten', 'abstimmungsgerat', 'stimmungsbilder', 'tabelle', 'geodaten', 'bedurfnisse', 'zufriedenheit', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-19T01:19:06.421627`
