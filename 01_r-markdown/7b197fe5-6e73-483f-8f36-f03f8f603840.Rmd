...
- **Keywords.de** `['nutzung', 'tabelle', 'abstimmungsgerat', 'einzeldaten', 'bedurfnisse', 'geodaten', 'abstimmungen', 'sachdaten', 'zufriedenheit', 'punktdaten', 'stzh', 'geoportal', 'lora', 'stimmungsbilder', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-12T01:17:39.956488`
