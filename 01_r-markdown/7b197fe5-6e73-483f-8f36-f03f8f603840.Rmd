...
- **Keywords.de** `['punktdaten', 'lora', 'abstimmungsgerat', 'nutzung', 'stimmungsbilder', 'geodaten', 'tabelle', 'bedurfnisse', 'geoportal', 'zufriedenheit', 'einzeldaten', 'stzh', 'bevolkerung', 'sachdaten', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-01-19T01:32:54.397413`
