...
- **Keywords.de** `['geoportal', 'punktdaten', 'stzh', 'bevolkerung', 'geodaten', 'tabelle', 'lora', 'einzeldaten', 'nutzung', 'stimmungsbilder', 'abstimmungen', 'abstimmungsgerat', 'bedurfnisse', 'zufriedenheit', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-28T01:03:56.527586`
