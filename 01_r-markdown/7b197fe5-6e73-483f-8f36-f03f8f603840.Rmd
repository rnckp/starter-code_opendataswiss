...
- **Keywords.de** `['bedurfnisse', 'tabelle', 'geoportal', 'stzh', 'punktdaten', 'nutzung', 'abstimmungen', 'lora', 'zufriedenheit', 'stimmungsbilder', 'geodaten', 'abstimmungsgerat', 'sachdaten', 'einzeldaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-10-30T02:22:27.437108`
