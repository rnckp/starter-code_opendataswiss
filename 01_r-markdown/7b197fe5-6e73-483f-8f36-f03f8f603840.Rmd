...
- **Keywords.de** `['stimmungsbilder', 'geoportal', 'einzeldaten', 'geodaten', 'bedurfnisse', 'abstimmungsgerat', 'tabelle', 'bevolkerung', 'stzh', 'punktdaten', 'lora', 'abstimmungen', 'nutzung', 'zufriedenheit', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-23T01:17:32.121095`
