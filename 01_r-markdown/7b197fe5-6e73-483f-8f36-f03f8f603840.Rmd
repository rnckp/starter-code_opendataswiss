...
- **Keywords.de** `['stimmungsbilder', 'geodaten', 'abstimmungsgerat', 'geoportal', 'einzeldaten', 'sachdaten', 'bedurfnisse', 'zufriedenheit', 'abstimmungen', 'lora', 'tabelle', 'stzh', 'nutzung', 'bevolkerung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-25T01:36:09.632675`
