...
- **Keywords.de** `['stimmungsbilder', 'abstimmungsgerat', 'sachdaten', 'bevolkerung', 'tabelle', 'geoportal', 'punktdaten', 'geodaten', 'zufriedenheit', 'nutzung', 'einzeldaten', 'abstimmungen', 'lora', 'stzh', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-18T01:20:38.020847`
