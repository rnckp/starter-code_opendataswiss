...
- **Keywords.de** `['stimmungsbilder', 'zufriedenheit', 'geodaten', 'geoportal', 'abstimmungen', 'bedurfnisse', 'sachdaten', 'abstimmungsgerat', 'tabelle', 'punktdaten', 'einzeldaten', 'nutzung', 'lora', 'bevolkerung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-08T01:20:27.660873`
