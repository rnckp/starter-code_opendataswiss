...
- **Keywords.de** `['einzeldaten', 'bedurfnisse', 'abstimmungen', 'nutzung', 'zufriedenheit', 'sachdaten', 'geoportal', 'geodaten', 'lora', 'bevolkerung', 'abstimmungsgerat', 'stimmungsbilder', 'tabelle', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-02T01:19:14.950583`
