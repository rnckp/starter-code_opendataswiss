...
- **Keywords.de** `['stimmungsbilder', 'stzh', 'punktdaten', 'einzeldaten', 'lora', 'nutzung', 'geodaten', 'bedurfnisse', 'sachdaten', 'abstimmungsgerat', 'zufriedenheit', 'geoportal', 'tabelle', 'bevolkerung', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-02T01:16:43.106385`
