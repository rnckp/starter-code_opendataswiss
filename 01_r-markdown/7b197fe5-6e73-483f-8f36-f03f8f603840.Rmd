...
- **Keywords.de** `['einzeldaten', 'punktdaten', 'stzh', 'geodaten', 'bedurfnisse', 'tabelle', 'abstimmungsgerat', 'stimmungsbilder', 'nutzung', 'abstimmungen', 'lora', 'geoportal', 'zufriedenheit', 'sachdaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-27T01:36:11.715392`
