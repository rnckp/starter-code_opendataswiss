...
- **Keywords.de** `['geoportal', 'stzh', 'zufriedenheit', 'abstimmungen', 'tabelle', 'bedurfnisse', 'punktdaten', 'bevolkerung', 'geodaten', 'nutzung', 'stimmungsbilder', 'sachdaten', 'einzeldaten', 'abstimmungsgerat', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-05T01:18:24.462910`
