...
- **Keywords.de** `['nutzung', 'abstimmungsgerat', 'bedurfnisse', 'punktdaten', 'zufriedenheit', 'geodaten', 'einzeldaten', 'stimmungsbilder', 'stzh', 'geoportal', 'abstimmungen', 'lora', 'sachdaten', 'tabelle', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-27T01:19:26.511556`
