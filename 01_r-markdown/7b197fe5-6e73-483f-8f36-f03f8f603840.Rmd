...
- **Keywords.de** `['abstimmungen', 'tabelle', 'zufriedenheit', 'sachdaten', 'geodaten', 'stimmungsbilder', 'stzh', 'nutzung', 'einzeldaten', 'abstimmungsgerat', 'geoportal', 'bedurfnisse', 'punktdaten', 'lora', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-04T01:13:12.944839`
