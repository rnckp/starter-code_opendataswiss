...
- **Keywords.de** `['lora', 'geoportal', 'abstimmungen', 'einzeldaten', 'bedurfnisse', 'punktdaten', 'nutzung', 'stzh', 'stimmungsbilder', 'bevolkerung', 'tabelle', 'sachdaten', 'abstimmungsgerat', 'zufriedenheit', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-01-21T01:16:32.208066`
