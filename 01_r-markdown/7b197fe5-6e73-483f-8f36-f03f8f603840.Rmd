...
- **Keywords.de** `['abstimmungen', 'nutzung', 'lora', 'geoportal', 'abstimmungsgerat', 'einzeldaten', 'bedurfnisse', 'tabelle', 'sachdaten', 'stzh', 'stimmungsbilder', 'punktdaten', 'zufriedenheit', 'bevolkerung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-14T01:37:32.819581`
