...
- **Keywords.de** `['nutzung', 'sachdaten', 'bevolkerung', 'zufriedenheit', 'stzh', 'lora', 'abstimmungsgerat', 'tabelle', 'bedurfnisse', 'punktdaten', 'einzeldaten', 'geodaten', 'stimmungsbilder', 'geoportal', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-02T01:16:56.361220`
