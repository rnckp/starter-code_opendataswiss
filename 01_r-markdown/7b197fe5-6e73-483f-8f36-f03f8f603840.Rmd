...
- **Keywords.de** `['nutzung', 'sachdaten', 'abstimmungen', 'einzeldaten', 'punktdaten', 'geoportal', 'stimmungsbilder', 'tabelle', 'zufriedenheit', 'geodaten', 'bedurfnisse', 'bevolkerung', 'lora', 'abstimmungsgerat', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-16T01:28:00.393169`
