...
- **Keywords.de** `['nutzung', 'stimmungsbilder', 'bedurfnisse', 'punktdaten', 'zufriedenheit', 'stzh', 'einzeldaten', 'tabelle', 'abstimmungen', 'geoportal', 'abstimmungsgerat', 'geodaten', 'sachdaten', 'lora', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-14T00:57:06.473184`
