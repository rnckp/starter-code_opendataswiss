...
- **Keywords.de** `['lora', 'bevolkerung', 'stzh', 'einzeldaten', 'geodaten', 'nutzung', 'zufriedenheit', 'abstimmungen', 'abstimmungsgerat', 'punktdaten', 'sachdaten', 'geoportal', 'bedurfnisse', 'tabelle', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-31T01:29:58.839004`
