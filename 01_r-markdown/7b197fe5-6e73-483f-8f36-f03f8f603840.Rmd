...
- **Keywords.de** `['abstimmungsgerat', 'bedurfnisse', 'stzh', 'lora', 'abstimmungen', 'geoportal', 'nutzung', 'tabelle', 'bevolkerung', 'punktdaten', 'sachdaten', 'geodaten', 'einzeldaten', 'zufriedenheit', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-15T01:24:37.926558`
