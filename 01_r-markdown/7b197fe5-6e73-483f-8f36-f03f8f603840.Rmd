...
- **Keywords.de** `['sachdaten', 'geoportal', 'punktdaten', 'nutzung', 'einzeldaten', 'stzh', 'abstimmungen', 'tabelle', 'abstimmungsgerat', 'lora', 'bedurfnisse', 'bevolkerung', 'stimmungsbilder', 'geodaten', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-19T01:32:33.894999`
