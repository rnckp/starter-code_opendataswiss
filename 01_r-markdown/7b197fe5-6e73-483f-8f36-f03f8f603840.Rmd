...
- **Keywords.de** `['geodaten', 'stzh', 'geoportal', 'bedurfnisse', 'bevolkerung', 'einzeldaten', 'abstimmungsgerat', 'tabelle', 'abstimmungen', 'lora', 'sachdaten', 'zufriedenheit', 'punktdaten', 'stimmungsbilder', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-27T01:26:43.843103`
