...
- **Keywords.de** `['nutzung', 'punktdaten', 'sachdaten', 'stzh', 'lora', 'tabelle', 'stimmungsbilder', 'einzeldaten', 'zufriedenheit', 'geodaten', 'abstimmungen', 'bevolkerung', 'geoportal', 'bedurfnisse', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-09T01:14:16.557604`
