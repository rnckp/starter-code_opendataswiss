...
- **Keywords.de** `['nutzung', 'geoportal', 'lora', 'einzeldaten', 'punktdaten', 'stimmungsbilder', 'abstimmungen', 'bevolkerung', 'sachdaten', 'bedurfnisse', 'zufriedenheit', 'tabelle', 'geodaten', 'abstimmungsgerat', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-01T01:06:33.006350`
