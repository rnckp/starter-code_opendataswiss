...
- **Keywords.de** `['sachdaten', 'geoportal', 'stimmungsbilder', 'bedurfnisse', 'abstimmungsgerat', 'lora', 'stzh', 'nutzung', 'zufriedenheit', 'einzeldaten', 'abstimmungen', 'tabelle', 'geodaten', 'bevolkerung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-08T01:33:34.418012`
