...
- **Keywords.de** `['einzeldaten', 'geodaten', 'sachdaten', 'tabelle', 'bedurfnisse', 'bevolkerung', 'lora', 'abstimmungen', 'abstimmungsgerat', 'punktdaten', 'stzh', 'geoportal', 'nutzung', 'zufriedenheit', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-27T01:35:04.983210`
