...
- **Keywords.de** `['abstimmungsgerat', 'bevolkerung', 'tabelle', 'geodaten', 'stzh', 'geoportal', 'stimmungsbilder', 'abstimmungen', 'bedurfnisse', 'zufriedenheit', 'nutzung', 'sachdaten', 'lora', 'einzeldaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-06T01:28:27.079925`
