...
- **Keywords.de** `['abstimmungen', 'nutzung', 'tabelle', 'lora', 'sachdaten', 'abstimmungsgerat', 'stzh', 'bevolkerung', 'zufriedenheit', 'geoportal', 'punktdaten', 'einzeldaten', 'geodaten', 'stimmungsbilder', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-24T01:42:47.721416`
