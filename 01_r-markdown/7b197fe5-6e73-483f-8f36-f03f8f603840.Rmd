...
- **Keywords.de** `['nutzung', 'stzh', 'geodaten', 'stimmungsbilder', 'tabelle', 'abstimmungsgerat', 'sachdaten', 'bevolkerung', 'abstimmungen', 'bedurfnisse', 'geoportal', 'zufriedenheit', 'punktdaten', 'lora', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-10-06T01:17:26.634499`
