...
- **Keywords.de** `['abstimmungen', 'zufriedenheit', 'bevolkerung', 'stzh', 'abstimmungsgerat', 'geoportal', 'lora', 'stimmungsbilder', 'einzeldaten', 'geodaten', 'nutzung', 'punktdaten', 'tabelle', 'sachdaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-29T01:13:23.174762`
