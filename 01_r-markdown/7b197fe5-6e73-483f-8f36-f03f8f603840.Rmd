...
- **Keywords.de** `['abstimmungsgerat', 'zufriedenheit', 'geoportal', 'lora', 'punktdaten', 'abstimmungen', 'bevolkerung', 'geodaten', 'sachdaten', 'tabelle', 'bedurfnisse', 'einzeldaten', 'stimmungsbilder', 'nutzung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-13T01:18:59.725465`
