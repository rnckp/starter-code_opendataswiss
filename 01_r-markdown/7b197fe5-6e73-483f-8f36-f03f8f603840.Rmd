...
- **Keywords.de** `['lora', 'sachdaten', 'abstimmungsgerat', 'stimmungsbilder', 'stzh', 'bevolkerung', 'geodaten', 'einzeldaten', 'abstimmungen', 'nutzung', 'punktdaten', 'tabelle', 'zufriedenheit', 'geoportal', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-20T01:23:50.270266`
