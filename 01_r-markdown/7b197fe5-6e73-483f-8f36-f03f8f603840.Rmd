...
- **Keywords.de** `['sachdaten', 'bedurfnisse', 'zufriedenheit', 'stimmungsbilder', 'nutzung', 'abstimmungen', 'tabelle', 'einzeldaten', 'lora', 'bevolkerung', 'punktdaten', 'abstimmungsgerat', 'stzh', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-30T01:29:50.077247`
