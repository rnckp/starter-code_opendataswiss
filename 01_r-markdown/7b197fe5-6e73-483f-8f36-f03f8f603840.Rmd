...
- **Keywords.de** `['geodaten', 'nutzung', 'lora', 'sachdaten', 'punktdaten', 'einzeldaten', 'tabelle', 'abstimmungen', 'bedurfnisse', 'stimmungsbilder', 'geoportal', 'zufriedenheit', 'bevolkerung', 'abstimmungsgerat', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-28T01:21:12.689086`
