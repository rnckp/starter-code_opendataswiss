...
- **Keywords.de** `['stimmungsbilder', 'nutzung', 'tabelle', 'bedurfnisse', 'punktdaten', 'abstimmungen', 'geoportal', 'geodaten', 'stzh', 'abstimmungsgerat', 'sachdaten', 'lora', 'bevolkerung', 'zufriedenheit', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-10-28T01:43:31.379739`
