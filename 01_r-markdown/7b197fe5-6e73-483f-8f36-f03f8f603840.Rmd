...
- **Keywords.de** `['sachdaten', 'bevolkerung', 'tabelle', 'einzeldaten', 'punktdaten', 'nutzung', 'lora', 'bedurfnisse', 'abstimmungen', 'stzh', 'geoportal', 'stimmungsbilder', 'zufriedenheit', 'geodaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-10T01:06:55.792494`
