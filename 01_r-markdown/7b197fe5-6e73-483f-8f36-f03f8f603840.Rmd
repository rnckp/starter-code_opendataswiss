...
- **Keywords.de** `['punktdaten', 'zufriedenheit', 'abstimmungen', 'stzh', 'bedurfnisse', 'sachdaten', 'stimmungsbilder', 'geodaten', 'lora', 'einzeldaten', 'nutzung', 'abstimmungsgerat', 'tabelle', 'geoportal', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-11T01:22:34.200778`
