...
- **Keywords.de** `['punktdaten', 'lora', 'bedurfnisse', 'zufriedenheit', 'einzeldaten', 'stzh', 'abstimmungen', 'nutzung', 'abstimmungsgerat', 'sachdaten', 'geoportal', 'tabelle', 'bevolkerung', 'geodaten', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-29T02:06:59.338737`
