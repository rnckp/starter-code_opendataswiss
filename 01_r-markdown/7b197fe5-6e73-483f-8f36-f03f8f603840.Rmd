...
- **Keywords.de** `['zufriedenheit', 'nutzung', 'abstimmungen', 'punktdaten', 'lora', 'tabelle', 'bevolkerung', 'geoportal', 'stzh', 'einzeldaten', 'sachdaten', 'bedurfnisse', 'geodaten', 'abstimmungsgerat', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-14T01:21:52.647996`
