...
- **Keywords.de** `['nutzung', 'zufriedenheit', 'geoportal', 'stimmungsbilder', 'stzh', 'geodaten', 'abstimmungen', 'tabelle', 'bevolkerung', 'punktdaten', 'abstimmungsgerat', 'lora', 'einzeldaten', 'sachdaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-01T02:16:27.156695`
