...
- **Keywords.de** `['sachdaten', 'geoportal', 'punktdaten', 'geodaten', 'tabelle', 'bedurfnisse', 'stimmungsbilder', 'zufriedenheit', 'einzeldaten', 'bevolkerung', 'stzh', 'abstimmungen', 'nutzung', 'lora', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-26T01:14:38.049166`
