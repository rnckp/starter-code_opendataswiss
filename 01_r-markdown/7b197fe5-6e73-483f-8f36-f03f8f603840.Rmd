...
- **Keywords.de** `['abstimmungsgerat', 'bedurfnisse', 'punktdaten', 'einzeldaten', 'zufriedenheit', 'sachdaten', 'lora', 'nutzung', 'tabelle', 'bevolkerung', 'stimmungsbilder', 'abstimmungen', 'geodaten', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-09T01:08:19.610560`
