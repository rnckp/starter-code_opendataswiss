...
- **Keywords.de** `['bedurfnisse', 'sachdaten', 'lora', 'geodaten', 'bevolkerung', 'zufriedenheit', 'tabelle', 'abstimmungen', 'stimmungsbilder', 'nutzung', 'geoportal', 'punktdaten', 'einzeldaten', 'abstimmungsgerat', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-10-05T01:39:14.607280`
