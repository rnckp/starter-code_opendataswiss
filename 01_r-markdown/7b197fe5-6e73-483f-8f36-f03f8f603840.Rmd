...
- **Keywords.de** `['bevolkerung', 'geoportal', 'lora', 'zufriedenheit', 'stzh', 'abstimmungen', 'geodaten', 'abstimmungsgerat', 'sachdaten', 'stimmungsbilder', 'punktdaten', 'bedurfnisse', 'einzeldaten', 'tabelle', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-18T01:56:29.232630`
