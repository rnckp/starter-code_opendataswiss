...
- **Keywords.de** `['sachdaten', 'stimmungsbilder', 'bedurfnisse', 'tabelle', 'punktdaten', 'stzh', 'lora', 'abstimmungen', 'bevolkerung', 'geodaten', 'nutzung', 'zufriedenheit', 'geoportal', 'abstimmungsgerat', 'einzeldaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-21T00:54:39.949737`
