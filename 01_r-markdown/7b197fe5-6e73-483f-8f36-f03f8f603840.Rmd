...
- **Keywords.de** `['stzh', 'zufriedenheit', 'bevolkerung', 'abstimmungsgerat', 'tabelle', 'lora', 'stimmungsbilder', 'bedurfnisse', 'nutzung', 'punktdaten', 'abstimmungen', 'einzeldaten', 'geodaten', 'geoportal', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-30T01:17:47.744914`
