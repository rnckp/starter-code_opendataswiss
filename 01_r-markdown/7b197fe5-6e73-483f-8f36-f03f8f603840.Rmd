...
- **Keywords.de** `['lora', 'stimmungsbilder', 'sachdaten', 'punktdaten', 'zufriedenheit', 'einzeldaten', 'abstimmungsgerat', 'geodaten', 'stzh', 'nutzung', 'bedurfnisse', 'geoportal', 'bevolkerung', 'abstimmungen', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-21T00:58:17.790892`
