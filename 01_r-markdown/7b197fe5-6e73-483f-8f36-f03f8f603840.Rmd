...
- **Keywords.de** `['lora', 'einzeldaten', 'bevolkerung', 'stzh', 'abstimmungsgerat', 'abstimmungen', 'nutzung', 'geodaten', 'zufriedenheit', 'geoportal', 'sachdaten', 'bedurfnisse', 'stimmungsbilder', 'punktdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-06T01:31:55.841768`
