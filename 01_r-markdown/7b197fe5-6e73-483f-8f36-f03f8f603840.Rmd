...
- **Keywords.de** `['stzh', 'punktdaten', 'abstimmungen', 'einzeldaten', 'lora', 'geoportal', 'bedurfnisse', 'zufriedenheit', 'sachdaten', 'tabelle', 'bevolkerung', 'abstimmungsgerat', 'nutzung', 'stimmungsbilder', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-26T01:11:32.529624`
