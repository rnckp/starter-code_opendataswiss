...
- **Keywords.de** `['geoportal', 'punktdaten', 'nutzung', 'stimmungsbilder', 'bedurfnisse', 'einzeldaten', 'bevolkerung', 'lora', 'zufriedenheit', 'geodaten', 'abstimmungen', 'sachdaten', 'tabelle', 'abstimmungsgerat', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-03-24T01:17:30.342583`
