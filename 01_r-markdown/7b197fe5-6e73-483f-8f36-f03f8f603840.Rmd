...
- **Keywords.de** `['geodaten', 'einzeldaten', 'bedurfnisse', 'punktdaten', 'zufriedenheit', 'stzh', 'nutzung', 'abstimmungsgerat', 'lora', 'tabelle', 'abstimmungen', 'bevolkerung', 'sachdaten', 'stimmungsbilder', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-10-07T01:36:26.210571`
