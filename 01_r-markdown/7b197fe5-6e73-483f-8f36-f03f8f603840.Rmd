...
- **Keywords.de** `['punktdaten', 'geodaten', 'einzeldaten', 'stzh', 'zufriedenheit', 'tabelle', 'sachdaten', 'bevolkerung', 'geoportal', 'lora', 'stimmungsbilder', 'nutzung', 'bedurfnisse', 'abstimmungsgerat', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-20T01:19:39.789341`
