...
- **Keywords.de** `['punktdaten', 'tabelle', 'geodaten', 'abstimmungsgerat', 'stimmungsbilder', 'zufriedenheit', 'einzeldaten', 'nutzung', 'sachdaten', 'bevolkerung', 'geoportal', 'bedurfnisse', 'stzh', 'lora', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-07T00:57:49.758356`
