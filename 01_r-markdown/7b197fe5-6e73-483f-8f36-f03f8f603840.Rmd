...
- **Keywords.de** `['abstimmungen', 'stzh', 'stimmungsbilder', 'zufriedenheit', 'tabelle', 'lora', 'einzeldaten', 'geodaten', 'sachdaten', 'abstimmungsgerat', 'bedurfnisse', 'nutzung', 'geoportal', 'punktdaten', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-17T02:23:58.375379`
