...
- **Keywords.de** `['abstimmungsgerat', 'stzh', 'punktdaten', 'bevolkerung', 'geoportal', 'abstimmungen', 'bedurfnisse', 'zufriedenheit', 'tabelle', 'einzeldaten', 'geodaten', 'stimmungsbilder', 'lora', 'nutzung', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-15T01:18:59.887719`
