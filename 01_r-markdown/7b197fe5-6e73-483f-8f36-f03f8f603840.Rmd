...
- **Keywords.de** `['sachdaten', 'abstimmungen', 'geodaten', 'bedurfnisse', 'zufriedenheit', 'geoportal', 'punktdaten', 'stzh', 'einzeldaten', 'bevolkerung', 'nutzung', 'tabelle', 'stimmungsbilder', 'abstimmungsgerat', 'lora']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-01-29T01:36:03.270638`
