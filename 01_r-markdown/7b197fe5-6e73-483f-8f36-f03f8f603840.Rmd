...
- **Keywords.de** `['zufriedenheit', 'bevolkerung', 'geoportal', 'lora', 'einzeldaten', 'bedurfnisse', 'sachdaten', 'abstimmungen', 'geodaten', 'stimmungsbilder', 'stzh', 'tabelle', 'abstimmungsgerat', 'nutzung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-23T01:13:38.236865`
