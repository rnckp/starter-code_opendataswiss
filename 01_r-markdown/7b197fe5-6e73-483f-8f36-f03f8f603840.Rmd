...
- **Keywords.de** `['abstimmungsgerat', 'sachdaten', 'stimmungsbilder', 'geoportal', 'zufriedenheit', 'abstimmungen', 'nutzung', 'einzeldaten', 'tabelle', 'geodaten', 'bevolkerung', 'lora', 'bedurfnisse', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-22T00:52:31.370684`
