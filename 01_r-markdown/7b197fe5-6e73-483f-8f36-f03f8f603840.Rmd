...
- **Keywords.de** `['lora', 'abstimmungsgerat', 'zufriedenheit', 'nutzung', 'punktdaten', 'stimmungsbilder', 'sachdaten', 'abstimmungen', 'bevolkerung', 'tabelle', 'geoportal', 'stzh', 'geodaten', 'einzeldaten', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-10-26T01:18:47.739995`
