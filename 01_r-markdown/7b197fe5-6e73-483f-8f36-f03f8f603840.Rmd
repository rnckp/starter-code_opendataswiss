...
- **Keywords.de** `['punktdaten', 'bedurfnisse', 'stzh', 'abstimmungsgerat', 'tabelle', 'geoportal', 'abstimmungen', 'lora', 'sachdaten', 'zufriedenheit', 'nutzung', 'einzeldaten', 'bevolkerung', 'stimmungsbilder', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-29T01:17:32.706732`
