...
- **Keywords.de** `['abstimmungen', 'einzeldaten', 'bevolkerung', 'punktdaten', 'nutzung', 'sachdaten', 'abstimmungsgerat', 'bedurfnisse', 'stzh', 'zufriedenheit', 'geodaten', 'tabelle', 'lora', 'geoportal', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-17T01:13:02.412289`
