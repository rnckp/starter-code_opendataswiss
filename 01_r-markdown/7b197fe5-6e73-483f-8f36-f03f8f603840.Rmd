...
- **Keywords.de** `['lora', 'abstimmungen', 'geodaten', 'abstimmungsgerat', 'punktdaten', 'bevolkerung', 'stzh', 'zufriedenheit', 'einzeldaten', 'geoportal', 'nutzung', 'bedurfnisse', 'stimmungsbilder', 'sachdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-28T01:44:49.650308`
