...
- **Keywords.de** `['stimmungsbilder', 'tabelle', 'abstimmungsgerat', 'stzh', 'lora', 'punktdaten', 'nutzung', 'geodaten', 'einzeldaten', 'bedurfnisse', 'sachdaten', 'geoportal', 'zufriedenheit', 'abstimmungen', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-27T01:35:44.505980`
