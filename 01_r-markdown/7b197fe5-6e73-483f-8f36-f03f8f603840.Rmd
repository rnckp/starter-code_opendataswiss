...
- **Keywords.de** `['punktdaten', 'sachdaten', 'abstimmungsgerat', 'geoportal', 'einzeldaten', 'bevolkerung', 'geodaten', 'stzh', 'lora', 'stimmungsbilder', 'tabelle', 'nutzung', 'zufriedenheit', 'abstimmungen', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-23T00:52:32.317920`
