...
- **Keywords.de** `['abstimmungen', 'geodaten', 'punktdaten', 'nutzung', 'einzeldaten', 'lora', 'tabelle', 'bevolkerung', 'stimmungsbilder', 'stzh', 'zufriedenheit', 'sachdaten', 'geoportal', 'abstimmungsgerat', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-28T01:28:10.690406`
