...
- **Keywords.de** `['bedurfnisse', 'stimmungsbilder', 'sachdaten', 'geodaten', 'zufriedenheit', 'bevolkerung', 'lora', 'einzeldaten', 'punktdaten', 'abstimmungsgerat', 'stzh', 'tabelle', 'nutzung', 'geoportal', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-24T01:28:28.108563`
