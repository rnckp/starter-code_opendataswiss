...
- **Keywords.de** `['punktdaten', 'bevolkerung', 'lora', 'stimmungsbilder', 'nutzung', 'tabelle', 'stzh', 'einzeldaten', 'geodaten', 'geoportal', 'bedurfnisse', 'abstimmungen', 'zufriedenheit', 'sachdaten', 'abstimmungsgerat']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-20T01:21:16.302606`
