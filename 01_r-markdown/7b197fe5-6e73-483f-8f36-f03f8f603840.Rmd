...
- **Keywords.de** `['geodaten', 'lora', 'bevolkerung', 'stzh', 'nutzung', 'tabelle', 'einzeldaten', 'stimmungsbilder', 'abstimmungen', 'bedurfnisse', 'geoportal', 'sachdaten', 'punktdaten', 'abstimmungsgerat', 'zufriedenheit']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-02-28T00:59:36.104845`
