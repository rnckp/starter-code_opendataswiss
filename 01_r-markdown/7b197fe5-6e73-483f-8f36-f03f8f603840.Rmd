...
- **Keywords.de** `['geoportal', 'bedurfnisse', 'zufriedenheit', 'sachdaten', 'tabelle', 'punktdaten', 'stimmungsbilder', 'abstimmungen', 'abstimmungsgerat', 'nutzung', 'bevolkerung', 'lora', 'einzeldaten', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-07T01:11:00.438447`
