...
- **Keywords.de** `['nutzung', 'abstimmungen', 'abstimmungsgerat', 'lora', 'einzeldaten', 'stzh', 'tabelle', 'geoportal', 'bedurfnisse', 'stimmungsbilder', 'punktdaten', 'sachdaten', 'geodaten', 'zufriedenheit', 'bevolkerung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-09T01:23:03.742836`
