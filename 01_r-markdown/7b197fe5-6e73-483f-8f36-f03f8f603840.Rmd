...
- **Keywords.de** `['stzh', 'einzeldaten', 'zufriedenheit', 'abstimmungen', 'geodaten', 'geoportal', 'bedurfnisse', 'lora', 'abstimmungsgerat', 'punktdaten', 'sachdaten', 'tabelle', 'bevolkerung', 'nutzung', 'stimmungsbilder']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-01-28T01:44:19.601893`
