...
- **Keywords.de** `['abstimmungsgerat', 'bedurfnisse', 'stimmungsbilder', 'sachdaten', 'lora', 'geodaten', 'einzeldaten', 'bevolkerung', 'nutzung', 'zufriedenheit', 'geoportal', 'stzh', 'abstimmungen', 'punktdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-14T00:55:50.747524`
