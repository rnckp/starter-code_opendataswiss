...
- **Keywords.de** `['punktdaten', 'tabelle', 'lora', 'bedurfnisse', 'abstimmungen', 'geoportal', 'geodaten', 'sachdaten', 'abstimmungsgerat', 'stzh', 'stimmungsbilder', 'einzeldaten', 'bevolkerung', 'zufriedenheit', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-17T01:25:28.154492`
