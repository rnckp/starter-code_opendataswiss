...
- **Keywords.de** `['stimmungsbilder', 'abstimmungen', 'geoportal', 'abstimmungsgerat', 'bedurfnisse', 'tabelle', 'lora', 'bevolkerung', 'sachdaten', 'geodaten', 'zufriedenheit', 'einzeldaten', 'nutzung', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-01T01:21:27.315420`
