...
- **Keywords.de** `['abstimmungen', 'tabelle', 'lora', 'stimmungsbilder', 'geodaten', 'punktdaten', 'nutzung', 'einzeldaten', 'bevolkerung', 'sachdaten', 'abstimmungsgerat', 'stzh', 'zufriedenheit', 'geoportal', 'bedurfnisse']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-01-22T01:13:39.305469`
