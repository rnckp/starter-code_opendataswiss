...
- **Keywords.de** `['punktdaten', 'bedurfnisse', 'abstimmungsgerat', 'bevolkerung', 'stzh', 'zufriedenheit', 'sachdaten', 'einzeldaten', 'tabelle', 'geodaten', 'abstimmungen', 'stimmungsbilder', 'geoportal', 'lora', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-04-25T01:19:04.498087`
