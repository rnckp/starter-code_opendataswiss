...
- **Keywords.de** `['tabelle', 'geoportal', 'stzh', 'zufriedenheit', 'geodaten', 'einzeldaten', 'lora', 'sachdaten', 'stimmungsbilder', 'bevolkerung', 'bedurfnisse', 'abstimmungsgerat', 'punktdaten', 'abstimmungen', 'nutzung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-07T01:20:53.365363`
