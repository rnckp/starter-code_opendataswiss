...
- **Keywords.de** `['zufriedenheit', 'abstimmungen', 'punktdaten', 'sachdaten', 'bedurfnisse', 'stimmungsbilder', 'lora', 'bevolkerung', 'stzh', 'geoportal', 'einzeldaten', 'abstimmungsgerat', 'nutzung', 'tabelle', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-10-04T01:36:49.039057`
