...
- **Keywords.de** `['stzh', 'geodaten', 'abstimmungen', 'tabelle', 'geoportal', 'einzeldaten', 'punktdaten', 'bevolkerung', 'abstimmungsgerat', 'nutzung', 'bedurfnisse', 'zufriedenheit', 'stimmungsbilder', 'lora', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-23T01:16:46.905127`
