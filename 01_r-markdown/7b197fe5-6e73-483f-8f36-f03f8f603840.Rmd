...
- **Keywords.de** `['zufriedenheit', 'lora', 'sachdaten', 'stzh', 'stimmungsbilder', 'abstimmungsgerat', 'tabelle', 'bevolkerung', 'bedurfnisse', 'geoportal', 'punktdaten', 'nutzung', 'geodaten', 'einzeldaten', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-07-17T01:19:55.471552`
