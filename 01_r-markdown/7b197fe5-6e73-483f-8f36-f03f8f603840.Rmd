...
- **Keywords.de** `['nutzung', 'zufriedenheit', 'punktdaten', 'sachdaten', 'stimmungsbilder', 'bevolkerung', 'stzh', 'einzeldaten', 'tabelle', 'geoportal', 'geodaten', 'lora', 'bedurfnisse', 'abstimmungsgerat', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-09-19T01:48:36.961642`
