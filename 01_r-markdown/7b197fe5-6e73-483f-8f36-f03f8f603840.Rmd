...
- **Keywords.de** `['stzh', 'zufriedenheit', 'bedurfnisse', 'geodaten', 'abstimmungsgerat', 'geoportal', 'stimmungsbilder', 'bevolkerung', 'nutzung', 'einzeldaten', 'punktdaten', 'tabelle', 'sachdaten', 'lora', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-20T01:08:48.733585`
