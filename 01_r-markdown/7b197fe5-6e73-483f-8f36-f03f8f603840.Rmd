...
- **Keywords.de** `['bevolkerung', 'zufriedenheit', 'einzeldaten', 'nutzung', 'lora', 'abstimmungen', 'punktdaten', 'stzh', 'stimmungsbilder', 'geodaten', 'abstimmungsgerat', 'geoportal', 'bedurfnisse', 'sachdaten', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-08-14T01:16:02.123656`
