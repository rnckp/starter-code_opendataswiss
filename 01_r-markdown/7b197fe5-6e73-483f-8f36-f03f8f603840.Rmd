...
- **Keywords.de** `['geodaten', 'zufriedenheit', 'stzh', 'einzeldaten', 'geoportal', 'tabelle', 'bevolkerung', 'lora', 'abstimmungsgerat', 'sachdaten', 'stimmungsbilder', 'bedurfnisse', 'nutzung', 'punktdaten', 'abstimmungen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-05-01T01:11:43.370515`
