...
- **Keywords.de** `['tabelle', 'punktdaten', 'lora', 'bevolkerung', 'zufriedenheit', 'einzeldaten', 'stimmungsbilder', 'geoportal', 'abstimmungen', 'abstimmungsgerat', 'stzh', 'bedurfnisse', 'nutzung', 'geodaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:25.207241`
- **Metadata_modified** `2023-06-10T01:20:46.318015`
