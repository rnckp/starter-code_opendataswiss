...
- **Keywords.de** `['stzh', 'geodaten', 'geoportal', 'vektordaten', 'polygondaten', 'baumhohe', 'baumkataster', 'punktdaten', 'baumstandorte', 'lidar', 'swisstlm3d', 'stadtbegrunung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:51.125247`
- **Metadata_modified** `2023-05-23T01:17:07.521139`
