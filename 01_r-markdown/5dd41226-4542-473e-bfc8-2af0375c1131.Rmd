...
- **Keywords.de** `['punktdaten', 'polygondaten', 'stadtbegrunung', 'baumkataster', 'geoportal', 'baumstandorte', 'stzh', 'lidar', 'swisstlm3d', 'geodaten', 'vektordaten', 'baumhohe']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:51.125247`
- **Metadata_modified** `2023-03-30T01:31:09.348961`
