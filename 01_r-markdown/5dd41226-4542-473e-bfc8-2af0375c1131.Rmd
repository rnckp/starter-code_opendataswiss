...
- **Keywords.de** `['lidar', 'punktdaten', 'vektordaten', 'stzh', 'swisstlm3d', 'geoportal', 'stadtbegrunung', 'polygondaten', 'baumkataster', 'baumhohe', 'geodaten', 'baumstandorte']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:51.125247`
- **Metadata_modified** `2023-07-30T01:07:31.710942`
