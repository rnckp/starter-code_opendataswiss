...
- **Keywords.de** `['geodaten', 'swisstlm3d', 'punktdaten', 'vektordaten', 'baumstandorte', 'lidar', 'baumkataster', 'baumhohe', 'polygondaten', 'stzh', 'stadtbegrunung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:51.125247`
- **Metadata_modified** `2023-05-16T01:00:29.141739`
