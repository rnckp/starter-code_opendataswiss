...
- **Keywords.de** `['geodaten', 'baumhohe', 'swisstlm3d', 'lidar', 'punktdaten', 'vektordaten', 'stzh', 'baumkataster', 'geoportal', 'stadtbegrunung', 'baumstandorte', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:51.125247`
- **Metadata_modified** `2023-04-13T01:23:02.224860`
