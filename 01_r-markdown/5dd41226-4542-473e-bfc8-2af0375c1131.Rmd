...
- **Keywords.de** `['lidar', 'vektordaten', 'polygondaten', 'baumhohe', 'stzh', 'punktdaten', 'baumstandorte', 'geoportal', 'stadtbegrunung', 'geodaten', 'baumkataster', 'swisstlm3d']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:51.125247`
- **Metadata_modified** `2023-04-16T01:00:34.600254`
