...
- **Keywords.de** `['stzh', 'polygondaten', 'swisstlm3d', 'punktdaten', 'stadtbegrunung', 'baumstandorte', 'baumkataster', 'geodaten', 'lidar', 'vektordaten', 'geoportal', 'baumhohe']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:51.125247`
- **Metadata_modified** `2023-05-26T01:16:45.480673`
