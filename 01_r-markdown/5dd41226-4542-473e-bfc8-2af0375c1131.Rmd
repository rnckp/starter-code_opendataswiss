...
- **Keywords.de** `['polygondaten', 'baumkataster', 'stadtbegrunung', 'geoportal', 'lidar', 'swisstlm3d', 'punktdaten', 'baumstandorte', 'stzh', 'baumhohe', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:51.125247`
- **Metadata_modified** `2023-05-28T01:03:28.122076`
