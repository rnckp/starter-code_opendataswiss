...
- **Keywords.de** `['punktdaten', 'baumstandorte', 'baumkataster', 'stzh', 'stadtbegrunung', 'polygondaten', 'geodaten', 'vektordaten', 'lidar', 'geoportal', 'swisstlm3d', 'baumhohe']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:51.125247`
- **Metadata_modified** `2023-04-23T01:11:26.680019`
