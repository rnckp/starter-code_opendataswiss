...
- **Keywords.de** `['geodaten', 'stzh', 'baumstandorte', 'punktdaten', 'baumkataster', 'baumhohe', 'stadtbegrunung', 'lidar', 'geoportal', 'polygondaten', 'vektordaten', 'swisstlm3d']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:51.125247`
- **Metadata_modified** `2023-06-23T01:18:19.759629`
