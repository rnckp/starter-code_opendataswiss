...
- **Keywords.de** `['lidar', 'geoportal', 'punktdaten', 'baumkataster', 'stadtbegrunung', 'stzh', 'polygondaten', 'baumhohe', 'geodaten', 'vektordaten', 'baumstandorte', 'swisstlm3d']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:10:51.125247`
- **Metadata_modified** `2023-04-20T01:18:56.048370`
