...
- **Keywords.de** `['statistikdaten', 'einwohnerinnen', 'schweizerinnen', 'verwitwet', 'evangelisch-reformiert', 'auslanderinnen', 'romisch-katholisch', 'frauen', 'ledig', 'geschieden', 'christkatholisch', 'verheiratet', 'religion', 'manner']`
- **Issued** `2022-09-05T00:00:00`
- **Metadata_created** `2022-12-13T15:08:02.999076`
- **Metadata_modified** `2024-08-08T03:36:29.950181`
...
df <- read_delim('https://data.bl.ch/api/v2/catalog/datasets/10030/exports/csv?use_labels=false')
