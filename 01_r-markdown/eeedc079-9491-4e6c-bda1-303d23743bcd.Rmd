...
- **Keywords.de** `['ausbildung', 'familienberatung', 'oeffentlicheschulen', 'corona', 's-bahn', 'kleinkinderbetreuung', 'bus', 'stellensuchende', 'kinder', 'energie', 'langsamverkehr', 'kinderbetreuung', 'medien', 'soziales', 'konsum', 'vorschulstufe', 'strassenverkehr', 'lehrlinge', 'wirtschaft', 'bahn', 'handelsregister', 'flugverkehr', 'volkswirtschaft', 'arbeitslose', 'kindergarten', 'flughafen', 'gesundheit', 'berufslehre', 'oeffentlicherverkehr', 'primarschule', 'strassenverkehrszaehlung', 'suchtprobleme', 'internetnutzung', 'mobilitaet', 'verkehrsfrequenz', 'todesfaelle', 'covid-19', 'flugbewegungen', 'jugendberatung', 'kinderkrippen', 'luftverkehr', 'sars-cov-2', 'verkehr', 'konkurse', 'psychosozial', 'gesundheitszustand', 'verkehrsmittelwahl', 'bildung']`
- **Issued** `2021-10-04T00:00:00`
- **Metadata_created** `2021-10-26T03:42:29.683204`
- **Metadata_modified** `2023-05-02T03:02:58.768761`
