...
- **Keywords.de** `['s-bahn', 'konsum', 'kindergarten', 'oeffentlicherverkehr', 'medien', 'todesfaelle', 'kinderkrippen', 'strassenverkehr', 'jugendberatung', 'langsamverkehr', 'kinderbetreuung', 'familienberatung', 'sars-cov-2', 'corona', 'konkurse', 'vorschulstufe', 'primarschule', 'ausbildung', 'bildung', 'arbeitslose', 'handelsregister', 'internetnutzung', 'bus', 'stellensuchende', 'bahn', 'soziales', 'verkehr', 'flugbewegungen', 'volkswirtschaft', 'flugverkehr', 'strassenverkehrszaehlung', 'verkehrsmittelwahl', 'psychosozial', 'mobilitaet', 'berufslehre', 'suchtprobleme', 'lehrlinge', 'wirtschaft', 'verkehrsfrequenz', 'gesundheitszustand', 'kleinkinderbetreuung', 'gesundheit', 'oeffentlicheschulen', 'energie', 'covid-19', 'luftverkehr', 'kinder', 'flughafen']`
- **Issued** `2021-10-04T00:00:00`
- **Metadata_created** `2021-10-26T03:42:29.683204`
- **Metadata_modified** `2023-03-11T03:02:28.917282`
