...
- **Keywords.de** `['todesfaelle', 'energie', 'familienberatung', 'bus', 'kinderkrippen', 'bildung', 'flughafen', 'wirtschaft', 'soziales', 'strassenverkehr', 'covid-19', 'konkurse', 'oeffentlicherverkehr', 'volkswirtschaft', 'gesundheitszustand', 'lehrlinge', 'bahn', 'sars-cov-2', 'kindergarten', 'suchtprobleme', 'arbeitslose', 'kinder', 'corona', 'konsum', 'stellensuchende', 'strassenverkehrszaehlung', 'verkehrsmittelwahl', 'psychosozial', 'handelsregister', 'verkehrsfrequenz', 'ausbildung', 'mobilitaet', 'verkehr', 's-bahn', 'vorschulstufe', 'langsamverkehr', 'oeffentlicheschulen', 'jugendberatung', 'gesundheit', 'luftverkehr', 'flugbewegungen', 'kleinkinderbetreuung', 'primarschule', 'internetnutzung', 'flugverkehr', 'medien', 'kinderbetreuung', 'berufslehre']`
- **Issued** `2021-10-04T00:00:00`
- **Metadata_created** `2021-10-26T03:42:29.683204`
- **Metadata_modified** `2023-03-02T03:05:11.728374`
