...
- **Keywords.de** `['internetnutzung', 'langsamverkehr', 'lehrlinge', 'kinderkrippen', 'kinder', 'medien', 'todesfaelle', 'konkurse', 'suchtprobleme', 'flughafen', 'stellensuchende', 'gesundheitszustand', 'jugendberatung', 'mobilitaet', 'bus', 'corona', 'handelsregister', 'vorschulstufe', 'sars-cov-2', 'bahn', 'arbeitslose', 'ausbildung', 'kindergarten', 'familienberatung', 'oeffentlicheschulen', 'verkehr', 'primarschule', 's-bahn', 'soziales', 'verkehrsfrequenz', 'gesundheit', 'volkswirtschaft', 'kinderbetreuung', 'energie', 'luftverkehr', 'covid-19', 'flugverkehr', 'berufslehre', 'psychosozial', 'flugbewegungen', 'bildung', 'verkehrsmittelwahl', 'oeffentlicherverkehr', 'wirtschaft', 'strassenverkehr', 'konsum', 'strassenverkehrszaehlung', 'kleinkinderbetreuung']`
- **Issued** `2021-10-04T00:00:00`
- **Metadata_created** `2021-10-26T03:42:29.683204`
- **Metadata_modified** `2023-03-26T03:01:33.951127`
