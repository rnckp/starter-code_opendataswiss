...
- **Keywords.de** `['einfamilienhaus', 'wohnungen', 'gebaude', 'gemeinde', 'neue-wohnungen', 'mehrfamilienhaus', 'wohnnutzung', 'gebaudekategorie', 'politische-gemeinde']`
- **Issued** `2021-12-20T00:00:00`
- **Metadata_created** `2023-12-20T11:53:04.413777`
- **Metadata_modified** `2024-06-16T11:07:33.136045`
...
df <- read_delim('https://data.tg.ch/api/v2/catalog/datasets/sk-stat-91/exports/csv')
