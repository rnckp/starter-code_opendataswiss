...
- **Keywords.de** `['tramlinien', 'vbg', 'punktdaten', 'bus', 'postauto', 'geodaten', 'geoportal', 'stzh', 'offentlicher-verkehr', 'tram', 'buslinien', 'vbz', 'strassenbahn', 'vektordaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-09T05:00:36.006899`
