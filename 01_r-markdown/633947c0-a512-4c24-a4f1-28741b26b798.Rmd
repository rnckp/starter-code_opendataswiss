...
- **Keywords.de** `['buslinien', 'bus', 'geoportal', 'tramlinien', 'stzh', 'vbg', 'punktdaten', 'geodaten', 'fundburo', 'postauto', 'tram', 'offentlicher-verkehr', 'vbz', 'strassenbahn', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-20T03:17:43.811303`
