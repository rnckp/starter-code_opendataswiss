...
- **Keywords.de** `['bus', 'vbz', 'offentlicher-verkehr', 'geodaten', 'vektordaten', 'vbg', 'buslinien', 'postauto', 'strassenbahn', 'geoportal', 'fundburo', 'tram', 'stzh', 'punktdaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-04T02:56:22.580881`
