...
- **Keywords.de** `['vbg', 'vektordaten', 'strassenbahn', 'tram', 'fundburo', 'punktdaten', 'geodaten', 'offentlicher-verkehr', 'geoportal', 'tramlinien', 'vbz', 'buslinien', 'bus', 'postauto', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-23T02:47:20.162835`
