...
- **Keywords.de** `['geodaten', 'vbz', 'strassenbahn', 'stzh', 'tramlinien', 'fundburo', 'offentlicher-verkehr', 'punktdaten', 'bus', 'buslinien', 'postauto', 'geoportal', 'vektordaten', 'tram', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-06T02:41:15.470479`
