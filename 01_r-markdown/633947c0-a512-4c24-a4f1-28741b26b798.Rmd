...
- **Keywords.de** `['buslinien', 'punktdaten', 'tramlinien', 'postauto', 'strassenbahn', 'bus', 'stzh', 'geodaten', 'vbz', 'fundburo', 'vbg', 'geoportal', 'vektordaten', 'offentlicher-verkehr', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-17T03:04:39.011979`
