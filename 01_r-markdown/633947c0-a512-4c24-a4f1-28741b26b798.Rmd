...
- **Keywords.de** `['bus', 'offentlicher-verkehr', 'geoportal', 'stzh', 'tram', 'vbg', 'geodaten', 'fundburo', 'tramlinien', 'strassenbahn', 'punktdaten', 'vbz', 'vektordaten', 'postauto', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-13T03:43:16.579754`
