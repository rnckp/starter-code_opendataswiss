...
- **Keywords.de** `['tramlinien', 'postauto', 'vektordaten', 'geoportal', 'vbz', 'tram', 'fundburo', 'buslinien', 'bus', 'offentlicher-verkehr', 'punktdaten', 'stzh', 'strassenbahn', 'vbg', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-13T03:27:43.866093`
