...
- **Keywords.de** `['fundburo', 'tram', 'vbz', 'stzh', 'geodaten', 'vektordaten', 'punktdaten', 'geoportal', 'strassenbahn', 'tramlinien', 'vbg', 'postauto', 'offentlicher-verkehr', 'bus', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-03T03:23:35.717016`
