...
- **Keywords.de** `['buslinien', 'punktdaten', 'geoportal', 'fundburo', 'vektordaten', 'strassenbahn', 'vbg', 'tram', 'stzh', 'offentlicher-verkehr', 'bus', 'tramlinien', 'geodaten', 'postauto', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-18T02:53:29.453353`
