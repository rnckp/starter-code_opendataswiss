...
- **Keywords.de** `['bus', 'vbg', 'offentlicher-verkehr', 'tram', 'geodaten', 'postauto', 'stzh', 'geoportal', 'vbz', 'tramlinien', 'fundburo', 'strassenbahn', 'punktdaten', 'buslinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-20T02:50:40.334457`
