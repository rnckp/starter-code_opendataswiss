...
- **Keywords.de** `['vbg', 'stzh', 'postauto', 'geodaten', 'tram', 'geoportal', 'fundburo', 'strassenbahn', 'tramlinien', 'punktdaten', 'vbz', 'buslinien', 'offentlicher-verkehr', 'vektordaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-04T03:38:47.772528`
