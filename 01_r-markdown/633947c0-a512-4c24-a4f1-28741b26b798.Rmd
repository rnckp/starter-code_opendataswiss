...
- **Keywords.de** `['buslinien', 'fundburo', 'bus', 'vbz', 'punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'geoportal', 'postauto', 'tramlinien', 'tram', 'vbg', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-11T03:14:58.115625`
