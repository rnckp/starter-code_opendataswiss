...
- **Keywords.de** `['vbg', 'vektordaten', 'stzh', 'vbz', 'postauto', 'geodaten', 'strassenbahn', 'fundburo', 'geoportal', 'buslinien', 'bus', 'punktdaten', 'offentlicher-verkehr', 'tramlinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-01T03:39:11.763545`
