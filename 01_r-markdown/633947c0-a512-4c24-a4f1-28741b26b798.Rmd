...
- **Keywords.de** `['vektordaten', 'vbz', 'tramlinien', 'geoportal', 'offentlicher-verkehr', 'geodaten', 'tram', 'fundburo', 'bus', 'strassenbahn', 'punktdaten', 'vbg', 'buslinien', 'postauto', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-29T02:52:33.620235`
