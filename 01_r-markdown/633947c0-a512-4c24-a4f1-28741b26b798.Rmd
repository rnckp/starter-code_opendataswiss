...
- **Keywords.de** `['geoportal', 'vbz', 'buslinien', 'vbg', 'fundburo', 'stzh', 'strassenbahn', 'bus', 'vektordaten', 'punktdaten', 'tramlinien', 'offentlicher-verkehr', 'postauto', 'tram', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-04T02:56:01.456278`
