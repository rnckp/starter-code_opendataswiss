...
- **Keywords.de** `['geoportal', 'vektordaten', 'vbz', 'punktdaten', 'vbg', 'postauto', 'strassenbahn', 'geodaten', 'stzh', 'fundburo', 'offentlicher-verkehr', 'buslinien', 'bus', 'tram', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-09T03:45:33.438567`
