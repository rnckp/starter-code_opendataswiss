...
- **Keywords.de** `['buslinien', 'vbg', 'bus', 'vektordaten', 'geodaten', 'punktdaten', 'tram', 'strassenbahn', 'geoportal', 'offentlicher-verkehr', 'postauto', 'fundburo', 'tramlinien', 'stzh', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-14T03:35:23.350475`
