...
- **Keywords.de** `['tram', 'geoportal', 'postauto', 'buslinien', 'fundburo', 'geodaten', 'strassenbahn', 'punktdaten', 'vbz', 'stzh', 'bus', 'offentlicher-verkehr', 'tramlinien', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-28T03:27:30.659806`
