...
- **Keywords.de** `['vbz', 'fundburo', 'vbg', 'stzh', 'buslinien', 'geodaten', 'bus', 'tram', 'geoportal', 'vektordaten', 'tramlinien', 'punktdaten', 'postauto', 'offentlicher-verkehr', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-22T03:18:08.643896`
