...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'postauto', 'vbz', 'punktdaten', 'fundburo', 'stzh', 'bus', 'geodaten', 'geoportal', 'buslinien', 'tram', 'vbg', 'offentlicher-verkehr', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-31T08:13:26.170085`
