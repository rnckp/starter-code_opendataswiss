...
- **Keywords.de** `['vbg', 'tram', 'punktdaten', 'geodaten', 'strassenbahn', 'postauto', 'stzh', 'vektordaten', 'tramlinien', 'geoportal', 'vbz', 'offentlicher-verkehr', 'fundburo', 'bus', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-25T03:22:28.159289`
