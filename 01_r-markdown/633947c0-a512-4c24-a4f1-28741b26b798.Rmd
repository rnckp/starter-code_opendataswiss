...
- **Keywords.de** `['buslinien', 'strassenbahn', 'fundburo', 'tram', 'postauto', 'geodaten', 'tramlinien', 'vbz', 'geoportal', 'bus', 'vbg', 'stzh', 'vektordaten', 'offentlicher-verkehr', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-20T03:16:20.294142`
