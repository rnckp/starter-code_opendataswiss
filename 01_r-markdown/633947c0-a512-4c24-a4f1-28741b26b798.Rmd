...
- **Keywords.de** `['postauto', 'vbg', 'geoportal', 'buslinien', 'vektordaten', 'strassenbahn', 'punktdaten', 'offentlicher-verkehr', 'geodaten', 'vbz', 'stzh', 'fundburo', 'bus', 'tram', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-17T03:09:51.279580`
