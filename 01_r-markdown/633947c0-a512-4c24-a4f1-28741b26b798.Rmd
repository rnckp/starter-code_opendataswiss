...
- **Keywords.de** `['postauto', 'vbg', 'geodaten', 'fundburo', 'offentlicher-verkehr', 'tram', 'vektordaten', 'tramlinien', 'bus', 'stzh', 'punktdaten', 'buslinien', 'strassenbahn', 'geoportal', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-18T03:33:46.662024`
