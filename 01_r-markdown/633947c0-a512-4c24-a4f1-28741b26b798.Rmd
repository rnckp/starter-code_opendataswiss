...
- **Keywords.de** `['stzh', 'strassenbahn', 'offentlicher-verkehr', 'geodaten', 'buslinien', 'vektordaten', 'tramlinien', 'fundburo', 'tram', 'vbz', 'punktdaten', 'bus', 'postauto', 'geoportal', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-14T02:49:45.482243`
