...
- **Keywords.de** `['punktdaten', 'fundburo', 'vbg', 'bus', 'geoportal', 'tramlinien', 'geodaten', 'vektordaten', 'stzh', 'tram', 'vbz', 'postauto', 'offentlicher-verkehr', 'buslinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-22T03:07:30.353887`
