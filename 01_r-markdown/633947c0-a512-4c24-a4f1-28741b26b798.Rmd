...
- **Keywords.de** `['buslinien', 'stzh', 'tram', 'bus', 'tramlinien', 'offentlicher-verkehr', 'fundburo', 'strassenbahn', 'geodaten', 'vektordaten', 'geoportal', 'punktdaten', 'vbz', 'vbg', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-09T03:15:20.193241`
