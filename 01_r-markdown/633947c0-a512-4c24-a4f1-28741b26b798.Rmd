...
- **Keywords.de** `['buslinien', 'offentlicher-verkehr', 'vbz', 'fundburo', 'vektordaten', 'geodaten', 'punktdaten', 'postauto', 'strassenbahn', 'geoportal', 'vbg', 'stzh', 'tram', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-26T02:48:07.959846`
