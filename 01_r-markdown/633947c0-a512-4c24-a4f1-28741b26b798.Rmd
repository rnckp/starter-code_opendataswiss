...
- **Keywords.de** `['geoportal', 'buslinien', 'geodaten', 'vektordaten', 'bus', 'tram', 'tramlinien', 'strassenbahn', 'fundburo', 'postauto', 'vbg', 'punktdaten', 'offentlicher-verkehr', 'stzh', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-26T03:42:37.692686`
