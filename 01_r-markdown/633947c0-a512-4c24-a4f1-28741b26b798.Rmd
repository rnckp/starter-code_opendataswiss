...
- **Keywords.de** `['vektordaten', 'punktdaten', 'strassenbahn', 'buslinien', 'postauto', 'tramlinien', 'bus', 'tram', 'fundburo', 'geoportal', 'stzh', 'geodaten', 'vbg', 'vbz', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-21T02:31:39.342049`
