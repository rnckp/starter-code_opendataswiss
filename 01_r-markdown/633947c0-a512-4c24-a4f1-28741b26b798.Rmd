...
- **Keywords.de** `['vbg', 'geoportal', 'buslinien', 'postauto', 'tramlinien', 'offentlicher-verkehr', 'fundburo', 'stzh', 'vbz', 'tram', 'strassenbahn', 'geodaten', 'punktdaten', 'bus', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-30T03:43:15.568147`
