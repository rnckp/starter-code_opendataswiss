...
- **Keywords.de** `['vektordaten', 'postauto', 'fundburo', 'vbz', 'offentlicher-verkehr', 'punktdaten', 'vbg', 'tram', 'bus', 'geoportal', 'strassenbahn', 'tramlinien', 'geodaten', 'buslinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-24T03:06:09.536716`
