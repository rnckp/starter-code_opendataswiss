...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'tram', 'vbg', 'geoportal', 'postauto', 'stzh', 'buslinien', 'offentlicher-verkehr', 'bus', 'vbz', 'tramlinien', 'punktdaten', 'fundburo', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-07T02:42:35.929258`
