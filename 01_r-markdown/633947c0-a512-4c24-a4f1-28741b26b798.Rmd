...
- **Keywords.de** `['offentlicher-verkehr', 'vbg', 'postauto', 'vektordaten', 'tramlinien', 'geoportal', 'bus', 'punktdaten', 'strassenbahn', 'stzh', 'buslinien', 'fundburo', 'vbz', 'tram', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-11T03:08:45.624161`
