...
- **Keywords.de** `['postauto', 'geodaten', 'punktdaten', 'bus', 'vbg', 'strassenbahn', 'stzh', 'offentlicher-verkehr', 'tram', 'tramlinien', 'vbz', 'vektordaten', 'buslinien', 'geoportal', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-10T03:29:49.479112`
