...
- **Keywords.de** `['fundburo', 'tramlinien', 'tram', 'vektordaten', 'geodaten', 'vbz', 'postauto', 'buslinien', 'bus', 'strassenbahn', 'vbg', 'punktdaten', 'offentlicher-verkehr', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-13T04:21:42.684015`
