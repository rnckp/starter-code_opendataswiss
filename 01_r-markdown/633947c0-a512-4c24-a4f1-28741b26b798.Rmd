...
- **Keywords.de** `['offentlicher-verkehr', 'geoportal', 'vbz', 'postauto', 'stzh', 'punktdaten', 'bus', 'vbg', 'geodaten', 'buslinien', 'vektordaten', 'tramlinien', 'fundburo', 'tram', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-21T03:16:51.457955`
