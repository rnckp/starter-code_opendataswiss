...
- **Keywords.de** `['punktdaten', 'tram', 'stzh', 'buslinien', 'vbz', 'strassenbahn', 'geodaten', 'offentlicher-verkehr', 'tramlinien', 'bus', 'vbg', 'vektordaten', 'postauto', 'geoportal', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-11T03:47:14.465120`
