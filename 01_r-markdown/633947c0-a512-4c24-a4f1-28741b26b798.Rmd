...
- **Keywords.de** `['strassenbahn', 'vbg', 'vektordaten', 'punktdaten', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'vbz', 'geoportal', 'buslinien', 'geodaten', 'bus', 'fundburo', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-14T04:04:28.639049`
