...
- **Keywords.de** `['vbz', 'postauto', 'geoportal', 'tram', 'buslinien', 'geodaten', 'vektordaten', 'stzh', 'offentlicher-verkehr', 'strassenbahn', 'vbg', 'punktdaten', 'bus', 'fundburo', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-02T03:23:31.129206`
