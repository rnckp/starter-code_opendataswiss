...
- **Keywords.de** `['offentlicher-verkehr', 'punktdaten', 'vbz', 'postauto', 'fundburo', 'stzh', 'strassenbahn', 'geoportal', 'vbg', 'tramlinien', 'vektordaten', 'buslinien', 'tram', 'geodaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-27T03:02:35.830190`
