...
- **Keywords.de** `['vektordaten', 'vbg', 'postauto', 'geodaten', 'tramlinien', 'vbz', 'punktdaten', 'fundburo', 'bus', 'buslinien', 'geoportal', 'stzh', 'offentlicher-verkehr', 'tram', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-20T02:26:00.474926`
