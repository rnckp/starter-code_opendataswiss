...
- **Keywords.de** `['postauto', 'geodaten', 'buslinien', 'fundburo', 'tram', 'bus', 'vbz', 'offentlicher-verkehr', 'stzh', 'tramlinien', 'punktdaten', 'vektordaten', 'vbg', 'strassenbahn', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-19T03:59:54.231950`
