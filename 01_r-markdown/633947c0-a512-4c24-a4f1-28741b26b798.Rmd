...
- **Keywords.de** `['stzh', 'strassenbahn', 'tram', 'vektordaten', 'buslinien', 'bus', 'tramlinien', 'vbz', 'offentlicher-verkehr', 'vbg', 'postauto', 'fundburo', 'punktdaten', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-06T03:43:10.959446`
