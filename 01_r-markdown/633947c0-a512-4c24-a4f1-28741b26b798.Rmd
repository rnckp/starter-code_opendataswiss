...
- **Keywords.de** `['tram', 'stzh', 'vbz', 'bus', 'tramlinien', 'strassenbahn', 'fundburo', 'postauto', 'punktdaten', 'geoportal', 'vbg', 'buslinien', 'offentlicher-verkehr', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-17T02:26:44.632591`
