...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'vbz', 'postauto', 'punktdaten', 'tramlinien', 'geoportal', 'stzh', 'tram', 'bus', 'geodaten', 'buslinien', 'strassenbahn', 'vbg', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-23T03:10:35.487004`
