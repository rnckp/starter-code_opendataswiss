...
- **Keywords.de** `['punktdaten', 'vektordaten', 'vbz', 'bus', 'tram', 'buslinien', 'stzh', 'geodaten', 'vbg', 'geoportal', 'strassenbahn', 'fundburo', 'postauto', 'tramlinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-13T02:52:13.186581`
