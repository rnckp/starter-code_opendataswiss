...
- **Keywords.de** `['postauto', 'vbz', 'buslinien', 'strassenbahn', 'vbg', 'geodaten', 'vektordaten', 'punktdaten', 'fundburo', 'geoportal', 'tramlinien', 'offentlicher-verkehr', 'tram', 'stzh', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-27T03:18:21.774904`
