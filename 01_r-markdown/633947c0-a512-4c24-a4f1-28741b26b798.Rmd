...
- **Keywords.de** `['bus', 'vbg', 'offentlicher-verkehr', 'stzh', 'punktdaten', 'vektordaten', 'fundburo', 'geoportal', 'buslinien', 'strassenbahn', 'postauto', 'vbz', 'tram', 'tramlinien', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-01T02:47:02.241614`
