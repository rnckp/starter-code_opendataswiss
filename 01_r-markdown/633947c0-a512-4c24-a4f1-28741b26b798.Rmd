...
- **Keywords.de** `['tramlinien', 'vektordaten', 'geoportal', 'tram', 'fundburo', 'stzh', 'postauto', 'geodaten', 'punktdaten', 'buslinien', 'vbz', 'offentlicher-verkehr', 'vbg', 'bus', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-12T02:57:24.254116`
