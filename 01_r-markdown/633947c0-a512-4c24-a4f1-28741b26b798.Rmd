...
- **Keywords.de** `['stzh', 'geodaten', 'vbz', 'strassenbahn', 'tram', 'buslinien', 'fundburo', 'postauto', 'offentlicher-verkehr', 'vektordaten', 'punktdaten', 'tramlinien', 'vbg', 'bus', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-21T02:12:05.338161`
