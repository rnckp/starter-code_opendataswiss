...
- **Keywords.de** `['vektordaten', 'buslinien', 'tramlinien', 'fundburo', 'tram', 'stzh', 'geodaten', 'geoportal', 'vbz', 'vbg', 'bus', 'offentlicher-verkehr', 'postauto', 'punktdaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-18T03:29:59.866260`
