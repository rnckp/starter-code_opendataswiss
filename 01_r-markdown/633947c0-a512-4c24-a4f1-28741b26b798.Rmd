...
- **Keywords.de** `['tramlinien', 'strassenbahn', 'offentlicher-verkehr', 'vektordaten', 'stzh', 'tram', 'buslinien', 'vbz', 'fundburo', 'bus', 'geoportal', 'punktdaten', 'postauto', 'geodaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-20T03:46:04.860191`
