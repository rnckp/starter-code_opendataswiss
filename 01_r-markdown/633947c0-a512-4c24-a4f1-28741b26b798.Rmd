...
- **Keywords.de** `['tram', 'buslinien', 'postauto', 'bus', 'stzh', 'vbg', 'vektordaten', 'strassenbahn', 'geodaten', 'fundburo', 'vbz', 'tramlinien', 'punktdaten', 'offentlicher-verkehr', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-28T02:46:45.131890`
