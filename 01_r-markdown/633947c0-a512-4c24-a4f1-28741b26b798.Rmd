...
- **Keywords.de** `['offentlicher-verkehr', 'vbg', 'buslinien', 'vektordaten', 'stzh', 'strassenbahn', 'bus', 'vbz', 'tram', 'geodaten', 'tramlinien', 'postauto', 'fundburo', 'punktdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-13T03:33:38.269692`
