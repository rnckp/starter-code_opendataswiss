...
- **Keywords.de** `['vbg', 'vbz', 'strassenbahn', 'geoportal', 'postauto', 'bus', 'offentlicher-verkehr', 'tramlinien', 'fundburo', 'vektordaten', 'tram', 'buslinien', 'stzh', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-26T02:52:12.041544`
