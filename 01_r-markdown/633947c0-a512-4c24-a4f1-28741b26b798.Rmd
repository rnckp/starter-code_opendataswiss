...
- **Keywords.de** `['bus', 'punktdaten', 'vbg', 'stzh', 'vektordaten', 'buslinien', 'geoportal', 'tramlinien', 'fundburo', 'postauto', 'strassenbahn', 'offentlicher-verkehr', 'tram', 'geodaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-21T02:54:45.050781`
