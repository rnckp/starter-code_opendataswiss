...
- **Keywords.de** `['geoportal', 'bus', 'offentlicher-verkehr', 'vektordaten', 'stzh', 'vbg', 'postauto', 'strassenbahn', 'tramlinien', 'vbz', 'fundburo', 'geodaten', 'punktdaten', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-03T02:57:48.359471`
