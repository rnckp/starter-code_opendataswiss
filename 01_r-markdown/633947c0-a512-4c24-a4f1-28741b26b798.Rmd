...
- **Keywords.de** `['offentlicher-verkehr', 'vbg', 'strassenbahn', 'vektordaten', 'tramlinien', 'buslinien', 'stzh', 'postauto', 'tram', 'fundburo', 'vbz', 'bus', 'geodaten', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-30T03:03:25.181253`
