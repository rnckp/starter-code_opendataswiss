...
- **Keywords.de** `['stzh', 'vbg', 'bus', 'vbz', 'tramlinien', 'punktdaten', 'geoportal', 'offentlicher-verkehr', 'postauto', 'buslinien', 'strassenbahn', 'fundburo', 'vektordaten', 'tram', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-14T03:05:08.519096`
