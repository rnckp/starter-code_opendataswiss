...
- **Keywords.de** `['stzh', 'tramlinien', 'strassenbahn', 'geoportal', 'bus', 'vbg', 'fundburo', 'buslinien', 'vbz', 'offentlicher-verkehr', 'tram', 'punktdaten', 'geodaten', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-07T03:02:22.458267`
