...
- **Keywords.de** `['tramlinien', 'vbz', 'strassenbahn', 'stzh', 'buslinien', 'geodaten', 'geoportal', 'vbg', 'postauto', 'offentlicher-verkehr', 'tram', 'fundburo', 'punktdaten', 'bus', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-09T03:44:21.410156`
