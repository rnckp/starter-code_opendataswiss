...
- **Keywords.de** `['postauto', 'buslinien', 'tramlinien', 'vbg', 'vbz', 'vektordaten', 'stzh', 'tram', 'strassenbahn', 'geoportal', 'offentlicher-verkehr', 'punktdaten', 'bus', 'fundburo', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-01T03:57:48.361221`
