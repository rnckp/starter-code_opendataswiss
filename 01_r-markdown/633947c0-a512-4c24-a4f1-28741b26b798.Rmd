...
- **Keywords.de** `['vektordaten', 'offentlicher-verkehr', 'vbz', 'stzh', 'punktdaten', 'vbg', 'tramlinien', 'bus', 'buslinien', 'geodaten', 'tram', 'fundburo', 'postauto', 'geoportal', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-01T02:47:24.278601`
