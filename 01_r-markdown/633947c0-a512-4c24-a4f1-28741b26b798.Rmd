...
- **Keywords.de** `['offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'vbg', 'bus', 'vbz', 'punktdaten', 'fundburo', 'buslinien', 'geoportal', 'tramlinien', 'postauto', 'stzh', 'tram', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-14T03:15:36.538165`
