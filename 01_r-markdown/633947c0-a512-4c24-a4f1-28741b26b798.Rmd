...
- **Keywords.de** `['buslinien', 'postauto', 'strassenbahn', 'geodaten', 'punktdaten', 'vbz', 'stzh', 'tramlinien', 'tram', 'fundburo', 'vbg', 'offentlicher-verkehr', 'vektordaten', 'bus', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-28T03:32:04.680709`
