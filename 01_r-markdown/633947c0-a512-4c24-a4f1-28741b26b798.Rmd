...
- **Keywords.de** `['tram', 'punktdaten', 'fundburo', 'buslinien', 'tramlinien', 'vbz', 'stzh', 'geodaten', 'vektordaten', 'strassenbahn', 'geoportal', 'vbg', 'bus', 'postauto', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-21T03:55:47.198842`
