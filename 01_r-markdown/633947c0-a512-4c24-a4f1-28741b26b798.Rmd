...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'buslinien', 'vbg', 'punktdaten', 'strassenbahn', 'postauto', 'tram', 'stzh', 'geodaten', 'vbz', 'bus', 'tramlinien', 'geoportal', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-16T03:06:06.579486`
