...
- **Keywords.de** `['vektordaten', 'tram', 'fundburo', 'buslinien', 'tramlinien', 'postauto', 'stzh', 'strassenbahn', 'geoportal', 'bus', 'offentlicher-verkehr', 'vbg', 'vbz', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-09T06:02:25.550443`
