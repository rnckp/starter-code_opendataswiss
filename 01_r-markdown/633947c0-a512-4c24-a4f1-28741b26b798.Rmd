...
- **Keywords.de** `['vektordaten', 'punktdaten', 'offentlicher-verkehr', 'geoportal', 'tramlinien', 'geodaten', 'vbg', 'strassenbahn', 'bus', 'buslinien', 'fundburo', 'tram', 'postauto', 'stzh', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-10T03:00:06.129342`
