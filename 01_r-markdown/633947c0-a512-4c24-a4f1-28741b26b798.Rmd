...
- **Keywords.de** `['buslinien', 'fundburo', 'offentlicher-verkehr', 'tramlinien', 'geodaten', 'tram', 'vbz', 'geoportal', 'strassenbahn', 'postauto', 'vektordaten', 'punktdaten', 'stzh', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-15T03:34:50.921640`
