...
- **Keywords.de** `['vbz', 'vektordaten', 'geoportal', 'stzh', 'strassenbahn', 'tram', 'postauto', 'tramlinien', 'offentlicher-verkehr', 'fundburo', 'vbg', 'geodaten', 'punktdaten', 'bus', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-20T02:47:12.537603`
