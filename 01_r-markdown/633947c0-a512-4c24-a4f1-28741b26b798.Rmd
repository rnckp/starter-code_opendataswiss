...
- **Keywords.de** `['geoportal', 'geodaten', 'punktdaten', 'bus', 'offentlicher-verkehr', 'vbg', 'tram', 'vektordaten', 'fundburo', 'vbz', 'tramlinien', 'postauto', 'buslinien', 'stzh', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-22T03:36:37.078973`
