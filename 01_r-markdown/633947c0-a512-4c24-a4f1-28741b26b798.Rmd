...
- **Keywords.de** `['vbz', 'bus', 'fundburo', 'tramlinien', 'strassenbahn', 'stzh', 'postauto', 'buslinien', 'punktdaten', 'vbg', 'geodaten', 'offentlicher-verkehr', 'geoportal', 'tram', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-28T02:44:10.301049`
