...
- **Keywords.de** `['punktdaten', 'tramlinien', 'strassenbahn', 'vbg', 'geodaten', 'vektordaten', 'geoportal', 'postauto', 'tram', 'buslinien', 'fundburo', 'vbz', 'offentlicher-verkehr', 'bus', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-16T03:37:52.276514`
