...
- **Keywords.de** `['buslinien', 'vbz', 'vektordaten', 'bus', 'offentlicher-verkehr', 'stzh', 'geoportal', 'strassenbahn', 'fundburo', 'geodaten', 'punktdaten', 'vbg', 'tram', 'tramlinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-15T02:48:30.317335`
