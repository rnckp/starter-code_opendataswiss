...
- **Keywords.de** `['tram', 'strassenbahn', 'tramlinien', 'vektordaten', 'geodaten', 'stzh', 'punktdaten', 'fundburo', 'bus', 'vbz', 'buslinien', 'geoportal', 'postauto', 'offentlicher-verkehr', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-09T03:23:17.390221`
