...
- **Keywords.de** `['stzh', 'fundburo', 'tram', 'vektordaten', 'offentlicher-verkehr', 'tramlinien', 'punktdaten', 'bus', 'vbg', 'geoportal', 'postauto', 'strassenbahn', 'vbz', 'buslinien', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-09T02:23:06.457494`
