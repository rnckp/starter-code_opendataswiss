...
- **Keywords.de** `['fundburo', 'bus', 'stzh', 'tramlinien', 'vektordaten', 'vbz', 'strassenbahn', 'vbg', 'geodaten', 'buslinien', 'offentlicher-verkehr', 'punktdaten', 'geoportal', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-05T03:23:57.051156`
