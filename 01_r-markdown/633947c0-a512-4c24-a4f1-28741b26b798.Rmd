...
- **Keywords.de** `['tramlinien', 'stzh', 'punktdaten', 'strassenbahn', 'offentlicher-verkehr', 'vektordaten', 'postauto', 'vbg', 'fundburo', 'buslinien', 'vbz', 'tram', 'bus', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-23T03:16:25.116696`
