...
- **Keywords.de** `['stzh', 'buslinien', 'punktdaten', 'fundburo', 'strassenbahn', 'tramlinien', 'bus', 'geodaten', 'tram', 'offentlicher-verkehr', 'geoportal', 'postauto', 'vektordaten', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-15T02:59:40.018966`
