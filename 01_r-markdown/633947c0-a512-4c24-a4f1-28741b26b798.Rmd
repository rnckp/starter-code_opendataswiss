...
- **Keywords.de** `['vbz', 'geoportal', 'postauto', 'fundburo', 'tram', 'tramlinien', 'buslinien', 'bus', 'vbg', 'offentlicher-verkehr', 'geodaten', 'punktdaten', 'strassenbahn', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-21T03:15:15.019814`
