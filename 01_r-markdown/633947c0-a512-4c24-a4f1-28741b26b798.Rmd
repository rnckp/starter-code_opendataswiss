...
- **Keywords.de** `['punktdaten', 'stzh', 'fundburo', 'offentlicher-verkehr', 'geoportal', 'tram', 'buslinien', 'tramlinien', 'vbz', 'geodaten', 'vbg', 'strassenbahn', 'postauto', 'vektordaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-20T03:11:54.582812`
