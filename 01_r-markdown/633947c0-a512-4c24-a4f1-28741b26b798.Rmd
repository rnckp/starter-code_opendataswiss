...
- **Keywords.de** `['geoportal', 'vbg', 'buslinien', 'fundburo', 'vektordaten', 'tram', 'strassenbahn', 'tramlinien', 'punktdaten', 'postauto', 'vbz', 'geodaten', 'stzh', 'bus', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-25T03:30:28.326757`
