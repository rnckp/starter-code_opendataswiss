...
- **Keywords.de** `['vektordaten', 'tram', 'geoportal', 'punktdaten', 'offentlicher-verkehr', 'fundburo', 'bus', 'strassenbahn', 'vbz', 'tramlinien', 'geodaten', 'buslinien', 'vbg', 'stzh', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-17T03:29:03.863307`
