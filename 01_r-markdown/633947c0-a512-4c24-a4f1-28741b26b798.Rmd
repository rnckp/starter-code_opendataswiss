...
- **Keywords.de** `['fundburo', 'bus', 'strassenbahn', 'geoportal', 'vbz', 'offentlicher-verkehr', 'stzh', 'tram', 'vbg', 'punktdaten', 'geodaten', 'vektordaten', 'tramlinien', 'postauto', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-31T02:47:10.893538`
