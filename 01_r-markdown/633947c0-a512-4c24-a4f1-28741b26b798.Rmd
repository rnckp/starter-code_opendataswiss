...
- **Keywords.de** `['fundburo', 'strassenbahn', 'tramlinien', 'postauto', 'geoportal', 'buslinien', 'bus', 'tram', 'punktdaten', 'vbg', 'vektordaten', 'offentlicher-verkehr', 'stzh', 'vbz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-31T03:26:11.007524`
