...
- **Keywords.de** `['strassenbahn', 'geoportal', 'stzh', 'fundburo', 'offentlicher-verkehr', 'vbg', 'vbz', 'postauto', 'bus', 'tramlinien', 'punktdaten', 'tram', 'buslinien', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-29T03:30:23.787613`
