...
- **Keywords.de** `['vbg', 'postauto', 'buslinien', 'tram', 'geoportal', 'fundburo', 'tramlinien', 'offentlicher-verkehr', 'vektordaten', 'strassenbahn', 'bus', 'punktdaten', 'stzh', 'vbz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-26T03:11:12.075706`
