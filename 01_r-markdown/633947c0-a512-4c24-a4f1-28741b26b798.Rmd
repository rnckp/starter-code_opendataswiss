...
- **Keywords.de** `['geodaten', 'vbg', 'strassenbahn', 'stzh', 'punktdaten', 'buslinien', 'tramlinien', 'fundburo', 'tram', 'offentlicher-verkehr', 'bus', 'postauto', 'vbz', 'vektordaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-19T03:31:33.020346`
