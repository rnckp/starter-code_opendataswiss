...
- **Keywords.de** `['buslinien', 'vbg', 'vektordaten', 'tramlinien', 'offentlicher-verkehr', 'postauto', 'tram', 'punktdaten', 'geoportal', 'fundburo', 'stzh', 'bus', 'geodaten', 'strassenbahn', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-07T03:22:04.587685`
