...
- **Keywords.de** `['vektordaten', 'offentlicher-verkehr', 'vbg', 'tramlinien', 'geoportal', 'stzh', 'postauto', 'punktdaten', 'strassenbahn', 'vbz', 'bus', 'fundburo', 'geodaten', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-15T03:42:08.627842`
