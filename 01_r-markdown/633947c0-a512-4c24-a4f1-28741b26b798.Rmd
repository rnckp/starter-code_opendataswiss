...
- **Keywords.de** `['postauto', 'stzh', 'tram', 'strassenbahn', 'offentlicher-verkehr', 'bus', 'vbg', 'punktdaten', 'fundburo', 'vektordaten', 'geoportal', 'geodaten', 'buslinien', 'tramlinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-26T03:17:30.252839`
