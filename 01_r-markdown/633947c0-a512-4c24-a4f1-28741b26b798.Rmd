...
- **Keywords.de** `['geoportal', 'vbg', 'offentlicher-verkehr', 'bus', 'fundburo', 'strassenbahn', 'tram', 'geodaten', 'buslinien', 'stzh', 'vbz', 'tramlinien', 'postauto', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-25T03:07:35.448010`
