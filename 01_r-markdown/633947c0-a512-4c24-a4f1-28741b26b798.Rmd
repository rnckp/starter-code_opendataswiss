...
- **Keywords.de** `['offentlicher-verkehr', 'postauto', 'stzh', 'fundburo', 'geodaten', 'punktdaten', 'buslinien', 'tram', 'strassenbahn', 'vbz', 'bus', 'tramlinien', 'vektordaten', 'vbg', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-25T03:20:31.330425`
