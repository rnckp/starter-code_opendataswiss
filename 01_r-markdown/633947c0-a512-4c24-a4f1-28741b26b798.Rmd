...
- **Keywords.de** `['punktdaten', 'postauto', 'geodaten', 'tramlinien', 'geoportal', 'vektordaten', 'bus', 'fundburo', 'buslinien', 'strassenbahn', 'tram', 'vbg', 'stzh', 'vbz', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-08T03:50:11.915153`
