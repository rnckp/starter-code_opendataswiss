...
- **Keywords.de** `['bus', 'vbz', 'buslinien', 'geoportal', 'tram', 'geodaten', 'punktdaten', 'tramlinien', 'strassenbahn', 'stzh', 'postauto', 'vektordaten', 'vbg', 'offentlicher-verkehr', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-06T03:11:54.744247`
