...
- **Keywords.de** `['stzh', 'offentlicher-verkehr', 'vektordaten', 'geoportal', 'punktdaten', 'strassenbahn', 'tram', 'tramlinien', 'buslinien', 'bus', 'vbz', 'vbg', 'geodaten', 'postauto', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-14T03:49:06.377504`
