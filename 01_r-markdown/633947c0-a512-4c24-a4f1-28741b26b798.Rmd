...
- **Keywords.de** `['geodaten', 'vbz', 'offentlicher-verkehr', 'tram', 'geoportal', 'strassenbahn', 'vbg', 'tramlinien', 'punktdaten', 'buslinien', 'fundburo', 'postauto', 'stzh', 'bus', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-25T03:24:53.758404`
