...
- **Keywords.de** `['buslinien', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'fundburo', 'strassenbahn', 'punktdaten', 'vbg', 'geoportal', 'geodaten', 'vektordaten', 'vbz', 'postauto', 'bus', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-02T03:42:50.459731`
