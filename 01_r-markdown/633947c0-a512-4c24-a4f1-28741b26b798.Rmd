...
- **Keywords.de** `['geodaten', 'vbz', 'buslinien', 'postauto', 'fundburo', 'offentlicher-verkehr', 'geoportal', 'tram', 'punktdaten', 'bus', 'vektordaten', 'vbg', 'stzh', 'strassenbahn', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-21T03:23:34.685501`
