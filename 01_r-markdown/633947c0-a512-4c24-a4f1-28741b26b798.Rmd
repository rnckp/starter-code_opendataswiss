...
- **Keywords.de** `['fundburo', 'tramlinien', 'strassenbahn', 'buslinien', 'tram', 'punktdaten', 'postauto', 'geodaten', 'geoportal', 'offentlicher-verkehr', 'vektordaten', 'vbg', 'stzh', 'bus', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-10T03:23:04.018209`
