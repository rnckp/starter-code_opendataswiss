...
- **Keywords.de** `['strassenbahn', 'stzh', 'offentlicher-verkehr', 'postauto', 'punktdaten', 'vektordaten', 'vbz', 'tramlinien', 'fundburo', 'vbg', 'geodaten', 'buslinien', 'bus', 'geoportal', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-14T02:52:46.544178`
