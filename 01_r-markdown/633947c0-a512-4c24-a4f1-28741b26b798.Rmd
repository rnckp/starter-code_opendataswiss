...
- **Keywords.de** `['punktdaten', 'tram', 'stzh', 'geoportal', 'postauto', 'vbz', 'offentlicher-verkehr', 'vektordaten', 'fundburo', 'strassenbahn', 'vbg', 'buslinien', 'bus', 'tramlinien', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-17T02:48:26.549310`
