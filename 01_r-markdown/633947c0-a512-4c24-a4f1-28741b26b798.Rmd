...
- **Keywords.de** `['geoportal', 'postauto', 'tramlinien', 'bus', 'offentlicher-verkehr', 'vektordaten', 'vbz', 'geodaten', 'tram', 'stzh', 'fundburo', 'vbg', 'buslinien', 'punktdaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-26T03:39:37.857786`
