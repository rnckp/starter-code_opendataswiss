...
- **Keywords.de** `['postauto', 'tram', 'fundburo', 'geodaten', 'tramlinien', 'buslinien', 'bus', 'punktdaten', 'vektordaten', 'geoportal', 'strassenbahn', 'stzh', 'vbz', 'offentlicher-verkehr', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-10T03:05:00.396836`
