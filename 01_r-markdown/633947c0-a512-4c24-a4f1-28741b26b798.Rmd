...
- **Keywords.de** `['fundburo', 'buslinien', 'strassenbahn', 'geodaten', 'bus', 'vbg', 'geoportal', 'stzh', 'postauto', 'vektordaten', 'offentlicher-verkehr', 'punktdaten', 'tram', 'tramlinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-22T03:12:37.872069`
