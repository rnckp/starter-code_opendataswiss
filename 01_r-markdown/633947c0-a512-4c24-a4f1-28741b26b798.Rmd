...
- **Keywords.de** `['tramlinien', 'postauto', 'bus', 'stzh', 'vbg', 'vbz', 'fundburo', 'punktdaten', 'geodaten', 'geoportal', 'tram', 'strassenbahn', 'vektordaten', 'buslinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-26T02:56:04.018103`
