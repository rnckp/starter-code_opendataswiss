...
- **Keywords.de** `['punktdaten', 'fundburo', 'strassenbahn', 'vbz', 'postauto', 'buslinien', 'tramlinien', 'geoportal', 'geodaten', 'vektordaten', 'stzh', 'bus', 'vbg', 'tram', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-25T03:13:01.623276`
