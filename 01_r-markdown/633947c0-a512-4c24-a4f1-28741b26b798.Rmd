...
- **Keywords.de** `['geodaten', 'strassenbahn', 'vektordaten', 'buslinien', 'bus', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'vbz', 'tram', 'fundburo', 'punktdaten', 'postauto', 'geoportal', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-18T03:53:11.272141`
