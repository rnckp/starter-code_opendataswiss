...
- **Keywords.de** `['bus', 'punktdaten', 'geodaten', 'strassenbahn', 'geoportal', 'vektordaten', 'tramlinien', 'buslinien', 'offentlicher-verkehr', 'vbz', 'vbg', 'postauto', 'tram', 'stzh', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-28T03:21:49.900872`
