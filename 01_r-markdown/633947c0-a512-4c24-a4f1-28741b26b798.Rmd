...
- **Keywords.de** `['offentlicher-verkehr', 'vbz', 'geodaten', 'buslinien', 'geoportal', 'tramlinien', 'punktdaten', 'postauto', 'tram', 'vbg', 'fundburo', 'stzh', 'strassenbahn', 'vektordaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-09T03:11:30.702367`
