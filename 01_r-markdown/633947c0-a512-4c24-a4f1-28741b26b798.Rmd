...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'geodaten', 'vektordaten', 'strassenbahn', 'tramlinien', 'geoportal', 'vbz', 'postauto', 'fundburo', 'bus', 'punktdaten', 'vbg', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-24T03:44:29.874404`
