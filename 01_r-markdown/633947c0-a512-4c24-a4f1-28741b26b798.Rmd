...
- **Keywords.de** `['buslinien', 'tram', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'stzh', 'geoportal', 'punktdaten', 'tramlinien', 'fundburo', 'bus', 'strassenbahn', 'vbg', 'geodaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-11T03:26:17.022382`
