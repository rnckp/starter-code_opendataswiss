...
- **Keywords.de** `['punktdaten', 'vbz', 'tramlinien', 'geoportal', 'tram', 'stzh', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr', 'geodaten', 'bus', 'postauto', 'buslinien', 'fundburo', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-16T03:37:23.082212`
