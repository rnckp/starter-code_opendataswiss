...
- **Keywords.de** `['bus', 'strassenbahn', 'tramlinien', 'buslinien', 'punktdaten', 'vektordaten', 'stzh', 'offentlicher-verkehr', 'vbz', 'geoportal', 'tram', 'geodaten', 'fundburo', 'postauto', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-13T03:23:52.125506`
