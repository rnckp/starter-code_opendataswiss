...
- **Keywords.de** `['tramlinien', 'geoportal', 'vektordaten', 'vbz', 'postauto', 'buslinien', 'vbg', 'punktdaten', 'strassenbahn', 'offentlicher-verkehr', 'stzh', 'geodaten', 'fundburo', 'bus', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-22T02:51:38.413597`
