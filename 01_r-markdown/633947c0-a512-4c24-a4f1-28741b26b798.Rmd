...
- **Keywords.de** `['vbg', 'postauto', 'fundburo', 'geoportal', 'geodaten', 'vbz', 'punktdaten', 'tram', 'bus', 'strassenbahn', 'offentlicher-verkehr', 'vektordaten', 'stzh', 'buslinien', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-30T02:54:06.323100`
