...
- **Keywords.de** `['punktdaten', 'vbg', 'offentlicher-verkehr', 'fundburo', 'geoportal', 'stzh', 'tram', 'geodaten', 'bus', 'strassenbahn', 'buslinien', 'postauto', 'vbz', 'tramlinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-09T03:10:54.178862`
