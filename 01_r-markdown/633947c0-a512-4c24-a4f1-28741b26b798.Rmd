...
- **Keywords.de** `['geodaten', 'vbg', 'buslinien', 'tramlinien', 'fundburo', 'tram', 'postauto', 'bus', 'vbz', 'punktdaten', 'stzh', 'offentlicher-verkehr', 'geoportal', 'strassenbahn', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-12T03:36:28.843637`
