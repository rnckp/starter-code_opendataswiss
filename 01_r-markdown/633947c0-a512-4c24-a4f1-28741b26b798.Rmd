...
- **Keywords.de** `['geodaten', 'fundburo', 'postauto', 'punktdaten', 'strassenbahn', 'bus', 'offentlicher-verkehr', 'stzh', 'vbz', 'vektordaten', 'geoportal', 'tramlinien', 'buslinien', 'vbg', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-14T03:07:44.022381`
