...
- **Keywords.de** `['strassenbahn', 'tramlinien', 'postauto', 'stzh', 'fundburo', 'buslinien', 'tram', 'vektordaten', 'offentlicher-verkehr', 'vbg', 'vbz', 'geoportal', 'geodaten', 'punktdaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-12T03:11:00.793676`
