...
- **Keywords.de** `['strassenbahn', 'stzh', 'postauto', 'bus', 'geoportal', 'fundburo', 'buslinien', 'vbg', 'punktdaten', 'vbz', 'vektordaten', 'tramlinien', 'tram', 'geodaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-24T03:08:50.330976`
