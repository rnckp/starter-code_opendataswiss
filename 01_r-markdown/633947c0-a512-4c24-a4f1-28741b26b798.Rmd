...
- **Keywords.de** `['offentlicher-verkehr', 'vbz', 'strassenbahn', 'bus', 'fundburo', 'punktdaten', 'tramlinien', 'vektordaten', 'postauto', 'tram', 'geodaten', 'buslinien', 'geoportal', 'stzh', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-27T03:17:18.170412`
