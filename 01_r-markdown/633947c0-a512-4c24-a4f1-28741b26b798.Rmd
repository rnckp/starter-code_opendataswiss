...
- **Keywords.de** `['punktdaten', 'stzh', 'geoportal', 'offentlicher-verkehr', 'vbg', 'vektordaten', 'tramlinien', 'vbz', 'strassenbahn', 'geodaten', 'bus', 'buslinien', 'tram', 'postauto', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-08T03:24:00.243131`
