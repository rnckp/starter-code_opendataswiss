...
- **Keywords.de** `['bus', 'tram', 'strassenbahn', 'geodaten', 'vektordaten', 'postauto', 'stzh', 'tramlinien', 'vbg', 'buslinien', 'vbz', 'offentlicher-verkehr', 'punktdaten', 'geoportal', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-15T02:47:22.481838`
