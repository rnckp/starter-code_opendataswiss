...
- **Keywords.de** `['geoportal', 'fundburo', 'vbz', 'tram', 'vbg', 'tramlinien', 'geodaten', 'vektordaten', 'stzh', 'postauto', 'bus', 'strassenbahn', 'offentlicher-verkehr', 'punktdaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-08T04:35:01.022611`
