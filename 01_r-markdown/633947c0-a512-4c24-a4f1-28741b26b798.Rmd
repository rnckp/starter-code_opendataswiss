...
- **Keywords.de** `['tram', 'postauto', 'vbz', 'bus', 'punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'geodaten', 'vektordaten', 'buslinien', 'vbg', 'geoportal', 'fundburo', 'tramlinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-02T02:37:07.126330`
