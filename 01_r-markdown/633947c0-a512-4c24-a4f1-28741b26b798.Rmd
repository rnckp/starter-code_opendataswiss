...
- **Keywords.de** `['tram', 'strassenbahn', 'tramlinien', 'fundburo', 'stzh', 'geodaten', 'vbg', 'buslinien', 'bus', 'geoportal', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'punktdaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-17T02:53:59.777445`
