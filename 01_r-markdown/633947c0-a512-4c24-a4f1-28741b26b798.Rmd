...
- **Keywords.de** `['vektordaten', 'strassenbahn', 'geodaten', 'offentlicher-verkehr', 'vbg', 'punktdaten', 'buslinien', 'tram', 'tramlinien', 'stzh', 'bus', 'postauto', 'vbz', 'fundburo', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-22T02:42:20.323542`
