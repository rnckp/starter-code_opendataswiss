...
- **Keywords.de** `['offentlicher-verkehr', 'tramlinien', 'postauto', 'geodaten', 'tram', 'vbz', 'strassenbahn', 'vektordaten', 'vbg', 'buslinien', 'punktdaten', 'fundburo', 'geoportal', 'bus', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-18T03:01:53.781812`
