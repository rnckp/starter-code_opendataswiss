...
- **Keywords.de** `['stzh', 'punktdaten', 'bus', 'offentlicher-verkehr', 'geoportal', 'postauto', 'vektordaten', 'tramlinien', 'strassenbahn', 'vbz', 'buslinien', 'tram', 'vbg', 'geodaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-23T02:53:42.855660`
