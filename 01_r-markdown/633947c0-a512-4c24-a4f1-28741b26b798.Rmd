...
- **Keywords.de** `['geodaten', 'punktdaten', 'geoportal', 'vbz', 'vektordaten', 'postauto', 'vbg', 'buslinien', 'offentlicher-verkehr', 'bus', 'tram', 'stzh', 'tramlinien', 'fundburo', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-12T03:08:06.198417`
