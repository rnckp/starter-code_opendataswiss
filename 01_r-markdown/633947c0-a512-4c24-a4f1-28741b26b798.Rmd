...
- **Keywords.de** `['strassenbahn', 'fundburo', 'stzh', 'bus', 'postauto', 'geodaten', 'buslinien', 'vbg', 'punktdaten', 'geoportal', 'vektordaten', 'tram', 'vbz', 'tramlinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-25T03:06:27.989902`
