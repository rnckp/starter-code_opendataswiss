...
- **Keywords.de** `['punktdaten', 'stzh', 'tram', 'postauto', 'buslinien', 'vbg', 'strassenbahn', 'geodaten', 'geoportal', 'vbz', 'fundburo', 'offentlicher-verkehr', 'vektordaten', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-19T03:57:02.055857`
