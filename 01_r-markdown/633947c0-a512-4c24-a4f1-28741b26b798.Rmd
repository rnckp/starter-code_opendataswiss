...
- **Keywords.de** `['vektordaten', 'offentlicher-verkehr', 'tram', 'geodaten', 'tramlinien', 'geoportal', 'postauto', 'punktdaten', 'bus', 'vbg', 'strassenbahn', 'fundburo', 'buslinien', 'stzh', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-27T03:26:36.752673`
