...
- **Keywords.de** `['vbg', 'vektordaten', 'vbz', 'geoportal', 'bus', 'tramlinien', 'tram', 'postauto', 'punktdaten', 'buslinien', 'offentlicher-verkehr', 'fundburo', 'strassenbahn', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-18T03:35:22.039724`
