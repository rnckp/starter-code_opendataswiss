...
- **Keywords.de** `['vbg', 'tramlinien', 'geoportal', 'bus', 'vektordaten', 'punktdaten', 'offentlicher-verkehr', 'fundburo', 'buslinien', 'tram', 'vbz', 'geodaten', 'postauto', 'strassenbahn', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-25T03:08:33.568107`
