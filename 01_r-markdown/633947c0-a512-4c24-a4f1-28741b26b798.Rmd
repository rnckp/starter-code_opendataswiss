...
- **Keywords.de** `['vbz', 'punktdaten', 'tramlinien', 'strassenbahn', 'vektordaten', 'vbg', 'offentlicher-verkehr', 'stzh', 'buslinien', 'geoportal', 'geodaten', 'postauto', 'fundburo', 'bus', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-29T02:49:52.460133`
