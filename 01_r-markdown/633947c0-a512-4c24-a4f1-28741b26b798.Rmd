...
- **Keywords.de** `['offentlicher-verkehr', 'strassenbahn', 'vbg', 'geodaten', 'postauto', 'geoportal', 'vektordaten', 'tram', 'fundburo', 'vbz', 'tramlinien', 'bus', 'punktdaten', 'buslinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-23T03:03:12.602884`
