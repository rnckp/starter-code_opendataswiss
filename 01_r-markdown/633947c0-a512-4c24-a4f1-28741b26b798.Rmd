...
- **Keywords.de** `['vbz', 'stzh', 'strassenbahn', 'geodaten', 'buslinien', 'vektordaten', 'punktdaten', 'vbg', 'tramlinien', 'bus', 'tram', 'postauto', 'geoportal', 'fundburo', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-06T04:37:03.536256`
