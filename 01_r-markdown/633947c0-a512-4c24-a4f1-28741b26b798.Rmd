...
- **Keywords.de** `['vbg', 'geodaten', 'vektordaten', 'offentlicher-verkehr', 'stzh', 'tramlinien', 'vbz', 'fundburo', 'bus', 'punktdaten', 'tram', 'buslinien', 'strassenbahn', 'postauto', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-17T03:15:03.171451`
