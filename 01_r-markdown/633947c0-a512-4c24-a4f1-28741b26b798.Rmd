...
- **Keywords.de** `['stzh', 'geodaten', 'tramlinien', 'buslinien', 'tram', 'vbg', 'strassenbahn', 'geoportal', 'vektordaten', 'bus', 'punktdaten', 'fundburo', 'offentlicher-verkehr', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-30T03:20:46.959863`
