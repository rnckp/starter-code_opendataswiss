...
- **Keywords.de** `['vbz', 'bus', 'geodaten', 'tramlinien', 'fundburo', 'vektordaten', 'strassenbahn', 'offentlicher-verkehr', 'geoportal', 'tram', 'punktdaten', 'postauto', 'stzh', 'buslinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-06T04:01:28.313591`
