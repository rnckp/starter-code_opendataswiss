...
- **Keywords.de** `['bus', 'tramlinien', 'buslinien', 'tram', 'geodaten', 'stzh', 'vektordaten', 'geoportal', 'vbg', 'offentlicher-verkehr', 'strassenbahn', 'punktdaten', 'postauto', 'vbz', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-10T02:46:21.864260`
