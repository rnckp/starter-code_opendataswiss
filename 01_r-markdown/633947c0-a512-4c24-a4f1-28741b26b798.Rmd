...
- **Keywords.de** `['offentlicher-verkehr', 'fundburo', 'strassenbahn', 'buslinien', 'punktdaten', 'postauto', 'vektordaten', 'vbg', 'geodaten', 'tram', 'bus', 'geoportal', 'stzh', 'vbz', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-23T04:08:32.871685`
