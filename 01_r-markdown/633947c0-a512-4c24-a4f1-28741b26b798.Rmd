...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'vbz', 'bus', 'strassenbahn', 'postauto', 'punktdaten', 'geodaten', 'fundburo', 'tramlinien', 'vektordaten', 'geoportal', 'buslinien', 'vbg', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-30T02:58:22.334738`
