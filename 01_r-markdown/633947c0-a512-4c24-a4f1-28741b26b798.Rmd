...
- **Keywords.de** `['punktdaten', 'vbg', 'postauto', 'tramlinien', 'geoportal', 'geodaten', 'offentlicher-verkehr', 'fundburo', 'buslinien', 'tram', 'bus', 'strassenbahn', 'vbz', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-15T03:28:43.887185`
