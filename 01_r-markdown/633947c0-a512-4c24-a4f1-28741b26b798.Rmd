...
- **Keywords.de** `['postauto', 'vbg', 'stzh', 'geodaten', 'bus', 'geoportal', 'punktdaten', 'vbz', 'tram', 'vektordaten', 'buslinien', 'fundburo', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-16T03:11:17.317824`
