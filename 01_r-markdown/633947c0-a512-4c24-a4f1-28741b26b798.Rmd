...
- **Keywords.de** `['vbg', 'offentlicher-verkehr', 'vbz', 'stzh', 'punktdaten', 'tram', 'postauto', 'strassenbahn', 'bus', 'geoportal', 'geodaten', 'fundburo', 'vektordaten', 'tramlinien', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-19T04:18:51.724703`
