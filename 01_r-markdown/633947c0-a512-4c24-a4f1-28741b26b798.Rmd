...
- **Keywords.de** `['vektordaten', 'postauto', 'vbz', 'strassenbahn', 'geodaten', 'geoportal', 'stzh', 'tramlinien', 'bus', 'tram', 'punktdaten', 'fundburo', 'vbg', 'buslinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-12T03:09:18.448617`
