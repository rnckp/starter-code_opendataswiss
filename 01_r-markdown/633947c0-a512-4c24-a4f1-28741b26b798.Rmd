...
- **Keywords.de** `['offentlicher-verkehr', 'geodaten', 'stzh', 'buslinien', 'strassenbahn', 'bus', 'fundburo', 'tramlinien', 'tram', 'postauto', 'vbz', 'vektordaten', 'vbg', 'punktdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-24T03:29:35.167125`
