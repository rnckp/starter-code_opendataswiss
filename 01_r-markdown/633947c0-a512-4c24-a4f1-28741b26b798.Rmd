...
- **Keywords.de** `['vbz', 'postauto', 'stzh', 'vektordaten', 'tram', 'offentlicher-verkehr', 'bus', 'geodaten', 'punktdaten', 'vbg', 'tramlinien', 'strassenbahn', 'geoportal', 'fundburo', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-15T03:44:16.589988`
