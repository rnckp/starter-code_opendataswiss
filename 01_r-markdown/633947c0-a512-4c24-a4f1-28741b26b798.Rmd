...
- **Keywords.de** `['strassenbahn', 'stzh', 'postauto', 'vektordaten', 'tramlinien', 'bus', 'fundburo', 'vbz', 'buslinien', 'geoportal', 'punktdaten', 'tram', 'offentlicher-verkehr', 'vbg', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-13T02:31:01.024909`
