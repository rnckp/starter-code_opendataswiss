...
- **Keywords.de** `['strassenbahn', 'postauto', 'geodaten', 'geoportal', 'tram', 'stzh', 'buslinien', 'fundburo', 'vektordaten', 'bus', 'vbg', 'offentlicher-verkehr', 'punktdaten', 'vbz', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-29T04:13:12.403957`
