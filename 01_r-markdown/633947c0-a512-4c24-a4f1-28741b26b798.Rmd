...
- **Keywords.de** `['postauto', 'strassenbahn', 'punktdaten', 'tram', 'vektordaten', 'buslinien', 'stzh', 'bus', 'offentlicher-verkehr', 'geoportal', 'vbg', 'fundburo', 'geodaten', 'vbz', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-25T02:51:32.812542`
