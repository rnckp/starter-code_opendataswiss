...
- **Keywords.de** `['vbz', 'tram', 'offentlicher-verkehr', 'postauto', 'vektordaten', 'geodaten', 'strassenbahn', 'punktdaten', 'vbg', 'buslinien', 'bus', 'fundburo', 'geoportal', 'tramlinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-29T03:36:53.936782`
