...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'buslinien', 'tramlinien', 'geodaten', 'punktdaten', 'fundburo', 'vbg', 'strassenbahn', 'postauto', 'stzh', 'tram', 'vbz', 'bus', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-26T02:36:12.731357`
