...
- **Keywords.de** `['geodaten', 'punktdaten', 'postauto', 'vbg', 'vbz', 'tramlinien', 'bus', 'buslinien', 'offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'fundburo', 'stzh', 'geoportal', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-09T02:57:02.282586`
