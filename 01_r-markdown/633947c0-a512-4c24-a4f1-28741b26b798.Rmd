...
- **Keywords.de** `['buslinien', 'postauto', 'tramlinien', 'strassenbahn', 'vektordaten', 'stzh', 'geoportal', 'geodaten', 'vbg', 'fundburo', 'offentlicher-verkehr', 'punktdaten', 'tram', 'bus', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-22T02:04:54.184858`
