...
- **Keywords.de** `['vektordaten', 'bus', 'strassenbahn', 'postauto', 'offentlicher-verkehr', 'buslinien', 'geodaten', 'tramlinien', 'tram', 'geoportal', 'punktdaten', 'stzh', 'vbg', 'vbz', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-02T03:18:29.817461`
