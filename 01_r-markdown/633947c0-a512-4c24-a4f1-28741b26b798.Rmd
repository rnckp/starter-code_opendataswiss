...
- **Keywords.de** `['punktdaten', 'vbz', 'vbg', 'geoportal', 'postauto', 'buslinien', 'offentlicher-verkehr', 'vektordaten', 'strassenbahn', 'tram', 'geodaten', 'fundburo', 'bus', 'stzh', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-30T03:02:02.945626`
