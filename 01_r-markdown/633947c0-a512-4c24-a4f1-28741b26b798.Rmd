...
- **Keywords.de** `['geodaten', 'buslinien', 'stzh', 'vbz', 'offentlicher-verkehr', 'tram', 'postauto', 'punktdaten', 'tramlinien', 'fundburo', 'strassenbahn', 'vbg', 'geoportal', 'bus', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-01T03:31:18.569854`
