...
- **Keywords.de** `['fundburo', 'vektordaten', 'vbg', 'buslinien', 'postauto', 'geoportal', 'punktdaten', 'vbz', 'bus', 'stzh', 'tramlinien', 'tram', 'geodaten', 'offentlicher-verkehr', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-15T03:01:29.173803`
