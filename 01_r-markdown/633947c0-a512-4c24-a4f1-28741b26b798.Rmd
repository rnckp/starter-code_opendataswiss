...
- **Keywords.de** `['vektordaten', 'stzh', 'geoportal', 'strassenbahn', 'offentlicher-verkehr', 'tram', 'bus', 'buslinien', 'vbz', 'geodaten', 'punktdaten', 'postauto', 'tramlinien', 'fundburo', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-16T03:22:08.941496`
