...
- **Keywords.de** `['fundburo', 'postauto', 'punktdaten', 'tram', 'tramlinien', 'geoportal', 'geodaten', 'stzh', 'strassenbahn', 'buslinien', 'bus', 'offentlicher-verkehr', 'vbg', 'vektordaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-03T04:57:18.124905`
