...
- **Keywords.de** `['tram', 'stzh', 'strassenbahn', 'vbg', 'offentlicher-verkehr', 'vektordaten', 'geoportal', 'tramlinien', 'geodaten', 'punktdaten', 'bus', 'buslinien', 'postauto', 'vbz', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-15T02:26:51.428650`
