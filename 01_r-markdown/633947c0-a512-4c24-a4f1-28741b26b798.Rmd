...
- **Keywords.de** `['vbg', 'vbz', 'tramlinien', 'buslinien', 'vektordaten', 'geoportal', 'geodaten', 'bus', 'stzh', 'offentlicher-verkehr', 'strassenbahn', 'punktdaten', 'fundburo', 'tram', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-17T03:12:33.412681`
