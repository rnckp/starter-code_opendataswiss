...
- **Keywords.de** `['vektordaten', 'offentlicher-verkehr', 'vbz', 'buslinien', 'fundburo', 'punktdaten', 'tram', 'stzh', 'vbg', 'strassenbahn', 'postauto', 'tramlinien', 'bus', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-01T02:53:18.103564`
