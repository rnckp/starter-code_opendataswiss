...
- **Keywords.de** `['tram', 'stzh', 'strassenbahn', 'vbg', 'postauto', 'geodaten', 'offentlicher-verkehr', 'fundburo', 'vbz', 'vektordaten', 'buslinien', 'geoportal', 'bus', 'punktdaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-17T04:29:31.703926`
