...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'tramlinien', 'fundburo', 'tram', 'vbg', 'vbz', 'offentlicher-verkehr', 'bus', 'postauto', 'geoportal', 'geodaten', 'punktdaten', 'stzh', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-03T03:05:12.369145`
