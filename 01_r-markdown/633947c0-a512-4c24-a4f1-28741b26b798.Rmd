...
- **Keywords.de** `['strassenbahn', 'postauto', 'tram', 'punktdaten', 'fundburo', 'vektordaten', 'geodaten', 'geoportal', 'vbg', 'tramlinien', 'stzh', 'buslinien', 'bus', 'vbz', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-01T02:56:28.803605`
