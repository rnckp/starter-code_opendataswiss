...
- **Keywords.de** `['vbz', 'bus', 'postauto', 'stzh', 'tram', 'punktdaten', 'buslinien', 'strassenbahn', 'vektordaten', 'geodaten', 'geoportal', 'fundburo', 'vbg', 'offentlicher-verkehr', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-07T03:23:39.969789`
