...
- **Keywords.de** `['stzh', 'bus', 'buslinien', 'tram', 'offentlicher-verkehr', 'geodaten', 'fundburo', 'vbg', 'punktdaten', 'vektordaten', 'postauto', 'strassenbahn', 'vbz', 'geoportal', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-12T03:40:29.611699`
