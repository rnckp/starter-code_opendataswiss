...
- **Keywords.de** `['bus', 'fundburo', 'stzh', 'tram', 'geoportal', 'vbz', 'punktdaten', 'vbg', 'buslinien', 'tramlinien', 'postauto', 'geodaten', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-10T05:45:43.327476`
