...
- **Keywords.de** `['geodaten', 'punktdaten', 'vbz', 'vbg', 'vektordaten', 'bus', 'stzh', 'fundburo', 'postauto', 'buslinien', 'offentlicher-verkehr', 'tramlinien', 'strassenbahn', 'geoportal', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-19T03:13:27.275138`
