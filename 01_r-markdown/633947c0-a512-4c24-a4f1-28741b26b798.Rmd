...
- **Keywords.de** `['postauto', 'vbg', 'fundburo', 'tram', 'bus', 'strassenbahn', 'buslinien', 'vbz', 'geodaten', 'tramlinien', 'geoportal', 'punktdaten', 'vektordaten', 'offentlicher-verkehr', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-15T03:34:41.003398`
