...
- **Keywords.de** `['vbz', 'vektordaten', 'offentlicher-verkehr', 'postauto', 'bus', 'tramlinien', 'geodaten', 'vbg', 'stzh', 'tram', 'geoportal', 'strassenbahn', 'buslinien', 'punktdaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-01T03:34:38.409023`
