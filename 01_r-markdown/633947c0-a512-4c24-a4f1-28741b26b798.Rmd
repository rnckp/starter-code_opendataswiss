...
- **Keywords.de** `['bus', 'buslinien', 'vektordaten', 'fundburo', 'offentlicher-verkehr', 'strassenbahn', 'geodaten', 'postauto', 'punktdaten', 'tram', 'vbz', 'tramlinien', 'vbg', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-04T04:33:00.972378`
