...
- **Keywords.de** `['fundburo', 'vbg', 'tram', 'geoportal', 'strassenbahn', 'vbz', 'offentlicher-verkehr', 'buslinien', 'bus', 'geodaten', 'punktdaten', 'stzh', 'postauto', 'tramlinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-07T03:23:06.428653`
