...
- **Keywords.de** `['punktdaten', 'vbz', 'geodaten', 'tram', 'geoportal', 'postauto', 'tramlinien', 'fundburo', 'vbg', 'strassenbahn', 'buslinien', 'stzh', 'vektordaten', 'bus', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-22T05:13:57.093812`
