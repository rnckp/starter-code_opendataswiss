...
- **Keywords.de** `['tramlinien', 'geoportal', 'punktdaten', 'strassenbahn', 'offentlicher-verkehr', 'vbz', 'buslinien', 'vbg', 'stzh', 'geodaten', 'fundburo', 'tram', 'bus', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-30T03:39:26.954128`
