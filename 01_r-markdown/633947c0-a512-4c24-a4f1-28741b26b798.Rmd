...
- **Keywords.de** `['vektordaten', 'fundburo', 'offentlicher-verkehr', 'strassenbahn', 'stzh', 'tram', 'vbg', 'geodaten', 'postauto', 'bus', 'buslinien', 'geoportal', 'punktdaten', 'vbz', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-04T03:19:25.830228`
