...
- **Keywords.de** `['tram', 'fundburo', 'strassenbahn', 'tramlinien', 'offentlicher-verkehr', 'vektordaten', 'postauto', 'buslinien', 'bus', 'vbz', 'geodaten', 'stzh', 'vbg', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-23T02:27:37.430278`
