...
- **Keywords.de** `['vbg', 'geodaten', 'tram', 'vbz', 'strassenbahn', 'stzh', 'tramlinien', 'fundburo', 'buslinien', 'geoportal', 'punktdaten', 'offentlicher-verkehr', 'bus', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-24T02:57:52.977482`
