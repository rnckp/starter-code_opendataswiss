...
- **Keywords.de** `['buslinien', 'punktdaten', 'vektordaten', 'offentlicher-verkehr', 'stzh', 'postauto', 'vbz', 'tram', 'bus', 'tramlinien', 'fundburo', 'geodaten', 'vbg', 'geoportal', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-15T03:06:25.813272`
