...
- **Keywords.de** `['vbg', 'stzh', 'offentlicher-verkehr', 'bus', 'vektordaten', 'fundburo', 'tramlinien', 'strassenbahn', 'tram', 'buslinien', 'geodaten', 'punktdaten', 'geoportal', 'postauto', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-03T03:13:55.243637`
