...
- **Keywords.de** `['punktdaten', 'buslinien', 'vbg', 'fundburo', 'geoportal', 'vbz', 'vektordaten', 'stzh', 'offentlicher-verkehr', 'tramlinien', 'bus', 'tram', 'geodaten', 'postauto', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-11T03:19:35.139215`
