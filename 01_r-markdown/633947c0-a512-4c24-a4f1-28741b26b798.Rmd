...
- **Keywords.de** `['tram', 'tramlinien', 'geodaten', 'punktdaten', 'geoportal', 'offentlicher-verkehr', 'vektordaten', 'strassenbahn', 'postauto', 'buslinien', 'vbg', 'vbz', 'stzh', 'fundburo', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-03T08:08:04.665388`
