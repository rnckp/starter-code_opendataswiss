...
- **Keywords.de** `['geoportal', 'tramlinien', 'vektordaten', 'tram', 'vbz', 'fundburo', 'vbg', 'postauto', 'stzh', 'strassenbahn', 'buslinien', 'bus', 'punktdaten', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-16T03:16:10.658974`
