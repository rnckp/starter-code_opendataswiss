...
- **Keywords.de** `['vbg', 'geodaten', 'strassenbahn', 'tram', 'vektordaten', 'bus', 'punktdaten', 'tramlinien', 'postauto', 'vbz', 'geoportal', 'fundburo', 'buslinien', 'stzh', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-31T03:10:01.708729`
