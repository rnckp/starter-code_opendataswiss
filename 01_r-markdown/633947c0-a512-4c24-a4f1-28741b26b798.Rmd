...
- **Keywords.de** `['bus', 'geodaten', 'offentlicher-verkehr', 'fundburo', 'strassenbahn', 'stzh', 'geoportal', 'punktdaten', 'tramlinien', 'vbz', 'tram', 'buslinien', 'postauto', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-03T02:29:45.843867`
