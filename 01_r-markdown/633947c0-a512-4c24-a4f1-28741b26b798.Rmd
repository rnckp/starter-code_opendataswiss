...
- **Keywords.de** `['bus', 'offentlicher-verkehr', 'postauto', 'geodaten', 'vbz', 'fundburo', 'vektordaten', 'tramlinien', 'strassenbahn', 'tram', 'buslinien', 'stzh', 'punktdaten', 'vbg', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-14T03:24:04.576004`
