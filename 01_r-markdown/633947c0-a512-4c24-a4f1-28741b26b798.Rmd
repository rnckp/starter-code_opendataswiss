...
- **Keywords.de** `['vbz', 'strassenbahn', 'vektordaten', 'tramlinien', 'bus', 'buslinien', 'punktdaten', 'fundburo', 'geodaten', 'tram', 'stzh', 'postauto', 'geoportal', 'offentlicher-verkehr', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-18T03:29:38.902260`
