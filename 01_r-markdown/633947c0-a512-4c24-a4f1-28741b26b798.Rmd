...
- **Keywords.de** `['strassenbahn', 'vbg', 'tramlinien', 'tram', 'punktdaten', 'geodaten', 'fundburo', 'vbz', 'stzh', 'vektordaten', 'geoportal', 'offentlicher-verkehr', 'buslinien', 'bus', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-18T02:16:02.145278`
