...
- **Keywords.de** `['strassenbahn', 'postauto', 'vektordaten', 'geoportal', 'tramlinien', 'vbg', 'fundburo', 'tram', 'bus', 'stzh', 'offentlicher-verkehr', 'vbz', 'geodaten', 'punktdaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-03T03:03:59.577779`
