...
- **Keywords.de** `['bus', 'strassenbahn', 'punktdaten', 'geoportal', 'vbz', 'stzh', 'tramlinien', 'vektordaten', 'vbg', 'fundburo', 'tram', 'postauto', 'geodaten', 'buslinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-05T03:02:36.047913`
