...
- **Keywords.de** `['tram', 'vbg', 'tramlinien', 'fundburo', 'geoportal', 'vbz', 'bus', 'offentlicher-verkehr', 'geodaten', 'stzh', 'strassenbahn', 'punktdaten', 'vektordaten', 'buslinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-06T02:47:15.685798`
