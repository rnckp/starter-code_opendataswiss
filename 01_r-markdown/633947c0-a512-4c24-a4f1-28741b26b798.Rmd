...
- **Keywords.de** `['vbz', 'geodaten', 'postauto', 'offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'tramlinien', 'tram', 'stzh', 'geoportal', 'punktdaten', 'fundburo', 'buslinien', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-27T02:55:46.601639`
