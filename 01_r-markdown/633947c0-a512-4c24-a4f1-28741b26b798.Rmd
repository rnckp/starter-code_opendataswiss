...
- **Keywords.de** `['bus', 'geoportal', 'offentlicher-verkehr', 'vbz', 'vbg', 'punktdaten', 'vektordaten', 'fundburo', 'tramlinien', 'tram', 'geodaten', 'buslinien', 'stzh', 'postauto', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-10T04:10:24.610628`
