...
- **Keywords.de** `['buslinien', 'geoportal', 'vbg', 'offentlicher-verkehr', 'stzh', 'tramlinien', 'vektordaten', 'vbz', 'geodaten', 'strassenbahn', 'punktdaten', 'postauto', 'fundburo', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-23T03:21:14.771560`
