...
- **Keywords.de** `['postauto', 'geoportal', 'tram', 'stzh', 'geodaten', 'tramlinien', 'fundburo', 'offentlicher-verkehr', 'buslinien', 'strassenbahn', 'punktdaten', 'vektordaten', 'vbz', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-28T02:59:27.662083`
