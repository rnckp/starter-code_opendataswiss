...
- **Keywords.de** `['strassenbahn', 'stzh', 'geodaten', 'vektordaten', 'postauto', 'vbz', 'punktdaten', 'buslinien', 'offentlicher-verkehr', 'tramlinien', 'tram', 'geoportal', 'bus', 'vbg', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-30T08:40:50.478434`
