...
- **Keywords.de** `['vektordaten', 'geodaten', 'fundburo', 'tramlinien', 'stzh', 'vbz', 'buslinien', 'tram', 'geoportal', 'strassenbahn', 'postauto', 'offentlicher-verkehr', 'punktdaten', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-02T03:13:55.568769`
