...
- **Keywords.de** `['vektordaten', 'tramlinien', 'offentlicher-verkehr', 'tram', 'vbz', 'stzh', 'bus', 'punktdaten', 'vbg', 'geoportal', 'strassenbahn', 'geodaten', 'postauto', 'buslinien', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-24T02:52:09.936706`
