...
- **Keywords.de** `['vektordaten', 'vbg', 'tram', 'strassenbahn', 'bus', 'geoportal', 'buslinien', 'tramlinien', 'stzh', 'vbz', 'fundburo', 'geodaten', 'punktdaten', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-03T03:25:26.312252`
