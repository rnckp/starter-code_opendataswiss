...
- **Keywords.de** `['vektordaten', 'postauto', 'punktdaten', 'strassenbahn', 'fundburo', 'geodaten', 'vbg', 'tramlinien', 'geoportal', 'offentlicher-verkehr', 'buslinien', 'tram', 'stzh', 'vbz', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-09T04:12:22.142432`
