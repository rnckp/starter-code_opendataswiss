...
- **Keywords.de** `['stzh', 'punktdaten', 'geodaten', 'vbz', 'offentlicher-verkehr', 'buslinien', 'postauto', 'tram', 'fundburo', 'bus', 'strassenbahn', 'tramlinien', 'vektordaten', 'geoportal', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-18T02:57:30.713955`
