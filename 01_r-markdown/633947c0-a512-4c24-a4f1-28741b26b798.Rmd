...
- **Keywords.de** `['stzh', 'bus', 'tram', 'buslinien', 'vbg', 'postauto', 'vbz', 'geodaten', 'tramlinien', 'strassenbahn', 'punktdaten', 'offentlicher-verkehr', 'vektordaten', 'geoportal', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-03T04:04:17.750233`
