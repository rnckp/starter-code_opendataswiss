...
- **Keywords.de** `['geodaten', 'geoportal', 'strassenbahn', 'offentlicher-verkehr', 'stzh', 'tram', 'vektordaten', 'postauto', 'buslinien', 'tramlinien', 'punktdaten', 'fundburo', 'bus', 'vbz', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-05T02:44:35.414633`
