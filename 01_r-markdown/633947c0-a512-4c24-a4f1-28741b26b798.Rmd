...
- **Keywords.de** `['buslinien', 'geoportal', 'bus', 'vbg', 'vektordaten', 'fundburo', 'vbz', 'postauto', 'tram', 'stzh', 'punktdaten', 'geodaten', 'tramlinien', 'strassenbahn', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-08T03:04:01.379830`
