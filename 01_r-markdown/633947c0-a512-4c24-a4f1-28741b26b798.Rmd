...
- **Keywords.de** `['vbz', 'strassenbahn', 'stzh', 'bus', 'vbg', 'offentlicher-verkehr', 'buslinien', 'punktdaten', 'tram', 'geoportal', 'vektordaten', 'geodaten', 'postauto', 'tramlinien', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-10T05:26:39.498555`
