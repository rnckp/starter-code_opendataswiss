...
- **Keywords.de** `['vbz', 'buslinien', 'offentlicher-verkehr', 'geodaten', 'tramlinien', 'bus', 'tram', 'fundburo', 'stzh', 'geoportal', 'vektordaten', 'strassenbahn', 'punktdaten', 'vbg', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-17T02:44:51.295025`
