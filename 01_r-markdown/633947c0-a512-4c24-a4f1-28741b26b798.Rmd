...
- **Keywords.de** `['geoportal', 'offentlicher-verkehr', 'vbg', 'strassenbahn', 'tramlinien', 'vbz', 'postauto', 'tram', 'stzh', 'vektordaten', 'buslinien', 'fundburo', 'punktdaten', 'geodaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-04T03:36:17.315603`
