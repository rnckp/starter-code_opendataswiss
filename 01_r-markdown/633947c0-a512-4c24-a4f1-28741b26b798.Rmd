...
- **Keywords.de** `['fundburo', 'vbg', 'vektordaten', 'buslinien', 'geoportal', 'vbz', 'punktdaten', 'geodaten', 'bus', 'tramlinien', 'stzh', 'offentlicher-verkehr', 'strassenbahn', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-14T03:21:50.070788`
