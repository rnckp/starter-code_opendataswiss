...
- **Keywords.de** `['stzh', 'punktdaten', 'geodaten', 'vbg', 'buslinien', 'tramlinien', 'vbz', 'offentlicher-verkehr', 'postauto', 'bus', 'geoportal', 'vektordaten', 'strassenbahn', 'tram', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-07T02:30:47.397790`
