...
- **Keywords.de** `['vbg', 'stzh', 'buslinien', 'bus', 'strassenbahn', 'tramlinien', 'geodaten', 'punktdaten', 'vbz', 'postauto', 'offentlicher-verkehr', 'geoportal', 'fundburo', 'tram', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-14T02:56:52.228929`
