...
- **Keywords.de** `['buslinien', 'tramlinien', 'vbg', 'vektordaten', 'postauto', 'vbz', 'offentlicher-verkehr', 'strassenbahn', 'geodaten', 'punktdaten', 'geoportal', 'tram', 'stzh', 'bus', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-14T03:39:49.127386`
