...
- **Keywords.de** `['tram', 'postauto', 'strassenbahn', 'buslinien', 'vbg', 'vektordaten', 'stzh', 'punktdaten', 'geodaten', 'fundburo', 'geoportal', 'vbz', 'tramlinien', 'bus', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-24T03:32:39.723868`
