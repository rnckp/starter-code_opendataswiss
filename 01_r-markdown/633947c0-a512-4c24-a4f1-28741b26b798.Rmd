...
- **Keywords.de** `['stzh', 'postauto', 'vbz', 'fundburo', 'buslinien', 'bus', 'vbg', 'geodaten', 'offentlicher-verkehr', 'strassenbahn', 'tram', 'geoportal', 'tramlinien', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-04T03:22:56.141756`
