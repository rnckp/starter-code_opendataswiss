...
- **Keywords.de** `['bus', 'punktdaten', 'fundburo', 'postauto', 'geoportal', 'tram', 'vbz', 'geodaten', 'vbg', 'strassenbahn', 'vektordaten', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-03T02:28:20.153580`
