...
- **Keywords.de** `['buslinien', 'geodaten', 'geoportal', 'stzh', 'fundburo', 'offentlicher-verkehr', 'vektordaten', 'vbz', 'punktdaten', 'postauto', 'vbg', 'strassenbahn', 'bus', 'tram', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-13T03:35:54.014783`
