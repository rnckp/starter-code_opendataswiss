...
- **Keywords.de** `['offentlicher-verkehr', 'geoportal', 'strassenbahn', 'buslinien', 'stzh', 'punktdaten', 'geodaten', 'tram', 'vektordaten', 'vbz', 'tramlinien', 'vbg', 'postauto', 'fundburo', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-01T03:54:09.458973`
