...
- **Keywords.de** `['bus', 'stzh', 'tram', 'tramlinien', 'postauto', 'geoportal', 'fundburo', 'geodaten', 'vbg', 'strassenbahn', 'buslinien', 'vbz', 'punktdaten', 'vektordaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-19T03:20:10.320295`
