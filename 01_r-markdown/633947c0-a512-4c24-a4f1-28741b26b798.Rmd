...
- **Keywords.de** `['geoportal', 'tram', 'vektordaten', 'tramlinien', 'bus', 'geodaten', 'vbz', 'postauto', 'vbg', 'punktdaten', 'offentlicher-verkehr', 'buslinien', 'stzh', 'fundburo', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-19T02:06:51.914125`
