...
- **Keywords.de** `['vektordaten', 'punktdaten', 'postauto', 'vbg', 'strassenbahn', 'geoportal', 'buslinien', 'bus', 'geodaten', 'stzh', 'fundburo', 'vbz', 'offentlicher-verkehr', 'tram', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-26T03:44:32.527402`
