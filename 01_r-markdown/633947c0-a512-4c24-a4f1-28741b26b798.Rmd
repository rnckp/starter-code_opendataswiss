...
- **Keywords.de** `['geoportal', 'tramlinien', 'strassenbahn', 'tram', 'stzh', 'fundburo', 'punktdaten', 'bus', 'vbg', 'geodaten', 'buslinien', 'vektordaten', 'postauto', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-13T04:16:20.709040`
