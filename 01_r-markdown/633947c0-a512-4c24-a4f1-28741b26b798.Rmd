...
- **Keywords.de** `['fundburo', 'geodaten', 'postauto', 'vbz', 'bus', 'tramlinien', 'vbg', 'strassenbahn', 'buslinien', 'offentlicher-verkehr', 'geoportal', 'punktdaten', 'stzh', 'vektordaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-21T03:46:13.257735`
