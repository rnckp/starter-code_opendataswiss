...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'buslinien', 'postauto', 'offentlicher-verkehr', 'bus', 'vbz', 'vbg', 'geoportal', 'tramlinien', 'tram', 'punktdaten', 'geodaten', 'stzh', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-10T03:25:33.954925`
