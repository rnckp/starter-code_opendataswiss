...
- **Keywords.de** `['offentlicher-verkehr', 'geoportal', 'stzh', 'tram', 'bus', 'vbg', 'fundburo', 'punktdaten', 'buslinien', 'vbz', 'strassenbahn', 'geodaten', 'tramlinien', 'postauto', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-06T03:14:01.018608`
