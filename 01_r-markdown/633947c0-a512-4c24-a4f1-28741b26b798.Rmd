...
- **Keywords.de** `['stzh', 'buslinien', 'geoportal', 'vektordaten', 'offentlicher-verkehr', 'punktdaten', 'bus', 'vbg', 'postauto', 'strassenbahn', 'tram', 'geodaten', 'fundburo', 'vbz', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-04T04:04:48.962609`
