...
- **Keywords.de** `['vektordaten', 'tram', 'vbg', 'postauto', 'geoportal', 'offentlicher-verkehr', 'vbz', 'buslinien', 'punktdaten', 'stzh', 'strassenbahn', 'tramlinien', 'geodaten', 'bus', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-29T03:03:09.773342`
