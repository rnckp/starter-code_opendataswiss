...
- **Keywords.de** `['geodaten', 'buslinien', 'strassenbahn', 'fundburo', 'vbz', 'vbg', 'postauto', 'bus', 'tram', 'offentlicher-verkehr', 'geoportal', 'tramlinien', 'punktdaten', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-24T02:48:19.525757`
