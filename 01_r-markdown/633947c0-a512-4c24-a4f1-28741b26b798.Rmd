...
- **Keywords.de** `['vektordaten', 'vbz', 'bus', 'vbg', 'stzh', 'postauto', 'offentlicher-verkehr', 'geodaten', 'strassenbahn', 'geoportal', 'tram', 'buslinien', 'fundburo', 'punktdaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-20T02:36:40.938170`
