...
- **Keywords.de** `['postauto', 'punktdaten', 'tramlinien', 'offentlicher-verkehr', 'tram', 'strassenbahn', 'fundburo', 'vektordaten', 'geoportal', 'vbz', 'bus', 'vbg', 'buslinien', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-16T03:11:37.441791`
