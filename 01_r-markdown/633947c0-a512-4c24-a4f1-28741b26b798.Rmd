...
- **Keywords.de** `['fundburo', 'strassenbahn', 'geodaten', 'geoportal', 'offentlicher-verkehr', 'bus', 'tramlinien', 'buslinien', 'vbz', 'tram', 'punktdaten', 'stzh', 'vbg', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-26T03:18:38.632617`
