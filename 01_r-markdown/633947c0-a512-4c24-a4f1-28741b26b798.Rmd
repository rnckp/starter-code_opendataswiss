...
- **Keywords.de** `['vektordaten', 'fundburo', 'postauto', 'vbz', 'strassenbahn', 'geodaten', 'offentlicher-verkehr', 'tramlinien', 'buslinien', 'stzh', 'bus', 'tram', 'punktdaten', 'geoportal', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-08T04:57:35.117750`
