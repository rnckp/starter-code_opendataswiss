...
- **Keywords.de** `['stzh', 'geoportal', 'bus', 'offentlicher-verkehr', 'postauto', 'vbg', 'tramlinien', 'tram', 'punktdaten', 'fundburo', 'strassenbahn', 'vbz', 'buslinien', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-17T03:25:14.062742`
