...
- **Keywords.de** `['strassenbahn', 'fundburo', 'vbg', 'geodaten', 'punktdaten', 'geoportal', 'bus', 'buslinien', 'tram', 'vektordaten', 'vbz', 'offentlicher-verkehr', 'postauto', 'stzh', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-03T03:18:02.205242`
