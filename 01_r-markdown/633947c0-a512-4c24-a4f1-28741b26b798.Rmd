...
- **Keywords.de** `['geodaten', 'geoportal', 'fundburo', 'offentlicher-verkehr', 'vbz', 'vbg', 'tram', 'stzh', 'punktdaten', 'postauto', 'bus', 'vektordaten', 'strassenbahn', 'buslinien', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-02T04:15:41.931531`
