...
- **Keywords.de** `['vektordaten', 'tram', 'postauto', 'fundburo', 'strassenbahn', 'vbg', 'geoportal', 'punktdaten', 'vbz', 'geodaten', 'buslinien', 'tramlinien', 'bus', 'stzh', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-08T03:41:43.203466`
