...
- **Keywords.de** `['vektordaten', 'geoportal', 'strassenbahn', 'tramlinien', 'postauto', 'vbz', 'tram', 'bus', 'geodaten', 'vbg', 'fundburo', 'punktdaten', 'offentlicher-verkehr', 'stzh', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-27T03:26:11.839739`
