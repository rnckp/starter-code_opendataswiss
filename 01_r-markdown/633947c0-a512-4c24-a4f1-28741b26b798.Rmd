...
- **Keywords.de** `['geodaten', 'tram', 'bus', 'tramlinien', 'fundburo', 'strassenbahn', 'vektordaten', 'vbz', 'postauto', 'buslinien', 'offentlicher-verkehr', 'geoportal', 'vbg', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-01T03:18:45.073104`
