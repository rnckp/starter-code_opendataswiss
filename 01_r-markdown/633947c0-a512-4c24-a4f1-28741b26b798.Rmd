...
- **Keywords.de** `['vbg', 'postauto', 'tramlinien', 'geoportal', 'buslinien', 'fundburo', 'punktdaten', 'tram', 'stzh', 'strassenbahn', 'vbz', 'bus', 'geodaten', 'offentlicher-verkehr', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-08T02:31:38.957410`
