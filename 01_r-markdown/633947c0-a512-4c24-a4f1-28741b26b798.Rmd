...
- **Keywords.de** `['geoportal', 'vbz', 'punktdaten', 'offentlicher-verkehr', 'bus', 'postauto', 'buslinien', 'vbg', 'geodaten', 'vektordaten', 'strassenbahn', 'fundburo', 'tramlinien', 'stzh', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-18T03:08:09.523021`
