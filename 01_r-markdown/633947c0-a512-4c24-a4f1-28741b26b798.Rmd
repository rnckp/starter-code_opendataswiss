...
- **Keywords.de** `['tramlinien', 'offentlicher-verkehr', 'vbz', 'geoportal', 'postauto', 'fundburo', 'vbg', 'vektordaten', 'punktdaten', 'buslinien', 'bus', 'strassenbahn', 'geodaten', 'stzh', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-04T03:11:12.406889`
