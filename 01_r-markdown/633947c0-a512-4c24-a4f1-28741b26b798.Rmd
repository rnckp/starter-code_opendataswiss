...
- **Keywords.de** `['tramlinien', 'fundburo', 'geoportal', 'offentlicher-verkehr', 'strassenbahn', 'geodaten', 'vektordaten', 'tram', 'buslinien', 'stzh', 'vbz', 'punktdaten', 'vbg', 'bus', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-19T04:17:10.289564`
