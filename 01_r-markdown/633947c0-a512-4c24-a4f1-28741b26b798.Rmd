...
- **Keywords.de** `['bus', 'vektordaten', 'postauto', 'geoportal', 'stzh', 'vbg', 'buslinien', 'vbz', 'punktdaten', 'geodaten', 'fundburo', 'tramlinien', 'offentlicher-verkehr', 'strassenbahn', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-19T03:12:00.719319`
