...
- **Keywords.de** `['punktdaten', 'bus', 'geodaten', 'vbz', 'strassenbahn', 'geoportal', 'stzh', 'vbg', 'offentlicher-verkehr', 'tramlinien', 'postauto', 'fundburo', 'vektordaten', 'tram', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-11T03:11:04.893046`
