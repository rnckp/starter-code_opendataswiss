...
- **Keywords.de** `['geodaten', 'vektordaten', 'vbz', 'strassenbahn', 'vbg', 'fundburo', 'bus', 'offentlicher-verkehr', 'punktdaten', 'stzh', 'buslinien', 'postauto', 'tram', 'tramlinien', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-22T03:36:14.798840`
