...
- **Keywords.de** `['tramlinien', 'strassenbahn', 'bus', 'geoportal', 'stzh', 'vektordaten', 'vbg', 'offentlicher-verkehr', 'buslinien', 'postauto', 'tram', 'fundburo', 'punktdaten', 'vbz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-25T03:37:18.801535`
