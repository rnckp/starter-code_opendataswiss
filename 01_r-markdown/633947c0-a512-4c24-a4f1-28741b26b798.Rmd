...
- **Keywords.de** `['bus', 'buslinien', 'vbz', 'stzh', 'vektordaten', 'offentlicher-verkehr', 'geoportal', 'postauto', 'tramlinien', 'tram', 'fundburo', 'geodaten', 'vbg', 'strassenbahn', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-26T03:31:22.129469`
