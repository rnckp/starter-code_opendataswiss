...
- **Keywords.de** `['postauto', 'strassenbahn', 'vbg', 'tramlinien', 'tram', 'buslinien', 'fundburo', 'geoportal', 'offentlicher-verkehr', 'vbz', 'stzh', 'bus', 'vektordaten', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-25T03:40:17.705305`
