...
- **Keywords.de** `['fundburo', 'vbz', 'tram', 'punktdaten', 'stzh', 'postauto', 'offentlicher-verkehr', 'tramlinien', 'bus', 'strassenbahn', 'geoportal', 'buslinien', 'geodaten', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-09T03:21:33.078431`
