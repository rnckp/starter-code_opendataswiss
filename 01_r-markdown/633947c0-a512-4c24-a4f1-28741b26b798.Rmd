...
- **Keywords.de** `['fundburo', 'offentlicher-verkehr', 'postauto', 'punktdaten', 'geoportal', 'tram', 'vektordaten', 'tramlinien', 'geodaten', 'buslinien', 'strassenbahn', 'vbz', 'bus', 'vbg', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-26T03:25:01.658518`
