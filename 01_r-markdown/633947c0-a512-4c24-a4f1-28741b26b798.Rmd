...
- **Keywords.de** `['punktdaten', 'bus', 'fundburo', 'strassenbahn', 'vektordaten', 'vbg', 'vbz', 'tramlinien', 'offentlicher-verkehr', 'geodaten', 'postauto', 'tram', 'buslinien', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-24T02:59:05.870723`
