...
- **Keywords.de** `['bus', 'tram', 'buslinien', 'tramlinien', 'geodaten', 'vbz', 'postauto', 'stzh', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr', 'punktdaten', 'geoportal', 'fundburo', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-13T03:23:17.019605`
