...
- **Keywords.de** `['postauto', 'stzh', 'strassenbahn', 'vektordaten', 'punktdaten', 'bus', 'buslinien', 'offentlicher-verkehr', 'geoportal', 'geodaten', 'vbz', 'fundburo', 'tramlinien', 'tram', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-27T03:07:30.165749`
