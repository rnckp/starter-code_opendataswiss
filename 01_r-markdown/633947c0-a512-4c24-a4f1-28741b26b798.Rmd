...
- **Keywords.de** `['buslinien', 'geodaten', 'tramlinien', 'fundburo', 'offentlicher-verkehr', 'stzh', 'vbg', 'punktdaten', 'tram', 'geoportal', 'strassenbahn', 'postauto', 'vektordaten', 'bus', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-24T03:26:52.668684`
