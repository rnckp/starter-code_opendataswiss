...
- **Keywords.de** `['vektordaten', 'punktdaten', 'vbg', 'stzh', 'geodaten', 'vbz', 'tram', 'bus', 'fundburo', 'postauto', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien', 'geoportal', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-07T03:38:12.682550`
