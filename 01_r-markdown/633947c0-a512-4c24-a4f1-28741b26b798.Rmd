...
- **Keywords.de** `['bus', 'geodaten', 'buslinien', 'postauto', 'stzh', 'tram', 'geoportal', 'vbg', 'fundburo', 'vektordaten', 'punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-28T03:29:30.156179`
