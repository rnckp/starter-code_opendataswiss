...
- **Keywords.de** `['geoportal', 'fundburo', 'offentlicher-verkehr', 'tramlinien', 'buslinien', 'strassenbahn', 'vbg', 'tram', 'vbz', 'punktdaten', 'stzh', 'bus', 'postauto', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-08T03:10:47.321544`
