...
- **Keywords.de** `['punktdaten', 'offentlicher-verkehr', 'tramlinien', 'tram', 'vbg', 'stzh', 'strassenbahn', 'vbz', 'fundburo', 'geodaten', 'geoportal', 'buslinien', 'postauto', 'bus', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-23T03:02:44.796260`
