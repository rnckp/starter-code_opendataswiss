...
- **Keywords.de** `['bus', 'geodaten', 'stzh', 'vektordaten', 'tramlinien', 'buslinien', 'vbz', 'punktdaten', 'vbg', 'postauto', 'strassenbahn', 'tram', 'fundburo', 'geoportal', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-03T03:11:44.811904`
