...
- **Keywords.de** `['postauto', 'punktdaten', 'geoportal', 'fundburo', 'stzh', 'buslinien', 'tram', 'bus', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr', 'geodaten', 'tramlinien', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-21T03:21:39.728396`
