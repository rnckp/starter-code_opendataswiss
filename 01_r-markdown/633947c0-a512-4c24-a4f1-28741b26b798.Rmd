...
- **Keywords.de** `['vektordaten', 'vbg', 'stzh', 'offentlicher-verkehr', 'punktdaten', 'buslinien', 'postauto', 'geodaten', 'bus', 'strassenbahn', 'tramlinien', 'vbz', 'fundburo', 'tram', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-23T03:16:30.221570`
