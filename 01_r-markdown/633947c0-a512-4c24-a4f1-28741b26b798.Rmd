...
- **Keywords.de** `['vbg', 'postauto', 'tram', 'tramlinien', 'buslinien', 'geoportal', 'geodaten', 'punktdaten', 'strassenbahn', 'vbz', 'vektordaten', 'fundburo', 'bus', 'stzh', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-24T03:41:53.420934`
