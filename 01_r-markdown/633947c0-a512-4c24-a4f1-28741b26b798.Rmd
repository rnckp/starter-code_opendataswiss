...
- **Keywords.de** `['fundburo', 'vbg', 'vektordaten', 'geodaten', 'geoportal', 'punktdaten', 'buslinien', 'tramlinien', 'bus', 'offentlicher-verkehr', 'strassenbahn', 'postauto', 'vbz', 'tram', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-18T03:27:03.577656`
