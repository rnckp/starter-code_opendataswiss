...
- **Keywords.de** `['vektordaten', 'tram', 'vbg', 'stzh', 'tramlinien', 'geodaten', 'buslinien', 'postauto', 'geoportal', 'bus', 'punktdaten', 'vbz', 'offentlicher-verkehr', 'strassenbahn', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-04T04:03:41.648241`
