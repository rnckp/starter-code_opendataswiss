...
- **Keywords.de** `['postauto', 'punktdaten', 'tram', 'tramlinien', 'strassenbahn', 'geoportal', 'buslinien', 'vbg', 'bus', 'stzh', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'geodaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-09T02:26:22.087991`
