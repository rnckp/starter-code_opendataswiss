...
- **Keywords.de** `['tramlinien', 'geoportal', 'tram', 'bus', 'postauto', 'strassenbahn', 'fundburo', 'vbz', 'geodaten', 'punktdaten', 'vektordaten', 'buslinien', 'vbg', 'stzh', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-26T02:56:47.960513`
