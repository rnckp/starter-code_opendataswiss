...
- **Keywords.de** `['tram', 'vektordaten', 'geodaten', 'vbg', 'fundburo', 'postauto', 'geoportal', 'tramlinien', 'buslinien', 'punktdaten', 'bus', 'stzh', 'offentlicher-verkehr', 'vbz', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-07T02:59:52.057583`
