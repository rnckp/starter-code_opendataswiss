...
- **Keywords.de** `['tram', 'geoportal', 'geodaten', 'vbg', 'strassenbahn', 'punktdaten', 'tramlinien', 'buslinien', 'vbz', 'stzh', 'postauto', 'bus', 'vektordaten', 'fundburo', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-06T05:50:18.455731`
