...
- **Keywords.de** `['strassenbahn', 'tramlinien', 'geodaten', 'stzh', 'bus', 'vbz', 'postauto', 'vbg', 'fundburo', 'tram', 'vektordaten', 'punktdaten', 'geoportal', 'offentlicher-verkehr', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-06T03:05:09.560327`
