...
- **Keywords.de** `['buslinien', 'punktdaten', 'geodaten', 'vbz', 'stzh', 'vbg', 'strassenbahn', 'geoportal', 'tram', 'postauto', 'tramlinien', 'bus', 'offentlicher-verkehr', 'vektordaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-19T03:18:07.527719`
