...
- **Keywords.de** `['geodaten', 'tramlinien', 'offentlicher-verkehr', 'bus', 'vektordaten', 'vbz', 'strassenbahn', 'vbg', 'stzh', 'postauto', 'geoportal', 'fundburo', 'tram', 'punktdaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-19T03:27:07.671979`
