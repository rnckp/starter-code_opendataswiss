...
- **Keywords.de** `['bus', 'strassenbahn', 'vbg', 'tram', 'geoportal', 'postauto', 'vbz', 'fundburo', 'offentlicher-verkehr', 'tramlinien', 'vektordaten', 'punktdaten', 'stzh', 'geodaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-04T03:18:58.936313`
