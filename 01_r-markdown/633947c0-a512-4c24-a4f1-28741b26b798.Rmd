...
- **Keywords.de** `['postauto', 'vbz', 'vbg', 'tramlinien', 'offentlicher-verkehr', 'bus', 'strassenbahn', 'tram', 'geoportal', 'fundburo', 'buslinien', 'stzh', 'vektordaten', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-14T03:08:59.092031`
