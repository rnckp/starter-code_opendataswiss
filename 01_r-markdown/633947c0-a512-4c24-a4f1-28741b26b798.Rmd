...
- **Keywords.de** `['offentlicher-verkehr', 'fundburo', 'geoportal', 'postauto', 'vbz', 'stzh', 'vbg', 'bus', 'geodaten', 'tram', 'punktdaten', 'buslinien', 'tramlinien', 'vektordaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-24T03:30:06.586782`
