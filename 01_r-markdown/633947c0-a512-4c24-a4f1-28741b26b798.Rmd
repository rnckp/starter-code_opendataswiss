...
- **Keywords.de** `['offentlicher-verkehr', 'strassenbahn', 'buslinien', 'stzh', 'geodaten', 'bus', 'geoportal', 'fundburo', 'tramlinien', 'postauto', 'tram', 'vbg', 'vbz', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-04T03:53:29.263476`
