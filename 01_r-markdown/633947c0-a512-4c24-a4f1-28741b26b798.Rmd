...
- **Keywords.de** `['tram', 'geoportal', 'fundburo', 'vektordaten', 'buslinien', 'vbz', 'tramlinien', 'stzh', 'strassenbahn', 'geodaten', 'punktdaten', 'offentlicher-verkehr', 'postauto', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-22T03:17:33.562639`
