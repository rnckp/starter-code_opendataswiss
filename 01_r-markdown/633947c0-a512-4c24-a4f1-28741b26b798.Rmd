...
- **Keywords.de** `['fundburo', 'geoportal', 'vbg', 'bus', 'strassenbahn', 'punktdaten', 'buslinien', 'vektordaten', 'offentlicher-verkehr', 'tram', 'vbz', 'geodaten', 'stzh', 'tramlinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-02T03:15:46.314054`
