...
- **Keywords.de** `['strassenbahn', 'tram', 'fundburo', 'geodaten', 'vektordaten', 'vbz', 'postauto', 'bus', 'stzh', 'offentlicher-verkehr', 'tramlinien', 'buslinien', 'vbg', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-15T02:53:01.473792`
