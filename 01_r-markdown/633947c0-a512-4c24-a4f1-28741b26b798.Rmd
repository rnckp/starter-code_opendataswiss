...
- **Keywords.de** `['strassenbahn', 'bus', 'geodaten', 'geoportal', 'tram', 'postauto', 'offentlicher-verkehr', 'vbz', 'tramlinien', 'stzh', 'vbg', 'fundburo', 'vektordaten', 'punktdaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-28T02:50:31.542558`
