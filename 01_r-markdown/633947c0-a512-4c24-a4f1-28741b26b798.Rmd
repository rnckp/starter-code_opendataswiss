...
- **Keywords.de** `['vbg', 'geodaten', 'bus', 'fundburo', 'tramlinien', 'punktdaten', 'strassenbahn', 'buslinien', 'geoportal', 'vektordaten', 'stzh', 'offentlicher-verkehr', 'vbz', 'tram', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-04T04:17:27.587224`
