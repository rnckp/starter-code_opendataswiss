...
- **Keywords.de** `['strassenbahn', 'vbz', 'geoportal', 'vbg', 'stzh', 'tram', 'geodaten', 'fundburo', 'punktdaten', 'offentlicher-verkehr', 'vektordaten', 'bus', 'buslinien', 'postauto', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-08T03:25:35.219844`
