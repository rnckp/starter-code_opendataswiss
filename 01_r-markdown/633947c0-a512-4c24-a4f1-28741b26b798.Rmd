...
- **Keywords.de** `['vbz', 'stzh', 'bus', 'geodaten', 'vbg', 'buslinien', 'postauto', 'offentlicher-verkehr', 'geoportal', 'tram', 'punktdaten', 'vektordaten', 'tramlinien', 'strassenbahn', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-27T02:55:09.440821`
