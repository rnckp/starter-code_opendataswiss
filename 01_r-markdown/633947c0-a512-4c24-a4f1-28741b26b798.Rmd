...
- **Keywords.de** `['vbz', 'tramlinien', 'geodaten', 'postauto', 'geoportal', 'bus', 'buslinien', 'tram', 'fundburo', 'offentlicher-verkehr', 'stzh', 'vbg', 'punktdaten', 'vektordaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-16T03:18:03.795290`
