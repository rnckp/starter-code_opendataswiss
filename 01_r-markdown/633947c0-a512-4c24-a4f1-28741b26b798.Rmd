...
- **Keywords.de** `['buslinien', 'geoportal', 'tram', 'punktdaten', 'bus', 'fundburo', 'postauto', 'tramlinien', 'vbg', 'strassenbahn', 'vbz', 'offentlicher-verkehr', 'stzh', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-07T03:19:23.834259`
