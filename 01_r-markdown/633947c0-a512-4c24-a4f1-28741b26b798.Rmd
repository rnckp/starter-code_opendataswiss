...
- **Keywords.de** `['vbz', 'geodaten', 'fundburo', 'stzh', 'strassenbahn', 'geoportal', 'vektordaten', 'offentlicher-verkehr', 'tram', 'bus', 'tramlinien', 'postauto', 'buslinien', 'punktdaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-09T04:19:37.764870`
