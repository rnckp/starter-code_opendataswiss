...
- **Keywords.de** `['postauto', 'geodaten', 'punktdaten', 'geoportal', 'bus', 'offentlicher-verkehr', 'tram', 'buslinien', 'vbg', 'fundburo', 'vbz', 'vektordaten', 'stzh', 'tramlinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-19T03:30:20.034862`
