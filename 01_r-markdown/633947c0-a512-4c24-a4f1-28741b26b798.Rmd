...
- **Keywords.de** `['vbz', 'geodaten', 'tramlinien', 'punktdaten', 'bus', 'buslinien', 'vbg', 'stzh', 'fundburo', 'tram', 'geoportal', 'postauto', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-22T02:56:41.651313`
