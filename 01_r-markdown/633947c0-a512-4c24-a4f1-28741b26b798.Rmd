...
- **Keywords.de** `['fundburo', 'geoportal', 'vbg', 'tramlinien', 'bus', 'stzh', 'offentlicher-verkehr', 'vbz', 'postauto', 'geodaten', 'tram', 'strassenbahn', 'punktdaten', 'buslinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-07T03:14:25.983820`
