...
- **Keywords.de** `['postauto', 'vektordaten', 'strassenbahn', 'punktdaten', 'vbg', 'buslinien', 'tram', 'geoportal', 'bus', 'offentlicher-verkehr', 'stzh', 'vbz', 'tramlinien', 'fundburo', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-08T02:52:55.117817`
