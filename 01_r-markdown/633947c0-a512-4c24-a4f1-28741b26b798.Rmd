...
- **Keywords.de** `['geodaten', 'strassenbahn', 'stzh', 'punktdaten', 'vektordaten', 'offentlicher-verkehr', 'postauto', 'bus', 'tram', 'buslinien', 'tramlinien', 'vbg', 'geoportal', 'vbz', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-01T03:21:11.083292`
