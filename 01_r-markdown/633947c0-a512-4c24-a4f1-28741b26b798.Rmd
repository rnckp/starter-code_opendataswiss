...
- **Keywords.de** `['strassenbahn', 'fundburo', 'vbz', 'postauto', 'tramlinien', 'bus', 'vbg', 'buslinien', 'offentlicher-verkehr', 'punktdaten', 'geoportal', 'stzh', 'tram', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-11T03:19:48.656311`
