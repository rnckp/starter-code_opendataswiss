...
- **Keywords.de** `['tramlinien', 'punktdaten', 'fundburo', 'vbz', 'postauto', 'bus', 'offentlicher-verkehr', 'stzh', 'vbg', 'buslinien', 'vektordaten', 'strassenbahn', 'geodaten', 'geoportal', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-29T02:53:43.465841`
