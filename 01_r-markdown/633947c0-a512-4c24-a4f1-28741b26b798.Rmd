...
- **Keywords.de** `['strassenbahn', 'tramlinien', 'vbg', 'geoportal', 'vbz', 'punktdaten', 'stzh', 'offentlicher-verkehr', 'postauto', 'bus', 'tram', 'buslinien', 'geodaten', 'vektordaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-11T03:37:45.536777`
