...
- **Keywords.de** `['stzh', 'tram', 'fundburo', 'buslinien', 'vektordaten', 'tramlinien', 'offentlicher-verkehr', 'geodaten', 'geoportal', 'strassenbahn', 'postauto', 'vbz', 'bus', 'vbg', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-27T03:01:38.762180`
