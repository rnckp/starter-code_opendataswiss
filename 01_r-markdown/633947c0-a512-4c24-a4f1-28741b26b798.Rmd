...
- **Keywords.de** `['punktdaten', 'postauto', 'vektordaten', 'vbz', 'fundburo', 'stzh', 'buslinien', 'offentlicher-verkehr', 'geoportal', 'strassenbahn', 'geodaten', 'tramlinien', 'bus', 'tram', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-15T02:54:39.678855`
