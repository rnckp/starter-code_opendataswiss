...
- **Keywords.de** `['vbz', 'buslinien', 'tramlinien', 'vbg', 'vektordaten', 'tram', 'bus', 'strassenbahn', 'fundburo', 'geoportal', 'punktdaten', 'stzh', 'postauto', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-20T02:14:27.233853`
