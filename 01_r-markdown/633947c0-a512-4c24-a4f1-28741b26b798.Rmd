...
- **Keywords.de** `['geoportal', 'strassenbahn', 'geodaten', 'vbz', 'buslinien', 'bus', 'vbg', 'postauto', 'tram', 'stzh', 'fundburo', 'offentlicher-verkehr', 'punktdaten', 'tramlinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-24T03:54:52.512311`
