...
- **Keywords.de** `['offentlicher-verkehr', 'buslinien', 'tram', 'geodaten', 'stzh', 'postauto', 'tramlinien', 'bus', 'geoportal', 'vbz', 'fundburo', 'vbg', 'strassenbahn', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-02T02:51:53.159614`
