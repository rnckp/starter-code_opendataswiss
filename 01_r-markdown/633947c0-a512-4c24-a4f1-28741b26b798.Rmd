...
- **Keywords.de** `['vbz', 'strassenbahn', 'tram', 'offentlicher-verkehr', 'fundburo', 'buslinien', 'bus', 'stzh', 'postauto', 'vbg', 'vektordaten', 'geoportal', 'tramlinien', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-05T04:16:01.092760`
