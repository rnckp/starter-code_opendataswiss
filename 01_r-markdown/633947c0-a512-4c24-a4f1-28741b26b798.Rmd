...
- **Keywords.de** `['buslinien', 'tramlinien', 'geodaten', 'punktdaten', 'postauto', 'geoportal', 'tram', 'stzh', 'offentlicher-verkehr', 'vektordaten', 'bus', 'vbg', 'fundburo', 'strassenbahn', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-05T02:29:43.418183`
