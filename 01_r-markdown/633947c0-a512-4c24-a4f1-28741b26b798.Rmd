...
- **Keywords.de** `['vbg', 'strassenbahn', 'stzh', 'tram', 'buslinien', 'offentlicher-verkehr', 'vektordaten', 'tramlinien', 'geoportal', 'geodaten', 'vbz', 'bus', 'fundburo', 'postauto', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-24T03:37:45.986991`
