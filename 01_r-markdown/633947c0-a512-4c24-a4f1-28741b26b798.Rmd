...
- **Keywords.de** `['geodaten', 'fundburo', 'tram', 'punktdaten', 'vbg', 'strassenbahn', 'vbz', 'tramlinien', 'geoportal', 'bus', 'postauto', 'vektordaten', 'offentlicher-verkehr', 'stzh', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-16T03:03:15.185794`
