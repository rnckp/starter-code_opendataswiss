...
- **Keywords.de** `['punktdaten', 'fundburo', 'bus', 'buslinien', 'tram', 'vektordaten', 'geodaten', 'geoportal', 'vbg', 'strassenbahn', 'postauto', 'offentlicher-verkehr', 'stzh', 'vbz', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-17T02:57:37.964027`
