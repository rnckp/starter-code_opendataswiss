...
- **Keywords.de** `['punktdaten', 'fundburo', 'postauto', 'strassenbahn', 'vektordaten', 'bus', 'vbz', 'geoportal', 'stzh', 'offentlicher-verkehr', 'tram', 'buslinien', 'tramlinien', 'vbg', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-29T04:06:50.340113`
