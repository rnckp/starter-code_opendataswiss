...
- **Keywords.de** `['postauto', 'vbg', 'stzh', 'geoportal', 'strassenbahn', 'vbz', 'vektordaten', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'tram', 'tramlinien', 'fundburo', 'buslinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-21T02:42:40.816079`
