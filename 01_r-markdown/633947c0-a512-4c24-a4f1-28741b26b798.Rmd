...
- **Keywords.de** `['geoportal', 'stzh', 'punktdaten', 'tram', 'geodaten', 'vektordaten', 'bus', 'buslinien', 'vbz', 'strassenbahn', 'tramlinien', 'fundburo', 'vbg', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-28T02:54:34.451068`
