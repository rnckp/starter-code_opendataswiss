...
- **Keywords.de** `['bus', 'postauto', 'stzh', 'vbz', 'geoportal', 'fundburo', 'vbg', 'strassenbahn', 'buslinien', 'offentlicher-verkehr', 'tramlinien', 'tram', 'punktdaten', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-12T05:21:24.645674`
