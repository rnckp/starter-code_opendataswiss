...
- **Keywords.de** `['stzh', 'bus', 'fundburo', 'postauto', 'vektordaten', 'offentlicher-verkehr', 'tram', 'tramlinien', 'geodaten', 'punktdaten', 'strassenbahn', 'geoportal', 'vbz', 'vbg', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-22T03:31:05.629616`
