...
- **Keywords.de** `['bus', 'punktdaten', 'vbg', 'tram', 'geoportal', 'stzh', 'tramlinien', 'fundburo', 'vektordaten', 'strassenbahn', 'offentlicher-verkehr', 'buslinien', 'geodaten', 'postauto', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-13T03:59:29.313172`
