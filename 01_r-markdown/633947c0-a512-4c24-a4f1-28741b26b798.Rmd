...
- **Keywords.de** `['punktdaten', 'tramlinien', 'tram', 'vbg', 'bus', 'fundburo', 'vbz', 'buslinien', 'strassenbahn', 'geodaten', 'offentlicher-verkehr', 'stzh', 'geoportal', 'postauto', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-26T03:07:13.190220`
