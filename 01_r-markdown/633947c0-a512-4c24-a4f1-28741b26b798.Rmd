...
- **Keywords.de** `['geoportal', 'tramlinien', 'punktdaten', 'vbz', 'fundburo', 'geodaten', 'vektordaten', 'vbg', 'offentlicher-verkehr', 'postauto', 'buslinien', 'stzh', 'bus', 'strassenbahn', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-02T02:21:00.462834`
