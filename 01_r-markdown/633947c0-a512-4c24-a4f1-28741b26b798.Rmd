...
- **Keywords.de** `['offentlicher-verkehr', 'buslinien', 'vektordaten', 'vbz', 'stzh', 'bus', 'fundburo', 'tramlinien', 'tram', 'geoportal', 'strassenbahn', 'postauto', 'vbg', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-20T02:48:39.350918`
