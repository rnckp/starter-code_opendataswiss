...
- **Keywords.de** `['vbz', 'geodaten', 'tram', 'fundburo', 'punktdaten', 'vbg', 'postauto', 'buslinien', 'offentlicher-verkehr', 'geoportal', 'strassenbahn', 'bus', 'tramlinien', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-17T02:42:44.485320`
