...
- **Keywords.de** `['tramlinien', 'punktdaten', 'stzh', 'vbg', 'fundburo', 'bus', 'postauto', 'geoportal', 'vbz', 'offentlicher-verkehr', 'strassenbahn', 'tram', 'buslinien', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-12T03:28:19.680940`
