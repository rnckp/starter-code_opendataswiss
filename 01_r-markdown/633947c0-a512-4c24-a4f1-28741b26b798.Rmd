...
- **Keywords.de** `['geodaten', 'bus', 'buslinien', 'stzh', 'fundburo', 'strassenbahn', 'punktdaten', 'tram', 'vbz', 'vbg', 'geoportal', 'tramlinien', 'offentlicher-verkehr', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-07T03:19:17.896294`
