...
- **Keywords.de** `['buslinien', 'geodaten', 'punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'fundburo', 'postauto', 'stzh', 'vektordaten', 'tram', 'tramlinien', 'geoportal', 'vbz', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-06T03:51:13.757021`
