...
- **Keywords.de** `['buslinien', 'strassenbahn', 'postauto', 'vektordaten', 'geoportal', 'bus', 'vbg', 'offentlicher-verkehr', 'stzh', 'tram', 'punktdaten', 'fundburo', 'tramlinien', 'geodaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-28T03:52:16.236582`
