...
- **Keywords.de** `['punktdaten', 'vbz', 'fundburo', 'stzh', 'tram', 'buslinien', 'offentlicher-verkehr', 'bus', 'vbg', 'vektordaten', 'tramlinien', 'postauto', 'strassenbahn', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-16T02:56:20.908209`
