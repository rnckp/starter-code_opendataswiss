...
- **Keywords.de** `['stzh', 'tram', 'bus', 'vektordaten', 'offentlicher-verkehr', 'geoportal', 'geodaten', 'vbg', 'fundburo', 'strassenbahn', 'tramlinien', 'punktdaten', 'buslinien', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-16T02:52:45.488914`
