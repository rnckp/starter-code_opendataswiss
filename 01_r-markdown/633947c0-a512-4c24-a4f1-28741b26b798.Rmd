...
- **Keywords.de** `['vbg', 'strassenbahn', 'fundburo', 'stzh', 'bus', 'punktdaten', 'offentlicher-verkehr', 'postauto', 'tramlinien', 'tram', 'geoportal', 'buslinien', 'geodaten', 'vbz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-21T03:35:16.375575`
