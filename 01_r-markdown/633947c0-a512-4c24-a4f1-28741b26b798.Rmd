...
- **Keywords.de** `['geodaten', 'punktdaten', 'fundburo', 'vbz', 'stzh', 'strassenbahn', 'postauto', 'tram', 'vbg', 'buslinien', 'tramlinien', 'geoportal', 'offentlicher-verkehr', 'vektordaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-08T03:33:10.335079`
