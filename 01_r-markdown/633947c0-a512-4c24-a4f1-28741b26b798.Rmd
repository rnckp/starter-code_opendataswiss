...
- **Keywords.de** `['punktdaten', 'geodaten', 'tram', 'stzh', 'strassenbahn', 'vbz', 'vbg', 'buslinien', 'offentlicher-verkehr', 'vektordaten', 'fundburo', 'geoportal', 'bus', 'postauto', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-28T03:04:50.778140`
