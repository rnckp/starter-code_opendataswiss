...
- **Keywords.de** `['fundburo', 'postauto', 'geoportal', 'tramlinien', 'offentlicher-verkehr', 'vbg', 'bus', 'vbz', 'strassenbahn', 'punktdaten', 'tram', 'buslinien', 'geodaten', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-31T03:26:58.397068`
