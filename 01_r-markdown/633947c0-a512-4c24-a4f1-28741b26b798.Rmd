...
- **Keywords.de** `['stzh', 'geodaten', 'buslinien', 'tramlinien', 'tram', 'strassenbahn', 'vektordaten', 'geoportal', 'offentlicher-verkehr', 'punktdaten', 'vbg', 'vbz', 'bus', 'fundburo', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-10T03:32:19.147344`
