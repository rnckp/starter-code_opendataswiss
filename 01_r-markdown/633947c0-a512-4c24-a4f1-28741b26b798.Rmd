...
- **Keywords.de** `['punktdaten', 'stzh', 'postauto', 'offentlicher-verkehr', 'tramlinien', 'geodaten', 'vektordaten', 'buslinien', 'vbg', 'bus', 'strassenbahn', 'vbz', 'geoportal', 'tram', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-03T03:41:02.264014`
