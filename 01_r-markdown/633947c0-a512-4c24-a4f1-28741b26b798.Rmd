...
- **Keywords.de** `['tram', 'strassenbahn', 'postauto', 'tramlinien', 'fundburo', 'stzh', 'geodaten', 'geoportal', 'vektordaten', 'vbg', 'punktdaten', 'bus', 'offentlicher-verkehr', 'vbz', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-12T03:20:00.069239`
