...
- **Keywords.de** `['geodaten', 'buslinien', 'fundburo', 'vektordaten', 'strassenbahn', 'bus', 'geoportal', 'offentlicher-verkehr', 'stzh', 'vbg', 'tramlinien', 'punktdaten', 'vbz', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-23T02:38:33.738251`
