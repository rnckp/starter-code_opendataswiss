...
- **Keywords.de** `['buslinien', 'punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'geoportal', 'postauto', 'stzh', 'geodaten', 'tram', 'tramlinien', 'bus', 'fundburo', 'vbz', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-08T05:31:09.637610`
