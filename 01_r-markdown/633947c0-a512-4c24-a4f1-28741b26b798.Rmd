...
- **Keywords.de** `['vektordaten', 'offentlicher-verkehr', 'punktdaten', 'bus', 'vbg', 'postauto', 'geoportal', 'tram', 'geodaten', 'buslinien', 'tramlinien', 'vbz', 'stzh', 'strassenbahn', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-04T04:04:42.177665`
