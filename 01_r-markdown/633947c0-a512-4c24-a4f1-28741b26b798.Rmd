...
- **Keywords.de** `['fundburo', 'strassenbahn', 'tram', 'bus', 'offentlicher-verkehr', 'geoportal', 'vektordaten', 'postauto', 'vbz', 'vbg', 'punktdaten', 'geodaten', 'tramlinien', 'stzh', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-05T05:05:26.014017`
