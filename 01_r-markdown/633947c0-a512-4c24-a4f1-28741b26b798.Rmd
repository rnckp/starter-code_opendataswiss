...
- **Keywords.de** `['tramlinien', 'tram', 'offentlicher-verkehr', 'vektordaten', 'punktdaten', 'strassenbahn', 'fundburo', 'geoportal', 'stzh', 'buslinien', 'vbg', 'bus', 'postauto', 'geodaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-08T02:52:46.887391`
