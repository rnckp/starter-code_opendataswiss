...
- **Keywords.de** `['tram', 'tramlinien', 'buslinien', 'vbg', 'geodaten', 'geoportal', 'punktdaten', 'bus', 'postauto', 'strassenbahn', 'vektordaten', 'stzh', 'fundburo', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-10T03:29:51.894193`
