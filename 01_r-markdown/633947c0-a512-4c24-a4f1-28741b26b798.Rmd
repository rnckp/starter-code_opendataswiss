...
- **Keywords.de** `['vektordaten', 'postauto', 'buslinien', 'geoportal', 'strassenbahn', 'tram', 'stzh', 'fundburo', 'geodaten', 'offentlicher-verkehr', 'punktdaten', 'tramlinien', 'vbg', 'vbz', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-29T02:30:27.800289`
