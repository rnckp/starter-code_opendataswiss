...
- **Keywords.de** `['stzh', 'tram', 'bus', 'buslinien', 'punktdaten', 'vbg', 'postauto', 'geoportal', 'offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'vbz', 'geodaten', 'tramlinien', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-15T03:04:58.698194`
