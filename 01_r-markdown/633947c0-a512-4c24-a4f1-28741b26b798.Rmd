...
- **Keywords.de** `['fundburo', 'postauto', 'stzh', 'strassenbahn', 'geodaten', 'punktdaten', 'vektordaten', 'vbg', 'geoportal', 'tramlinien', 'bus', 'buslinien', 'vbz', 'tram', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-09T03:29:14.982027`
