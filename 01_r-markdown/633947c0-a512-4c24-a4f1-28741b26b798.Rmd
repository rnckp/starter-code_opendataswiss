...
- **Keywords.de** `['punktdaten', 'bus', 'offentlicher-verkehr', 'vbz', 'vbg', 'buslinien', 'strassenbahn', 'geodaten', 'vektordaten', 'tramlinien', 'tram', 'geoportal', 'postauto', 'fundburo', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-21T03:41:40.403054`
