...
- **Keywords.de** `['stzh', 'vbz', 'bus', 'postauto', 'fundburo', 'tram', 'vbg', 'geodaten', 'buslinien', 'punktdaten', 'tramlinien', 'strassenbahn', 'vektordaten', 'geoportal', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-26T02:57:57.194327`
