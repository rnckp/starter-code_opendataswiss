...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'geodaten', 'bus', 'punktdaten', 'vbg', 'tram', 'buslinien', 'fundburo', 'geoportal', 'offentlicher-verkehr', 'tramlinien', 'stzh', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-24T03:50:14.759347`
