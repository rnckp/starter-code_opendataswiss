...
- **Keywords.de** `['postauto', 'vbz', 'tram', 'geodaten', 'punktdaten', 'tramlinien', 'offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'geoportal', 'stzh', 'bus', 'fundburo', 'buslinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-03T03:11:43.794290`
