...
- **Keywords.de** `['vbz', 'vbg', 'fundburo', 'punktdaten', 'geoportal', 'stzh', 'geodaten', 'vektordaten', 'tramlinien', 'tram', 'postauto', 'bus', 'strassenbahn', 'offentlicher-verkehr', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-13T03:25:54.726467`
