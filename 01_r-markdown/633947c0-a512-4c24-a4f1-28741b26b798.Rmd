...
- **Keywords.de** `['stzh', 'postauto', 'tramlinien', 'offentlicher-verkehr', 'bus', 'geoportal', 'vektordaten', 'fundburo', 'punktdaten', 'tram', 'buslinien', 'geodaten', 'strassenbahn', 'vbz', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-30T03:23:43.963876`
