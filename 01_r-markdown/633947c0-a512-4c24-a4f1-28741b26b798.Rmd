...
- **Keywords.de** `['strassenbahn', 'geoportal', 'tram', 'punktdaten', 'bus', 'buslinien', 'fundburo', 'vbz', 'geodaten', 'offentlicher-verkehr', 'stzh', 'postauto', 'tramlinien', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-04T03:55:57.512278`
