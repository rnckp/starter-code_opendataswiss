...
- **Keywords.de** `['strassenbahn', 'geodaten', 'tram', 'vbg', 'buslinien', 'bus', 'fundburo', 'geoportal', 'tramlinien', 'punktdaten', 'vbz', 'stzh', 'offentlicher-verkehr', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-21T03:30:11.612591`
