...
- **Keywords.de** `['vektordaten', 'tram', 'postauto', 'geodaten', 'geoportal', 'vbg', 'fundburo', 'vbz', 'bus', 'stzh', 'offentlicher-verkehr', 'strassenbahn', 'punktdaten', 'tramlinien', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-06T03:22:13.614063`
