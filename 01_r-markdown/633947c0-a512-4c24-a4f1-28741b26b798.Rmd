...
- **Keywords.de** `['geodaten', 'strassenbahn', 'vbz', 'offentlicher-verkehr', 'vektordaten', 'buslinien', 'bus', 'fundburo', 'vbg', 'punktdaten', 'stzh', 'tramlinien', 'geoportal', 'tram', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-19T02:40:04.483118`
