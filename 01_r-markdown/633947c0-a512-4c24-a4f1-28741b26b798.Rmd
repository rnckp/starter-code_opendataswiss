...
- **Keywords.de** `['vbz', 'stzh', 'vektordaten', 'vbg', 'buslinien', 'bus', 'punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien', 'postauto', 'fundburo', 'tram', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-22T03:34:03.054223`
