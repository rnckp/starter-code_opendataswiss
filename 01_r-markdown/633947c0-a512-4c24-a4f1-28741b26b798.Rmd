...
- **Keywords.de** `['bus', 'offentlicher-verkehr', 'punktdaten', 'tram', 'strassenbahn', 'vektordaten', 'geodaten', 'vbg', 'buslinien', 'postauto', 'stzh', 'fundburo', 'geoportal', 'tramlinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-01T03:00:07.084738`
