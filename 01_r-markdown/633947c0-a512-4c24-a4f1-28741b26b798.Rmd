...
- **Keywords.de** `['geoportal', 'bus', 'geodaten', 'vbg', 'vektordaten', 'vbz', 'buslinien', 'postauto', 'offentlicher-verkehr', 'tramlinien', 'tram', 'fundburo', 'strassenbahn', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-30T03:31:45.710744`
