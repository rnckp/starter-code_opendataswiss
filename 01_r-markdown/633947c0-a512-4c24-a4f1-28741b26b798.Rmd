...
- **Keywords.de** `['postauto', 'offentlicher-verkehr', 'vektordaten', 'geodaten', 'fundburo', 'geoportal', 'vbz', 'tram', 'punktdaten', 'stzh', 'vbg', 'buslinien', 'strassenbahn', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-06T03:25:54.223616`
