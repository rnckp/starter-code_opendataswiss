...
- **Keywords.de** `['offentlicher-verkehr', 'tram', 'vbg', 'tramlinien', 'postauto', 'vbz', 'bus', 'geodaten', 'geoportal', 'strassenbahn', 'stzh', 'punktdaten', 'vektordaten', 'fundburo', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-31T03:19:37.297460`
