...
- **Keywords.de** `['offentlicher-verkehr', 'vbg', 'tramlinien', 'tram', 'vektordaten', 'punktdaten', 'vbz', 'stzh', 'geodaten', 'bus', 'strassenbahn', 'buslinien', 'fundburo', 'geoportal', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-05T03:32:59.408381`
