...
- **Keywords.de** `['bus', 'tramlinien', 'stzh', 'offentlicher-verkehr', 'vbz', 'strassenbahn', 'vbg', 'punktdaten', 'geodaten', 'geoportal', 'postauto', 'fundburo', 'buslinien', 'tram', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-17T03:15:59.096103`
