...
- **Keywords.de** `['stzh', 'geoportal', 'postauto', 'bus', 'vektordaten', 'punktdaten', 'tram', 'offentlicher-verkehr', 'strassenbahn', 'fundburo', 'tramlinien', 'vbz', 'geodaten', 'buslinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-24T04:02:05.199201`
