...
- **Keywords.de** `['punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'tramlinien', 'postauto', 'vbz', 'geoportal', 'fundburo', 'tram', 'stzh', 'bus', 'geodaten', 'buslinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-11T03:41:23.185410`
