...
- **Keywords.de** `['punktdaten', 'postauto', 'vbg', 'tram', 'tramlinien', 'strassenbahn', 'vbz', 'buslinien', 'stzh', 'offentlicher-verkehr', 'vektordaten', 'bus', 'fundburo', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-06T03:09:21.953999`
