...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'tramlinien', 'vektordaten', 'buslinien', 'tram', 'vbz', 'geodaten', 'bus', 'fundburo', 'geoportal', 'strassenbahn', 'postauto', 'punktdaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-18T04:05:16.136188`
