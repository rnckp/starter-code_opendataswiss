...
- **Keywords.de** `['stzh', 'offentlicher-verkehr', 'bus', 'tramlinien', 'fundburo', 'vbz', 'vektordaten', 'geoportal', 'vbg', 'geodaten', 'strassenbahn', 'postauto', 'buslinien', 'punktdaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-27T03:24:03.411187`
