...
- **Keywords.de** `['vektordaten', 'buslinien', 'tramlinien', 'bus', 'offentlicher-verkehr', 'vbz', 'fundburo', 'geoportal', 'stzh', 'tram', 'vbg', 'strassenbahn', 'postauto', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-30T02:58:58.965945`
