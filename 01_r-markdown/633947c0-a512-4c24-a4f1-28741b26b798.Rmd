...
- **Keywords.de** `['vbz', 'tramlinien', 'vektordaten', 'punktdaten', 'geoportal', 'buslinien', 'fundburo', 'postauto', 'tram', 'geodaten', 'stzh', 'offentlicher-verkehr', 'bus', 'vbg', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-21T02:30:51.205664`
