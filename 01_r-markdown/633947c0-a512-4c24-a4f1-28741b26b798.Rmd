...
- **Keywords.de** `['buslinien', 'postauto', 'tram', 'offentlicher-verkehr', 'bus', 'geodaten', 'punktdaten', 'geoportal', 'vektordaten', 'fundburo', 'tramlinien', 'stzh', 'strassenbahn', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-02T03:30:23.930060`
