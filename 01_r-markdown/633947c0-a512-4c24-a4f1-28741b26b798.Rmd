...
- **Keywords.de** `['geodaten', 'fundburo', 'vektordaten', 'postauto', 'tram', 'vbg', 'offentlicher-verkehr', 'bus', 'punktdaten', 'stzh', 'geoportal', 'strassenbahn', 'vbz', 'buslinien', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-11T05:25:19.041669`
