...
- **Keywords.de** `['strassenbahn', 'buslinien', 'fundburo', 'stzh', 'vektordaten', 'punktdaten', 'tramlinien', 'bus', 'vbg', 'postauto', 'geodaten', 'tram', 'vbz', 'geoportal', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-31T03:24:35.143796`
