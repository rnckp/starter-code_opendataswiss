...
- **Keywords.de** `['bus', 'vbg', 'strassenbahn', 'geodaten', 'tram', 'vektordaten', 'buslinien', 'punktdaten', 'stzh', 'offentlicher-verkehr', 'geoportal', 'fundburo', 'tramlinien', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-14T03:41:19.735157`
