...
- **Keywords.de** `['tramlinien', 'geoportal', 'strassenbahn', 'geodaten', 'tram', 'offentlicher-verkehr', 'vbg', 'stzh', 'vbz', 'buslinien', 'punktdaten', 'fundburo', 'bus', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-14T03:38:36.689601`
