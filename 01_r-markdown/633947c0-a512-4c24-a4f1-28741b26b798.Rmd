...
- **Keywords.de** `['tram', 'fundburo', 'buslinien', 'punktdaten', 'offentlicher-verkehr', 'vektordaten', 'bus', 'vbz', 'strassenbahn', 'vbg', 'geoportal', 'tramlinien', 'stzh', 'geodaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-24T03:38:58.119183`
