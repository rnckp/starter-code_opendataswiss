...
- **Keywords.de** `['offentlicher-verkehr', 'punktdaten', 'tramlinien', 'strassenbahn', 'postauto', 'geodaten', 'vektordaten', 'fundburo', 'vbg', 'stzh', 'tram', 'bus', 'vbz', 'buslinien', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-29T03:19:56.148738`
