...
- **Keywords.de** `['tram', 'fundburo', 'stzh', 'vektordaten', 'buslinien', 'geodaten', 'tramlinien', 'geoportal', 'strassenbahn', 'bus', 'postauto', 'vbg', 'vbz', 'punktdaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-10T03:34:51.464864`
