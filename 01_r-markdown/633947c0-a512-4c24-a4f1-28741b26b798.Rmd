...
- **Keywords.de** `['bus', 'geoportal', 'punktdaten', 'postauto', 'buslinien', 'fundburo', 'vektordaten', 'geodaten', 'vbg', 'stzh', 'offentlicher-verkehr', 'tramlinien', 'tram', 'vbz', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-28T04:03:43.544465`
