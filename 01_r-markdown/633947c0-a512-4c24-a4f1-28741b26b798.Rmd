...
- **Keywords.de** `['stzh', 'vektordaten', 'fundburo', 'offentlicher-verkehr', 'punktdaten', 'vbg', 'vbz', 'geoportal', 'strassenbahn', 'tramlinien', 'bus', 'postauto', 'buslinien', 'geodaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-16T03:25:26.846268`
