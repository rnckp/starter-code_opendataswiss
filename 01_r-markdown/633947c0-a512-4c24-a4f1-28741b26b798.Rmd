...
- **Keywords.de** `['tram', 'offentlicher-verkehr', 'geodaten', 'postauto', 'vektordaten', 'punktdaten', 'bus', 'vbz', 'tramlinien', 'vbg', 'strassenbahn', 'buslinien', 'geoportal', 'stzh', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-13T03:04:03.616754`
