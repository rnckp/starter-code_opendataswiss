...
- **Keywords.de** `['offentlicher-verkehr', 'postauto', 'vbz', 'geoportal', 'punktdaten', 'tram', 'bus', 'geodaten', 'tramlinien', 'vektordaten', 'strassenbahn', 'vbg', 'buslinien', 'stzh', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-02T03:04:20.048382`
