...
- **Keywords.de** `['geodaten', 'postauto', 'offentlicher-verkehr', 'stzh', 'fundburo', 'punktdaten', 'tram', 'buslinien', 'vbz', 'geoportal', 'tramlinien', 'vbg', 'vektordaten', 'bus', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-29T03:21:21.301220`
