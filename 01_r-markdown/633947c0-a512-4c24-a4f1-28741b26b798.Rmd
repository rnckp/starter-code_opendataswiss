...
- **Keywords.de** `['tram', 'bus', 'stzh', 'postauto', 'fundburo', 'offentlicher-verkehr', 'geodaten', 'vbg', 'punktdaten', 'strassenbahn', 'vbz', 'vektordaten', 'tramlinien', 'buslinien', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-30T03:18:28.677203`
