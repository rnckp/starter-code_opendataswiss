...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'fundburo', 'tram', 'buslinien', 'tramlinien', 'geodaten', 'strassenbahn', 'bus', 'punktdaten', 'vbz', 'geoportal', 'postauto', 'vektordaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-07T04:28:47.873117`
