...
- **Keywords.de** `['tramlinien', 'offentlicher-verkehr', 'fundburo', 'punktdaten', 'stzh', 'buslinien', 'strassenbahn', 'bus', 'vbg', 'tram', 'postauto', 'geoportal', 'geodaten', 'vbz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-15T03:42:06.312887`
