...
- **Keywords.de** `['postauto', 'vektordaten', 'vbz', 'geoportal', 'offentlicher-verkehr', 'tram', 'strassenbahn', 'tramlinien', 'bus', 'punktdaten', 'buslinien', 'fundburo', 'stzh', 'vbg', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-20T03:34:29.003248`
