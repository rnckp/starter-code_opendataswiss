...
- **Keywords.de** `['fundburo', 'geodaten', 'stzh', 'strassenbahn', 'vbz', 'vbg', 'offentlicher-verkehr', 'vektordaten', 'tram', 'buslinien', 'postauto', 'punktdaten', 'tramlinien', 'bus', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-18T03:04:07.216383`
