...
- **Keywords.de** `['tramlinien', 'postauto', 'stzh', 'vbg', 'fundburo', 'strassenbahn', 'punktdaten', 'vektordaten', 'geoportal', 'bus', 'tram', 'geodaten', 'offentlicher-verkehr', 'vbz', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-26T04:51:00.752459`
