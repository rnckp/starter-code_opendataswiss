...
- **Keywords.de** `['stzh', 'vbz', 'fundburo', 'vbg', 'strassenbahn', 'buslinien', 'vektordaten', 'geodaten', 'bus', 'tram', 'offentlicher-verkehr', 'punktdaten', 'geoportal', 'tramlinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-12T03:36:47.146448`
