...
- **Keywords.de** `['strassenbahn', 'bus', 'vbz', 'fundburo', 'vektordaten', 'offentlicher-verkehr', 'tram', 'tramlinien', 'vbg', 'punktdaten', 'stzh', 'geoportal', 'buslinien', 'geodaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-25T03:47:06.011599`
