...
- **Keywords.de** `['vektordaten', 'punktdaten', 'geoportal', 'offentlicher-verkehr', 'bus', 'fundburo', 'tram', 'buslinien', 'vbg', 'geodaten', 'postauto', 'vbz', 'strassenbahn', 'tramlinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-08T02:41:24.701779`
