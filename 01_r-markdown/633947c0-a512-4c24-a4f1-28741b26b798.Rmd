...
- **Keywords.de** `['strassenbahn', 'tram', 'buslinien', 'postauto', 'vektordaten', 'bus', 'geoportal', 'fundburo', 'stzh', 'vbg', 'tramlinien', 'offentlicher-verkehr', 'vbz', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-09T06:01:16.284823`
