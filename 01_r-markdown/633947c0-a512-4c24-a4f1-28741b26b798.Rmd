...
- **Keywords.de** `['vbg', 'stzh', 'tram', 'strassenbahn', 'offentlicher-verkehr', 'postauto', 'tramlinien', 'geoportal', 'geodaten', 'bus', 'vektordaten', 'vbz', 'punktdaten', 'buslinien', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-01T03:46:58.693620`
