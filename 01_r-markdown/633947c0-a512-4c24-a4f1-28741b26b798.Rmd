...
- **Keywords.de** `['postauto', 'vektordaten', 'vbz', 'buslinien', 'stzh', 'geoportal', 'punktdaten', 'offentlicher-verkehr', 'geodaten', 'tram', 'fundburo', 'tramlinien', 'bus', 'vbg', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-02T03:18:48.522625`
