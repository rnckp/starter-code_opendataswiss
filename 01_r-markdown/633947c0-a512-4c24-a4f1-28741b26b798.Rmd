...
- **Keywords.de** `['bus', 'vbz', 'tram', 'fundburo', 'buslinien', 'vbg', 'geoportal', 'geodaten', 'vektordaten', 'stzh', 'offentlicher-verkehr', 'punktdaten', 'tramlinien', 'postauto', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-26T03:33:04.768308`
