...
- **Keywords.de** `['postauto', 'punktdaten', 'bus', 'vbg', 'tramlinien', 'vektordaten', 'tram', 'stzh', 'geoportal', 'offentlicher-verkehr', 'fundburo', 'buslinien', 'vbz', 'geodaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-07T03:08:51.516103`
