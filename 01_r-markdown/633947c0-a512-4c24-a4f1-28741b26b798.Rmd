...
- **Keywords.de** `['strassenbahn', 'fundburo', 'buslinien', 'bus', 'vbg', 'geodaten', 'geoportal', 'tramlinien', 'tram', 'postauto', 'offentlicher-verkehr', 'vektordaten', 'vbz', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-05T03:22:28.455211`
