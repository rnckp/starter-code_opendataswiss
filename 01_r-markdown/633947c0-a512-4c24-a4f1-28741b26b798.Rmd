...
- **Keywords.de** `['buslinien', 'strassenbahn', 'geodaten', 'vbz', 'fundburo', 'tram', 'offentlicher-verkehr', 'vbg', 'vektordaten', 'tramlinien', 'postauto', 'geoportal', 'bus', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-19T03:15:18.335042`
