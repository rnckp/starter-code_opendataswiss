...
- **Keywords.de** `['strassenbahn', 'vbg', 'offentlicher-verkehr', 'geodaten', 'punktdaten', 'bus', 'vbz', 'geoportal', 'buslinien', 'stzh', 'fundburo', 'postauto', 'tram', 'tramlinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-14T03:12:27.515265`
