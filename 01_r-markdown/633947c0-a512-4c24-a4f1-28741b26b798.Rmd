...
- **Keywords.de** `['vbz', 'geoportal', 'offentlicher-verkehr', 'postauto', 'buslinien', 'fundburo', 'vektordaten', 'bus', 'vbg', 'tram', 'geodaten', 'stzh', 'punktdaten', 'tramlinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-17T01:57:02.710672`
