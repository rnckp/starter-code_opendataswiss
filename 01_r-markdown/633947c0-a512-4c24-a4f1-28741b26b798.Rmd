...
- **Keywords.de** `['tramlinien', 'vektordaten', 'stzh', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'bus', 'punktdaten', 'vbz', 'tram', 'fundburo', 'buslinien', 'postauto', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-08T03:19:57.747745`
