...
- **Keywords.de** `['postauto', 'tramlinien', 'buslinien', 'punktdaten', 'vektordaten', 'bus', 'tram', 'fundburo', 'geodaten', 'vbg', 'offentlicher-verkehr', 'vbz', 'stzh', 'strassenbahn', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-07T04:11:39.818540`
