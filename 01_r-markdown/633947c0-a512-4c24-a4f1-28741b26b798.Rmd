...
- **Keywords.de** `['vbz', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'tram', 'buslinien', 'bus', 'strassenbahn', 'geoportal', 'vektordaten', 'vbg', 'stzh', 'fundburo', 'tramlinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-18T03:23:30.426904`
