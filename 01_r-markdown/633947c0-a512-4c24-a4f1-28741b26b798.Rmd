...
- **Keywords.de** `['stzh', 'tram', 'vbg', 'vbz', 'fundburo', 'tramlinien', 'bus', 'punktdaten', 'buslinien', 'postauto', 'geoportal', 'geodaten', 'vektordaten', 'offentlicher-verkehr', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-17T03:21:28.214169`
