...
- **Keywords.de** `['punktdaten', 'stzh', 'vbg', 'strassenbahn', 'tramlinien', 'offentlicher-verkehr', 'geodaten', 'postauto', 'tram', 'geoportal', 'buslinien', 'vbz', 'fundburo', 'vektordaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-29T03:23:06.393677`
