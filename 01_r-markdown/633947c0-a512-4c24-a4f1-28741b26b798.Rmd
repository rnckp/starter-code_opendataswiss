...
- **Keywords.de** `['offentlicher-verkehr', 'tram', 'buslinien', 'vektordaten', 'bus', 'vbg', 'punktdaten', 'fundburo', 'strassenbahn', 'geoportal', 'stzh', 'tramlinien', 'postauto', 'vbz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-10T03:10:47.343908`
