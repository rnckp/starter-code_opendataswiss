...
- **Keywords.de** `['stzh', 'vbz', 'tramlinien', 'strassenbahn', 'fundburo', 'vbg', 'offentlicher-verkehr', 'bus', 'tram', 'postauto', 'geodaten', 'buslinien', 'geoportal', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-22T02:46:27.307362`
