...
- **Keywords.de** `['stzh', 'strassenbahn', 'tram', 'tramlinien', 'fundburo', 'vbz', 'buslinien', 'geodaten', 'postauto', 'geoportal', 'punktdaten', 'vbg', 'vektordaten', 'bus', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-10T02:53:29.153833`
