...
- **Keywords.de** `['geodaten', 'fundburo', 'postauto', 'buslinien', 'vbz', 'bus', 'vektordaten', 'offentlicher-verkehr', 'tram', 'punktdaten', 'geoportal', 'vbg', 'stzh', 'tramlinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-02T02:33:51.865259`
