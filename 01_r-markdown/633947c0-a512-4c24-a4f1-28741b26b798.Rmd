...
- **Keywords.de** `['buslinien', 'tram', 'vektordaten', 'stzh', 'punktdaten', 'fundburo', 'vbz', 'vbg', 'tramlinien', 'postauto', 'bus', 'offentlicher-verkehr', 'geoportal', 'strassenbahn', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-13T02:30:55.936938`
