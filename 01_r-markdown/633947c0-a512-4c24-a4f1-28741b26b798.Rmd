...
- **Keywords.de** `['fundburo', 'bus', 'tram', 'buslinien', 'offentlicher-verkehr', 'tramlinien', 'vektordaten', 'vbz', 'postauto', 'geoportal', 'vbg', 'stzh', 'punktdaten', 'geodaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-16T02:52:43.948455`
