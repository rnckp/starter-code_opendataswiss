...
- **Keywords.de** `['strassenbahn', 'punktdaten', 'vbg', 'vektordaten', 'tramlinien', 'offentlicher-verkehr', 'geoportal', 'buslinien', 'geodaten', 'fundburo', 'bus', 'postauto', 'tram', 'vbz', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-28T03:42:29.125205`
