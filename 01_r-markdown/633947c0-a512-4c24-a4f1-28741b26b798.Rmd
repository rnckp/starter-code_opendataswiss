...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'stzh', 'tramlinien', 'strassenbahn', 'bus', 'geoportal', 'buslinien', 'vbz', 'vbg', 'punktdaten', 'fundburo', 'geodaten', 'tram', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-26T05:24:17.355918`
