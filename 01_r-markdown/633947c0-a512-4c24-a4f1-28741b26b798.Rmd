...
- **Keywords.de** `['fundburo', 'strassenbahn', 'buslinien', 'tramlinien', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'geodaten', 'tram', 'postauto', 'bus', 'geoportal', 'vbg', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-26T03:14:03.974878`
