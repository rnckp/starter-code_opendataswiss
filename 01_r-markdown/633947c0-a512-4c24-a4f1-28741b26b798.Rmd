...
- **Keywords.de** `['vbz', 'geoportal', 'buslinien', 'vbg', 'stzh', 'tram', 'offentlicher-verkehr', 'vektordaten', 'postauto', 'bus', 'punktdaten', 'tramlinien', 'fundburo', 'strassenbahn', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-11T03:21:41.200011`
