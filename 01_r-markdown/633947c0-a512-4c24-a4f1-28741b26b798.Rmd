...
- **Keywords.de** `['tram', 'buslinien', 'vbg', 'geodaten', 'vbz', 'tramlinien', 'offentlicher-verkehr', 'postauto', 'geoportal', 'vektordaten', 'fundburo', 'strassenbahn', 'punktdaten', 'bus', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-04T03:16:59.224712`
