...
- **Keywords.de** `['fundburo', 'strassenbahn', 'buslinien', 'tramlinien', 'punktdaten', 'postauto', 'vbz', 'vbg', 'tram', 'geoportal', 'bus', 'vektordaten', 'geodaten', 'stzh', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-20T02:53:29.195344`
