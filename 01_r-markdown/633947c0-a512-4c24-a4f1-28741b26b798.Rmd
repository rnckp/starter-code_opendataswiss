...
- **Keywords.de** `['strassenbahn', 'geodaten', 'tramlinien', 'bus', 'vbg', 'stzh', 'buslinien', 'fundburo', 'geoportal', 'postauto', 'tram', 'vbz', 'offentlicher-verkehr', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-04T03:24:08.716142`
