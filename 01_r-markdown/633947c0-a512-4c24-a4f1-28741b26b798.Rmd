...
- **Keywords.de** `['tram', 'buslinien', 'vektordaten', 'fundburo', 'bus', 'geodaten', 'offentlicher-verkehr', 'vbg', 'stzh', 'tramlinien', 'geoportal', 'strassenbahn', 'postauto', 'vbz', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-22T02:56:57.018500`
