...
- **Keywords.de** `['strassenbahn', 'fundburo', 'geoportal', 'vektordaten', 'geodaten', 'tram', 'punktdaten', 'tramlinien', 'vbg', 'stzh', 'buslinien', 'bus', 'postauto', 'vbz', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-05T03:04:51.811989`
