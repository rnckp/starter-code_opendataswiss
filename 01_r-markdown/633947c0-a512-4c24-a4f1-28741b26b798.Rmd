...
- **Keywords.de** `['tramlinien', 'bus', 'vektordaten', 'geoportal', 'vbg', 'tram', 'postauto', 'offentlicher-verkehr', 'strassenbahn', 'vbz', 'fundburo', 'buslinien', 'punktdaten', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-12T02:45:40.793496`
