...
- **Keywords.de** `['fundburo', 'vektordaten', 'buslinien', 'vbg', 'tramlinien', 'vbz', 'geoportal', 'punktdaten', 'geodaten', 'stzh', 'bus', 'strassenbahn', 'postauto', 'tram', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-12T03:17:06.128705`
