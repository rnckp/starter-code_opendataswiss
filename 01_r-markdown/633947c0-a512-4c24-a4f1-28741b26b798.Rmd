...
- **Keywords.de** `['tramlinien', 'bus', 'stzh', 'punktdaten', 'offentlicher-verkehr', 'fundburo', 'geodaten', 'buslinien', 'strassenbahn', 'tram', 'vbg', 'vektordaten', 'geoportal', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-18T03:37:04.091643`
