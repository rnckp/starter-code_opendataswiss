...
- **Keywords.de** `['vbg', 'buslinien', 'punktdaten', 'offentlicher-verkehr', 'vbz', 'postauto', 'geodaten', 'bus', 'stzh', 'strassenbahn', 'tramlinien', 'tram', 'vektordaten', 'fundburo', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-06T02:49:38.811850`
