...
- **Keywords.de** `['bus', 'stzh', 'vbg', 'buslinien', 'geodaten', 'strassenbahn', 'punktdaten', 'tram', 'fundburo', 'vektordaten', 'vbz', 'tramlinien', 'geoportal', 'postauto', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-25T03:13:39.473457`
