...
- **Keywords.de** `['tramlinien', 'geodaten', 'bus', 'geoportal', 'tram', 'offentlicher-verkehr', 'buslinien', 'vektordaten', 'vbz', 'stzh', 'punktdaten', 'vbg', 'postauto', 'fundburo', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-27T03:06:47.214227`
