...
- **Keywords.de** `['strassenbahn', 'stzh', 'punktdaten', 'vbg', 'vbz', 'postauto', 'buslinien', 'geoportal', 'tram', 'vektordaten', 'geodaten', 'offentlicher-verkehr', 'tramlinien', 'fundburo', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-05T03:26:51.882958`
