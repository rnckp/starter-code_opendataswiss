...
- **Keywords.de** `['stzh', 'vektordaten', 'bus', 'strassenbahn', 'buslinien', 'fundburo', 'geoportal', 'offentlicher-verkehr', 'tramlinien', 'geodaten', 'punktdaten', 'tram', 'postauto', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-18T03:18:49.799377`
