...
- **Keywords.de** `['bus', 'vbz', 'buslinien', 'vbg', 'postauto', 'vektordaten', 'punktdaten', 'geodaten', 'stzh', 'tram', 'strassenbahn', 'fundburo', 'tramlinien', 'geoportal', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-31T03:41:57.922652`
