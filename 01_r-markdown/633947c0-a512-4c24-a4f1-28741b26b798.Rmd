...
- **Keywords.de** `['postauto', 'tramlinien', 'fundburo', 'vbz', 'punktdaten', 'strassenbahn', 'tram', 'offentlicher-verkehr', 'geoportal', 'vektordaten', 'geodaten', 'stzh', 'bus', 'buslinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-18T03:34:39.911380`
