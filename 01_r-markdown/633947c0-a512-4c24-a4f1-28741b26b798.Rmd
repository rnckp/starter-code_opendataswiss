...
- **Keywords.de** `['vektordaten', 'strassenbahn', 'fundburo', 'vbg', 'punktdaten', 'offentlicher-verkehr', 'tramlinien', 'stzh', 'bus', 'postauto', 'vbz', 'geodaten', 'buslinien', 'tram', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-06T01:34:31.067210`
