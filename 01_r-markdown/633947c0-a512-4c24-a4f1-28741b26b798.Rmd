...
- **Keywords.de** `['geodaten', 'strassenbahn', 'bus', 'fundburo', 'vektordaten', 'tram', 'postauto', 'offentlicher-verkehr', 'stzh', 'buslinien', 'vbg', 'punktdaten', 'tramlinien', 'geoportal', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-02T03:25:09.805431`
