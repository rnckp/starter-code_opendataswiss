...
- **Keywords.de** `['buslinien', 'tram', 'bus', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'vektordaten', 'strassenbahn', 'fundburo', 'geodaten', 'vbg', 'vbz', 'geoportal', 'postauto', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-06T03:15:49.178735`
