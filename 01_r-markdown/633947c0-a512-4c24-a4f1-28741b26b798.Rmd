...
- **Keywords.de** `['fundburo', 'tram', 'tramlinien', 'vektordaten', 'bus', 'strassenbahn', 'buslinien', 'geodaten', 'punktdaten', 'postauto', 'stzh', 'vbz', 'offentlicher-verkehr', 'vbg', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-26T03:46:42.780387`
