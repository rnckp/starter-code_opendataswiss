...
- **Keywords.de** `['bus', 'tramlinien', 'geoportal', 'vbz', 'vektordaten', 'fundburo', 'offentlicher-verkehr', 'strassenbahn', 'punktdaten', 'tram', 'buslinien', 'postauto', 'stzh', 'geodaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-27T03:24:45.346998`
