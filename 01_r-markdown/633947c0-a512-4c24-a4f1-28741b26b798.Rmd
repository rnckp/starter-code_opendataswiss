...
- **Keywords.de** `['tram', 'vbz', 'fundburo', 'geoportal', 'offentlicher-verkehr', 'vbg', 'bus', 'stzh', 'tramlinien', 'vektordaten', 'postauto', 'buslinien', 'punktdaten', 'geodaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-03T05:28:18.072951`
