...
- **Keywords.de** `['fundburo', 'strassenbahn', 'bus', 'buslinien', 'offentlicher-verkehr', 'geoportal', 'vbz', 'stzh', 'postauto', 'vbg', 'geodaten', 'vektordaten', 'tramlinien', 'tram', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-16T03:24:43.234384`
