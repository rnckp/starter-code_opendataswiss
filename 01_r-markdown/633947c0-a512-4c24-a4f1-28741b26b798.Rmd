...
- **Keywords.de** `['geodaten', 'punktdaten', 'buslinien', 'geoportal', 'tramlinien', 'strassenbahn', 'offentlicher-verkehr', 'vektordaten', 'postauto', 'tram', 'vbz', 'fundburo', 'vbg', 'stzh', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-28T04:38:05.432612`
