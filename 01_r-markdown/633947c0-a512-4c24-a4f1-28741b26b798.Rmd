...
- **Keywords.de** `['bus', 'geoportal', 'buslinien', 'punktdaten', 'offentlicher-verkehr', 'vbz', 'tramlinien', 'vbg', 'vektordaten', 'strassenbahn', 'geodaten', 'tram', 'fundburo', 'stzh', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-05T02:41:50.903911`
