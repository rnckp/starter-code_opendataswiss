...
- **Keywords.de** `['vektordaten', 'bus', 'postauto', 'vbg', 'punktdaten', 'strassenbahn', 'tramlinien', 'vbz', 'buslinien', 'fundburo', 'stzh', 'geoportal', 'tram', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-06T02:50:47.529952`
