...
- **Keywords.de** `['stzh', 'offentlicher-verkehr', 'tram', 'punktdaten', 'buslinien', 'fundburo', 'geoportal', 'vbg', 'vbz', 'bus', 'strassenbahn', 'geodaten', 'tramlinien', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-27T03:10:43.361274`
