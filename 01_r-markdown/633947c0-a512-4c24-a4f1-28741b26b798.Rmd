...
- **Keywords.de** `['punktdaten', 'stzh', 'strassenbahn', 'bus', 'tram', 'tramlinien', 'vbz', 'geodaten', 'vektordaten', 'vbg', 'buslinien', 'offentlicher-verkehr', 'postauto', 'fundburo', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-29T02:29:06.885738`
