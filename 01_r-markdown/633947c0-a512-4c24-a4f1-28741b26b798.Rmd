...
- **Keywords.de** `['postauto', 'offentlicher-verkehr', 'vbz', 'bus', 'tram', 'buslinien', 'geoportal', 'vbg', 'geodaten', 'punktdaten', 'stzh', 'tramlinien', 'strassenbahn', 'vektordaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-12T02:56:44.782862`
