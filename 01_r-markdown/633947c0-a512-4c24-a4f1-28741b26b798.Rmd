...
- **Keywords.de** `['punktdaten', 'vbg', 'fundburo', 'strassenbahn', 'geoportal', 'stzh', 'offentlicher-verkehr', 'buslinien', 'tram', 'vektordaten', 'postauto', 'geodaten', 'tramlinien', 'vbz', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-08T03:38:32.263043`
