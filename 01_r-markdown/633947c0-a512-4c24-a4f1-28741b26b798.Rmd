...
- **Keywords.de** `['vbz', 'postauto', 'strassenbahn', 'punktdaten', 'stzh', 'vektordaten', 'vbg', 'tram', 'buslinien', 'geoportal', 'tramlinien', 'bus', 'fundburo', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-16T04:14:03.805649`
