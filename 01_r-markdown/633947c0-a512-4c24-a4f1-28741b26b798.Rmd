...
- **Keywords.de** `['fundburo', 'vbz', 'strassenbahn', 'bus', 'postauto', 'geoportal', 'buslinien', 'tram', 'vbg', 'stzh', 'tramlinien', 'geodaten', 'offentlicher-verkehr', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-10T03:01:09.760469`
