...
- **Keywords.de** `['punktdaten', 'tram', 'geoportal', 'offentlicher-verkehr', 'postauto', 'vbz', 'stzh', 'bus', 'vektordaten', 'tramlinien', 'vbg', 'geodaten', 'buslinien', 'strassenbahn', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-17T03:40:39.925615`
