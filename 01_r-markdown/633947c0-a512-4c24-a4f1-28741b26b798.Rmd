...
- **Keywords.de** `['tramlinien', 'vbz', 'vektordaten', 'buslinien', 'punktdaten', 'vbg', 'postauto', 'bus', 'stzh', 'tram', 'fundburo', 'geodaten', 'offentlicher-verkehr', 'geoportal', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-05T02:47:45.741677`
