...
- **Keywords.de** `['offentlicher-verkehr', 'vbz', 'bus', 'geoportal', 'tram', 'stzh', 'strassenbahn', 'tramlinien', 'vektordaten', 'punktdaten', 'buslinien', 'postauto', 'fundburo', 'geodaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-01T03:30:53.255569`
