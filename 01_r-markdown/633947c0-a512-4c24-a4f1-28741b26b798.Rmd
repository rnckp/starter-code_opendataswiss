...
- **Keywords.de** `['vbz', 'punktdaten', 'stzh', 'buslinien', 'strassenbahn', 'vbg', 'tramlinien', 'postauto', 'vektordaten', 'bus', 'geoportal', 'fundburo', 'tram', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-28T03:06:32.550977`
