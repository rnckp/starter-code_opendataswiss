...
- **Keywords.de** `['vbz', 'tramlinien', 'tram', 'vektordaten', 'strassenbahn', 'fundburo', 'geodaten', 'buslinien', 'postauto', 'bus', 'offentlicher-verkehr', 'geoportal', 'punktdaten', 'stzh', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-13T02:41:08.582772`
