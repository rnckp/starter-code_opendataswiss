...
- **Keywords.de** `['stzh', 'vbz', 'vbg', 'geodaten', 'bus', 'tram', 'fundburo', 'offentlicher-verkehr', 'tramlinien', 'vektordaten', 'postauto', 'buslinien', 'punktdaten', 'geoportal', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-13T04:02:16.890450`
