...
- **Keywords.de** `['tramlinien', 'punktdaten', 'postauto', 'geoportal', 'strassenbahn', 'geodaten', 'vbg', 'vbz', 'offentlicher-verkehr', 'buslinien', 'vektordaten', 'fundburo', 'tram', 'stzh', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-20T02:57:22.215910`
