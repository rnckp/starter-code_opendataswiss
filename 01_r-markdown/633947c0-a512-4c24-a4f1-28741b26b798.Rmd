...
- **Keywords.de** `['postauto', 'geodaten', 'punktdaten', 'strassenbahn', 'vbz', 'geoportal', 'tramlinien', 'stzh', 'buslinien', 'bus', 'offentlicher-verkehr', 'vektordaten', 'fundburo', 'vbg', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-22T03:17:29.002333`
