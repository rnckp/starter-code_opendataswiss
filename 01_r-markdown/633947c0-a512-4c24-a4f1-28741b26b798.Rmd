...
- **Keywords.de** `['fundburo', 'vbz', 'strassenbahn', 'buslinien', 'postauto', 'geoportal', 'punktdaten', 'tramlinien', 'offentlicher-verkehr', 'tram', 'vbg', 'geodaten', 'stzh', 'vektordaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-02T03:56:05.775622`
