...
- **Keywords.de** `['vbg', 'fundburo', 'geoportal', 'geodaten', 'vbz', 'offentlicher-verkehr', 'buslinien', 'punktdaten', 'vektordaten', 'tramlinien', 'stzh', 'strassenbahn', 'tram', 'bus', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-06T03:36:03.041011`
