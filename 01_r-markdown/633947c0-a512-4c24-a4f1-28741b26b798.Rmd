...
- **Keywords.de** `['punktdaten', 'geodaten', 'stzh', 'tramlinien', 'bus', 'offentlicher-verkehr', 'postauto', 'vbz', 'vbg', 'vektordaten', 'tram', 'geoportal', 'strassenbahn', 'fundburo', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-12T03:37:34.064448`
