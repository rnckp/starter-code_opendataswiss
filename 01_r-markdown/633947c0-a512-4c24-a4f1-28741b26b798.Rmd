...
- **Keywords.de** `['geodaten', 'bus', 'tramlinien', 'postauto', 'vektordaten', 'buslinien', 'stzh', 'offentlicher-verkehr', 'strassenbahn', 'tram', 'geoportal', 'fundburo', 'vbg', 'punktdaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-07T03:25:41.608456`
