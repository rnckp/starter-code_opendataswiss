...
- **Keywords.de** `['geoportal', 'strassenbahn', 'tram', 'punktdaten', 'vbg', 'geodaten', 'vbz', 'tramlinien', 'buslinien', 'bus', 'stzh', 'offentlicher-verkehr', 'vektordaten', 'postauto', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-31T03:30:18.225161`
