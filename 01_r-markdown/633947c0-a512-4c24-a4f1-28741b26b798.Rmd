...
- **Keywords.de** `['strassenbahn', 'punktdaten', 'vektordaten', 'fundburo', 'geodaten', 'bus', 'tram', 'geoportal', 'postauto', 'offentlicher-verkehr', 'stzh', 'buslinien', 'vbg', 'tramlinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-18T02:10:50.967360`
