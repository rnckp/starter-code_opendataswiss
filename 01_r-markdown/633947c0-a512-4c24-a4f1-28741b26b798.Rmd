...
- **Keywords.de** `['tram', 'strassenbahn', 'geoportal', 'punktdaten', 'bus', 'offentlicher-verkehr', 'vbg', 'tramlinien', 'buslinien', 'vektordaten', 'postauto', 'stzh', 'fundburo', 'geodaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-17T02:43:13.588164`
