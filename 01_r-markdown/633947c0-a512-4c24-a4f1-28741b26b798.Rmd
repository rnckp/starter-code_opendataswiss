...
- **Keywords.de** `['geoportal', 'postauto', 'punktdaten', 'fundburo', 'stzh', 'vbg', 'vektordaten', 'strassenbahn', 'vbz', 'bus', 'offentlicher-verkehr', 'tram', 'geodaten', 'tramlinien', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-11T03:15:17.306160`
