...
- **Keywords.de** `['punktdaten', 'tramlinien', 'postauto', 'vbg', 'vbz', 'tram', 'vektordaten', 'offentlicher-verkehr', 'geodaten', 'stzh', 'bus', 'strassenbahn', 'geoportal', 'buslinien', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-30T04:06:00.266308`
