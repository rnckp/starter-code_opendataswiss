...
- **Keywords.de** `['buslinien', 'stzh', 'postauto', 'geoportal', 'tramlinien', 'fundburo', 'bus', 'geodaten', 'punktdaten', 'tram', 'offentlicher-verkehr', 'vbg', 'vbz', 'vektordaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-29T02:45:57.438171`
