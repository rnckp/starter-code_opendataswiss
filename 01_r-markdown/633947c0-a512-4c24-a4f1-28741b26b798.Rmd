...
- **Keywords.de** `['geoportal', 'tram', 'stzh', 'postauto', 'fundburo', 'punktdaten', 'tramlinien', 'geodaten', 'vbz', 'vbg', 'vektordaten', 'strassenbahn', 'buslinien', 'bus', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-12T03:06:51.118910`
