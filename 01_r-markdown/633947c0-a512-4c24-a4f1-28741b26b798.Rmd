...
- **Keywords.de** `['vbz', 'vektordaten', 'offentlicher-verkehr', 'vbg', 'fundburo', 'stzh', 'geoportal', 'postauto', 'tramlinien', 'buslinien', 'bus', 'tram', 'strassenbahn', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-27T03:06:24.261848`
