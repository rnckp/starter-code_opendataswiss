...
- **Keywords.de** `['punktdaten', 'bus', 'postauto', 'vektordaten', 'offentlicher-verkehr', 'geodaten', 'vbz', 'stzh', 'tramlinien', 'tram', 'geoportal', 'vbg', 'strassenbahn', 'fundburo', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-23T03:27:03.925248`
