...
- **Keywords.de** `['vektordaten', 'punktdaten', 'tramlinien', 'vbz', 'buslinien', 'postauto', 'strassenbahn', 'offentlicher-verkehr', 'geoportal', 'geodaten', 'stzh', 'fundburo', 'tram', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-19T02:53:45.987193`
