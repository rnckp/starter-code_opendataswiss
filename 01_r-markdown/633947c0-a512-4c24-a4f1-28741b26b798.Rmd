...
- **Keywords.de** `['fundburo', 'geodaten', 'vbg', 'postauto', 'strassenbahn', 'bus', 'tramlinien', 'punktdaten', 'buslinien', 'offentlicher-verkehr', 'vektordaten', 'stzh', 'vbz', 'tram', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-21T03:33:39.035206`
