...
- **Keywords.de** `['vbg', 'bus', 'fundburo', 'postauto', 'strassenbahn', 'tramlinien', 'geoportal', 'vektordaten', 'vbz', 'geodaten', 'buslinien', 'punktdaten', 'offentlicher-verkehr', 'tram', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-21T03:43:43.442371`
