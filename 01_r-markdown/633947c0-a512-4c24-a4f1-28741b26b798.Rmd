...
- **Keywords.de** `['stzh', 'vektordaten', 'vbg', 'tramlinien', 'postauto', 'bus', 'offentlicher-verkehr', 'strassenbahn', 'buslinien', 'fundburo', 'tram', 'punktdaten', 'geoportal', 'vbz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-17T03:59:50.570484`
