...
- **Keywords.de** `['vbg', 'offentlicher-verkehr', 'tramlinien', 'tram', 'buslinien', 'vektordaten', 'strassenbahn', 'geoportal', 'punktdaten', 'postauto', 'vbz', 'fundburo', 'bus', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-17T01:30:47.293815`
