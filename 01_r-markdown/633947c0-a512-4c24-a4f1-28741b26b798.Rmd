...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'tramlinien', 'vektordaten', 'fundburo', 'postauto', 'geoportal', 'bus', 'strassenbahn', 'buslinien', 'tram', 'vbg', 'geodaten', 'vbz', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-11T03:30:18.906399`
