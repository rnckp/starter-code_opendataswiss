...
- **Keywords.de** `['buslinien', 'bus', 'vektordaten', 'offentlicher-verkehr', 'vbg', 'geodaten', 'tram', 'stzh', 'geoportal', 'punktdaten', 'fundburo', 'strassenbahn', 'tramlinien', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-30T03:19:45.598484`
