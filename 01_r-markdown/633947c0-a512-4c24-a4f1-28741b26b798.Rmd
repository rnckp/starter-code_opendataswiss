...
- **Keywords.de** `['postauto', 'vektordaten', 'vbz', 'vbg', 'offentlicher-verkehr', 'tramlinien', 'fundburo', 'geodaten', 'geoportal', 'tram', 'stzh', 'bus', 'punktdaten', 'buslinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-06T03:11:08.636078`
