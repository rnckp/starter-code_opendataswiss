...
- **Keywords.de** `['tramlinien', 'punktdaten', 'bus', 'stzh', 'vbz', 'geodaten', 'offentlicher-verkehr', 'buslinien', 'vektordaten', 'fundburo', 'geoportal', 'postauto', 'vbg', 'strassenbahn', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-06T03:16:33.540606`
