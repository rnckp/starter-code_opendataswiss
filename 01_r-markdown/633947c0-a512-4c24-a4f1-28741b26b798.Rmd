...
- **Keywords.de** `['vbg', 'bus', 'postauto', 'tram', 'stzh', 'punktdaten', 'strassenbahn', 'geoportal', 'tramlinien', 'vektordaten', 'fundburo', 'geodaten', 'offentlicher-verkehr', 'vbz', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-20T04:53:48.786619`
