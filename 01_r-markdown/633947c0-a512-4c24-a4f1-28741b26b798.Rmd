...
- **Keywords.de** `['postauto', 'tram', 'offentlicher-verkehr', 'bus', 'vektordaten', 'geodaten', 'strassenbahn', 'stzh', 'tramlinien', 'vbz', 'vbg', 'punktdaten', 'buslinien', 'fundburo', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-12T03:36:39.260661`
