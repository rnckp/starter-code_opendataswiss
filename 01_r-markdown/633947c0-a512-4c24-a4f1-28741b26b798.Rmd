...
- **Keywords.de** `['tram', 'offentlicher-verkehr', 'vbz', 'strassenbahn', 'buslinien', 'punktdaten', 'stzh', 'vbg', 'tramlinien', 'postauto', 'geoportal', 'vektordaten', 'bus', 'fundburo', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-28T03:15:40.750577`
