...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'punktdaten', 'stzh', 'vbg', 'buslinien', 'geodaten', 'vbz', 'tram', 'postauto', 'bus', 'fundburo', 'geoportal', 'tramlinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-03T03:27:45.432862`
