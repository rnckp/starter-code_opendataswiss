...
- **Keywords.de** `['geoportal', 'postauto', 'geodaten', 'stzh', 'vektordaten', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'buslinien', 'bus', 'punktdaten', 'vbz', 'fundburo', 'tramlinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-15T03:22:41.662336`
