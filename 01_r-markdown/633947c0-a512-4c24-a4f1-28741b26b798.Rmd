...
- **Keywords.de** `['tram', 'strassenbahn', 'vbg', 'offentlicher-verkehr', 'vbz', 'fundburo', 'vektordaten', 'postauto', 'geoportal', 'geodaten', 'stzh', 'tramlinien', 'punktdaten', 'buslinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-09T03:04:22.339331`
