...
- **Keywords.de** `['tram', 'stzh', 'postauto', 'vektordaten', 'vbg', 'geodaten', 'strassenbahn', 'vbz', 'bus', 'tramlinien', 'geoportal', 'offentlicher-verkehr', 'punktdaten', 'fundburo', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-12-04T03:16:53.567217`
