...
- **Keywords.de** `['buslinien', 'vbz', 'bus', 'geoportal', 'stzh', 'postauto', 'tramlinien', 'strassenbahn', 'fundburo', 'vbg', 'geodaten', 'punktdaten', 'offentlicher-verkehr', 'vektordaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-24T01:50:12.219329`
