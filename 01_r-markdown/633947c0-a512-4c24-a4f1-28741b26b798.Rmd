...
- **Keywords.de** `['tram', 'postauto', 'offentlicher-verkehr', 'geoportal', 'bus', 'buslinien', 'stzh', 'strassenbahn', 'vbg', 'vbz', 'tramlinien', 'vektordaten', 'geodaten', 'fundburo', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-07T04:23:01.522951`
