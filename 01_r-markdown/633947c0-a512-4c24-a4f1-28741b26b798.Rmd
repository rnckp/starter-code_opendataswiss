...
- **Keywords.de** `['vbz', 'stzh', 'tram', 'vbg', 'vektordaten', 'geodaten', 'strassenbahn', 'geoportal', 'punktdaten', 'bus', 'fundburo', 'offentlicher-verkehr', 'buslinien', 'postauto', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-14T03:08:18.589150`
