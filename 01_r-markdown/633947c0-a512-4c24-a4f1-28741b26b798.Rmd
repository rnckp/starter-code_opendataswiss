...
- **Keywords.de** `['bus', 'postauto', 'buslinien', 'geodaten', 'stzh', 'vbz', 'vektordaten', 'fundburo', 'punktdaten', 'strassenbahn', 'tram', 'geoportal', 'offentlicher-verkehr', 'vbg', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-05-01T04:06:56.269610`
