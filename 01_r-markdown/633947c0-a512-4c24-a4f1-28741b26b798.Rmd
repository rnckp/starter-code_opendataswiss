...
- **Keywords.de** `['fundburo', 'postauto', 'offentlicher-verkehr', 'vbz', 'punktdaten', 'vbg', 'bus', 'geodaten', 'stzh', 'strassenbahn', 'geoportal', 'tramlinien', 'vektordaten', 'tram', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-05T04:18:00.178966`
