...
- **Keywords.de** `['geoportal', 'tramlinien', 'postauto', 'punktdaten', 'fundburo', 'strassenbahn', 'stzh', 'bus', 'offentlicher-verkehr', 'tram', 'vektordaten', 'buslinien', 'vbz', 'geodaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-26T03:24:03.629075`
