...
- **Keywords.de** `['postauto', 'vbg', 'punktdaten', 'buslinien', 'strassenbahn', 'tram', 'vbz', 'offentlicher-verkehr', 'vektordaten', 'bus', 'geoportal', 'tramlinien', 'stzh', 'fundburo', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-21T03:16:08.494807`
