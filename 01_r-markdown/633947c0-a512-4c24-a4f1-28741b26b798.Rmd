...
- **Keywords.de** `['punktdaten', 'tramlinien', 'vbz', 'offentlicher-verkehr', 'vektordaten', 'strassenbahn', 'fundburo', 'geoportal', 'tram', 'geodaten', 'postauto', 'stzh', 'vbg', 'buslinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-02T03:04:37.750760`
