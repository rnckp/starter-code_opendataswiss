...
- **Keywords.de** `['buslinien', 'strassenbahn', 'vektordaten', 'tramlinien', 'fundburo', 'vbg', 'stzh', 'tram', 'punktdaten', 'bus', 'geodaten', 'vbz', 'postauto', 'offentlicher-verkehr', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-04T03:49:14.193972`
