...
- **Keywords.de** `['vbg', 'offentlicher-verkehr', 'tram', 'fundburo', 'vektordaten', 'punktdaten', 'buslinien', 'geoportal', 'tramlinien', 'strassenbahn', 'stzh', 'vbz', 'bus', 'postauto', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-09T02:30:23.052167`
