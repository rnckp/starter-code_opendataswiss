...
- **Keywords.de** `['offentlicher-verkehr', 'vbg', 'stzh', 'bus', 'geodaten', 'geoportal', 'punktdaten', 'buslinien', 'fundburo', 'tramlinien', 'tram', 'postauto', 'strassenbahn', 'vektordaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-12T03:28:19.682546`
