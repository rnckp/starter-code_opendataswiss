...
- **Keywords.de** `['vbz', 'punktdaten', 'bus', 'geodaten', 'vektordaten', 'vbg', 'fundburo', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'postauto', 'buslinien', 'tram', 'strassenbahn', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-14T02:58:53.446754`
