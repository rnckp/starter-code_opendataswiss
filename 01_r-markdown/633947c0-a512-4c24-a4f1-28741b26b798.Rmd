...
- **Keywords.de** `['vektordaten', 'stzh', 'strassenbahn', 'vbz', 'punktdaten', 'offentlicher-verkehr', 'postauto', 'tramlinien', 'buslinien', 'geodaten', 'tram', 'geoportal', 'bus', 'fundburo', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-02-20T03:40:59.909164`
