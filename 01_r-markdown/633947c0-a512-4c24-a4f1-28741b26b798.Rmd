...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'geoportal', 'bus', 'vbz', 'tramlinien', 'fundburo', 'punktdaten', 'tram', 'geodaten', 'strassenbahn', 'vektordaten', 'postauto', 'buslinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-06-01T03:31:20.293956`
