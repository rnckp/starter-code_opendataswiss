...
- **Keywords.de** `['stzh', 'buslinien', 'bus', 'tram', 'fundburo', 'postauto', 'tramlinien', 'geoportal', 'strassenbahn', 'vektordaten', 'geodaten', 'punktdaten', 'vbz', 'vbg', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-16T03:19:31.845355`
