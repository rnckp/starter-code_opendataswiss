...
- **Keywords.de** `['tramlinien', 'vektordaten', 'geoportal', 'vbz', 'geodaten', 'punktdaten', 'fundburo', 'strassenbahn', 'offentlicher-verkehr', 'buslinien', 'vbg', 'stzh', 'tram', 'postauto', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-14T03:03:48.284363`
