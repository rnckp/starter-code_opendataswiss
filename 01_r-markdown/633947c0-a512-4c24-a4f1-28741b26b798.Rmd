...
- **Keywords.de** `['offentlicher-verkehr', 'tramlinien', 'strassenbahn', 'geoportal', 'tram', 'punktdaten', 'vbg', 'postauto', 'bus', 'fundburo', 'stzh', 'vektordaten', 'geodaten', 'buslinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-01T08:47:30.050590`
