...
- **Keywords.de** `['geoportal', 'stzh', 'vektordaten', 'offentlicher-verkehr', 'bus', 'punktdaten', 'geodaten', 'fundburo', 'tramlinien', 'vbz', 'postauto', 'tram', 'vbg', 'strassenbahn', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-02T04:19:26.575003`
