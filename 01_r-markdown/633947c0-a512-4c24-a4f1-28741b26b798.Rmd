...
- **Keywords.de** `['geoportal', 'offentlicher-verkehr', 'tram', 'tramlinien', 'postauto', 'punktdaten', 'stzh', 'bus', 'buslinien', 'vektordaten', 'geodaten', 'vbz', 'strassenbahn', 'fundburo', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-23T03:07:45.957246`
