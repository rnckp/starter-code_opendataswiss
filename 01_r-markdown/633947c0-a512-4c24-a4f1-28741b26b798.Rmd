...
- **Keywords.de** `['strassenbahn', 'tramlinien', 'tram', 'bus', 'fundburo', 'vbg', 'vektordaten', 'stzh', 'vbz', 'geodaten', 'postauto', 'punktdaten', 'buslinien', 'offentlicher-verkehr', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-01T03:07:18.625764`
