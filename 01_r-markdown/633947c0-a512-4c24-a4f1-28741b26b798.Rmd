...
- **Keywords.de** `['tram', 'postauto', 'fundburo', 'geoportal', 'buslinien', 'bus', 'vbz', 'vektordaten', 'offentlicher-verkehr', 'geodaten', 'punktdaten', 'vbg', 'strassenbahn', 'stzh', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-02T10:14:44.071980`
