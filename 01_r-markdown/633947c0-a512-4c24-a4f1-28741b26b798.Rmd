...
- **Keywords.de** `['geoportal', 'tram', 'postauto', 'tramlinien', 'stzh', 'vektordaten', 'strassenbahn', 'offentlicher-verkehr', 'vbg', 'vbz', 'geodaten', 'fundburo', 'punktdaten', 'bus', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-25T02:47:23.949835`
