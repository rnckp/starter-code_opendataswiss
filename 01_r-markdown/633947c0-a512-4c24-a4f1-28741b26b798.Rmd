...
- **Keywords.de** `['punktdaten', 'vektordaten', 'strassenbahn', 'postauto', 'fundburo', 'geodaten', 'vbg', 'stzh', 'vbz', 'tram', 'geoportal', 'buslinien', 'offentlicher-verkehr', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-28T03:46:06.719963`
