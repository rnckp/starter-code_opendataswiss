...
- **Keywords.de** `['strassenbahn', 'buslinien', 'geoportal', 'tram', 'geodaten', 'fundburo', 'vbg', 'vbz', 'bus', 'tramlinien', 'offentlicher-verkehr', 'stzh', 'vektordaten', 'postauto', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-07-26T02:53:11.416717`
