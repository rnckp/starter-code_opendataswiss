...
- **Keywords.de** `['postauto', 'buslinien', 'tram', 'punktdaten', 'stzh', 'tramlinien', 'strassenbahn', 'fundburo', 'vbz', 'offentlicher-verkehr', 'vektordaten', 'bus', 'vbg', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-30T03:04:05.877685`
