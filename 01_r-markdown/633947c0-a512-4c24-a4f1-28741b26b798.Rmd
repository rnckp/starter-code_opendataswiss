...
- **Keywords.de** `['bus', 'tramlinien', 'postauto', 'offentlicher-verkehr', 'fundburo', 'geoportal', 'buslinien', 'vbg', 'vbz', 'punktdaten', 'vektordaten', 'tram', 'stzh', 'strassenbahn', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-16T03:21:54.417624`
