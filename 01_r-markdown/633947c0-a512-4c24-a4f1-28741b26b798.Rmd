...
- **Keywords.de** `['punktdaten', 'strassenbahn', 'vbg', 'stzh', 'buslinien', 'vbz', 'bus', 'tram', 'geoportal', 'tramlinien', 'vektordaten', 'offentlicher-verkehr', 'geodaten', 'postauto', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-01T04:11:00.544268`
