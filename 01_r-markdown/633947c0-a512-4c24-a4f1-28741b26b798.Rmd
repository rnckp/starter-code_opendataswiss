...
- **Keywords.de** `['vbg', 'strassenbahn', 'vbz', 'tram', 'stzh', 'geoportal', 'bus', 'tramlinien', 'punktdaten', 'fundburo', 'postauto', 'geodaten', 'buslinien', 'offentlicher-verkehr', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-24T03:21:37.684286`
