...
- **Keywords.de** `['vbg', 'punktdaten', 'strassenbahn', 'postauto', 'offentlicher-verkehr', 'buslinien', 'bus', 'vbz', 'tramlinien', 'geoportal', 'fundburo', 'vektordaten', 'geodaten', 'tram', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-21T03:11:36.129555`
