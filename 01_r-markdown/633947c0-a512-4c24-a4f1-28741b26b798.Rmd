...
- **Keywords.de** `['strassenbahn', 'fundburo', 'postauto', 'geoportal', 'punktdaten', 'vektordaten', 'tramlinien', 'bus', 'stzh', 'offentlicher-verkehr', 'vbz', 'vbg', 'geodaten', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-19T03:15:17.019860`
