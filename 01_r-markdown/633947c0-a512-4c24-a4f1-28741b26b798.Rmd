...
- **Keywords.de** `['geodaten', 'postauto', 'vbz', 'tramlinien', 'buslinien', 'strassenbahn', 'fundburo', 'vektordaten', 'punktdaten', 'offentlicher-verkehr', 'stzh', 'bus', 'tram', 'vbg', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-11-08T03:03:34.992393`
