...
- **Keywords.de** `['tramlinien', 'geodaten', 'stzh', 'bus', 'postauto', 'vbg', 'strassenbahn', 'punktdaten', 'tram', 'offentlicher-verkehr', 'fundburo', 'vektordaten', 'vbz', 'geoportal', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-04T02:56:27.809181`
