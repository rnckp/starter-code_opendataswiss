...
- **Keywords.de** `['vbg', 'buslinien', 'stzh', 'offentlicher-verkehr', 'fundburo', 'tramlinien', 'vektordaten', 'postauto', 'geoportal', 'punktdaten', 'geodaten', 'strassenbahn', 'tram', 'vbz', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-17T02:50:47.177038`
