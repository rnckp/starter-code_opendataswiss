...
- **Keywords.de** `['fundburo', 'punktdaten', 'vbg', 'offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'stzh', 'postauto', 'geoportal', 'geodaten', 'vbz', 'bus', 'tram', 'tramlinien', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-21T03:22:09.017278`
