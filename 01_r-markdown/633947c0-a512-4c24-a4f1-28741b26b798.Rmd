...
- **Keywords.de** `['tramlinien', 'vbg', 'stzh', 'tram', 'punktdaten', 'bus', 'buslinien', 'geoportal', 'strassenbahn', 'geodaten', 'fundburo', 'vbz', 'offentlicher-verkehr', 'postauto', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-08T03:09:08.164145`
