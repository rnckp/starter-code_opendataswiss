...
- **Keywords.de** `['tramlinien', 'strassenbahn', 'tram', 'buslinien', 'geoportal', 'vektordaten', 'punktdaten', 'geodaten', 'bus', 'stzh', 'vbz', 'vbg', 'fundburo', 'postauto', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-08-20T03:18:05.339704`
