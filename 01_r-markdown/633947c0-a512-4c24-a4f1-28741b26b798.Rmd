...
- **Keywords.de** `['bus', 'geodaten', 'offentlicher-verkehr', 'postauto', 'vektordaten', 'geoportal', 'tramlinien', 'strassenbahn', 'vbg', 'stzh', 'vbz', 'buslinien', 'fundburo', 'punktdaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-11T03:34:26.977715`
