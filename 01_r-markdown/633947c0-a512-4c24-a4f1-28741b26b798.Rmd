...
- **Keywords.de** `['vbz', 'buslinien', 'geodaten', 'tram', 'vektordaten', 'tramlinien', 'geoportal', 'fundburo', 'punktdaten', 'offentlicher-verkehr', 'stzh', 'vbg', 'strassenbahn', 'bus', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-12T03:15:15.801779`
