...
- **Keywords.de** `['vbg', 'vektordaten', 'strassenbahn', 'tram', 'bus', 'punktdaten', 'buslinien', 'geoportal', 'offentlicher-verkehr', 'stzh', 'geodaten', 'fundburo', 'vbz', 'postauto', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-30T03:13:38.682349`
