...
- **Keywords.de** `['vbz', 'offentlicher-verkehr', 'strassenbahn', 'stzh', 'tramlinien', 'geoportal', 'tram', 'bus', 'vbg', 'punktdaten', 'vektordaten', 'postauto', 'fundburo', 'geodaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-12-20T02:34:45.691360`
