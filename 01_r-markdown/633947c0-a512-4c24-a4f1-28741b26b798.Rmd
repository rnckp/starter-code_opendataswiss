...
- **Keywords.de** `['vbg', 'vektordaten', 'postauto', 'offentlicher-verkehr', 'fundburo', 'geodaten', 'tramlinien', 'geoportal', 'bus', 'strassenbahn', 'buslinien', 'vbz', 'stzh', 'punktdaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-09-04T03:34:37.674310`
