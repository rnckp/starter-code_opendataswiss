...
- **Keywords.de** `['punktdaten', 'bus', 'stzh', 'geodaten', 'tram', 'tramlinien', 'postauto', 'vbz', 'offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'geoportal', 'fundburo', 'vbg', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-09T03:39:52.154746`
