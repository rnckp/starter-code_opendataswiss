...
- **Keywords.de** `['bus', 'vbz', 'strassenbahn', 'vektordaten', 'tram', 'geoportal', 'offentlicher-verkehr', 'tramlinien', 'buslinien', 'postauto', 'geodaten', 'vbg', 'punktdaten', 'fundburo', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-10T04:10:00.241937`
