...
- **Keywords.de** `['geodaten', 'punktdaten', 'geoportal', 'tramlinien', 'tram', 'fundburo', 'vektordaten', 'stzh', 'postauto', 'strassenbahn', 'vbz', 'offentlicher-verkehr', 'bus', 'vbg', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-14T02:32:02.252646`
