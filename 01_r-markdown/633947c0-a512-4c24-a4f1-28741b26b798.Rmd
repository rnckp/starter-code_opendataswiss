...
- **Keywords.de** `['punktdaten', 'bus', 'fundburo', 'vbg', 'strassenbahn', 'vektordaten', 'vbz', 'geoportal', 'tram', 'offentlicher-verkehr', 'stzh', 'buslinien', 'geodaten', 'postauto', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-06-03T02:48:56.844019`
