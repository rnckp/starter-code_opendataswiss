...
- **Keywords.de** `['fundburo', 'stzh', 'vbg', 'vbz', 'tram', 'geoportal', 'punktdaten', 'strassenbahn', 'bus', 'tramlinien', 'postauto', 'buslinien', 'vektordaten', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-30T03:11:19.727733`
