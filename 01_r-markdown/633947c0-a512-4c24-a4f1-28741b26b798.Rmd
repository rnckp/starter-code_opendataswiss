...
- **Keywords.de** `['buslinien', 'vbg', 'fundburo', 'postauto', 'strassenbahn', 'bus', 'punktdaten', 'stzh', 'offentlicher-verkehr', 'vbz', 'tram', 'vektordaten', 'geoportal', 'geodaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-11T02:58:33.339837`
