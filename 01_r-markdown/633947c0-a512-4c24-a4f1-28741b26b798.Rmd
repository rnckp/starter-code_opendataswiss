...
- **Keywords.de** `['vbg', 'vektordaten', 'tram', 'geodaten', 'bus', 'geoportal', 'vbz', 'punktdaten', 'stzh', 'fundburo', 'buslinien', 'strassenbahn', 'tramlinien', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-10-28T03:03:31.357939`
