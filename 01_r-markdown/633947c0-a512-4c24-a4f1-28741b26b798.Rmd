...
- **Keywords.de** `['geoportal', 'offentlicher-verkehr', 'fundburo', 'postauto', 'tram', 'punktdaten', 'stzh', 'tramlinien', 'buslinien', 'vektordaten', 'vbg', 'bus', 'geodaten', 'strassenbahn', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-22T02:52:22.940813`
