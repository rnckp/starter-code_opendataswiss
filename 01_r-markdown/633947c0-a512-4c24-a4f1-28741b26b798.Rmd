...
- **Keywords.de** `['postauto', 'geoportal', 'fundburo', 'bus', 'vektordaten', 'punktdaten', 'geodaten', 'strassenbahn', 'offentlicher-verkehr', 'buslinien', 'vbg', 'stzh', 'vbz', 'tramlinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-03-10T03:11:50.927201`
