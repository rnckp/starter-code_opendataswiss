...
- **Keywords.de** `['vbg', 'tram', 'vektordaten', 'offentlicher-verkehr', 'postauto', 'geodaten', 'geoportal', 'punktdaten', 'fundburo', 'tramlinien', 'stzh', 'buslinien', 'strassenbahn', 'bus', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-13T03:21:05.059456`
