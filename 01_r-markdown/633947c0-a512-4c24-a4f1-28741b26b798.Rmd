...
- **Keywords.de** `['postauto', 'stzh', 'geoportal', 'fundburo', 'tramlinien', 'offentlicher-verkehr', 'tram', 'strassenbahn', 'vbz', 'bus', 'buslinien', 'vbg', 'geodaten', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-02-23T03:07:59.868070`
