...
- **Keywords.de** `['postauto', 'vektordaten', 'vbg', 'punktdaten', 'tramlinien', 'strassenbahn', 'vbz', 'fundburo', 'geodaten', 'offentlicher-verkehr', 'buslinien', 'tram', 'bus', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2023-11-24T02:47:39.090606`
