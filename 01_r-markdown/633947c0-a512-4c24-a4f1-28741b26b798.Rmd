...
- **Keywords.de** `['strassenbahn', 'buslinien', 'postauto', 'vbg', 'bus', 'stzh', 'vektordaten', 'geoportal', 'geodaten', 'vbz', 'punktdaten', 'offentlicher-verkehr', 'tramlinien', 'fundburo', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-04-27T03:56:47.148647`
