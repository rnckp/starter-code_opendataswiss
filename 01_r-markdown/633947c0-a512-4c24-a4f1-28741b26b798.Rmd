...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'vbg', 'geoportal', 'vbz', 'buslinien', 'stzh', 'offentlicher-verkehr', 'bus', 'punktdaten', 'tram', 'postauto', 'tramlinien', 'fundburo', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-24T02:15:43.762147`
