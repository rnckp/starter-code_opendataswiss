...
- **Keywords.de** `['stzh', 'punktdaten', 'offentlicher-verkehr', 'geodaten', 'buslinien', 'vbg', 'postauto', 'vektordaten', 'strassenbahn', 'vbz', 'bus', 'tram', 'tramlinien', 'geoportal', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-09-28T03:26:37.545920`
