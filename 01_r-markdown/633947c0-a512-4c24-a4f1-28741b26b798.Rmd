...
- **Keywords.de** `['fundburo', 'postauto', 'vbg', 'vektordaten', 'vbz', 'offentlicher-verkehr', 'punktdaten', 'tramlinien', 'geoportal', 'stzh', 'buslinien', 'bus', 'strassenbahn', 'tram', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-13T02:58:18.780793`
