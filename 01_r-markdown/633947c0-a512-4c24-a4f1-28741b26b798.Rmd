...
- **Keywords.de** `['geoportal', 'stzh', 'fundburo', 'geodaten', 'postauto', 'bus', 'punktdaten', 'offentlicher-verkehr', 'tram', 'vbz', 'buslinien', 'vbg', 'vektordaten', 'tramlinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-16T04:42:30.775961`
