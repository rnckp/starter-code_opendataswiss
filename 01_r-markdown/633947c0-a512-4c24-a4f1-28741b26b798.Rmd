...
- **Keywords.de** `['fundburo', 'vbz', 'vbg', 'strassenbahn', 'bus', 'geodaten', 'geoportal', 'buslinien', 'offentlicher-verkehr', 'punktdaten', 'tram', 'vektordaten', 'postauto', 'tramlinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-24T03:26:05.914586`
