...
- **Keywords.de** `['strassenbahn', 'stzh', 'fundburo', 'offentlicher-verkehr', 'geoportal', 'vektordaten', 'postauto', 'bus', 'vbz', 'geodaten', 'vbg', 'tram', 'punktdaten', 'tramlinien', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-04T06:59:25.150527`
