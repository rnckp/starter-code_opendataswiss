...
- **Keywords.de** `['bus', 'tramlinien', 'punktdaten', 'vbz', 'strassenbahn', 'vektordaten', 'fundburo', 'tram', 'stzh', 'offentlicher-verkehr', 'vbg', 'postauto', 'geodaten', 'buslinien', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-17T02:08:07.434571`
