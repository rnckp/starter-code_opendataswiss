...
- **Keywords.de** `['geodaten', 'strassenbahn', 'buslinien', 'offentlicher-verkehr', 'geoportal', 'tramlinien', 'vbg', 'postauto', 'tram', 'vektordaten', 'vbz', 'punktdaten', 'bus', 'stzh', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-07-09T03:44:39.165855`
