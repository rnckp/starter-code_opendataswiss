...
- **Keywords.de** `['offentlicher-verkehr', 'geoportal', 'postauto', 'vbz', 'strassenbahn', 'tram', 'geodaten', 'fundburo', 'vektordaten', 'stzh', 'tramlinien', 'buslinien', 'punktdaten', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-01-01T03:36:56.008631`
