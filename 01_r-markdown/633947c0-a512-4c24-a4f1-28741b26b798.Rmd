...
- **Keywords.de** `['geoportal', 'buslinien', 'vektordaten', 'vbz', 'punktdaten', 'bus', 'offentlicher-verkehr', 'strassenbahn', 'geodaten', 'tramlinien', 'stzh', 'tram', 'vbg', 'fundburo', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-04-02T05:15:22.550911`
