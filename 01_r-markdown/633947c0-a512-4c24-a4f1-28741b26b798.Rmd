...
- **Keywords.de** `['vbg', 'offentlicher-verkehr', 'geodaten', 'vbz', 'postauto', 'tram', 'vektordaten', 'strassenbahn', 'stzh', 'bus', 'fundburo', 'buslinien', 'tramlinien', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-11T03:30:08.104446`
