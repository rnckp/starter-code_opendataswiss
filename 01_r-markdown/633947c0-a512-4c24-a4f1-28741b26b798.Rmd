...
- **Keywords.de** `['vbz', 'tram', 'tramlinien', 'vbg', 'vektordaten', 'buslinien', 'fundburo', 'punktdaten', 'stzh', 'postauto', 'strassenbahn', 'offentlicher-verkehr', 'geodaten', 'geoportal', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2025-08-03T03:18:52.149932`
