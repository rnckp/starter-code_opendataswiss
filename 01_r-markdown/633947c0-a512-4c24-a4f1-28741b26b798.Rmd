...
- **Keywords.de** `['stzh', 'vbz', 'strassenbahn', 'vbg', 'offentlicher-verkehr', 'buslinien', 'fundburo', 'postauto', 'punktdaten', 'tramlinien', 'bus', 'geodaten', 'tram', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-01-22T03:16:33.855801`
