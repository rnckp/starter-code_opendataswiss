...
- **Keywords.de** `['bus', 'geodaten', 'tram', 'stzh', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien', 'vektordaten', 'buslinien', 'vbz', 'vbg', 'punktdaten', 'fundburo', 'postauto', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-05-19T02:51:06.333365`
