...
- **Keywords.de** `['punktdaten', 'fundburo', 'strassenbahn', 'tramlinien', 'postauto', 'vbz', 'tram', 'vbg', 'geodaten', 'offentlicher-verkehr', 'geoportal', 'vektordaten', 'bus', 'buslinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:40:27.153364`
- **Metadata_modified** `2024-03-08T03:25:05.726400`
