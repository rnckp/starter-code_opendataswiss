...
- **Keywords.de** `['katasterbuch', 'denkmalschutz', 'bauten', 'baugeschichte', 'gebaude', 'schutzinventar', 'amtliche-vermessung', 'einstufung', 'hinweisinventar', 'schutzstatus', 'historische-gebaude', 'wertvoll', 'denkmalpflege']`
- **Issued** `2023-01-25T00:00:00`
- **Metadata_created** `2023-01-25T11:02:59.238472`
- **Metadata_modified** `2024-03-03T11:03:07.104429`
...
df <- read_delim('https://data.tg.ch/api/v2/catalog/datasets/dbu-dp-3/exports/csv')
