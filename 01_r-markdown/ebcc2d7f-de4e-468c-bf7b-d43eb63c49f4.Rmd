...
- **Publisher** `Justiz- und Sicherheitsdepartement/Rettung/Sanität`
- **Organization.display_name.de** `Kanton Basel-Stadt`
- **Organization.url** `https://www.opendata.bs.ch`
- **Maintainer** `None`
- **Maintainer_email** `None`
- **Keywords.de** `['standort', 'herz', 'lunge', 'reanimation', 'notfall', 'cpr', 'wiederbelebung']`
- **Issued** `2019-11-06T00:00:00`
- **Metadata_created** `2022-06-09T08:40:00.878545`
- **Metadata_modified** `2023-03-24T00:35:23.274954`
