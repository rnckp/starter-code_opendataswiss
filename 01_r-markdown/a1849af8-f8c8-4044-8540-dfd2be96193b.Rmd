...
MeteoSchweiz betreibt das Nationale Pollenmessnetz. Es umfasst 16 automatische Pollen-Messstationen, welche die wichtigsten Klima- und Vegetationsräume der Schweiz berücksichtigen. Die Messungen liefern wertvolle Informationen für Allergiker/-innen. Der Datensatz enthält pro Station aktuelle Pollenkonzentrationen in den Auflösungen stündlich ('h'), täglich ('d') und jährlich ('y'). Es gibt aktualisierte Datensätze vom aktuellen Jahr bis gestern ('recent') sowie seit Messbeginn in Zehnjahresschritten ('historical'). Wenn Sie tägliche oder jährliche Werte benötigen, empfehlen wir Ihnen dringend, die entsprechende Auflösung herunterzuladen.
...
Auto-generated R starter code for the dataset d28bd725-bd8c-4176-bf6a-c76e34799d57@bundesamt-fur-meteorologie-und-klimatologie-meteoschweiz.
...
- **Metadata_modified** `2026-01-30T00:22:26.140912`
...
df <- read_delim('https://data.geo.admin.ch/browser/index.html#/collections/ch.meteoschweiz.ogd-pollen')
