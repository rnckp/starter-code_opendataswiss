...
- **Keywords.de** `['geodaten', 'holzheizkraftwerk', 'liniendaten', 'klarwerk', 'kehrichtheizkraftwerk', 'fernwarme', 'energie', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'heizen', 'fernwarmeversorgung', 'polygondaten', 'geoportal', 'kalteversorgung', 'energieversorgung', 'warmeversorgung', 'vektordaten', 'netto-null', 'punktdaten', 'stzh', 'energie-aus-gereinigtem-abwasser', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-27T03:09:13.362757`
