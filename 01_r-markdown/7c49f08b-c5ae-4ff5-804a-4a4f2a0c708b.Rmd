...
- **Keywords.de** `['energieversorgung', 'klarwerk', 'netto-null', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'punktdaten', 'geodaten', 'fernwarmeversorgung', 'stzh', 'kehrichtheizkraftwerk', 'kalteversorgung', 'polygondaten', 'leitungsgebundene-energieversorgung', 'heizen', 'energieplanung', 'liniendaten', 'erneuerbar-heizen', 'energieplankarte', 'energie', 'geoportal', 'fernwarme', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-25T03:09:55.970613`
