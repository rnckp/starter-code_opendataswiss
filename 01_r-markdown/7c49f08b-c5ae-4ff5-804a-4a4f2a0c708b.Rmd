...
- **Keywords.de** `['erneuerbar-heizen', 'punktdaten', 'liniendaten', 'netto-null', 'kehrichtheizkraftwerk', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'stzh', 'holzheizkraftwerk', 'geodaten', 'fernwarme', 'energie', 'heizen', 'polygondaten', 'geoportal', 'klarwerk', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'energieplanung', 'energieplankarte', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-03-08T03:06:39.804898`
