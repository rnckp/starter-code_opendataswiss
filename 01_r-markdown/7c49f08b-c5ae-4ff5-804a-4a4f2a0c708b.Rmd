...
- **Keywords.de** `['fernwarme', 'punktdaten', 'netto-null', 'energieplanung', 'kehrichtheizkraftwerk', 'liniendaten', 'kalteversorgung', 'vektordaten', 'heizen', 'erneuerbar-heizen', 'energieplankarte', 'warmeversorgung', 'geoportal', 'geodaten', 'leitungsgebundene-energieversorgung', 'energie', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'stzh', 'polygondaten', 'klarwerk', 'fernwarmeversorgung', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-11T03:27:01.315272`
