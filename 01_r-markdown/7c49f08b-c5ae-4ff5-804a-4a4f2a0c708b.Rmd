...
- **Keywords.de** `['energie', 'energie-aus-gereinigtem-abwasser', 'heizen', 'energieplanung', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'fernwarmeversorgung', 'geoportal', 'netto-null', 'polygondaten', 'vektordaten', 'erneuerbar-heizen', 'klarwerk', 'fernwarme', 'kalteversorgung', 'geodaten', 'stzh', 'liniendaten', 'kehrichtheizkraftwerk', 'punktdaten', 'holzheizkraftwerk', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-05T03:26:36.829510`
