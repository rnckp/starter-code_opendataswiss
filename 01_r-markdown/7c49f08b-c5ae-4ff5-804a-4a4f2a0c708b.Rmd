...
- **Keywords.de** `['stzh', 'polygondaten', 'energieplankarte', 'kehrichtheizkraftwerk', 'energie', 'warmeversorgung', 'heizen', 'geoportal', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'holzheizkraftwerk', 'netto-null', 'fernwarme', 'punktdaten', 'leitungsgebundene-energieversorgung', 'energieplanung', 'energieversorgung', 'vektordaten', 'klarwerk', 'erneuerbar-heizen', 'liniendaten', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-29T02:31:23.487893`
