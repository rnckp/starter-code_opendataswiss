...
- **Keywords.de** `['polygondaten', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'fernwarme', 'warmeversorgung', 'netto-null', 'kalteversorgung', 'heizen', 'punktdaten', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'geoportal', 'stzh', 'erneuerbar-heizen', 'vektordaten', 'klarwerk', 'fernwarmeversorgung', 'energieplanung', 'energieplankarte', 'holzheizkraftwerk', 'energie', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-07T04:33:30.583796`
