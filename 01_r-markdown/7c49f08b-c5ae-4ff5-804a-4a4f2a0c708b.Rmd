...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'stzh', 'heizen', 'leitungsgebundene-energieversorgung', 'geodaten', 'erneuerbar-heizen', 'polygondaten', 'holzheizkraftwerk', 'energieplanung', 'kalteversorgung', 'klarwerk', 'warmeversorgung', 'liniendaten', 'energie', 'geoportal', 'energieversorgung', 'vektordaten', 'energieplankarte', 'fernwarme', 'kehrichtheizkraftwerk', 'punktdaten', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-26T03:09:13.673754`
