...
- **Keywords.de** `['geodaten', 'energie', 'polygondaten', 'geoportal', 'netto-null', 'punktdaten', 'klarwerk', 'energieplanung', 'holzheizkraftwerk', 'vektordaten', 'kehrichtheizkraftwerk', 'heizen', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'liniendaten', 'fernwarme', 'energieplankarte', 'fernwarmeversorgung', 'stzh', 'energieversorgung', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-17T03:31:47.686448`
