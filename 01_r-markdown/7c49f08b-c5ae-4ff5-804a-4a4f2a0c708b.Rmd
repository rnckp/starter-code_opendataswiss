...
- **Keywords.de** `['heizen', 'netto-null', 'energieplanung', 'energieversorgung', 'stzh', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'fernwarmeversorgung', 'liniendaten', 'geoportal', 'warmeversorgung', 'kehrichtheizkraftwerk', 'kalteversorgung', 'punktdaten', 'polygondaten', 'geodaten', 'erneuerbar-heizen', 'energieplankarte', 'holzheizkraftwerk', 'fernwarme', 'leitungsgebundene-energieversorgung', 'vektordaten', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-23T03:18:57.215506`
