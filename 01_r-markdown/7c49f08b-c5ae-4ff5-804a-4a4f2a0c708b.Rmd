...
- **Keywords.de** `['kalteversorgung', 'netto-null', 'energie', 'energieversorgung', 'liniendaten', 'stzh', 'energieplankarte', 'fernwarmeversorgung', 'polygondaten', 'erneuerbar-heizen', 'warmeversorgung', 'geoportal', 'holzheizkraftwerk', 'geodaten', 'leitungsgebundene-energieversorgung', 'klarwerk', 'vektordaten', 'kehrichtheizkraftwerk', 'energieplanung', 'fernwarme', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-08T03:11:38.040012`
