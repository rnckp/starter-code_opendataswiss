...
- **Keywords.de** `['kalteversorgung', 'liniendaten', 'geodaten', 'energieversorgung', 'kehrichtheizkraftwerk', 'heizen', 'klarwerk', 'energieplankarte', 'fernwarme', 'energie', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'stzh', 'fernwarmeversorgung', 'energieplanung', 'geoportal', 'polygondaten', 'vektordaten', 'warmeversorgung', 'erneuerbar-heizen', 'netto-null', 'punktdaten', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-13T02:33:05.184208`
