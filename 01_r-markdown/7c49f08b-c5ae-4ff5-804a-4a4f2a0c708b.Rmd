...
- **Keywords.de** `['energieplanung', 'holzheizkraftwerk', 'energieversorgung', 'geoportal', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'energie', 'fernwarme', 'energieplankarte', 'polygondaten', 'netto-null', 'liniendaten', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'klarwerk', 'kehrichtheizkraftwerk', 'kalteversorgung', 'warmeversorgung', 'stzh', 'geodaten', 'heizen', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-23T03:03:27.993410`
