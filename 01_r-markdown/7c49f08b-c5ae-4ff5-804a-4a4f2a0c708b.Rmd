...
- **Keywords.de** `['energie', 'energieplankarte', 'stzh', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'energieversorgung', 'geoportal', 'erneuerbar-heizen', 'netto-null', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'heizen', 'punktdaten', 'fernwarme', 'geodaten', 'vektordaten', 'leitungsgebundene-energieversorgung', 'polygondaten', 'kalteversorgung', 'klarwerk', 'energieplanung', 'holzheizkraftwerk', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-04T03:47:22.177235`
