...
- **Keywords.de** `['energieversorgung', 'energieplanung', 'geoportal', 'liniendaten', 'holzheizkraftwerk', 'netto-null', 'kalteversorgung', 'kehrichtheizkraftwerk', 'punktdaten', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'vektordaten', 'klarwerk', 'fernwarme', 'heizen', 'stzh', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'warmeversorgung', 'geodaten', 'energie', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-30T03:44:36.869906`
