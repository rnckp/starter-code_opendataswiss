...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'fernwarme', 'energie', 'netto-null', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'warmeversorgung', 'fernwarmeversorgung', 'stzh', 'erneuerbar-heizen', 'energieversorgung', 'energieplanung', 'kalteversorgung', 'klarwerk', 'liniendaten', 'punktdaten', 'energieplankarte', 'holzheizkraftwerk', 'geoportal', 'polygondaten', 'heizen', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-25T04:29:07.485363`
