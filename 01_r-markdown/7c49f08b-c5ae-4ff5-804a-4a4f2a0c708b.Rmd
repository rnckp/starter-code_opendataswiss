...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'kalteversorgung', 'geoportal', 'warmeversorgung', 'fernwarmeversorgung', 'energieplankarte', 'stzh', 'klarwerk', 'energieplanung', 'fernwarme', 'vektordaten', 'heizen', 'liniendaten', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'energie', 'energieversorgung', 'netto-null', 'geodaten', 'erneuerbar-heizen', 'holzheizkraftwerk', 'punktdaten', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-04T03:28:22.161802`
