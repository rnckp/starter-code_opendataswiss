...
- **Keywords.de** `['geoportal', 'netto-null', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'holzheizkraftwerk', 'heizen', 'energieplanung', 'liniendaten', 'fernwarme', 'erneuerbar-heizen', 'warmeversorgung', 'punktdaten', 'polygondaten', 'kalteversorgung', 'kehrichtheizkraftwerk', 'energieplankarte', 'stzh', 'energie', 'leitungsgebundene-energieversorgung', 'vektordaten', 'energieversorgung', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-24T03:21:48.585214`
