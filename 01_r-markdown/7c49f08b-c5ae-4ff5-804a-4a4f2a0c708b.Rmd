...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'energieversorgung', 'fernwarmeversorgung', 'liniendaten', 'geoportal', 'kalteversorgung', 'heizen', 'leitungsgebundene-energieversorgung', 'polygondaten', 'stzh', 'punktdaten', 'warmeversorgung', 'netto-null', 'erneuerbar-heizen', 'energie', 'vektordaten', 'kehrichtheizkraftwerk', 'klarwerk', 'energieplankarte', 'energieplanung', 'geodaten', 'holzheizkraftwerk', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-12T03:19:07.488314`
