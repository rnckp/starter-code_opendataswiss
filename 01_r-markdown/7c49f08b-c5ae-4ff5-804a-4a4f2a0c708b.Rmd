...
- **Keywords.de** `['holzheizkraftwerk', 'geodaten', 'energieplanung', 'energie', 'kehrichtheizkraftwerk', 'fernwarme', 'stzh', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'geoportal', 'klarwerk', 'energieversorgung', 'polygondaten', 'liniendaten', 'erneuerbar-heizen', 'energieplankarte', 'netto-null', 'heizen', 'fernwarmeversorgung', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-09T03:30:57.925283`
