...
- **Keywords.de** `['energieplankarte', 'kehrichtheizkraftwerk', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'fernwarmeversorgung', 'fernwarme', 'energieplanung', 'warmeversorgung', 'geodaten', 'punktdaten', 'polygondaten', 'energie', 'kalteversorgung', 'liniendaten', 'stzh', 'erneuerbar-heizen', 'vektordaten', 'klarwerk', 'heizen', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-24T03:56:03.454787`
