...
- **Keywords.de** `['fernwarmeversorgung', 'polygondaten', 'punktdaten', 'holzheizkraftwerk', 'energieplankarte', 'kalteversorgung', 'energieversorgung', 'netto-null', 'fernwarme', 'stzh', 'geodaten', 'warmeversorgung', 'geoportal', 'energie', 'vektordaten', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'heizen', 'liniendaten', 'kehrichtheizkraftwerk', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-01T03:41:54.469285`
