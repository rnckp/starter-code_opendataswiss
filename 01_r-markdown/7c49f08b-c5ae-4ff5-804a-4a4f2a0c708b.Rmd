...
- **Keywords.de** `['energieplankarte', 'punktdaten', 'energie', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'stzh', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'polygondaten', 'erneuerbar-heizen', 'energieplanung', 'leitungsgebundene-energieversorgung', 'klarwerk', 'energieversorgung', 'fernwarme', 'geoportal', 'warmeversorgung', 'vektordaten', 'heizen', 'geodaten', 'kalteversorgung', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-19T03:37:28.327590`
