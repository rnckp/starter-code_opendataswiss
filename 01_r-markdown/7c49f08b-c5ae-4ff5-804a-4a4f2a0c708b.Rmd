...
- **Keywords.de** `['fernwarmeversorgung', 'energieplanung', 'heizen', 'erneuerbar-heizen', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'energieplankarte', 'liniendaten', 'energieversorgung', 'geodaten', 'stzh', 'warmeversorgung', 'polygondaten', 'holzheizkraftwerk', 'energie', 'kehrichtheizkraftwerk', 'punktdaten', 'klarwerk', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-22T03:03:41.939810`
