...
- **Keywords.de** `['geoportal', 'holzheizkraftwerk', 'erneuerbar-heizen', 'geodaten', 'punktdaten', 'heizen', 'vektordaten', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'fernwarme', 'liniendaten', 'fernwarmeversorgung', 'stzh', 'kehrichtheizkraftwerk', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'energieplankarte', 'klarwerk', 'energie', 'netto-null', 'kalteversorgung', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-06T03:27:36.744819`
