...
- **Keywords.de** `['punktdaten', 'warmeversorgung', 'energieplanung', 'energie', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'polygondaten', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'fernwarme', 'liniendaten', 'vektordaten', 'heizen', 'geodaten', 'kehrichtheizkraftwerk', 'energieversorgung', 'fernwarmeversorgung', 'netto-null', 'erneuerbar-heizen', 'klarwerk', 'energieplankarte', 'stzh', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-20T04:15:46.445069`
