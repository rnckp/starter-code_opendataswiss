...
- **Keywords.de** `['fernwarmeversorgung', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'energieplanung', 'kehrichtheizkraftwerk', 'geodaten', 'liniendaten', 'stzh', 'leitungsgebundene-energieversorgung', 'klarwerk', 'holzheizkraftwerk', 'geoportal', 'polygondaten', 'vektordaten', 'warmeversorgung', 'fernwarme', 'heizen', 'energieversorgung', 'netto-null', 'energieplankarte', 'kalteversorgung', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-21T03:54:04.852777`
