...
- **Keywords.de** `['fernwarmeversorgung', 'polygondaten', 'holzheizkraftwerk', 'energie', 'energieplanung', 'heizen', 'kalteversorgung', 'liniendaten', 'klarwerk', 'geodaten', 'geoportal', 'fernwarme', 'netto-null', 'warmeversorgung', 'energieplankarte', 'energieversorgung', 'stzh', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'punktdaten', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-02T03:20:19.642601`
