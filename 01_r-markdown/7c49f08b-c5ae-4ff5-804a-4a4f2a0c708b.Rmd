...
- **Keywords.de** `['warmeversorgung', 'kalteversorgung', 'liniendaten', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'klarwerk', 'stzh', 'holzheizkraftwerk', 'heizen', 'leitungsgebundene-energieversorgung', 'polygondaten', 'fernwarme', 'energie', 'vektordaten', 'fernwarmeversorgung', 'energieversorgung', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'punktdaten', 'energieplanung', 'energieplankarte', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-19T04:08:07.546234`
