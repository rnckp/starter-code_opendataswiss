...
- **Keywords.de** `['stzh', 'fernwarme', 'klarwerk', 'geodaten', 'energieplanung', 'energieplankarte', 'netto-null', 'polygondaten', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'vektordaten', 'leitungsgebundene-energieversorgung', 'energie', 'holzheizkraftwerk', 'warmeversorgung', 'heizen', 'energieversorgung', 'kalteversorgung', 'punktdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-21T03:18:14.460132`
