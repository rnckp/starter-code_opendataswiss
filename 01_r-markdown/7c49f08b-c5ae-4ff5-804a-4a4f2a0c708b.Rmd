...
- **Keywords.de** `['holzheizkraftwerk', 'geodaten', 'kehrichtheizkraftwerk', 'punktdaten', 'energie', 'warmeversorgung', 'kalteversorgung', 'stzh', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'geoportal', 'fernwarmeversorgung', 'heizen', 'netto-null', 'energieplanung', 'energieversorgung', 'fernwarme', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'energieplankarte', 'klarwerk', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-17T03:53:35.118039`
