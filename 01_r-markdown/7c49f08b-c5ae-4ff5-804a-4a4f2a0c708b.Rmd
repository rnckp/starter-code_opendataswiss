...
- **Keywords.de** `['vektordaten', 'liniendaten', 'geoportal', 'energieplankarte', 'warmeversorgung', 'energieversorgung', 'stzh', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'kehrichtheizkraftwerk', 'geodaten', 'energieplanung', 'polygondaten', 'fernwarmeversorgung', 'punktdaten', 'erneuerbar-heizen', 'fernwarme', 'leitungsgebundene-energieversorgung', 'heizen', 'netto-null', 'holzheizkraftwerk', 'klarwerk', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-28T03:51:02.615443`
