...
- **Keywords.de** `['punktdaten', 'energie', 'fernwarmeversorgung', 'fernwarme', 'kehrichtheizkraftwerk', 'energieversorgung', 'stzh', 'liniendaten', 'polygondaten', 'heizen', 'klarwerk', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'geodaten', 'warmeversorgung', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'netto-null', 'kalteversorgung', 'energieplanung', 'erneuerbar-heizen', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-14T04:09:45.770255`
