...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'klarwerk', 'energieversorgung', 'liniendaten', 'punktdaten', 'geodaten', 'energieplanung', 'geoportal', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'vektordaten', 'kalteversorgung', 'erneuerbar-heizen', 'stzh', 'netto-null', 'fernwarmeversorgung', 'heizen', 'energieplankarte', 'holzheizkraftwerk', 'energie', 'fernwarme', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-28T03:06:01.277679`
