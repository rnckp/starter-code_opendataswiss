...
- **Keywords.de** `['heizen', 'stzh', 'kehrichtheizkraftwerk', 'energie', 'geoportal', 'netto-null', 'liniendaten', 'erneuerbar-heizen', 'energieplankarte', 'geodaten', 'energieversorgung', 'kalteversorgung', 'polygondaten', 'fernwarme', 'vektordaten', 'fernwarmeversorgung', 'energieplanung', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'punktdaten', 'warmeversorgung', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-05T03:05:09.695183`
