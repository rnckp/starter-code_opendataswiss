...
- **Keywords.de** `['fernwarmeversorgung', 'geodaten', 'geoportal', 'stzh', 'energie', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'polygondaten', 'energieplankarte', 'punktdaten', 'kalteversorgung', 'kehrichtheizkraftwerk', 'fernwarme', 'erneuerbar-heizen', 'netto-null', 'vektordaten', 'klarwerk', 'holzheizkraftwerk', 'warmeversorgung', 'liniendaten', 'heizen', 'energieversorgung', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-18T03:10:10.338859`
