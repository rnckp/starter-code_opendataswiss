...
- **Keywords.de** `['liniendaten', 'energie-aus-gereinigtem-abwasser', 'heizen', 'klarwerk', 'energieplanung', 'warmeversorgung', 'vektordaten', 'geoportal', 'geodaten', 'fernwarme', 'fernwarmeversorgung', 'energie', 'leitungsgebundene-energieversorgung', 'stzh', 'punktdaten', 'netto-null', 'erneuerbar-heizen', 'energieplankarte', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'energieversorgung', 'kalteversorgung', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-21T03:25:55.529527`
