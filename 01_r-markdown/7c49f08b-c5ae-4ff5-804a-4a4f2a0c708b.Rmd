...
- **Keywords.de** `['fernwarme', 'stzh', 'fernwarmeversorgung', 'geoportal', 'liniendaten', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'netto-null', 'polygondaten', 'vektordaten', 'heizen', 'warmeversorgung', 'kalteversorgung', 'kehrichtheizkraftwerk', 'energie', 'punktdaten', 'energieversorgung', 'klarwerk', 'energieplankarte', 'erneuerbar-heizen', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-14T03:51:37.484695`
