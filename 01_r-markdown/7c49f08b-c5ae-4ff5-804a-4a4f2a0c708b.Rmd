...
- **Keywords.de** `['energieversorgung', 'geodaten', 'stzh', 'erneuerbar-heizen', 'liniendaten', 'polygondaten', 'fernwarme', 'kalteversorgung', 'geoportal', 'vektordaten', 'energieplankarte', 'heizen', 'fernwarmeversorgung', 'klarwerk', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'netto-null', 'punktdaten', 'energieplanung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-06T03:30:57.021026`
