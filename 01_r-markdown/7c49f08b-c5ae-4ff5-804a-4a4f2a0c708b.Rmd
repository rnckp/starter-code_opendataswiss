...
- **Keywords.de** `['energie', 'kehrichtheizkraftwerk', 'vektordaten', 'energieplanung', 'polygondaten', 'heizen', 'energieplankarte', 'stzh', 'fernwarme', 'geoportal', 'klarwerk', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'warmeversorgung', 'kalteversorgung', 'netto-null', 'geodaten', 'liniendaten', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-31T03:22:16.733823`
