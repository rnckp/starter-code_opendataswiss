...
- **Keywords.de** `['kalteversorgung', 'energie', 'warmeversorgung', 'vektordaten', 'geoportal', 'punktdaten', 'energieversorgung', 'erneuerbar-heizen', 'fernwarmeversorgung', 'klarwerk', 'geodaten', 'stzh', 'kehrichtheizkraftwerk', 'polygondaten', 'holzheizkraftwerk', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'fernwarme', 'heizen', 'netto-null', 'energieplanung', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-16T03:15:09.262296`
