...
- **Keywords.de** `['geodaten', 'kalteversorgung', 'fernwarmeversorgung', 'energieplankarte', 'polygondaten', 'geoportal', 'holzheizkraftwerk', 'vektordaten', 'punktdaten', 'kehrichtheizkraftwerk', 'warmeversorgung', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'stzh', 'erneuerbar-heizen', 'energieplanung', 'leitungsgebundene-energieversorgung', 'klarwerk', 'energie', 'netto-null', 'energieversorgung', 'heizen', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-23T03:09:03.359475`
