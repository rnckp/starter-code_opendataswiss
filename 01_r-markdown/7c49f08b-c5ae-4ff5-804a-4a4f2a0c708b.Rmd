...
- **Keywords.de** `['liniendaten', 'energie', 'warmeversorgung', 'fernwarme', 'fernwarmeversorgung', 'polygondaten', 'leitungsgebundene-energieversorgung', 'punktdaten', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'stzh', 'holzheizkraftwerk', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'energieplanung', 'kalteversorgung', 'netto-null', 'geoportal', 'klarwerk', 'energieversorgung', 'geodaten', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-30T03:34:19.628413`
