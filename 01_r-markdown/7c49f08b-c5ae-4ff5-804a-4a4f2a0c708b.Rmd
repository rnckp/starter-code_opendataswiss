...
- **Keywords.de** `['netto-null', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'energie', 'fernwarme', 'kalteversorgung', 'energieversorgung', 'stzh', 'heizen', 'energieplanung', 'geoportal', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'liniendaten', 'warmeversorgung', 'polygondaten', 'energieplankarte', 'klarwerk', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-01T03:37:31.944473`
