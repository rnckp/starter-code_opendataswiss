...
- **Keywords.de** `['kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'geoportal', 'heizen', 'stzh', 'energieversorgung', 'liniendaten', 'geodaten', 'energieplankarte', 'energieplanung', 'fernwarmeversorgung', 'energie', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'netto-null', 'polygondaten', 'punktdaten', 'vektordaten', 'klarwerk', 'holzheizkraftwerk', 'erneuerbar-heizen', 'fernwarme', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-14T03:12:46.573956`
