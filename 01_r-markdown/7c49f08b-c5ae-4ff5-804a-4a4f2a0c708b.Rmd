...
- **Keywords.de** `['kehrichtheizkraftwerk', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'geoportal', 'liniendaten', 'erneuerbar-heizen', 'energie', 'netto-null', 'fernwarmeversorgung', 'klarwerk', 'warmeversorgung', 'heizen', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'stzh', 'geodaten', 'energieplanung', 'energieversorgung', 'energieplankarte', 'holzheizkraftwerk', 'vektordaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-29T03:02:20.830781`
