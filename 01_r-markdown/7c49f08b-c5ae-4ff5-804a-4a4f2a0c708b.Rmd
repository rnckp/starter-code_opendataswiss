...
- **Keywords.de** `['warmeversorgung', 'stzh', 'fernwarmeversorgung', 'holzheizkraftwerk', 'netto-null', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'heizen', 'polygondaten', 'geoportal', 'erneuerbar-heizen', 'energie', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'energieversorgung', 'energieplanung', 'fernwarme', 'kalteversorgung', 'kehrichtheizkraftwerk', 'punktdaten', 'liniendaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-11T03:02:48.026573`
