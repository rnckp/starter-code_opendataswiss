...
- **Keywords.de** `['warmeversorgung', 'holzheizkraftwerk', 'vektordaten', 'liniendaten', 'kalteversorgung', 'klarwerk', 'polygondaten', 'heizen', 'fernwarmeversorgung', 'punktdaten', 'energieplanung', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'geoportal', 'kehrichtheizkraftwerk', 'energieversorgung', 'energie', 'netto-null', 'energieplankarte', 'erneuerbar-heizen', 'fernwarme', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-18T03:11:02.756794`
