...
- **Keywords.de** `['fernwarme', 'kalteversorgung', 'heizen', 'holzheizkraftwerk', 'polygondaten', 'klarwerk', 'kehrichtheizkraftwerk', 'punktdaten', 'liniendaten', 'fernwarmeversorgung', 'energieplanung', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'erneuerbar-heizen', 'stzh', 'vektordaten', 'energie', 'geodaten', 'geoportal', 'energieversorgung', 'energieplankarte', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-18T02:12:44.786180`
