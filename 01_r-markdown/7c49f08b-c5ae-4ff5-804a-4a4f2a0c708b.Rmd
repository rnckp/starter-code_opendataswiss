...
- **Keywords.de** `['energie', 'kehrichtheizkraftwerk', 'kalteversorgung', 'heizen', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'netto-null', 'punktdaten', 'fernwarmeversorgung', 'polygondaten', 'stzh', 'energieplankarte', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'fernwarme', 'geoportal', 'warmeversorgung', 'vektordaten', 'geodaten', 'klarwerk', 'energieplanung', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-22T03:40:42.057590`
