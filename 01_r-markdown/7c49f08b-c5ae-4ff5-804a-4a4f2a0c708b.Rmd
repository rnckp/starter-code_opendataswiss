...
- **Keywords.de** `['geodaten', 'leitungsgebundene-energieversorgung', 'energieplanung', 'fernwarme', 'geoportal', 'fernwarmeversorgung', 'vektordaten', 'heizen', 'stzh', 'energie', 'punktdaten', 'netto-null', 'klarwerk', 'kalteversorgung', 'energieversorgung', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'warmeversorgung', 'polygondaten', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-15T03:35:54.329784`
