...
- **Keywords.de** `['fernwarmeversorgung', 'energieplanung', 'holzheizkraftwerk', 'energieplankarte', 'heizen', 'warmeversorgung', 'vektordaten', 'liniendaten', 'polygondaten', 'erneuerbar-heizen', 'energieversorgung', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'leitungsgebundene-energieversorgung', 'fernwarme', 'netto-null', 'kalteversorgung', 'stzh', 'kehrichtheizkraftwerk', 'geoportal', 'energie', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-15T03:02:00.689989`
