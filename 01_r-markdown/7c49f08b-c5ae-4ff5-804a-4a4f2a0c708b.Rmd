...
- **Keywords.de** `['warmeversorgung', 'energieplanung', 'holzheizkraftwerk', 'energie', 'fernwarmeversorgung', 'energieplankarte', 'energieversorgung', 'polygondaten', 'netto-null', 'geoportal', 'fernwarme', 'geodaten', 'heizen', 'punktdaten', 'klarwerk', 'kalteversorgung', 'liniendaten', 'leitungsgebundene-energieversorgung', 'stzh', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-30T03:13:52.688446`
