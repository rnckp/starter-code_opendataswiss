...
- **Keywords.de** `['stzh', 'vektordaten', 'energieplankarte', 'klarwerk', 'heizen', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'energieplanung', 'geodaten', 'liniendaten', 'punktdaten', 'kalteversorgung', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'energie', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'polygondaten', 'netto-null', 'geoportal', 'fernwarme', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-30T03:28:41.687915`
