...
- **Keywords.de** `['kalteversorgung', 'punktdaten', 'liniendaten', 'holzheizkraftwerk', 'energieplanung', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'warmeversorgung', 'energieplankarte', 'klarwerk', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'energie', 'geoportal', 'netto-null', 'energieversorgung', 'geodaten', 'stzh', 'leitungsgebundene-energieversorgung', 'heizen', 'polygondaten', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-04T02:58:35.893554`
