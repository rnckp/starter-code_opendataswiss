...
- **Keywords.de** `['energieversorgung', 'liniendaten', 'netto-null', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'energie', 'stzh', 'kehrichtheizkraftwerk', 'polygondaten', 'fernwarmeversorgung', 'energieplanung', 'erneuerbar-heizen', 'kalteversorgung', 'punktdaten', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'holzheizkraftwerk', 'fernwarme', 'energieplankarte', 'geodaten', 'vektordaten', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-22T03:24:16.196977`
