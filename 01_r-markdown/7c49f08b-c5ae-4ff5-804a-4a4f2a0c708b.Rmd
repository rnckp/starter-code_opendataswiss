...
- **Keywords.de** `['kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'heizen', 'netto-null', 'liniendaten', 'warmeversorgung', 'fernwarmeversorgung', 'energie', 'stzh', 'vektordaten', 'kalteversorgung', 'energieplankarte', 'erneuerbar-heizen', 'polygondaten', 'punktdaten', 'energieversorgung', 'geodaten', 'energieplanung', 'holzheizkraftwerk', 'geoportal', 'fernwarme', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-17T02:53:42.840960`
