...
- **Keywords.de** `['stzh', 'energieversorgung', 'fernwarmeversorgung', 'geoportal', 'energie', 'netto-null', 'fernwarme', 'erneuerbar-heizen', 'energieplankarte', 'kalteversorgung', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'heizen', 'kehrichtheizkraftwerk', 'punktdaten', 'polygondaten', 'klarwerk', 'geodaten', 'energieplanung', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-03T03:17:03.242741`
