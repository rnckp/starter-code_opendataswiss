...
- **Keywords.de** `['stzh', 'fernwarmeversorgung', 'energie', 'klarwerk', 'erneuerbar-heizen', 'energieplanung', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'heizen', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'geodaten', 'netto-null', 'energieversorgung', 'punktdaten', 'holzheizkraftwerk', 'vektordaten', 'geoportal', 'polygondaten', 'fernwarme', 'kalteversorgung', 'warmeversorgung', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-08T02:54:37.133131`
