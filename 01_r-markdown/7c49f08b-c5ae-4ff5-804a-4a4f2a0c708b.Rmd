...
- **Keywords.de** `['netto-null', 'kehrichtheizkraftwerk', 'energieversorgung', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'punktdaten', 'erneuerbar-heizen', 'holzheizkraftwerk', 'kalteversorgung', 'energie', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'geoportal', 'fernwarme', 'fernwarmeversorgung', 'energieplanung', 'klarwerk', 'polygondaten', 'heizen', 'warmeversorgung', 'vektordaten', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-10T02:56:16.289663`
