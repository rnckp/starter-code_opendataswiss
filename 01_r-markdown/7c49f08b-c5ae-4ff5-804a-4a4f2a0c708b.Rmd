...
- **Keywords.de** `['punktdaten', 'heizen', 'erneuerbar-heizen', 'vektordaten', 'netto-null', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'warmeversorgung', 'kehrichtheizkraftwerk', 'liniendaten', 'polygondaten', 'fernwarme', 'energie', 'energieplanung', 'energieplankarte', 'geodaten', 'stzh', 'klarwerk', 'geoportal', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-25T02:53:42.039901`
