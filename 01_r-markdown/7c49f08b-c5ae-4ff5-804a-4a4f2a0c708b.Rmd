...
- **Keywords.de** `['geoportal', 'holzheizkraftwerk', 'liniendaten', 'warmeversorgung', 'klarwerk', 'polygondaten', 'stzh', 'erneuerbar-heizen', 'fernwarmeversorgung', 'energieplankarte', 'energieversorgung', 'heizen', 'kalteversorgung', 'kehrichtheizkraftwerk', 'punktdaten', 'fernwarme', 'energie', 'netto-null', 'vektordaten', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-26T03:26:21.210249`
