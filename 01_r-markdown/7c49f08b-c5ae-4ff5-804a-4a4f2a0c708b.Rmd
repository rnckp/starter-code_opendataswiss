...
- **Keywords.de** `['energieversorgung', 'vektordaten', 'klarwerk', 'geodaten', 'polygondaten', 'punktdaten', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'stzh', 'netto-null', 'energieplanung', 'heizen', 'liniendaten', 'fernwarme', 'erneuerbar-heizen', 'energie', 'leitungsgebundene-energieversorgung', 'geoportal', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'energieplankarte', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-08T05:29:08.222659`
