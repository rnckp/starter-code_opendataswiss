...
- **Keywords.de** `['liniendaten', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'punktdaten', 'energieplankarte', 'holzheizkraftwerk', 'fernwarme', 'erneuerbar-heizen', 'heizen', 'energieplanung', 'stzh', 'fernwarmeversorgung', 'netto-null', 'klarwerk', 'vektordaten', 'kalteversorgung', 'energie', 'geodaten', 'warmeversorgung', 'polygondaten', 'geoportal', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-13T03:00:12.904020`
