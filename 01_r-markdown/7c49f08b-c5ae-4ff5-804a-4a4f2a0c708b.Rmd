...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'netto-null', 'punktdaten', 'energieversorgung', 'holzheizkraftwerk', 'erneuerbar-heizen', 'fernwarmeversorgung', 'polygondaten', 'liniendaten', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'heizen', 'vektordaten', 'geodaten', 'energie', 'fernwarme', 'kehrichtheizkraftwerk', 'klarwerk', 'energieplanung', 'kalteversorgung', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-26T03:20:46.108810`
