...
- **Keywords.de** `['klarwerk', 'kehrichtheizkraftwerk', 'stzh', 'liniendaten', 'netto-null', 'energieversorgung', 'polygondaten', 'vektordaten', 'heizen', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'energieplanung', 'warmeversorgung', 'energie', 'holzheizkraftwerk', 'erneuerbar-heizen', 'geodaten', 'geoportal', 'fernwarmeversorgung', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-09T03:24:29.887728`
