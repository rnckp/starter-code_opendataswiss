...
- **Keywords.de** `['kalteversorgung', 'fernwarme', 'punktdaten', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'energieversorgung', 'heizen', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'netto-null', 'fernwarmeversorgung', 'holzheizkraftwerk', 'klarwerk', 'stzh', 'energie', 'polygondaten', 'kehrichtheizkraftwerk', 'vektordaten', 'erneuerbar-heizen', 'energieplankarte', 'liniendaten', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-28T03:08:59.068551`
