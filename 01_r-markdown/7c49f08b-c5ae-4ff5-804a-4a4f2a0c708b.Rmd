...
- **Keywords.de** `['punktdaten', 'kalteversorgung', 'liniendaten', 'energieversorgung', 'vektordaten', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'geoportal', 'leitungsgebundene-energieversorgung', 'klarwerk', 'energieplanung', 'kehrichtheizkraftwerk', 'energie', 'geodaten', 'fernwarme', 'heizen', 'warmeversorgung', 'erneuerbar-heizen', 'fernwarmeversorgung', 'stzh', 'holzheizkraftwerk', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-13T03:41:05.952734`
