...
- **Keywords.de** `['erneuerbar-heizen', 'kehrichtheizkraftwerk', 'warmeversorgung', 'energieplankarte', 'kalteversorgung', 'polygondaten', 'vektordaten', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'heizen', 'energieplanung', 'fernwarme', 'geoportal', 'stzh', 'geodaten', 'energie', 'punktdaten', 'holzheizkraftwerk', 'klarwerk', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-27T03:21:11.353615`
