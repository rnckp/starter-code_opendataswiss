...
- **Keywords.de** `['heizen', 'netto-null', 'fernwarmeversorgung', 'warmeversorgung', 'punktdaten', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'kalteversorgung', 'fernwarme', 'energie', 'geodaten', 'holzheizkraftwerk', 'energieplanung', 'energieplankarte', 'polygondaten', 'vektordaten', 'erneuerbar-heizen', 'geoportal', 'liniendaten', 'klarwerk', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-23T04:51:41.882222`
