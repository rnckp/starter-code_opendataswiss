...
- **Keywords.de** `['erneuerbar-heizen', 'energieplanung', 'vektordaten', 'heizen', 'energie', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'polygondaten', 'liniendaten', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'netto-null', 'geodaten', 'kalteversorgung', 'energieplankarte', 'punktdaten', 'fernwarmeversorgung', 'stzh', 'fernwarme', 'energieversorgung', 'geoportal', 'warmeversorgung', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-21T03:26:58.328653`
