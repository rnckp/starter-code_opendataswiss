...
- **Keywords.de** `['erneuerbar-heizen', 'energieplanung', 'geoportal', 'heizen', 'klarwerk', 'kalteversorgung', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'liniendaten', 'fernwarmeversorgung', 'stzh', 'polygondaten', 'energie', 'geodaten', 'energieversorgung', 'fernwarme', 'kehrichtheizkraftwerk', 'netto-null', 'warmeversorgung', 'energieplankarte', 'punktdaten', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-06T03:15:05.566124`
