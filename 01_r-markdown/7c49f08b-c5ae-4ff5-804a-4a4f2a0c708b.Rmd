...
- **Keywords.de** `['kehrichtheizkraftwerk', 'geoportal', 'energie', 'vektordaten', 'fernwarmeversorgung', 'energieversorgung', 'polygondaten', 'warmeversorgung', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'punktdaten', 'klarwerk', 'stzh', 'netto-null', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'kalteversorgung', 'energieplanung', 'heizen', 'erneuerbar-heizen', 'fernwarme', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-07T03:22:13.132193`
