...
- **Keywords.de** `['heizen', 'punktdaten', 'kalteversorgung', 'geodaten', 'leitungsgebundene-energieversorgung', 'vektordaten', 'fernwarmeversorgung', 'energie', 'energieplanung', 'fernwarme', 'netto-null', 'stzh', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'energieversorgung', 'polygondaten', 'energieplankarte', 'geoportal', 'erneuerbar-heizen', 'liniendaten', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-11T03:16:59.679646`
