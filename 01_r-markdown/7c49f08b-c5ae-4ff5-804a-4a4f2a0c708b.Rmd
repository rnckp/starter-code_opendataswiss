...
- **Keywords.de** `['fernwarmeversorgung', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'holzheizkraftwerk', 'energie', 'energieplankarte', 'energieversorgung', 'heizen', 'stzh', 'erneuerbar-heizen', 'netto-null', 'liniendaten', 'warmeversorgung', 'fernwarme', 'klarwerk', 'geodaten', 'energieplanung', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'punktdaten', 'geoportal', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-16T03:19:27.772158`
