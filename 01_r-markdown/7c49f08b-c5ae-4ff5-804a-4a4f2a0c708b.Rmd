...
- **Keywords.de** `['vektordaten', 'heizen', 'kalteversorgung', 'fernwarme', 'fernwarmeversorgung', 'polygondaten', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'energie', 'energieplanung', 'holzheizkraftwerk', 'geoportal', 'kehrichtheizkraftwerk', 'warmeversorgung', 'punktdaten', 'klarwerk', 'netto-null', 'stzh', 'liniendaten', 'energieplankarte', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-25T03:33:28.971961`
