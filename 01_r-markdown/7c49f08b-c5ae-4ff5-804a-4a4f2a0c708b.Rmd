...
- **Keywords.de** `['energieplankarte', 'warmeversorgung', 'erneuerbar-heizen', 'geoportal', 'netto-null', 'fernwarme', 'kehrichtheizkraftwerk', 'energie', 'liniendaten', 'kalteversorgung', 'heizen', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'energieplanung', 'holzheizkraftwerk', 'punktdaten', 'stzh', 'polygondaten', 'energieversorgung', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'klarwerk', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-07T03:24:33.379608`
