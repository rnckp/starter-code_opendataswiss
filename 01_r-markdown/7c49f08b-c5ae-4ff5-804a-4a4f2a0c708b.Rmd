...
- **Keywords.de** `['kehrichtheizkraftwerk', 'liniendaten', 'erneuerbar-heizen', 'holzheizkraftwerk', 'energieversorgung', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'kalteversorgung', 'geoportal', 'energieplankarte', 'warmeversorgung', 'klarwerk', 'netto-null', 'fernwarmeversorgung', 'punktdaten', 'leitungsgebundene-energieversorgung', 'energie', 'vektordaten', 'heizen', 'geodaten', 'energieplanung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-04T04:09:31.612692`
