...
- **Keywords.de** `['stzh', 'erneuerbar-heizen', 'netto-null', 'holzheizkraftwerk', 'energieplanung', 'heizen', 'polygondaten', 'energieversorgung', 'vektordaten', 'liniendaten', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'klarwerk', 'energie', 'punktdaten', 'fernwarmeversorgung', 'fernwarme', 'geoportal', 'geodaten', 'warmeversorgung', 'energieplankarte', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-26T02:39:29.927165`
