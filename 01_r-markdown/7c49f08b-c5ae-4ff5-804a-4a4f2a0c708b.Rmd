...
- **Keywords.de** `['holzheizkraftwerk', 'geoportal', 'heizen', 'liniendaten', 'energieplanung', 'kehrichtheizkraftwerk', 'punktdaten', 'energie', 'kalteversorgung', 'klarwerk', 'vektordaten', 'erneuerbar-heizen', 'energieplankarte', 'fernwarme', 'geodaten', 'polygondaten', 'fernwarmeversorgung', 'stzh', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'netto-null', 'energieversorgung', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-23T03:10:47.971696`
