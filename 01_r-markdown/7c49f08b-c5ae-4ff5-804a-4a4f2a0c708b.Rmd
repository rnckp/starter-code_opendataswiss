...
- **Keywords.de** `['warmeversorgung', 'geodaten', 'energieplankarte', 'erneuerbar-heizen', 'heizen', 'fernwarme', 'klarwerk', 'kehrichtheizkraftwerk', 'kalteversorgung', 'vektordaten', 'energie', 'holzheizkraftwerk', 'polygondaten', 'fernwarmeversorgung', 'stzh', 'leitungsgebundene-energieversorgung', 'liniendaten', 'geoportal', 'punktdaten', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-20T02:48:00.936967`
