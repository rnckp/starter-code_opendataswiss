...
- **Keywords.de** `['geoportal', 'geodaten', 'heizen', 'polygondaten', 'kehrichtheizkraftwerk', 'energieplanung', 'liniendaten', 'erneuerbar-heizen', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'klarwerk', 'fernwarmeversorgung', 'punktdaten', 'kalteversorgung', 'vektordaten', 'fernwarme', 'energie', 'stzh', 'holzheizkraftwerk', 'netto-null', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-04T03:25:44.479019`
