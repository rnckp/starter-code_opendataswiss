...
- **Keywords.de** `['fernwarme', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'energie', 'kehrichtheizkraftwerk', 'polygondaten', 'geoportal', 'netto-null', 'energieversorgung', 'vektordaten', 'geodaten', 'stzh', 'fernwarmeversorgung', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'liniendaten', 'warmeversorgung', 'energieplankarte', 'erneuerbar-heizen', 'punktdaten', 'kalteversorgung', 'klarwerk', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-03-12T03:21:29.196446`
