...
- **Keywords.de** `['warmeversorgung', 'klarwerk', 'kalteversorgung', 'stzh', 'fernwarmeversorgung', 'geoportal', 'energieplanung', 'netto-null', 'energie', 'polygondaten', 'vektordaten', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'punktdaten', 'energieversorgung', 'liniendaten', 'heizen', 'erneuerbar-heizen', 'energieplankarte', 'fernwarme', 'geodaten', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-07T02:50:16.737000`
