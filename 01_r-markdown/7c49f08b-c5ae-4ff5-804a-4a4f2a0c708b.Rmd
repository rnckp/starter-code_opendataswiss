...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'energieversorgung', 'warmeversorgung', 'geodaten', 'kehrichtheizkraftwerk', 'fernwarme', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'polygondaten', 'holzheizkraftwerk', 'punktdaten', 'kalteversorgung', 'heizen', 'energieplanung', 'stzh', 'liniendaten', 'vektordaten', 'energieplankarte', 'energie', 'geoportal', 'erneuerbar-heizen', 'netto-null', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-05T03:46:14.306615`
