...
- **Keywords.de** `['heizen', 'klarwerk', 'geoportal', 'vektordaten', 'holzheizkraftwerk', 'energieversorgung', 'energieplankarte', 'energie', 'warmeversorgung', 'kalteversorgung', 'energieplanung', 'stzh', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'erneuerbar-heizen', 'netto-null', 'fernwarmeversorgung', 'fernwarme', 'liniendaten', 'punktdaten', 'kehrichtheizkraftwerk', 'polygondaten', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-03T03:33:06.684335`
