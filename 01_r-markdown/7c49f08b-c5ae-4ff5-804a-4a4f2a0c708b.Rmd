...
- **Keywords.de** `['liniendaten', 'vektordaten', 'geoportal', 'polygondaten', 'netto-null', 'kehrichtheizkraftwerk', 'fernwarme', 'energieplanung', 'fernwarmeversorgung', 'heizen', 'punktdaten', 'klarwerk', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'energieversorgung', 'kalteversorgung', 'geodaten', 'erneuerbar-heizen', 'holzheizkraftwerk', 'energie', 'stzh', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-21T03:12:52.377846`
