...
- **Keywords.de** `['fernwarmeversorgung', 'klarwerk', 'kehrichtheizkraftwerk', 'kalteversorgung', 'stzh', 'liniendaten', 'energie', 'erneuerbar-heizen', 'punktdaten', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'vektordaten', 'leitungsgebundene-energieversorgung', 'fernwarme', 'geodaten', 'heizen', 'geoportal', 'warmeversorgung', 'netto-null', 'polygondaten', 'energieversorgung', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-12T03:44:07.105422`
