...
- **Keywords.de** `['geodaten', 'liniendaten', 'leitungsgebundene-energieversorgung', 'stzh', 'energie', 'erneuerbar-heizen', 'fernwarmeversorgung', 'vektordaten', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'fernwarme', 'warmeversorgung', 'punktdaten', 'energieplanung', 'netto-null', 'heizen', 'energieversorgung', 'klarwerk', 'polygondaten', 'kalteversorgung', 'geoportal', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-22T03:09:41.652559`
