...
- **Keywords.de** `['kehrichtheizkraftwerk', 'geoportal', 'leitungsgebundene-energieversorgung', 'klarwerk', 'warmeversorgung', 'fernwarme', 'vektordaten', 'polygondaten', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'geodaten', 'energieversorgung', 'erneuerbar-heizen', 'liniendaten', 'heizen', 'energieplankarte', 'energie', 'netto-null', 'holzheizkraftwerk', 'stzh', 'fernwarmeversorgung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-26T02:54:38.831522`
