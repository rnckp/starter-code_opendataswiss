...
- **Keywords.de** `['klarwerk', 'punktdaten', 'leitungsgebundene-energieversorgung', 'netto-null', 'polygondaten', 'holzheizkraftwerk', 'energieplankarte', 'geodaten', 'energieversorgung', 'erneuerbar-heizen', 'energie', 'warmeversorgung', 'kehrichtheizkraftwerk', 'fernwarme', 'stzh', 'geoportal', 'heizen', 'liniendaten', 'fernwarmeversorgung', 'energieplanung', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-05T03:28:33.488363`
