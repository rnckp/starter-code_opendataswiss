...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'kalteversorgung', 'fernwarmeversorgung', 'geoportal', 'polygondaten', 'liniendaten', 'kehrichtheizkraftwerk', 'heizen', 'energie', 'energieversorgung', 'klarwerk', 'erneuerbar-heizen', 'netto-null', 'holzheizkraftwerk', 'energieplanung', 'stzh', 'punktdaten', 'fernwarme', 'energieplankarte', 'geodaten', 'leitungsgebundene-energieversorgung', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-17T02:59:30.315182`
