...
- **Keywords.de** `['warmeversorgung', 'geodaten', 'geoportal', 'energie', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'punktdaten', 'fernwarme', 'energieplanung', 'stzh', 'netto-null', 'liniendaten', 'holzheizkraftwerk', 'polygondaten', 'energieversorgung', 'kalteversorgung', 'vektordaten', 'energieplankarte', 'kehrichtheizkraftwerk', 'klarwerk', 'erneuerbar-heizen', 'heizen', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-24T01:59:07.857891`
