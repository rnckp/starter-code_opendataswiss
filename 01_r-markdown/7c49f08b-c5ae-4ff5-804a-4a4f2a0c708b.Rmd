...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'punktdaten', 'netto-null', 'kalteversorgung', 'warmeversorgung', 'klarwerk', 'energieplankarte', 'kehrichtheizkraftwerk', 'fernwarme', 'erneuerbar-heizen', 'geoportal', 'stzh', 'geodaten', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energieplanung', 'liniendaten', 'energieversorgung', 'fernwarmeversorgung', 'heizen', 'energie', 'vektordaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-24T03:31:55.502300`
