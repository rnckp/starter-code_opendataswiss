...
- **Keywords.de** `['kalteversorgung', 'geodaten', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'energieplanung', 'energie', 'holzheizkraftwerk', 'liniendaten', 'erneuerbar-heizen', 'energieplankarte', 'vektordaten', 'netto-null', 'heizen', 'punktdaten', 'polygondaten', 'energieversorgung', 'fernwarmeversorgung', 'stzh', 'klarwerk', 'fernwarme', 'leitungsgebundene-energieversorgung', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-17T02:47:15.261256`
