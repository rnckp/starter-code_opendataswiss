...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'energieplankarte', 'energieversorgung', 'liniendaten', 'punktdaten', 'vektordaten', 'erneuerbar-heizen', 'stzh', 'geoportal', 'heizen', 'polygondaten', 'warmeversorgung', 'netto-null', 'energie', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'klarwerk', 'fernwarme', 'kalteversorgung', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-24T02:55:36.990818`
