...
- **Keywords.de** `['energieplanung', 'geodaten', 'stzh', 'warmeversorgung', 'energie', 'vektordaten', 'netto-null', 'geoportal', 'energieplankarte', 'kalteversorgung', 'polygondaten', 'punktdaten', 'heizen', 'kehrichtheizkraftwerk', 'energieversorgung', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'klarwerk', 'liniendaten', 'fernwarmeversorgung', 'fernwarme', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-30T04:08:05.567670`
