...
- **Keywords.de** `['netto-null', 'klarwerk', 'fernwarme', 'liniendaten', 'polygondaten', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'kehrichtheizkraftwerk', 'geoportal', 'energieversorgung', 'warmeversorgung', 'punktdaten', 'fernwarmeversorgung', 'kalteversorgung', 'holzheizkraftwerk', 'energie', 'vektordaten', 'erneuerbar-heizen', 'heizen', 'stzh', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-06T02:52:43.771237`
