...
- **Keywords.de** `['energieplankarte', 'netto-null', 'fernwarme', 'punktdaten', 'geodaten', 'warmeversorgung', 'klarwerk', 'fernwarmeversorgung', 'energieplanung', 'kehrichtheizkraftwerk', 'vektordaten', 'leitungsgebundene-energieversorgung', 'polygondaten', 'holzheizkraftwerk', 'stzh', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'heizen', 'erneuerbar-heizen', 'liniendaten', 'energie', 'kalteversorgung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-07T03:22:26.118003`
