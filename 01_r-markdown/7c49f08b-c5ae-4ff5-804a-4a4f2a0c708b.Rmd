...
- **Keywords.de** `['heizen', 'kalteversorgung', 'geoportal', 'holzheizkraftwerk', 'netto-null', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'fernwarmeversorgung', 'vektordaten', 'klarwerk', 'energieplanung', 'stzh', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'fernwarme', 'energieversorgung', 'punktdaten', 'geodaten', 'energieplankarte', 'kehrichtheizkraftwerk', 'liniendaten', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-12T03:17:37.522820`
