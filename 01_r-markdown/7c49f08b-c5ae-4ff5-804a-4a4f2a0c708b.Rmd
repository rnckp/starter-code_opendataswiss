...
- **Keywords.de** `['geodaten', 'kehrichtheizkraftwerk', 'netto-null', 'liniendaten', 'energieplanung', 'geoportal', 'fernwarmeversorgung', 'holzheizkraftwerk', 'polygondaten', 'fernwarme', 'energie', 'punktdaten', 'heizen', 'erneuerbar-heizen', 'vektordaten', 'energieplankarte', 'kalteversorgung', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'stzh', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-05T02:53:53.418550`
