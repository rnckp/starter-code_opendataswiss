...
- **Keywords.de** `['holzheizkraftwerk', 'heizen', 'energieplanung', 'energie', 'warmeversorgung', 'geoportal', 'erneuerbar-heizen', 'punktdaten', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'kehrichtheizkraftwerk', 'liniendaten', 'energieplankarte', 'vektordaten', 'kalteversorgung', 'fernwarme', 'stzh', 'leitungsgebundene-energieversorgung', 'klarwerk', 'geodaten', 'fernwarmeversorgung', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-26T03:34:20.562494`
