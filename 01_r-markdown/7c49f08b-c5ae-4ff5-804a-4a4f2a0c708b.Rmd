...
- **Keywords.de** `['geoportal', 'kalteversorgung', 'geodaten', 'heizen', 'holzheizkraftwerk', 'stzh', 'energie', 'leitungsgebundene-energieversorgung', 'vektordaten', 'kehrichtheizkraftwerk', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'liniendaten', 'erneuerbar-heizen', 'energieplankarte', 'energieplanung', 'energieversorgung', 'fernwarmeversorgung', 'klarwerk', 'netto-null', 'fernwarme', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-03T02:36:53.283751`
