...
- **Keywords.de** `['heizen', 'energie', 'vektordaten', 'liniendaten', 'holzheizkraftwerk', 'fernwarmeversorgung', 'erneuerbar-heizen', 'geodaten', 'fernwarme', 'energieversorgung', 'warmeversorgung', 'energieplanung', 'netto-null', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'stzh', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'geoportal', 'kehrichtheizkraftwerk', 'polygondaten', 'punktdaten', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-09T03:12:11.209981`
