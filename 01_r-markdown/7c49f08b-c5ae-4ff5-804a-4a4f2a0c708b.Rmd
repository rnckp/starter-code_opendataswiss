...
- **Keywords.de** `['erneuerbar-heizen', 'netto-null', 'geodaten', 'heizen', 'energieplankarte', 'liniendaten', 'energie', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'energieversorgung', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'fernwarme', 'geoportal', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'holzheizkraftwerk', 'klarwerk', 'energieplanung', 'stzh', 'polygondaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-04T03:14:05.419963`
