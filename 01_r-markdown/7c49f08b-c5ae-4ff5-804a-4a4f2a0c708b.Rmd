...
- **Keywords.de** `['fernwarme', 'liniendaten', 'energieplankarte', 'polygondaten', 'stzh', 'energie', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'vektordaten', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'geoportal', 'klarwerk', 'netto-null', 'energieversorgung', 'punktdaten', 'erneuerbar-heizen', 'heizen', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'geodaten', 'energieplanung', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-06T03:38:40.390120`
