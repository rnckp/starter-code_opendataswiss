...
- **Keywords.de** `['vektordaten', 'liniendaten', 'geodaten', 'erneuerbar-heizen', 'punktdaten', 'heizen', 'fernwarmeversorgung', 'energieplanung', 'netto-null', 'energie', 'fernwarme', 'klarwerk', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'polygondaten', 'geoportal', 'kehrichtheizkraftwerk', 'warmeversorgung', 'stzh', 'kalteversorgung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-29T02:50:14.944391`
