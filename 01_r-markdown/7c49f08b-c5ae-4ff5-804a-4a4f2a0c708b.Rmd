...
- **Keywords.de** `['netto-null', 'liniendaten', 'polygondaten', 'fernwarme', 'kehrichtheizkraftwerk', 'warmeversorgung', 'holzheizkraftwerk', 'kalteversorgung', 'punktdaten', 'energieplankarte', 'geoportal', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'stzh', 'energie', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'energieplanung', 'heizen', 'energieversorgung', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-31T03:33:38.140390`
