...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'energieplankarte', 'vektordaten', 'stzh', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'energieplanung', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'klarwerk', 'geodaten', 'polygondaten', 'warmeversorgung', 'netto-null', 'punktdaten', 'liniendaten', 'heizen', 'energie', 'erneuerbar-heizen', 'holzheizkraftwerk', 'kalteversorgung', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-19T03:26:57.861372`
