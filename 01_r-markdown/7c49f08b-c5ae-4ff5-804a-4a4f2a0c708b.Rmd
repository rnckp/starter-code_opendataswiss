...
- **Keywords.de** `['geodaten', 'energieplanung', 'kalteversorgung', 'vektordaten', 'kehrichtheizkraftwerk', 'liniendaten', 'energieversorgung', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'holzheizkraftwerk', 'punktdaten', 'fernwarmeversorgung', 'netto-null', 'stzh', 'energie', 'energieplankarte', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'geoportal', 'heizen', 'klarwerk', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-21T03:35:00.535692`
