...
- **Keywords.de** `['heizen', 'energieplankarte', 'fernwarme', 'liniendaten', 'energieversorgung', 'kalteversorgung', 'polygondaten', 'stzh', 'warmeversorgung', 'energie', 'kehrichtheizkraftwerk', 'energieplanung', 'netto-null', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'punktdaten', 'holzheizkraftwerk', 'geoportal', 'fernwarmeversorgung', 'vektordaten', 'leitungsgebundene-energieversorgung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-03T03:14:30.238027`
