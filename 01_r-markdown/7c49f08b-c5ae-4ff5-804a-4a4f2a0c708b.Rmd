...
- **Keywords.de** `['fernwarme', 'kehrichtheizkraftwerk', 'polygondaten', 'fernwarmeversorgung', 'stzh', 'heizen', 'punktdaten', 'netto-null', 'energie', 'kalteversorgung', 'energieplankarte', 'klarwerk', 'geodaten', 'liniendaten', 'energieplanung', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'holzheizkraftwerk', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'geoportal', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-23T04:13:16.144978`
