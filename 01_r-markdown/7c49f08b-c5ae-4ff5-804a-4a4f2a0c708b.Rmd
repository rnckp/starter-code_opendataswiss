...
- **Keywords.de** `['geoportal', 'energieplanung', 'polygondaten', 'vektordaten', 'punktdaten', 'energieversorgung', 'energie', 'klarwerk', 'liniendaten', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'heizen', 'netto-null', 'energieplankarte', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'geodaten', 'fernwarmeversorgung', 'stzh', 'fernwarme', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-28T03:56:03.467250`
