...
- **Keywords.de** `['kehrichtheizkraftwerk', 'polygondaten', 'heizen', 'klarwerk', 'holzheizkraftwerk', 'kalteversorgung', 'geoportal', 'geodaten', 'punktdaten', 'energie', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'energieplanung', 'stzh', 'erneuerbar-heizen', 'energieplankarte', 'netto-null', 'fernwarme', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'vektordaten', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-12T03:42:20.223727`
