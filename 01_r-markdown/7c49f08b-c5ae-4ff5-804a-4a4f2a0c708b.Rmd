...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'energie', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'polygondaten', 'netto-null', 'energieplanung', 'klarwerk', 'energieplankarte', 'geoportal', 'geodaten', 'fernwarmeversorgung', 'stzh', 'fernwarme', 'liniendaten', 'punktdaten', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'kalteversorgung', 'vektordaten', 'energieversorgung', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-10T03:28:06.924756`
