...
- **Keywords.de** `['netto-null', 'stzh', 'punktdaten', 'geodaten', 'energieplanung', 'vektordaten', 'energie', 'klarwerk', 'holzheizkraftwerk', 'kalteversorgung', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'energieversorgung', 'erneuerbar-heizen', 'fernwarmeversorgung', 'heizen', 'kehrichtheizkraftwerk', 'polygondaten', 'leitungsgebundene-energieversorgung', 'fernwarme', 'geoportal', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-10T03:40:08.251379`
