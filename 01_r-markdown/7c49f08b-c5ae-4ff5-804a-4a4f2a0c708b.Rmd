...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'kalteversorgung', 'liniendaten', 'energieplankarte', 'energie', 'geoportal', 'energieversorgung', 'stzh', 'energieplanung', 'fernwarmeversorgung', 'polygondaten', 'geodaten', 'fernwarme', 'klarwerk', 'heizen', 'erneuerbar-heizen', 'warmeversorgung', 'holzheizkraftwerk', 'vektordaten', 'netto-null', 'punktdaten', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-28T02:51:08.909159`
