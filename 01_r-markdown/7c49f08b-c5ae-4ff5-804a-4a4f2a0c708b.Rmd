...
- **Keywords.de** `['kalteversorgung', 'holzheizkraftwerk', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'punktdaten', 'leitungsgebundene-energieversorgung', 'geodaten', 'vektordaten', 'fernwarme', 'energieplanung', 'warmeversorgung', 'netto-null', 'stzh', 'klarwerk', 'heizen', 'geoportal', 'energie', 'energieversorgung', 'erneuerbar-heizen', 'energieplankarte', 'liniendaten', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-28T03:06:43.644471`
