...
- **Keywords.de** `['geoportal', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'polygondaten', 'geodaten', 'netto-null', 'liniendaten', 'warmeversorgung', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'stzh', 'fernwarmeversorgung', 'vektordaten', 'energieplanung', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'energieplankarte', 'heizen', 'kalteversorgung', 'klarwerk', 'energie', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-21T03:23:55.922348`
