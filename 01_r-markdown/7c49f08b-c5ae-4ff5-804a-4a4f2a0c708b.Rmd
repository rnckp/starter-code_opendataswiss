...
- **Keywords.de** `['liniendaten', 'holzheizkraftwerk', 'stzh', 'heizen', 'fernwarme', 'geodaten', 'warmeversorgung', 'kehrichtheizkraftwerk', 'energieplankarte', 'netto-null', 'erneuerbar-heizen', 'fernwarmeversorgung', 'energieplanung', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'klarwerk', 'polygondaten', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'kalteversorgung', 'geoportal', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-13T03:49:18.895405`
