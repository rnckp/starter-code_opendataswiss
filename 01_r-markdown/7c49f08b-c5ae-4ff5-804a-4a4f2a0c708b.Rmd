...
- **Keywords.de** `['klarwerk', 'warmeversorgung', 'liniendaten', 'energie', 'vektordaten', 'fernwarme', 'polygondaten', 'kalteversorgung', 'stzh', 'kehrichtheizkraftwerk', 'energieplanung', 'geodaten', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'heizen', 'energieversorgung', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'geoportal', 'punktdaten', 'erneuerbar-heizen', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-30T03:00:50.517108`
