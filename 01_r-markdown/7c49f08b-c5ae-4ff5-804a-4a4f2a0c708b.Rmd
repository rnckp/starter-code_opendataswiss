...
- **Keywords.de** `['energieversorgung', 'geodaten', 'warmeversorgung', 'kehrichtheizkraftwerk', 'polygondaten', 'holzheizkraftwerk', 'fernwarmeversorgung', 'geoportal', 'vektordaten', 'leitungsgebundene-energieversorgung', 'klarwerk', 'energieplanung', 'erneuerbar-heizen', 'energie', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'netto-null', 'punktdaten', 'stzh', 'energieplankarte', 'liniendaten', 'kalteversorgung', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-22T02:56:24.745099`
