...
- **Keywords.de** `['geodaten', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'kalteversorgung', 'heizen', 'stzh', 'energieversorgung', 'polygondaten', 'erneuerbar-heizen', 'fernwarme', 'punktdaten', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'geoportal', 'kehrichtheizkraftwerk', 'liniendaten', 'warmeversorgung', 'holzheizkraftwerk', 'energieplankarte', 'vektordaten', 'energie', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-14T03:32:30.126679`
