...
- **Keywords.de** `['punktdaten', 'energieplanung', 'vektordaten', 'klarwerk', 'energieplankarte', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'erneuerbar-heizen', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'heizen', 'polygondaten', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'stzh', 'warmeversorgung', 'fernwarme', 'energie', 'liniendaten', 'kalteversorgung', 'holzheizkraftwerk', 'netto-null', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-13T03:07:17.611202`
