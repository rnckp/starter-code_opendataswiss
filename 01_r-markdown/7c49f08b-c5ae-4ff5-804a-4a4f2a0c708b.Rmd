...
- **Keywords.de** `['stzh', 'holzheizkraftwerk', 'geoportal', 'kehrichtheizkraftwerk', 'warmeversorgung', 'polygondaten', 'energieplanung', 'vektordaten', 'liniendaten', 'netto-null', 'fernwarmeversorgung', 'kalteversorgung', 'heizen', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'energie', 'punktdaten', 'energieversorgung', 'klarwerk', 'fernwarme', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-28T03:30:27.142771`
