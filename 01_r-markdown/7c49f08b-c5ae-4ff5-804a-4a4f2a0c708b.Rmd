...
- **Keywords.de** `['energieversorgung', 'liniendaten', 'energieplanung', 'heizen', 'fernwarmeversorgung', 'geoportal', 'vektordaten', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'klarwerk', 'fernwarme', 'holzheizkraftwerk', 'geodaten', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'energieplankarte', 'warmeversorgung', 'energie', 'leitungsgebundene-energieversorgung', 'polygondaten', 'netto-null', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-16T03:45:31.021006`
