...
- **Keywords.de** `['heizen', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'fernwarmeversorgung', 'vektordaten', 'liniendaten', 'klarwerk', 'energieplanung', 'erneuerbar-heizen', 'kalteversorgung', 'energieversorgung', 'punktdaten', 'geodaten', 'geoportal', 'polygondaten', 'netto-null', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'energie', 'warmeversorgung', 'energieplankarte', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-10T03:12:36.327163`
