...
- **Keywords.de** `['kalteversorgung', 'energie', 'stzh', 'netto-null', 'polygondaten', 'vektordaten', 'energieplanung', 'fernwarmeversorgung', 'liniendaten', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'geoportal', 'energieversorgung', 'geodaten', 'fernwarme', 'erneuerbar-heizen', 'punktdaten', 'heizen', 'energieplankarte', 'warmeversorgung', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-23T03:31:12.068212`
