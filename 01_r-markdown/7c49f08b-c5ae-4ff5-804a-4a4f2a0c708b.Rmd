...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'geoportal', 'kalteversorgung', 'punktdaten', 'fernwarme', 'fernwarmeversorgung', 'warmeversorgung', 'holzheizkraftwerk', 'energieplankarte', 'klarwerk', 'energie', 'leitungsgebundene-energieversorgung', 'stzh', 'liniendaten', 'vektordaten', 'energieplanung', 'energieversorgung', 'heizen', 'polygondaten', 'netto-null', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-23T02:47:12.845850`
