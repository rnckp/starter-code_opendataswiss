...
- **Keywords.de** `['polygondaten', 'netto-null', 'heizen', 'energie', 'liniendaten', 'leitungsgebundene-energieversorgung', 'geodaten', 'warmeversorgung', 'kehrichtheizkraftwerk', 'stzh', 'geoportal', 'punktdaten', 'vektordaten', 'holzheizkraftwerk', 'fernwarme', 'klarwerk', 'kalteversorgung', 'erneuerbar-heizen', 'fernwarmeversorgung', 'energieversorgung', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-09T03:13:55.568979`
