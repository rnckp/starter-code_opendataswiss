...
- **Keywords.de** `['vektordaten', 'stzh', 'punktdaten', 'warmeversorgung', 'liniendaten', 'geodaten', 'fernwarme', 'geoportal', 'energieversorgung', 'energieplanung', 'heizen', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'klarwerk', 'energieplankarte', 'energie', 'polygondaten', 'erneuerbar-heizen', 'netto-null', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-29T03:06:00.036205`
