...
- **Keywords.de** `['geoportal', 'netto-null', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'heizen', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'punktdaten', 'geodaten', 'liniendaten', 'stzh', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'polygondaten', 'energie', 'fernwarme', 'vektordaten', 'energieplankarte', 'kalteversorgung', 'energieplanung', 'energieversorgung', 'warmeversorgung', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-08T03:55:19.869123`
