...
- **Keywords.de** `['heizen', 'liniendaten', 'fernwarmeversorgung', 'klarwerk', 'geoportal', 'polygondaten', 'stzh', 'energieplanung', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'energieversorgung', 'geodaten', 'punktdaten', 'energie', 'netto-null', 'vektordaten', 'energieplankarte', 'fernwarme', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-17T03:00:39.207670`
