...
- **Keywords.de** `['kehrichtheizkraftwerk', 'polygondaten', 'fernwarme', 'netto-null', 'kalteversorgung', 'geodaten', 'stzh', 'erneuerbar-heizen', 'energieversorgung', 'liniendaten', 'energie', 'leitungsgebundene-energieversorgung', 'heizen', 'klarwerk', 'geoportal', 'energieplankarte', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'punktdaten', 'warmeversorgung', 'energieplanung', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-04T03:20:22.468375`
