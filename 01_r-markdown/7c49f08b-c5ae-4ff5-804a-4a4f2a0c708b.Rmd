...
- **Keywords.de** `['fernwarme', 'energie', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'kalteversorgung', 'holzheizkraftwerk', 'energieversorgung', 'vektordaten', 'punktdaten', 'liniendaten', 'kehrichtheizkraftwerk', 'stzh', 'geodaten', 'polygondaten', 'energieplankarte', 'geoportal', 'fernwarmeversorgung', 'heizen', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'netto-null', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-08T02:46:15.135671`
