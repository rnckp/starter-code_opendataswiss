...
- **Keywords.de** `['energieplankarte', 'netto-null', 'kehrichtheizkraftwerk', 'kalteversorgung', 'geoportal', 'vektordaten', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'polygondaten', 'fernwarme', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'heizen', 'warmeversorgung', 'klarwerk', 'energie', 'erneuerbar-heizen', 'liniendaten', 'holzheizkraftwerk', 'energieplanung', 'fernwarmeversorgung', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-21T03:18:17.365964`
