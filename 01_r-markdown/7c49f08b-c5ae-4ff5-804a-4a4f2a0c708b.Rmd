...
- **Keywords.de** `['polygondaten', 'kehrichtheizkraftwerk', 'warmeversorgung', 'geodaten', 'kalteversorgung', 'energieversorgung', 'vektordaten', 'geoportal', 'holzheizkraftwerk', 'klarwerk', 'energie', 'leitungsgebundene-energieversorgung', 'stzh', 'liniendaten', 'fernwarme', 'energieplankarte', 'heizen', 'fernwarmeversorgung', 'energieplanung', 'netto-null', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-21T03:30:56.827154`
