...
- **Keywords.de** `['liniendaten', 'heizen', 'kalteversorgung', 'energie', 'vektordaten', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'geoportal', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'energieplanung', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'energieversorgung', 'warmeversorgung', 'fernwarme', 'polygondaten', 'geodaten', 'stzh', 'energieplankarte', 'punktdaten', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-14T02:58:23.175538`
