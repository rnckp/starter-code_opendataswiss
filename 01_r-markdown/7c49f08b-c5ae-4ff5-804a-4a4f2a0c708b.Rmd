...
- **Keywords.de** `['fernwarme', 'geoportal', 'punktdaten', 'kalteversorgung', 'fernwarmeversorgung', 'warmeversorgung', 'geodaten', 'stzh', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'energieversorgung', 'energieplankarte', 'erneuerbar-heizen', 'heizen', 'vektordaten', 'energie', 'holzheizkraftwerk', 'netto-null', 'polygondaten', 'liniendaten', 'kehrichtheizkraftwerk', 'energieplanung', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-15T03:14:45.186486`
