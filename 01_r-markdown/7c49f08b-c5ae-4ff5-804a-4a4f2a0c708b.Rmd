...
- **Keywords.de** `['stzh', 'holzheizkraftwerk', 'punktdaten', 'heizen', 'energieversorgung', 'liniendaten', 'energieplankarte', 'geoportal', 'vektordaten', 'warmeversorgung', 'polygondaten', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'klarwerk', 'erneuerbar-heizen', 'energieplanung', 'netto-null', 'energie', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'geodaten', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-19T04:18:47.467728`
