...
- **Keywords.de** `['erneuerbar-heizen', 'stzh', 'energieversorgung', 'netto-null', 'liniendaten', 'klarwerk', 'energieplanung', 'punktdaten', 'holzheizkraftwerk', 'geoportal', 'kehrichtheizkraftwerk', 'warmeversorgung', 'heizen', 'kalteversorgung', 'fernwarme', 'leitungsgebundene-energieversorgung', 'vektordaten', 'energieplankarte', 'energie', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'fernwarmeversorgung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-27T03:06:24.353220`
