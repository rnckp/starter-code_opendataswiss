...
- **Keywords.de** `['erneuerbar-heizen', 'geodaten', 'energieversorgung', 'netto-null', 'stzh', 'geoportal', 'vektordaten', 'energieplankarte', 'heizen', 'polygondaten', 'fernwarme', 'energieplanung', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'klarwerk', 'energie', 'warmeversorgung', 'liniendaten', 'kalteversorgung', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-23T02:29:11.211770`
