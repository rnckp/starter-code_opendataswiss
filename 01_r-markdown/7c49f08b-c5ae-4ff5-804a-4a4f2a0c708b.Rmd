...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'punktdaten', 'energieplanung', 'stzh', 'vektordaten', 'polygondaten', 'energie', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'heizen', 'geodaten', 'energieplankarte', 'geoportal', 'erneuerbar-heizen', 'holzheizkraftwerk', 'energieversorgung', 'klarwerk', 'kalteversorgung', 'liniendaten', 'warmeversorgung', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-23T03:23:55.778333`
