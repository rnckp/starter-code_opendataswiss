...
- **Keywords.de** `['fernwarme', 'holzheizkraftwerk', 'punktdaten', 'warmeversorgung', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'klarwerk', 'kehrichtheizkraftwerk', 'energie', 'heizen', 'fernwarmeversorgung', 'netto-null', 'liniendaten', 'polygondaten', 'erneuerbar-heizen', 'energieversorgung', 'energieplanung', 'geoportal', 'vektordaten', 'stzh', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-03-06T03:06:28.376939`
