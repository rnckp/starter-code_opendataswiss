...
- **Keywords.de** `['fernwarmeversorgung', 'energieplankarte', 'energieplanung', 'heizen', 'holzheizkraftwerk', 'liniendaten', 'punktdaten', 'energie', 'kehrichtheizkraftwerk', 'stzh', 'leitungsgebundene-energieversorgung', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'erneuerbar-heizen', 'kalteversorgung', 'geoportal', 'energieversorgung', 'warmeversorgung', 'vektordaten', 'polygondaten', 'geodaten', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-21T03:23:26.037977`
