...
- **Keywords.de** `['warmeversorgung', 'energieplanung', 'punktdaten', 'energieplankarte', 'erneuerbar-heizen', 'geoportal', 'liniendaten', 'kehrichtheizkraftwerk', 'fernwarme', 'netto-null', 'energie', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'fernwarmeversorgung', 'holzheizkraftwerk', 'klarwerk', 'geodaten', 'stzh', 'vektordaten', 'leitungsgebundene-energieversorgung', 'heizen', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-06T04:39:42.075139`
