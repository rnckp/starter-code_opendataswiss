...
- **Keywords.de** `['fernwarmeversorgung', 'heizen', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'energie', 'erneuerbar-heizen', 'geodaten', 'warmeversorgung', 'netto-null', 'energieversorgung', 'punktdaten', 'fernwarme', 'holzheizkraftwerk', 'energieplankarte', 'kehrichtheizkraftwerk', 'liniendaten', 'polygondaten', 'klarwerk', 'vektordaten', 'kalteversorgung', 'energieplanung', 'stzh', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-19T03:32:10.341866`
