...
- **Keywords.de** `['erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'polygondaten', 'heizen', 'geodaten', 'kehrichtheizkraftwerk', 'kalteversorgung', 'holzheizkraftwerk', 'energieplankarte', 'energie', 'warmeversorgung', 'energieplanung', 'energieversorgung', 'fernwarmeversorgung', 'netto-null', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'stzh', 'liniendaten', 'vektordaten', 'klarwerk', 'fernwarme', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-06T03:12:45.823478`
