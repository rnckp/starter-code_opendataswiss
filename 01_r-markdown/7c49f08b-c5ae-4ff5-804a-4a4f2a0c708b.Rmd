...
- **Keywords.de** `['netto-null', 'vektordaten', 'leitungsgebundene-energieversorgung', 'klarwerk', 'stzh', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'energieversorgung', 'energieplanung', 'energieplankarte', 'heizen', 'geoportal', 'fernwarme', 'holzheizkraftwerk', 'punktdaten', 'liniendaten', 'energie', 'warmeversorgung', 'fernwarmeversorgung', 'kalteversorgung', 'kehrichtheizkraftwerk', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-16T03:40:23.578341`
