...
- **Keywords.de** `['erneuerbar-heizen', 'klarwerk', 'liniendaten', 'energieplanung', 'leitungsgebundene-energieversorgung', 'stzh', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'vektordaten', 'warmeversorgung', 'energieversorgung', 'heizen', 'geodaten', 'polygondaten', 'kehrichtheizkraftwerk', 'punktdaten', 'fernwarme', 'fernwarmeversorgung', 'holzheizkraftwerk', 'energie', 'geoportal', 'netto-null', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-14T03:25:13.940945`
