...
- **Keywords.de** `['stzh', 'energieplanung', 'punktdaten', 'kalteversorgung', 'warmeversorgung', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'liniendaten', 'klarwerk', 'fernwarme', 'geoportal', 'kehrichtheizkraftwerk', 'vektordaten', 'heizen', 'energieplankarte', 'geodaten', 'energie', 'energieversorgung', 'fernwarmeversorgung', 'netto-null', 'erneuerbar-heizen', 'polygondaten', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-25T03:11:32.273563`
