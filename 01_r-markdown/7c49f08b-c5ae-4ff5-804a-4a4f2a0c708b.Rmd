...
- **Keywords.de** `['netto-null', 'vektordaten', 'geodaten', 'punktdaten', 'kehrichtheizkraftwerk', 'energieversorgung', 'fernwarme', 'fernwarmeversorgung', 'klarwerk', 'heizen', 'polygondaten', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'kalteversorgung', 'warmeversorgung', 'energie', 'erneuerbar-heizen', 'liniendaten', 'stzh', 'energieplanung', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-27T03:16:45.483830`
