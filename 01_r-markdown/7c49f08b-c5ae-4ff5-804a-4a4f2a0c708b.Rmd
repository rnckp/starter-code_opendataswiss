...
- **Keywords.de** `['vektordaten', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'liniendaten', 'punktdaten', 'klarwerk', 'geodaten', 'geoportal', 'energieplankarte', 'netto-null', 'energieplanung', 'fernwarme', 'polygondaten', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'heizen', 'stzh', 'energieversorgung', 'energie', 'warmeversorgung', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-08T02:36:12.999975`
