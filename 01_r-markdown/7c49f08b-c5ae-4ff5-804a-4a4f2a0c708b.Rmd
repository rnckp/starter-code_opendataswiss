...
- **Keywords.de** `['energieversorgung', 'punktdaten', 'erneuerbar-heizen', 'energieplankarte', 'stzh', 'geodaten', 'vektordaten', 'energieplanung', 'kalteversorgung', 'kehrichtheizkraftwerk', 'polygondaten', 'holzheizkraftwerk', 'energie', 'geoportal', 'netto-null', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'heizen', 'fernwarmeversorgung', 'liniendaten', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-17T02:27:09.775819`
