...
- **Keywords.de** `['kehrichtheizkraftwerk', 'geoportal', 'warmeversorgung', 'fernwarme', 'heizen', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'energieplankarte', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'punktdaten', 'energieplanung', 'klarwerk', 'polygondaten', 'holzheizkraftwerk', 'energie', 'kalteversorgung', 'vektordaten', 'liniendaten', 'netto-null', 'stzh', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-20T02:52:27.767896`
