...
- **Keywords.de** `['kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'polygondaten', 'geodaten', 'klarwerk', 'liniendaten', 'fernwarmeversorgung', 'stzh', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'heizen', 'punktdaten', 'warmeversorgung', 'holzheizkraftwerk', 'erneuerbar-heizen', 'energieplanung', 'energie', 'kalteversorgung', 'fernwarme', 'geoportal', 'netto-null', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-01T02:46:19.996465`
