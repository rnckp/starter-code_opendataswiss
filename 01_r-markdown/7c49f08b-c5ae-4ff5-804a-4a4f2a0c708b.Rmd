...
- **Keywords.de** `['geodaten', 'warmeversorgung', 'polygondaten', 'heizen', 'punktdaten', 'geoportal', 'stzh', 'vektordaten', 'liniendaten', 'kalteversorgung', 'energieplanung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'energieplankarte', 'netto-null', 'energie', 'leitungsgebundene-energieversorgung', 'klarwerk', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'energieversorgung', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-01T03:38:43.392955`
