...
- **Keywords.de** `['stzh', 'heizen', 'geoportal', 'fernwarme', 'energieversorgung', 'energieplankarte', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'netto-null', 'vektordaten', 'fernwarmeversorgung', 'energieplanung', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'liniendaten', 'erneuerbar-heizen', 'geodaten', 'polygondaten', 'klarwerk', 'punktdaten', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-21T02:13:28.461580`
