...
- **Keywords.de** `['heizen', 'stzh', 'energieplankarte', 'netto-null', 'vektordaten', 'energieversorgung', 'geoportal', 'geodaten', 'kalteversorgung', 'punktdaten', 'warmeversorgung', 'fernwarmeversorgung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'energie', 'liniendaten', 'energieplanung', 'fernwarme', 'klarwerk', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-25T03:08:11.311316`
