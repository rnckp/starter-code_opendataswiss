...
- **Keywords.de** `['geodaten', 'kehrichtheizkraftwerk', 'vektordaten', 'liniendaten', 'holzheizkraftwerk', 'heizen', 'polygondaten', 'warmeversorgung', 'netto-null', 'fernwarmeversorgung', 'stzh', 'punktdaten', 'erneuerbar-heizen', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'energieplankarte', 'kalteversorgung', 'energieplanung', 'fernwarme', 'leitungsgebundene-energieversorgung', 'energie', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-15T02:55:30.127285`
