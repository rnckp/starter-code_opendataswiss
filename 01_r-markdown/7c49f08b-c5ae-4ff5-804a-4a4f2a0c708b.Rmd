...
- **Keywords.de** `['warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'energie', 'holzheizkraftwerk', 'energieplanung', 'netto-null', 'erneuerbar-heizen', 'geodaten', 'fernwarmeversorgung', 'kalteversorgung', 'liniendaten', 'punktdaten', 'kehrichtheizkraftwerk', 'polygondaten', 'vektordaten', 'stzh', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'energieversorgung', 'fernwarme', 'heizen', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-06T03:20:03.540781`
