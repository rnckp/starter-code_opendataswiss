...
- **Keywords.de** `['energieversorgung', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'punktdaten', 'heizen', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'holzheizkraftwerk', 'energieplankarte', 'energie', 'geodaten', 'stzh', 'klarwerk', 'fernwarmeversorgung', 'fernwarme', 'vektordaten', 'kalteversorgung', 'polygondaten', 'geoportal', 'liniendaten', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-18T03:22:20.655680`
