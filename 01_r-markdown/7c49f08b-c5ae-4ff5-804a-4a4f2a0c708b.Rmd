...
- **Keywords.de** `['polygondaten', 'netto-null', 'energieversorgung', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'geoportal', 'holzheizkraftwerk', 'energieplankarte', 'geodaten', 'punktdaten', 'fernwarme', 'fernwarmeversorgung', 'liniendaten', 'vektordaten', 'kehrichtheizkraftwerk', 'energieplanung', 'leitungsgebundene-energieversorgung', 'stzh', 'energie', 'erneuerbar-heizen', 'klarwerk', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-17T03:29:17.136558`
