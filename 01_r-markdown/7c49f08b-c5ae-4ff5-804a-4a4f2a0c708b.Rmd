...
- **Keywords.de** `['polygondaten', 'energie', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'fernwarmeversorgung', 'warmeversorgung', 'holzheizkraftwerk', 'kalteversorgung', 'fernwarme', 'liniendaten', 'klarwerk', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'stzh', 'heizen', 'energieversorgung', 'punktdaten', 'geoportal', 'energieplanung', 'vektordaten', 'energieplankarte', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-22T02:06:26.953590`
