...
- **Keywords.de** `['vektordaten', 'energieplankarte', 'geoportal', 'fernwarme', 'polygondaten', 'erneuerbar-heizen', 'energieplanung', 'netto-null', 'kalteversorgung', 'stzh', 'liniendaten', 'geodaten', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'energieversorgung', 'heizen', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'energie', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'klarwerk', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-17T04:40:33.071489`
