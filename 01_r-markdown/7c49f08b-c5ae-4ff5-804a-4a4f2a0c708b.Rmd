...
- **Keywords.de** `['kehrichtheizkraftwerk', 'holzheizkraftwerk', 'polygondaten', 'geoportal', 'energie', 'energieplankarte', 'punktdaten', 'vektordaten', 'klarwerk', 'geodaten', 'netto-null', 'kalteversorgung', 'stzh', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'fernwarme', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'heizen', 'energieplanung', 'liniendaten', 'warmeversorgung', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-03-01T03:22:52.358895`
