...
- **Keywords.de** `['kehrichtheizkraftwerk', 'klarwerk', 'geoportal', 'kalteversorgung', 'energie', 'liniendaten', 'fernwarmeversorgung', 'energieversorgung', 'erneuerbar-heizen', 'vektordaten', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'geodaten', 'leitungsgebundene-energieversorgung', 'energieplanung', 'punktdaten', 'holzheizkraftwerk', 'energieplankarte', 'stzh', 'heizen', 'netto-null', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-25T02:51:02.749095`
