...
- **Keywords.de** `['heizen', 'netto-null', 'fernwarmeversorgung', 'geodaten', 'energieplankarte', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'geoportal', 'holzheizkraftwerk', 'kalteversorgung', 'energieversorgung', 'punktdaten', 'polygondaten', 'stzh', 'liniendaten', 'vektordaten', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'energie', 'fernwarme', 'kehrichtheizkraftwerk', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-03-16T03:40:08.778118`
