...
- **Keywords.de** `['holzheizkraftwerk', 'fernwarmeversorgung', 'geoportal', 'heizen', 'kalteversorgung', 'punktdaten', 'energieplankarte', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'klarwerk', 'geodaten', 'stzh', 'leitungsgebundene-energieversorgung', 'polygondaten', 'liniendaten', 'energie', 'netto-null', 'vektordaten', 'energieversorgung', 'warmeversorgung', 'fernwarme', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-21T02:37:20.391763`
