...
- **Keywords.de** `['energieversorgung', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'liniendaten', 'holzheizkraftwerk', 'energie', 'netto-null', 'kehrichtheizkraftwerk', 'heizen', 'fernwarmeversorgung', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'punktdaten', 'vektordaten', 'warmeversorgung', 'polygondaten', 'energieplankarte', 'klarwerk', 'geoportal', 'stzh', 'fernwarme', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-15T05:09:59.797200`
