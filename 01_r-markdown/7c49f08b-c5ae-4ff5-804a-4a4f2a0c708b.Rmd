...
- **Keywords.de** `['punktdaten', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'liniendaten', 'polygondaten', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'holzheizkraftwerk', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'kalteversorgung', 'energie', 'fernwarme', 'energieplanung', 'erneuerbar-heizen', 'klarwerk', 'stzh', 'energieplankarte', 'netto-null', 'energieversorgung', 'heizen', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-02T03:32:35.155030`
