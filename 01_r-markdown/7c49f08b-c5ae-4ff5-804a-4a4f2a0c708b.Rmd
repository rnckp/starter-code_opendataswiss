...
- **Keywords.de** `['netto-null', 'kehrichtheizkraftwerk', 'geodaten', 'geoportal', 'energieversorgung', 'vektordaten', 'warmeversorgung', 'liniendaten', 'klarwerk', 'polygondaten', 'fernwarme', 'stzh', 'heizen', 'erneuerbar-heizen', 'energie', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'punktdaten', 'energieplankarte', 'energieplanung', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-24T02:18:31.800840`
