...
- **Keywords.de** `['erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'energieplankarte', 'warmeversorgung', 'netto-null', 'klarwerk', 'kalteversorgung', 'holzheizkraftwerk', 'geodaten', 'energie', 'liniendaten', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'punktdaten', 'fernwarmeversorgung', 'energieplanung', 'vektordaten', 'stzh', 'polygondaten', 'energieversorgung', 'heizen', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-02T03:30:56.344797`
