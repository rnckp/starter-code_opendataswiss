...
- **Keywords.de** `['kalteversorgung', 'vektordaten', 'liniendaten', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'stzh', 'fernwarmeversorgung', 'netto-null', 'punktdaten', 'fernwarme', 'klarwerk', 'geoportal', 'polygondaten', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'kehrichtheizkraftwerk', 'heizen', 'geodaten', 'warmeversorgung', 'holzheizkraftwerk', 'energie', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-21T03:45:07.022069`
