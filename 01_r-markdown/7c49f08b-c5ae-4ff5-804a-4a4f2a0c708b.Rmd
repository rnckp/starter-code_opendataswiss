...
- **Keywords.de** `['energieplankarte', 'klarwerk', 'energie', 'vektordaten', 'fernwarmeversorgung', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'warmeversorgung', 'holzheizkraftwerk', 'energieversorgung', 'kalteversorgung', 'fernwarme', 'heizen', 'liniendaten', 'geoportal', 'netto-null', 'punktdaten', 'stzh', 'polygondaten', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-13T04:26:02.298740`
