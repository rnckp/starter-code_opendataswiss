...
- **Keywords.de** `['energieplanung', 'geoportal', 'heizen', 'geodaten', 'kalteversorgung', 'warmeversorgung', 'liniendaten', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'vektordaten', 'punktdaten', 'klarwerk', 'netto-null', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'fernwarme', 'stzh', 'energie', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'holzheizkraftwerk', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-27T03:10:17.565859`
