...
- **Keywords.de** `['fernwarmeversorgung', 'holzheizkraftwerk', 'stzh', 'energieversorgung', 'fernwarme', 'kalteversorgung', 'energie', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'geodaten', 'vektordaten', 'warmeversorgung', 'liniendaten', 'klarwerk', 'geoportal', 'heizen', 'polygondaten', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'punktdaten', 'energieplankarte', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-12T03:11:02.180226`
