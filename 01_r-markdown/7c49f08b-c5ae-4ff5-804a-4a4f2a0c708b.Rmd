...
- **Keywords.de** `['liniendaten', 'stzh', 'kalteversorgung', 'energieplanung', 'heizen', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'polygondaten', 'erneuerbar-heizen', 'geodaten', 'punktdaten', 'energie', 'warmeversorgung', 'fernwarmeversorgung', 'holzheizkraftwerk', 'fernwarme', 'kehrichtheizkraftwerk', 'energieversorgung', 'klarwerk', 'energieplankarte', 'geoportal', 'netto-null', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-15T03:25:46.863242`
