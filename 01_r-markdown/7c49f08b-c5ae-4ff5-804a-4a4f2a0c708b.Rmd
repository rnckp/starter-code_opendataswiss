...
- **Keywords.de** `['fernwarme', 'erneuerbar-heizen', 'kalteversorgung', 'geoportal', 'energie', 'geodaten', 'polygondaten', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'stzh', 'holzheizkraftwerk', 'netto-null', 'fernwarmeversorgung', 'heizen', 'energieplanung', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'energieplankarte', 'klarwerk', 'energieversorgung', 'punktdaten', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-18T02:16:17.675958`
