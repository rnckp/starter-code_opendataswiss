...
- **Keywords.de** `['energieversorgung', 'geoportal', 'holzheizkraftwerk', 'punktdaten', 'liniendaten', 'energie', 'kehrichtheizkraftwerk', 'geodaten', 'fernwarme', 'heizen', 'polygondaten', 'netto-null', 'vektordaten', 'klarwerk', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'erneuerbar-heizen', 'stzh', 'warmeversorgung', 'energieplankarte', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-19T04:30:15.412344`
