...
- **Keywords.de** `['holzheizkraftwerk', 'fernwarmeversorgung', 'energieversorgung', 'netto-null', 'erneuerbar-heizen', 'stzh', 'warmeversorgung', 'energie', 'kehrichtheizkraftwerk', 'vektordaten', 'energieplanung', 'geodaten', 'heizen', 'fernwarme', 'klarwerk', 'geoportal', 'polygondaten', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'punktdaten', 'energieplankarte', 'liniendaten', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-10T03:04:34.076849`
