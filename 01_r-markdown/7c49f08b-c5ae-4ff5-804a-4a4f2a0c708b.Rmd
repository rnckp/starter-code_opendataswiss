...
- **Keywords.de** `['kehrichtheizkraftwerk', 'netto-null', 'vektordaten', 'energieplankarte', 'polygondaten', 'erneuerbar-heizen', 'punktdaten', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'geoportal', 'energieversorgung', 'geodaten', 'leitungsgebundene-energieversorgung', 'klarwerk', 'holzheizkraftwerk', 'heizen', 'stzh', 'fernwarme', 'energie', 'kalteversorgung', 'energieplanung', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-01T03:13:19.226281`
