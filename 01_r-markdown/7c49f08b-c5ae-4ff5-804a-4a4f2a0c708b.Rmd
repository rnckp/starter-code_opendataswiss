...
- **Keywords.de** `['energie', 'kalteversorgung', 'geoportal', 'vektordaten', 'polygondaten', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'energieplanung', 'fernwarme', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'geodaten', 'klarwerk', 'stzh', 'warmeversorgung', 'fernwarmeversorgung', 'heizen', 'energieplankarte', 'erneuerbar-heizen', 'energieversorgung', 'holzheizkraftwerk', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-13T03:37:19.184028`
