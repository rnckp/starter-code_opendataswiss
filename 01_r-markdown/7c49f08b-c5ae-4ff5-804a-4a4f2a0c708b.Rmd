...
- **Keywords.de** `['holzheizkraftwerk', 'kehrichtheizkraftwerk', 'heizen', 'liniendaten', 'energieplankarte', 'warmeversorgung', 'punktdaten', 'fernwarme', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'energieversorgung', 'netto-null', 'geoportal', 'energie', 'polygondaten', 'geodaten', 'kalteversorgung', 'klarwerk', 'vektordaten', 'stzh', 'fernwarmeversorgung', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-30T03:02:14.639890`
