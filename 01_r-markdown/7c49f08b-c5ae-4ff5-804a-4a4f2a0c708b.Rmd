...
- **Keywords.de** `['stzh', 'kehrichtheizkraftwerk', 'energieplanung', 'fernwarmeversorgung', 'kalteversorgung', 'geoportal', 'warmeversorgung', 'energieversorgung', 'energie', 'heizen', 'klarwerk', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'polygondaten', 'geodaten', 'vektordaten', 'holzheizkraftwerk', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'erneuerbar-heizen', 'punktdaten', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-04T03:22:42.052044`
