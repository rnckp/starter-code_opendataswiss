...
- **Keywords.de** `['geodaten', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'energieplankarte', 'fernwarme', 'kalteversorgung', 'punktdaten', 'warmeversorgung', 'polygondaten', 'erneuerbar-heizen', 'heizen', 'vektordaten', 'netto-null', 'fernwarmeversorgung', 'geoportal', 'energieplanung', 'kehrichtheizkraftwerk', 'stzh', 'holzheizkraftwerk', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-01T03:57:30.468761`
