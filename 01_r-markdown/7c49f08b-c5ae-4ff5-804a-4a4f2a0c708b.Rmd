...
- **Keywords.de** `['warmeversorgung', 'geodaten', 'klarwerk', 'fernwarme', 'energieversorgung', 'energieplankarte', 'kalteversorgung', 'liniendaten', 'holzheizkraftwerk', 'fernwarmeversorgung', 'erneuerbar-heizen', 'heizen', 'energie', 'geoportal', 'stzh', 'punktdaten', 'energieplanung', 'polygondaten', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'netto-null', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-29T03:34:11.277457`
