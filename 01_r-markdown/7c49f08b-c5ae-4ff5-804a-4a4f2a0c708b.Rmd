...
- **Keywords.de** `['polygondaten', 'kalteversorgung', 'klarwerk', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'heizen', 'kehrichtheizkraftwerk', 'geoportal', 'punktdaten', 'erneuerbar-heizen', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'stzh', 'energieplanung', 'vektordaten', 'holzheizkraftwerk', 'energieversorgung', 'netto-null', 'warmeversorgung', 'energieplankarte', 'liniendaten', 'fernwarme', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-24T03:12:33.839743`
