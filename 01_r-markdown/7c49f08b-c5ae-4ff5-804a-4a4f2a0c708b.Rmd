...
- **Keywords.de** `['kalteversorgung', 'netto-null', 'energieplankarte', 'fernwarme', 'stzh', 'energieversorgung', 'punktdaten', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energie', 'polygondaten', 'energieplanung', 'warmeversorgung', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'heizen', 'kehrichtheizkraftwerk', 'geodaten', 'liniendaten', 'klarwerk', 'vektordaten', 'erneuerbar-heizen', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-18T02:55:22.623611`
