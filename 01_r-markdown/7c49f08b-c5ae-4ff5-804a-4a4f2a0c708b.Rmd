...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'energieplanung', 'netto-null', 'energieversorgung', 'liniendaten', 'erneuerbar-heizen', 'energieplankarte', 'holzheizkraftwerk', 'fernwarme', 'warmeversorgung', 'polygondaten', 'energie', 'vektordaten', 'geodaten', 'heizen', 'stzh', 'punktdaten', 'geoportal', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-28T04:43:15.343864`
