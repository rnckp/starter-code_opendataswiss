...
- **Keywords.de** `['holzheizkraftwerk', 'energieplanung', 'energieplankarte', 'energie', 'fernwarmeversorgung', 'liniendaten', 'stzh', 'heizen', 'geodaten', 'fernwarme', 'kalteversorgung', 'erneuerbar-heizen', 'polygondaten', 'netto-null', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'warmeversorgung', 'energieversorgung', 'vektordaten', 'punktdaten', 'kehrichtheizkraftwerk', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-15T02:52:42.094033`
