...
- **Keywords.de** `['erneuerbar-heizen', 'vektordaten', 'kalteversorgung', 'geodaten', 'klarwerk', 'punktdaten', 'fernwarmeversorgung', 'liniendaten', 'energie', 'leitungsgebundene-energieversorgung', 'heizen', 'stzh', 'fernwarme', 'kehrichtheizkraftwerk', 'netto-null', 'energieversorgung', 'warmeversorgung', 'polygondaten', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'geoportal', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-29T02:52:04.433515`
