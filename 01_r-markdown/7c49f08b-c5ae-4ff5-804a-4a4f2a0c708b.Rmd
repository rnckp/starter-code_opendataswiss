...
- **Keywords.de** `['punktdaten', 'warmeversorgung', 'kalteversorgung', 'energieversorgung', 'vektordaten', 'geodaten', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'fernwarme', 'liniendaten', 'heizen', 'holzheizkraftwerk', 'fernwarmeversorgung', 'energieplankarte', 'energieplanung', 'geoportal', 'stzh', 'energie', 'netto-null', 'erneuerbar-heizen', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-19T03:22:43.598898`
