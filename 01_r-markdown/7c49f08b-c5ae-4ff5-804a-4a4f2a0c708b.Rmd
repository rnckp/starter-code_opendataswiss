...
- **Keywords.de** `['geoportal', 'warmeversorgung', 'vektordaten', 'punktdaten', 'stzh', 'energie', 'energieplankarte', 'fernwarme', 'holzheizkraftwerk', 'kalteversorgung', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'energieversorgung', 'liniendaten', 'energieplanung', 'heizen', 'netto-null', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-28T03:33:49.949864`
