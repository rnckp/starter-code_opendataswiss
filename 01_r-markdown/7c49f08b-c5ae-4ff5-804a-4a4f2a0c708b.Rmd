...
- **Keywords.de** `['erneuerbar-heizen', 'energieplankarte', 'fernwarmeversorgung', 'geoportal', 'holzheizkraftwerk', 'netto-null', 'klarwerk', 'vektordaten', 'warmeversorgung', 'kehrichtheizkraftwerk', 'heizen', 'polygondaten', 'energieplanung', 'energie', 'stzh', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energieversorgung', 'punktdaten', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-14T03:11:31.104125`
