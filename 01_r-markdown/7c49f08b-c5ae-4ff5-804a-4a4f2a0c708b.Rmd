...
- **Keywords.de** `['fernwarme', 'fernwarmeversorgung', 'geodaten', 'energieplanung', 'punktdaten', 'kalteversorgung', 'vektordaten', 'polygondaten', 'leitungsgebundene-energieversorgung', 'netto-null', 'erneuerbar-heizen', 'heizen', 'warmeversorgung', 'liniendaten', 'klarwerk', 'energieplankarte', 'energieversorgung', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'energie', 'energie-aus-gereinigtem-abwasser', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-09T03:51:56.447395`
