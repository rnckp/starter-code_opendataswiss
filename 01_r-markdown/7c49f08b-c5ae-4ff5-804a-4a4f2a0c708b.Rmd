...
- **Keywords.de** `['holzheizkraftwerk', 'fernwarme', 'kalteversorgung', 'warmeversorgung', 'klarwerk', 'stzh', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'liniendaten', 'energieplanung', 'energieversorgung', 'vektordaten', 'heizen', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'polygondaten', 'geodaten', 'geoportal', 'fernwarmeversorgung', 'netto-null', 'punktdaten', 'kehrichtheizkraftwerk', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-16T03:15:42.628374`
