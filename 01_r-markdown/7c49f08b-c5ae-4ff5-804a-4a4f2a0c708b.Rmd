...
- **Keywords.de** `['geodaten', 'leitungsgebundene-energieversorgung', 'netto-null', 'erneuerbar-heizen', 'polygondaten', 'geoportal', 'punktdaten', 'fernwarme', 'energie', 'energieversorgung', 'energieplankarte', 'liniendaten', 'stzh', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'kalteversorgung', 'fernwarmeversorgung', 'klarwerk', 'energieplanung', 'holzheizkraftwerk', 'warmeversorgung', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-30T03:41:54.665035`
