...
- **Keywords.de** `['vektordaten', 'liniendaten', 'fernwarme', 'geoportal', 'netto-null', 'geodaten', 'warmeversorgung', 'klarwerk', 'punktdaten', 'energieplankarte', 'energieversorgung', 'polygondaten', 'holzheizkraftwerk', 'fernwarmeversorgung', 'stzh', 'energie-aus-gereinigtem-abwasser', 'heizen', 'kalteversorgung', 'energie', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'energieplanung', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-18T03:11:31.175875`
