...
- **Keywords.de** `['energie', 'kehrichtheizkraftwerk', 'energieplankarte', 'heizen', 'netto-null', 'polygondaten', 'fernwarme', 'stzh', 'geoportal', 'vektordaten', 'punktdaten', 'energieplanung', 'geodaten', 'liniendaten', 'leitungsgebundene-energieversorgung', 'klarwerk', 'fernwarmeversorgung', 'warmeversorgung', 'energieversorgung', 'holzheizkraftwerk', 'kalteversorgung', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-14T03:48:25.214443`
