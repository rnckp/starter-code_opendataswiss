...
- **Keywords.de** `['erneuerbar-heizen', 'energieplanung', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'klarwerk', 'geoportal', 'polygondaten', 'energieplankarte', 'kehrichtheizkraftwerk', 'punktdaten', 'netto-null', 'geodaten', 'leitungsgebundene-energieversorgung', 'vektordaten', 'warmeversorgung', 'liniendaten', 'energie', 'fernwarmeversorgung', 'kalteversorgung', 'stzh', 'heizen', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-15T03:00:30.926696`
