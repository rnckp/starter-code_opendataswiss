...
- **Keywords.de** `['polygondaten', 'erneuerbar-heizen', 'geoportal', 'energieplanung', 'heizen', 'klarwerk', 'stzh', 'netto-null', 'geodaten', 'energieplankarte', 'fernwarmeversorgung', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'energieversorgung', 'vektordaten', 'energie', 'fernwarme', 'warmeversorgung', 'liniendaten', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-08T03:12:14.164496`
