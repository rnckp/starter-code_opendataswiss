...
- **Keywords.de** `['liniendaten', 'punktdaten', 'leitungsgebundene-energieversorgung', 'vektordaten', 'kalteversorgung', 'energie', 'energieversorgung', 'geodaten', 'netto-null', 'energieplanung', 'erneuerbar-heizen', 'fernwarme', 'holzheizkraftwerk', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'heizen', 'geoportal', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'klarwerk', 'polygondaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-01T04:03:12.892706`
