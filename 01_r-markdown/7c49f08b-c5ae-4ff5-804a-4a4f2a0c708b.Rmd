...
- **Keywords.de** `['geoportal', 'polygondaten', 'netto-null', 'stzh', 'liniendaten', 'punktdaten', 'vektordaten', 'warmeversorgung', 'energieplanung', 'energieversorgung', 'klarwerk', 'energieplankarte', 'geodaten', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'heizen', 'holzheizkraftwerk', 'fernwarmeversorgung', 'fernwarme', 'energie', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-18T03:32:42.799786`
