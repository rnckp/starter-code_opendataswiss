...
- **Keywords.de** `['punktdaten', 'geoportal', 'energieversorgung', 'holzheizkraftwerk', 'liniendaten', 'energie', 'energieplanung', 'polygondaten', 'erneuerbar-heizen', 'heizen', 'fernwarme', 'geodaten', 'warmeversorgung', 'energieplankarte', 'kalteversorgung', 'fernwarmeversorgung', 'stzh', 'netto-null', 'klarwerk', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-05T02:43:24.048235`
