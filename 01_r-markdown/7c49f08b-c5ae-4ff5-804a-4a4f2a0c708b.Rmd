...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'geoportal', 'erneuerbar-heizen', 'punktdaten', 'vektordaten', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'energieversorgung', 'energieplankarte', 'energieplanung', 'klarwerk', 'netto-null', 'polygondaten', 'heizen', 'fernwarme', 'energie', 'stzh', 'fernwarmeversorgung', 'geodaten', 'liniendaten', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-26T03:45:49.254373`
