...
- **Keywords.de** `['punktdaten', 'kehrichtheizkraftwerk', 'geoportal', 'stzh', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'energieplanung', 'kalteversorgung', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'heizen', 'fernwarme', 'erneuerbar-heizen', 'klarwerk', 'geodaten', 'energie', 'energieversorgung', 'vektordaten', 'netto-null', 'liniendaten', 'fernwarmeversorgung', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-26T03:35:52.544917`
