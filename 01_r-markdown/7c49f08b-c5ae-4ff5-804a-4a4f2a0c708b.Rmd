...
- **Keywords.de** `['fernwarme', 'heizen', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'geoportal', 'kalteversorgung', 'fernwarmeversorgung', 'energie', 'punktdaten', 'vektordaten', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'stzh', 'erneuerbar-heizen', 'energieplankarte', 'polygondaten', 'netto-null', 'holzheizkraftwerk', 'klarwerk', 'warmeversorgung', 'energieversorgung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-11T03:01:35.725080`
