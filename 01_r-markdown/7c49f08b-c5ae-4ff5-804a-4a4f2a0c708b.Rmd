...
- **Keywords.de** `['punktdaten', 'netto-null', 'liniendaten', 'vektordaten', 'erneuerbar-heizen', 'energie', 'fernwarme', 'stzh', 'holzheizkraftwerk', 'energieplanung', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'warmeversorgung', 'heizen', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'geodaten', 'energieplankarte', 'kehrichtheizkraftwerk', 'geoportal', 'klarwerk', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-26T03:18:02.201042`
