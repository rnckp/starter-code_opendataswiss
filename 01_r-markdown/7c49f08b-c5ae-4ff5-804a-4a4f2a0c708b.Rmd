...
- **Keywords.de** `['energieversorgung', 'polygondaten', 'stzh', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'punktdaten', 'fernwarmeversorgung', 'holzheizkraftwerk', 'vektordaten', 'fernwarme', 'heizen', 'erneuerbar-heizen', 'energieplankarte', 'geoportal', 'energie', 'kehrichtheizkraftwerk', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'energieplanung', 'warmeversorgung', 'liniendaten', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-06T02:55:39.909416`
