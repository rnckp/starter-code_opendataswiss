...
- **Keywords.de** `['erneuerbar-heizen', 'vektordaten', 'warmeversorgung', 'heizen', 'energieplankarte', 'netto-null', 'energieplanung', 'klarwerk', 'geoportal', 'kehrichtheizkraftwerk', 'kalteversorgung', 'punktdaten', 'holzheizkraftwerk', 'fernwarmeversorgung', 'fernwarme', 'polygondaten', 'liniendaten', 'leitungsgebundene-energieversorgung', 'geodaten', 'energieversorgung', 'energie', 'stzh', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-14T03:53:19.116646`
