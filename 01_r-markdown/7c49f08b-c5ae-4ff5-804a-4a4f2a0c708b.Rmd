...
- **Keywords.de** `['vektordaten', 'polygondaten', 'liniendaten', 'kalteversorgung', 'klarwerk', 'netto-null', 'kehrichtheizkraftwerk', 'warmeversorgung', 'holzheizkraftwerk', 'geodaten', 'heizen', 'erneuerbar-heizen', 'stzh', 'energieplanung', 'energieversorgung', 'energie', 'punktdaten', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-07T03:35:24.320396`
