...
- **Keywords.de** `['warmeversorgung', 'kalteversorgung', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'energieplankarte', 'vektordaten', 'stzh', 'holzheizkraftwerk', 'energieversorgung', 'netto-null', 'erneuerbar-heizen', 'energie', 'kehrichtheizkraftwerk', 'heizen', 'leitungsgebundene-energieversorgung', 'fernwarme', 'klarwerk', 'geodaten', 'liniendaten', 'polygondaten', 'fernwarmeversorgung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-01T02:53:37.251433`
