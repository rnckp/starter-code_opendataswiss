...
- **Keywords.de** `['stzh', 'liniendaten', 'energie', 'geoportal', 'fernwarme', 'polygondaten', 'energieplankarte', 'geodaten', 'holzheizkraftwerk', 'warmeversorgung', 'punktdaten', 'netto-null', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'fernwarmeversorgung', 'energieplanung', 'kalteversorgung', 'energieversorgung', 'klarwerk', 'vektordaten', 'heizen', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-24T03:10:10.598669`
