...
- **Keywords.de** `['punktdaten', 'geodaten', 'erneuerbar-heizen', 'netto-null', 'stzh', 'kehrichtheizkraftwerk', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'energie', 'heizen', 'klarwerk', 'vektordaten', 'polygondaten', 'holzheizkraftwerk', 'warmeversorgung', 'geoportal', 'energieplanung', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energieversorgung', 'fernwarmeversorgung', 'liniendaten', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-25T03:19:09.230487`
