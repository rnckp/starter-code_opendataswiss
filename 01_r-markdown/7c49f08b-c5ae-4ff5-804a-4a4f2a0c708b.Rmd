...
- **Keywords.de** `['geodaten', 'liniendaten', 'kalteversorgung', 'geoportal', 'stzh', 'energieplankarte', 'warmeversorgung', 'klarwerk', 'fernwarme', 'fernwarmeversorgung', 'energie', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'holzheizkraftwerk', 'netto-null', 'energieversorgung', 'polygondaten', 'heizen', 'leitungsgebundene-energieversorgung', 'vektordaten', 'kehrichtheizkraftwerk', 'punktdaten', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-10T03:40:10.961222`
