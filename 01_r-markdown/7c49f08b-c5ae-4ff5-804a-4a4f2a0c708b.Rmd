...
- **Keywords.de** `['erneuerbar-heizen', 'energieplankarte', 'polygondaten', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'energieversorgung', 'energie', 'fernwarme', 'kehrichtheizkraftwerk', 'klarwerk', 'kalteversorgung', 'holzheizkraftwerk', 'stzh', 'punktdaten', 'geodaten', 'leitungsgebundene-energieversorgung', 'heizen', 'energieplanung', 'liniendaten', 'netto-null', 'vektordaten', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-16T03:26:17.747489`
