...
- **Keywords.de** `['energieplanung', 'punktdaten', 'geoportal', 'warmeversorgung', 'stzh', 'fernwarmeversorgung', 'klarwerk', 'energieplankarte', 'vektordaten', 'fernwarme', 'geodaten', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'heizen', 'liniendaten', 'netto-null', 'polygondaten', 'energieversorgung', 'kalteversorgung', 'energie', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-11T03:39:01.341429`
