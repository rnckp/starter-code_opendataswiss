...
- **Keywords.de** `['energieplankarte', 'klarwerk', 'vektordaten', 'warmeversorgung', 'geodaten', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'heizen', 'netto-null', 'punktdaten', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'stzh', 'energieplanung', 'fernwarme', 'energieversorgung', 'geoportal', 'energie', 'polygondaten', 'erneuerbar-heizen', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-20T03:37:00.312777`
