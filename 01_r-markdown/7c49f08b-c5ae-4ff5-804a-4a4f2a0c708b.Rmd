...
- **Keywords.de** `['liniendaten', 'energieplanung', 'polygondaten', 'punktdaten', 'klarwerk', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'heizen', 'geodaten', 'vektordaten', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'stzh', 'fernwarme', 'netto-null', 'energieversorgung', 'kehrichtheizkraftwerk', 'geoportal', 'warmeversorgung', 'energieplankarte', 'holzheizkraftwerk', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-19T03:15:43.731801`
