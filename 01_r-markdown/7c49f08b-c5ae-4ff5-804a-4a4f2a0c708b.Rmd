...
- **Keywords.de** `['netto-null', 'stzh', 'geoportal', 'polygondaten', 'kehrichtheizkraftwerk', 'liniendaten', 'energie', 'fernwarme', 'fernwarmeversorgung', 'heizen', 'energieplanung', 'punktdaten', 'holzheizkraftwerk', 'erneuerbar-heizen', 'energieplankarte', 'geodaten', 'warmeversorgung', 'energieversorgung', 'vektordaten', 'kalteversorgung', 'klarwerk', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-20T02:29:51.595800`
