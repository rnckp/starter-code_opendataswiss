...
- **Keywords.de** `['energieplanung', 'polygondaten', 'stzh', 'kehrichtheizkraftwerk', 'geodaten', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'energieversorgung', 'energieplankarte', 'energie', 'vektordaten', 'klarwerk', 'fernwarme', 'warmeversorgung', 'netto-null', 'erneuerbar-heizen', 'punktdaten', 'heizen', 'liniendaten', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-13T02:42:36.027592`
