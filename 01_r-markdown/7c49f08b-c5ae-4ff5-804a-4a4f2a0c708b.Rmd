...
- **Keywords.de** `['liniendaten', 'netto-null', 'energie', 'heizen', 'geodaten', 'vektordaten', 'energieplanung', 'energieversorgung', 'punktdaten', 'geoportal', 'erneuerbar-heizen', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'stzh', 'kalteversorgung', 'kehrichtheizkraftwerk', 'energieplankarte', 'warmeversorgung', 'holzheizkraftwerk', 'klarwerk', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-07T03:31:05.804113`
