...
- **Keywords.de** `['klarwerk', 'kehrichtheizkraftwerk', 'vektordaten', 'energie', 'netto-null', 'energieplanung', 'fernwarmeversorgung', 'energieversorgung', 'punktdaten', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'heizen', 'polygondaten', 'warmeversorgung', 'liniendaten', 'holzheizkraftwerk', 'fernwarme', 'kalteversorgung', 'geoportal', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-02T03:31:18.883910`
