...
- **Keywords.de** `['fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'holzheizkraftwerk', 'energie', 'geoportal', 'geodaten', 'polygondaten', 'kalteversorgung', 'warmeversorgung', 'energieplanung', 'liniendaten', 'netto-null', 'fernwarme', 'energieversorgung', 'heizen', 'klarwerk', 'stzh', 'energieplankarte', 'kehrichtheizkraftwerk', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-12T02:53:42.096472`
