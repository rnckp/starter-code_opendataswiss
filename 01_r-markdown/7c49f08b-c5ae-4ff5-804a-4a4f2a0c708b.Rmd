...
- **Keywords.de** `['kehrichtheizkraftwerk', 'polygondaten', 'energieversorgung', 'punktdaten', 'warmeversorgung', 'netto-null', 'kalteversorgung', 'klarwerk', 'energieplankarte', 'liniendaten', 'geoportal', 'geodaten', 'heizen', 'leitungsgebundene-energieversorgung', 'fernwarme', 'erneuerbar-heizen', 'stzh', 'holzheizkraftwerk', 'energieplanung', 'energie', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-24T04:09:01.668464`
