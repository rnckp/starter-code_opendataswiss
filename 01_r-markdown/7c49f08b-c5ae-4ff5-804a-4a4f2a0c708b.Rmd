...
- **Keywords.de** `['punktdaten', 'kalteversorgung', 'energieplankarte', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'stzh', 'energie', 'warmeversorgung', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'netto-null', 'heizen', 'geoportal', 'energieversorgung', 'fernwarme', 'energieplanung', 'geodaten', 'liniendaten', 'fernwarmeversorgung', 'polygondaten', 'vektordaten', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-27T03:14:59.967523`
