...
- **Keywords.de** `['energie', 'fernwarmeversorgung', 'energieversorgung', 'klarwerk', 'netto-null', 'polygondaten', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'liniendaten', 'energieplankarte', 'vektordaten', 'geodaten', 'stzh', 'geoportal', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'kalteversorgung', 'energieplanung', 'heizen', 'fernwarme', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-07T04:19:35.425037`
