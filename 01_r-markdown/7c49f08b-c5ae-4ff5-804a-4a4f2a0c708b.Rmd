...
- **Keywords.de** `['holzheizkraftwerk', 'punktdaten', 'geoportal', 'geodaten', 'liniendaten', 'netto-null', 'fernwarme', 'vektordaten', 'erneuerbar-heizen', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'leitungsgebundene-energieversorgung', 'stzh', 'kalteversorgung', 'heizen', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'klarwerk', 'warmeversorgung', 'energieplankarte', 'energieplanung', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-24T03:37:59.217900`
