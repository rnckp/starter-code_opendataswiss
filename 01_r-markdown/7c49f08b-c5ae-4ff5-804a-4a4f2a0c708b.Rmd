...
- **Keywords.de** `['energieversorgung', 'geoportal', 'erneuerbar-heizen', 'geodaten', 'fernwarme', 'polygondaten', 'holzheizkraftwerk', 'energieplanung', 'stzh', 'punktdaten', 'klarwerk', 'fernwarmeversorgung', 'kalteversorgung', 'heizen', 'warmeversorgung', 'energieplankarte', 'energie', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'kehrichtheizkraftwerk', 'netto-null', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-24T03:23:13.571311`
