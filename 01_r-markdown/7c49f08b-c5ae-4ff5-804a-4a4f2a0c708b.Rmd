...
- **Keywords.de** `['energieversorgung', 'energie', 'klarwerk', 'energieplanung', 'heizen', 'polygondaten', 'punktdaten', 'warmeversorgung', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'netto-null', 'stzh', 'erneuerbar-heizen', 'liniendaten', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'holzheizkraftwerk', 'fernwarme', 'geodaten', 'fernwarmeversorgung', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-24T02:49:08.251081`
