...
- **Keywords.de** `['klarwerk', 'energieplankarte', 'energieversorgung', 'polygondaten', 'punktdaten', 'holzheizkraftwerk', 'liniendaten', 'geodaten', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'energieplanung', 'fernwarmeversorgung', 'kalteversorgung', 'heizen', 'kehrichtheizkraftwerk', 'warmeversorgung', 'energie', 'erneuerbar-heizen', 'stzh', 'fernwarme', 'vektordaten', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-09T02:24:11.578776`
