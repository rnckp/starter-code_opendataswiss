...
- **Keywords.de** `['fernwarme', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'energie', 'netto-null', 'energieplankarte', 'kalteversorgung', 'polygondaten', 'heizen', 'klarwerk', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'stzh', 'geoportal', 'geodaten', 'liniendaten', 'punktdaten', 'erneuerbar-heizen', 'energieplanung', 'holzheizkraftwerk', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-02T03:02:30.369041`
