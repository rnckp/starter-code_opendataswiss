...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'netto-null', 'erneuerbar-heizen', 'fernwarmeversorgung', 'polygondaten', 'punktdaten', 'kehrichtheizkraftwerk', 'geodaten', 'energieversorgung', 'energieplankarte', 'vektordaten', 'energieplanung', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'fernwarme', 'warmeversorgung', 'liniendaten', 'heizen', 'holzheizkraftwerk', 'energie', 'stzh', 'geoportal', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-26T04:57:42.019818`
