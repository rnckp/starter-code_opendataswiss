...
- **Keywords.de** `['kehrichtheizkraftwerk', 'klarwerk', 'leitungsgebundene-energieversorgung', 'fernwarme', 'erneuerbar-heizen', 'energieplankarte', 'energieplanung', 'fernwarmeversorgung', 'stzh', 'heizen', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'energieversorgung', 'geodaten', 'holzheizkraftwerk', 'liniendaten', 'polygondaten', 'energie', 'punktdaten', 'warmeversorgung', 'vektordaten', 'geoportal', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-03T03:28:40.121808`
