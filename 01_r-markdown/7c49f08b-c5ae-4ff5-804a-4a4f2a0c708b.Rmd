...
- **Keywords.de** `['liniendaten', 'energie', 'netto-null', 'energieplankarte', 'holzheizkraftwerk', 'fernwarme', 'heizen', 'geoportal', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'erneuerbar-heizen', 'warmeversorgung', 'kalteversorgung', 'vektordaten', 'fernwarmeversorgung', 'stzh', 'energieversorgung', 'energieplanung', 'klarwerk', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-10T03:05:19.953828`
