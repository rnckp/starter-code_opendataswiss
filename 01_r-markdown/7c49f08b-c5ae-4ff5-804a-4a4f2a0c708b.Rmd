...
- **Keywords.de** `['polygondaten', 'punktdaten', 'heizen', 'vektordaten', 'netto-null', 'fernwarme', 'energieplankarte', 'fernwarmeversorgung', 'klarwerk', 'warmeversorgung', 'erneuerbar-heizen', 'kalteversorgung', 'energie', 'geoportal', 'liniendaten', 'kehrichtheizkraftwerk', 'energieplanung', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'stzh', 'geodaten', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-25T03:25:45.180516`
