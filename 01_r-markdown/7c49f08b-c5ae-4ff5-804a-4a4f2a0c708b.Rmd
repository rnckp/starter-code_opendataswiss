...
- **Keywords.de** `['kalteversorgung', 'warmeversorgung', 'geodaten', 'energieplankarte', 'erneuerbar-heizen', 'fernwarme', 'polygondaten', 'klarwerk', 'energieversorgung', 'geoportal', 'vektordaten', 'leitungsgebundene-energieversorgung', 'stzh', 'netto-null', 'heizen', 'energie', 'liniendaten', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-28T03:14:12.654260`
