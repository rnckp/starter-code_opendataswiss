...
- **Keywords.de** `['geoportal', 'warmeversorgung', 'heizen', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'fernwarme', 'kalteversorgung', 'energieplankarte', 'klarwerk', 'polygondaten', 'erneuerbar-heizen', 'geodaten', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'energieplanung', 'liniendaten', 'energie', 'holzheizkraftwerk', 'stzh', 'kehrichtheizkraftwerk', 'vektordaten', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-28T02:48:04.452006`
