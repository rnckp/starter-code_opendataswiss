...
- **Keywords.de** `['energieversorgung', 'kalteversorgung', 'geoportal', 'liniendaten', 'fernwarme', 'punktdaten', 'warmeversorgung', 'energieplankarte', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'energieplanung', 'polygondaten', 'fernwarmeversorgung', 'energie', 'geodaten', 'vektordaten', 'klarwerk', 'stzh', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-02T02:49:37.478722`
