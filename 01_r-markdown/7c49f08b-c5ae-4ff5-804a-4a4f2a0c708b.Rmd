...
- **Keywords.de** `['polygondaten', 'punktdaten', 'liniendaten', 'fernwarme', 'heizen', 'fernwarmeversorgung', 'vektordaten', 'energie', 'kalteversorgung', 'energieversorgung', 'warmeversorgung', 'netto-null', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'geoportal', 'geodaten', 'energieplankarte', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'stzh', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-17T04:04:16.175053`
