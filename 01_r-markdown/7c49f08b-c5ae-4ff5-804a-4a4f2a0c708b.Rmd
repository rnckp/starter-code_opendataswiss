...
- **Keywords.de** `['energieplanung', 'punktdaten', 'liniendaten', 'netto-null', 'energie', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'energieplankarte', 'geodaten', 'holzheizkraftwerk', 'klarwerk', 'kehrichtheizkraftwerk', 'geoportal', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'stzh', 'kalteversorgung', 'heizen', 'fernwarmeversorgung', 'vektordaten', 'fernwarme', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-01T03:14:10.835033`
