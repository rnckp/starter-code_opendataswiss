...
- **Keywords.de** `['erneuerbar-heizen', 'fernwarmeversorgung', 'polygondaten', 'holzheizkraftwerk', 'fernwarme', 'energieplanung', 'kalteversorgung', 'klarwerk', 'netto-null', 'warmeversorgung', 'liniendaten', 'energieversorgung', 'vektordaten', 'geoportal', 'leitungsgebundene-energieversorgung', 'stzh', 'heizen', 'energie', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'geodaten', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-16T03:23:40.257904`
