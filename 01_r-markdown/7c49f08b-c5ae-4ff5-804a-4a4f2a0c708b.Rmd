...
- **Keywords.de** `['polygondaten', 'klarwerk', 'holzheizkraftwerk', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'netto-null', 'geoportal', 'energie', 'liniendaten', 'heizen', 'energieplankarte', 'fernwarmeversorgung', 'energieplanung', 'fernwarme', 'punktdaten', 'vektordaten', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'stzh', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-26T03:13:54.219860`
