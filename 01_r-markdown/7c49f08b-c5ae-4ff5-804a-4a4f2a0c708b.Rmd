...
- **Keywords.de** `['stzh', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'warmeversorgung', 'liniendaten', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'netto-null', 'geoportal', 'vektordaten', 'energieversorgung', 'fernwarmeversorgung', 'punktdaten', 'holzheizkraftwerk', 'energieplankarte', 'fernwarme', 'polygondaten', 'klarwerk', 'energieplanung', 'leitungsgebundene-energieversorgung', 'energie', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-04T03:56:21.861855`
