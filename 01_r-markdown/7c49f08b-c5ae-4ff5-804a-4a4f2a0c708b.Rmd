...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'holzheizkraftwerk', 'energie', 'klarwerk', 'fernwarme', 'energieplanung', 'energieversorgung', 'kalteversorgung', 'kehrichtheizkraftwerk', 'geoportal', 'netto-null', 'geodaten', 'warmeversorgung', 'liniendaten', 'fernwarmeversorgung', 'vektordaten', 'polygondaten', 'heizen', 'punktdaten', 'energieplankarte', 'stzh', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-03T03:30:03.329229`
