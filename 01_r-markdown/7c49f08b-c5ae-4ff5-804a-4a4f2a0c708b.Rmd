...
- **Keywords.de** `['stzh', 'energie', 'heizen', 'kalteversorgung', 'warmeversorgung', 'geodaten', 'liniendaten', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'energieversorgung', 'polygondaten', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'punktdaten', 'fernwarmeversorgung', 'netto-null', 'vektordaten', 'geoportal', 'kehrichtheizkraftwerk', 'fernwarme', 'holzheizkraftwerk', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-11T03:17:15.284282`
