...
- **Keywords.de** `['fernwarmeversorgung', 'polygondaten', 'heizen', 'energie', 'kalteversorgung', 'punktdaten', 'stzh', 'klarwerk', 'leitungsgebundene-energieversorgung', 'geoportal', 'kehrichtheizkraftwerk', 'vektordaten', 'netto-null', 'geodaten', 'energieplankarte', 'warmeversorgung', 'erneuerbar-heizen', 'energieversorgung', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'fernwarme', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-27T04:42:57.214623`
