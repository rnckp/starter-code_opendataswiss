...
- **Keywords.de** `['punktdaten', 'heizen', 'kalteversorgung', 'netto-null', 'energie', 'energieplanung', 'geodaten', 'geoportal', 'erneuerbar-heizen', 'stzh', 'fernwarmeversorgung', 'energieversorgung', 'energieplankarte', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'liniendaten', 'fernwarme', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'vektordaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-02T04:31:03.632360`
