...
- **Keywords.de** `['netto-null', 'klarwerk', 'polygondaten', 'erneuerbar-heizen', 'kalteversorgung', 'stzh', 'energieplanung', 'energieversorgung', 'liniendaten', 'energie', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'warmeversorgung', 'kehrichtheizkraftwerk', 'energieplankarte', 'fernwarmeversorgung', 'holzheizkraftwerk', 'geodaten', 'fernwarme', 'heizen', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-02T02:57:21.680250`
