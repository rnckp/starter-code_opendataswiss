...
- **Keywords.de** `['klarwerk', 'energieversorgung', 'energieplankarte', 'punktdaten', 'kehrichtheizkraftwerk', 'geodaten', 'erneuerbar-heizen', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'heizen', 'vektordaten', 'holzheizkraftwerk', 'liniendaten', 'kalteversorgung', 'energieplanung', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energie', 'stzh', 'geoportal', 'netto-null', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-17T02:14:34.188998`
