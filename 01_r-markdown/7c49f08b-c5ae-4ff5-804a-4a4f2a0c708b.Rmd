...
- **Keywords.de** `['holzheizkraftwerk', 'polygondaten', 'energieplankarte', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'vektordaten', 'geodaten', 'fernwarme', 'heizen', 'stzh', 'erneuerbar-heizen', 'energieversorgung', 'kalteversorgung', 'geoportal', 'klarwerk', 'energie', 'liniendaten', 'punktdaten', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-06T03:13:22.296628`
