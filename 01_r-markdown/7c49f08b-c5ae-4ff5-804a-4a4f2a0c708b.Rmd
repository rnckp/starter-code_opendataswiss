...
- **Keywords.de** `['energie', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'energieplanung', 'klarwerk', 'energieplankarte', 'warmeversorgung', 'geodaten', 'erneuerbar-heizen', 'vektordaten', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'stzh', 'kalteversorgung', 'liniendaten', 'netto-null', 'heizen', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'fernwarme', 'geoportal', 'polygondaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-25T03:15:44.429357`
