...
Auto-generated R starter code for the dataset 6b6e9fd7-8694-453a-af32-931c4b43cca7@stadt-zurich.
...
- **Keywords.de** `['energie', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'energieplanung', 'energieversorgung', 'erneuerbar-heizen', 'fernwarme', 'fernwarmeversorgung', 'geodaten', 'geoportal', 'heizen', 'holzheizkraftwerk', 'kalteversorgung', 'kehrichtheizkraftwerk', 'klarwerk', 'leitungsgebundene-energieversorgung', 'liniendaten', 'netto-null', 'polygondaten', 'punktdaten', 'stzh', 'vektordaten', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2026-01-06T01:06:54.555539`
