...
- **Keywords.de** `['geodaten', 'punktdaten', 'liniendaten', 'energieplankarte', 'kehrichtheizkraftwerk', 'heizen', 'holzheizkraftwerk', 'energie', 'leitungsgebundene-energieversorgung', 'geoportal', 'klarwerk', 'vektordaten', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'fernwarmeversorgung', 'energieversorgung', 'fernwarme', 'stzh', 'kalteversorgung', 'energieplanung', 'erneuerbar-heizen', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-21T02:56:42.625283`
