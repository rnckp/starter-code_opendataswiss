...
- **Keywords.de** `['holzheizkraftwerk', 'energie', 'polygondaten', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'stzh', 'klarwerk', 'geoportal', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'liniendaten', 'netto-null', 'heizen', 'vektordaten', 'fernwarme', 'geodaten', 'warmeversorgung', 'erneuerbar-heizen', 'punktdaten', 'energieplankarte', 'energieversorgung', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-14T03:05:30.759018`
