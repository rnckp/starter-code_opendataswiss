...
- **Keywords.de** `['energie', 'heizen', 'netto-null', 'fernwarmeversorgung', 'warmeversorgung', 'energieplankarte', 'kehrichtheizkraftwerk', 'punktdaten', 'leitungsgebundene-energieversorgung', 'klarwerk', 'fernwarme', 'liniendaten', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'stzh', 'kalteversorgung', 'energieplanung', 'geoportal', 'vektordaten', 'holzheizkraftwerk', 'energieversorgung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-08T04:02:45.402599`
