...
- **Keywords.de** `['geodaten', 'liniendaten', 'stzh', 'vektordaten', 'energieversorgung', 'heizen', 'energieplankarte', 'polygondaten', 'erneuerbar-heizen', 'netto-null', 'kehrichtheizkraftwerk', 'warmeversorgung', 'fernwarmeversorgung', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'energie', 'kalteversorgung', 'fernwarme', 'energieplanung', 'punktdaten', 'geoportal', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-17T03:15:43.533782`
