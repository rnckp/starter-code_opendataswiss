...
- **Keywords.de** `['polygondaten', 'energieplanung', 'heizen', 'liniendaten', 'energieversorgung', 'erneuerbar-heizen', 'fernwarme', 'fernwarmeversorgung', 'stzh', 'netto-null', 'warmeversorgung', 'punktdaten', 'vektordaten', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'energieplankarte', 'geoportal', 'energie', 'kalteversorgung', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-04T03:36:56.283817`
