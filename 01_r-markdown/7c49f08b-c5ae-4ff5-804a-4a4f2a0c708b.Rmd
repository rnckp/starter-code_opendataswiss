...
- **Keywords.de** `['netto-null', 'energieplankarte', 'warmeversorgung', 'energie', 'energieversorgung', 'kalteversorgung', 'stzh', 'liniendaten', 'holzheizkraftwerk', 'erneuerbar-heizen', 'klarwerk', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'polygondaten', 'leitungsgebundene-energieversorgung', 'fernwarme', 'geoportal', 'fernwarmeversorgung', 'heizen', 'energieplanung', 'kehrichtheizkraftwerk', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-07T03:35:07.165886`
