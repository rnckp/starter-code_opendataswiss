...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'polygondaten', 'vektordaten', 'kalteversorgung', 'energieplanung', 'erneuerbar-heizen', 'fernwarmeversorgung', 'geodaten', 'holzheizkraftwerk', 'klarwerk', 'energie', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'netto-null', 'energieversorgung', 'energieplankarte', 'punktdaten', 'warmeversorgung', 'liniendaten', 'stzh', 'heizen', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-13T03:39:30.068617`
