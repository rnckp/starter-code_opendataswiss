...
- **Keywords.de** `['energieplanung', 'geoportal', 'vektordaten', 'energieversorgung', 'geodaten', 'heizen', 'fernwarme', 'holzheizkraftwerk', 'klarwerk', 'erneuerbar-heizen', 'fernwarmeversorgung', 'liniendaten', 'kehrichtheizkraftwerk', 'stzh', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'punktdaten', 'energie', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'netto-null', 'kalteversorgung', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-29T02:39:27.794728`
