...
- **Keywords.de** `['geoportal', 'liniendaten', 'energieplanung', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'energie', 'stzh', 'klarwerk', 'energieversorgung', 'energieplankarte', 'vektordaten', 'geodaten', 'netto-null', 'heizen', 'kehrichtheizkraftwerk', 'punktdaten', 'fernwarme', 'kalteversorgung', 'erneuerbar-heizen', 'holzheizkraftwerk', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-03T04:06:00.474953`
