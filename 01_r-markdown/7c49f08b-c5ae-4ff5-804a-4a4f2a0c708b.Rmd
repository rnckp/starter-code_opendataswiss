...
- **Keywords.de** `['holzheizkraftwerk', 'fernwarme', 'netto-null', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'energie', 'geodaten', 'kalteversorgung', 'energieversorgung', 'energieplankarte', 'heizen', 'fernwarmeversorgung', 'vektordaten', 'liniendaten', 'geoportal', 'stzh', 'warmeversorgung', 'kehrichtheizkraftwerk', 'polygondaten', 'klarwerk', 'leitungsgebundene-energieversorgung', 'energieplanung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-17T02:47:53.322214`
