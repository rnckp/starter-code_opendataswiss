...
- **Keywords.de** `['energieversorgung', 'fernwarmeversorgung', 'kalteversorgung', 'vektordaten', 'liniendaten', 'heizen', 'warmeversorgung', 'energie', 'geoportal', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'klarwerk', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'punktdaten', 'netto-null', 'geodaten', 'stzh', 'fernwarme', 'polygondaten', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-23T02:57:50.210499`
