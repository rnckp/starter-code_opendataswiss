...
- **Keywords.de** `['geoportal', 'energieplanung', 'punktdaten', 'klarwerk', 'fernwarmeversorgung', 'stzh', 'warmeversorgung', 'energieplankarte', 'kehrichtheizkraftwerk', 'energieversorgung', 'polygondaten', 'heizen', 'liniendaten', 'leitungsgebundene-energieversorgung', 'vektordaten', 'netto-null', 'geodaten', 'fernwarme', 'holzheizkraftwerk', 'erneuerbar-heizen', 'energie', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-13T04:04:34.641492`
