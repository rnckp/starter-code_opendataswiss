...
- **Keywords.de** `['polygondaten', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'fernwarmeversorgung', 'kalteversorgung', 'punktdaten', 'stzh', 'geoportal', 'netto-null', 'fernwarme', 'energie', 'geodaten', 'holzheizkraftwerk', 'erneuerbar-heizen', 'energieplanung', 'heizen', 'kehrichtheizkraftwerk', 'energieplankarte', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-16T03:03:44.825355`
