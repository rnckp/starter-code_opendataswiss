...
- **Keywords.de** `['holzheizkraftwerk', 'energieversorgung', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'heizen', 'energie', 'liniendaten', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'vektordaten', 'punktdaten', 'erneuerbar-heizen', 'stzh', 'warmeversorgung', 'klarwerk', 'fernwarmeversorgung', 'netto-null', 'polygondaten', 'kalteversorgung', 'energieplanung', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-30T03:25:13.392571`
