...
- **Keywords.de** `['geodaten', 'heizen', 'energieplankarte', 'holzheizkraftwerk', 'fernwarme', 'stzh', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'kalteversorgung', 'energieversorgung', 'punktdaten', 'geoportal', 'kehrichtheizkraftwerk', 'vektordaten', 'leitungsgebundene-energieversorgung', 'polygondaten', 'liniendaten', 'klarwerk', 'energieplanung', 'fernwarmeversorgung', 'energie', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-31T03:59:42.139369`
