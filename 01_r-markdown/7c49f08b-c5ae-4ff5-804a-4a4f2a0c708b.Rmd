...
- **Keywords.de** `['heizen', 'energieplanung', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energie', 'stzh', 'kalteversorgung', 'energieversorgung', 'geoportal', 'liniendaten', 'polygondaten', 'warmeversorgung', 'fernwarme', 'klarwerk', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'punktdaten', 'vektordaten', 'erneuerbar-heizen', 'energieplankarte', 'geodaten', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-16T03:11:30.893605`
