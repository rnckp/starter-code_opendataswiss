...
- **Keywords.de** `['kalteversorgung', 'geoportal', 'energie', 'fernwarme', 'klarwerk', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'liniendaten', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'energieplanung', 'warmeversorgung', 'punktdaten', 'heizen', 'geodaten', 'polygondaten', 'energieplankarte', 'stzh', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-10T03:33:59.589406`
