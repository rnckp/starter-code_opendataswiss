...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'vektordaten', 'energieplanung', 'erneuerbar-heizen', 'fernwarme', 'liniendaten', 'stzh', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'punktdaten', 'polygondaten', 'kehrichtheizkraftwerk', 'netto-null', 'kalteversorgung', 'klarwerk', 'geoportal', 'heizen', 'energieplankarte', 'geodaten', 'warmeversorgung', 'energie', 'holzheizkraftwerk', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-27T03:51:42.729945`
