...
- **Keywords.de** `['stzh', 'fernwarme', 'klarwerk', 'leitungsgebundene-energieversorgung', 'geoportal', 'holzheizkraftwerk', 'liniendaten', 'kalteversorgung', 'erneuerbar-heizen', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'energieplankarte', 'vektordaten', 'kehrichtheizkraftwerk', 'warmeversorgung', 'energieplanung', 'energie', 'heizen', 'energieversorgung', 'polygondaten', 'fernwarmeversorgung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-29T04:08:53.060306`
