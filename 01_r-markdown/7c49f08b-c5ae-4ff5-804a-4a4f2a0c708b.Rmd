...
- **Keywords.de** `['fernwarmeversorgung', 'klarwerk', 'leitungsgebundene-energieversorgung', 'energieplanung', 'liniendaten', 'stzh', 'punktdaten', 'kalteversorgung', 'kehrichtheizkraftwerk', 'energieplankarte', 'energieversorgung', 'vektordaten', 'geodaten', 'polygondaten', 'heizen', 'warmeversorgung', 'erneuerbar-heizen', 'energie', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'geoportal', 'holzheizkraftwerk', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-12T02:59:02.071626`
