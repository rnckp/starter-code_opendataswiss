...
- **Keywords.de** `['punktdaten', 'vektordaten', 'energie', 'warmeversorgung', 'energieplanung', 'klarwerk', 'kehrichtheizkraftwerk', 'geodaten', 'leitungsgebundene-energieversorgung', 'polygondaten', 'geoportal', 'fernwarme', 'netto-null', 'stzh', 'heizen', 'erneuerbar-heizen', 'kalteversorgung', 'holzheizkraftwerk', 'energieplankarte', 'energieversorgung', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-20T02:44:10.546726`
