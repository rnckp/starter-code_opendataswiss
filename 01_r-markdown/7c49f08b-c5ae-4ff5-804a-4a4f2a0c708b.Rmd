...
- **Keywords.de** `['kehrichtheizkraftwerk', 'energieplankarte', 'liniendaten', 'polygondaten', 'energieplanung', 'geodaten', 'warmeversorgung', 'punktdaten', 'fernwarme', 'energie', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'geoportal', 'netto-null', 'stzh', 'klarwerk', 'fernwarmeversorgung', 'vektordaten', 'holzheizkraftwerk', 'heizen', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-20T03:18:56.845770`
