...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'liniendaten', 'kehrichtheizkraftwerk', 'energieversorgung', 'geoportal', 'holzheizkraftwerk', 'erneuerbar-heizen', 'klarwerk', 'heizen', 'energieplanung', 'stzh', 'fernwarmeversorgung', 'warmeversorgung', 'punktdaten', 'polygondaten', 'kalteversorgung', 'energie', 'energieplankarte', 'netto-null', 'geodaten', 'fernwarme', 'vektordaten', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-26T03:04:59.379082`
