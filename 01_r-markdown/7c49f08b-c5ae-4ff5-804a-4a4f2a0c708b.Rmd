...
- **Keywords.de** `['warmeversorgung', 'kalteversorgung', 'polygondaten', 'erneuerbar-heizen', 'holzheizkraftwerk', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'energie', 'energieplanung', 'geoportal', 'liniendaten', 'klarwerk', 'fernwarme', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'netto-null', 'stzh', 'heizen', 'geodaten', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'energieversorgung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-14T03:03:19.106606`
