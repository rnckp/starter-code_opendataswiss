...
- **Keywords.de** `['warmeversorgung', 'geodaten', 'stzh', 'liniendaten', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'energie', 'punktdaten', 'holzheizkraftwerk', 'energieplanung', 'kalteversorgung', 'polygondaten', 'fernwarmeversorgung', 'netto-null', 'geoportal', 'heizen', 'fernwarme', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'erneuerbar-heizen', 'energieversorgung', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-22T03:21:26.569328`
