...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'fernwarme', 'polygondaten', 'geodaten', 'klarwerk', 'netto-null', 'holzheizkraftwerk', 'vektordaten', 'stzh', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'energieversorgung', 'energieplankarte', 'erneuerbar-heizen', 'heizen', 'fernwarmeversorgung', 'geoportal', 'warmeversorgung', 'punktdaten', 'kalteversorgung', 'energie', 'liniendaten', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-07-30T03:09:39.469241`
