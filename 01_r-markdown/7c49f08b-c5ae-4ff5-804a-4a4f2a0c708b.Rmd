...
- **Keywords.de** `['energieplanung', 'klarwerk', 'fernwarme', 'heizen', 'erneuerbar-heizen', 'geodaten', 'warmeversorgung', 'kehrichtheizkraftwerk', 'kalteversorgung', 'netto-null', 'punktdaten', 'stzh', 'liniendaten', 'energie', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'geoportal', 'vektordaten', 'polygondaten', 'energieversorgung', 'energieplankarte', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-30T03:05:43.109554`
