...
- **Keywords.de** `['energieplanung', 'energie', 'polygondaten', 'energieversorgung', 'netto-null', 'kalteversorgung', 'kehrichtheizkraftwerk', 'geoportal', 'energieplankarte', 'fernwarmeversorgung', 'heizen', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'stzh', 'punktdaten', 'leitungsgebundene-energieversorgung', 'liniendaten', 'klarwerk', 'vektordaten', 'geodaten', 'holzheizkraftwerk', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-25T03:26:03.982004`
