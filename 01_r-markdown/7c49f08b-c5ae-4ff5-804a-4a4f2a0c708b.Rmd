...
- **Keywords.de** `['geodaten', 'leitungsgebundene-energieversorgung', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'geoportal', 'energie', 'netto-null', 'energieplankarte', 'stzh', 'liniendaten', 'fernwarmeversorgung', 'warmeversorgung', 'heizen', 'kehrichtheizkraftwerk', 'energieversorgung', 'holzheizkraftwerk', 'erneuerbar-heizen', 'energieplanung', 'punktdaten', 'polygondaten', 'vektordaten', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-04T03:21:27.723139`
