...
- **Keywords.de** `['kalteversorgung', 'energieplanung', 'geoportal', 'warmeversorgung', 'punktdaten', 'energieplankarte', 'fernwarme', 'holzheizkraftwerk', 'klarwerk', 'polygondaten', 'liniendaten', 'energieversorgung', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'energie', 'heizen', 'stzh', 'vektordaten', 'geodaten', 'fernwarmeversorgung', 'netto-null', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-31T02:54:15.501253`
