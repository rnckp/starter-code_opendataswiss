...
- **Keywords.de** `['geoportal', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'kalteversorgung', 'energieplankarte', 'holzheizkraftwerk', 'geodaten', 'erneuerbar-heizen', 'vektordaten', 'liniendaten', 'energie', 'stzh', 'fernwarmeversorgung', 'klarwerk', 'netto-null', 'leitungsgebundene-energieversorgung', 'polygondaten', 'energieplanung', 'heizen', 'kehrichtheizkraftwerk', 'fernwarme', 'punktdaten', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-09T03:48:08.413607`
