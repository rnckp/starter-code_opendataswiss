...
- **Keywords.de** `['warmeversorgung', 'geoportal', 'liniendaten', 'polygondaten', 'fernwarme', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'erneuerbar-heizen', 'punktdaten', 'stzh', 'energieversorgung', 'energieplanung', 'leitungsgebundene-energieversorgung', 'netto-null', 'geodaten', 'kalteversorgung', 'energieplankarte', 'holzheizkraftwerk', 'vektordaten', 'fernwarmeversorgung', 'energie', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-11T03:34:26.387607`
