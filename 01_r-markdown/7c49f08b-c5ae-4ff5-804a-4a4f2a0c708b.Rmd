...
- **Keywords.de** `['fernwarmeversorgung', 'energie', 'energieversorgung', 'klarwerk', 'geoportal', 'kehrichtheizkraftwerk', 'energieplanung', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'liniendaten', 'energieplankarte', 'warmeversorgung', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'netto-null', 'polygondaten', 'fernwarme', 'kalteversorgung', 'heizen', 'holzheizkraftwerk', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-09-26T02:58:02.035862`
