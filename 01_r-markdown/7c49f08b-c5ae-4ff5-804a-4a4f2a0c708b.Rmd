...
- **Keywords.de** `['kalteversorgung', 'stzh', 'fernwarme', 'geodaten', 'geoportal', 'holzheizkraftwerk', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'energieplanung', 'vektordaten', 'punktdaten', 'klarwerk', 'erneuerbar-heizen', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'warmeversorgung', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'liniendaten', 'energie', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-27T03:58:01.781828`
