...
- **Keywords.de** `['liniendaten', 'stzh', 'fernwarme', 'heizen', 'energieplanung', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'warmeversorgung', 'klarwerk', 'energieplankarte', 'geoportal', 'leitungsgebundene-energieversorgung', 'geodaten', 'energieversorgung', 'punktdaten', 'kehrichtheizkraftwerk', 'kalteversorgung', 'energie', 'holzheizkraftwerk', 'polygondaten', 'erneuerbar-heizen', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-22T03:16:48.922995`
