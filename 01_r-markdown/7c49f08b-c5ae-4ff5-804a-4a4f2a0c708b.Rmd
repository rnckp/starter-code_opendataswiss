...
- **Keywords.de** `['energieplanung', 'energieversorgung', 'warmeversorgung', 'energieplankarte', 'vektordaten', 'liniendaten', 'fernwarmeversorgung', 'fernwarme', 'punktdaten', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'heizen', 'geoportal', 'holzheizkraftwerk', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'stzh', 'energie', 'netto-null', 'polygondaten', 'klarwerk', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-07T02:34:11.818097`
