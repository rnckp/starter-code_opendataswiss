...
- **Keywords.de** `['energieversorgung', 'polygondaten', 'netto-null', 'energie', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'punktdaten', 'stzh', 'klarwerk', 'kalteversorgung', 'heizen', 'holzheizkraftwerk', 'vektordaten', 'fernwarme', 'energieplankarte', 'erneuerbar-heizen', 'energieplanung', 'geodaten', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'liniendaten', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-06-02T03:07:11.601969`
