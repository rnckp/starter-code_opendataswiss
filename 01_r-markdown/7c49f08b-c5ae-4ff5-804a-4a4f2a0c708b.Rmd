...
- **Keywords.de** `['liniendaten', 'polygondaten', 'geoportal', 'kehrichtheizkraftwerk', 'kalteversorgung', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'stzh', 'energieversorgung', 'geodaten', 'energieplanung', 'warmeversorgung', 'erneuerbar-heizen', 'punktdaten', 'energie', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'fernwarme', 'heizen', 'vektordaten', 'fernwarmeversorgung', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-30T03:22:14.543990`
