...
- **Keywords.de** `['punktdaten', 'geodaten', 'klarwerk', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'heizen', 'netto-null', 'polygondaten', 'kalteversorgung', 'stzh', 'energieversorgung', 'erneuerbar-heizen', 'fernwarmeversorgung', 'holzheizkraftwerk', 'energie', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'vektordaten', 'geoportal', 'liniendaten', 'energieplanung', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-03-02T03:16:33.972138`
