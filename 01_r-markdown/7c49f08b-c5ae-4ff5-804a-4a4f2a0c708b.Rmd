...
- **Keywords.de** `['holzheizkraftwerk', 'stzh', 'leitungsgebundene-energieversorgung', 'polygondaten', 'kalteversorgung', 'vektordaten', 'energieversorgung', 'warmeversorgung', 'liniendaten', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'energie', 'netto-null', 'energieplankarte', 'fernwarmeversorgung', 'klarwerk', 'energieplanung', 'heizen', 'punktdaten', 'kehrichtheizkraftwerk', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-08T03:36:08.794746`
