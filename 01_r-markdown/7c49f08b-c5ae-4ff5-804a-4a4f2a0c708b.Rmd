...
- **Keywords.de** `['energie', 'kehrichtheizkraftwerk', 'netto-null', 'energieplanung', 'kalteversorgung', 'fernwarme', 'fernwarmeversorgung', 'liniendaten', 'holzheizkraftwerk', 'punktdaten', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'geodaten', 'klarwerk', 'geoportal', 'polygondaten', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'stzh', 'heizen', 'energieversorgung', 'vektordaten', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-09T03:11:11.824044`
