...
- **Keywords.de** `['stzh', 'energieplankarte', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'holzheizkraftwerk', 'netto-null', 'energie', 'kalteversorgung', 'polygondaten', 'punktdaten', 'geodaten', 'fernwarme', 'energieversorgung', 'erneuerbar-heizen', 'heizen', 'energieplanung', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'fernwarmeversorgung', 'liniendaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-10-09T04:21:56.428769`
