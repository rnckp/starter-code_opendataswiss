...
- **Keywords.de** `['warmeversorgung', 'kalteversorgung', 'klarwerk', 'erneuerbar-heizen', 'fernwarmeversorgung', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'fernwarme', 'polygondaten', 'energieplanung', 'energie', 'punktdaten', 'geodaten', 'stzh', 'energieversorgung', 'heizen', 'vektordaten', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'netto-null', 'geoportal', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-03-07T03:02:01.056232`
