...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'klarwerk', 'vektordaten', 'energieplankarte', 'netto-null', 'polygondaten', 'geoportal', 'energieversorgung', 'liniendaten', 'energieplanung', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'fernwarme', 'fernwarmeversorgung', 'punktdaten', 'heizen', 'warmeversorgung', 'geodaten', 'stzh', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-22T03:38:31.142691`
