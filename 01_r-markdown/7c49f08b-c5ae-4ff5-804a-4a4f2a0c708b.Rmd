...
- **Keywords.de** `['energie', 'geodaten', 'klarwerk', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'liniendaten', 'netto-null', 'heizen', 'fernwarmeversorgung', 'polygondaten', 'punktdaten', 'kehrichtheizkraftwerk', 'geoportal', 'energieplanung', 'energieplankarte', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'warmeversorgung', 'fernwarme', 'stzh', 'holzheizkraftwerk', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-18T03:29:37.560553`
