...
- **Keywords.de** `['warmeversorgung', 'geoportal', 'netto-null', 'kalteversorgung', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'heizen', 'fernwarmeversorgung', 'geodaten', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'energieplankarte', 'kehrichtheizkraftwerk', 'energieplanung', 'fernwarme', 'vektordaten', 'erneuerbar-heizen', 'stzh', 'energie', 'holzheizkraftwerk', 'polygondaten', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-12T03:33:46.590515`
