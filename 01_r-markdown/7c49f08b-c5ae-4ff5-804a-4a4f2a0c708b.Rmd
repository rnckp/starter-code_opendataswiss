...
- **Keywords.de** `['klarwerk', 'geodaten', 'stzh', 'heizen', 'vektordaten', 'punktdaten', 'liniendaten', 'polygondaten', 'erneuerbar-heizen', 'energie', 'leitungsgebundene-energieversorgung', 'netto-null', 'fernwarme', 'kehrichtheizkraftwerk', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'warmeversorgung', 'energieplanung', 'energieversorgung', 'energieplankarte', 'fernwarmeversorgung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-30T03:26:10.929471`
