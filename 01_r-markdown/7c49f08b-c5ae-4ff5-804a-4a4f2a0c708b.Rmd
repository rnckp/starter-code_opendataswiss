...
- **Keywords.de** `['geoportal', 'erneuerbar-heizen', 'holzheizkraftwerk', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'energie', 'klarwerk', 'geodaten', 'polygondaten', 'liniendaten', 'energieplankarte', 'kehrichtheizkraftwerk', 'heizen', 'vektordaten', 'energieplanung', 'netto-null', 'kalteversorgung', 'stzh', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'fernwarme', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-09T03:30:26.760762`
