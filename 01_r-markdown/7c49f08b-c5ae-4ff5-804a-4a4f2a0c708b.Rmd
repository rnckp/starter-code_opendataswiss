...
- **Keywords.de** `['stzh', 'heizen', 'fernwarmeversorgung', 'holzheizkraftwerk', 'energieversorgung', 'warmeversorgung', 'netto-null', 'energieplanung', 'energieplankarte', 'kalteversorgung', 'kehrichtheizkraftwerk', 'vektordaten', 'leitungsgebundene-energieversorgung', 'polygondaten', 'erneuerbar-heizen', 'energie', 'klarwerk', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'geodaten', 'punktdaten', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-22T03:33:55.853230`
