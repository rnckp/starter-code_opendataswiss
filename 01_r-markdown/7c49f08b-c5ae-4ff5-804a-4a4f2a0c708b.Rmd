...
- **Keywords.de** `['punktdaten', 'kehrichtheizkraftwerk', 'kalteversorgung', 'stzh', 'energieplankarte', 'klarwerk', 'energie', 'heizen', 'fernwarmeversorgung', 'fernwarme', 'energieplanung', 'warmeversorgung', 'netto-null', 'leitungsgebundene-energieversorgung', 'geodaten', 'energieversorgung', 'liniendaten', 'vektordaten', 'holzheizkraftwerk', 'erneuerbar-heizen', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-20T02:16:10.536729`
