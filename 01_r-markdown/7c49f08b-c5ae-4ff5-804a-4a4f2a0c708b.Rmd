...
- **Keywords.de** `['punktdaten', 'vektordaten', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'kehrichtheizkraftwerk', 'geoportal', 'liniendaten', 'stzh', 'holzheizkraftwerk', 'fernwarme', 'geodaten', 'netto-null', 'polygondaten', 'energieplankarte', 'heizen', 'warmeversorgung', 'erneuerbar-heizen', 'klarwerk', 'fernwarmeversorgung', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-06T02:53:56.359108`
