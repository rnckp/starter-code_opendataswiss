...
- **Keywords.de** `['energieplanung', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'liniendaten', 'fernwarmeversorgung', 'energieplankarte', 'vektordaten', 'leitungsgebundene-energieversorgung', 'heizen', 'energie', 'warmeversorgung', 'klarwerk', 'geodaten', 'stzh', 'geoportal', 'erneuerbar-heizen', 'fernwarme', 'kalteversorgung', 'energieversorgung', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-27T02:57:45.466544`
