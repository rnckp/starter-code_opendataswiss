...
- **Keywords.de** `['energieversorgung', 'warmeversorgung', 'fernwarmeversorgung', 'geoportal', 'holzheizkraftwerk', 'polygondaten', 'erneuerbar-heizen', 'kalteversorgung', 'kehrichtheizkraftwerk', 'vektordaten', 'heizen', 'energie-aus-gereinigtem-abwasser', 'energie', 'klarwerk', 'energieplanung', 'geodaten', 'netto-null', 'fernwarme', 'energieplankarte', 'stzh', 'liniendaten', 'leitungsgebundene-energieversorgung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-03-15T03:04:46.709114`
