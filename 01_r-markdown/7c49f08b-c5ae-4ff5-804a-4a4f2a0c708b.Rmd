...
- **Keywords.de** `['warmeversorgung', 'kehrichtheizkraftwerk', 'geoportal', 'heizen', 'energieplankarte', 'netto-null', 'liniendaten', 'vektordaten', 'energie', 'erneuerbar-heizen', 'geodaten', 'klarwerk', 'punktdaten', 'kalteversorgung', 'stzh', 'energieplanung', 'energieversorgung', 'fernwarme', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-30T03:06:21.353126`
