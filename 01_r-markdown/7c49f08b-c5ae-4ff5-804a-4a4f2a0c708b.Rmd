...
- **Keywords.de** `['geoportal', 'netto-null', 'fernwarmeversorgung', 'liniendaten', 'kalteversorgung', 'erneuerbar-heizen', 'polygondaten', 'vektordaten', 'geodaten', 'fernwarme', 'energieplanung', 'stzh', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'klarwerk', 'energieplankarte', 'punktdaten', 'kehrichtheizkraftwerk', 'energie', 'energieversorgung', 'holzheizkraftwerk', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-19T03:14:27.073721`
