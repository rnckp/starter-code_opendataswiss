...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'stzh', 'heizen', 'netto-null', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'energieplanung', 'erneuerbar-heizen', 'holzheizkraftwerk', 'geodaten', 'energieversorgung', 'vektordaten', 'klarwerk', 'fernwarme', 'kalteversorgung', 'geoportal', 'fernwarmeversorgung', 'energie', 'energieplankarte', 'warmeversorgung', 'polygondaten', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-02T03:30:30.670886`
