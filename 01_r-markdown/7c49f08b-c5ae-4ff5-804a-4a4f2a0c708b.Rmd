...
- **Keywords.de** `['geodaten', 'energieversorgung', 'stzh', 'kalteversorgung', 'klarwerk', 'vektordaten', 'energie', 'netto-null', 'fernwarmeversorgung', 'liniendaten', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'heizen', 'kehrichtheizkraftwerk', 'fernwarme', 'punktdaten', 'holzheizkraftwerk', 'geoportal', 'energieplankarte', 'polygondaten', 'warmeversorgung', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-10T03:12:33.288455`
