...
- **Keywords.de** `['stzh', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'liniendaten', 'energieplanung', 'holzheizkraftwerk', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'klarwerk', 'geodaten', 'netto-null', 'heizen', 'warmeversorgung', 'kalteversorgung', 'fernwarmeversorgung', 'energie', 'fernwarme', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'punktdaten', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-12-14T03:42:50.570231`
