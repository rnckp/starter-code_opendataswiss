...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'energieplankarte', 'fernwarme', 'energie', 'kehrichtheizkraftwerk', 'geoportal', 'fernwarmeversorgung', 'stzh', 'kalteversorgung', 'punktdaten', 'holzheizkraftwerk', 'energieversorgung', 'liniendaten', 'heizen', 'energieplanung', 'erneuerbar-heizen', 'polygondaten', 'klarwerk', 'netto-null', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-11T03:28:33.555732`
