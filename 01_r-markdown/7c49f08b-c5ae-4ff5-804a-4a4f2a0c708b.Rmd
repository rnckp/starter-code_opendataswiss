...
- **Keywords.de** `['liniendaten', 'vektordaten', 'kalteversorgung', 'kehrichtheizkraftwerk', 'klarwerk', 'punktdaten', 'holzheizkraftwerk', 'geoportal', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'stzh', 'heizen', 'energieplankarte', 'warmeversorgung', 'energieversorgung', 'energie', 'energieplanung', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'netto-null', 'geodaten', 'fernwarme', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-05-23T02:54:32.683408`
