...
- **Keywords.de** `['energie', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'netto-null', 'punktdaten', 'energieplanung', 'kalteversorgung', 'polygondaten', 'stzh', 'klarwerk', 'heizen', 'warmeversorgung', 'geodaten', 'liniendaten', 'holzheizkraftwerk', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'vektordaten', 'energieplankarte', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'geoportal', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-01T03:43:40.384171`
