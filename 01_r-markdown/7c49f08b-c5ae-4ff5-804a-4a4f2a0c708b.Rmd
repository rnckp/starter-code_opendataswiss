...
- **Keywords.de** `['kehrichtheizkraftwerk', 'warmeversorgung', 'fernwarme', 'polygondaten', 'energieplanung', 'netto-null', 'fernwarmeversorgung', 'vektordaten', 'stzh', 'energieversorgung', 'energieplankarte', 'holzheizkraftwerk', 'heizen', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'energie', 'erneuerbar-heizen', 'geoportal', 'leitungsgebundene-energieversorgung', 'geodaten', 'kalteversorgung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-10T04:11:48.812657`
