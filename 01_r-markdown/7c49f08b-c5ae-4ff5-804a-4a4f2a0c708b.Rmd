...
- **Keywords.de** `['geoportal', 'holzheizkraftwerk', 'fernwarme', 'punktdaten', 'stzh', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'klarwerk', 'kehrichtheizkraftwerk', 'warmeversorgung', 'heizen', 'vektordaten', 'fernwarmeversorgung', 'netto-null', 'geodaten', 'kalteversorgung', 'energieplankarte', 'polygondaten', 'liniendaten', 'energieplanung', 'leitungsgebundene-energieversorgung', 'energie', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-02T04:01:56.135687`
