...
- **Keywords.de** `['erneuerbar-heizen', 'fernwarmeversorgung', 'geodaten', 'fernwarme', 'energieversorgung', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'geoportal', 'energie', 'polygondaten', 'holzheizkraftwerk', 'punktdaten', 'vektordaten', 'stzh', 'netto-null', 'warmeversorgung', 'kalteversorgung', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'heizen', 'energieplanung', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-05T02:59:51.492487`
