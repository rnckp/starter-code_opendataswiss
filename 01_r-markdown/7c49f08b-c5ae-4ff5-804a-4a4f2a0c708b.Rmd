...
- **Keywords.de** `['energieplanung', 'leitungsgebundene-energieversorgung', 'fernwarme', 'geoportal', 'klarwerk', 'heizen', 'warmeversorgung', 'geodaten', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'kehrichtheizkraftwerk', 'kalteversorgung', 'energie', 'netto-null', 'punktdaten', 'energieplankarte', 'liniendaten', 'stzh', 'fernwarmeversorgung', 'holzheizkraftwerk', 'energieversorgung', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-05-26T03:46:16.722644`
