...
- **Keywords.de** `['stzh', 'warmeversorgung', 'vektordaten', 'kalteversorgung', 'geodaten', 'fernwarme', 'erneuerbar-heizen', 'energieversorgung', 'klarwerk', 'energie', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'punktdaten', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'geoportal', 'netto-null', 'energieplankarte', 'heizen', 'liniendaten', 'energieplanung', 'leitungsgebundene-energieversorgung', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-20T03:53:40.834502`
