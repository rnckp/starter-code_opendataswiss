...
- **Keywords.de** `['erneuerbar-heizen', 'liniendaten', 'energieversorgung', 'stzh', 'energieplanung', 'vektordaten', 'netto-null', 'punktdaten', 'klarwerk', 'polygondaten', 'kalteversorgung', 'warmeversorgung', 'energie', 'geoportal', 'fernwarme', 'kehrichtheizkraftwerk', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'holzheizkraftwerk', 'heizen', 'geodaten', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-20T05:02:02.609777`
