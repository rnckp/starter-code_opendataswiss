...
- **Keywords.de** `['stzh', 'vektordaten', 'liniendaten', 'klarwerk', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'energieplanung', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'kehrichtheizkraftwerk', 'warmeversorgung', 'heizen', 'geodaten', 'kalteversorgung', 'holzheizkraftwerk', 'geoportal', 'fernwarme', 'energie', 'fernwarmeversorgung', 'polygondaten', 'energieplankarte', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-11T03:26:35.712828`
