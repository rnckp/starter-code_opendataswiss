...
- **Keywords.de** `['energie', 'geodaten', 'kalteversorgung', 'liniendaten', 'netto-null', 'heizen', 'fernwarmeversorgung', 'energieplankarte', 'fernwarme', 'warmeversorgung', 'geoportal', 'klarwerk', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'kehrichtheizkraftwerk', 'energieplanung', 'energieversorgung', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'vektordaten', 'erneuerbar-heizen', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-16T03:33:10.635132`
