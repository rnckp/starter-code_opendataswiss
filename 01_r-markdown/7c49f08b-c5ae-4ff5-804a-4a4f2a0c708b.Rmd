...
- **Keywords.de** `['energieversorgung', 'stzh', 'fernwarmeversorgung', 'klarwerk', 'kehrichtheizkraftwerk', 'vektordaten', 'fernwarme', 'polygondaten', 'energieplankarte', 'energieplanung', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'holzheizkraftwerk', 'energie', 'kalteversorgung', 'geoportal', 'geodaten', 'warmeversorgung', 'heizen', 'punktdaten', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-04-05T03:27:23.409875`
