...
- **Keywords.de** `['geoportal', 'leitungsgebundene-energieversorgung', 'punktdaten', 'polygondaten', 'energieplankarte', 'holzheizkraftwerk', 'fernwarme', 'erneuerbar-heizen', 'stzh', 'netto-null', 'kehrichtheizkraftwerk', 'klarwerk', 'warmeversorgung', 'energieversorgung', 'energie', 'heizen', 'geodaten', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'liniendaten', 'energieplanung', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-08T03:24:25.555614`
