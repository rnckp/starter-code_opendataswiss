...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'punktdaten', 'energieplanung', 'fernwarme', 'geoportal', 'liniendaten', 'fernwarmeversorgung', 'kalteversorgung', 'erneuerbar-heizen', 'stzh', 'netto-null', 'klarwerk', 'vektordaten', 'energieversorgung', 'holzheizkraftwerk', 'energie', 'kehrichtheizkraftwerk', 'geodaten', 'polygondaten', 'heizen', 'warmeversorgung', 'energieplankarte', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-01-17T03:34:21.114644`
