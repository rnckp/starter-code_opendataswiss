...
- **Keywords.de** `['netto-null', 'energie', 'warmeversorgung', 'heizen', 'klarwerk', 'geoportal', 'holzheizkraftwerk', 'fernwarmeversorgung', 'stzh', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'polygondaten', 'vektordaten', 'leitungsgebundene-energieversorgung', 'liniendaten', 'fernwarme', 'punktdaten', 'energieversorgung', 'energieplanung', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-01T03:02:20.595705`
