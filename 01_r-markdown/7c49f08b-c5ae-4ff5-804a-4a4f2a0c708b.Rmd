...
- **Keywords.de** `['geodaten', 'polygondaten', 'punktdaten', 'erneuerbar-heizen', 'klarwerk', 'heizen', 'energieplanung', 'geoportal', 'kehrichtheizkraftwerk', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'energieversorgung', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'energie', 'stzh', 'vektordaten', 'kalteversorgung', 'netto-null', 'fernwarme', 'fernwarmeversorgung', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-02-14T03:32:26.025161`
