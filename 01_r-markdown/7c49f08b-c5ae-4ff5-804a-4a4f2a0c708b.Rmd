...
- **Keywords.de** `['geodaten', 'energie', 'polygondaten', 'erneuerbar-heizen', 'kalteversorgung', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'kehrichtheizkraftwerk', 'energieversorgung', 'fernwarmeversorgung', 'vektordaten', 'stzh', 'punktdaten', 'fernwarme', 'holzheizkraftwerk', 'netto-null', 'warmeversorgung', 'energieplankarte', 'geoportal', 'heizen', 'energieplanung', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-11-15T03:45:24.319520`
