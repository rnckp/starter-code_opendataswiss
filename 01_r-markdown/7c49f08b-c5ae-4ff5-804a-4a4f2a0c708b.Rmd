...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'fernwarme', 'heizen', 'klarwerk', 'leitungsgebundene-energieversorgung', 'netto-null', 'polygondaten', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'warmeversorgung', 'erneuerbar-heizen', 'kalteversorgung', 'energieplankarte', 'holzheizkraftwerk', 'geoportal', 'vektordaten', 'punktdaten', 'energie', 'liniendaten', 'geodaten', 'energieversorgung', 'stzh', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-04-19T02:08:26.339962`
