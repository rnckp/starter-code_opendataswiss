...
- **Keywords.de** `['erneuerbar-heizen', 'kehrichtheizkraftwerk', 'geodaten', 'fernwarmeversorgung', 'energieversorgung', 'kalteversorgung', 'energieplankarte', 'netto-null', 'geoportal', 'liniendaten', 'punktdaten', 'heizen', 'vektordaten', 'klarwerk', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energieplanung', 'polygondaten', 'warmeversorgung', 'holzheizkraftwerk', 'energie', 'energie-aus-gereinigtem-abwasser', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-22T02:46:29.355868`
