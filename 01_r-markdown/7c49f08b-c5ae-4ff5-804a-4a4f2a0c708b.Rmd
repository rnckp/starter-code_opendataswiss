...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'heizen', 'netto-null', 'vektordaten', 'polygondaten', 'punktdaten', 'energieplanung', 'energieplankarte', 'geoportal', 'kehrichtheizkraftwerk', 'liniendaten', 'warmeversorgung', 'geodaten', 'stzh', 'klarwerk', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'fernwarme', 'kalteversorgung', 'energieversorgung', 'holzheizkraftwerk', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-05T04:32:01.520513`
