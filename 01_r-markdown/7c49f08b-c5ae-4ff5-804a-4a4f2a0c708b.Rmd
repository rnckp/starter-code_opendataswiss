...
- **Keywords.de** `['kehrichtheizkraftwerk', 'energieplanung', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'energieversorgung', 'energie', 'fernwarme', 'heizen', 'energieplankarte', 'holzheizkraftwerk', 'warmeversorgung', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'netto-null', 'kalteversorgung', 'polygondaten', 'stzh', 'geodaten', 'erneuerbar-heizen', 'klarwerk', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-09T06:19:00.240201`
