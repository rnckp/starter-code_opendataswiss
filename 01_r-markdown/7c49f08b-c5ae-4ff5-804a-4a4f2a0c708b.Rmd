...
- **Keywords.de** `['energie', 'punktdaten', 'kehrichtheizkraftwerk', 'fernwarme', 'energieversorgung', 'stzh', 'energieplanung', 'liniendaten', 'heizen', 'warmeversorgung', 'holzheizkraftwerk', 'klarwerk', 'polygondaten', 'vektordaten', 'geoportal', 'geodaten', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'erneuerbar-heizen', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-07-15T03:50:19.918802`
