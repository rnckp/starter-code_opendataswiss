...
- **Keywords.de** `['kalteversorgung', 'stzh', 'geodaten', 'klarwerk', 'energieplankarte', 'warmeversorgung', 'holzheizkraftwerk', 'fernwarme', 'energie', 'vektordaten', 'fernwarmeversorgung', 'netto-null', 'liniendaten', 'energieplanung', 'energieversorgung', 'polygondaten', 'punktdaten', 'heizen', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'geoportal', 'kehrichtheizkraftwerk', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2024-08-20T03:18:39.757384`
