...
- **Keywords.de** `['fernwarme', 'energieplanung', 'punktdaten', 'energieversorgung', 'geoportal', 'netto-null', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'warmeversorgung', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'polygondaten', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'klarwerk', 'fernwarmeversorgung', 'heizen', 'energie', 'kalteversorgung', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-08-25T02:07:21.102466`
