...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'geodaten', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'geoportal', 'holzheizkraftwerk', 'energieplanung', 'kalteversorgung', 'punktdaten', 'klarwerk', 'stzh', 'fernwarmeversorgung', 'polygondaten', 'erneuerbar-heizen', 'energie', 'netto-null', 'kehrichtheizkraftwerk', 'liniendaten', 'fernwarme', 'energieversorgung', 'heizen', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-09-10T06:02:10.364456`
