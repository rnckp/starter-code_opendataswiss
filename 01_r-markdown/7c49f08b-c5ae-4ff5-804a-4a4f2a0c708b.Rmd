...
- **Keywords.de** `['holzheizkraftwerk', 'fernwarme', 'energieplanung', 'energie', 'geoportal', 'erneuerbar-heizen', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'geodaten', 'vektordaten', 'klarwerk', 'fernwarmeversorgung', 'stzh', 'energieplankarte', 'heizen', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'netto-null', 'punktdaten', 'energieversorgung', 'polygondaten', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:31.988729`
- **Metadata_modified** `2025-06-07T04:25:41.793971`
