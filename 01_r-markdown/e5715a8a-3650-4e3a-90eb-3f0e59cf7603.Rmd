...
- **Keywords.de** `['zentrumszone', 'mischzone', 'offentliche-nutzung', 'bodennutzung', 'flache', 'statistikdaten', 'arbeitszone', 'bauzone', 'freizeitzone', 'wohnzone', 'tourismuszone']`
- **Issued** `2022-09-05T00:00:00`
- **Metadata_created** `2022-12-13T15:07:53.048485`
- **Metadata_modified** `2024-08-08T03:39:37.588062`
...
df <- read_delim('https://data.bl.ch/api/v2/catalog/datasets/10090/exports/csv?use_labels=false')
