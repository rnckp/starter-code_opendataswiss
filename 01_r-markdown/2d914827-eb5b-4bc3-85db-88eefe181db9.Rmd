...
- **Keywords.de** `['windgeschwindigkeit', 'luftdruck', 'temperatur', 'hr', 'messwerte', 'tabelle', 'luftfeuchte', 'regendauer', 'umweltdaten', 'sachdaten', 'niederschlag', 'meteo', 'luft', 'wind', 'feuchte', 'wd', 'hitze', 'windrichtung', 'p_', 'kalte', 'wv', 'zeitreihe', 'global-strahlung', 'regen', 'wetter', 't_', 'echtzeit', 'lufttemperatur']`
- **Issued** `nan`
- **Metadata_created** `2024-11-28T02:48:27.678398`
- **Metadata_modified** `2025-01-18T03:25:33.811143`
