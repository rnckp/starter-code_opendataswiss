...
- **Keywords.de** `['windrichtung', 'luft', 'niederschlag', 'wd', 'zeitreihe', 'messwerte', 'wv', 'sachdaten', 'regendauer', 'luftfeuchte', 'regen', 'umweltdaten', 'meteo', 'temperatur', 'luftdruck', 't_', 'wind', 'hitze', 'hr', 'global-strahlung', 'echtzeit', 'kalte', 'windgeschwindigkeit', 'p_', 'feuchte', 'tabelle', 'lufttemperatur', 'wetter']`
- **Issued** `nan`
- **Metadata_created** `2024-11-28T02:48:27.678398`
- **Metadata_modified** `2025-03-13T04:05:14.862530`
