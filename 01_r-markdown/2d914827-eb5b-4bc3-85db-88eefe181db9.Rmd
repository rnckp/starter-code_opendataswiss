...
- **Keywords.de** `['luft', 'tabelle', 'windrichtung', 'temperatur', 'hr', 'echtzeit', 'hitze', 'umweltdaten', 'sachdaten', 't_', 'niederschlag', 'global-strahlung', 'regendauer', 'wd', 'wv', 'kalte', 'regen', 'p_', 'windgeschwindigkeit', 'lufttemperatur', 'wetter', 'meteo', 'feuchte', 'luftdruck', 'zeitreihe', 'messwerte', 'luftfeuchte', 'wind']`
- **Issued** `nan`
- **Metadata_created** `2024-11-28T02:48:27.678398`
- **Metadata_modified** `2025-09-06T04:20:25.774832`
