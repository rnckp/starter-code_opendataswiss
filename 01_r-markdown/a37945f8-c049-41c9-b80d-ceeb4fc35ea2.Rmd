...
- **Publisher** `Gesundheitsschutz, Umwelt- und Gesundheitsschutz, Gesundheits- und Umweltdepartement`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `Open Data Zürich`
- **Maintainer_email** `opendata@zuerich.ch`
- **Keywords.de** `['geoportal', 'geodaten', 'wc', 'bagno', 'toilette', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:05:56.652074`
- **Metadata_modified** `2023-08-18T01:58:18.356571`
...
# Description              : 
# Issued                   : 2022-05-09T03:05:52.631131
# Modified                 : None
