...
- **Publisher** `Statistik Stadt Zürich; Präsidialdepartement, Stadtentwicklung, Bevölkerungsbefragung`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `None`
- **Maintainer_email** `None`
- **Keywords.de** `['stadtentwicklung', 'bvb', 'zeitreihe', 'lebensqualitat', 'verkehr', 'umfrage', 'tabelle', 'befragung', 'wohnen', 'zufriedenheit', 'sachdaten', 'stichprobe']`
- **Issued** `2019-12-12T00:00:00`
- **Metadata_created** `2023-12-09T02:59:25.984664`
- **Metadata_modified** `2023-12-19T02:41:21.586711`
...
# Modified                 : 2023-12-18T20:52:21.612493
...
# Modified                 : 2023-12-18T20:52:16.094133
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceNotRequired
