...
[Direct link by **opendata.swiss** for dataset](https://opendata.swiss/de/dataset/energiedashboard-ch-monatliche-gas-nettoimporte-vsg1)<br>
[Direct link by **Bundesamt für Energie BFE** for dataset](https://www.energiedashboard.admin.ch/dashboard)

Auto generated R starter code for data set BFE-DS-0097@bundesamt-fur-energie-bfe.
...
- **Metadata_modified** `2026-01-06T01:57:39.298479`
