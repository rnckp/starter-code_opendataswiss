...
- **Publisher.name** `Öffentlichkeitsarbeit, PRD DS, Präsidialdepartement`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `Open Data Zürich`
- **Maintainer_email** `opendata@zuerich.ch`
- **Keywords.de** `['deutschkurs', 'geoportal', 'geodaten', 'vektordaten', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:38:45.257152`
- **Metadata_modified** `2025-05-09T02:20:20.565675`
