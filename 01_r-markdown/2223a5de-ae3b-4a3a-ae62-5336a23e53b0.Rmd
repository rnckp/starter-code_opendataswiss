...
Auto-generated R starter code for the dataset 5ab7db80-25b1-4ea9-b9b9-3505107ca023@bundesamt-fur-meteorologie-und-klimatologie-meteoschweiz.
...
- **Keywords.de** `['atmospharische-bedingungen', 'meteorologisch-geografische-kennwerte', 'meteorologischer-parameter', 'luft-atmosphare', 'wetter', 'klimatologie', 'schnee', 'meteorologie', 'niederschlag', 'bgdi-bundesgeodaten-infrastruktur', 'opendata']`
- **Issued** `2025-05-20T00:00:00`
- **Metadata_created** `2025-05-21T02:18:39.355104`
- **Metadata_modified** `2026-01-30T00:22:32.466132`
...
df <- read_delim('https://data.geo.admin.ch/browser/index.html#/collections/ch.meteoschweiz.ogd-nime')
