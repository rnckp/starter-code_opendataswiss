...
- **Keywords.de** `['investition', 'verlust', 'konto', 'erfolg', 'bilanz', 'haben', 'gewinn', 'soll', 'buchung']`
- **Issued** `2023-07-13T09:47:45+00:00`
- **Metadata_created** `2023-07-13T11:02:23.745670`
- **Metadata_modified** `2024-07-12T14:17:38.635677`
...
df <- read_delim('https://data.tg.ch/api/v2/catalog/datasets/dfs-fv-15/exports/csv')
