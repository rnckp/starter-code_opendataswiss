...
- **Keywords.de** `['energy-hackdays', 'erneuerbare-energien', 'solar', 'sonne', 'pv', 'strom', 'photovoltaik', 'sonnenenergie']`
- **Issued** `2021-07-28T00:00:00`
- **Metadata_created** `2023-12-21T12:48:24.708734`
- **Metadata_modified** `2024-08-09T05:01:48.527929`
...
df <- read_delim('https://daten.stadt.sg.ch/api/v2/catalog/datasets/stromproduktion-der-solaranlagen-der-stgaller-stadtwerke/exports/csv?use_labels=true')
