...
Auto-generated R starter code for the dataset cofog_int@eidgenossische-finanzverwaltung-efv.
...
- **Metadata_modified** `2026-01-06T01:57:32.284312`
...
df <- read_delim('https://www.data.finance.admin.ch/static/assets/datasets/gfs_dashboard/cofog_int_codelist.csv')
...
df <- read_delim('https://www.data.finance.admin.ch/static/assets/datasets/gfs_dashboard/cofog_int.csv')
