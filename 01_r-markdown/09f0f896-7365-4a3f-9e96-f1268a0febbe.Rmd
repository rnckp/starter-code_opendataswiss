...
- **Keywords.de** `['strassenbaum', 'vektordaten', 'baumersatz', 'baum', 'stadtbaum', 'fallung', 'stzh', 'baumersatzliste', 'stadtbaume', 'punktdaten', 'geodaten', 'geoportal', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-29T04:14:55.289586`
