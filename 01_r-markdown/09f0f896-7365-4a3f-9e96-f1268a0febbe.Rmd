...
- **Keywords.de** `['vektordaten', 'geodaten', 'stzh', 'strassenbaum', 'parkbaum', 'baumersatzliste', 'stadtbaume', 'baumersatz', 'baum', 'punktdaten', 'stadtbaum', 'geoportal', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-24T03:39:53.717912`
