...
- **Keywords.de** `['baumersatz', 'baumersatzliste', 'baum', 'stzh', 'geoportal', 'punktdaten', 'stadtbaum', 'geodaten', 'fallung', 'vektordaten', 'parkbaum', 'strassenbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-09T02:30:36.637614`
