...
- **Keywords.de** `['baumersatzliste', 'strassenbaum', 'baum', 'baumersatz', 'punktdaten', 'vektordaten', 'fallung', 'stzh', 'stadtbaume', 'geodaten', 'geoportal', 'stadtbaum', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-31T03:11:05.061817`
