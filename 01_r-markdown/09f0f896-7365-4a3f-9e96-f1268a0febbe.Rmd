...
- **Keywords.de** `['geodaten', 'stadtbaume', 'vektordaten', 'stadtbaum', 'punktdaten', 'stzh', 'parkbaum', 'baum', 'strassenbaum', 'geoportal', 'baumersatzliste', 'fallung', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-26T03:35:07.867734`
