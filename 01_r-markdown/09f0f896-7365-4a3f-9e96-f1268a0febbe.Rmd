...
- **Keywords.de** `['vektordaten', 'geodaten', 'fallung', 'geoportal', 'stadtbaume', 'baumersatzliste', 'stadtbaum', 'baum', 'punktdaten', 'baumersatz', 'parkbaum', 'strassenbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-02T03:05:11.483462`
