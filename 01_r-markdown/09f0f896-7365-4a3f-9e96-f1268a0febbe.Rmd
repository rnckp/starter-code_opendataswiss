...
- **Keywords.de** `['stadtbaume', 'geodaten', 'stzh', 'strassenbaum', 'baumersatzliste', 'geoportal', 'parkbaum', 'punktdaten', 'baum', 'vektordaten', 'fallung', 'baumersatz', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-03T04:57:43.866578`
