...
- **Keywords.de** `['baumersatz', 'fallung', 'baumersatzliste', 'stzh', 'geodaten', 'vektordaten', 'parkbaum', 'stadtbaume', 'baum', 'stadtbaum', 'punktdaten', 'strassenbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-14T02:59:11.330418`
