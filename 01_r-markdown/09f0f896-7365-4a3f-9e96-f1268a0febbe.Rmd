...
- **Keywords.de** `['geodaten', 'stzh', 'baumersatz', 'baumersatzliste', 'baum', 'fallung', 'strassenbaum', 'stadtbaum', 'punktdaten', 'vektordaten', 'geoportal', 'parkbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-03T08:11:05.988901`
