...
- **Keywords.de** `['fallung', 'stadtbaume', 'punktdaten', 'strassenbaum', 'baumersatzliste', 'parkbaum', 'geodaten', 'stzh', 'vektordaten', 'geoportal', 'baum', 'stadtbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-22T02:56:23.820714`
