...
- **Keywords.de** `['punktdaten', 'baum', 'stzh', 'stadtbaum', 'vektordaten', 'fallung', 'geoportal', 'baumersatzliste', 'strassenbaum', 'parkbaum', 'geodaten', 'baumersatz', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-06-14T03:30:54.320706`
