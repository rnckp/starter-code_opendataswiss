...
- **Keywords.de** `['geodaten', 'geoportal', 'punktdaten', 'stadtbaum', 'fallung', 'baum', 'vektordaten', 'strassenbaum', 'baumersatz', 'stzh', 'baumersatzliste', 'parkbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-14T03:00:57.518950`
