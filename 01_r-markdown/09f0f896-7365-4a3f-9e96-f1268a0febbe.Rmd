...
- **Keywords.de** `['stzh', 'geoportal', 'baum', 'strassenbaum', 'vektordaten', 'stadtbaum', 'geodaten', 'baumersatzliste', 'parkbaum', 'punktdaten', 'stadtbaume', 'baumersatz', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-30T03:04:54.449095`
