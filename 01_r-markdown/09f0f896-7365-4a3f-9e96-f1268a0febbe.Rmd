...
- **Keywords.de** `['vektordaten', 'stadtbaum', 'geoportal', 'fallung', 'parkbaum', 'baumersatz', 'baum', 'baumersatzliste', 'punktdaten', 'stadtbaume', 'strassenbaum', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-14T03:29:06.720847`
