...
- **Keywords.de** `['geoportal', 'punktdaten', 'stadtbaum', 'stzh', 'baumersatz', 'vektordaten', 'baum', 'fallung', 'baumersatzliste', 'stadtbaume', 'parkbaum', 'strassenbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-16T02:58:36.290110`
