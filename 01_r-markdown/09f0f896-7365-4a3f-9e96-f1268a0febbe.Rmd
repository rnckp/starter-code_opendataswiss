...
- **Keywords.de** `['stadtbaum', 'baum', 'fallung', 'strassenbaum', 'geodaten', 'parkbaum', 'stadtbaume', 'vektordaten', 'geoportal', 'baumersatz', 'baumersatzliste', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-02T04:25:02.862518`
