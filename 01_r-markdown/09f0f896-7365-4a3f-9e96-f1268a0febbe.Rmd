...
- **Keywords.de** `['baumersatz', 'baumersatzliste', 'fallung', 'parkbaum', 'stzh', 'vektordaten', 'stadtbaume', 'geodaten', 'geoportal', 'punktdaten', 'baum', 'strassenbaum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-12T05:23:22.367962`
