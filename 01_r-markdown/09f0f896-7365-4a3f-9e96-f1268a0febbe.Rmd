...
- **Keywords.de** `['parkbaum', 'stadtbaume', 'baum', 'vektordaten', 'stadtbaum', 'fallung', 'stzh', 'geodaten', 'punktdaten', 'geoportal', 'baumersatz', 'baumersatzliste', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-15T03:45:15.868386`
