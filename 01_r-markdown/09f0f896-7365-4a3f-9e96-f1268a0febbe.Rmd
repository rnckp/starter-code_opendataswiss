...
- **Keywords.de** `['strassenbaum', 'parkbaum', 'stadtbaum', 'fallung', 'baumersatz', 'geodaten', 'baumersatzliste', 'stzh', 'stadtbaume', 'geoportal', 'baum', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-19T03:30:05.088774`
