...
- **Keywords.de** `['baumersatzliste', 'stzh', 'geoportal', 'parkbaum', 'punktdaten', 'vektordaten', 'baum', 'stadtbaume', 'baumersatz', 'strassenbaum', 'stadtbaum', 'geodaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-25T03:14:10.447727`
