...
- **Keywords.de** `['stzh', 'baum', 'geodaten', 'strassenbaum', 'stadtbaume', 'parkbaum', 'geoportal', 'punktdaten', 'baumersatz', 'baumersatzliste', 'fallung', 'stadtbaum', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-30T03:12:02.427127`
