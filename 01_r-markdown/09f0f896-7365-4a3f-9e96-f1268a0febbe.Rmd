...
- **Keywords.de** `['stadtbaum', 'stadtbaume', 'punktdaten', 'fallung', 'strassenbaum', 'geodaten', 'baumersatz', 'vektordaten', 'baum', 'baumersatzliste', 'parkbaum', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-13T02:33:56.217028`
