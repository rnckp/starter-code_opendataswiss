...
- **Keywords.de** `['fallung', 'punktdaten', 'geoportal', 'baumersatzliste', 'parkbaum', 'vektordaten', 'stzh', 'baumersatz', 'stadtbaum', 'baum', 'strassenbaum', 'stadtbaume', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-10T03:33:03.455101`
