...
- **Keywords.de** `['fallung', 'vektordaten', 'geoportal', 'strassenbaum', 'parkbaum', 'stadtbaum', 'baumersatz', 'geodaten', 'stzh', 'baumersatzliste', 'baum', 'punktdaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-08T03:41:52.374884`
