...
- **Keywords.de** `['stadtbaume', 'baumersatz', 'fallung', 'stadtbaum', 'stzh', 'baum', 'vektordaten', 'punktdaten', 'baumersatzliste', 'parkbaum', 'geodaten', 'geoportal', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-18T03:18:16.873071`
