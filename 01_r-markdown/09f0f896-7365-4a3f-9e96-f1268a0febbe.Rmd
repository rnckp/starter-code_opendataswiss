...
- **Keywords.de** `['stadtbaum', 'baumersatzliste', 'fallung', 'punktdaten', 'geodaten', 'stadtbaume', 'strassenbaum', 'baum', 'baumersatz', 'parkbaum', 'stzh', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-07T04:15:40.728993`
