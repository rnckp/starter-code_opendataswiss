...
- **Keywords.de** `['stadtbaum', 'parkbaum', 'stadtbaume', 'geodaten', 'baum', 'baumersatz', 'geoportal', 'fallung', 'strassenbaum', 'stzh', 'punktdaten', 'vektordaten', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-03T03:00:15.347631`
