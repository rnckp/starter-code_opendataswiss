...
- **Keywords.de** `['geodaten', 'baumersatz', 'punktdaten', 'vektordaten', 'stadtbaum', 'baum', 'baumersatzliste', 'stadtbaume', 'fallung', 'strassenbaum', 'parkbaum', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-01T03:03:55.281507`
