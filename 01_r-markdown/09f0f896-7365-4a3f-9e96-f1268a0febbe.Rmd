...
- **Keywords.de** `['baumersatz', 'parkbaum', 'punktdaten', 'strassenbaum', 'stzh', 'geodaten', 'geoportal', 'stadtbaum', 'fallung', 'baumersatzliste', 'baum', 'stadtbaume', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-06T05:56:55.830997`
