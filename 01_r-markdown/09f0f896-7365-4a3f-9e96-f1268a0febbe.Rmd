...
- **Keywords.de** `['fallung', 'stadtbaume', 'geodaten', 'stadtbaum', 'strassenbaum', 'geoportal', 'punktdaten', 'parkbaum', 'baumersatzliste', 'stzh', 'baum', 'vektordaten', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-24T02:52:40.234266`
