...
- **Keywords.de** `['stzh', 'baumersatzliste', 'baum', 'baumersatz', 'parkbaum', 'stadtbaum', 'punktdaten', 'geoportal', 'stadtbaume', 'vektordaten', 'geodaten', 'strassenbaum', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-10T04:10:22.153579`
