...
- **Keywords.de** `['stzh', 'strassenbaum', 'geoportal', 'punktdaten', 'vektordaten', 'parkbaum', 'baum', 'geodaten', 'stadtbaum', 'stadtbaume', 'baumersatzliste', 'fallung', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-11T03:25:37.683575`
