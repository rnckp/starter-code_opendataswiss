...
- **Keywords.de** `['strassenbaum', 'geoportal', 'geodaten', 'parkbaum', 'fallung', 'baum', 'baumersatzliste', 'stzh', 'baumersatz', 'stadtbaume', 'punktdaten', 'stadtbaum', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-26T02:51:48.973072`
