...
- **Keywords.de** `['stadtbaume', 'strassenbaum', 'geodaten', 'baumersatz', 'geoportal', 'parkbaum', 'fallung', 'stzh', 'punktdaten', 'vektordaten', 'baumersatzliste', 'baum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-11T03:10:03.225559`
