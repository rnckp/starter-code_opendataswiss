...
- **Keywords.de** `['stadtbaum', 'geodaten', 'baum', 'geoportal', 'stadtbaume', 'fallung', 'vektordaten', 'baumersatz', 'stzh', 'punktdaten', 'parkbaum', 'strassenbaum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-03T03:27:43.360328`
