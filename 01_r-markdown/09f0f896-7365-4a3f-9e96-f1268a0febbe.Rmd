...
- **Keywords.de** `['fallung', 'vektordaten', 'geoportal', 'stzh', 'parkbaum', 'geodaten', 'strassenbaum', 'baumersatz', 'punktdaten', 'baum', 'baumersatzliste', 'stadtbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-11T04:48:51.534136`
