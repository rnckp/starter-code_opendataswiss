...
- **Keywords.de** `['parkbaum', 'geodaten', 'baumersatzliste', 'baum', 'stadtbaume', 'punktdaten', 'baumersatz', 'vektordaten', 'strassenbaum', 'fallung', 'stadtbaum', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-10T03:35:28.313804`
