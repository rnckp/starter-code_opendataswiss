...
- **Keywords.de** `['parkbaum', 'geodaten', 'baum', 'fallung', 'geoportal', 'vektordaten', 'punktdaten', 'stadtbaum', 'baumersatz', 'strassenbaum', 'stadtbaume', 'baumersatzliste', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-13T03:23:50.385897`
