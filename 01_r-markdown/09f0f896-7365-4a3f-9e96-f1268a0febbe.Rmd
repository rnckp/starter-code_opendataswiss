...
- **Keywords.de** `['strassenbaum', 'stzh', 'stadtbaume', 'fallung', 'baumersatz', 'geoportal', 'geodaten', 'baum', 'parkbaum', 'baumersatzliste', 'punktdaten', 'stadtbaum', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-17T02:52:02.932082`
