...
- **Keywords.de** `['stadtbaume', 'parkbaum', 'vektordaten', 'punktdaten', 'geoportal', 'geodaten', 'stadtbaum', 'strassenbaum', 'fallung', 'baumersatz', 'baum', 'stzh', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-14T02:32:41.247450`
