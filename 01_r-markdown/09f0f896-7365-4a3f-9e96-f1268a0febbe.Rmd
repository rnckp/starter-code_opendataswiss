...
- **Keywords.de** `['baumersatzliste', 'baumersatz', 'stzh', 'vektordaten', 'stadtbaum', 'geoportal', 'strassenbaum', 'stadtbaume', 'punktdaten', 'geodaten', 'parkbaum', 'baum', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-14T03:48:52.362464`
