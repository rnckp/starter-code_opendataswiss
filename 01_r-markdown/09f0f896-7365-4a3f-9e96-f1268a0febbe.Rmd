...
- **Keywords.de** `['strassenbaum', 'stadtbaum', 'baum', 'punktdaten', 'geoportal', 'stadtbaume', 'baumersatz', 'baumersatzliste', 'parkbaum', 'geodaten', 'fallung', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-26T02:46:42.473746`
