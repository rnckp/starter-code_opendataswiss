...
- **Keywords.de** `['fallung', 'geoportal', 'baumersatz', 'vektordaten', 'stadtbaum', 'strassenbaum', 'baum', 'parkbaum', 'stadtbaume', 'punktdaten', 'baumersatzliste', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-30T03:21:31.052064`
