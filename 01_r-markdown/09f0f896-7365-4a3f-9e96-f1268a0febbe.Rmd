...
- **Keywords.de** `['fallung', 'baumersatzliste', 'geodaten', 'punktdaten', 'baum', 'vektordaten', 'stzh', 'stadtbaume', 'strassenbaum', 'baumersatz', 'stadtbaum', 'geoportal', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-26T03:19:43.636119`
