...
- **Keywords.de** `['stadtbaume', 'geodaten', 'vektordaten', 'fallung', 'baumersatzliste', 'parkbaum', 'baum', 'geoportal', 'stadtbaum', 'stzh', 'baumersatz', 'punktdaten', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-19T03:12:10.818248`
