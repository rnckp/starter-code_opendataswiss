...
- **Keywords.de** `['baumersatzliste', 'baum', 'strassenbaum', 'geoportal', 'stadtbaume', 'baumersatz', 'fallung', 'parkbaum', 'stadtbaum', 'punktdaten', 'stzh', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-27T03:51:33.240336`
