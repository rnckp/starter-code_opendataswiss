...
- **Keywords.de** `['stzh', 'stadtbaume', 'baumersatz', 'baum', 'stadtbaum', 'punktdaten', 'geoportal', 'geodaten', 'fallung', 'parkbaum', 'vektordaten', 'strassenbaum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-09T04:21:36.518102`
