...
- **Keywords.de** `['stzh', 'punktdaten', 'baum', 'geodaten', 'stadtbaum', 'baumersatz', 'geoportal', 'vektordaten', 'stadtbaume', 'baumersatzliste', 'fallung', 'parkbaum', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-25T03:07:51.306884`
