...
- **Keywords.de** `['geoportal', 'stzh', 'punktdaten', 'stadtbaume', 'baumersatz', 'vektordaten', 'stadtbaum', 'parkbaum', 'fallung', 'strassenbaum', 'baum', 'baumersatzliste', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-13T03:40:41.335064`
