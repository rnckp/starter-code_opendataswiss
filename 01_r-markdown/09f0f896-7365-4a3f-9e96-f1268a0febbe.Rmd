...
- **Keywords.de** `['stzh', 'punktdaten', 'baumersatz', 'stadtbaum', 'strassenbaum', 'vektordaten', 'geodaten', 'parkbaum', 'stadtbaume', 'fallung', 'baum', 'geoportal', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-25T02:49:34.787665`
