...
- **Keywords.de** `['punktdaten', 'baum', 'baumersatz', 'parkbaum', 'geodaten', 'strassenbaum', 'baumersatzliste', 'stadtbaume', 'stadtbaum', 'vektordaten', 'fallung', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-08T03:10:09.314805`
