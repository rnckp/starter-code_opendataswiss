...
- **Keywords.de** `['baum', 'vektordaten', 'stzh', 'stadtbaum', 'stadtbaume', 'baumersatz', 'strassenbaum', 'baumersatzliste', 'punktdaten', 'parkbaum', 'fallung', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-12T03:12:23.707958`
