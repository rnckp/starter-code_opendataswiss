...
- **Keywords.de** `['geodaten', 'stzh', 'baumersatzliste', 'strassenbaum', 'baumersatz', 'geoportal', 'stadtbaum', 'stadtbaume', 'vektordaten', 'punktdaten', 'fallung', 'baum', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-20T02:30:58.802976`
