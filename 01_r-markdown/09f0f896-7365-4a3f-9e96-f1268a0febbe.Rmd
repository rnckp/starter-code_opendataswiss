...
- **Keywords.de** `['stzh', 'parkbaum', 'geoportal', 'stadtbaume', 'baumersatzliste', 'baum', 'baumersatz', 'vektordaten', 'fallung', 'punktdaten', 'stadtbaum', 'strassenbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-01T08:50:12.554270`
