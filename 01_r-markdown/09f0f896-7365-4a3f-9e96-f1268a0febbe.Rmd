...
- **Keywords.de** `['stadtbaume', 'strassenbaum', 'stadtbaum', 'baumersatzliste', 'baum', 'geodaten', 'fallung', 'parkbaum', 'baumersatz', 'geoportal', 'vektordaten', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-06-26T03:17:30.602542`
