...
- **Keywords.de** `['stadtbaume', 'stadtbaum', 'punktdaten', 'strassenbaum', 'baumersatz', 'baum', 'geoportal', 'baumersatzliste', 'vektordaten', 'stzh', 'fallung', 'parkbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-10T03:07:25.522131`
