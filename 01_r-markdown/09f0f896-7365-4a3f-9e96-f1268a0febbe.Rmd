...
- **Keywords.de** `['strassenbaum', 'baumersatzliste', 'punktdaten', 'stzh', 'geoportal', 'baumersatz', 'stadtbaum', 'vektordaten', 'parkbaum', 'baum', 'geodaten', 'fallung', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-17T03:11:45.314608`
