...
- **Keywords.de** `['stzh', 'baumersatzliste', 'vektordaten', 'punktdaten', 'strassenbaum', 'geodaten', 'geoportal', 'fallung', 'baum', 'baumersatz', 'parkbaum', 'stadtbaume', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-04T03:56:03.755627`
