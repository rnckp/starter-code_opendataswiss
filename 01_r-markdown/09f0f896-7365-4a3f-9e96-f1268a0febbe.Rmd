...
- **Keywords.de** `['baum', 'fallung', 'geodaten', 'baumersatz', 'vektordaten', 'parkbaum', 'stadtbaum', 'baumersatzliste', 'stadtbaume', 'stzh', 'punktdaten', 'geoportal', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-26T03:41:46.652302`
