...
- **Keywords.de** `['stzh', 'vektordaten', 'baumersatz', 'stadtbaume', 'baumersatzliste', 'fallung', 'geoportal', 'parkbaum', 'stadtbaum', 'geodaten', 'baum', 'strassenbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-27T03:05:52.223900`
