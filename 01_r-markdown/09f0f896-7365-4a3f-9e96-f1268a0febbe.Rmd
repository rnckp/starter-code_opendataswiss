...
- **Keywords.de** `['stzh', 'baumersatzliste', 'punktdaten', 'fallung', 'baum', 'stadtbaum', 'parkbaum', 'stadtbaume', 'geodaten', 'baumersatz', 'geoportal', 'vektordaten', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-12T03:10:19.822282`
