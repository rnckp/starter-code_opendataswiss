...
- **Keywords.de** `['baumersatz', 'geoportal', 'stadtbaum', 'fallung', 'geodaten', 'stzh', 'vektordaten', 'baumersatzliste', 'punktdaten', 'stadtbaume', 'strassenbaum', 'parkbaum', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-26T03:47:37.771443`
