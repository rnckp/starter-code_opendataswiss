...
- **Keywords.de** `['punktdaten', 'geodaten', 'baumersatzliste', 'fallung', 'stadtbaume', 'vektordaten', 'baum', 'baumersatz', 'geoportal', 'strassenbaum', 'stzh', 'parkbaum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-28T02:47:23.347285`
