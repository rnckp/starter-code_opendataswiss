...
- **Keywords.de** `['fallung', 'stzh', 'baumersatz', 'baumersatzliste', 'vektordaten', 'strassenbaum', 'baum', 'geoportal', 'parkbaum', 'geodaten', 'stadtbaume', 'stadtbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-27T03:01:36.274136`
