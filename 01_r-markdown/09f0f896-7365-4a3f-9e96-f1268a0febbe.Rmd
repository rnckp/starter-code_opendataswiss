...
- **Keywords.de** `['punktdaten', 'geoportal', 'baum', 'parkbaum', 'geodaten', 'stzh', 'stadtbaume', 'stadtbaum', 'fallung', 'baumersatz', 'vektordaten', 'strassenbaum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-21T02:31:28.529100`
