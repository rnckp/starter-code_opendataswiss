...
- **Keywords.de** `['stadtbaume', 'baumersatzliste', 'vektordaten', 'stzh', 'baum', 'geoportal', 'fallung', 'punktdaten', 'parkbaum', 'geodaten', 'strassenbaum', 'stadtbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-22T03:17:11.830460`
