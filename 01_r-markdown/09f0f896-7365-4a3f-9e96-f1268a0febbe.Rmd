...
- **Keywords.de** `['geodaten', 'stadtbaum', 'baumersatz', 'fallung', 'baumersatzliste', 'stadtbaume', 'baum', 'punktdaten', 'stzh', 'parkbaum', 'geoportal', 'vektordaten', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-11T03:27:19.749584`
