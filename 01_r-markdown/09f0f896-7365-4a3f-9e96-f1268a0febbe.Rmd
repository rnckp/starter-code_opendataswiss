...
- **Keywords.de** `['stadtbaum', 'vektordaten', 'parkbaum', 'punktdaten', 'fallung', 'stadtbaume', 'baumersatz', 'stzh', 'geodaten', 'baum', 'geoportal', 'baumersatzliste', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-16T03:26:49.421189`
