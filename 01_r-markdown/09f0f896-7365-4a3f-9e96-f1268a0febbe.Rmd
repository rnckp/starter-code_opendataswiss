...
- **Keywords.de** `['punktdaten', 'geoportal', 'stadtbaum', 'stzh', 'vektordaten', 'geodaten', 'parkbaum', 'stadtbaume', 'fallung', 'baumersatz', 'baum', 'strassenbaum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-05T02:45:04.632360`
