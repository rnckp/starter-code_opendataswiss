...
- **Keywords.de** `['stadtbaume', 'vektordaten', 'geoportal', 'punktdaten', 'stzh', 'fallung', 'parkbaum', 'strassenbaum', 'baumersatzliste', 'baumersatz', 'geodaten', 'stadtbaum', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-09T03:29:43.913423`
