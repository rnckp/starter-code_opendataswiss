...
- **Keywords.de** `['baum', 'geoportal', 'geodaten', 'vektordaten', 'baumersatzliste', 'fallung', 'punktdaten', 'stadtbaum', 'parkbaum', 'stadtbaume', 'stzh', 'strassenbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-28T03:07:33.094141`
