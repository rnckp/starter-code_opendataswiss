...
- **Keywords.de** `['stzh', 'baumersatz', 'stadtbaum', 'baum', 'vektordaten', 'strassenbaum', 'parkbaum', 'geoportal', 'stadtbaume', 'geodaten', 'fallung', 'baumersatzliste', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-01T02:48:08.087118`
