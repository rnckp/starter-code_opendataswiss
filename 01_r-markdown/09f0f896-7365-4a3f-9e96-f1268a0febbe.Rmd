...
- **Keywords.de** `['geoportal', 'fallung', 'stadtbaume', 'baumersatzliste', 'parkbaum', 'geodaten', 'stzh', 'baumersatz', 'strassenbaum', 'stadtbaum', 'baum', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-24T03:27:58.260592`
