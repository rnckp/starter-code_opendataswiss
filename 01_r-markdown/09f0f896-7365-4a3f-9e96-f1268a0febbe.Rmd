...
- **Keywords.de** `['geodaten', 'fallung', 'stzh', 'baumersatzliste', 'parkbaum', 'stadtbaum', 'punktdaten', 'strassenbaum', 'baum', 'vektordaten', 'geoportal', 'stadtbaume', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-21T03:32:41.948333`
