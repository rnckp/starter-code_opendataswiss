...
- **Keywords.de** `['baumersatzliste', 'fallung', 'baum', 'stadtbaum', 'strassenbaum', 'geoportal', 'parkbaum', 'baumersatz', 'vektordaten', 'stzh', 'geodaten', 'stadtbaume', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-19T03:18:15.526733`
