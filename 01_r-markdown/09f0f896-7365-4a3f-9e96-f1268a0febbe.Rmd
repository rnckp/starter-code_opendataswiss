...
- **Keywords.de** `['stadtbaume', 'baum', 'geoportal', 'stzh', 'strassenbaum', 'fallung', 'parkbaum', 'punktdaten', 'vektordaten', 'baumersatzliste', 'stadtbaum', 'baumersatz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-02T02:55:31.965275`
