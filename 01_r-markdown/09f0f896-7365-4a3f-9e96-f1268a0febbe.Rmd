...
- **Keywords.de** `['punktdaten', 'strassenbaum', 'fallung', 'vektordaten', 'baumersatz', 'geoportal', 'stadtbaum', 'stadtbaume', 'baumersatzliste', 'parkbaum', 'geodaten', 'baum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-18T02:53:45.726920`
