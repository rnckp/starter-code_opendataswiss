...
- **Keywords.de** `['baumersatz', 'punktdaten', 'stadtbaum', 'stzh', 'baumersatzliste', 'fallung', 'vektordaten', 'parkbaum', 'strassenbaum', 'geodaten', 'baum', 'geoportal', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-10T03:30:19.325959`
