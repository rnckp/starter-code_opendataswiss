...
- **Keywords.de** `['vektordaten', 'geodaten', 'parkbaum', 'baumersatz', 'baum', 'stadtbaume', 'stadtbaum', 'strassenbaum', 'baumersatzliste', 'stzh', 'geoportal', 'fallung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-19T03:15:38.278833`
