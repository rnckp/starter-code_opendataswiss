...
- **Keywords.de** `['baum', 'baumersatzliste', 'strassenbaum', 'geodaten', 'stadtbaume', 'punktdaten', 'stadtbaum', 'vektordaten', 'parkbaum', 'baumersatz', 'geoportal', 'stzh', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-12T03:15:21.567133`
