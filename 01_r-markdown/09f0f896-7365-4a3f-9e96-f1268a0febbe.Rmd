...
- **Keywords.de** `['baum', 'fallung', 'strassenbaum', 'baumersatz', 'stadtbaum', 'parkbaum', 'geodaten', 'stzh', 'punktdaten', 'baumersatzliste', 'vektordaten', 'geoportal', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-03-16T03:40:05.465014`
