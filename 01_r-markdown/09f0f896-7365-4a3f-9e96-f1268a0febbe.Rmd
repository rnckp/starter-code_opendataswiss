...
- **Keywords.de** `['punktdaten', 'baumersatz', 'fallung', 'geoportal', 'baumersatzliste', 'geodaten', 'vektordaten', 'stadtbaum', 'stzh', 'parkbaum', 'strassenbaum', 'baum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-19T04:24:33.031490`
