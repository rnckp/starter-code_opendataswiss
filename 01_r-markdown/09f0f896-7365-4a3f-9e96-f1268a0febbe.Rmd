...
- **Keywords.de** `['vektordaten', 'geodaten', 'baumersatz', 'baum', 'punktdaten', 'parkbaum', 'baumersatzliste', 'stadtbaum', 'fallung', 'geoportal', 'strassenbaum', 'stzh', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-04T04:25:13.201776`
