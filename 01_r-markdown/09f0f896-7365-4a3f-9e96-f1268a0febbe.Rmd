...
- **Keywords.de** `['strassenbaum', 'baumersatz', 'geodaten', 'parkbaum', 'stzh', 'geoportal', 'baumersatzliste', 'punktdaten', 'fallung', 'baum', 'stadtbaume', 'stadtbaum', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-06-21T03:44:55.803799`
