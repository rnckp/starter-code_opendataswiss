...
- **Keywords.de** `['strassenbaum', 'vektordaten', 'baum', 'geoportal', 'stzh', 'baumersatz', 'geodaten', 'stadtbaum', 'parkbaum', 'baumersatzliste', 'punktdaten', 'stadtbaume', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-31T03:29:55.321144`
