...
- **Keywords.de** `['strassenbaum', 'geodaten', 'fallung', 'baum', 'punktdaten', 'stzh', 'geoportal', 'vektordaten', 'stadtbaum', 'baumersatz', 'baumersatzliste', 'stadtbaume', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-09T06:01:20.039807`
