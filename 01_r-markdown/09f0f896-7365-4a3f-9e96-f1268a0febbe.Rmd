...
- **Keywords.de** `['stadtbaume', 'vektordaten', 'baum', 'stadtbaum', 'fallung', 'geoportal', 'parkbaum', 'geodaten', 'stzh', 'strassenbaum', 'baumersatzliste', 'baumersatz', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-15T03:46:17.687557`
