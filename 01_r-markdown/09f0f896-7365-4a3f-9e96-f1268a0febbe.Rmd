...
- **Keywords.de** `['strassenbaum', 'stadtbaum', 'geoportal', 'baumersatzliste', 'parkbaum', 'stzh', 'stadtbaume', 'baumersatz', 'geodaten', 'punktdaten', 'fallung', 'vektordaten', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-11T05:31:17.433835`
