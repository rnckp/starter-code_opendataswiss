...
- **Keywords.de** `['baum', 'stzh', 'strassenbaum', 'punktdaten', 'baumersatz', 'vektordaten', 'stadtbaume', 'stadtbaum', 'fallung', 'baumersatzliste', 'geodaten', 'parkbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-03T04:05:44.316782`
