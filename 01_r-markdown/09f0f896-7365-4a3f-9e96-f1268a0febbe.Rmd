...
- **Keywords.de** `['strassenbaum', 'stadtbaume', 'stzh', 'vektordaten', 'baumersatz', 'parkbaum', 'geoportal', 'baum', 'stadtbaum', 'geodaten', 'punktdaten', 'baumersatzliste', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-15T03:21:58.854118`
