...
- **Keywords.de** `['vektordaten', 'fallung', 'baumersatzliste', 'stadtbaume', 'geoportal', 'parkbaum', 'punktdaten', 'geodaten', 'baum', 'strassenbaum', 'stzh', 'baumersatz', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-06T04:40:53.023634`
