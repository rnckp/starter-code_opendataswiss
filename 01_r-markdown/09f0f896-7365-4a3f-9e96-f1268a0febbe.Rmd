...
- **Keywords.de** `['punktdaten', 'stzh', 'stadtbaume', 'geoportal', 'strassenbaum', 'fallung', 'baumersatz', 'baum', 'stadtbaum', 'baumersatzliste', 'parkbaum', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-03-04T03:56:39.230186`
