...
- **Keywords.de** `['baumersatz', 'stadtbaume', 'stzh', 'vektordaten', 'geoportal', 'strassenbaum', 'baumersatzliste', 'parkbaum', 'geodaten', 'punktdaten', 'baum', 'stadtbaum', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-23T03:29:51.250953`
