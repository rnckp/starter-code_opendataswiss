...
- **Keywords.de** `['stadtbaume', 'geodaten', 'stzh', 'vektordaten', 'baum', 'baumersatzliste', 'punktdaten', 'baumersatz', 'strassenbaum', 'fallung', 'geoportal', 'parkbaum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-03T03:11:30.294392`
