...
- **Keywords.de** `['baum', 'punktdaten', 'geoportal', 'baumersatzliste', 'fallung', 'vektordaten', 'stadtbaume', 'parkbaum', 'stzh', 'geodaten', 'stadtbaum', 'baumersatz', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-10T02:52:32.728091`
