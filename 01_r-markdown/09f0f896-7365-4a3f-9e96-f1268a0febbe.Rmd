...
- **Keywords.de** `['strassenbaum', 'stadtbaume', 'parkbaum', 'geoportal', 'fallung', 'vektordaten', 'geodaten', 'baumersatz', 'stadtbaum', 'punktdaten', 'stzh', 'baum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-11T03:26:24.161024`
