...
- **Keywords.de** `['fallung', 'stadtbaume', 'baumersatzliste', 'punktdaten', 'vektordaten', 'strassenbaum', 'geodaten', 'baum', 'geoportal', 'baumersatz', 'stadtbaum', 'stzh', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-12T03:11:36.303884`
