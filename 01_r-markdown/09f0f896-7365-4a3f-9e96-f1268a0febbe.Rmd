...
- **Keywords.de** `['vektordaten', 'stadtbaum', 'geoportal', 'baumersatzliste', 'baumersatz', 'fallung', 'strassenbaum', 'parkbaum', 'baum', 'stzh', 'stadtbaume', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-28T03:14:42.923120`
