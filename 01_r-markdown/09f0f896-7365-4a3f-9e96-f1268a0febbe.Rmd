...
- **Keywords.de** `['stadtbaum', 'fallung', 'baumersatzliste', 'strassenbaum', 'geodaten', 'baum', 'stadtbaume', 'punktdaten', 'parkbaum', 'baumersatz', 'geoportal', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-22T03:22:39.449756`
