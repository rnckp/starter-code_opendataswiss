...
- **Keywords.de** `['stadtbaume', 'stadtbaum', 'vektordaten', 'punktdaten', 'strassenbaum', 'baum', 'geoportal', 'geodaten', 'stzh', 'baumersatzliste', 'baumersatz', 'fallung', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-02T02:50:22.740603`
