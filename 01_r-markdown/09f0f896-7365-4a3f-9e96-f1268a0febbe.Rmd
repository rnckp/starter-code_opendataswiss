...
- **Keywords.de** `['vektordaten', 'stadtbaume', 'geoportal', 'baum', 'geodaten', 'parkbaum', 'stadtbaum', 'baumersatzliste', 'fallung', 'punktdaten', 'baumersatz', 'strassenbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-13T02:29:33.225651`
