...
- **Keywords.de** `['punktdaten', 'vektordaten', 'geoportal', 'baumersatzliste', 'strassenbaum', 'geodaten', 'parkbaum', 'stadtbaume', 'stzh', 'baumersatz', 'stadtbaum', 'baum', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-08T03:09:29.199242`
