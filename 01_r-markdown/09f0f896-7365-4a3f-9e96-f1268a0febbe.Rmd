...
- **Keywords.de** `['stadtbaum', 'baum', 'parkbaum', 'stadtbaume', 'baumersatzliste', 'geodaten', 'punktdaten', 'fallung', 'vektordaten', 'strassenbaum', 'geoportal', 'stzh', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-19T03:34:24.834947`
