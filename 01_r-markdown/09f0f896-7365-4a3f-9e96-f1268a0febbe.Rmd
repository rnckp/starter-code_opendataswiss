...
- **Keywords.de** `['stadtbaum', 'geodaten', 'stadtbaume', 'stzh', 'strassenbaum', 'fallung', 'vektordaten', 'baum', 'punktdaten', 'parkbaum', 'baumersatz', 'baumersatzliste', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-08T05:33:30.724353`
