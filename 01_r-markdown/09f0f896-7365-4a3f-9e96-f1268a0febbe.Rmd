...
- **Keywords.de** `['strassenbaum', 'baum', 'parkbaum', 'fallung', 'stzh', 'stadtbaum', 'geoportal', 'punktdaten', 'vektordaten', 'geodaten', 'baumersatzliste', 'stadtbaume', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-01T04:11:16.169656`
