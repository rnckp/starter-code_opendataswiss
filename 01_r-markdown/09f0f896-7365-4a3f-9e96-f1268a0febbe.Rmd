...
- **Keywords.de** `['baumersatz', 'stadtbaum', 'vektordaten', 'baum', 'parkbaum', 'fallung', 'punktdaten', 'stadtbaume', 'geoportal', 'baumersatzliste', 'stzh', 'strassenbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-29T02:29:09.690133`
