...
- **Keywords.de** `['punktdaten', 'strassenbaum', 'stzh', 'baumersatz', 'vektordaten', 'geodaten', 'baum', 'baumersatzliste', 'stadtbaum', 'parkbaum', 'geoportal', 'fallung', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-05T02:39:09.973406`
