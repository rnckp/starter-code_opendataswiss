...
- **Keywords.de** `['geodaten', 'vektordaten', 'parkbaum', 'baumersatzliste', 'stadtbaum', 'geoportal', 'strassenbaum', 'baumersatz', 'stzh', 'baum', 'fallung', 'stadtbaume', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-05T03:26:53.719833`
