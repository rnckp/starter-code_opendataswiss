...
- **Keywords.de** `['stadtbaume', 'strassenbaum', 'vektordaten', 'fallung', 'geodaten', 'parkbaum', 'baumersatzliste', 'stadtbaum', 'baumersatz', 'geoportal', 'punktdaten', 'baum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-19T04:03:54.739484`
