...
- **Keywords.de** `['parkbaum', 'geoportal', 'stzh', 'geodaten', 'baum', 'punktdaten', 'baumersatz', 'vektordaten', 'stadtbaum', 'fallung', 'baumersatzliste', 'strassenbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-19T04:16:22.838915`
