...
- **Keywords.de** `['parkbaum', 'vektordaten', 'fallung', 'baumersatz', 'strassenbaum', 'baum', 'geoportal', 'stadtbaum', 'stadtbaume', 'baumersatzliste', 'geodaten', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-29T02:48:41.731243`
