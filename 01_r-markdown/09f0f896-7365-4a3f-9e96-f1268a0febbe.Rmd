...
- **Keywords.de** `['geoportal', 'fallung', 'vektordaten', 'stadtbaume', 'stzh', 'baumersatzliste', 'baum', 'parkbaum', 'punktdaten', 'baumersatz', 'stadtbaum', 'geodaten', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-15T03:33:17.048036`
