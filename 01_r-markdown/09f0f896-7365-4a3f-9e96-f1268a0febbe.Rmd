...
- **Keywords.de** `['parkbaum', 'fallung', 'geoportal', 'baum', 'baumersatzliste', 'baumersatz', 'vektordaten', 'stadtbaum', 'stzh', 'strassenbaum', 'geodaten', 'stadtbaume', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-02T03:16:11.267611`
