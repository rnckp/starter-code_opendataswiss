...
- **Keywords.de** `['strassenbaum', 'fallung', 'geodaten', 'punktdaten', 'baumersatz', 'stadtbaume', 'baumersatzliste', 'stzh', 'vektordaten', 'baum', 'stadtbaum', 'geoportal', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-01T03:30:56.721481`
