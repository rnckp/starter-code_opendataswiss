...
- **Keywords.de** `['stadtbaum', 'fallung', 'punktdaten', 'geoportal', 'baumersatz', 'baum', 'vektordaten', 'stadtbaume', 'parkbaum', 'strassenbaum', 'stzh', 'baumersatzliste', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-13T04:04:38.651969`
