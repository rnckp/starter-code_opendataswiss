...
- **Keywords.de** `['geoportal', 'stadtbaum', 'baumersatz', 'stzh', 'baum', 'punktdaten', 'vektordaten', 'baumersatzliste', 'geodaten', 'parkbaum', 'stadtbaume', 'strassenbaum', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-27T03:20:06.436544`
