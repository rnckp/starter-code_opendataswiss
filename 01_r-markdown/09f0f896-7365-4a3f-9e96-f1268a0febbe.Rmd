...
- **Keywords.de** `['fallung', 'baum', 'vektordaten', 'stadtbaum', 'parkbaum', 'punktdaten', 'baumersatz', 'strassenbaum', 'geoportal', 'geodaten', 'baumersatzliste', 'stadtbaume', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-01T02:46:55.568291`
