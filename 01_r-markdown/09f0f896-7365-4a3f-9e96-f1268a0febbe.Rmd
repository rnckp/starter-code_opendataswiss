...
- **Keywords.de** `['baumersatzliste', 'strassenbaum', 'stadtbaume', 'geoportal', 'vektordaten', 'baumersatz', 'punktdaten', 'stzh', 'baum', 'stadtbaum', 'fallung', 'parkbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-21T03:39:44.202530`
