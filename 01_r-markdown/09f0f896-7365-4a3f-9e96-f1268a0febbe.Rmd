...
- **Keywords.de** `['fallung', 'stzh', 'baumersatz', 'parkbaum', 'geodaten', 'baumersatzliste', 'baum', 'stadtbaum', 'vektordaten', 'punktdaten', 'stadtbaume', 'strassenbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-09T04:12:29.935149`
