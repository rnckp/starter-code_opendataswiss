...
- **Keywords.de** `['strassenbaum', 'baumersatz', 'punktdaten', 'stzh', 'stadtbaum', 'vektordaten', 'parkbaum', 'geoportal', 'geodaten', 'baumersatzliste', 'fallung', 'stadtbaume', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-06T01:36:41.749564`
