...
- **Keywords.de** `['fallung', 'baumersatz', 'parkbaum', 'strassenbaum', 'geodaten', 'vektordaten', 'punktdaten', 'stadtbaume', 'stzh', 'baumersatzliste', 'geoportal', 'stadtbaum', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-27T03:11:04.667391`
