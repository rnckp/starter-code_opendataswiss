...
- **Keywords.de** `['stadtbaum', 'geoportal', 'fallung', 'geodaten', 'stzh', 'stadtbaume', 'strassenbaum', 'punktdaten', 'baumersatz', 'baumersatzliste', 'baum', 'parkbaum', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-05T04:17:27.559761`
