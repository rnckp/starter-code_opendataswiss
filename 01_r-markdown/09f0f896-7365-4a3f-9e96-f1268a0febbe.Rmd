...
- **Keywords.de** `['geodaten', 'geoportal', 'strassenbaum', 'fallung', 'vektordaten', 'stzh', 'parkbaum', 'baumersatz', 'baumersatzliste', 'baum', 'stadtbaume', 'stadtbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-03T03:07:10.208277`
