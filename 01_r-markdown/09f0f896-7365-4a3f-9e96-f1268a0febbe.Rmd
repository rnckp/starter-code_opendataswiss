...
- **Keywords.de** `['stzh', 'stadtbaum', 'geoportal', 'baumersatz', 'parkbaum', 'baumersatzliste', 'punktdaten', 'vektordaten', 'strassenbaum', 'stadtbaume', 'baum', 'geodaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-11-20T02:59:03.277990`
