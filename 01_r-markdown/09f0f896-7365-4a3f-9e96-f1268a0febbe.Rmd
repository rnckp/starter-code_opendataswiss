...
- **Keywords.de** `['geodaten', 'parkbaum', 'punktdaten', 'stzh', 'strassenbaum', 'stadtbaume', 'stadtbaum', 'vektordaten', 'baumersatz', 'geoportal', 'fallung', 'baumersatzliste', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-09T03:22:13.154482`
