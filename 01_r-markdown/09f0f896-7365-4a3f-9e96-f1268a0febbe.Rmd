...
- **Keywords.de** `['strassenbaum', 'parkbaum', 'stzh', 'geodaten', 'baumersatzliste', 'punktdaten', 'baum', 'vektordaten', 'geoportal', 'baumersatz', 'stadtbaume', 'stadtbaum', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-22T03:40:51.795206`
