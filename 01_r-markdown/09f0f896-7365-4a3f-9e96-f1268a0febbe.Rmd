...
- **Keywords.de** `['geodaten', 'baum', 'baumersatz', 'stzh', 'punktdaten', 'stadtbaume', 'stadtbaum', 'fallung', 'vektordaten', 'strassenbaum', 'geoportal', 'parkbaum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-04T07:05:50.831649`
