...
- **Keywords.de** `['baumersatzliste', 'baumersatz', 'vektordaten', 'strassenbaum', 'stzh', 'fallung', 'stadtbaum', 'baum', 'punktdaten', 'parkbaum', 'geoportal', 'geodaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-12T03:40:49.292190`
