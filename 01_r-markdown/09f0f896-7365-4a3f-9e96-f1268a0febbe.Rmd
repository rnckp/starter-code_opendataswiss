...
- **Keywords.de** `['strassenbaum', 'geodaten', 'stadtbaume', 'stzh', 'punktdaten', 'baumersatzliste', 'fallung', 'vektordaten', 'stadtbaum', 'baum', 'baumersatz', 'geoportal', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-04T02:57:34.394319`
