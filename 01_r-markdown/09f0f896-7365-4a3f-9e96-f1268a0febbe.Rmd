...
- **Keywords.de** `['strassenbaum', 'geoportal', 'stzh', 'punktdaten', 'baumersatz', 'baumersatzliste', 'stadtbaume', 'parkbaum', 'vektordaten', 'fallung', 'baum', 'stadtbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-27T04:00:26.141338`
