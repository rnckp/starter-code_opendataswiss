...
- **Keywords.de** `['geodaten', 'baumersatz', 'strassenbaum', 'punktdaten', 'fallung', 'baumersatzliste', 'geoportal', 'parkbaum', 'baum', 'vektordaten', 'stadtbaum', 'stzh', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-11T03:38:22.404531`
