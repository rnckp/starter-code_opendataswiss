...
- **Keywords.de** `['stadtbaume', 'vektordaten', 'geodaten', 'parkbaum', 'baumersatzliste', 'stadtbaum', 'fallung', 'geoportal', 'stzh', 'baumersatz', 'punktdaten', 'strassenbaum', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-13T03:40:07.182695`
