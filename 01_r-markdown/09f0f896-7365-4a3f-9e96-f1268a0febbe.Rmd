...
- **Keywords.de** `['baumersatz', 'stadtbaum', 'strassenbaum', 'fallung', 'vektordaten', 'parkbaum', 'geoportal', 'punktdaten', 'stzh', 'stadtbaume', 'geodaten', 'baumersatzliste', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-14T02:55:23.820836`
