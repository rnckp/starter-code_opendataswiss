...
- **Keywords.de** `['vektordaten', 'stadtbaum', 'parkbaum', 'baumersatz', 'baumersatzliste', 'baum', 'geodaten', 'stadtbaume', 'strassenbaum', 'stzh', 'geoportal', 'fallung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-26T04:53:58.319580`
