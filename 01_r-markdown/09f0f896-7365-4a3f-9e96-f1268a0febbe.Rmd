...
- **Keywords.de** `['strassenbaum', 'stzh', 'stadtbaume', 'fallung', 'punktdaten', 'baum', 'baumersatzliste', 'geodaten', 'vektordaten', 'parkbaum', 'geoportal', 'baumersatz', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-15T02:51:08.909239`
