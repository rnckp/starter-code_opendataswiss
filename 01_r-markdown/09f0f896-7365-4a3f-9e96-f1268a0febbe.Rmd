...
- **Keywords.de** `['geodaten', 'stadtbaum', 'stzh', 'baum', 'baumersatz', 'punktdaten', 'parkbaum', 'fallung', 'vektordaten', 'stadtbaume', 'geoportal', 'strassenbaum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-16T03:04:19.189080`
