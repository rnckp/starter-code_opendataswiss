...
- **Keywords.de** `['vektordaten', 'stzh', 'stadtbaume', 'geoportal', 'geodaten', 'punktdaten', 'stadtbaum', 'baum', 'fallung', 'strassenbaum', 'baumersatzliste', 'parkbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-05T03:26:34.846098`
