...
- **Keywords.de** `['stadtbaume', 'geodaten', 'vektordaten', 'baumersatz', 'punktdaten', 'fallung', 'baum', 'baumersatzliste', 'geoportal', 'strassenbaum', 'stadtbaum', 'stzh', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-25T03:09:44.719686`
