...
- **Keywords.de** `['punktdaten', 'stadtbaum', 'parkbaum', 'baum', 'geodaten', 'baumersatz', 'vektordaten', 'stadtbaume', 'stzh', 'baumersatzliste', 'geoportal', 'strassenbaum', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-25T03:13:37.153574`
