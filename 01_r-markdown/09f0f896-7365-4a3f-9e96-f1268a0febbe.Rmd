...
- **Keywords.de** `['baum', 'geoportal', 'stadtbaume', 'parkbaum', 'fallung', 'strassenbaum', 'baumersatzliste', 'geodaten', 'stzh', 'punktdaten', 'vektordaten', 'stadtbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-01T03:39:55.859763`
