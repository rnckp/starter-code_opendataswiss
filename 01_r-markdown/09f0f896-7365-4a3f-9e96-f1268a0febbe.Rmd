...
- **Keywords.de** `['geodaten', 'geoportal', 'vektordaten', 'parkbaum', 'fallung', 'stadtbaume', 'stadtbaum', 'baumersatz', 'baumersatzliste', 'punktdaten', 'baum', 'strassenbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-08T02:57:54.621718`
