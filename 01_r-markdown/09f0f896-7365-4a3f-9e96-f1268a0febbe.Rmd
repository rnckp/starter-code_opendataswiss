...
- **Keywords.de** `['stadtbaum', 'stzh', 'punktdaten', 'parkbaum', 'geodaten', 'strassenbaum', 'geoportal', 'fallung', 'stadtbaume', 'vektordaten', 'baum', 'baumersatz', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-02T03:32:07.379915`
