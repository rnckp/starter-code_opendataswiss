...
- **Keywords.de** `['parkbaum', 'strassenbaum', 'stadtbaume', 'geoportal', 'baum', 'baumersatz', 'stzh', 'stadtbaum', 'vektordaten', 'baumersatzliste', 'punktdaten', 'fallung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-08T02:34:41.351702`
