...
- **Keywords.de** `['stzh', 'geoportal', 'baum', 'baumersatzliste', 'punktdaten', 'stadtbaum', 'geodaten', 'parkbaum', 'vektordaten', 'strassenbaum', 'baumersatz', 'stadtbaume', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-19T02:06:38.497970`
