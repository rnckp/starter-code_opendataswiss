...
- **Keywords.de** `['stadtbaume', 'parkbaum', 'vektordaten', 'strassenbaum', 'geoportal', 'stzh', 'fallung', 'baum', 'baumersatz', 'punktdaten', 'baumersatzliste', 'stadtbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-16T04:18:41.472509`
