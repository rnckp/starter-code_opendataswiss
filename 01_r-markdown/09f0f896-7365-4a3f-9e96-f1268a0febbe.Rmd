...
- **Keywords.de** `['parkbaum', 'geoportal', 'baum', 'punktdaten', 'stadtbaume', 'stzh', 'stadtbaum', 'baumersatzliste', 'vektordaten', 'strassenbaum', 'baumersatz', 'geodaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-11T03:14:19.466109`
