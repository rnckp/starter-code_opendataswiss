...
- **Keywords.de** `['baumersatz', 'fallung', 'parkbaum', 'strassenbaum', 'punktdaten', 'geodaten', 'baum', 'geoportal', 'stzh', 'stadtbaum', 'baumersatzliste', 'vektordaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-14T04:08:23.949857`
