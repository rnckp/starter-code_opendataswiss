...
- **Keywords.de** `['fallung', 'geodaten', 'baum', 'stzh', 'baumersatzliste', 'parkbaum', 'geoportal', 'punktdaten', 'strassenbaum', 'stadtbaume', 'baumersatz', 'stadtbaum', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-29T04:09:17.468383`
