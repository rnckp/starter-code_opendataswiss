...
- **Keywords.de** `['baum', 'punktdaten', 'geodaten', 'stadtbaum', 'parkbaum', 'fallung', 'vektordaten', 'baumersatzliste', 'strassenbaum', 'baumersatz', 'geoportal', 'stzh', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-19T03:16:27.207747`
