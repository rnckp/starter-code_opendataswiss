...
- **Keywords.de** `['stadtbaume', 'geoportal', 'vektordaten', 'stadtbaum', 'baum', 'baumersatzliste', 'fallung', 'baumersatz', 'parkbaum', 'geodaten', 'stzh', 'strassenbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-02T03:28:55.874947`
