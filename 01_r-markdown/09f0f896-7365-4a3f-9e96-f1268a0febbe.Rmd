...
- **Keywords.de** `['geodaten', 'stadtbaum', 'parkbaum', 'strassenbaum', 'stzh', 'vektordaten', 'geoportal', 'baumersatz', 'punktdaten', 'fallung', 'stadtbaume', 'baum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-17T03:30:55.330691`
