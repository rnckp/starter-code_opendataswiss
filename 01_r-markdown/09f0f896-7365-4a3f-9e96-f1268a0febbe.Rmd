...
- **Keywords.de** `['geoportal', 'fallung', 'baumersatzliste', 'stadtbaum', 'punktdaten', 'geodaten', 'baum', 'parkbaum', 'stadtbaume', 'strassenbaum', 'stzh', 'baumersatz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-29T02:58:18.733607`
