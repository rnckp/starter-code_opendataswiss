...
- **Keywords.de** `['parkbaum', 'baumersatzliste', 'punktdaten', 'vektordaten', 'fallung', 'strassenbaum', 'stadtbaume', 'geoportal', 'stadtbaum', 'geodaten', 'baumersatz', 'stzh', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-12T02:56:54.866193`
