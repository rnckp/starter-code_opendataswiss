...
- **Keywords.de** `['stadtbaume', 'fallung', 'baumersatz', 'stzh', 'strassenbaum', 'geoportal', 'baumersatzliste', 'parkbaum', 'baum', 'vektordaten', 'stadtbaum', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-08T03:27:37.021950`
