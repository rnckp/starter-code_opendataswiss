...
- **Keywords.de** `['baumersatzliste', 'geoportal', 'geodaten', 'parkbaum', 'stzh', 'stadtbaume', 'baumersatz', 'vektordaten', 'strassenbaum', 'fallung', 'baum', 'punktdaten', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-29T02:52:36.234692`
