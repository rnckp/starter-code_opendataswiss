...
- **Keywords.de** `['stadtbaum', 'baumersatz', 'strassenbaum', 'parkbaum', 'stadtbaume', 'fallung', 'punktdaten', 'vektordaten', 'baumersatzliste', 'stzh', 'baum', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-11T03:23:25.314099`
