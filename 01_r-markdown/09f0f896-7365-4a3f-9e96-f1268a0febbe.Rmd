...
- **Keywords.de** `['stadtbaum', 'vektordaten', 'punktdaten', 'baum', 'stadtbaume', 'geoportal', 'stzh', 'baumersatz', 'baumersatzliste', 'parkbaum', 'fallung', 'strassenbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-21T03:59:09.102465`
