...
- **Keywords.de** `['stadtbaume', 'baumersatzliste', 'vektordaten', 'stzh', 'baumersatz', 'punktdaten', 'geodaten', 'fallung', 'baum', 'stadtbaum', 'geoportal', 'parkbaum', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-13T03:27:28.816788`
