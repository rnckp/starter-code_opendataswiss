...
- **Keywords.de** `['baumersatz', 'geoportal', 'vektordaten', 'strassenbaum', 'stadtbaum', 'stadtbaume', 'stzh', 'baumersatzliste', 'geodaten', 'baum', 'fallung', 'punktdaten', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-23T02:47:44.531559`
