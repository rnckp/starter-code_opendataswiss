...
- **Keywords.de** `['baum', 'fallung', 'strassenbaum', 'punktdaten', 'geodaten', 'baumersatzliste', 'geoportal', 'parkbaum', 'stadtbaume', 'vektordaten', 'baumersatz', 'stzh', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-25T03:23:39.469664`
