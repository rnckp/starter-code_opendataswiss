...
- **Keywords.de** `['geodaten', 'stadtbaume', 'baum', 'vektordaten', 'stadtbaum', 'fallung', 'parkbaum', 'baumersatzliste', 'strassenbaum', 'punktdaten', 'geoportal', 'baumersatz', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-17T03:28:04.309909`
