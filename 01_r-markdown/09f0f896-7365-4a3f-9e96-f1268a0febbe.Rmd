...
- **Keywords.de** `['stadtbaum', 'parkbaum', 'baum', 'geoportal', 'baumersatz', 'stadtbaume', 'fallung', 'strassenbaum', 'stzh', 'vektordaten', 'punktdaten', 'geodaten', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-06T03:15:59.312855`
