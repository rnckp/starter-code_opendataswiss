...
- **Keywords.de** `['baumersatz', 'geoportal', 'stzh', 'strassenbaum', 'parkbaum', 'stadtbaum', 'vektordaten', 'stadtbaume', 'fallung', 'geodaten', 'punktdaten', 'baum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-11-19T02:58:55.752469`
