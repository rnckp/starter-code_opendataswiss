...
- **Keywords.de** `['vektordaten', 'fallung', 'baum', 'parkbaum', 'baumersatz', 'stzh', 'strassenbaum', 'baumersatzliste', 'punktdaten', 'stadtbaum', 'geoportal', 'geodaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-10T03:27:33.073818`
