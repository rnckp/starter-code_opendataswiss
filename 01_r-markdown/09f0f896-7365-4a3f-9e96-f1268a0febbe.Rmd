...
- **Keywords.de** `['parkbaum', 'stadtbaum', 'geodaten', 'strassenbaum', 'baumersatzliste', 'punktdaten', 'stadtbaume', 'baum', 'vektordaten', 'fallung', 'geoportal', 'baumersatz', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-17T02:26:13.768632`
