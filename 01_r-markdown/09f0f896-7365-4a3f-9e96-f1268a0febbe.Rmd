...
- **Keywords.de** `['vektordaten', 'baumersatzliste', 'stzh', 'punktdaten', 'geodaten', 'stadtbaume', 'baumersatz', 'parkbaum', 'stadtbaum', 'geoportal', 'fallung', 'baum', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-14T03:04:28.691164`
