...
- **Keywords.de** `['geodaten', 'fallung', 'punktdaten', 'strassenbaum', 'stadtbaum', 'parkbaum', 'baumersatzliste', 'vektordaten', 'geoportal', 'baum', 'stzh', 'baumersatz', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-28T03:08:28.566259`
