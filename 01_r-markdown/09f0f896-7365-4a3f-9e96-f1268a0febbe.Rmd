...
- **Keywords.de** `['parkbaum', 'geodaten', 'stadtbaum', 'vektordaten', 'baumersatz', 'stadtbaume', 'stzh', 'baumersatzliste', 'baum', 'punktdaten', 'fallung', 'strassenbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-20T03:19:09.948907`
