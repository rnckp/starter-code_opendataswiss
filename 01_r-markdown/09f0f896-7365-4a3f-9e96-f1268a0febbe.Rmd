...
- **Keywords.de** `['punktdaten', 'geodaten', 'stadtbaum', 'strassenbaum', 'baumersatzliste', 'baumersatz', 'vektordaten', 'fallung', 'stadtbaume', 'geoportal', 'baum', 'parkbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-06T04:04:58.807881`
