...
- **Keywords.de** `['stzh', 'baumersatz', 'parkbaum', 'baum', 'vektordaten', 'geoportal', 'baumersatzliste', 'stadtbaum', 'punktdaten', 'stadtbaume', 'geodaten', 'fallung', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-01T03:53:54.715032`
