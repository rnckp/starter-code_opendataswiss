...
- **Keywords.de** `['baum', 'stadtbaume', 'geodaten', 'strassenbaum', 'stzh', 'parkbaum', 'fallung', 'geoportal', 'baumersatz', 'vektordaten', 'baumersatzliste', 'stadtbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-09T06:11:15.502785`
