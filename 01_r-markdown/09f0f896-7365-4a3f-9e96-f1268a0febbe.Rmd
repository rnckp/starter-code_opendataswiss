...
- **Keywords.de** `['geodaten', 'geoportal', 'punktdaten', 'stadtbaume', 'fallung', 'baumersatz', 'baum', 'vektordaten', 'parkbaum', 'stadtbaum', 'stzh', 'strassenbaum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-26T03:17:11.057775`
