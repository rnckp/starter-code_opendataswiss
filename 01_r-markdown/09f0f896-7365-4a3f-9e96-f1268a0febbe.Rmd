...
- **Keywords.de** `['geodaten', 'stadtbaum', 'parkbaum', 'baum', 'fallung', 'baumersatz', 'strassenbaum', 'baumersatzliste', 'geoportal', 'punktdaten', 'stadtbaume', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-16T04:41:54.384187`
