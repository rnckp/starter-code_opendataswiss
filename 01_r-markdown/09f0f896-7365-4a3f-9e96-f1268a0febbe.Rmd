...
- **Keywords.de** `['parkbaum', 'punktdaten', 'baumersatz', 'stadtbaume', 'stzh', 'strassenbaum', 'baum', 'fallung', 'geoportal', 'geodaten', 'stadtbaum', 'baumersatzliste', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-17T02:58:03.476338`
