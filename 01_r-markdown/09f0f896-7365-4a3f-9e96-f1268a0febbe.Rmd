...
- **Keywords.de** `['stadtbaum', 'geodaten', 'punktdaten', 'fallung', 'baumersatz', 'baumersatzliste', 'strassenbaum', 'baum', 'geoportal', 'stadtbaume', 'stzh', 'vektordaten', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-26T02:59:49.314694`
