...
- **Keywords.de** `['baum', 'baumersatz', 'baumersatzliste', 'stzh', 'geodaten', 'fallung', 'punktdaten', 'geoportal', 'stadtbaume', 'vektordaten', 'strassenbaum', 'stadtbaum', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-23T03:05:22.961885`
