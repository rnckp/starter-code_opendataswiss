...
- **Keywords.de** `['stadtbaume', 'strassenbaum', 'geodaten', 'parkbaum', 'baumersatzliste', 'fallung', 'punktdaten', 'geoportal', 'baumersatz', 'baum', 'vektordaten', 'stadtbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-12T03:45:08.876524`
