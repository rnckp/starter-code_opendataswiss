...
- **Keywords.de** `['stzh', 'stadtbaum', 'geodaten', 'baumersatzliste', 'parkbaum', 'strassenbaum', 'fallung', 'vektordaten', 'baum', 'geoportal', 'stadtbaume', 'punktdaten', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-06T03:19:49.565134`
