...
- **Keywords.de** `['fallung', 'stadtbaum', 'baum', 'geoportal', 'stadtbaume', 'baumersatzliste', 'parkbaum', 'stzh', 'punktdaten', 'geodaten', 'vektordaten', 'baumersatz', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-28T03:45:30.850775`
