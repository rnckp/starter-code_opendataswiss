...
- **Keywords.de** `['stadtbaume', 'geoportal', 'stadtbaum', 'baumersatzliste', 'baumersatz', 'stzh', 'geodaten', 'fallung', 'punktdaten', 'vektordaten', 'parkbaum', 'baum', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-09T03:47:25.743013`
