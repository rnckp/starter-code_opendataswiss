...
- **Keywords.de** `['fallung', 'geoportal', 'baumersatz', 'parkbaum', 'stadtbaume', 'stadtbaum', 'geodaten', 'strassenbaum', 'baumersatzliste', 'stzh', 'punktdaten', 'vektordaten', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-30T08:42:35.440990`
