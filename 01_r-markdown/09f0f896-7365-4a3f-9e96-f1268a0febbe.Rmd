...
- **Keywords.de** `['baumersatz', 'stadtbaume', 'stadtbaum', 'baum', 'parkbaum', 'baumersatzliste', 'geodaten', 'geoportal', 'punktdaten', 'vektordaten', 'stzh', 'fallung', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-14T03:08:13.788200`
