...
- **Keywords.de** `['strassenbaum', 'stzh', 'geoportal', 'punktdaten', 'fallung', 'baum', 'stadtbaum', 'vektordaten', 'baumersatzliste', 'geodaten', 'stadtbaume', 'parkbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-02T04:20:13.735036`
