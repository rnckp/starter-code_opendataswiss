...
- **Keywords.de** `['punktdaten', 'baumersatz', 'stadtbaum', 'stadtbaume', 'fallung', 'baum', 'vektordaten', 'parkbaum', 'baumersatzliste', 'stzh', 'geoportal', 'strassenbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-28T03:05:29.498457`
