...
- **Keywords.de** `['geodaten', 'parkbaum', 'stzh', 'geoportal', 'stadtbaum', 'strassenbaum', 'fallung', 'vektordaten', 'punktdaten', 'baumersatzliste', 'baum', 'stadtbaume', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-27T03:29:27.087350`
