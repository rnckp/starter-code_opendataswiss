...
- **Keywords.de** `['punktdaten', 'fallung', 'baumersatz', 'geoportal', 'parkbaum', 'baumersatzliste', 'stadtbaum', 'stadtbaume', 'stzh', 'vektordaten', 'geodaten', 'strassenbaum', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-23T03:07:34.686447`
