...
- **Keywords.de** `['parkbaum', 'baumersatzliste', 'baum', 'stadtbaume', 'baumersatz', 'geodaten', 'fallung', 'vektordaten', 'punktdaten', 'stzh', 'strassenbaum', 'stadtbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-29T02:34:18.503177`
