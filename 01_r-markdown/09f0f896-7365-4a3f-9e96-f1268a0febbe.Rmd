...
- **Keywords.de** `['stzh', 'baumersatz', 'vektordaten', 'parkbaum', 'baum', 'punktdaten', 'fallung', 'geoportal', 'strassenbaum', 'stadtbaum', 'geodaten', 'stadtbaume', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-06T02:52:04.590148`
