...
- **Keywords.de** `['baumersatzliste', 'strassenbaum', 'geodaten', 'baum', 'stadtbaum', 'parkbaum', 'stzh', 'geoportal', 'baumersatz', 'stadtbaume', 'fallung', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-17T03:43:05.711788`
