...
- **Keywords.de** `['strassenbaum', 'baum', 'vektordaten', 'geoportal', 'punktdaten', 'baumersatz', 'stadtbaume', 'baumersatzliste', 'stadtbaum', 'stzh', 'parkbaum', 'geodaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-14T05:16:09.989751`
