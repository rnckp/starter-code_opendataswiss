...
- **Keywords.de** `['geoportal', 'fallung', 'geodaten', 'stadtbaum', 'vektordaten', 'baumersatz', 'stadtbaume', 'punktdaten', 'strassenbaum', 'parkbaum', 'baum', 'stzh', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-25T02:49:19.053935`
