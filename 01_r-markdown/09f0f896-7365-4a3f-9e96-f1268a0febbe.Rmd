...
- **Keywords.de** `['baumersatzliste', 'baum', 'fallung', 'vektordaten', 'parkbaum', 'stadtbaume', 'strassenbaum', 'baumersatz', 'geoportal', 'stzh', 'geodaten', 'stadtbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-09T02:25:40.783445`
