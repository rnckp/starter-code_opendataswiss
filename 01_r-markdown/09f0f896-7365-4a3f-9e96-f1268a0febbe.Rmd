...
- **Keywords.de** `['stadtbaum', 'fallung', 'geodaten', 'punktdaten', 'stzh', 'parkbaum', 'baumersatzliste', 'baumersatz', 'baum', 'strassenbaum', 'vektordaten', 'stadtbaume', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-04T03:46:07.963250`
