...
- **Keywords.de** `['parkbaum', 'stadtbaum', 'baumersatzliste', 'stadtbaume', 'geodaten', 'punktdaten', 'strassenbaum', 'vektordaten', 'geoportal', 'baum', 'fallung', 'stzh', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-07T03:25:19.770960`
