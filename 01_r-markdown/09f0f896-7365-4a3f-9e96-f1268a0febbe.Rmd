...
- **Keywords.de** `['baum', 'baumersatzliste', 'geodaten', 'baumersatz', 'geoportal', 'fallung', 'vektordaten', 'punktdaten', 'stadtbaume', 'strassenbaum', 'stadtbaum', 'parkbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-16T03:19:05.900388`
