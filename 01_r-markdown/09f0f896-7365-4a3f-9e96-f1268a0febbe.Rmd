...
- **Keywords.de** `['punktdaten', 'parkbaum', 'strassenbaum', 'baum', 'stzh', 'stadtbaum', 'vektordaten', 'baumersatz', 'baumersatzliste', 'fallung', 'geoportal', 'geodaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-03-10T03:15:10.503374`
