...
- **Keywords.de** `['stzh', 'geoportal', 'baumersatzliste', 'parkbaum', 'baumersatz', 'vektordaten', 'strassenbaum', 'fallung', 'baum', 'stadtbaume', 'stadtbaum', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-01T03:58:30.928289`
