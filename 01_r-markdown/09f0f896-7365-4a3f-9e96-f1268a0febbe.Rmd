...
- **Keywords.de** `['punktdaten', 'stadtbaum', 'geoportal', 'stzh', 'baum', 'vektordaten', 'stadtbaume', 'strassenbaum', 'parkbaum', 'baumersatzliste', 'fallung', 'geodaten', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-01T03:21:01.180541`
