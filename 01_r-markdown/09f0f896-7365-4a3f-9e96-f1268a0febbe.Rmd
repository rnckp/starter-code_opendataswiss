...
- **Keywords.de** `['punktdaten', 'baumersatz', 'fallung', 'baum', 'vektordaten', 'stadtbaume', 'baumersatzliste', 'stzh', 'parkbaum', 'geoportal', 'geodaten', 'strassenbaum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-15T02:53:35.820901`
