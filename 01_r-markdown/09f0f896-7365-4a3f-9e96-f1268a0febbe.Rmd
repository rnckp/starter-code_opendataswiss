...
- **Keywords.de** `['strassenbaum', 'stadtbaume', 'parkbaum', 'geoportal', 'stzh', 'geodaten', 'vektordaten', 'punktdaten', 'fallung', 'baum', 'baumersatzliste', 'baumersatz', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-12T02:56:47.765610`
