...
- **Keywords.de** `['geodaten', 'geoportal', 'stadtbaume', 'stadtbaum', 'strassenbaum', 'vektordaten', 'baumersatzliste', 'stzh', 'baum', 'parkbaum', 'baumersatz', 'punktdaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-28T04:39:35.343410`
