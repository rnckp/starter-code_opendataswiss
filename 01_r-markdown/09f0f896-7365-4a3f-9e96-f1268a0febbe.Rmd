...
- **Keywords.de** `['baumersatz', 'geodaten', 'vektordaten', 'geoportal', 'stadtbaum', 'punktdaten', 'fallung', 'parkbaum', 'strassenbaum', 'baumersatzliste', 'baum', 'stadtbaume', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-05T03:06:53.377180`
