...
- **Keywords.de** `['parkbaum', 'geoportal', 'stadtbaum', 'stzh', 'baumersatz', 'fallung', 'baumersatzliste', 'geodaten', 'punktdaten', 'baum', 'vektordaten', 'strassenbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-17T02:46:10.667333`
