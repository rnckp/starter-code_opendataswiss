...
- **Keywords.de** `['baum', 'baumersatz', 'strassenbaum', 'stzh', 'geoportal', 'fallung', 'geodaten', 'stadtbaume', 'punktdaten', 'vektordaten', 'parkbaum', 'baumersatzliste', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-19T03:32:16.632750`
