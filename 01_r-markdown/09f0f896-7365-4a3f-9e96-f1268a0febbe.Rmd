...
- **Keywords.de** `['parkbaum', 'stadtbaume', 'baum', 'stzh', 'geodaten', 'baumersatzliste', 'strassenbaum', 'baumersatz', 'vektordaten', 'fallung', 'geoportal', 'stadtbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-02T05:15:37.070882`
