...
- **Keywords.de** `['parkbaum', 'geoportal', 'strassenbaum', 'baumersatzliste', 'stadtbaum', 'baum', 'vektordaten', 'fallung', 'baumersatz', 'punktdaten', 'stzh', 'stadtbaume', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-06-25T03:28:43.768857`
