...
- **Keywords.de** `['geodaten', 'stzh', 'vektordaten', 'punktdaten', 'strassenbaum', 'stadtbaume', 'baum', 'baumersatzliste', 'fallung', 'stadtbaum', 'baumersatz', 'geoportal', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-28T03:33:52.637297`
