...
- **Keywords.de** `['fallung', 'geoportal', 'stadtbaume', 'baumersatz', 'vektordaten', 'stadtbaum', 'punktdaten', 'stzh', 'parkbaum', 'geodaten', 'baumersatzliste', 'baum', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-20T03:35:12.484204`
