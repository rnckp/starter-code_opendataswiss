...
- **Keywords.de** `['stadtbaum', 'geodaten', 'baumersatz', 'punktdaten', 'baum', 'baumersatzliste', 'stadtbaume', 'fallung', 'geoportal', 'stzh', 'strassenbaum', 'vektordaten', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-28T03:22:53.853792`
