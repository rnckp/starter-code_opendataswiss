...
- **Keywords.de** `['stzh', 'geoportal', 'baumersatzliste', 'stadtbaume', 'fallung', 'strassenbaum', 'parkbaum', 'baumersatz', 'stadtbaum', 'punktdaten', 'vektordaten', 'geodaten', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-28T02:54:47.140026`
