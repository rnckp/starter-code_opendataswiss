...
- **Keywords.de** `['fallung', 'baumersatz', 'baum', 'punktdaten', 'strassenbaum', 'parkbaum', 'stadtbaume', 'baumersatzliste', 'stzh', 'vektordaten', 'stadtbaum', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-18T02:14:49.981841`
