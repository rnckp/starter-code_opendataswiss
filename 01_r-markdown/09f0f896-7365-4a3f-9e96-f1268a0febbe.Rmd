...
- **Keywords.de** `['punktdaten', 'stadtbaume', 'stadtbaum', 'geoportal', 'fallung', 'baum', 'strassenbaum', 'stzh', 'vektordaten', 'baumersatz', 'geodaten', 'baumersatzliste', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-12T02:47:36.157520`
