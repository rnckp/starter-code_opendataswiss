...
- **Keywords.de** `['stadtbaum', 'stzh', 'geodaten', 'baumersatzliste', 'baum', 'vektordaten', 'geoportal', 'parkbaum', 'punktdaten', 'fallung', 'stadtbaume', 'strassenbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-18T04:06:40.233854`
