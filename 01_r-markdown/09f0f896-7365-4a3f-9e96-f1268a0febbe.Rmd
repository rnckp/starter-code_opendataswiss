...
- **Keywords.de** `['stadtbaum', 'stadtbaume', 'fallung', 'geodaten', 'baumersatzliste', 'strassenbaum', 'punktdaten', 'vektordaten', 'stzh', 'baumersatz', 'geoportal', 'baum', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-21T02:55:20.475331`
