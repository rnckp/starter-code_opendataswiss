...
- **Keywords.de** `['strassenbaum', 'baumersatzliste', 'stadtbaum', 'punktdaten', 'geodaten', 'stzh', 'parkbaum', 'fallung', 'stadtbaume', 'baumersatz', 'geoportal', 'vektordaten', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-06-13T03:40:29.405150`
