...
- **Keywords.de** `['stzh', 'baumersatzliste', 'stadtbaume', 'parkbaum', 'punktdaten', 'strassenbaum', 'vektordaten', 'baum', 'baumersatz', 'stadtbaum', 'fallung', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-20T02:51:17.944033`
