...
- **Keywords.de** `['stadtbaum', 'strassenbaum', 'baumersatzliste', 'fallung', 'stadtbaume', 'vektordaten', 'parkbaum', 'stzh', 'baumersatz', 'geoportal', 'geodaten', 'baum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-10T05:52:48.343973`
