...
- **Keywords.de** `['baumersatz', 'fallung', 'punktdaten', 'geodaten', 'geoportal', 'stadtbaum', 'stzh', 'baum', 'strassenbaum', 'baumersatzliste', 'vektordaten', 'parkbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-19T02:54:23.663403`
