...
- **Keywords.de** `['stzh', 'strassenbaum', 'baumersatzliste', 'baumersatz', 'vektordaten', 'parkbaum', 'geoportal', 'baum', 'punktdaten', 'stadtbaum', 'stadtbaume', 'fallung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-08T03:09:34.581755`
