...
- **Keywords.de** `['stadtbaume', 'punktdaten', 'stzh', 'geodaten', 'baum', 'vektordaten', 'parkbaum', 'baumersatzliste', 'fallung', 'baumersatz', 'geoportal', 'strassenbaum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-24T03:06:02.293686`
