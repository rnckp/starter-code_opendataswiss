...
- **Keywords.de** `['parkbaum', 'punktdaten', 'geodaten', 'stzh', 'baum', 'stadtbaume', 'geoportal', 'vektordaten', 'strassenbaum', 'baumersatzliste', 'fallung', 'stadtbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-27T03:15:48.090770`
