...
- **Keywords.de** `['geodaten', 'stzh', 'parkbaum', 'stadtbaume', 'baumersatz', 'baum', 'geoportal', 'vektordaten', 'stadtbaum', 'baumersatzliste', 'punktdaten', 'fallung', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-11-24T02:49:30.489694`
