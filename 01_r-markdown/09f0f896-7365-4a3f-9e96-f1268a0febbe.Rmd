...
- **Keywords.de** `['strassenbaum', 'parkbaum', 'baumersatzliste', 'baumersatz', 'stadtbaum', 'geodaten', 'geoportal', 'stadtbaume', 'punktdaten', 'baum', 'stzh', 'fallung', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-07T03:27:13.926423`
