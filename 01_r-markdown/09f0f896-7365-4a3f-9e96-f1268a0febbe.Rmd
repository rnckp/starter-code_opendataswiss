...
- **Keywords.de** `['baum', 'fallung', 'geoportal', 'strassenbaum', 'punktdaten', 'baumersatz', 'stadtbaum', 'vektordaten', 'baumersatzliste', 'parkbaum', 'stzh', 'stadtbaume', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-07T04:26:57.342004`
