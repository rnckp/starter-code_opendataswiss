...
- **Keywords.de** `['baumersatz', 'stadtbaum', 'punktdaten', 'stadtbaume', 'geodaten', 'baum', 'baumersatzliste', 'strassenbaum', 'fallung', 'stzh', 'parkbaum', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-13T03:26:05.322245`
