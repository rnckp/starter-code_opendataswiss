...
- **Keywords.de** `['baumersatz', 'stzh', 'vektordaten', 'strassenbaum', 'punktdaten', 'baum', 'geodaten', 'baumersatzliste', 'stadtbaume', 'fallung', 'geoportal', 'parkbaum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-24T03:29:30.532273`
