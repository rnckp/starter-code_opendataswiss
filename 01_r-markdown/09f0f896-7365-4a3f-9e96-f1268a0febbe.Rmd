...
- **Keywords.de** `['stadtbaum', 'stadtbaume', 'geodaten', 'punktdaten', 'stzh', 'parkbaum', 'baumersatzliste', 'strassenbaum', 'fallung', 'geoportal', 'baumersatz', 'vektordaten', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-03T03:15:24.992308`
