...
- **Keywords.de** `['strassenbaum', 'baumersatz', 'stzh', 'fallung', 'geoportal', 'baum', 'vektordaten', 'parkbaum', 'punktdaten', 'stadtbaume', 'baumersatzliste', 'geodaten', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-13T03:05:10.119707`
