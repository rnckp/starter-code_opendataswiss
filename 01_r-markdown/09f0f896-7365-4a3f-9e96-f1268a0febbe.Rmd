...
- **Keywords.de** `['strassenbaum', 'baumersatz', 'vektordaten', 'stzh', 'parkbaum', 'baum', 'stadtbaum', 'stadtbaume', 'baumersatzliste', 'geodaten', 'geoportal', 'punktdaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-30T03:04:33.380565`
