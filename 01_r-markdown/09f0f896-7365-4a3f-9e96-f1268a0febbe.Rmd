...
- **Keywords.de** `['punktdaten', 'parkbaum', 'stadtbaume', 'stzh', 'baumersatz', 'vektordaten', 'stadtbaum', 'baum', 'geodaten', 'geoportal', 'strassenbaum', 'baumersatzliste', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-31T03:28:41.294930`
