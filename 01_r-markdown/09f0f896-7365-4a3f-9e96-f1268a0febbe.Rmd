...
- **Keywords.de** `['geoportal', 'vektordaten', 'strassenbaum', 'stzh', 'baumersatzliste', 'geodaten', 'stadtbaume', 'fallung', 'stadtbaum', 'baum', 'parkbaum', 'baumersatz', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-06-30T03:43:11.198495`
