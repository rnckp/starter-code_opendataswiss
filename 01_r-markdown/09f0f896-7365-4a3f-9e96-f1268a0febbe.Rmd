...
- **Keywords.de** `['geodaten', 'vektordaten', 'baum', 'stadtbaume', 'parkbaum', 'stadtbaum', 'punktdaten', 'geoportal', 'stzh', 'baumersatz', 'strassenbaum', 'baumersatzliste', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-04T03:18:49.256662`
