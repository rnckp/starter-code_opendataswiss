...
- **Keywords.de** `['geodaten', 'baumersatz', 'fallung', 'punktdaten', 'geoportal', 'stadtbaum', 'baum', 'parkbaum', 'stzh', 'strassenbaum', 'stadtbaume', 'vektordaten', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-28T02:45:00.818139`
