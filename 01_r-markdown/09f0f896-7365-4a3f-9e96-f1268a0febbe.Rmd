...
- **Keywords.de** `['baumersatzliste', 'punktdaten', 'baum', 'fallung', 'geoportal', 'geodaten', 'stzh', 'vektordaten', 'stadtbaum', 'strassenbaum', 'parkbaum', 'stadtbaume', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-25T03:22:15.393749`
