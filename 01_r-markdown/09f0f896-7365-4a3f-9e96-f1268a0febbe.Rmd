...
- **Keywords.de** `['parkbaum', 'fallung', 'baumersatzliste', 'baumersatz', 'vektordaten', 'baum', 'geodaten', 'stzh', 'strassenbaum', 'punktdaten', 'geoportal', 'stadtbaume', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-24T02:16:53.152044`
