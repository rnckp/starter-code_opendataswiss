...
- **Keywords.de** `['geodaten', 'punktdaten', 'baumersatzliste', 'strassenbaum', 'baum', 'baumersatz', 'vektordaten', 'geoportal', 'stzh', 'parkbaum', 'fallung', 'stadtbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-20T02:46:14.268358`
