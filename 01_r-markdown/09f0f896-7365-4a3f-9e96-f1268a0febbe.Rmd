...
- **Keywords.de** `['baum', 'baumersatzliste', 'geoportal', 'vektordaten', 'stadtbaum', 'fallung', 'geodaten', 'punktdaten', 'baumersatz', 'parkbaum', 'stzh', 'strassenbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-03T03:22:55.621745`
