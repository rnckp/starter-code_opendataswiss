...
- **Keywords.de** `['parkbaum', 'geoportal', 'baumersatz', 'strassenbaum', 'stadtbaume', 'fallung', 'stzh', 'baumersatzliste', 'baum', 'vektordaten', 'geodaten', 'stadtbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-07T03:20:47.993011`
