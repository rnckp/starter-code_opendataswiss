...
- **Keywords.de** `['baumersatzliste', 'parkbaum', 'fallung', 'stzh', 'baumersatz', 'vektordaten', 'geoportal', 'strassenbaum', 'stadtbaume', 'stadtbaum', 'geodaten', 'punktdaten', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-21T03:11:38.977838`
