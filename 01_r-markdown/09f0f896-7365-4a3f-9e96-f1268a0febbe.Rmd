...
- **Keywords.de** `['stadtbaume', 'stzh', 'geodaten', 'baum', 'baumersatz', 'parkbaum', 'vektordaten', 'fallung', 'strassenbaum', 'geoportal', 'punktdaten', 'stadtbaum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-02T02:38:52.144446`
