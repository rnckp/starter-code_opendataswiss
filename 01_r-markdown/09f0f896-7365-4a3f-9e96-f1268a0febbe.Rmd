...
- **Keywords.de** `['baumersatzliste', 'vektordaten', 'geoportal', 'baum', 'stadtbaume', 'stzh', 'geodaten', 'strassenbaum', 'punktdaten', 'fallung', 'parkbaum', 'baumersatz', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-20T03:27:15.269498`
