...
- **Keywords.de** `['parkbaum', 'fallung', 'stadtbaum', 'baumersatz', 'stzh', 'punktdaten', 'baum', 'stadtbaume', 'vektordaten', 'baumersatzliste', 'strassenbaum', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-25T03:31:42.147959`
