...
- **Keywords.de** `['geodaten', 'stadtbaume', 'geoportal', 'baumersatzliste', 'parkbaum', 'punktdaten', 'strassenbaum', 'baum', 'stzh', 'vektordaten', 'stadtbaum', 'fallung', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-14T03:16:53.322395`
