...
- **Keywords.de** `['stadtbaum', 'fallung', 'baumersatzliste', 'vektordaten', 'punktdaten', 'geoportal', 'baumersatz', 'parkbaum', 'baum', 'strassenbaum', 'geodaten', 'stzh', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-30T02:58:31.942143`
