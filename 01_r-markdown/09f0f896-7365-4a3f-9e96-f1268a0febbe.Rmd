...
- **Keywords.de** `['geoportal', 'baum', 'vektordaten', 'strassenbaum', 'stzh', 'fallung', 'geodaten', 'stadtbaume', 'parkbaum', 'stadtbaum', 'punktdaten', 'baumersatz', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-04T03:22:17.523664`
