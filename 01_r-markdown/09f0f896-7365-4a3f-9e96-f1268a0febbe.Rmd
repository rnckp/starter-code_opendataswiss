...
- **Keywords.de** `['geodaten', 'baumersatzliste', 'geoportal', 'strassenbaum', 'fallung', 'stadtbaume', 'baumersatz', 'stadtbaum', 'punktdaten', 'stzh', 'parkbaum', 'baum', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-24T03:37:50.830531`
