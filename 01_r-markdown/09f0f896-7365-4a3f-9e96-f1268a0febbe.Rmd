...
- **Keywords.de** `['stzh', 'baumersatzliste', 'punktdaten', 'parkbaum', 'stadtbaume', 'geodaten', 'vektordaten', 'baumersatz', 'strassenbaum', 'baum', 'geoportal', 'stadtbaum', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-28T04:03:56.361975`
