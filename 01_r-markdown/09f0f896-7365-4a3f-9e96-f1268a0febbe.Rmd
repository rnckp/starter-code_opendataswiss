...
- **Keywords.de** `['stzh', 'baumersatz', 'fallung', 'vektordaten', 'parkbaum', 'geodaten', 'stadtbaum', 'punktdaten', 'strassenbaum', 'baum', 'geoportal', 'baumersatzliste', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-24T03:57:32.624242`
