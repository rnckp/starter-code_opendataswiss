...
- **Keywords.de** `['parkbaum', 'fallung', 'stadtbaume', 'baum', 'geodaten', 'punktdaten', 'vektordaten', 'stadtbaum', 'baumersatz', 'geoportal', 'stzh', 'baumersatzliste', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-17T04:33:40.597188`
