...
- **Keywords.de** `['stzh', 'stadtbaume', 'punktdaten', 'stadtbaum', 'baumersatz', 'baumersatzliste', 'baum', 'strassenbaum', 'fallung', 'geodaten', 'parkbaum', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-20T03:45:26.925677`
