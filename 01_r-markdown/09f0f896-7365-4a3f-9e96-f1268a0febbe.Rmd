...
- **Keywords.de** `['punktdaten', 'stadtbaume', 'stadtbaum', 'baumersatzliste', 'stzh', 'baum', 'geodaten', 'geoportal', 'fallung', 'strassenbaum', 'parkbaum', 'vektordaten', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-18T03:08:43.040643`
