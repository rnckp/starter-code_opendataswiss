...
- **Keywords.de** `['fallung', 'geoportal', 'baumersatz', 'strassenbaum', 'stzh', 'stadtbaum', 'baum', 'baumersatzliste', 'vektordaten', 'parkbaum', 'stadtbaume', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-06T03:50:44.525340`
