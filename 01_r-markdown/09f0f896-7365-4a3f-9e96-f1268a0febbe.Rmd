...
- **Keywords.de** `['geodaten', 'geoportal', 'fallung', 'parkbaum', 'punktdaten', 'baumersatz', 'stadtbaume', 'strassenbaum', 'baum', 'vektordaten', 'baumersatzliste', 'stadtbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-31T08:16:20.162050`
