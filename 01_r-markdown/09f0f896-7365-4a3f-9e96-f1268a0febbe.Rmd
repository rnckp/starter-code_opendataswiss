...
- **Keywords.de** `['stzh', 'stadtbaum', 'geodaten', 'punktdaten', 'fallung', 'stadtbaume', 'baum', 'strassenbaum', 'baumersatz', 'baumersatzliste', 'parkbaum', 'vektordaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-22T02:04:39.951351`
