...
- **Keywords.de** `['geodaten', 'baumersatzliste', 'stadtbaume', 'stzh', 'baumersatz', 'parkbaum', 'vektordaten', 'stadtbaum', 'baum', 'strassenbaum', 'punktdaten', 'geoportal', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-04T04:03:42.843646`
