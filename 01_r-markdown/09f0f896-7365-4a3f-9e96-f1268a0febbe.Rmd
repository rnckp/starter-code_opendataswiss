...
- **Keywords.de** `['fallung', 'parkbaum', 'stadtbaume', 'geoportal', 'stzh', 'baum', 'baumersatz', 'vektordaten', 'stadtbaum', 'geodaten', 'strassenbaum', 'punktdaten', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-10T05:11:28.842515`
