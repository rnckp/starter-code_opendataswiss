...
- **Keywords.de** `['stadtbaume', 'stadtbaum', 'geoportal', 'baumersatz', 'strassenbaum', 'parkbaum', 'baumersatzliste', 'vektordaten', 'stzh', 'fallung', 'baum', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-06T03:12:13.255139`
