...
- **Keywords.de** `['fallung', 'baum', 'stadtbaum', 'strassenbaum', 'baumersatzliste', 'punktdaten', 'vektordaten', 'geodaten', 'parkbaum', 'stzh', 'baumersatz', 'geoportal', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-15T05:07:10.548564`
