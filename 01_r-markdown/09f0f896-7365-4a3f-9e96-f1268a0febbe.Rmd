...
- **Keywords.de** `['strassenbaum', 'geodaten', 'vektordaten', 'punktdaten', 'baum', 'baumersatz', 'baumersatzliste', 'geoportal', 'stadtbaum', 'stzh', 'parkbaum', 'stadtbaume', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-15T03:15:54.281802`
