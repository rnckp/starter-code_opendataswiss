...
- **Keywords.de** `['baumersatzliste', 'fallung', 'parkbaum', 'vektordaten', 'baumersatz', 'punktdaten', 'geodaten', 'stzh', 'stadtbaum', 'baum', 'strassenbaum', 'geoportal', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-16T03:30:55.429830`
