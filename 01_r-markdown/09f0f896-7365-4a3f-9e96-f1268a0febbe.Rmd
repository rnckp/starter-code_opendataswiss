...
- **Keywords.de** `['stadtbaum', 'vektordaten', 'parkbaum', 'baumersatz', 'stzh', 'punktdaten', 'baum', 'baumersatzliste', 'geodaten', 'fallung', 'strassenbaum', 'geoportal', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-07T03:22:35.003501`
