...
- **Keywords.de** `['baumersatzliste', 'stadtbaume', 'strassenbaum', 'baum', 'baumersatz', 'parkbaum', 'punktdaten', 'geoportal', 'fallung', 'stadtbaum', 'stzh', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-26T02:59:55.611528`
