...
- **Keywords.de** `['baumersatz', 'parkbaum', 'vektordaten', 'baum', 'baumersatzliste', 'stadtbaum', 'stadtbaume', 'punktdaten', 'stzh', 'geoportal', 'geodaten', 'fallung', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-20T02:42:33.543984`
