...
- **Keywords.de** `['baum', 'stadtbaum', 'baumersatzliste', 'vektordaten', 'fallung', 'punktdaten', 'geoportal', 'strassenbaum', 'baumersatz', 'stzh', 'geodaten', 'stadtbaume', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-23T02:28:24.082563`
