...
- **Keywords.de** `['stadtbaum', 'geoportal', 'stzh', 'baumersatzliste', 'baumersatz', 'fallung', 'punktdaten', 'geodaten', 'vektordaten', 'baum', 'strassenbaum', 'stadtbaume', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-09T03:43:45.309970`
