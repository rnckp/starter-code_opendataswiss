...
- **Keywords.de** `['parkbaum', 'stzh', 'baumersatz', 'strassenbaum', 'stadtbaume', 'baum', 'vektordaten', 'fallung', 'geodaten', 'stadtbaum', 'punktdaten', 'baumersatzliste', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-29T03:05:53.040232`
