...
- **Keywords.de** `['punktdaten', 'strassenbaum', 'parkbaum', 'baumersatz', 'stadtbaume', 'geoportal', 'vektordaten', 'fallung', 'stzh', 'baumersatzliste', 'geodaten', 'stadtbaum', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-01T03:16:15.664614`
