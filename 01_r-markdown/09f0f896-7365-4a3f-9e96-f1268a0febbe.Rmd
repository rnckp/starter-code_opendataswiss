...
- **Keywords.de** `['parkbaum', 'baum', 'baumersatzliste', 'vektordaten', 'stzh', 'baumersatz', 'geoportal', 'strassenbaum', 'stadtbaum', 'geodaten', 'stadtbaume', 'punktdaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-25T04:25:32.139284`
