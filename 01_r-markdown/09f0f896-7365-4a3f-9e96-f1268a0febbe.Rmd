...
- **Keywords.de** `['stzh', 'geoportal', 'baumersatz', 'stadtbaum', 'stadtbaume', 'baum', 'geodaten', 'parkbaum', 'baumersatzliste', 'strassenbaum', 'fallung', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-05T02:45:31.930745`
