...
- **Keywords.de** `['baumersatz', 'geodaten', 'stzh', 'geoportal', 'baum', 'punktdaten', 'vektordaten', 'baumersatzliste', 'fallung', 'parkbaum', 'stadtbaum', 'stadtbaume', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-24T03:22:23.183040`
