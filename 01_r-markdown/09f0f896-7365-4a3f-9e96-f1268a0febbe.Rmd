...
- **Keywords.de** `['geoportal', 'baum', 'punktdaten', 'stzh', 'stadtbaum', 'vektordaten', 'baumersatz', 'stadtbaume', 'parkbaum', 'fallung', 'baumersatzliste', 'strassenbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-11T03:32:41.263044`
