...
- **Keywords.de** `['stadtbaume', 'geoportal', 'stzh', 'baumersatz', 'stadtbaum', 'strassenbaum', 'punktdaten', 'baumersatzliste', 'baum', 'fallung', 'parkbaum', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-19T03:22:46.054232`
