...
- **Keywords.de** `['baumersatz', 'stzh', 'fallung', 'vektordaten', 'geoportal', 'punktdaten', 'stadtbaume', 'strassenbaum', 'baum', 'geodaten', 'baumersatzliste', 'parkbaum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-14T03:09:17.495265`
