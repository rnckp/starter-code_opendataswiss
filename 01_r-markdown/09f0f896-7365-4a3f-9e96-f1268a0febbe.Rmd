...
- **Keywords.de** `['geoportal', 'stadtbaum', 'geodaten', 'baumersatzliste', 'parkbaum', 'stzh', 'vektordaten', 'stadtbaume', 'baum', 'baumersatz', 'fallung', 'punktdaten', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-11-29T03:24:27.516549`
