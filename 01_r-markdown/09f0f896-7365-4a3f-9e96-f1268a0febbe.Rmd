...
- **Keywords.de** `['stzh', 'geodaten', 'fallung', 'stadtbaume', 'strassenbaum', 'stadtbaum', 'vektordaten', 'geoportal', 'baum', 'punktdaten', 'parkbaum', 'baumersatzliste', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-22T02:54:06.280414`
