...
- **Keywords.de** `['baumersatz', 'baumersatzliste', 'stadtbaum', 'fallung', 'baum', 'geodaten', 'stzh', 'vektordaten', 'punktdaten', 'geoportal', 'parkbaum', 'strassenbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-13T04:02:32.270026`
