...
- **Keywords.de** `['baum', 'strassenbaum', 'fallung', 'stzh', 'punktdaten', 'vektordaten', 'stadtbaum', 'parkbaum', 'stadtbaume', 'geodaten', 'baumersatz', 'baumersatzliste', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-20T04:55:55.043504`
