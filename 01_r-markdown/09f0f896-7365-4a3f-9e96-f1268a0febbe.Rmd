...
- **Keywords.de** `['parkbaum', 'vektordaten', 'stadtbaume', 'baumersatzliste', 'geodaten', 'stadtbaum', 'stzh', 'baum', 'geoportal', 'strassenbaum', 'fallung', 'baumersatz', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-04T03:08:24.308218`
