...
- **Keywords.de** `['fallung', 'stadtbaum', 'stzh', 'baumersatz', 'vektordaten', 'parkbaum', 'strassenbaum', 'baumersatzliste', 'geoportal', 'baum', 'stadtbaume', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-26T02:36:58.674269`
