...
- **Keywords.de** `['geoportal', 'punktdaten', 'geodaten', 'baum', 'vektordaten', 'stzh', 'fallung', 'strassenbaum', 'stadtbaume', 'baumersatzliste', 'stadtbaum', 'parkbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-20T02:13:25.284742`
