...
- **Keywords.de** `['geoportal', 'baum', 'punktdaten', 'baumersatzliste', 'vektordaten', 'geodaten', 'stzh', 'stadtbaum', 'parkbaum', 'strassenbaum', 'stadtbaume', 'baumersatz', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-08T03:25:43.224409`
