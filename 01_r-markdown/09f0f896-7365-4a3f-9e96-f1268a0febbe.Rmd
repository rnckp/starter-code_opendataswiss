...
- **Keywords.de** `['strassenbaum', 'stzh', 'baumersatzliste', 'vektordaten', 'stadtbaum', 'baumersatz', 'baum', 'punktdaten', 'stadtbaume', 'geodaten', 'parkbaum', 'geoportal', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-08T04:38:56.020652`
