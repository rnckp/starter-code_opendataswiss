...
- **Keywords.de** `['geoportal', 'geodaten', 'baumersatzliste', 'baum', 'parkbaum', 'stadtbaum', 'vektordaten', 'baumersatz', 'strassenbaum', 'stadtbaume', 'punktdaten', 'stzh', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-03-08T03:09:12.372463`
