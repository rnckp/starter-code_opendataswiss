...
- **Keywords.de** `['strassenbaum', 'baumersatz', 'vektordaten', 'stadtbaume', 'fallung', 'geodaten', 'stadtbaum', 'geoportal', 'baum', 'baumersatzliste', 'punktdaten', 'parkbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-22T02:46:23.582698`
