...
- **Keywords.de** `['fallung', 'baumersatz', 'geoportal', 'punktdaten', 'stadtbaume', 'parkbaum', 'stadtbaum', 'baumersatzliste', 'vektordaten', 'baum', 'geodaten', 'strassenbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-21T03:34:48.898585`
