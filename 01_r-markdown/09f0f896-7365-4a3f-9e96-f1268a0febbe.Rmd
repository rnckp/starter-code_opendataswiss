...
- **Keywords.de** `['parkbaum', 'baum', 'baumersatzliste', 'strassenbaum', 'geoportal', 'stadtbaum', 'vektordaten', 'geodaten', 'stzh', 'stadtbaume', 'punktdaten', 'fallung', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-08T03:32:01.502664`
