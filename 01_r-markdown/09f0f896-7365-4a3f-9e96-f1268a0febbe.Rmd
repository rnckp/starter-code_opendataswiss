...
- **Keywords.de** `['geodaten', 'stzh', 'baumersatzliste', 'fallung', 'baum', 'baumersatz', 'parkbaum', 'vektordaten', 'punktdaten', 'strassenbaum', 'stadtbaume', 'stadtbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-15T03:05:33.390543`
