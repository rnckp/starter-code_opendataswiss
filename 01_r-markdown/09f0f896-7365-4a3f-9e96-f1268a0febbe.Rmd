...
- **Keywords.de** `['strassenbaum', 'stzh', 'baum', 'geodaten', 'geoportal', 'baumersatz', 'punktdaten', 'baumersatzliste', 'stadtbaume', 'stadtbaum', 'parkbaum', 'vektordaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-26T02:57:49.737849`
