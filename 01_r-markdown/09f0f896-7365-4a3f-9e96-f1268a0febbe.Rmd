...
- **Keywords.de** `['geodaten', 'stadtbaume', 'baum', 'stadtbaum', 'geoportal', 'strassenbaum', 'punktdaten', 'vektordaten', 'baumersatzliste', 'fallung', 'baumersatz', 'stzh', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-06T02:52:20.465920`
