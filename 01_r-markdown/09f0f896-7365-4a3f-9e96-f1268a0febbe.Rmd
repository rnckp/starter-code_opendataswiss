...
- **Keywords.de** `['punktdaten', 'geodaten', 'stadtbaum', 'vektordaten', 'strassenbaum', 'geoportal', 'baumersatzliste', 'baum', 'stadtbaume', 'baumersatz', 'parkbaum', 'fallung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-31T03:25:28.188064`
