...
- **Keywords.de** `['vektordaten', 'stzh', 'baumersatz', 'baum', 'fallung', 'parkbaum', 'stadtbaume', 'punktdaten', 'strassenbaum', 'baumersatzliste', 'stadtbaum', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-29T03:20:04.028562`
