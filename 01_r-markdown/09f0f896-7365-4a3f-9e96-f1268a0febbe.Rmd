...
- **Keywords.de** `['baumersatz', 'geodaten', 'parkbaum', 'strassenbaum', 'stadtbaume', 'punktdaten', 'baum', 'stadtbaum', 'geoportal', 'stzh', 'baumersatzliste', 'vektordaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-16T03:02:26.781774`
