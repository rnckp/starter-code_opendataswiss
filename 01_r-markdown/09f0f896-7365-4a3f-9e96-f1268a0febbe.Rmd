...
- **Keywords.de** `['strassenbaum', 'punktdaten', 'baum', 'baumersatzliste', 'stadtbaume', 'fallung', 'geoportal', 'stadtbaum', 'geodaten', 'baumersatz', 'parkbaum', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-23T03:18:31.820273`
