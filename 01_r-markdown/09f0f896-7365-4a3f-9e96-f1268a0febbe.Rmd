...
- **Keywords.de** `['parkbaum', 'geodaten', 'stadtbaume', 'geoportal', 'stzh', 'vektordaten', 'baumersatz', 'baumersatzliste', 'punktdaten', 'strassenbaum', 'fallung', 'stadtbaum', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-01T03:13:15.942517`
