...
- **Keywords.de** `['baumersatzliste', 'stzh', 'parkbaum', 'strassenbaum', 'baum', 'geoportal', 'punktdaten', 'vektordaten', 'fallung', 'stadtbaum', 'baumersatz', 'geodaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-21T03:23:23.024271`
