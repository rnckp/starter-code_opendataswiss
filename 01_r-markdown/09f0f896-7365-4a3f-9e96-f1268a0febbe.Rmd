...
- **Keywords.de** `['stadtbaume', 'geoportal', 'punktdaten', 'strassenbaum', 'stzh', 'baum', 'parkbaum', 'vektordaten', 'stadtbaum', 'baumersatz', 'baumersatzliste', 'fallung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-09-18T04:03:59.009273`
