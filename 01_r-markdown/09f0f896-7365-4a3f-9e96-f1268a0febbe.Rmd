...
- **Keywords.de** `['baumersatz', 'fallung', 'geoportal', 'baum', 'parkbaum', 'vektordaten', 'strassenbaum', 'geodaten', 'stadtbaum', 'punktdaten', 'stadtbaume', 'stzh', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-06-04T04:35:34.784955`
