...
- **Keywords.de** `['stzh', 'vektordaten', 'baumersatz', 'stadtbaum', 'fallung', 'stadtbaume', 'baum', 'parkbaum', 'geoportal', 'geodaten', 'strassenbaum', 'baumersatzliste', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-24T04:03:34.566828`
