...
- **Keywords.de** `['punktdaten', 'geoportal', 'stadtbaum', 'stadtbaume', 'baumersatz', 'baumersatzliste', 'fallung', 'strassenbaum', 'parkbaum', 'vektordaten', 'baum', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-04T04:08:19.055277`
