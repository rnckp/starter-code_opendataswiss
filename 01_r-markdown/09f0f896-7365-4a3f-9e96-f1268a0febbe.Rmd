...
- **Keywords.de** `['baum', 'geoportal', 'vektordaten', 'parkbaum', 'stzh', 'baumersatz', 'strassenbaum', 'stadtbaume', 'punktdaten', 'geodaten', 'fallung', 'baumersatzliste', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-04T02:56:31.652846`
