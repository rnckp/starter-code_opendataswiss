...
- **Keywords.de** `['geodaten', 'parkbaum', 'punktdaten', 'vektordaten', 'stadtbaume', 'fallung', 'baumersatzliste', 'baumersatz', 'stadtbaum', 'strassenbaum', 'stzh', 'geoportal', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-18T03:26:09.959495`
