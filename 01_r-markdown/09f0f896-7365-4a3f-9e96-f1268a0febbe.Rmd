...
- **Keywords.de** `['geodaten', 'geoportal', 'parkbaum', 'baumersatzliste', 'stadtbaume', 'stadtbaum', 'baum', 'strassenbaum', 'punktdaten', 'fallung', 'stzh', 'baumersatz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-06T03:27:52.504259`
