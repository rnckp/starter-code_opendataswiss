...
- **Keywords.de** `['geodaten', 'stadtbaum', 'stadtbaume', 'geoportal', 'stzh', 'parkbaum', 'punktdaten', 'baumersatz', 'fallung', 'baumersatzliste', 'vektordaten', 'baum', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-03T03:14:54.896140`
