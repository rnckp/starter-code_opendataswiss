...
- **Keywords.de** `['stadtbaume', 'parkbaum', 'baumersatzliste', 'baum', 'baumersatz', 'stadtbaum', 'geodaten', 'stzh', 'geoportal', 'strassenbaum', 'punktdaten', 'vektordaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-10T03:04:28.522369`
