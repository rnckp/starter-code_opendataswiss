...
- **Keywords.de** `['stadtbaum', 'geoportal', 'strassenbaum', 'parkbaum', 'stzh', 'punktdaten', 'stadtbaume', 'fallung', 'geodaten', 'baumersatzliste', 'vektordaten', 'baum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-04T02:59:47.555046`
