...
- **Keywords.de** `['baum', 'baumersatz', 'geoportal', 'parkbaum', 'stadtbaume', 'punktdaten', 'stadtbaum', 'baumersatzliste', 'strassenbaum', 'fallung', 'stzh', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-04T03:21:48.015057`
