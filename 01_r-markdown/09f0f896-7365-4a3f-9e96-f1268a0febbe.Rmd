...
- **Keywords.de** `['stadtbaum', 'fallung', 'geoportal', 'geodaten', 'baumersatz', 'stadtbaume', 'parkbaum', 'stzh', 'vektordaten', 'punktdaten', 'strassenbaum', 'baum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-16T03:15:15.743217`
