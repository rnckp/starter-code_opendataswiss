...
- **Keywords.de** `['punktdaten', 'geodaten', 'stadtbaume', 'vektordaten', 'geoportal', 'parkbaum', 'baumersatz', 'stzh', 'fallung', 'strassenbaum', 'stadtbaum', 'baum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-11T03:20:25.428652`
