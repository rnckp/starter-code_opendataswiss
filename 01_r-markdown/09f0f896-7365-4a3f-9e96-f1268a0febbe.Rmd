...
- **Keywords.de** `['stadtbaum', 'strassenbaum', 'vektordaten', 'geodaten', 'parkbaum', 'geoportal', 'punktdaten', 'stadtbaume', 'baumersatz', 'stzh', 'baum', 'fallung', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-24T03:25:56.463641`
