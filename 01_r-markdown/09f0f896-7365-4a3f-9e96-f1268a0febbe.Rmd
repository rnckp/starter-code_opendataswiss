...
- **Keywords.de** `['fallung', 'geodaten', 'baumersatz', 'strassenbaum', 'baum', 'geoportal', 'stadtbaume', 'stadtbaum', 'baumersatzliste', 'parkbaum', 'stzh', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-14T03:43:44.186475`
