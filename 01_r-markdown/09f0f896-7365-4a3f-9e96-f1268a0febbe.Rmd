...
- **Keywords.de** `['stadtbaum', 'stzh', 'geodaten', 'vektordaten', 'fallung', 'baumersatzliste', 'punktdaten', 'baum', 'stadtbaume', 'parkbaum', 'geoportal', 'baumersatz', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-20T03:10:34.005118`
