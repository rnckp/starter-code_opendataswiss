...
- **Keywords.de** `['geodaten', 'stadtbaume', 'parkbaum', 'strassenbaum', 'baum', 'stadtbaum', 'baumersatzliste', 'stzh', 'punktdaten', 'vektordaten', 'fallung', 'baumersatz', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-18T02:57:56.302428`
