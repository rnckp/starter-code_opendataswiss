...
- **Keywords.de** `['geoportal', 'baumersatzliste', 'parkbaum', 'vektordaten', 'fallung', 'stadtbaum', 'baum', 'strassenbaum', 'baumersatz', 'stzh', 'geodaten', 'punktdaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-06T03:10:45.389486`
