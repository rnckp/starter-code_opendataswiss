...
- **Keywords.de** `['stadtbaum', 'strassenbaum', 'baum', 'stzh', 'geodaten', 'punktdaten', 'vektordaten', 'parkbaum', 'baumersatz', 'geoportal', 'fallung', 'baumersatzliste', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-07T03:03:39.948690`
