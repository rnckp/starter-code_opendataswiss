...
- **Keywords.de** `['baumersatzliste', 'geoportal', 'strassenbaum', 'parkbaum', 'geodaten', 'fallung', 'baumersatz', 'vektordaten', 'punktdaten', 'baum', 'stadtbaum', 'stzh', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-24T02:58:25.956560`
