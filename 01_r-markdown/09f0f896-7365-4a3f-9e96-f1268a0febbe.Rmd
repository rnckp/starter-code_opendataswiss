...
- **Keywords.de** `['parkbaum', 'stzh', 'geoportal', 'vektordaten', 'geodaten', 'fallung', 'baumersatz', 'stadtbaum', 'strassenbaum', 'baumersatzliste', 'stadtbaume', 'punktdaten', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-28T02:45:52.280450`
