...
- **Keywords.de** `['parkbaum', 'stzh', 'stadtbaume', 'stadtbaum', 'geodaten', 'baum', 'baumersatz', 'geoportal', 'strassenbaum', 'vektordaten', 'baumersatzliste', 'fallung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-23T02:45:34.543924`
