...
- **Keywords.de** `['geodaten', 'geoportal', 'stzh', 'baumersatz', 'fallung', 'baumersatzliste', 'strassenbaum', 'parkbaum', 'baum', 'vektordaten', 'stadtbaum', 'punktdaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-16T03:28:30.459306`
