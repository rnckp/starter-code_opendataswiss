...
- **Keywords.de** `['stadtbaume', 'baumersatz', 'fallung', 'strassenbaum', 'geodaten', 'punktdaten', 'stzh', 'geoportal', 'parkbaum', 'stadtbaum', 'baumersatzliste', 'vektordaten', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-04T03:26:52.850890`
