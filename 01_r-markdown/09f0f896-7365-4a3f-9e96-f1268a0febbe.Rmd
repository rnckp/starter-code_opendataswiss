...
- **Keywords.de** `['geodaten', 'baumersatz', 'fallung', 'parkbaum', 'geoportal', 'stadtbaum', 'punktdaten', 'baum', 'stadtbaume', 'baumersatzliste', 'stzh', 'strassenbaum', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-09T03:47:09.041331`
