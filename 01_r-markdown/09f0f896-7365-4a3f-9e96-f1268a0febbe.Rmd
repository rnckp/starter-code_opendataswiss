...
- **Keywords.de** `['geoportal', 'stadtbaume', 'parkbaum', 'geodaten', 'punktdaten', 'baumersatzliste', 'strassenbaum', 'baum', 'stadtbaum', 'stzh', 'baumersatz', 'vektordaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-08T03:53:08.574741`
