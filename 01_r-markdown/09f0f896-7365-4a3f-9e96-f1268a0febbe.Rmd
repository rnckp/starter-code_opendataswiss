...
- **Keywords.de** `['strassenbaum', 'baumersatzliste', 'baum', 'stadtbaum', 'stzh', 'punktdaten', 'vektordaten', 'baumersatz', 'stadtbaume', 'geoportal', 'geodaten', 'parkbaum', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-05T02:53:44.349754`
