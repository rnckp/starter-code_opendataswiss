...
- **Keywords.de** `['punktdaten', 'baum', 'stadtbaume', 'geoportal', 'baumersatzliste', 'strassenbaum', 'baumersatz', 'stadtbaum', 'vektordaten', 'fallung', 'geodaten', 'stzh', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-07T04:30:45.744743`
