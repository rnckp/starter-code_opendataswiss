...
- **Keywords.de** `['geodaten', 'vektordaten', 'stadtbaum', 'punktdaten', 'strassenbaum', 'stadtbaume', 'stzh', 'baumersatz', 'baum', 'baumersatzliste', 'fallung', 'parkbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-26T03:47:43.938169`
