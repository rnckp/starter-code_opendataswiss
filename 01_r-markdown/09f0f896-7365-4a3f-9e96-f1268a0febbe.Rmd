...
- **Keywords.de** `['stadtbaume', 'punktdaten', 'vektordaten', 'geoportal', 'baumersatzliste', 'baumersatz', 'baum', 'parkbaum', 'strassenbaum', 'stzh', 'fallung', 'geodaten', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-21T03:24:29.308766`
