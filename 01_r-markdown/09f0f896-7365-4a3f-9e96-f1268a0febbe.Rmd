...
- **Keywords.de** `['geoportal', 'baum', 'strassenbaum', 'punktdaten', 'vektordaten', 'stadtbaum', 'baumersatzliste', 'stadtbaume', 'stzh', 'baumersatz', 'parkbaum', 'fallung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-02T03:26:12.458649`
