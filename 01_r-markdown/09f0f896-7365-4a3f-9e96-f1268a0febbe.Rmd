...
- **Keywords.de** `['strassenbaum', 'baumersatzliste', 'stadtbaum', 'fallung', 'baumersatz', 'stadtbaume', 'stzh', 'baum', 'geoportal', 'geodaten', 'vektordaten', 'parkbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-13T03:30:23.421887`
