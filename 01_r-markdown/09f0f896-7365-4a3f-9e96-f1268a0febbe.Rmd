...
- **Keywords.de** `['punktdaten', 'parkbaum', 'geodaten', 'baumersatzliste', 'baum', 'stzh', 'stadtbaum', 'fallung', 'stadtbaume', 'geoportal', 'baumersatz', 'vektordaten', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-21T02:38:42.548610`
