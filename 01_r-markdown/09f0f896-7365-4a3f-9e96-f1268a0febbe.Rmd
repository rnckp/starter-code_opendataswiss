...
- **Keywords.de** `['parkbaum', 'fallung', 'geoportal', 'stadtbaume', 'baumersatz', 'stadtbaum', 'vektordaten', 'baum', 'geodaten', 'stzh', 'baumersatzliste', 'punktdaten', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-18T03:21:49.890938`
