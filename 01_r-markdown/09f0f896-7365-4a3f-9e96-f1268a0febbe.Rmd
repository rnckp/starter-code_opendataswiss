...
- **Keywords.de** `['geoportal', 'geodaten', 'vektordaten', 'baum', 'punktdaten', 'baumersatzliste', 'stadtbaume', 'strassenbaum', 'stadtbaum', 'parkbaum', 'fallung', 'baumersatz', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-03-17T03:16:50.601499`
