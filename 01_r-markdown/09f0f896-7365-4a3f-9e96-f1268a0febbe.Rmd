...
- **Keywords.de** `['baum', 'baumersatz', 'geoportal', 'vektordaten', 'geodaten', 'parkbaum', 'baumersatzliste', 'fallung', 'stadtbaume', 'punktdaten', 'strassenbaum', 'stzh', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-02T10:18:52.336447`
