...
- **Keywords.de** `['stadtbaum', 'baum', 'stzh', 'parkbaum', 'geodaten', 'baumersatzliste', 'vektordaten', 'strassenbaum', 'punktdaten', 'fallung', 'geoportal', 'stadtbaume', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-03T03:24:05.730212`
