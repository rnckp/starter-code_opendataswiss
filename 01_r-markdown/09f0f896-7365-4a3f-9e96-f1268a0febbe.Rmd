...
- **Keywords.de** `['strassenbaum', 'vektordaten', 'geodaten', 'baumersatzliste', 'stadtbaume', 'fallung', 'geoportal', 'stadtbaum', 'baum', 'punktdaten', 'parkbaum', 'stzh', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-29T03:30:53.896696`
