...
- **Keywords.de** `['punktdaten', 'geodaten', 'baumersatzliste', 'parkbaum', 'stzh', 'vektordaten', 'stadtbaume', 'strassenbaum', 'baum', 'geoportal', 'baumersatz', 'stadtbaum', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-26T03:25:10.164503`
