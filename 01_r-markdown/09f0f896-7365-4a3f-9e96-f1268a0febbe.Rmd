...
- **Keywords.de** `['baumersatzliste', 'fallung', 'baum', 'parkbaum', 'punktdaten', 'geoportal', 'baumersatz', 'stadtbaum', 'stadtbaume', 'geodaten', 'strassenbaum', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-27T03:08:03.629782`
