...
- **Keywords.de** `['geodaten', 'stadtbaume', 'fallung', 'baum', 'vektordaten', 'parkbaum', 'stadtbaum', 'baumersatzliste', 'punktdaten', 'strassenbaum', 'baumersatz', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-16T03:23:03.438616`
