...
- **Keywords.de** `['geodaten', 'parkbaum', 'punktdaten', 'baumersatzliste', 'geoportal', 'vektordaten', 'stadtbaume', 'baum', 'baumersatz', 'strassenbaum', 'stzh', 'fallung', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-11-23T03:19:10.921765`
