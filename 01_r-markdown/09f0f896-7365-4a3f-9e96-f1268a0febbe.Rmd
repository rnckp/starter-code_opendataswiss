...
- **Keywords.de** `['punktdaten', 'stadtbaume', 'baumersatzliste', 'vektordaten', 'geoportal', 'geodaten', 'baum', 'strassenbaum', 'baumersatz', 'parkbaum', 'stadtbaum', 'fallung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-15T02:58:17.718436`
