...
- **Keywords.de** `['geodaten', 'baumersatzliste', 'baum', 'punktdaten', 'parkbaum', 'strassenbaum', 'stadtbaume', 'vektordaten', 'baumersatz', 'stzh', 'stadtbaum', 'fallung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-03-12T03:22:30.880759`
