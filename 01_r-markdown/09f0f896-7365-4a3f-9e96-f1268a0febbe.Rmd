...
- **Keywords.de** `['fallung', 'stadtbaume', 'baum', 'baumersatz', 'stzh', 'punktdaten', 'parkbaum', 'geodaten', 'geoportal', 'stadtbaum', 'baumersatzliste', 'vektordaten', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-19T02:49:54.329769`
