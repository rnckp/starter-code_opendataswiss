...
- **Keywords.de** `['baum', 'baumersatz', 'baumersatzliste', 'geoportal', 'stadtbaume', 'punktdaten', 'fallung', 'stadtbaum', 'vektordaten', 'strassenbaum', 'parkbaum', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-28T03:31:07.950286`
