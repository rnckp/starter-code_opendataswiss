...
- **Keywords.de** `['fallung', 'stadtbaume', 'baumersatz', 'stadtbaum', 'baumersatzliste', 'strassenbaum', 'geoportal', 'parkbaum', 'stzh', 'geodaten', 'punktdaten', 'baum', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-02T03:01:07.459693`
