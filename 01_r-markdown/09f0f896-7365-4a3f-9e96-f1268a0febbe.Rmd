...
- **Keywords.de** `['baumersatz', 'baum', 'vektordaten', 'stadtbaum', 'punktdaten', 'parkbaum', 'baumersatzliste', 'geoportal', 'fallung', 'strassenbaum', 'stzh', 'geodaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-07T02:50:05.327038`
