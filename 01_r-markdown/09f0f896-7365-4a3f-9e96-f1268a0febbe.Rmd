...
- **Keywords.de** `['stzh', 'baumersatz', 'stadtbaum', 'geoportal', 'strassenbaum', 'punktdaten', 'parkbaum', 'baum', 'stadtbaume', 'geodaten', 'baumersatzliste', 'vektordaten', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-27T03:06:01.016024`
