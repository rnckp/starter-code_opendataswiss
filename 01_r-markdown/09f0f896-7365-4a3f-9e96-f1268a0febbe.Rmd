...
- **Keywords.de** `['baumersatz', 'baum', 'fallung', 'stadtbaume', 'punktdaten', 'geodaten', 'parkbaum', 'stzh', 'stadtbaum', 'baumersatzliste', 'vektordaten', 'strassenbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-20T02:53:53.752881`
