...
- **Keywords.de** `['baumersatz', 'baum', 'parkbaum', 'vektordaten', 'strassenbaum', 'stadtbaume', 'fallung', 'baumersatzliste', 'geoportal', 'punktdaten', 'stadtbaum', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-06-17T01:33:44.999764`
