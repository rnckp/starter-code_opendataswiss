...
- **Keywords.de** `['strassenbaum', 'punktdaten', 'fallung', 'geoportal', 'baum', 'stadtbaume', 'geodaten', 'stzh', 'baumersatzliste', 'stadtbaum', 'parkbaum', 'baumersatz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-21T02:11:37.879692`
