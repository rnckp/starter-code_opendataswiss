...
- **Keywords.de** `['baumersatzliste', 'stzh', 'geodaten', 'strassenbaum', 'baum', 'stadtbaume', 'geoportal', 'stadtbaum', 'vektordaten', 'fallung', 'baumersatz', 'parkbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-02T02:27:53.267366`
