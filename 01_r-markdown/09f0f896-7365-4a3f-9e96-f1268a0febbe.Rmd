...
- **Keywords.de** `['baumersatz', 'baum', 'stadtbaume', 'stzh', 'punktdaten', 'parkbaum', 'fallung', 'vektordaten', 'stadtbaum', 'baumersatzliste', 'strassenbaum', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-30T03:24:32.845857`
