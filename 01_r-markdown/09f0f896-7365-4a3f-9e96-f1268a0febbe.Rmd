...
- **Keywords.de** `['stzh', 'punktdaten', 'baumersatz', 'fallung', 'baumersatzliste', 'strassenbaum', 'parkbaum', 'geodaten', 'baum', 'geoportal', 'stadtbaum', 'vektordaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-03T02:51:11.433783`
