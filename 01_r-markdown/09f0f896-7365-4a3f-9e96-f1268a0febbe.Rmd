...
- **Keywords.de** `['punktdaten', 'parkbaum', 'baum', 'baumersatzliste', 'stadtbaume', 'baumersatz', 'stzh', 'stadtbaum', 'geodaten', 'fallung', 'strassenbaum', 'vektordaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-18T03:43:16.767807`
