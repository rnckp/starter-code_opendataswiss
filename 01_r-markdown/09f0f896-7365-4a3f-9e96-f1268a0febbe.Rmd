...
- **Keywords.de** `['geodaten', 'baumersatz', 'stadtbaum', 'punktdaten', 'baum', 'geoportal', 'parkbaum', 'fallung', 'stzh', 'strassenbaum', 'stadtbaume', 'baumersatzliste', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-31T02:50:56.206897`
