...
- **Keywords.de** `['stadtbaum', 'baum', 'geodaten', 'fallung', 'stadtbaume', 'vektordaten', 'strassenbaum', 'parkbaum', 'stzh', 'geoportal', 'punktdaten', 'baumersatz', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-23T04:11:17.228454`
