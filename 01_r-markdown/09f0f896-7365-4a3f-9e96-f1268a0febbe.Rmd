...
- **Keywords.de** `['vektordaten', 'stadtbaume', 'geodaten', 'geoportal', 'baumersatz', 'baumersatzliste', 'stadtbaum', 'baum', 'strassenbaum', 'fallung', 'stzh', 'parkbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-11-26T02:53:44.825640`
