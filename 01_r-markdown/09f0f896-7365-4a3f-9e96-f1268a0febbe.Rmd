...
- **Keywords.de** `['geodaten', 'geoportal', 'vektordaten', 'stadtbaum', 'baum', 'stadtbaume', 'baumersatz', 'stzh', 'fallung', 'parkbaum', 'strassenbaum', 'punktdaten', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-17T03:24:07.776514`
