...
- **Keywords.de** `['stadtbaum', 'baum', 'stzh', 'vektordaten', 'geoportal', 'geodaten', 'baumersatzliste', 'fallung', 'stadtbaume', 'baumersatz', 'parkbaum', 'punktdaten', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-16T03:40:48.245620`
