...
- **Keywords.de** `['geoportal', 'stadtbaum', 'baumersatz', 'punktdaten', 'fallung', 'stzh', 'strassenbaum', 'stadtbaume', 'vektordaten', 'baumersatzliste', 'parkbaum', 'geodaten', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-02T04:01:45.030821`
