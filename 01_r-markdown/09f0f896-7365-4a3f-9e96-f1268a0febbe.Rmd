...
- **Keywords.de** `['strassenbaum', 'vektordaten', 'geoportal', 'baum', 'baumersatzliste', 'punktdaten', 'stadtbaum', 'stadtbaume', 'stzh', 'parkbaum', 'geodaten', 'baumersatz', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-02T03:18:48.619451`
