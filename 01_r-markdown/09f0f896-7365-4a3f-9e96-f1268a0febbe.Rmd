...
- **Keywords.de** `['fallung', 'stadtbaume', 'strassenbaum', 'baumersatzliste', 'stzh', 'geodaten', 'vektordaten', 'stadtbaum', 'geoportal', 'baum', 'parkbaum', 'punktdaten', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-30T02:59:42.033251`
