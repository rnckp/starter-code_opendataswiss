...
- **Keywords.de** `['geodaten', 'punktdaten', 'vektordaten', 'stadtbaum', 'stzh', 'baumersatz', 'stadtbaume', 'geoportal', 'strassenbaum', 'parkbaum', 'baum', 'fallung', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-27T03:25:45.527225`
