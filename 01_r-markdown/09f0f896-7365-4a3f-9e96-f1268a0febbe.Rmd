...
- **Keywords.de** `['stadtbaum', 'stzh', 'punktdaten', 'geoportal', 'baumersatzliste', 'fallung', 'strassenbaum', 'stadtbaume', 'geodaten', 'baum', 'parkbaum', 'baumersatz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-14T03:25:50.869434`
