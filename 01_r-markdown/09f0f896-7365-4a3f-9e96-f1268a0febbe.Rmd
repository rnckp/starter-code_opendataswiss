...
- **Keywords.de** `['stadtbaume', 'fallung', 'geoportal', 'vektordaten', 'stadtbaum', 'baum', 'baumersatz', 'parkbaum', 'punktdaten', 'geodaten', 'baumersatzliste', 'strassenbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-06T02:48:54.248671`
