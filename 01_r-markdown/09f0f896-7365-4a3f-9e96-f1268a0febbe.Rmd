...
- **Keywords.de** `['baumersatz', 'geodaten', 'strassenbaum', 'geoportal', 'stadtbaum', 'parkbaum', 'baumersatzliste', 'fallung', 'stzh', 'vektordaten', 'baum', 'stadtbaume', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-10T04:13:08.207441`
