...
- **Keywords.de** `['baum', 'geoportal', 'geodaten', 'fallung', 'baumersatz', 'stzh', 'baumersatzliste', 'strassenbaum', 'punktdaten', 'vektordaten', 'stadtbaum', 'parkbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-18T03:25:41.808745`
