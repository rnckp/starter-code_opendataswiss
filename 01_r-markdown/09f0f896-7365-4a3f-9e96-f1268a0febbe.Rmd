...
- **Keywords.de** `['strassenbaum', 'baumersatz', 'stadtbaume', 'fallung', 'parkbaum', 'vektordaten', 'punktdaten', 'stzh', 'stadtbaum', 'geodaten', 'geoportal', 'baum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-17T03:08:13.430838`
