...
- **Keywords.de** `['baumersatzliste', 'punktdaten', 'vektordaten', 'strassenbaum', 'stzh', 'parkbaum', 'geoportal', 'stadtbaum', 'stadtbaume', 'geodaten', 'fallung', 'baumersatz', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-20T02:41:49.287075`
