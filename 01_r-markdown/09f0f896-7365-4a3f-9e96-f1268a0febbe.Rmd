...
- **Keywords.de** `['stadtbaum', 'punktdaten', 'fallung', 'baumersatz', 'strassenbaum', 'geoportal', 'vektordaten', 'stadtbaume', 'parkbaum', 'baum', 'baumersatzliste', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-22T02:57:02.829658`
