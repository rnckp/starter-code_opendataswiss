...
- **Keywords.de** `['fallung', 'baum', 'geoportal', 'punktdaten', 'stadtbaum', 'geodaten', 'parkbaum', 'strassenbaum', 'stadtbaume', 'vektordaten', 'stzh', 'baumersatzliste', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-04T04:04:49.637341`
