...
- **Keywords.de** `['fallung', 'stadtbaum', 'geodaten', 'stadtbaume', 'baum', 'vektordaten', 'stzh', 'baumersatzliste', 'strassenbaum', 'baumersatz', 'geoportal', 'punktdaten', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-18T03:32:44.594235`
