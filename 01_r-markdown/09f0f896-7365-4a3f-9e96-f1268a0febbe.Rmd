...
- **Keywords.de** `['baumersatzliste', 'stadtbaume', 'vektordaten', 'fallung', 'punktdaten', 'parkbaum', 'stadtbaum', 'baum', 'geodaten', 'geoportal', 'stzh', 'baumersatz', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-17T03:50:15.574696`
