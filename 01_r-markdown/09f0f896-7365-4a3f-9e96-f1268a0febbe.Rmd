...
- **Keywords.de** `['punktdaten', 'stzh', 'parkbaum', 'geoportal', 'baumersatz', 'fallung', 'strassenbaum', 'baumersatzliste', 'stadtbaum', 'vektordaten', 'baum', 'geodaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-07-17T02:48:31.663545`
