...
- **Keywords.de** `['fallung', 'baumersatzliste', 'geoportal', 'punktdaten', 'parkbaum', 'stadtbaum', 'vektordaten', 'stadtbaume', 'geodaten', 'stzh', 'baumersatz', 'baum', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-04T03:30:51.809777`
