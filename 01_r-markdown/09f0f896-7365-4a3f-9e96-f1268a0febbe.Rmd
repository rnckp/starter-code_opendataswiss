...
- **Keywords.de** `['baumersatz', 'baum', 'punktdaten', 'geoportal', 'stadtbaum', 'strassenbaum', 'stadtbaume', 'geodaten', 'parkbaum', 'stzh', 'baumersatzliste', 'fallung', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-19T04:10:23.687714`
