...
- **Keywords.de** `['parkbaum', 'vektordaten', 'baum', 'baumersatzliste', 'stzh', 'baumersatz', 'stadtbaum', 'stadtbaume', 'geoportal', 'fallung', 'strassenbaum', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-01T02:52:05.580226`
