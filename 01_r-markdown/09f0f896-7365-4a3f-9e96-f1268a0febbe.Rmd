...
- **Keywords.de** `['vektordaten', 'baumersatz', 'stzh', 'strassenbaum', 'geodaten', 'fallung', 'stadtbaume', 'baumersatzliste', 'stadtbaum', 'punktdaten', 'baum', 'parkbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-07-21T03:24:11.723039`
