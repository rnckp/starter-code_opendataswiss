...
- **Keywords.de** `['stadtbaume', 'baumersatz', 'stadtbaum', 'geoportal', 'baumersatzliste', 'fallung', 'punktdaten', 'geodaten', 'baum', 'vektordaten', 'parkbaum', 'strassenbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-31T03:22:19.544667`
