...
- **Keywords.de** `['parkbaum', 'strassenbaum', 'stadtbaume', 'geoportal', 'punktdaten', 'vektordaten', 'fallung', 'baumersatz', 'stzh', 'geodaten', 'baum', 'stadtbaum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-01-20T03:51:19.007466`
