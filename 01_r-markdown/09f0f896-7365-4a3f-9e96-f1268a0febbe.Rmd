...
- **Keywords.de** `['stadtbaum', 'stzh', 'stadtbaume', 'vektordaten', 'baum', 'baumersatzliste', 'fallung', 'geodaten', 'geoportal', 'strassenbaum', 'baumersatz', 'parkbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-04-30T04:07:20.488764`
