...
- **Keywords.de** `['geodaten', 'parkbaum', 'stadtbaum', 'baumersatzliste', 'vektordaten', 'stadtbaume', 'strassenbaum', 'baumersatz', 'baum', 'fallung', 'punktdaten', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-25T02:07:50.335247`
