...
- **Keywords.de** `['stzh', 'punktdaten', 'parkbaum', 'fallung', 'stadtbaum', 'baumersatz', 'baum', 'baumersatzliste', 'geoportal', 'strassenbaum', 'stadtbaume', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-03-07T03:02:10.463378`
