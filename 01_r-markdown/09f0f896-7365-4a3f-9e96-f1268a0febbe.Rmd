...
- **Keywords.de** `['baum', 'vektordaten', 'punktdaten', 'parkbaum', 'fallung', 'geodaten', 'baumersatz', 'strassenbaum', 'stzh', 'stadtbaum', 'geoportal', 'baumersatzliste', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-06-28T03:10:12.717127`
