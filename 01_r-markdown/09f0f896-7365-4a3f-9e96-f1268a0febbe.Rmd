...
- **Keywords.de** `['stadtbaume', 'fallung', 'stadtbaum', 'baum', 'baumersatz', 'strassenbaum', 'geodaten', 'vektordaten', 'parkbaum', 'baumersatzliste', 'stzh', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-06-02T03:48:24.322247`
