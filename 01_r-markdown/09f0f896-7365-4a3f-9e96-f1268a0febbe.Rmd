...
- **Keywords.de** `['stadtbaum', 'baumersatzliste', 'geodaten', 'geoportal', 'baum', 'strassenbaum', 'stzh', 'parkbaum', 'stadtbaume', 'fallung', 'punktdaten', 'vektordaten', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-25T03:21:37.695633`
