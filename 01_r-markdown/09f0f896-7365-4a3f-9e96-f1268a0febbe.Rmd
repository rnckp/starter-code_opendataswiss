...
- **Keywords.de** `['baum', 'fallung', 'baumersatz', 'stzh', 'strassenbaum', 'geodaten', 'punktdaten', 'stadtbaume', 'vektordaten', 'parkbaum', 'stadtbaum', 'geoportal', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-11-26T03:08:41.859410`
