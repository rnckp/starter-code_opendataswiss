...
- **Keywords.de** `['geodaten', 'baumersatzliste', 'vektordaten', 'parkbaum', 'stadtbaum', 'stzh', 'strassenbaum', 'punktdaten', 'baum', 'stadtbaume', 'baumersatz', 'geoportal', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-02-06T03:23:55.715653`
