...
- **Keywords.de** `['stadtbaume', 'parkbaum', 'stadtbaum', 'vektordaten', 'geodaten', 'baumersatzliste', 'fallung', 'baum', 'geoportal', 'stzh', 'punktdaten', 'strassenbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-26T03:11:02.725854`
