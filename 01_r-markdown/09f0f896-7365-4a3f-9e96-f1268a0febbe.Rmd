...
- **Keywords.de** `['punktdaten', 'baumersatz', 'stadtbaum', 'vektordaten', 'parkbaum', 'fallung', 'stadtbaume', 'strassenbaum', 'baum', 'geodaten', 'stzh', 'geoportal', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-17T02:55:36.788623`
