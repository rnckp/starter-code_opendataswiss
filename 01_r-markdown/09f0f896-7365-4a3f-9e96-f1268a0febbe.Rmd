...
- **Keywords.de** `['stadtbaum', 'geoportal', 'vektordaten', 'fallung', 'baumersatz', 'strassenbaum', 'punktdaten', 'geodaten', 'parkbaum', 'baum', 'baumersatzliste', 'stadtbaume', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-04T03:21:18.215279`
