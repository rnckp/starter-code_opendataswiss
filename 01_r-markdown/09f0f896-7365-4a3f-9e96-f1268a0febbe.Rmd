...
- **Keywords.de** `['geoportal', 'stadtbaum', 'punktdaten', 'fallung', 'stzh', 'baum', 'parkbaum', 'strassenbaum', 'baumersatzliste', 'vektordaten', 'stadtbaume', 'geodaten', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-08-17T02:08:54.518236`
