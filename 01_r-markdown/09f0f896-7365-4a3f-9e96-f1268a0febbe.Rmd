...
- **Keywords.de** `['vektordaten', 'baum', 'stzh', 'stadtbaume', 'strassenbaum', 'fallung', 'baumersatz', 'stadtbaum', 'baumersatzliste', 'geodaten', 'parkbaum', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-06-18T03:05:18.745245`
