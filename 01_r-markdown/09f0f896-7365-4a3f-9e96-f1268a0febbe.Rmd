...
- **Keywords.de** `['strassenbaum', 'geoportal', 'stadtbaume', 'parkbaum', 'baum', 'vektordaten', 'geodaten', 'baumersatz', 'stzh', 'baumersatzliste', 'fallung', 'stadtbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-27T02:55:38.624343`
