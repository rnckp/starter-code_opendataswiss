...
- **Keywords.de** `['vektordaten', 'baumersatzliste', 'stadtbaume', 'baum', 'punktdaten', 'baumersatz', 'geodaten', 'geoportal', 'fallung', 'stzh', 'stadtbaum', 'strassenbaum', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-17T04:04:23.273424`
