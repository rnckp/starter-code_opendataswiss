...
- **Keywords.de** `['stadtbaum', 'stadtbaume', 'baumersatz', 'strassenbaum', 'fallung', 'baum', 'punktdaten', 'baumersatzliste', 'parkbaum', 'geoportal', 'geodaten', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-02-25T03:07:34.470907`
