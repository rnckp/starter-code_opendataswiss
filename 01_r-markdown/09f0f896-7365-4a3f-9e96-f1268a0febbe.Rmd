...
- **Keywords.de** `['baum', 'fallung', 'stadtbaume', 'stadtbaum', 'parkbaum', 'vektordaten', 'geodaten', 'stzh', 'baumersatzliste', 'strassenbaum', 'punktdaten', 'geoportal', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-12-03T02:30:16.258462`
