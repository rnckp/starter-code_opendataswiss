...
- **Keywords.de** `['stadtbaum', 'geodaten', 'baumersatzliste', 'vektordaten', 'stzh', 'punktdaten', 'geoportal', 'baum', 'fallung', 'baumersatz', 'parkbaum', 'strassenbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-09-29T02:47:57.917710`
