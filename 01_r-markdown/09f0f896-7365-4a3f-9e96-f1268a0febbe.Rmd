...
- **Keywords.de** `['baum', 'geoportal', 'vektordaten', 'parkbaum', 'baumersatz', 'fallung', 'strassenbaum', 'stadtbaum', 'baumersatzliste', 'stadtbaume', 'stzh', 'punktdaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2023-11-22T02:47:47.430154`
