...
- **Keywords.de** `['stadtbaume', 'baumersatz', 'punktdaten', 'stzh', 'baum', 'vektordaten', 'baumersatzliste', 'stadtbaum', 'geodaten', 'strassenbaum', 'fallung', 'parkbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-01-16T02:54:01.466242`
