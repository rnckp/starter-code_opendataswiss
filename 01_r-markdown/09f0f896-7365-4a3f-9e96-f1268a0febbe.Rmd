...
- **Keywords.de** `['geoportal', 'parkbaum', 'baumersatz', 'baumersatzliste', 'stadtbaum', 'strassenbaum', 'fallung', 'geodaten', 'stzh', 'stadtbaume', 'punktdaten', 'vektordaten', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-05-23T02:53:40.132543`
