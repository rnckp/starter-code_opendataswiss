...
- **Keywords.de** `['punktdaten', 'stzh', 'geodaten', 'stadtbaume', 'baumersatzliste', 'vektordaten', 'fallung', 'parkbaum', 'baum', 'baumersatz', 'geoportal', 'stadtbaum', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-15T03:00:45.187918`
