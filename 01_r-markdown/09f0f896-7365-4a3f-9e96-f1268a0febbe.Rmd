...
- **Keywords.de** `['baumersatzliste', 'strassenbaum', 'stzh', 'geoportal', 'punktdaten', 'stadtbaume', 'vektordaten', 'parkbaum', 'baumersatz', 'baum', 'fallung', 'stadtbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2025-05-21T03:19:41.942542`
