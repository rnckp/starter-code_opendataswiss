...
- **Keywords.de** `['stadtbaum', 'baum', 'stzh', 'stadtbaume', 'geoportal', 'vektordaten', 'geodaten', 'punktdaten', 'parkbaum', 'strassenbaum', 'baumersatzliste', 'baumersatz', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-03-31T03:42:11.669032`
