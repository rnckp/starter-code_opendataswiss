...
- **Keywords.de** `['punktdaten', 'baum', 'stadtbaume', 'stzh', 'baumersatzliste', 'vektordaten', 'fallung', 'geoportal', 'strassenbaum', 'baumersatz', 'stadtbaum', 'parkbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-08-05T03:03:03.463941`
