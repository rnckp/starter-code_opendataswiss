...
- **Keywords.de** `['geoportal', 'stadtbaum', 'strassenbaum', 'baum', 'vektordaten', 'geodaten', 'stzh', 'punktdaten', 'baumersatz', 'stadtbaume', 'parkbaum', 'fallung', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-10-26T03:34:07.352547`
