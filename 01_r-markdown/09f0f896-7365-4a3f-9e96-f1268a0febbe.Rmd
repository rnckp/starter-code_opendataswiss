...
- **Keywords.de** `['baum', 'parkbaum', 'baumersatzliste', 'vektordaten', 'punktdaten', 'strassenbaum', 'stadtbaum', 'stzh', 'baumersatz', 'geodaten', 'geoportal', 'fallung', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-11T03:27:44.281108`
