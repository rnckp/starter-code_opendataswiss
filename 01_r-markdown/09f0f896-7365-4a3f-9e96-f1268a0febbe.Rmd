...
- **Keywords.de** `['fallung', 'baumersatz', 'punktdaten', 'geoportal', 'parkbaum', 'stadtbaume', 'stzh', 'stadtbaum', 'baumersatzliste', 'vektordaten', 'strassenbaum', 'baum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-12-09T03:17:24.723742`
