...
- **Keywords.de** `['parkbaum', 'baumersatz', 'fallung', 'stadtbaum', 'baum', 'vektordaten', 'stadtbaume', 'geodaten', 'strassenbaum', 'punktdaten', 'geoportal', 'baumersatzliste', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:43:52.750092`
- **Metadata_modified** `2024-04-11T03:42:03.169810`
