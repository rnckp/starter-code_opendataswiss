...
- **Publisher** `Statistik Stadt Zürich, Leerflächenzählung`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `Open Data Zürich`
- **Maintainer_email** `opendata@zuerich.ch`
- **Keywords.de** `['tabelle', 'sasa', 'nichtwohnungsbau', 'leerflaechen', 'sachdaten', 'zeitreihe']`
- **Issued** `2021-10-30T00:00:00`
- **Metadata_created** `2021-11-23T02:03:26.411714`
- **Metadata_modified** `2024-07-06T03:06:34.425481`
...
# Modified                 : 2024-05-07T20:52:33.723263
