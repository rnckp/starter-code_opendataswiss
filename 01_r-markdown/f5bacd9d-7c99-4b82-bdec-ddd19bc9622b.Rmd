...
- **Metadata_modified** `2024-09-23T10:04:30.336637`
...
df <- read_delim('https://www.bazg.admin.ch/bazg/de/home/themen/schweizerische-aussenhandelsstatistik/daten/verkehrmittel\OGD_TRANSIT_DATEN_2023.csv')
...
df <- read_delim('https://www.bazg.admin.ch/bazg/de/home/themen/schweizerische-aussenhandelsstatistik/daten/verkehrmittel/OGD_Zollstellen.csv')
...
df <- read_delim('https://www.bazg.admin.ch/bazg/de/home/themen/schweizerische-aussenhandelsstatistik/daten/verkehrmittel/OGD_VERKEHRSTRAEGER_TRANSIT.csv')

# Distribution 3
# Package_id               : f5bacd9d-7c99-4b82-bdec-ddd19bc9622b
# Description              : Die Aussenhandelsstatistik erhebt die Daten auf der Basis der Warenanmeldungen, die gemäss dem schweizerischen Zolltarif (Tares) erfolgen. Somit gibt der Zolltarif die Struktur der Aussenhandelsstatistik vor, wobei die einzelnen Tarifnummern je nach Fragestellung zu unterschiedlichen Warengruppen (= Nomenklaturen) zusammengefasst werden. 
# Issued                   : 2024-09-26T00:00:00
# Modified                 : 
# Rights                   : None

df <- read_delim('https://www.bazg.admin.ch/bazg/de/home/themen/schweizerische-aussenhandelsstatistik/daten/verkehrmittel/OGD_WARENGRUPPEN_TRANSIT.csv')
