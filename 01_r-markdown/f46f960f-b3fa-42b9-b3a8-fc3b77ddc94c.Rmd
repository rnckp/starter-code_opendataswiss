...
- **Keywords.de** `['windrichtung', 'luftdruck', 'tabelle', 'messwerte', 't_', 'wind', 'feuchte', 'sachdaten', 'hitze', 'regen', 'windgeschwindigkeit', 'lufttemperatur', 'p_', 'regendauer', 'global-strahlung', 'umweltdaten', 'luft', 'wv', 'temperatur', 'kalte', 'hr', 'wd', 'niederschlag', 'luftfeuchte', 'zeitreihe', 'wetter', 'meteo', 'echtzeit']`
- **Issued** `nan`
- **Metadata_created** `2023-09-07T00:56:14.154854`
- **Metadata_modified** `2024-06-14T02:52:40.674246`
