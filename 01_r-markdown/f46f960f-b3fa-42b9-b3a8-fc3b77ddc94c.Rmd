...
- **Keywords.de** `['sachdaten', 'messwerte', 'p_', 'wd', 'feuchte', 'echtzeit', 'global-strahlung', 'wind', 'wv', 'regen', 'niederschlag', 'meteo', 'tabelle', 'luftdruck', 'luftfeuchte', 'umweltdaten', 'windgeschwindigkeit', 'hitze', 'hr', 't_', 'wetter', 'lufttemperatur', 'regendauer', 'kalte', 'zeitreihe', 'windrichtung', 'luft', 'temperatur']`
- **Issued** `nan`
- **Metadata_created** `2023-09-07T00:56:14.154854`
- **Metadata_modified** `2024-11-24T04:12:09.567064`
