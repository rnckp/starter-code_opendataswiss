...
- **Keywords.de** `['zeitreihe', 'meteo', 't_', 'luftdruck', 'hitze', 'wetter', 'luftfeuchte', 'kalte', 'niederschlag', 'wd', 'regen', 'tabelle', 'windgeschwindigkeit', 'wind', 'wv', 'umweltdaten', 'hr', 'global-strahlung', 'echtzeit', 'luft', 'regendauer', 'p_', 'sachdaten', 'messwerte', 'feuchte', 'lufttemperatur', 'windrichtung', 'temperatur']`
- **Issued** `nan`
- **Metadata_created** `2023-09-07T00:56:14.154854`
- **Metadata_modified** `2024-02-08T04:25:51.238253`
