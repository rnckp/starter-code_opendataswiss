...
- **Keywords.de** `['echtzeit', 'meteo', 'niederschlag', 'umweltdaten', 'regendauer', 'global-strahlung', 'hr', 'luftdruck', 'feuchte', 'luft', 'wind', 'wetter', 'windrichtung', 'luftfeuchte', 'hitze', 'tabelle', 'lufttemperatur', 'windgeschwindigkeit', 'regen', 'temperatur', 'zeitreihe', 'kalte', 'messwerte', 'wd', 't_', 'sachdaten', 'wv', 'p_']`
- **Issued** `nan`
- **Metadata_created** `2023-09-07T00:56:14.154854`
- **Metadata_modified** `2024-06-15T02:47:04.245286`
