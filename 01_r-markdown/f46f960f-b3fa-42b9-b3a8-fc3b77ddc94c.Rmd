...
- **Keywords.de** `['luftdruck', 'windrichtung', 'luft', 'niederschlag', 'umweltdaten', 't_', 'meteo', 'hr', 'wd', 'tabelle', 'global-strahlung', 'zeitreihe', 'lufttemperatur', 'hitze', 'feuchte', 'wv', 'wind', 'p_', 'luftfeuchte', 'regen', 'messwerte', 'regendauer', 'wetter', 'windgeschwindigkeit', 'kalte', 'temperatur', 'echtzeit', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-09-07T00:56:14.154854`
- **Metadata_modified** `2024-11-26T03:12:19.301724`
