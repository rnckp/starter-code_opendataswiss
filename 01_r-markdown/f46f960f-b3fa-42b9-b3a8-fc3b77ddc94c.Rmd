...
- **Keywords.de** `['global-strahlung', 'temperatur', 'niederschlag', 'umweltdaten', 'feuchte', 'hr', 'tabelle', 'messwerte', 'wd', 'echtzeit', 'wind', 'sachdaten', 'windrichtung', 'lufttemperatur', 'regen', 'regendauer', 'meteo', 'zeitreihe', 'windgeschwindigkeit', 'luftdruck', 'p_', 'wetter', 'luftfeuchte', 'kalte', 't_', 'hitze', 'wv', 'luft']`
- **Issued** `nan`
- **Metadata_created** `2023-09-07T00:56:14.154854`
- **Metadata_modified** `2024-06-16T03:19:11.173988`
