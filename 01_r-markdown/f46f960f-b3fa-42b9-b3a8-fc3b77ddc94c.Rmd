...
- **Keywords.de** `['wd', 'luftdruck', 'meteo', 'feuchte', 'hr', 'global-strahlung', 'zeitreihe', 'messwerte', 'tabelle', 'regendauer', 'kalte', 'windrichtung', 't_', 'temperatur', 'wv', 'windgeschwindigkeit', 'luftfeuchte', 'lufttemperatur', 'sachdaten', 'hitze', 'niederschlag', 'umweltdaten', 'wind', 'wetter', 'luft', 'echtzeit', 'regen', 'p_']`
- **Issued** `nan`
- **Metadata_created** `2023-09-07T00:56:14.154854`
- **Metadata_modified** `2023-11-20T03:00:38.820115`
