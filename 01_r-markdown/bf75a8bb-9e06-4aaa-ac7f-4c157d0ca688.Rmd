...
- **Keywords.de** `['statistikdaten', 'broschure', 'pdf-datei', 'jahrbuch', 'analyse', 'bericht', 'archivdaten', 'webartikel', 'baselland-in-zahlen']`
- **Issued** `2024-07-25T00:00:00`
- **Metadata_created** `2024-07-26T03:19:37.500915`
- **Metadata_modified** `2024-07-29T04:11:25.175460`
...
df <- read_delim('https://data.bl.ch/api/v2/catalog/datasets/12570/exports/csv')
