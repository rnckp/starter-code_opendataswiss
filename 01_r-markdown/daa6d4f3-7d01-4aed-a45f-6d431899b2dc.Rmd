...
- **Publisher** `Stab Direktion, Liegenschaften, Finanzdepartement`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `Open Data Zürich`
- **Maintainer_email** `opendata@zuerich.ch`
- **Keywords.de** `['stzh', 'stiftungen', 'vektordaten', 'gebaude', 'geoportal', 'wohnungen', 'geodaten', 'grundstucke', 'punktdaten', 'polygondaten', 'liegenschaften']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:57.332519`
- **Metadata_modified** `2023-09-25T01:29:43.807768`
...
# Description              : 
# Issued                   : 2022-05-09T03:06:59.125276
# Modified                 : None
