...
- **Keywords.de** `['zeitreihe', 'windrichtung', 'messwerte', 'hitze', 'sachdaten', 'regendauer', 'kalte', 'wetter', 'feuchte', 'p_', 'echtzeit', 'niederschlag', 'global-strahlung', 'wv', 'tabelle', 't_', 'umweltdaten', 'luft', 'wind', 'wd', 'lufttemperatur', 'luftdruck', 'meteo', 'temperatur', 'luftfeuchte', 'windgeschwindigkeit', 'regen', 'hr']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-12-01T03:37:18.048194`
