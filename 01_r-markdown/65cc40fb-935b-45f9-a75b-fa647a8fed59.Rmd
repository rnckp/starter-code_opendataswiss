...
- **Keywords.de** `['regendauer', 'wind', 'sachdaten', 'luftfeuchte', 'umweltdaten', 'niederschlag', 'wd', 't_', 'windgeschwindigkeit', 'global-strahlung', 'luftdruck', 'hitze', 'tabelle', 'meteo', 'wetter', 'p_', 'lufttemperatur', 'zeitreihe', 'hr', 'luft', 'windrichtung', 'kalte', 'temperatur', 'messwerte', 'feuchte', 'wv', 'regen', 'echtzeit']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-17T01:09:41.094308`
