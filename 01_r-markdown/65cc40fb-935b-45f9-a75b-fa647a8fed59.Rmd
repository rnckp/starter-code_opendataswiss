...
- **Keywords.de** `['niederschlag', 'wind', 'luft', 'meteo', 'regendauer', 'temperatur', 'umweltdaten', 'echtzeit', 'sachdaten', 'windrichtung', 'regen', 'windgeschwindigkeit', 'hr', 't_', 'wd', 'wv', 'global-strahlung', 'messwerte', 'zeitreihe', 'hitze', 'luftdruck', 'luftfeuchte', 'kalte', 'p_', 'tabelle', 'feuchte', 'wetter', 'lufttemperatur']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-03-26T01:10:53.091819`
