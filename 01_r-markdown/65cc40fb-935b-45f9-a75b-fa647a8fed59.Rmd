...
- **Keywords.de** `['regendauer', 'zeitreihe', 'temperatur', 'windgeschwindigkeit', 'wd', 'umweltdaten', 'tabelle', 't_', 'wind', 'luftdruck', 'lufttemperatur', 'sachdaten', 'niederschlag', 'regen', 'hr', 'wetter', 'kalte', 'feuchte', 'messwerte', 'windrichtung', 'p_', 'hitze', 'meteo', 'luftfeuchte', 'wv', 'echtzeit', 'global-strahlung', 'luft']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-29T01:14:45.947901`
