...
- **Keywords.de** `['global-strahlung', 'regen', 'tabelle', 'temperatur', 'sachdaten', 'luft', 'windrichtung', 'wetter', 't_', 'wind', 'feuchte', 'wv', 'windgeschwindigkeit', 'niederschlag', 'hitze', 'luftdruck', 'p_', 'regendauer', 'kalte', 'lufttemperatur', 'luftfeuchte', 'messwerte', 'hr', 'wd', 'zeitreihe', 'meteo', 'umweltdaten', 'echtzeit']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2024-03-16T03:35:47.540997`
