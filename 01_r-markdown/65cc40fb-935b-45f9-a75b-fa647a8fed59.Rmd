...
- **Keywords.de** `['sachdaten', 'luft', 'luftfeuchte', 'meteo', 'umweltdaten', 'regen', 'wd', 'temperatur', 'wind', 'global-strahlung', 'hitze', 'wv', 'regendauer', 't_', 'echtzeit', 'windrichtung', 'lufttemperatur', 'feuchte', 'hr', 'zeitreihe', 'luftdruck', 'kalte', 'niederschlag', 'wetter', 'p_', 'tabelle', 'windgeschwindigkeit', 'messwerte']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-23T01:08:08.867764`
