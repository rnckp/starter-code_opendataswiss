...
- **Keywords.de** `['luft', 'lufttemperatur', 'feuchte', 'wv', 'temperatur', 'luftfeuchte', 'p_', 'meteo', 'windrichtung', 'hr', 'echtzeit', 'hitze', 'niederschlag', 'luftdruck', 'global-strahlung', 'zeitreihe', 'messwerte', 'wind', 't_', 'wd', 'windgeschwindigkeit', 'tabelle', 'sachdaten', 'umweltdaten', 'kalte', 'regendauer', 'regen', 'wetter']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-01-23T00:57:51.815766`
