...
- **Keywords.de** `['p_', 'feuchte', 'niederschlag', 't_', 'luft', 'messwerte', 'lufttemperatur', 'sachdaten', 'wind', 'regendauer', 'meteo', 'tabelle', 'windgeschwindigkeit', 'wetter', 'wv', 'zeitreihe', 'regen', 'luftfeuchte', 'hr', 'wd', 'umweltdaten', 'echtzeit', 'kalte', 'global-strahlung', 'temperatur', 'hitze', 'luftdruck', 'windrichtung']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-01-21T01:09:59.906457`
