...
- **Keywords.de** `['luftdruck', 'wv', 'feuchte', 'tabelle', 'umweltdaten', 'wind', 'niederschlag', 'regen', 'wd', 'wetter', 'global-strahlung', 't_', 'temperatur', 'messwerte', 'zeitreihe', 'hr', 'windrichtung', 'p_', 'kalte', 'hitze', 'luft', 'luftfeuchte', 'meteo', 'echtzeit', 'windgeschwindigkeit', 'sachdaten', 'lufttemperatur', 'regendauer']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-01-30T01:03:43.035430`
