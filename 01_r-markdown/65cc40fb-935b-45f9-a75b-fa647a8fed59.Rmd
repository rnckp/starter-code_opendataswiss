...
- **Keywords.de** `['wind', 'windrichtung', 'sachdaten', 'zeitreihe', 'messwerte', 'regendauer', 'hitze', 'windgeschwindigkeit', 'global-strahlung', 'kalte', 'lufttemperatur', 't_', 'tabelle', 'wv', 'temperatur', 'wetter', 'luftdruck', 'echtzeit', 'niederschlag', 'feuchte', 'hr', 'meteo', 'luft', 'wd', 'luftfeuchte', 'umweltdaten', 'regen', 'p_']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2024-11-17T01:59:40.058244`
