...
- **Keywords.de** `['regen', 'windrichtung', 'p_', 'luft', 'messwerte', 'luftfeuchte', 'wv', 'niederschlag', 'feuchte', 'lufttemperatur', 'global-strahlung', 'hitze', 'zeitreihe', 'regendauer', 'sachdaten', 'umweltdaten', 'luftdruck', 't_', 'kalte', 'wd', 'meteo', 'hr', 'wind', 'wetter', 'echtzeit', 'tabelle', 'windgeschwindigkeit', 'temperatur']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-12-29T04:18:09.450761`
