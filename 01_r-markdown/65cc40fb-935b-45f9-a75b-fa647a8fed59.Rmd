...
- **Keywords.de** `['lufttemperatur', 'messwerte', 'hr', 'luftdruck', 'wd', 'feuchte', 'regendauer', 'sachdaten', 'p_', 'windrichtung', 'echtzeit', 'niederschlag', 'wv', 'regen', 'hitze', 't_', 'wetter', 'umweltdaten', 'tabelle', 'zeitreihe', 'wind', 'windgeschwindigkeit', 'luft', 'luftfeuchte', 'global-strahlung', 'meteo', 'kalte', 'temperatur']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-02-23T00:50:07.840675`
