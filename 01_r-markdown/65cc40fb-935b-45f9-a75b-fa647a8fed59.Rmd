...
- **Keywords.de** `['windgeschwindigkeit', 'wind', 'lufttemperatur', 't_', 'regendauer', 'echtzeit', 'hitze', 'kalte', 'sachdaten', 'global-strahlung', 'luftdruck', 'luftfeuchte', 'hr', 'temperatur', 'wv', 'meteo', 'wd', 'messwerte', 'niederschlag', 'tabelle', 'regen', 'wetter', 'p_', 'windrichtung', 'feuchte', 'umweltdaten', 'luft', 'zeitreihe']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2024-11-23T03:20:50.786282`
