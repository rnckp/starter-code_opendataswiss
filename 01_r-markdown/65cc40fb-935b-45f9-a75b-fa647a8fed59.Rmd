...
- **Keywords.de** `['p_', 'luftdruck', 'echtzeit', 'umweltdaten', 'sachdaten', 'kalte', 'luftfeuchte', 'meteo', 'regendauer', 'luft', 'feuchte', 'lufttemperatur', 'messwerte', 'tabelle', 'windrichtung', 'wd', 'wetter', 'global-strahlung', 'hr', 'regen', 'windgeschwindigkeit', 'niederschlag', 'zeitreihe', 'temperatur', 'wind', 'wv', 'hitze', 't_']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-12-28T03:12:17.278311`
