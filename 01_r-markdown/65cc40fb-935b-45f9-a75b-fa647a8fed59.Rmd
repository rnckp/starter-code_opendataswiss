...
- **Keywords.de** `['kalte', 'umweltdaten', 'feuchte', 'p_', 'wv', 'messwerte', 'luft', 'sachdaten', 'hitze', 'tabelle', 'wind', 'meteo', 'hr', 'global-strahlung', 'windrichtung', 'niederschlag', 'zeitreihe', 'lufttemperatur', 'regendauer', 'wetter', 't_', 'luftdruck', 'echtzeit', 'wd', 'temperatur', 'luftfeuchte', 'regen', 'windgeschwindigkeit']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2024-11-26T03:10:58.998644`
