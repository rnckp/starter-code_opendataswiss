...
- **Keywords.de** `['echtzeit', 'windgeschwindigkeit', 'luftfeuchte', 'wv', 'windrichtung', 'umweltdaten', 'wetter', 'global-strahlung', 'luft', 'messwerte', 'temperatur', 'niederschlag', 'wd', 'p_', 'wind', 't_', 'zeitreihe', 'sachdaten', 'lufttemperatur', 'regendauer', 'tabelle', 'feuchte', 'luftdruck', 'kalte', 'hr', 'regen', 'hitze', 'meteo']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-01-18T00:55:39.138733`
