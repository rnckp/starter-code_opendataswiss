...
- **Keywords.de** `['wd', 'temperatur', 'luftfeuchte', 'echtzeit', 'wv', 'wetter', 'hitze', 'wind', 'regendauer', 'hr', 'niederschlag', 'sachdaten', 'messwerte', 'luftdruck', 'kalte', 'zeitreihe', 'windrichtung', 'feuchte', 'meteo', 'global-strahlung', 'tabelle', 'luft', 'umweltdaten', 'regen', 'p_', 'lufttemperatur', 'windgeschwindigkeit', 't_']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-02T01:42:52.957743`
