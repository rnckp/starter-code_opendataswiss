...
- **Keywords.de** `['p_', 'windgeschwindigkeit', 'hitze', 't_', 'regendauer', 'zeitreihe', 'wetter', 'luftfeuchte', 'wind', 'temperatur', 'luft', 'global-strahlung', 'wd', 'meteo', 'feuchte', 'regen', 'tabelle', 'sachdaten', 'hr', 'windrichtung', 'umweltdaten', 'messwerte', 'kalte', 'lufttemperatur', 'wv', 'echtzeit', 'niederschlag', 'luftdruck']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-10T00:55:25.651850`
