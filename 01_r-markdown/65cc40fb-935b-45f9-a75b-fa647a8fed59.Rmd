...
- **Keywords.de** `['tabelle', 'regendauer', 'niederschlag', 'lufttemperatur', 'wind', 'windrichtung', 'sachdaten', 'zeitreihe', 'luft', 'regen', 'hr', 't_', 'luftdruck', 'windgeschwindigkeit', 'p_', 'kalte', 'messwerte', 'luftfeuchte', 'temperatur', 'wd', 'wetter', 'meteo', 'echtzeit', 'wv', 'hitze', 'feuchte', 'global-strahlung', 'umweltdaten']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-12T01:48:28.275262`
