...
- **Keywords.de** `['niederschlag', 'luft', 'global-strahlung', 'sachdaten', 'wind', 'zeitreihe', 'feuchte', 'messwerte', 'windrichtung', 'regendauer', 'p_', 'meteo', 'temperatur', 'lufttemperatur', 'regen', 'windgeschwindigkeit', 'umweltdaten', 'hitze', 'kalte', 'hr', 't_', 'luftdruck', 'wd', 'wetter', 'echtzeit', 'wv', 'tabelle', 'luftfeuchte']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-05-10T01:05:10.299614`
