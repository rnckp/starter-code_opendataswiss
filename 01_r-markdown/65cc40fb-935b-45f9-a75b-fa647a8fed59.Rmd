...
- **Keywords.de** `['t_', 'niederschlag', 'wetter', 'wd', 'regendauer', 'luft', 'kalte', 'luftdruck', 'regen', 'zeitreihe', 'tabelle', 'umweltdaten', 'windrichtung', 'lufttemperatur', 'temperatur', 'luftfeuchte', 'messwerte', 'feuchte', 'hitze', 'windgeschwindigkeit', 'hr', 'wind', 'global-strahlung', 'wv', 'p_', 'echtzeit', 'sachdaten', 'meteo']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2024-02-08T03:11:09.425673`
