...
- **Keywords.de** `['temperatur', 'luft', 'niederschlag', 't_', 'tabelle', 'regen', 'umweltdaten', 'hitze', 'luftdruck', 'wd', 'luftfeuchte', 'meteo', 'windrichtung', 'lufttemperatur', 'wetter', 'wind', 'echtzeit', 'kalte', 'sachdaten', 'zeitreihe', 'hr', 'wv', 'p_', 'global-strahlung', 'messwerte', 'windgeschwindigkeit', 'feuchte', 'regendauer']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-06T01:23:13.177218`
