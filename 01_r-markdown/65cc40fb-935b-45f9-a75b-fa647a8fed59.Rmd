...
- **Keywords.de** `['feuchte', 't_', 'wv', 'windgeschwindigkeit', 'niederschlag', 'wd', 'regendauer', 'global-strahlung', 'regen', 'sachdaten', 'messwerte', 'kalte', 'hr', 'meteo', 'tabelle', 'echtzeit', 'umweltdaten', 'wind', 'hitze', 'temperatur', 'windrichtung', 'luft', 'p_', 'luftdruck', 'wetter', 'luftfeuchte', 'zeitreihe', 'lufttemperatur']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-02-13T01:01:11.305346`
