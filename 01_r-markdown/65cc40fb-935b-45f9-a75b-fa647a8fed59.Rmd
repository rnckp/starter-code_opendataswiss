...
- **Keywords.de** `['wetter', 'umweltdaten', 'zeitreihe', 'messwerte', 'regen', 'luftdruck', 'feuchte', 'wind', 'niederschlag', 'sachdaten', 'p_', 'luft', 'windgeschwindigkeit', 'echtzeit', 'lufttemperatur', 'meteo', 'global-strahlung', 'hr', 'luftfeuchte', 'regendauer', 'tabelle', 'wd', 'windrichtung', 'wv', 'hitze', 't_', 'temperatur', 'kalte']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-02-01T00:58:56.706168`
