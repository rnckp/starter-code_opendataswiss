...
- **Keywords.de** `['wind', 'global-strahlung', 'temperatur', 'wv', 'umweltdaten', 'kalte', 'niederschlag', 'luft', 'windrichtung', 'regen', 'messwerte', 'sachdaten', 'wetter', 'tabelle', 'feuchte', 'lufttemperatur', 'luftdruck', 'luftfeuchte', 'echtzeit', 'windgeschwindigkeit', 'regendauer', 'hitze', 'meteo', 't_', 'hr', 'wd', 'p_', 'zeitreihe']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-24T01:03:49.413133`
