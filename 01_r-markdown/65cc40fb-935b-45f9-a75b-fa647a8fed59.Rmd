...
- **Keywords.de** `['wind', 'wetter', 'tabelle', 'umweltdaten', 'temperatur', 'windgeschwindigkeit', 'regen', 'hr', 'luftdruck', 'echtzeit', 'feuchte', 'regendauer', 'sachdaten', 'global-strahlung', 'wd', 'meteo', 'wv', 'luft', 'luftfeuchte', 'niederschlag', 'messwerte', 'zeitreihe', 'windrichtung', 'lufttemperatur', 't_', 'kalte', 'hitze', 'p_']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-05-08T00:51:08.030467`
