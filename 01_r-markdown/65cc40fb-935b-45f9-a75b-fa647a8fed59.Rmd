...
- **Keywords.de** `['temperatur', 'kalte', 'zeitreihe', 'regen', 'luft', 'windgeschwindigkeit', 'regendauer', 'p_', 'global-strahlung', 'messwerte', 'wind', 'echtzeit', 'feuchte', 't_', 'meteo', 'luftfeuchte', 'wetter', 'lufttemperatur', 'umweltdaten', 'sachdaten', 'hr', 'wv', 'wd', 'hitze', 'tabelle', 'windrichtung', 'luftdruck', 'niederschlag']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-09-26T01:19:01.609946`
