...
- **Keywords.de** `['wv', 'regendauer', 'tabelle', 't_', 'wind', 'umweltdaten', 'windgeschwindigkeit', 'wetter', 'meteo', 'feuchte', 'niederschlag', 'temperatur', 'messwerte', 'luftdruck', 'kalte', 'global-strahlung', 'hr', 'windrichtung', 'sachdaten', 'wd', 'zeitreihe', 'p_', 'lufttemperatur', 'regen', 'echtzeit', 'luft', 'luftfeuchte', 'hitze']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-09T01:12:42.154972`
