...
- **Keywords.de** `['windrichtung', 'tabelle', 'niederschlag', 'wind', 'hr', 'zeitreihe', 'luft', 'luftfeuchte', 'windgeschwindigkeit', 'umweltdaten', 'wetter', 'messwerte', 'kalte', 'wv', 'regendauer', 'feuchte', 'sachdaten', 't_', 'lufttemperatur', 'wd', 'global-strahlung', 'p_', 'temperatur', 'regen', 'echtzeit', 'luftdruck', 'meteo', 'hitze']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-15T01:05:41.579593`
