...
- **Keywords.de** `['t_', 'umweltdaten', 'niederschlag', 'feuchte', 'wind', 'messwerte', 'zeitreihe', 'wetter', 'wv', 'luft', 'windrichtung', 'meteo', 'kalte', 'lufttemperatur', 'regen', 'echtzeit', 'regendauer', 'tabelle', 'hr', 'p_', 'temperatur', 'wd', 'luftdruck', 'windgeschwindigkeit', 'luftfeuchte', 'hitze', 'sachdaten', 'global-strahlung']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-01-25T01:08:32.335782`
