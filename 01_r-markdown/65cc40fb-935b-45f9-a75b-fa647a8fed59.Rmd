...
- **Keywords.de** `['luftdruck', 'windrichtung', 'wetter', 'sachdaten', 'messwerte', 'zeitreihe', 'global-strahlung', 'tabelle', 'hr', 'wd', 't_', 'wv', 'windgeschwindigkeit', 'feuchte', 'regen', 'umweltdaten', 'hitze', 'echtzeit', 'regendauer', 'lufttemperatur', 'niederschlag', 'luft', 'wind', 'kalte', 'luftfeuchte', 'temperatur', 'meteo', 'p_']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-02-18T01:16:15.152722`
