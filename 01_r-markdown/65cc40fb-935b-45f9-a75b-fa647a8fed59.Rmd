...
- **Keywords.de** `['wd', 'p_', 'hr', 'luftdruck', 'wv', 'meteo', 'feuchte', 'echtzeit', 'hitze', 'zeitreihe', 'windgeschwindigkeit', 'temperatur', 't_', 'regendauer', 'umweltdaten', 'wind', 'messwerte', 'tabelle', 'kalte', 'wetter', 'regen', 'luftfeuchte', 'sachdaten', 'niederschlag', 'global-strahlung', 'windrichtung', 'lufttemperatur', 'luft']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-01-24T00:57:56.912057`
