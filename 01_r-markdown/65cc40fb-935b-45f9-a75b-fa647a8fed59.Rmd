...
- **Keywords.de** `['kalte', 'p_', 'luftdruck', 'umweltdaten', 'windrichtung', 'hr', 'niederschlag', 't_', 'meteo', 'wd', 'windgeschwindigkeit', 'lufttemperatur', 'wetter', 'wind', 'global-strahlung', 'tabelle', 'wv', 'messwerte', 'sachdaten', 'luft', 'zeitreihe', 'temperatur', 'hitze', 'echtzeit', 'luftfeuchte', 'regen', 'regendauer', 'feuchte']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-03-04T00:53:05.217213`
