...
- **Keywords.de** `['umweltdaten', 'wind', 'niederschlag', 'zeitreihe', 'wetter', 'lufttemperatur', 'feuchte', 'meteo', 'temperatur', 'luftdruck', 'luftfeuchte', 'hr', 'p_', 'wd', 'sachdaten', 'messwerte', 't_', 'tabelle', 'luft', 'windgeschwindigkeit', 'kalte', 'regen', 'hitze', 'echtzeit', 'regendauer', 'wv', 'global-strahlung', 'windrichtung']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-27T01:00:44.069553`
