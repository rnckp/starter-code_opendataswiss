...
- **Keywords.de** `['zeitreihe', 'messwerte', 'wetter', 'regendauer', 'umweltdaten', 'luft', 'windgeschwindigkeit', 'echtzeit', 'niederschlag', 'luftdruck', 'feuchte', 'luftfeuchte', 'wind', 'wv', 'kalte', 'tabelle', 'wd', 'global-strahlung', 'windrichtung', 'p_', 'hr', 'sachdaten', 'regen', 't_', 'lufttemperatur', 'meteo', 'hitze', 'temperatur']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-02-16T01:10:49.554966`
