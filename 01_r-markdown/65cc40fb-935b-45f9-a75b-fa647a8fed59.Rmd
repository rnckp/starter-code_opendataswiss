...
- **Keywords.de** `['t_', 'niederschlag', 'zeitreihe', 'lufttemperatur', 'global-strahlung', 'umweltdaten', 'hitze', 'windgeschwindigkeit', 'luftdruck', 'hr', 'kalte', 'tabelle', 'wv', 'messwerte', 'wd', 'luft', 'regen', 'feuchte', 'temperatur', 'wind', 'regendauer', 'meteo', 'p_', 'echtzeit', 'wetter', 'windrichtung', 'luftfeuchte', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-05-01T01:09:25.392726`
