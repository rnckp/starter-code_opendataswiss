...
- **Keywords.de** `['hitze', 'lufttemperatur', 'zeitreihe', 'feuchte', 'kalte', 'regendauer', 'sachdaten', 't_', 'p_', 'niederschlag', 'umweltdaten', 'luft', 'meteo', 'hr', 'wv', 'echtzeit', 'windgeschwindigkeit', 'temperatur', 'wd', 'windrichtung', 'tabelle', 'global-strahlung', 'luftdruck', 'regen', 'wind', 'wetter', 'messwerte', 'luftfeuchte']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-09-25T01:25:59.362756`
