...
- **Keywords.de** `['echtzeit', 'tabelle', 'kalte', 'niederschlag', 'luftfeuchte', 't_', 'luft', 'temperatur', 'feuchte', 'hitze', 'hr', 'meteo', 'zeitreihe', 'global-strahlung', 'windgeschwindigkeit', 'sachdaten', 'wetter', 'wind', 'windrichtung', 'luftdruck', 'lufttemperatur', 'regen', 'umweltdaten', 'p_', 'messwerte', 'wd', 'wv', 'regendauer']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-02-26T01:44:59.122621`
