...
- **Keywords.de** `['messwerte', 'p_', 'global-strahlung', 'feuchte', 'niederschlag', 'regendauer', 'luft', 'kalte', 'wind', 'umweltdaten', 'windrichtung', 'zeitreihe', 'hitze', 'temperatur', 't_', 'meteo', 'echtzeit', 'regen', 'tabelle', 'windgeschwindigkeit', 'wd', 'luftdruck', 'wetter', 'lufttemperatur', 'sachdaten', 'hr', 'wv', 'luftfeuchte']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2024-11-24T03:33:48.165745`
