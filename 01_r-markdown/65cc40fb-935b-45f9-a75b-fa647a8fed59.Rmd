...
- **Keywords.de** `['sachdaten', 'global-strahlung', 'niederschlag', 'meteo', 'regendauer', 'lufttemperatur', 'windgeschwindigkeit', 'tabelle', 'hr', 'echtzeit', 'wind', 'luftfeuchte', 'zeitreihe', 'umweltdaten', 'luftdruck', 'wv', 'wd', 'messwerte', 'wetter', 't_', 'kalte', 'regen', 'hitze', 'p_', 'feuchte', 'windrichtung', 'temperatur', 'luft']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-04-26T01:11:42.209640`
