...
- **Keywords.de** `['feuchte', 'kalte', 'messwerte', 'wind', 'umweltdaten', 'tabelle', 'lufttemperatur', 'luftfeuchte', 'hr', 'p_', 'wd', 'echtzeit', 'temperatur', 'niederschlag', 'hitze', 'wv', 'zeitreihe', 'regendauer', 'windgeschwindigkeit', 'luft', 'regen', 'windrichtung', 't_', 'sachdaten', 'meteo', 'luftdruck', 'global-strahlung', 'wetter']`
- **Issued** `nan`
- **Metadata_created** `2020-10-22T05:36:44.587948`
- **Metadata_modified** `2023-03-24T01:14:20.473838`
