...
- **Keywords.de** `['fernwarmeversorgung', 'geoportal', 'warmeversorgung', 'energieplankarte', 'energie', 'netto-null', 'erneuerbar-heizen', 'stzh', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'fernwarme', 'heizen', 'holzheizkraftwerk', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'energieversorgung', 'geodaten', 'energieplanung', 'vektordaten', 'polygondaten', 'kehrichtheizkraftwerk', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-13T01:20:15.812635`
