...
- **Keywords.de** `['heizen', 'polygondaten', 'klarwerk', 'energieplanung', 'holzheizkraftwerk', 'netto-null', 'stzh', 'erneuerbar-heizen', 'fernwarmeversorgung', 'geodaten', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'energie', 'liniendaten', 'energieversorgung', 'vektordaten', 'fernwarme', 'energieplankarte', 'geoportal', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-21T01:38:58.802096`
