...
- **Keywords.de** `['kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'energie', 'polygondaten', 'energieplankarte', 'warmeversorgung', 'erneuerbar-heizen', 'energieplanung', 'vektordaten', 'energieversorgung', 'punktdaten', 'holzheizkraftwerk', 'stzh', 'kalteversorgung', 'fernwarmeversorgung', 'netto-null', 'heizen', 'geodaten', 'klarwerk', 'fernwarme', 'liniendaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-28T01:25:28.757925`
