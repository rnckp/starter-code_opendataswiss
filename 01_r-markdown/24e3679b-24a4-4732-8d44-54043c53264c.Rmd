...
- **Keywords.de** `['warmeversorgung', 'energie', 'holzheizkraftwerk', 'fernwarme', 'energieversorgung', 'kalteversorgung', 'klarwerk', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'stzh', 'energieplankarte', 'polygondaten', 'geodaten', 'leitungsgebundene-energieversorgung', 'geoportal', 'fernwarmeversorgung', 'punktdaten', 'erneuerbar-heizen', 'vektordaten', 'heizen', 'netto-null', 'kehrichtheizkraftwerk', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-10-27T01:38:25.547717`
