...
- **Keywords.de** `['geodaten', 'warmeversorgung', 'punktdaten', 'leitungsgebundene-energieversorgung', 'heizen', 'netto-null', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'vektordaten', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'energieversorgung', 'erneuerbar-heizen', 'kalteversorgung', 'klarwerk', 'stzh', 'energie', 'liniendaten', 'energieplankarte', 'energieplanung', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-26T01:19:10.986663`
