...
- **Keywords.de** `['polygondaten', 'geoportal', 'holzheizkraftwerk', 'heizen', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'fernwarme', 'vektordaten', 'punktdaten', 'kalteversorgung', 'energieplankarte', 'energieversorgung', 'kehrichtheizkraftwerk', 'energie', 'netto-null', 'stzh', 'geodaten', 'klarwerk', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'erneuerbar-heizen', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-26T01:47:36.079933`
