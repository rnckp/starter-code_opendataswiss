...
- **Keywords.de** `['fernwarmeversorgung', 'energieplanung', 'geoportal', 'energieplankarte', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'kalteversorgung', 'geodaten', 'polygondaten', 'warmeversorgung', 'klarwerk', 'stzh', 'liniendaten', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'heizen', 'energie', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'fernwarme', 'netto-null', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-18T01:13:15.099872`
