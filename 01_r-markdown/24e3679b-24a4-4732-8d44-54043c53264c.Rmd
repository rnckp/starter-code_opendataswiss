...
- **Keywords.de** `['liniendaten', 'erneuerbar-heizen', 'stzh', 'netto-null', 'geoportal', 'heizen', 'kalteversorgung', 'energie', 'warmeversorgung', 'geodaten', 'energieversorgung', 'punktdaten', 'klarwerk', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'polygondaten', 'vektordaten', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-08T01:11:29.238779`
