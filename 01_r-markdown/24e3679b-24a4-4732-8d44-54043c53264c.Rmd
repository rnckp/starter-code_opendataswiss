...
- **Keywords.de** `['kehrichtheizkraftwerk', 'energieplanung', 'energieversorgung', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'energie', 'heizen', 'stzh', 'holzheizkraftwerk', 'kalteversorgung', 'geoportal', 'polygondaten', 'erneuerbar-heizen', 'fernwarme', 'vektordaten', 'energieplankarte', 'geodaten', 'fernwarmeversorgung', 'liniendaten', 'klarwerk', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-18T01:37:31.207514`
