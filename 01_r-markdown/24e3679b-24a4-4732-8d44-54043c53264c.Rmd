...
- **Keywords.de** `['kehrichtheizkraftwerk', 'kalteversorgung', 'punktdaten', 'fernwarme', 'erneuerbar-heizen', 'liniendaten', 'holzheizkraftwerk', 'energieplankarte', 'energieversorgung', 'fernwarmeversorgung', 'warmeversorgung', 'energie', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'heizen', 'stzh', 'leitungsgebundene-energieversorgung', 'geoportal', 'vektordaten', 'energieplanung', 'netto-null', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-14T01:00:50.306441`
