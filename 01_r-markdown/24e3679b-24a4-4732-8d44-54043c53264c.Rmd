...
- **Keywords.de** `['heizen', 'geoportal', 'kalteversorgung', 'stzh', 'klarwerk', 'vektordaten', 'erneuerbar-heizen', 'energieplanung', 'energie', 'kehrichtheizkraftwerk', 'geodaten', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'fernwarmeversorgung', 'energieplankarte', 'warmeversorgung', 'netto-null', 'fernwarme', 'liniendaten', 'polygondaten', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-12T01:25:37.434785`
