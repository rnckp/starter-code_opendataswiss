...
- **Keywords.de** `['fernwarmeversorgung', 'heizen', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'liniendaten', 'geoportal', 'netto-null', 'kehrichtheizkraftwerk', 'energieversorgung', 'energieplanung', 'energieplankarte', 'vektordaten', 'polygondaten', 'geodaten', 'warmeversorgung', 'fernwarme', 'erneuerbar-heizen', 'holzheizkraftwerk', 'punktdaten', 'klarwerk', 'energie', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-10-10T01:13:18.083202`
