...
- **Keywords.de** `['netto-null', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'heizen', 'kalteversorgung', 'energieplanung', 'holzheizkraftwerk', 'vektordaten', 'punktdaten', 'erneuerbar-heizen', 'stzh', 'klarwerk', 'geoportal', 'warmeversorgung', 'geodaten', 'polygondaten', 'liniendaten', 'energieversorgung', 'energie', 'energieplankarte', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-20T01:21:19.198789`
