...
- **Keywords.de** `['energieversorgung', 'geoportal', 'kehrichtheizkraftwerk', 'energieplankarte', 'warmeversorgung', 'heizen', 'punktdaten', 'holzheizkraftwerk', 'energie', 'erneuerbar-heizen', 'netto-null', 'klarwerk', 'geodaten', 'polygondaten', 'liniendaten', 'leitungsgebundene-energieversorgung', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'stzh', 'kalteversorgung', 'energieplanung', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-29T01:15:43.596295`
