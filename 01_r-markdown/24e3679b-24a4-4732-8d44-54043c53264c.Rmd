...
- **Keywords.de** `['erneuerbar-heizen', 'vektordaten', 'warmeversorgung', 'punktdaten', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'holzheizkraftwerk', 'energieplankarte', 'netto-null', 'energieversorgung', 'heizen', 'kehrichtheizkraftwerk', 'stzh', 'geodaten', 'klarwerk', 'polygondaten', 'liniendaten', 'energie', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'energieplanung', 'fernwarme', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-08T01:51:43.505053`
