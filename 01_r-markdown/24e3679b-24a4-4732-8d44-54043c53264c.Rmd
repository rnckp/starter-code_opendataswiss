...
- **Keywords.de** `['warmeversorgung', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'liniendaten', 'vektordaten', 'netto-null', 'fernwarmeversorgung', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'energie', 'energieplankarte', 'fernwarme', 'geodaten', 'polygondaten', 'punktdaten', 'klarwerk', 'energieplanung', 'energieversorgung', 'geoportal', 'heizen', 'kalteversorgung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-08T00:59:54.340122`
