...
- **Keywords.de** `['warmeversorgung', 'kalteversorgung', 'klarwerk', 'liniendaten', 'heizen', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energieversorgung', 'netto-null', 'fernwarmeversorgung', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'vektordaten', 'polygondaten', 'energie', 'holzheizkraftwerk', 'erneuerbar-heizen', 'geoportal', 'stzh', 'energieplanung', 'energieplankarte', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-22T01:12:57.826183`
