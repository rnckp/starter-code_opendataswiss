...
- **Keywords.de** `['polygondaten', 'energieplanung', 'erneuerbar-heizen', 'fernwarmeversorgung', 'liniendaten', 'energieplankarte', 'kehrichtheizkraftwerk', 'vektordaten', 'punktdaten', 'fernwarme', 'klarwerk', 'energie', 'geodaten', 'leitungsgebundene-energieversorgung', 'geoportal', 'warmeversorgung', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'netto-null', 'holzheizkraftwerk', 'stzh', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-02T01:13:10.054435`
