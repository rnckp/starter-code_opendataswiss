...
- **Keywords.de** `['netto-null', 'heizen', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'punktdaten', 'klarwerk', 'liniendaten', 'fernwarme', 'stzh', 'polygondaten', 'warmeversorgung', 'geoportal', 'energie', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'fernwarmeversorgung', 'energieplanung', 'vektordaten', 'kalteversorgung', 'geodaten', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-03T00:58:11.074872`
