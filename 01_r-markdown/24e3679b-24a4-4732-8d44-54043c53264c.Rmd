...
- **Keywords.de** `['punktdaten', 'heizen', 'warmeversorgung', 'polygondaten', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energieversorgung', 'geoportal', 'vektordaten', 'stzh', 'energieplanung', 'klarwerk', 'kalteversorgung', 'energie', 'liniendaten', 'erneuerbar-heizen', 'energieplankarte', 'geodaten', 'fernwarmeversorgung', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-03T01:03:52.049481`
