...
- **Keywords.de** `['punktdaten', 'stzh', 'polygondaten', 'klarwerk', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'geoportal', 'fernwarme', 'energieplanung', 'holzheizkraftwerk', 'erneuerbar-heizen', 'heizen', 'energieversorgung', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'geodaten', 'energie', 'warmeversorgung', 'netto-null', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-04T01:19:34.553566`
