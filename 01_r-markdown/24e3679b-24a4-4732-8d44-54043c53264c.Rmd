...
- **Keywords.de** `['punktdaten', 'stzh', 'warmeversorgung', 'energieplanung', 'kehrichtheizkraftwerk', 'energieplankarte', 'vektordaten', 'klarwerk', 'geodaten', 'geoportal', 'fernwarme', 'kalteversorgung', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'heizen', 'erneuerbar-heizen', 'liniendaten', 'polygondaten', 'energie', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-01-30T01:07:38.557346`
