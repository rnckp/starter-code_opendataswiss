...
- **Keywords.de** `['holzheizkraftwerk', 'energieversorgung', 'polygondaten', 'erneuerbar-heizen', 'netto-null', 'punktdaten', 'stzh', 'energieplanung', 'fernwarme', 'warmeversorgung', 'vektordaten', 'geodaten', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'liniendaten', 'geoportal', 'kalteversorgung', 'heizen', 'energie', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'klarwerk', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-21T01:16:33.243725`
