...
- **Keywords.de** `['energie', 'leitungsgebundene-energieversorgung', 'netto-null', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'stzh', 'holzheizkraftwerk', 'warmeversorgung', 'punktdaten', 'polygondaten', 'kehrichtheizkraftwerk', 'fernwarme', 'geoportal', 'heizen', 'liniendaten', 'energieversorgung', 'energieplanung', 'energieplankarte', 'fernwarmeversorgung', 'vektordaten', 'klarwerk', 'kalteversorgung', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-01-27T01:19:37.246894`
