...
- **Keywords.de** `['warmeversorgung', 'erneuerbar-heizen', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'geodaten', 'fernwarmeversorgung', 'heizen', 'energieplanung', 'kalteversorgung', 'fernwarme', 'polygondaten', 'liniendaten', 'stzh', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'vektordaten', 'netto-null', 'geoportal', 'kehrichtheizkraftwerk', 'energieversorgung', 'punktdaten', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-27T01:42:33.546541`
