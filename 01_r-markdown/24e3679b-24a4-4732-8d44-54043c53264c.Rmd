...
- **Keywords.de** `['liniendaten', 'kalteversorgung', 'geodaten', 'energieversorgung', 'erneuerbar-heizen', 'geoportal', 'klarwerk', 'heizen', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'polygondaten', 'leitungsgebundene-energieversorgung', 'netto-null', 'punktdaten', 'holzheizkraftwerk', 'warmeversorgung', 'stzh', 'energieplanung', 'energie', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'vektordaten', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-28T01:31:39.679968`
