...
- **Keywords.de** `['energieversorgung', 'netto-null', 'fernwarmeversorgung', 'polygondaten', 'kehrichtheizkraftwerk', 'liniendaten', 'erneuerbar-heizen', 'energieplankarte', 'energie', 'holzheizkraftwerk', 'warmeversorgung', 'kalteversorgung', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'punktdaten', 'geodaten', 'stzh', 'fernwarme', 'energieplanung', 'heizen', 'klarwerk', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-10-28T01:48:54.147309`
