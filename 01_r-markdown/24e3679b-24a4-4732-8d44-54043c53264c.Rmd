...
- **Keywords.de** `['punktdaten', 'energie', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'klarwerk', 'vektordaten', 'energieplanung', 'geoportal', 'netto-null', 'polygondaten', 'energieplankarte', 'holzheizkraftwerk', 'energieversorgung', 'liniendaten', 'stzh', 'heizen', 'fernwarmeversorgung', 'fernwarme', 'kehrichtheizkraftwerk', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-14T01:04:02.783472`
