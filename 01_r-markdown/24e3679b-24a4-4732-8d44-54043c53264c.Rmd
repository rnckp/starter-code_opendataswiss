...
- **Keywords.de** `['warmeversorgung', 'punktdaten', 'vektordaten', 'geodaten', 'geoportal', 'energie', 'klarwerk', 'heizen', 'erneuerbar-heizen', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'energieplanung', 'holzheizkraftwerk', 'energieversorgung', 'fernwarme', 'stzh', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'kalteversorgung', 'energieplankarte', 'polygondaten', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-25T01:12:30.788746`
