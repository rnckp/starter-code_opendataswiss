...
- **Keywords.de** `['holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'geoportal', 'kalteversorgung', 'energieversorgung', 'punktdaten', 'polygondaten', 'fernwarme', 'klarwerk', 'energieplanung', 'heizen', 'energieplankarte', 'netto-null', 'liniendaten', 'fernwarmeversorgung', 'geodaten', 'energie', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'vektordaten', 'stzh', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-08T02:45:53.101280`
