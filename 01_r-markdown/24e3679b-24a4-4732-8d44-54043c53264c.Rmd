...
- **Keywords.de** `['holzheizkraftwerk', 'heizen', 'vektordaten', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'energieplankarte', 'erneuerbar-heizen', 'stzh', 'energie', 'fernwarme', 'geoportal', 'geodaten', 'punktdaten', 'kalteversorgung', 'energieplanung', 'energieversorgung', 'klarwerk', 'netto-null', 'liniendaten', 'warmeversorgung', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-08T01:17:10.630555`
