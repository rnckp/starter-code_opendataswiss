...
- **Keywords.de** `['energieplanung', 'polygondaten', 'kehrichtheizkraftwerk', 'liniendaten', 'netto-null', 'punktdaten', 'energieversorgung', 'erneuerbar-heizen', 'energie', 'fernwarmeversorgung', 'holzheizkraftwerk', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'stzh', 'klarwerk', 'energieplankarte', 'heizen', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'geodaten', 'vektordaten', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-10-29T01:46:42.012204`
