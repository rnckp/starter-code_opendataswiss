...
- **Keywords.de** `['heizen', 'klarwerk', 'vektordaten', 'energie', 'kehrichtheizkraftwerk', 'punktdaten', 'netto-null', 'liniendaten', 'fernwarmeversorgung', 'stzh', 'fernwarme', 'geoportal', 'warmeversorgung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'kalteversorgung', 'energieplanung', 'polygondaten', 'energieversorgung', 'erneuerbar-heizen', 'geodaten', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-22T01:10:03.793883`
