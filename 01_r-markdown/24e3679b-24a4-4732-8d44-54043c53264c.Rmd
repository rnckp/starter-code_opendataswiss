...
- **Keywords.de** `['liniendaten', 'kehrichtheizkraftwerk', 'geoportal', 'fernwarme', 'energieplankarte', 'energieplanung', 'erneuerbar-heizen', 'warmeversorgung', 'geodaten', 'klarwerk', 'fernwarmeversorgung', 'punktdaten', 'netto-null', 'heizen', 'stzh', 'holzheizkraftwerk', 'vektordaten', 'kalteversorgung', 'energieversorgung', 'energie', 'polygondaten', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-16T01:18:11.770708`
