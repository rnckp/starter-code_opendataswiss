...
- **Keywords.de** `['warmeversorgung', 'geodaten', 'liniendaten', 'fernwarme', 'fernwarmeversorgung', 'punktdaten', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'netto-null', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'energie', 'heizen', 'stzh', 'polygondaten', 'vektordaten', 'energieversorgung', 'energieplanung', 'kalteversorgung', 'geoportal', 'kehrichtheizkraftwerk', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-23T01:17:57.881808`
