...
- **Keywords.de** `['netto-null', 'liniendaten', 'warmeversorgung', 'energieplanung', 'kalteversorgung', 'polygondaten', 'energie', 'erneuerbar-heizen', 'stzh', 'geodaten', 'geoportal', 'heizen', 'kehrichtheizkraftwerk', 'punktdaten', 'energieversorgung', 'holzheizkraftwerk', 'energieplankarte', 'fernwarme', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'leitungsgebundene-energieversorgung', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-18T01:22:00.404234`
