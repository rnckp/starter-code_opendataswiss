...
- **Keywords.de** `['stzh', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'erneuerbar-heizen', 'fernwarme', 'energieplankarte', 'punktdaten', 'vektordaten', 'fernwarmeversorgung', 'energie', 'energieversorgung', 'kehrichtheizkraftwerk', 'geodaten', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'klarwerk', 'warmeversorgung', 'netto-null', 'liniendaten', 'polygondaten', 'heizen', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-01T01:30:50.805164`
