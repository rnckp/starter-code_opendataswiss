...
- **Keywords.de** `['netto-null', 'energieversorgung', 'fernwarmeversorgung', 'vektordaten', 'geoportal', 'kalteversorgung', 'warmeversorgung', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'liniendaten', 'stzh', 'erneuerbar-heizen', 'fernwarme', 'punktdaten', 'energie', 'kehrichtheizkraftwerk', 'energieplankarte', 'heizen', 'klarwerk', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-11-02T02:46:26.269528`
