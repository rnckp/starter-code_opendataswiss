...
- **Keywords.de** `['geodaten', 'fernwarme', 'stzh', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'leitungsgebundene-energieversorgung', 'klarwerk', 'energie', 'erneuerbar-heizen', 'warmeversorgung', 'vektordaten', 'heizen', 'energieplanung', 'geoportal', 'energieversorgung', 'energieplankarte', 'punktdaten', 'polygondaten', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'kalteversorgung', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-10T00:59:05.064411`
