...
- **Keywords.de** `['holzheizkraftwerk', 'netto-null', 'warmeversorgung', 'fernwarme', 'leitungsgebundene-energieversorgung', 'heizen', 'energieversorgung', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'energie', 'geodaten', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'punktdaten', 'energieplanung', 'vektordaten', 'liniendaten', 'kalteversorgung', 'klarwerk', 'geoportal', 'erneuerbar-heizen', 'stzh', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-05T01:12:00.856242`
