...
- **Keywords.de** `['erneuerbar-heizen', 'warmeversorgung', 'energieplankarte', 'energie', 'geoportal', 'punktdaten', 'leitungsgebundene-energieversorgung', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'kehrichtheizkraftwerk', 'energieplanung', 'liniendaten', 'holzheizkraftwerk', 'energieversorgung', 'fernwarmeversorgung', 'heizen', 'kalteversorgung', 'polygondaten', 'stzh', 'fernwarme', 'klarwerk', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-17T01:43:38.229058`
