...
- **Keywords.de** `['kehrichtheizkraftwerk', 'energieplanung', 'erneuerbar-heizen', 'heizen', 'vektordaten', 'energieversorgung', 'holzheizkraftwerk', 'polygondaten', 'klarwerk', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'energie', 'geoportal', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'stzh', 'fernwarmeversorgung', 'liniendaten', 'fernwarme', 'punktdaten', 'energieplankarte', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-04T01:43:30.105172`
