...
- **Keywords.de** `['erneuerbar-heizen', 'energie', 'geoportal', 'netto-null', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'stzh', 'fernwarmeversorgung', 'geodaten', 'heizen', 'warmeversorgung', 'energieplankarte', 'polygondaten', 'leitungsgebundene-energieversorgung', 'klarwerk', 'vektordaten', 'liniendaten', 'kalteversorgung', 'energieplanung', 'fernwarme', 'energieversorgung', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-23T01:15:48.680216`
