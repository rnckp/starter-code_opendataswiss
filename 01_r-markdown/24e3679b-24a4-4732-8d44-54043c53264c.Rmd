...
- **Keywords.de** `['kalteversorgung', 'erneuerbar-heizen', 'liniendaten', 'klarwerk', 'heizen', 'energieplanung', 'energie', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'vektordaten', 'punktdaten', 'netto-null', 'warmeversorgung', 'polygondaten', 'fernwarme', 'geodaten', 'geoportal', 'stzh', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-23T01:20:26.620772`
