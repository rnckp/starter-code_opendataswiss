...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'punktdaten', 'klarwerk', 'geodaten', 'stzh', 'holzheizkraftwerk', 'fernwarme', 'energie', 'warmeversorgung', 'energieplanung', 'kalteversorgung', 'heizen', 'geoportal', 'fernwarmeversorgung', 'erneuerbar-heizen', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'kehrichtheizkraftwerk', 'energieplankarte', 'vektordaten', 'energieversorgung', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-10-08T01:20:12.468707`
