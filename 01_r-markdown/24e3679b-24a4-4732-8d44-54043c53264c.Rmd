...
- **Keywords.de** `['klarwerk', 'energieplanung', 'punktdaten', 'liniendaten', 'energie', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'geoportal', 'leitungsgebundene-energieversorgung', 'stzh', 'polygondaten', 'fernwarmeversorgung', 'geodaten', 'fernwarme', 'warmeversorgung', 'holzheizkraftwerk', 'heizen', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'kalteversorgung', 'netto-null', 'energieplankarte', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-14T01:22:13.066876`
