...
- **Keywords.de** `['geoportal', 'heizen', 'fernwarmeversorgung', 'polygondaten', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'energieplanung', 'energieplankarte', 'geodaten', 'energie', 'warmeversorgung', 'liniendaten', 'klarwerk', 'vektordaten', 'fernwarme', 'punktdaten', 'erneuerbar-heizen', 'netto-null', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-22T01:26:23.935765`
