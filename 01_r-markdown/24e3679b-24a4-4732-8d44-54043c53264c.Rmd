...
- **Keywords.de** `['energieversorgung', 'erneuerbar-heizen', 'fernwarmeversorgung', 'geodaten', 'energieplankarte', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'stzh', 'kehrichtheizkraftwerk', 'energie', 'kalteversorgung', 'vektordaten', 'liniendaten', 'energieplanung', 'warmeversorgung', 'heizen', 'fernwarme', 'polygondaten', 'netto-null', 'holzheizkraftwerk', 'klarwerk', 'geoportal', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-12T01:22:23.558182`
