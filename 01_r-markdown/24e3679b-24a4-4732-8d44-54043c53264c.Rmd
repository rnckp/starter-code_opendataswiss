...
- **Keywords.de** `['energieplanung', 'stzh', 'netto-null', 'polygondaten', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'energieversorgung', 'kehrichtheizkraftwerk', 'klarwerk', 'geodaten', 'fernwarmeversorgung', 'fernwarme', 'vektordaten', 'kalteversorgung', 'holzheizkraftwerk', 'punktdaten', 'liniendaten', 'energie', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-02T01:18:26.867690`
