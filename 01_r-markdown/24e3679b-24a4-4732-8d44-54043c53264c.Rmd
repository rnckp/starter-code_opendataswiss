...
- **Keywords.de** `['heizen', 'punktdaten', 'kalteversorgung', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'kehrichtheizkraftwerk', 'vektordaten', 'fernwarme', 'holzheizkraftwerk', 'energieplankarte', 'warmeversorgung', 'energieversorgung', 'liniendaten', 'geodaten', 'polygondaten', 'geoportal', 'energieplanung', 'energie', 'erneuerbar-heizen', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-25T01:21:57.361815`
