...
- **Keywords.de** `['energieplanung', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'stzh', 'energieversorgung', 'vektordaten', 'geodaten', 'kehrichtheizkraftwerk', 'liniendaten', 'erneuerbar-heizen', 'punktdaten', 'geoportal', 'heizen', 'klarwerk', 'fernwarme', 'polygondaten', 'kalteversorgung', 'energie', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'energieplankarte', 'fernwarmeversorgung', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-01T01:15:45.858308`
