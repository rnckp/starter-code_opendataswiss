...
- **Keywords.de** `['liniendaten', 'energieplanung', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'klarwerk', 'netto-null', 'warmeversorgung', 'geoportal', 'kehrichtheizkraftwerk', 'fernwarme', 'energieversorgung', 'polygondaten', 'kalteversorgung', 'vektordaten', 'erneuerbar-heizen', 'stzh', 'punktdaten', 'energieplankarte', 'heizen', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'geodaten', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-16T01:29:14.480968`
