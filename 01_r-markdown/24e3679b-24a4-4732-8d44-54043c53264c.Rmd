...
- **Keywords.de** `['energieplanung', 'warmeversorgung', 'fernwarme', 'geodaten', 'stzh', 'vektordaten', 'kalteversorgung', 'erneuerbar-heizen', 'energie', 'fernwarmeversorgung', 'heizen', 'energieplankarte', 'kehrichtheizkraftwerk', 'geoportal', 'energieversorgung', 'netto-null', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'leitungsgebundene-energieversorgung', 'punktdaten', 'liniendaten', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-11T01:48:44.833258`
