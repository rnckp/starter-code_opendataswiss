...
- **Keywords.de** `['stzh', 'fernwarmeversorgung', 'heizen', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'energieplanung', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'kalteversorgung', 'warmeversorgung', 'geodaten', 'vektordaten', 'energieplankarte', 'energie', 'netto-null', 'energieversorgung', 'polygondaten', 'fernwarme', 'punktdaten', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-05T01:23:11.253919`
