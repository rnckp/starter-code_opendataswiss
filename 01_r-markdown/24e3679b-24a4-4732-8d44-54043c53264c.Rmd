...
- **Keywords.de** `['punktdaten', 'klarwerk', 'energieversorgung', 'polygondaten', 'warmeversorgung', 'kalteversorgung', 'fernwarme', 'stzh', 'liniendaten', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'vektordaten', 'energieplanung', 'leitungsgebundene-energieversorgung', 'geodaten', 'energieplankarte', 'energie', 'netto-null', 'heizen', 'geoportal', 'fernwarmeversorgung', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-09T01:14:54.976682`
