...
- **Keywords.de** `['liniendaten', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'kehrichtheizkraftwerk', 'netto-null', 'fernwarmeversorgung', 'energieversorgung', 'fernwarme', 'erneuerbar-heizen', 'polygondaten', 'leitungsgebundene-energieversorgung', 'energie', 'punktdaten', 'klarwerk', 'kalteversorgung', 'geodaten', 'energieplanung', 'heizen', 'holzheizkraftwerk', 'geoportal', 'stzh', 'energieplankarte', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-16T01:19:29.859552`
