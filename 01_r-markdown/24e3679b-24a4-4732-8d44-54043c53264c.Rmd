...
- **Keywords.de** `['klarwerk', 'warmeversorgung', 'energieplankarte', 'energieversorgung', 'erneuerbar-heizen', 'fernwarmeversorgung', 'punktdaten', 'energie', 'fernwarme', 'kehrichtheizkraftwerk', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'geoportal', 'energieplanung', 'polygondaten', 'stzh', 'geodaten', 'heizen', 'liniendaten', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-04T01:12:10.776983`
