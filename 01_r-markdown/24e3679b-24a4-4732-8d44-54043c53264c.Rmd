...
- **Keywords.de** `['stzh', 'punktdaten', 'netto-null', 'liniendaten', 'heizen', 'fernwarmeversorgung', 'energieversorgung', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'energieplanung', 'leitungsgebundene-energieversorgung', 'fernwarme', 'warmeversorgung', 'vektordaten', 'geoportal', 'klarwerk', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'polygondaten', 'geodaten', 'energie', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-27T01:21:44.943433`
