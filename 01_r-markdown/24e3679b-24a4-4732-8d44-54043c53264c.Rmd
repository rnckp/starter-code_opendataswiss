...
- **Keywords.de** `['energieversorgung', 'erneuerbar-heizen', 'energieplanung', 'warmeversorgung', 'vektordaten', 'polygondaten', 'energieplankarte', 'punktdaten', 'liniendaten', 'stzh', 'fernwarme', 'kalteversorgung', 'fernwarmeversorgung', 'geoportal', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'klarwerk', 'energie', 'heizen', 'geodaten', 'holzheizkraftwerk', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-26T01:42:17.564425`
