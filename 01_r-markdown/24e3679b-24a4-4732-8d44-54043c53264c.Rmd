...
- **Keywords.de** `['holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'warmeversorgung', 'klarwerk', 'liniendaten', 'energieplanung', 'fernwarmeversorgung', 'kalteversorgung', 'netto-null', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'vektordaten', 'fernwarme', 'stzh', 'punktdaten', 'geodaten', 'geoportal', 'polygondaten', 'energieversorgung', 'energie', 'heizen', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-16T01:09:25.895119`
