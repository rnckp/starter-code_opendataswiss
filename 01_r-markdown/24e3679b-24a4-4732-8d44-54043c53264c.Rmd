...
- **Keywords.de** `['polygondaten', 'stzh', 'energie', 'vektordaten', 'kalteversorgung', 'liniendaten', 'fernwarme', 'warmeversorgung', 'fernwarmeversorgung', 'klarwerk', 'heizen', 'holzheizkraftwerk', 'netto-null', 'geodaten', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'punktdaten', 'kehrichtheizkraftwerk', 'energieplankarte', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-30T01:18:21.023875`
