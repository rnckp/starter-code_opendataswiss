...
- **Keywords.de** `['heizen', 'klarwerk', 'fernwarme', 'liniendaten', 'energie', 'holzheizkraftwerk', 'energieplanung', 'punktdaten', 'fernwarmeversorgung', 'geodaten', 'energieversorgung', 'kalteversorgung', 'geoportal', 'stzh', 'vektordaten', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'kehrichtheizkraftwerk', 'polygondaten', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-19T01:20:53.945361`
