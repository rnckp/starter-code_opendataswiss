...
- **Keywords.de** `['energieversorgung', 'erneuerbar-heizen', 'energieplanung', 'geodaten', 'energie', 'leitungsgebundene-energieversorgung', 'stzh', 'liniendaten', 'heizen', 'warmeversorgung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'kalteversorgung', 'netto-null', 'fernwarme', 'fernwarmeversorgung', 'energieplankarte', 'polygondaten', 'geoportal', 'kehrichtheizkraftwerk', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-21T01:00:40.615706`
