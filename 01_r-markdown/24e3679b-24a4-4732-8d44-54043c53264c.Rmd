...
- **Keywords.de** `['energie', 'vektordaten', 'energieplankarte', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'klarwerk', 'geoportal', 'erneuerbar-heizen', 'energieplanung', 'netto-null', 'kalteversorgung', 'energieversorgung', 'geodaten', 'fernwarme', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'polygondaten', 'holzheizkraftwerk', 'stzh', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'liniendaten', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-09T01:09:23.890688`
