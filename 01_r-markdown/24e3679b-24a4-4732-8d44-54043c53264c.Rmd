...
- **Keywords.de** `['heizen', 'vektordaten', 'leitungsgebundene-energieversorgung', 'stzh', 'geodaten', 'kehrichtheizkraftwerk', 'kalteversorgung', 'energieplanung', 'geoportal', 'erneuerbar-heizen', 'warmeversorgung', 'fernwarme', 'holzheizkraftwerk', 'netto-null', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'energie', 'polygondaten', 'liniendaten', 'energieplankarte', 'energieversorgung', 'punktdaten', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-27T01:38:32.439932`
