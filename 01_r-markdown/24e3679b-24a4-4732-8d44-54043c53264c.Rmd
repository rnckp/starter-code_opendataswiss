...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'energieplankarte', 'klarwerk', 'energieversorgung', 'heizen', 'stzh', 'punktdaten', 'liniendaten', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'warmeversorgung', 'energie', 'geodaten', 'netto-null', 'vektordaten', 'polygondaten', 'leitungsgebundene-energieversorgung', 'geoportal', 'energieplanung', 'fernwarme', 'fernwarmeversorgung', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-10-06T01:15:34.856221`
