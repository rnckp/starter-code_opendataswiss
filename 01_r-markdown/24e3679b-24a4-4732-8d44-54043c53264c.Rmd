...
- **Keywords.de** `['energie', 'kalteversorgung', 'heizen', 'polygondaten', 'netto-null', 'holzheizkraftwerk', 'fernwarme', 'liniendaten', 'warmeversorgung', 'kehrichtheizkraftwerk', 'energieversorgung', 'energieplanung', 'energieplankarte', 'fernwarmeversorgung', 'vektordaten', 'klarwerk', 'geodaten', 'leitungsgebundene-energieversorgung', 'stzh', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-12T01:14:45.448116`
