...
- **Keywords.de** `['klarwerk', 'geoportal', 'leitungsgebundene-energieversorgung', 'liniendaten', 'energieplanung', 'warmeversorgung', 'netto-null', 'kalteversorgung', 'holzheizkraftwerk', 'punktdaten', 'erneuerbar-heizen', 'vektordaten', 'energie', 'energieplankarte', 'fernwarme', 'geodaten', 'kehrichtheizkraftwerk', 'polygondaten', 'stzh', 'heizen', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-21T01:05:32.162974`
