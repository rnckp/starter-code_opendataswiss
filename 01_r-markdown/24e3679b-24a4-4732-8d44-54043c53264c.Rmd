...
- **Keywords.de** `['energie', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'polygondaten', 'stzh', 'energieplanung', 'klarwerk', 'energieplankarte', 'holzheizkraftwerk', 'heizen', 'energieversorgung', 'warmeversorgung', 'geodaten', 'vektordaten', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'liniendaten', 'kalteversorgung', 'fernwarme', 'fernwarmeversorgung', 'geoportal', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-01-28T01:46:11.301308`
