...
- **Keywords.de** `['fernwarmeversorgung', 'heizen', 'energie', 'polygondaten', 'energieplankarte', 'stzh', 'warmeversorgung', 'kalteversorgung', 'holzheizkraftwerk', 'liniendaten', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'netto-null', 'energieversorgung', 'geoportal', 'energieplanung', 'geodaten', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'fernwarme', 'leitungsgebundene-energieversorgung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-26T01:18:02.146744`
