...
- **Keywords.de** `['polygondaten', 'energieplankarte', 'energieplanung', 'vektordaten', 'leitungsgebundene-energieversorgung', 'liniendaten', 'energieversorgung', 'klarwerk', 'geodaten', 'erneuerbar-heizen', 'heizen', 'warmeversorgung', 'fernwarme', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'stzh', 'fernwarmeversorgung', 'energie', 'netto-null', 'punktdaten', 'geoportal', 'kehrichtheizkraftwerk', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-20T01:14:23.252096`
