...
- **Keywords.de** `['fernwarme', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'polygondaten', 'holzheizkraftwerk', 'geoportal', 'energie', 'heizen', 'erneuerbar-heizen', 'warmeversorgung', 'geodaten', 'leitungsgebundene-energieversorgung', 'punktdaten', 'liniendaten', 'stzh', 'klarwerk', 'kalteversorgung', 'vektordaten', 'kehrichtheizkraftwerk', 'netto-null', 'energieplanung', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-25T01:20:57.755066`
