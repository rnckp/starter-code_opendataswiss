...
- **Keywords.de** `['stzh', 'energie', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'holzheizkraftwerk', 'vektordaten', 'geodaten', 'punktdaten', 'heizen', 'geoportal', 'energieplanung', 'kehrichtheizkraftwerk', 'polygondaten', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'warmeversorgung', 'fernwarmeversorgung', 'erneuerbar-heizen', 'fernwarme', 'energieplankarte', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-23T01:16:56.628519`
