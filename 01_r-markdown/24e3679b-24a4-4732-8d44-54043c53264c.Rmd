...
- **Keywords.de** `['liniendaten', 'klarwerk', 'energieplanung', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'energie', 'fernwarmeversorgung', 'heizen', 'polygondaten', 'geoportal', 'punktdaten', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'stzh', 'vektordaten', 'geodaten', 'netto-null', 'energieversorgung', 'kehrichtheizkraftwerk', 'kalteversorgung', 'holzheizkraftwerk', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-10T01:08:37.803114`
