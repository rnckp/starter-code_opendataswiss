...
- **Keywords.de** `['kalteversorgung', 'holzheizkraftwerk', 'warmeversorgung', 'energieplanung', 'energieversorgung', 'klarwerk', 'erneuerbar-heizen', 'energieplankarte', 'geodaten', 'geoportal', 'kehrichtheizkraftwerk', 'punktdaten', 'fernwarmeversorgung', 'liniendaten', 'vektordaten', 'leitungsgebundene-energieversorgung', 'energie', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'netto-null', 'fernwarme', 'stzh', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-28T01:50:03.966102`
