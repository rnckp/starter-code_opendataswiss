...
- **Keywords.de** `['kehrichtheizkraftwerk', 'erneuerbar-heizen', 'vektordaten', 'energie', 'stzh', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'energieversorgung', 'fernwarme', 'klarwerk', 'heizen', 'energieplanung', 'leitungsgebundene-energieversorgung', 'netto-null', 'energieplankarte', 'holzheizkraftwerk', 'warmeversorgung', 'kalteversorgung', 'geoportal', 'punktdaten', 'geodaten', 'liniendaten', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-01T01:08:44.802083`
