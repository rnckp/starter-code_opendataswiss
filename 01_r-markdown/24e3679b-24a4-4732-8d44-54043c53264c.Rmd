...
- **Keywords.de** `['kalteversorgung', 'energie', 'fernwarmeversorgung', 'netto-null', 'punktdaten', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'liniendaten', 'geodaten', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energieplankarte', 'energieversorgung', 'kehrichtheizkraftwerk', 'energieplanung', 'stzh', 'klarwerk', 'vektordaten', 'heizen', 'polygondaten', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-20T01:13:37.524212`
