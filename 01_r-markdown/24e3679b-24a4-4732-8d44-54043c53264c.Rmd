...
- **Keywords.de** `['liniendaten', 'geoportal', 'energieplanung', 'geodaten', 'fernwarmeversorgung', 'klarwerk', 'stzh', 'netto-null', 'kehrichtheizkraftwerk', 'punktdaten', 'energie', 'polygondaten', 'energieplankarte', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'heizen', 'warmeversorgung', 'erneuerbar-heizen', 'kalteversorgung', 'fernwarme', 'vektordaten', 'energieversorgung', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-28T01:17:44.010050`
