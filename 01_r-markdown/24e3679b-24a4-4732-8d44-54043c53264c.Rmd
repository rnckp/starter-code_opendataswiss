...
- **Keywords.de** `['punktdaten', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'stzh', 'polygondaten', 'fernwarme', 'holzheizkraftwerk', 'warmeversorgung', 'kehrichtheizkraftwerk', 'geoportal', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'energieversorgung', 'heizen', 'vektordaten', 'energie', 'energieplankarte', 'netto-null', 'klarwerk', 'energieplanung', 'liniendaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-19T01:33:54.591184`
