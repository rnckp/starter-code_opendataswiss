...
- **Keywords.de** `['geoportal', 'warmeversorgung', 'energie', 'energieversorgung', 'klarwerk', 'erneuerbar-heizen', 'fernwarmeversorgung', 'polygondaten', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energieplanung', 'stzh', 'kalteversorgung', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'punktdaten', 'vektordaten', 'netto-null', 'energieplankarte', 'liniendaten', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-09T01:17:50.828329`
