...
- **Keywords.de** `['erneuerbar-heizen', 'energieversorgung', 'liniendaten', 'warmeversorgung', 'fernwarme', 'heizen', 'stzh', 'fernwarmeversorgung', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'energie', 'vektordaten', 'punktdaten', 'netto-null', 'klarwerk', 'kehrichtheizkraftwerk', 'energieplanung', 'geodaten', 'polygondaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-07T01:05:15.926263`
