...
- **Keywords.de** `['klarwerk', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'stzh', 'erneuerbar-heizen', 'fernwarmeversorgung', 'kalteversorgung', 'punktdaten', 'fernwarme', 'energieversorgung', 'polygondaten', 'geodaten', 'netto-null', 'holzheizkraftwerk', 'vektordaten', 'heizen', 'kehrichtheizkraftwerk', 'energie', 'leitungsgebundene-energieversorgung', 'liniendaten', 'energieplankarte', 'energieplanung', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-29T02:13:00.164032`
