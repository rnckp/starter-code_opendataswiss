...
- **Keywords.de** `['geoportal', 'energieplankarte', 'kalteversorgung', 'netto-null', 'geodaten', 'energieplanung', 'holzheizkraftwerk', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'punktdaten', 'warmeversorgung', 'energieversorgung', 'klarwerk', 'fernwarme', 'vektordaten', 'fernwarmeversorgung', 'polygondaten', 'heizen', 'energie', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'stzh', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-16T01:03:25.884782`
