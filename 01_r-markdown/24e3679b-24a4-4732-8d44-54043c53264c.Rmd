...
- **Keywords.de** `['holzheizkraftwerk', 'kehrichtheizkraftwerk', 'stzh', 'netto-null', 'warmeversorgung', 'liniendaten', 'geoportal', 'heizen', 'erneuerbar-heizen', 'polygondaten', 'punktdaten', 'energieversorgung', 'klarwerk', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energie', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'vektordaten', 'energieplanung', 'energieplankarte', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-04T01:16:02.331186`
