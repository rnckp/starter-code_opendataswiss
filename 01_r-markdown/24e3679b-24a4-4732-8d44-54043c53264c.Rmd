...
- **Keywords.de** `['geodaten', 'holzheizkraftwerk', 'punktdaten', 'erneuerbar-heizen', 'energieplankarte', 'kehrichtheizkraftwerk', 'energie', 'geoportal', 'liniendaten', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'energieplanung', 'stzh', 'netto-null', 'fernwarmeversorgung', 'klarwerk', 'polygondaten', 'energieversorgung', 'fernwarme', 'heizen', 'leitungsgebundene-energieversorgung', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-23T01:21:10.582884`
