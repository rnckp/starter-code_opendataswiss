...
- **Keywords.de** `['energie', 'warmeversorgung', 'fernwarme', 'energieversorgung', 'kalteversorgung', 'polygondaten', 'netto-null', 'holzheizkraftwerk', 'liniendaten', 'vektordaten', 'heizen', 'klarwerk', 'punktdaten', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'energieplanung', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'leitungsgebundene-energieversorgung', 'geodaten', 'erneuerbar-heizen', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-30T01:23:01.897189`
