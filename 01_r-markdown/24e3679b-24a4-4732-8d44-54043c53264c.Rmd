...
- **Keywords.de** `['erneuerbar-heizen', 'fernwarmeversorgung', 'punktdaten', 'holzheizkraftwerk', 'netto-null', 'geoportal', 'energie', 'stzh', 'liniendaten', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'klarwerk', 'heizen', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'polygondaten', 'vektordaten', 'kehrichtheizkraftwerk', 'geodaten', 'kalteversorgung', 'warmeversorgung', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-02T01:19:48.009316`
