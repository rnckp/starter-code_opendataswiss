...
- **Keywords.de** `['warmeversorgung', 'punktdaten', 'polygondaten', 'heizen', 'geoportal', 'vektordaten', 'holzheizkraftwerk', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'energie', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'stzh', 'netto-null', 'erneuerbar-heizen', 'energieversorgung', 'liniendaten', 'energieplanung', 'energieplankarte', 'klarwerk', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-01T01:09:22.923475`
