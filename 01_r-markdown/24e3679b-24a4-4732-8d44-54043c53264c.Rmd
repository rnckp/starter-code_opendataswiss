...
- **Keywords.de** `['netto-null', 'heizen', 'geodaten', 'vektordaten', 'polygondaten', 'fernwarmeversorgung', 'klarwerk', 'warmeversorgung', 'erneuerbar-heizen', 'liniendaten', 'kehrichtheizkraftwerk', 'geoportal', 'punktdaten', 'energieversorgung', 'kalteversorgung', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'stzh', 'energieplankarte', 'energie', 'energieplanung', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-01-24T01:08:06.521943`
