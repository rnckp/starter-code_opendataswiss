...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'heizen', 'warmeversorgung', 'polygondaten', 'kalteversorgung', 'holzheizkraftwerk', 'energieplanung', 'stzh', 'energie', 'energieversorgung', 'erneuerbar-heizen', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'geoportal', 'fernwarme', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'punktdaten', 'klarwerk', 'netto-null', 'vektordaten', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-19T01:25:24.843548`
