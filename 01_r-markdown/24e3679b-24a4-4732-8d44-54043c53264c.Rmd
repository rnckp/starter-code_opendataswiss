...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'energie', 'energieversorgung', 'vektordaten', 'kehrichtheizkraftwerk', 'warmeversorgung', 'kalteversorgung', 'stzh', 'liniendaten', 'energieplanung', 'polygondaten', 'energieplankarte', 'klarwerk', 'punktdaten', 'netto-null', 'holzheizkraftwerk', 'geoportal', 'fernwarmeversorgung', 'fernwarme', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'geodaten', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-10T01:09:56.005990`
