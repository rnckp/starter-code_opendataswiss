...
- **Keywords.de** `['netto-null', 'geoportal', 'energieversorgung', 'punktdaten', 'energieplanung', 'heizen', 'kalteversorgung', 'stzh', 'liniendaten', 'fernwarme', 'holzheizkraftwerk', 'warmeversorgung', 'energieplankarte', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'klarwerk', 'energie', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'polygondaten', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-07T01:01:35.916183`
