...
- **Keywords.de** `['kehrichtheizkraftwerk', 'liniendaten', 'stzh', 'energieplanung', 'erneuerbar-heizen', 'energie', 'energieplankarte', 'fernwarme', 'polygondaten', 'klarwerk', 'netto-null', 'vektordaten', 'geoportal', 'heizen', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'geodaten', 'fernwarmeversorgung', 'punktdaten', 'warmeversorgung', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-27T01:30:02.168168`
