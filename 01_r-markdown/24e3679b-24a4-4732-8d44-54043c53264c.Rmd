...
- **Keywords.de** `['geodaten', 'erneuerbar-heizen', 'punktdaten', 'energieplanung', 'fernwarmeversorgung', 'heizen', 'fernwarme', 'kehrichtheizkraftwerk', 'energieplankarte', 'liniendaten', 'stzh', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'energie', 'klarwerk', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'vektordaten', 'energieversorgung', 'netto-null', 'holzheizkraftwerk', 'geoportal', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-05T01:28:07.046377`
