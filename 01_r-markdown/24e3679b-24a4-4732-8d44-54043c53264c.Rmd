...
- **Keywords.de** `['liniendaten', 'klarwerk', 'energieplanung', 'geodaten', 'energieplankarte', 'erneuerbar-heizen', 'heizen', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'fernwarme', 'geoportal', 'netto-null', 'kalteversorgung', 'energie', 'punktdaten', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'stzh', 'holzheizkraftwerk', 'warmeversorgung', 'vektordaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-13T01:08:50.830262`
