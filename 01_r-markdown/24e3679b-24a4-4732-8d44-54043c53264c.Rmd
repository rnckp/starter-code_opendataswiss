...
- **Keywords.de** `['erneuerbar-heizen', 'geodaten', 'energieplanung', 'kehrichtheizkraftwerk', 'heizen', 'vektordaten', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'energieplankarte', 'holzheizkraftwerk', 'fernwarmeversorgung', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'fernwarme', 'punktdaten', 'stzh', 'kalteversorgung', 'liniendaten', 'geoportal', 'polygondaten', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-06T01:26:35.470295`
