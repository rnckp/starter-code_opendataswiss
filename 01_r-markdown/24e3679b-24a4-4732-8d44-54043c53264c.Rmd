...
- **Keywords.de** `['geoportal', 'fernwarme', 'energieplanung', 'punktdaten', 'heizen', 'kalteversorgung', 'fernwarmeversorgung', 'stzh', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'geodaten', 'holzheizkraftwerk', 'netto-null', 'energieplankarte', 'energie', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'erneuerbar-heizen', 'klarwerk', 'energieversorgung', 'vektordaten', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-01-25T01:13:57.147233`
