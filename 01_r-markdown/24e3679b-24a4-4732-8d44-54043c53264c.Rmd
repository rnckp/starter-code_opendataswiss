...
- **Keywords.de** `['geodaten', 'stzh', 'heizen', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'vektordaten', 'geoportal', 'netto-null', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'polygondaten', 'fernwarmeversorgung', 'warmeversorgung', 'klarwerk', 'energie', 'holzheizkraftwerk', 'fernwarme', 'energieplanung', 'liniendaten', 'punktdaten', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-07T01:30:11.734717`
