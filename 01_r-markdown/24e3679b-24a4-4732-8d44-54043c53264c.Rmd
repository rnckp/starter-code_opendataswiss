...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'stzh', 'netto-null', 'heizen', 'fernwarmeversorgung', 'energieplankarte', 'energieversorgung', 'fernwarme', 'erneuerbar-heizen', 'geodaten', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'energie', 'warmeversorgung', 'liniendaten', 'polygondaten', 'klarwerk', 'geoportal', 'punktdaten', 'vektordaten', 'kehrichtheizkraftwerk', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-14T01:02:13.177800`
