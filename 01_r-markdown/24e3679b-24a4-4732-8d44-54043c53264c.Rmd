...
- **Keywords.de** `['erneuerbar-heizen', 'geoportal', 'energieplankarte', 'fernwarmeversorgung', 'netto-null', 'energieplanung', 'kehrichtheizkraftwerk', 'liniendaten', 'warmeversorgung', 'heizen', 'vektordaten', 'stzh', 'geodaten', 'punktdaten', 'klarwerk', 'energieversorgung', 'holzheizkraftwerk', 'polygondaten', 'fernwarme', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-10T01:10:00.548374`
