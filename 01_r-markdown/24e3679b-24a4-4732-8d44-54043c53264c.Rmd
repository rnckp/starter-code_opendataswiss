...
- **Keywords.de** `['fernwarme', 'energieversorgung', 'holzheizkraftwerk', 'energieplanung', 'netto-null', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'kalteversorgung', 'klarwerk', 'liniendaten', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'stzh', 'heizen', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'vektordaten', 'geoportal', 'energie', 'punktdaten', 'geodaten', 'fernwarmeversorgung', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-01T02:19:03.580116`
