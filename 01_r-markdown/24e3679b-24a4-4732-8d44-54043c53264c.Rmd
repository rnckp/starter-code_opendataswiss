...
- **Keywords.de** `['geodaten', 'stzh', 'holzheizkraftwerk', 'erneuerbar-heizen', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'energie', 'kehrichtheizkraftwerk', 'klarwerk', 'kalteversorgung', 'geoportal', 'energieversorgung', 'energieplankarte', 'polygondaten', 'warmeversorgung', 'punktdaten', 'heizen', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energieplanung', 'vektordaten', 'netto-null', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-10-25T01:09:00.989504`
