...
- **Keywords.de** `['kehrichtheizkraftwerk', 'energieversorgung', 'erneuerbar-heizen', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'leitungsgebundene-energieversorgung', 'polygondaten', 'netto-null', 'energieplanung', 'klarwerk', 'energie', 'heizen', 'fernwarme', 'punktdaten', 'kalteversorgung', 'stzh', 'fernwarmeversorgung', 'liniendaten', 'energieplankarte', 'vektordaten', 'holzheizkraftwerk', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-19T01:49:36.672896`
