...
- **Keywords.de** `['kalteversorgung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'leitungsgebundene-energieversorgung', 'geoportal', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'energie', 'warmeversorgung', 'stzh', 'netto-null', 'heizen', 'energieplankarte', 'vektordaten', 'fernwarme', 'punktdaten', 'liniendaten', 'erneuerbar-heizen', 'klarwerk', 'geodaten', 'energieversorgung', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-09T01:25:14.042137`
