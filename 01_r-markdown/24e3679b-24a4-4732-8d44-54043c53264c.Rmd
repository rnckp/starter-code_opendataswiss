...
- **Keywords.de** `['polygondaten', 'heizen', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'geoportal', 'stzh', 'energie', 'energieplankarte', 'fernwarmeversorgung', 'klarwerk', 'kalteversorgung', 'punktdaten', 'fernwarme', 'energieversorgung', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'erneuerbar-heizen', 'energieplanung', 'geodaten', 'netto-null', 'kehrichtheizkraftwerk', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-03T01:17:42.652931`
