...
- **Keywords.de** `['kehrichtheizkraftwerk', 'polygondaten', 'energieplankarte', 'energie', 'fernwarme', 'stzh', 'energieversorgung', 'liniendaten', 'vektordaten', 'warmeversorgung', 'geoportal', 'punktdaten', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'heizen', 'energieplanung', 'erneuerbar-heizen', 'geodaten', 'kalteversorgung', 'netto-null', 'fernwarmeversorgung', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-26T01:14:45.611899`
