...
- **Keywords.de** `['kalteversorgung', 'warmeversorgung', 'heizen', 'leitungsgebundene-energieversorgung', 'fernwarme', 'liniendaten', 'netto-null', 'vektordaten', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'energieplankarte', 'fernwarmeversorgung', 'stzh', 'klarwerk', 'erneuerbar-heizen', 'geodaten', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'energieversorgung', 'energieplanung', 'energie', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-12T01:59:04.555277`
