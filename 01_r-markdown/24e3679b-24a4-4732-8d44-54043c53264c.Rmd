...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'fernwarmeversorgung', 'liniendaten', 'energie', 'stzh', 'geodaten', 'polygondaten', 'energieversorgung', 'kalteversorgung', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'geoportal', 'punktdaten', 'fernwarme', 'energieplankarte', 'netto-null', 'holzheizkraftwerk', 'energieplanung', 'vektordaten', 'heizen', 'klarwerk', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-22T01:08:08.813709`
