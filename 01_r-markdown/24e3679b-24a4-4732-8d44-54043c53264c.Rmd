...
- **Keywords.de** `['energieversorgung', 'stzh', 'energie', 'netto-null', 'heizen', 'vektordaten', 'liniendaten', 'polygondaten', 'erneuerbar-heizen', 'holzheizkraftwerk', 'energieplankarte', 'kalteversorgung', 'punktdaten', 'leitungsgebundene-energieversorgung', 'geoportal', 'fernwarmeversorgung', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'geodaten', 'fernwarme', 'energieplanung', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-18T01:13:34.977435`
