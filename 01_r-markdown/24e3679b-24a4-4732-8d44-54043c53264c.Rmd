...
- **Keywords.de** `['fernwarmeversorgung', 'energieplanung', 'kehrichtheizkraftwerk', 'fernwarme', 'holzheizkraftwerk', 'kalteversorgung', 'energie', 'polygondaten', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'stzh', 'heizen', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'energieplankarte', 'erneuerbar-heizen', 'energieversorgung', 'liniendaten', 'klarwerk', 'vektordaten', 'punktdaten', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-17T01:13:55.001834`
