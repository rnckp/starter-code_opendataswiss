...
- **Keywords.de** `['klarwerk', 'energieplankarte', 'kalteversorgung', 'geodaten', 'netto-null', 'liniendaten', 'kehrichtheizkraftwerk', 'polygondaten', 'energieversorgung', 'fernwarme', 'energie', 'warmeversorgung', 'vektordaten', 'holzheizkraftwerk', 'geoportal', 'fernwarmeversorgung', 'energieplanung', 'punktdaten', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'stzh', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-01T01:33:13.010977`
