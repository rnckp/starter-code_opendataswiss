...
- **Keywords.de** `['liniendaten', 'warmeversorgung', 'energieplanung', 'fernwarmeversorgung', 'geoportal', 'netto-null', 'energie', 'geodaten', 'holzheizkraftwerk', 'erneuerbar-heizen', 'punktdaten', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'kehrichtheizkraftwerk', 'stzh', 'klarwerk', 'energieplankarte', 'fernwarme', 'vektordaten', 'polygondaten', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-01-20T01:17:56.944833`
