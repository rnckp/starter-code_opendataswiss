...
- **Keywords.de** `['liniendaten', 'leitungsgebundene-energieversorgung', 'punktdaten', 'energieplanung', 'kehrichtheizkraftwerk', 'erneuerbar-heizen', 'energieversorgung', 'fernwarmeversorgung', 'klarwerk', 'kalteversorgung', 'fernwarme', 'geodaten', 'stzh', 'heizen', 'energieplankarte', 'netto-null', 'polygondaten', 'holzheizkraftwerk', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'geoportal', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-03T01:17:43.654965`
