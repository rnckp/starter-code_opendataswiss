...
- **Keywords.de** `['erneuerbar-heizen', 'geodaten', 'energieplankarte', 'stzh', 'punktdaten', 'energieplanung', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'energie', 'vektordaten', 'holzheizkraftwerk', 'liniendaten', 'klarwerk', 'heizen', 'polygondaten', 'netto-null', 'geoportal', 'kehrichtheizkraftwerk', 'energieversorgung', 'fernwarmeversorgung', 'fernwarme', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-10-04T01:33:00.642234`
