...
- **Keywords.de** `['kalteversorgung', 'netto-null', 'holzheizkraftwerk', 'erneuerbar-heizen', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'energieplankarte', 'vektordaten', 'punktdaten', 'geodaten', 'energie', 'geoportal', 'warmeversorgung', 'kehrichtheizkraftwerk', 'stzh', 'energieversorgung', 'energieplanung', 'heizen', 'fernwarmeversorgung', 'polygondaten', 'liniendaten', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-10-26T01:23:25.128283`
