...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'geoportal', 'liniendaten', 'fernwarmeversorgung', 'kalteversorgung', 'warmeversorgung', 'energie', 'fernwarme', 'erneuerbar-heizen', 'holzheizkraftwerk', 'geodaten', 'polygondaten', 'punktdaten', 'kehrichtheizkraftwerk', 'heizen', 'energieversorgung', 'energieplanung', 'energieplankarte', 'stzh', 'vektordaten', 'klarwerk', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-27T01:18:00.428890`
