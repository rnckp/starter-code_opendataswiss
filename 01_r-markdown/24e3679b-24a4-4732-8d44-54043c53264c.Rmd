...
- **Keywords.de** `['klarwerk', 'fernwarme', 'geodaten', 'kalteversorgung', 'erneuerbar-heizen', 'energieversorgung', 'polygondaten', 'vektordaten', 'punktdaten', 'netto-null', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'energie', 'liniendaten', 'geoportal', 'holzheizkraftwerk', 'heizen', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'stzh', 'energieplankarte', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-03T01:20:44.859169`
