...
- **Keywords.de** `['kalteversorgung', 'energieplanung', 'liniendaten', 'fernwarme', 'heizen', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'geodaten', 'erneuerbar-heizen', 'holzheizkraftwerk', 'geoportal', 'warmeversorgung', 'energie', 'polygondaten', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'punktdaten', 'netto-null', 'stzh', 'energieplankarte', 'klarwerk', 'vektordaten', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-22T02:34:28.795753`
