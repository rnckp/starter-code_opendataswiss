...
- **Keywords.de** `['energie', 'energieplanung', 'liniendaten', 'energieplankarte', 'stzh', 'netto-null', 'klarwerk', 'kalteversorgung', 'geodaten', 'kehrichtheizkraftwerk', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'geoportal', 'energieversorgung', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'punktdaten', 'heizen', 'holzheizkraftwerk', 'erneuerbar-heizen', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-07T01:10:27.234245`
