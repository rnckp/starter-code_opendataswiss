...
- **Keywords.de** `['netto-null', 'stzh', 'polygondaten', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'geoportal', 'energie', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'energieversorgung', 'geodaten', 'energieplanung', 'erneuerbar-heizen', 'liniendaten', 'heizen', 'holzheizkraftwerk', 'kalteversorgung', 'fernwarmeversorgung', 'vektordaten', 'klarwerk', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-27T01:05:49.881654`
