...
- **Keywords.de** `['geoportal', 'geodaten', 'energieplanung', 'fernwarmeversorgung', 'liniendaten', 'leitungsgebundene-energieversorgung', 'polygondaten', 'erneuerbar-heizen', 'vektordaten', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'netto-null', 'kalteversorgung', 'energie', 'kehrichtheizkraftwerk', 'punktdaten', 'holzheizkraftwerk', 'energieversorgung', 'stzh', 'energieplankarte', 'klarwerk', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-13T00:58:31.150574`
