...
- **Keywords.de** `['klarwerk', 'kalteversorgung', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'liniendaten', 'energieversorgung', 'fernwarmeversorgung', 'punktdaten', 'erneuerbar-heizen', 'vektordaten', 'polygondaten', 'energie', 'stzh', 'kehrichtheizkraftwerk', 'energieplanung', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'heizen', 'geodaten', 'geoportal', 'fernwarme', 'holzheizkraftwerk', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-13T01:22:20.793134`
