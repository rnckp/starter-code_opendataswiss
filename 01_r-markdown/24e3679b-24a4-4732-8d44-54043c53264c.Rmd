...
- **Keywords.de** `['fernwarme', 'energie', 'energieplanung', 'energieversorgung', 'stzh', 'holzheizkraftwerk', 'netto-null', 'kalteversorgung', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'geodaten', 'punktdaten', 'liniendaten', 'klarwerk', 'energieplankarte', 'warmeversorgung', 'kehrichtheizkraftwerk', 'heizen', 'fernwarmeversorgung', 'polygondaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-03T01:16:01.512370`
