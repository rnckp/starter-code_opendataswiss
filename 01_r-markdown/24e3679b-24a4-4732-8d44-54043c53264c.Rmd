...
- **Keywords.de** `['fernwarme', 'klarwerk', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'energie', 'vektordaten', 'energieplanung', 'fernwarmeversorgung', 'punktdaten', 'polygondaten', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'erneuerbar-heizen', 'energieversorgung', 'stzh', 'kalteversorgung', 'heizen', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'geodaten', 'geoportal', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-01-17T00:55:37.646802`
