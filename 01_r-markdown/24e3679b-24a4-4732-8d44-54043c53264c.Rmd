...
- **Keywords.de** `['warmeversorgung', 'heizen', 'netto-null', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'fernwarme', 'polygondaten', 'energieversorgung', 'energieplanung', 'geoportal', 'punktdaten', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'klarwerk', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'stzh', 'energieplankarte', 'vektordaten', 'energie', 'holzheizkraftwerk', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-23T00:56:43.554287`
