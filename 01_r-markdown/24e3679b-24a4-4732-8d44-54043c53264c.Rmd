...
- **Keywords.de** `['geoportal', 'energie', 'fernwarmeversorgung', 'holzheizkraftwerk', 'warmeversorgung', 'punktdaten', 'kehrichtheizkraftwerk', 'energieplankarte', 'kalteversorgung', 'fernwarme', 'energieplanung', 'netto-null', 'stzh', 'erneuerbar-heizen', 'heizen', 'geodaten', 'liniendaten', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-23T01:14:11.838137`
