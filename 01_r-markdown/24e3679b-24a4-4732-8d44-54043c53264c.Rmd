...
- **Keywords.de** `['fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'geodaten', 'polygondaten', 'stzh', 'holzheizkraftwerk', 'liniendaten', 'punktdaten', 'energieplankarte', 'vektordaten', 'kehrichtheizkraftwerk', 'energieplanung', 'energieversorgung', 'heizen', 'energie', 'klarwerk', 'erneuerbar-heizen', 'geoportal', 'kalteversorgung', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-23T01:13:08.899789`
