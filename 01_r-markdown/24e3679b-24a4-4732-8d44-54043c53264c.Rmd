...
- **Keywords.de** `['liniendaten', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'polygondaten', 'stzh', 'klarwerk', 'geodaten', 'vektordaten', 'energieversorgung', 'heizen', 'energie-aus-gereinigtem-abwasser', 'energie', 'energieplanung', 'kehrichtheizkraftwerk', 'netto-null', 'punktdaten', 'erneuerbar-heizen', 'kalteversorgung', 'holzheizkraftwerk', 'energieplankarte', 'fernwarme', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-05T01:19:17.708558`
