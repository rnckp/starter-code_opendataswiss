...
- **Keywords.de** `['polygondaten', 'punktdaten', 'energie', 'liniendaten', 'fernwarme', 'klarwerk', 'stzh', 'geodaten', 'netto-null', 'kalteversorgung', 'vektordaten', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'energieplanung', 'erneuerbar-heizen', 'geoportal', 'energieversorgung', 'heizen', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-06-29T01:02:59.497105`
