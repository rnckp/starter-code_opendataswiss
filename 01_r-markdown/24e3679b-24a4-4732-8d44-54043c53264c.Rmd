...
- **Keywords.de** `['polygondaten', 'stzh', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energieplanung', 'geodaten', 'netto-null', 'liniendaten', 'kalteversorgung', 'klarwerk', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'kehrichtheizkraftwerk', 'heizen', 'warmeversorgung', 'energie', 'erneuerbar-heizen', 'energieplankarte', 'vektordaten', 'fernwarmeversorgung', 'geoportal', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-10-03T01:16:50.938273`
