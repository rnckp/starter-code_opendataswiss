...
- **Keywords.de** `['polygondaten', 'vektordaten', 'punktdaten', 'energieplankarte', 'stzh', 'heizen', 'energie', 'liniendaten', 'geodaten', 'netto-null', 'fernwarmeversorgung', 'holzheizkraftwerk', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'fernwarme', 'energieversorgung', 'energieplanung', 'kehrichtheizkraftwerk', 'geoportal', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'erneuerbar-heizen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-28T01:05:33.739298`
