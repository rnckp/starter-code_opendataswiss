...
- **Keywords.de** `['punktdaten', 'polygondaten', 'netto-null', 'leitungsgebundene-energieversorgung', 'geodaten', 'stzh', 'kehrichtheizkraftwerk', 'kalteversorgung', 'energieplanung', 'energieversorgung', 'fernwarmeversorgung', 'warmeversorgung', 'heizen', 'geoportal', 'holzheizkraftwerk', 'liniendaten', 'klarwerk', 'fernwarme', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'energie', 'erneuerbar-heizen', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-15T01:35:14.082893`
