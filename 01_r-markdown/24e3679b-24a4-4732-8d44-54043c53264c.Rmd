...
- **Keywords.de** `['geodaten', 'liniendaten', 'fernwarmeversorgung', 'energieplanung', 'fernwarme', 'kalteversorgung', 'punktdaten', 'stzh', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'geoportal', 'heizen', 'energieversorgung', 'warmeversorgung', 'klarwerk', 'erneuerbar-heizen', 'energie', 'vektordaten', 'energieplankarte', 'polygondaten', 'netto-null', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-05T01:07:02.845605`
