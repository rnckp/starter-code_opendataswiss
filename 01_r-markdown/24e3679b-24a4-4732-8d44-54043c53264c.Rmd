...
- **Keywords.de** `['klarwerk', 'geoportal', 'energieplankarte', 'netto-null', 'fernwarme', 'polygondaten', 'energie', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'erneuerbar-heizen', 'vektordaten', 'energieplanung', 'heizen', 'punktdaten', 'liniendaten', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'stzh', 'holzheizkraftwerk', 'warmeversorgung', 'energieversorgung', 'kalteversorgung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-02T01:26:53.884881`
