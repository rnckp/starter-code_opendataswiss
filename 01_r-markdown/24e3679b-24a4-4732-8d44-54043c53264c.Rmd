...
- **Keywords.de** `['heizen', 'kalteversorgung', 'energie', 'erneuerbar-heizen', 'stzh', 'fernwarmeversorgung', 'netto-null', 'polygondaten', 'vektordaten', 'punktdaten', 'energieplankarte', 'klarwerk', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'liniendaten', 'geodaten', 'geoportal', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'energieplanung', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-09T00:58:25.916622`
