...
- **Keywords.de** `['heizen', 'leitungsgebundene-energieversorgung', 'polygondaten', 'vektordaten', 'energieplanung', 'energieplankarte', 'warmeversorgung', 'geoportal', 'liniendaten', 'stzh', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'punktdaten', 'netto-null', 'fernwarme', 'fernwarmeversorgung', 'energie', 'holzheizkraftwerk', 'energieversorgung', 'klarwerk', 'erneuerbar-heizen', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-03T02:06:10.270276`
