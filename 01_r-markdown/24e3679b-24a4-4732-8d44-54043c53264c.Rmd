...
- **Keywords.de** `['klarwerk', 'kehrichtheizkraftwerk', 'vektordaten', 'holzheizkraftwerk', 'geodaten', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'energie', 'energieplankarte', 'netto-null', 'geoportal', 'energieversorgung', 'polygondaten', 'punktdaten', 'energieplanung', 'stzh', 'erneuerbar-heizen', 'liniendaten', 'heizen', 'warmeversorgung', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-02T01:22:17.409680`
