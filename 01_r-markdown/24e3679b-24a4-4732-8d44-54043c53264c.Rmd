...
- **Keywords.de** `['geodaten', 'vektordaten', 'heizen', 'energieplanung', 'erneuerbar-heizen', 'geoportal', 'punktdaten', 'stzh', 'energie', 'liniendaten', 'polygondaten', 'fernwarme', 'energieversorgung', 'kalteversorgung', 'warmeversorgung', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'netto-null', 'kehrichtheizkraftwerk', 'klarwerk', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-03T01:17:01.519941`
