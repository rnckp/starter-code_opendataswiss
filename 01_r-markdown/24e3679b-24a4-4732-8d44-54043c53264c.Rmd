...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'energieplanung', 'geodaten', 'fernwarme', 'kalteversorgung', 'vektordaten', 'punktdaten', 'energie', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'klarwerk', 'holzheizkraftwerk', 'energieversorgung', 'stzh', 'geoportal', 'polygondaten', 'heizen', 'liniendaten', 'netto-null', 'kehrichtheizkraftwerk', 'energieplankarte', 'warmeversorgung', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-11T01:38:52.649817`
