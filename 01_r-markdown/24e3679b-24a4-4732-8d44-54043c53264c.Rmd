...
- **Keywords.de** `['kehrichtheizkraftwerk', 'punktdaten', 'fernwarmeversorgung', 'kalteversorgung', 'holzheizkraftwerk', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'leitungsgebundene-energieversorgung', 'geoportal', 'erneuerbar-heizen', 'warmeversorgung', 'energie', 'energieversorgung', 'heizen', 'klarwerk', 'stzh', 'liniendaten', 'vektordaten', 'fernwarme', 'energieplankarte', 'netto-null', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-07T01:24:56.845069`
