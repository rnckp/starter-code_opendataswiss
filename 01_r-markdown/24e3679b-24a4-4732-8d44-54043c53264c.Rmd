...
- **Keywords.de** `['energieplanung', 'heizen', 'energieplankarte', 'warmeversorgung', 'geoportal', 'energieversorgung', 'netto-null', 'punktdaten', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'fernwarme', 'energie', 'liniendaten', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'vektordaten', 'erneuerbar-heizen', 'klarwerk', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'stzh', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-02-07T02:04:49.010909`
