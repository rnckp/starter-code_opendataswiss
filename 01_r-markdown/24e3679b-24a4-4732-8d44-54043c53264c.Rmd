...
- **Keywords.de** `['erneuerbar-heizen', 'klarwerk', 'punktdaten', 'energieversorgung', 'vektordaten', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'stzh', 'leitungsgebundene-energieversorgung', 'polygondaten', 'energieplanung', 'heizen', 'kalteversorgung', 'liniendaten', 'fernwarme', 'geoportal', 'warmeversorgung', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'energieplankarte', 'netto-null', 'energie', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-19T01:49:58.284080`
