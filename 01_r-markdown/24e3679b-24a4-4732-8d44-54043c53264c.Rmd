...
- **Keywords.de** `['holzheizkraftwerk', 'fernwarmeversorgung', 'energie', 'netto-null', 'erneuerbar-heizen', 'klarwerk', 'punktdaten', 'stzh', 'energieversorgung', 'heizen', 'geoportal', 'warmeversorgung', 'fernwarme', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'vektordaten', 'energieplankarte', 'polygondaten', 'energieplanung', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-30T01:33:40.344369`
