...
- **Keywords.de** `['heizen', 'polygondaten', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'netto-null', 'energieversorgung', 'punktdaten', 'kalteversorgung', 'fernwarme', 'geodaten', 'erneuerbar-heizen', 'energieplankarte', 'energie', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'liniendaten', 'klarwerk', 'energieplanung', 'vektordaten', 'holzheizkraftwerk', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-01-23T01:03:27.823330`
