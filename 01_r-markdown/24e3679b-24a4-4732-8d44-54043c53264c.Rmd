...
- **Keywords.de** `['kehrichtheizkraftwerk', 'energieversorgung', 'punktdaten', 'stzh', 'fernwarmeversorgung', 'geodaten', 'geoportal', 'fernwarme', 'heizen', 'erneuerbar-heizen', 'energieplanung', 'kalteversorgung', 'holzheizkraftwerk', 'vektordaten', 'netto-null', 'energieplankarte', 'warmeversorgung', 'liniendaten', 'leitungsgebundene-energieversorgung', 'energie', 'polygondaten', 'klarwerk', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-04-04T01:06:24.390810`
