...
- **Keywords.de** `['erneuerbar-heizen', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'warmeversorgung', 'energie', 'energieplanung', 'energieversorgung', 'netto-null', 'heizen', 'holzheizkraftwerk', 'punktdaten', 'polygondaten', 'geoportal', 'leitungsgebundene-energieversorgung', 'vektordaten', 'stzh', 'klarwerk', 'kehrichtheizkraftwerk', 'energieplankarte', 'fernwarmeversorgung', 'fernwarme', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-14T01:18:38.813349`
