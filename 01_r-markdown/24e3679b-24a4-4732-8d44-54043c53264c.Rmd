...
- **Keywords.de** `['geoportal', 'energieplanung', 'netto-null', 'leitungsgebundene-energieversorgung', 'heizen', 'liniendaten', 'warmeversorgung', 'holzheizkraftwerk', 'kalteversorgung', 'kehrichtheizkraftwerk', 'energieplankarte', 'punktdaten', 'stzh', 'erneuerbar-heizen', 'geodaten', 'fernwarmeversorgung', 'polygondaten', 'klarwerk', 'energie', 'vektordaten', 'energieversorgung', 'fernwarme', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-15T01:36:50.777778`
