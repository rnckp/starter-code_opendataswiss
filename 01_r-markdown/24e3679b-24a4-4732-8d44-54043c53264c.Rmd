...
- **Keywords.de** `['kehrichtheizkraftwerk', 'stzh', 'warmeversorgung', 'polygondaten', 'erneuerbar-heizen', 'geoportal', 'klarwerk', 'holzheizkraftwerk', 'geodaten', 'netto-null', 'punktdaten', 'fernwarme', 'vektordaten', 'energieplanung', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'energie', 'liniendaten', 'heizen', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-07-20T02:07:08.686124`
