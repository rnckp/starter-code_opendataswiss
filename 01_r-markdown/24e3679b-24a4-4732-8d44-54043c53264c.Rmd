...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'energieplankarte', 'liniendaten', 'punktdaten', 'leitungsgebundene-energieversorgung', 'netto-null', 'heizen', 'fernwarmeversorgung', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'vektordaten', 'energieversorgung', 'energie', 'warmeversorgung', 'stzh', 'polygondaten', 'fernwarme', 'geodaten', 'geoportal', 'energieplanung', 'holzheizkraftwerk', 'klarwerk', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-13T01:15:04.658819`
