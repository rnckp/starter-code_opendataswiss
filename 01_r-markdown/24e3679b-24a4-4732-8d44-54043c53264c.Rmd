...
- **Keywords.de** `['punktdaten', 'vektordaten', 'erneuerbar-heizen', 'energieplanung', 'warmeversorgung', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'liniendaten', 'stzh', 'kalteversorgung', 'geodaten', 'netto-null', 'klarwerk', 'energieplankarte', 'geoportal', 'polygondaten', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'heizen', 'energie', 'fernwarme', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-03-13T01:05:51.408620`
