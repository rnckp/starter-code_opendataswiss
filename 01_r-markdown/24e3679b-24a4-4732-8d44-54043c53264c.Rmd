...
- **Keywords.de** `['energie', 'klarwerk', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'geoportal', 'energieplankarte', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'holzheizkraftwerk', 'liniendaten', 'stzh', 'fernwarmeversorgung', 'punktdaten', 'vektordaten', 'polygondaten', 'geodaten', 'warmeversorgung', 'heizen', 'fernwarme', 'energieversorgung', 'erneuerbar-heizen', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-09-16T01:18:17.843395`
