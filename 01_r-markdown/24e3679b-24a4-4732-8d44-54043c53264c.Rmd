...
- **Keywords.de** `['geodaten', 'kehrichtheizkraftwerk', 'kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'punktdaten', 'energieversorgung', 'fernwarmeversorgung', 'energie', 'fernwarme', 'klarwerk', 'liniendaten', 'stzh', 'vektordaten', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'warmeversorgung', 'geoportal', 'polygondaten', 'erneuerbar-heizen', 'netto-null', 'heizen', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-08-02T01:20:11.010842`
