...
- **Keywords.de** `['klarwerk', 'energieplankarte', 'polygondaten', 'stzh', 'heizen', 'energieplanung', 'vektordaten', 'energie', 'fernwarme', 'punktdaten', 'fernwarmeversorgung', 'energieversorgung', 'kehrichtheizkraftwerk', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'warmeversorgung', 'liniendaten', 'netto-null', 'geodaten', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:14:32.220935`
- **Metadata_modified** `2023-05-26T01:19:22.978810`
