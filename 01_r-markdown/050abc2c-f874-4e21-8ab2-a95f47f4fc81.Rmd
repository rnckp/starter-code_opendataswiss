...
## Dataset: Qualitätsindikatoren der Schweizer Akutspitäler 2016

Die Qualitätsindikatoren der Schweizer Akutspitäler beinhalten Angaben zu den Behandlungen in den Schweizer Spitälern 2016. Ausgewiesen werden Fallzahlen, Anteilswerte (z. B. Kaiserschnittrate) sowie die Mortalität bei bestimmten Krankheitsbildern und Eingriffen.
...
[Direct link by **opendata.swiss** for dataset](https://opendata.swiss/de/dataset/quality-indicators-of-the-swiss-acute-care-hospitals-2016)<br>
[Direct link by **Bundesamt für Gesundheit BAG** for dataset](http://www.bag.admin.ch/qiss)

Auto generated R starter code for data set qip16@bundesamt-fur-gesundheit-bag.
...
- **Metadata_created** `2018-01-18T14:38:30.997087`
- **Metadata_modified** `2022-04-27T09:49:22.066423`
...
# Distribution 0
# Package_id               : 050abc2c-f874-4e21-8ab2-a95f47f4fc81
# Description              : 
# Issued                   : 2018-02-27T00:00:00
# Modified                 : 
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://bag-files.opendata.swiss/owncloud/index.php/s/MDhXc5CbXtvXuE3')
