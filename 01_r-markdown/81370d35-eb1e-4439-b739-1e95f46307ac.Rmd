...
- **Publisher** `Kontraktmanagement, Support, Sozialdepartement`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `Open Data Zürich`
- **Maintainer_email** `opendata@zuerich.ch`
- **Keywords.de** `['kinderbetreuung', 'tagesfamilien', 'sachdaten', 'kita', 'kennzahlen', 'tabelle', 'kindertagesstatten', 'belegungsfaktor', 'zeitreihe']`
- **Issued** `2018-04-23T00:00:00`
- **Metadata_created** `2019-07-30T00:44:03.761222`
- **Metadata_modified** `2024-05-16T03:14:39.043076`
...
# Modified                 : 2024-05-15T21:02:54.827875
