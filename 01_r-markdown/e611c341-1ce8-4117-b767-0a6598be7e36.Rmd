...
- **Keywords.de** `['stadtbaum', 'baumersatz', 'stadtbaume', 'vektordaten', 'geoportal', 'punktdaten', 'parkbaum', 'fallung', 'strassenbaum', 'baumersatzliste', 'baum', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-05T01:20:33.135384`
