...
- **Keywords.de** `['punktdaten', 'strassenbaum', 'stzh', 'geoportal', 'stadtbaume', 'geodaten', 'baum', 'baumersatzliste', 'stadtbaum', 'parkbaum', 'fallung', 'baumersatz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-14T01:04:10.613411`
