...
- **Keywords.de** `['fallung', 'punktdaten', 'strassenbaum', 'baum', 'geodaten', 'vektordaten', 'stadtbaume', 'parkbaum', 'baumersatz', 'stadtbaum', 'stzh', 'baumersatzliste', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-10T01:09:35.318935`
