...
- **Keywords.de** `['geodaten', 'punktdaten', 'stadtbaum', 'baumersatzliste', 'strassenbaum', 'baumersatz', 'vektordaten', 'stzh', 'fallung', 'baum', 'stadtbaume', 'parkbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-17T01:11:18.542686`
