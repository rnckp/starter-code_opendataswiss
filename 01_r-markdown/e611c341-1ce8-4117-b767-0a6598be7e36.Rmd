...
- **Keywords.de** `['baum', 'stzh', 'strassenbaum', 'fallung', 'geoportal', 'punktdaten', 'baumersatzliste', 'baumersatz', 'stadtbaum', 'parkbaum', 'geodaten', 'stadtbaume', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-23T01:11:55.399557`
