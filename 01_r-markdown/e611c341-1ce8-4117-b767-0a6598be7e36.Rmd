...
- **Keywords.de** `['geoportal', 'stadtbaume', 'stzh', 'stadtbaum', 'vektordaten', 'strassenbaum', 'punktdaten', 'baumersatz', 'fallung', 'parkbaum', 'baumersatzliste', 'baum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-23T01:14:24.754218`
