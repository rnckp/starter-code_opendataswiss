...
- **Keywords.de** `['geoportal', 'geodaten', 'punktdaten', 'baumersatz', 'fallung', 'vektordaten', 'stadtbaum', 'strassenbaum', 'stzh', 'baum', 'parkbaum', 'stadtbaume', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-16T01:02:02.894492`
