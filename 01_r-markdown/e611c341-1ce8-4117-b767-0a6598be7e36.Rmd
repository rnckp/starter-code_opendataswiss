...
- **Keywords.de** `['stadtbaume', 'geoportal', 'geodaten', 'vektordaten', 'baumersatz', 'punktdaten', 'baumersatzliste', 'fallung', 'parkbaum', 'baum', 'strassenbaum', 'stadtbaum', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-01T01:22:15.466325`
