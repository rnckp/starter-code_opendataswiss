...
- **Keywords.de** `['fallung', 'stzh', 'geoportal', 'parkbaum', 'baumersatzliste', 'geodaten', 'strassenbaum', 'baumersatz', 'stadtbaum', 'vektordaten', 'punktdaten', 'baum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-22T00:53:52.227203`
