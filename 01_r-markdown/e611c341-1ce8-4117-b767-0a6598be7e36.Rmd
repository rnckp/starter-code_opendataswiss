...
- **Keywords.de** `['vektordaten', 'baum', 'baumersatzliste', 'stadtbaum', 'stzh', 'strassenbaum', 'geoportal', 'punktdaten', 'geodaten', 'stadtbaume', 'parkbaum', 'baumersatz', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-02T01:14:02.595518`
