...
- **Keywords.de** `['stzh', 'baum', 'parkbaum', 'baumersatz', 'geodaten', 'baumersatzliste', 'stadtbaum', 'punktdaten', 'fallung', 'vektordaten', 'geoportal', 'strassenbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-05-09T00:54:55.768828`
