...
- **Keywords.de** `['parkbaum', 'geodaten', 'stzh', 'baumersatzliste', 'strassenbaum', 'baum', 'stadtbaum', 'vektordaten', 'stadtbaume', 'geoportal', 'fallung', 'baumersatz', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-20T01:20:29.820119`
