...
- **Keywords.de** `['stadtbaum', 'baum', 'geodaten', 'stadtbaume', 'parkbaum', 'fallung', 'punktdaten', 'stzh', 'geoportal', 'baumersatz', 'strassenbaum', 'baumersatzliste', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-01-20T01:16:21.725236`
