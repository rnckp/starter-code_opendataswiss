...
- **Keywords.de** `['strassenbaum', 'fallung', 'stzh', 'baumersatz', 'stadtbaum', 'vektordaten', 'geodaten', 'parkbaum', 'baumersatzliste', 'punktdaten', 'geoportal', 'baum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-01-29T01:35:54.620629`
