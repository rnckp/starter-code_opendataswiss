...
- **Keywords.de** `['baumersatz', 'stzh', 'vektordaten', 'geodaten', 'strassenbaum', 'punktdaten', 'baum', 'stadtbaume', 'geoportal', 'baumersatzliste', 'stadtbaum', 'parkbaum', 'fallung']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-26T01:16:34.920679`
