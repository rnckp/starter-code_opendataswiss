...
- **Keywords.de** `['baumersatz', 'geoportal', 'stadtbaum', 'geodaten', 'fallung', 'stadtbaume', 'baumersatzliste', 'vektordaten', 'parkbaum', 'stzh', 'baum', 'strassenbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-14T00:58:38.945091`
