...
- **Keywords.de** `['baum', 'geodaten', 'stzh', 'geoportal', 'baumersatz', 'fallung', 'strassenbaum', 'baumersatzliste', 'punktdaten', 'stadtbaum', 'vektordaten', 'parkbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-18T01:12:12.983304`
