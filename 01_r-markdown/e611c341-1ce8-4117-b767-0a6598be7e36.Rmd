...
- **Keywords.de** `['strassenbaum', 'stadtbaum', 'fallung', 'baumersatzliste', 'geoportal', 'baum', 'stadtbaume', 'vektordaten', 'punktdaten', 'stzh', 'parkbaum', 'baumersatz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-01-17T00:52:13.416591`
