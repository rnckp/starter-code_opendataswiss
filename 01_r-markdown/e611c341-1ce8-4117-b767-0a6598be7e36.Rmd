...
- **Keywords.de** `['punktdaten', 'parkbaum', 'vektordaten', 'baumersatzliste', 'geoportal', 'stadtbaume', 'fallung', 'baum', 'strassenbaum', 'baumersatz', 'stadtbaum', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-01-18T01:00:29.005047`
