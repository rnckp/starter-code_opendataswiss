...
- **Keywords.de** `['punktdaten', 'stadtbaume', 'vektordaten', 'geoportal', 'baum', 'baumersatzliste', 'strassenbaum', 'geodaten', 'fallung', 'stadtbaum', 'baumersatz', 'stzh', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-24T01:17:20.457657`
