...
- **Keywords.de** `['stadtbaum', 'strassenbaum', 'baumersatz', 'baum', 'fallung', 'baumersatzliste', 'punktdaten', 'stzh', 'vektordaten', 'stadtbaume', 'geoportal', 'geodaten', 'parkbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-05-07T01:12:59.642689`
