...
- **Keywords.de** `['fallung', 'vektordaten', 'parkbaum', 'baumersatz', 'punktdaten', 'strassenbaum', 'stzh', 'geodaten', 'stadtbaume', 'stadtbaum', 'baum', 'baumersatzliste', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-10T00:58:26.309956`
