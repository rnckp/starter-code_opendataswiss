...
- **Keywords.de** `['parkbaum', 'geoportal', 'baumersatzliste', 'punktdaten', 'vektordaten', 'baum', 'fallung', 'strassenbaum', 'baumersatz', 'geodaten', 'stadtbaum', 'stzh', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-18T01:01:22.076215`
