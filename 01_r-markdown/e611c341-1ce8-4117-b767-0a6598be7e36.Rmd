...
- **Keywords.de** `['stadtbaume', 'baum', 'stadtbaum', 'strassenbaum', 'parkbaum', 'stzh', 'punktdaten', 'baumersatz', 'fallung', 'baumersatzliste', 'vektordaten', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-06T01:44:39.358679`
