...
- **Keywords.de** `['vektordaten', 'geoportal', 'baum', 'strassenbaum', 'stzh', 'geodaten', 'punktdaten', 'fallung', 'parkbaum', 'baumersatzliste', 'baumersatz', 'stadtbaum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-20T01:18:53.215290`
