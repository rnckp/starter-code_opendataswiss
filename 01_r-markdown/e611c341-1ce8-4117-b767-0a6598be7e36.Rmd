...
- **Keywords.de** `['stzh', 'baumersatzliste', 'fallung', 'baumersatz', 'geodaten', 'parkbaum', 'geoportal', 'strassenbaum', 'vektordaten', 'stadtbaume', 'punktdaten', 'stadtbaum', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-04T00:59:51.336086`
