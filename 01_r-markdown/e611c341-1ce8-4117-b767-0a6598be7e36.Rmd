...
- **Keywords.de** `['stzh', 'vektordaten', 'baumersatzliste', 'baum', 'fallung', 'geodaten', 'stadtbaum', 'stadtbaume', 'geoportal', 'baumersatz', 'punktdaten', 'parkbaum', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-28T01:29:47.411737`
