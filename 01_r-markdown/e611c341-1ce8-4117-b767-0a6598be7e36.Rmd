...
- **Keywords.de** `['fallung', 'strassenbaum', 'geodaten', 'vektordaten', 'stzh', 'baumersatz', 'baumersatzliste', 'parkbaum', 'geoportal', 'stadtbaume', 'stadtbaum', 'baum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-21T00:55:25.510010`
