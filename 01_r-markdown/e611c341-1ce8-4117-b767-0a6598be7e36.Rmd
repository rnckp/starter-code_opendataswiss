...
- **Keywords.de** `['geoportal', 'vektordaten', 'strassenbaum', 'punktdaten', 'baum', 'baumersatz', 'parkbaum', 'fallung', 'baumersatzliste', 'stadtbaum', 'geodaten', 'stzh', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-22T01:10:32.884290`
