...
- **Keywords.de** `['baumersatzliste', 'punktdaten', 'stadtbaume', 'baumersatz', 'fallung', 'parkbaum', 'geoportal', 'stzh', 'stadtbaum', 'baum', 'vektordaten', 'geodaten', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-05-08T00:58:18.444658`
