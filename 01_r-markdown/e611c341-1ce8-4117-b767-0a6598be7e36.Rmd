...
- **Keywords.de** `['geoportal', 'punktdaten', 'parkbaum', 'baumersatz', 'vektordaten', 'baum', 'strassenbaum', 'fallung', 'stadtbaum', 'stzh', 'baumersatzliste', 'stadtbaume', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-20T01:22:55.109662`
