...
- **Keywords.de** `['geoportal', 'stadtbaum', 'baumersatzliste', 'fallung', 'parkbaum', 'baum', 'geodaten', 'vektordaten', 'punktdaten', 'stadtbaume', 'stzh', 'baumersatz', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-12T01:04:56.000916`
