...
- **Keywords.de** `['stadtbaume', 'baum', 'baumersatzliste', 'vektordaten', 'stadtbaum', 'geoportal', 'strassenbaum', 'parkbaum', 'fallung', 'stzh', 'punktdaten', 'geodaten', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-02T01:44:59.119852`
