...
- **Keywords.de** `['baum', 'stadtbaum', 'punktdaten', 'baumersatz', 'geoportal', 'strassenbaum', 'geodaten', 'vektordaten', 'parkbaum', 'baumersatzliste', 'stadtbaume', 'fallung', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-16T01:16:53.729534`
