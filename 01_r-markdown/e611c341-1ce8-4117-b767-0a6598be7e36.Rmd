...
- **Keywords.de** `['stzh', 'stadtbaume', 'vektordaten', 'baumersatz', 'parkbaum', 'geoportal', 'baumersatzliste', 'stadtbaum', 'fallung', 'strassenbaum', 'baum', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-13T01:04:14.854121`
