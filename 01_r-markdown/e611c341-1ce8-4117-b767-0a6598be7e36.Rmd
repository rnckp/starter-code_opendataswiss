...
- **Keywords.de** `['baumersatz', 'strassenbaum', 'baumersatzliste', 'parkbaum', 'stadtbaum', 'geoportal', 'stadtbaume', 'vektordaten', 'punktdaten', 'fallung', 'baum', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-30T01:32:54.519896`
