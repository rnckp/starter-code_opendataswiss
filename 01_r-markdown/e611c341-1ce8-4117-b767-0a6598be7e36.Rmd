...
- **Keywords.de** `['geodaten', 'geoportal', 'strassenbaum', 'stzh', 'punktdaten', 'baum', 'vektordaten', 'fallung', 'parkbaum', 'stadtbaum', 'baumersatz', 'stadtbaume', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-24T01:06:31.184264`
