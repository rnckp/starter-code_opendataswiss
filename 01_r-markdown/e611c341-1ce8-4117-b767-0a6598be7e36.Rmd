...
- **Keywords.de** `['baumersatzliste', 'parkbaum', 'baum', 'fallung', 'geoportal', 'geodaten', 'strassenbaum', 'vektordaten', 'stadtbaume', 'stadtbaum', 'baumersatz', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-05-12T01:22:55.330896`
