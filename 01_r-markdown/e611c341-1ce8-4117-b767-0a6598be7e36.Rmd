...
- **Keywords.de** `['baum', 'strassenbaum', 'geodaten', 'stadtbaume', 'vektordaten', 'parkbaum', 'stadtbaum', 'fallung', 'punktdaten', 'baumersatz', 'baumersatzliste', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-09T01:07:50.456674`
