...
- **Keywords.de** `['geodaten', 'vektordaten', 'parkbaum', 'punktdaten', 'geoportal', 'stzh', 'stadtbaum', 'baumersatzliste', 'baum', 'fallung', 'strassenbaum', 'stadtbaume', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-01T01:06:03.558893`
