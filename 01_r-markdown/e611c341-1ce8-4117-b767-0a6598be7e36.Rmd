...
- **Keywords.de** `['baumersatzliste', 'punktdaten', 'fallung', 'baum', 'baumersatz', 'strassenbaum', 'geodaten', 'vektordaten', 'stadtbaume', 'parkbaum', 'geoportal', 'stzh', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-06T01:26:18.906989`
