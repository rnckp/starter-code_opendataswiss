...
- **Keywords.de** `['geoportal', 'stadtbaume', 'parkbaum', 'stadtbaum', 'stzh', 'punktdaten', 'strassenbaum', 'fallung', 'baumersatzliste', 'baumersatz', 'geodaten', 'baum', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-11T01:46:22.102525`
