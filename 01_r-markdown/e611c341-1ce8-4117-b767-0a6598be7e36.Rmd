...
- **Keywords.de** `['geoportal', 'strassenbaum', 'parkbaum', 'baumersatzliste', 'stzh', 'stadtbaum', 'stadtbaume', 'punktdaten', 'baumersatz', 'vektordaten', 'fallung', 'baum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-17T01:03:35.348594`
