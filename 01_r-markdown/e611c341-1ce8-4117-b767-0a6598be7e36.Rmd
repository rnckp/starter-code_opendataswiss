...
- **Keywords.de** `['punktdaten', 'fallung', 'strassenbaum', 'baum', 'geodaten', 'parkbaum', 'baumersatz', 'stadtbaume', 'stzh', 'vektordaten', 'baumersatzliste', 'stadtbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-11T01:09:43.417919`
