...
- **Keywords.de** `['strassenbaum', 'fallung', 'stadtbaum', 'stzh', 'parkbaum', 'geodaten', 'baumersatz', 'vektordaten', 'punktdaten', 'geoportal', 'stadtbaume', 'baum', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-27T01:36:13.978094`
