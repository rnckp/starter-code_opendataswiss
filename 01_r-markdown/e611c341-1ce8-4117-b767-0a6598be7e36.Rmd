...
- **Keywords.de** `['baum', 'geoportal', 'stzh', 'punktdaten', 'baumersatzliste', 'strassenbaum', 'vektordaten', 'stadtbaume', 'baumersatz', 'fallung', 'geodaten', 'parkbaum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-28T01:03:11.761720`
