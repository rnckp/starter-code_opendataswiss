...
- **Keywords.de** `['stadtbaume', 'strassenbaum', 'geoportal', 'fallung', 'stzh', 'geodaten', 'baumersatz', 'vektordaten', 'baumersatzliste', 'baum', 'punktdaten', 'parkbaum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-26T01:16:14.276062`
