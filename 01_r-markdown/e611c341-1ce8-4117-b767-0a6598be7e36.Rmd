...
- **Keywords.de** `['geoportal', 'punktdaten', 'parkbaum', 'stadtbaume', 'stzh', 'baum', 'vektordaten', 'stadtbaum', 'baumersatz', 'fallung', 'strassenbaum', 'geodaten', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-21T01:04:43.181834`
