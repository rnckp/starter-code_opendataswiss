...
- **Keywords.de** `['geoportal', 'stzh', 'stadtbaume', 'parkbaum', 'stadtbaum', 'geodaten', 'strassenbaum', 'baum', 'baumersatzliste', 'baumersatz', 'fallung', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-18T01:20:21.238946`
