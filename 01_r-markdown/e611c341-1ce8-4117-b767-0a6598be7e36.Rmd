...
- **Keywords.de** `['stzh', 'parkbaum', 'fallung', 'baum', 'stadtbaume', 'baumersatzliste', 'stadtbaum', 'strassenbaum', 'geoportal', 'baumersatz', 'geodaten', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-03T01:02:35.838156`
