...
- **Keywords.de** `['punktdaten', 'stadtbaume', 'strassenbaum', 'parkbaum', 'geodaten', 'baum', 'geoportal', 'baumersatz', 'stadtbaum', 'vektordaten', 'fallung', 'stzh', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-01-21T01:15:51.432942`
