...
- **Keywords.de** `['baumersatzliste', 'geoportal', 'fallung', 'baumersatz', 'strassenbaum', 'geodaten', 'stadtbaume', 'punktdaten', 'vektordaten', 'parkbaum', 'stzh', 'baum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-07T00:59:38.816642`
