...
- **Keywords.de** `['baum', 'punktdaten', 'stzh', 'stadtbaume', 'geoportal', 'fallung', 'strassenbaum', 'vektordaten', 'baumersatzliste', 'parkbaum', 'baumersatz', 'stadtbaum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-13T01:06:13.425485`
