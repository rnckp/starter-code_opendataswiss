...
- **Keywords.de** `['baumersatz', 'geoportal', 'baum', 'fallung', 'stadtbaume', 'baumersatzliste', 'stadtbaum', 'stzh', 'strassenbaum', 'vektordaten', 'geodaten', 'parkbaum', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-05-03T00:56:11.763705`
