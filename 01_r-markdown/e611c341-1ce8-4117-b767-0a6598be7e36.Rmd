...
- **Keywords.de** `['stadtbaum', 'baumersatz', 'stzh', 'strassenbaum', 'baumersatzliste', 'punktdaten', 'parkbaum', 'geodaten', 'stadtbaume', 'fallung', 'vektordaten', 'baum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-30T01:29:52.979223`
