...
- **Keywords.de** `['strassenbaum', 'geodaten', 'stadtbaume', 'baumersatzliste', 'geoportal', 'baum', 'punktdaten', 'parkbaum', 'vektordaten', 'fallung', 'stzh', 'stadtbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-09-17T01:38:15.533427`
