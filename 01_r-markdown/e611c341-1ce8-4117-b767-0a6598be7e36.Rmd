...
- **Keywords.de** `['strassenbaum', 'baum', 'parkbaum', 'punktdaten', 'stadtbaum', 'geoportal', 'geodaten', 'stadtbaume', 'fallung', 'vektordaten', 'baumersatz', 'stzh', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-25T00:54:23.532855`
