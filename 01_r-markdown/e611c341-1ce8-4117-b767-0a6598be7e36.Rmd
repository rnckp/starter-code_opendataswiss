...
- **Keywords.de** `['geodaten', 'stzh', 'stadtbaum', 'baum', 'baumersatz', 'fallung', 'geoportal', 'baumersatzliste', 'strassenbaum', 'parkbaum', 'punktdaten', 'stadtbaume', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-03T01:16:08.869631`
