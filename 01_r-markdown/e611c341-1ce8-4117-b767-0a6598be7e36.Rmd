...
- **Keywords.de** `['strassenbaum', 'stzh', 'stadtbaum', 'parkbaum', 'stadtbaume', 'baumersatz', 'geoportal', 'fallung', 'geodaten', 'vektordaten', 'baumersatzliste', 'punktdaten', 'baum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-01-28T01:44:55.103027`
