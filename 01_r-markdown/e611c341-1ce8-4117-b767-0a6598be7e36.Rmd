...
- **Keywords.de** `['vektordaten', 'punktdaten', 'geodaten', 'baum', 'baumersatzliste', 'stadtbaume', 'strassenbaum', 'baumersatz', 'stzh', 'stadtbaum', 'parkbaum', 'fallung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-23T00:53:55.142993`
