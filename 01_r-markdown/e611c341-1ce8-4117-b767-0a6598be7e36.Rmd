...
- **Keywords.de** `['parkbaum', 'geodaten', 'stzh', 'vektordaten', 'baumersatz', 'baumersatzliste', 'geoportal', 'punktdaten', 'fallung', 'strassenbaum', 'stadtbaum', 'baum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-19T01:05:42.379559`
