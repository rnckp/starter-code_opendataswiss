...
- **Keywords.de** `['baumersatzliste', 'vektordaten', 'stadtbaum', 'baum', 'baumersatz', 'geodaten', 'stadtbaume', 'strassenbaum', 'fallung', 'stzh', 'punktdaten', 'parkbaum', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-01-26T01:17:59.231618`
