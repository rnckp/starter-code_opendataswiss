...
- **Keywords.de** `['baumersatz', 'baumersatzliste', 'geodaten', 'stadtbaum', 'strassenbaum', 'vektordaten', 'stzh', 'geoportal', 'fallung', 'punktdaten', 'parkbaum', 'baum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-27T01:03:53.415338`
