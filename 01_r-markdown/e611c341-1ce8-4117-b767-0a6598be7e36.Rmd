...
- **Keywords.de** `['parkbaum', 'vektordaten', 'fallung', 'stadtbaum', 'stadtbaume', 'baumersatzliste', 'geodaten', 'stzh', 'punktdaten', 'baum', 'geoportal', 'strassenbaum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-15T01:07:42.414348`
