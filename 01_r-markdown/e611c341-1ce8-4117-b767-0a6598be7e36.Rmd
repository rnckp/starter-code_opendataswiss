...
- **Keywords.de** `['geoportal', 'punktdaten', 'parkbaum', 'baumersatz', 'fallung', 'stadtbaume', 'stzh', 'geodaten', 'strassenbaum', 'baumersatzliste', 'baum', 'stadtbaum', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-31T02:40:43.667040`
