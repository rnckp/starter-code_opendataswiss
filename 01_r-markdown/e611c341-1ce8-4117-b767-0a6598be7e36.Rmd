...
- **Keywords.de** `['stadtbaum', 'baumersatz', 'punktdaten', 'parkbaum', 'geoportal', 'geodaten', 'stadtbaume', 'strassenbaum', 'baum', 'fallung', 'vektordaten', 'baumersatzliste', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-12T01:35:07.182691`
