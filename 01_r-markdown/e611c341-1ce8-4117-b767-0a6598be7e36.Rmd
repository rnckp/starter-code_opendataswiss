...
- **Keywords.de** `['parkbaum', 'geoportal', 'punktdaten', 'fallung', 'stzh', 'baumersatz', 'stadtbaum', 'geodaten', 'baumersatzliste', 'baum', 'strassenbaum', 'stadtbaume', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-05-01T01:12:19.037293`
