...
- **Keywords.de** `['stzh', 'vektordaten', 'fallung', 'baumersatzliste', 'stadtbaume', 'geodaten', 'parkbaum', 'stadtbaum', 'geoportal', 'punktdaten', 'strassenbaum', 'baum', 'baumersatz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-11T01:14:06.672658`
