...
- **Keywords.de** `['baum', 'geoportal', 'stadtbaum', 'stadtbaume', 'parkbaum', 'vektordaten', 'baumersatz', 'punktdaten', 'stzh', 'geodaten', 'baumersatzliste', 'fallung', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-04T01:04:18.549260`
