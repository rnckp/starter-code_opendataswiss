...
- **Keywords.de** `['stadtbaume', 'baumersatz', 'vektordaten', 'stzh', 'strassenbaum', 'geoportal', 'punktdaten', 'stadtbaum', 'parkbaum', 'baumersatzliste', 'fallung', 'baum', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-19T01:18:43.266849`
