...
- **Keywords.de** `['stzh', 'baumersatz', 'baumersatzliste', 'vektordaten', 'parkbaum', 'fallung', 'geoportal', 'stadtbaume', 'geodaten', 'baum', 'stadtbaum', 'punktdaten', 'strassenbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-04-25T01:21:43.904659`
