...
- **Keywords.de** `['geodaten', 'stadtbaume', 'fallung', 'geoportal', 'parkbaum', 'stzh', 'baumersatz', 'strassenbaum', 'stadtbaum', 'baum', 'punktdaten', 'vektordaten', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-15T01:31:08.032969`
