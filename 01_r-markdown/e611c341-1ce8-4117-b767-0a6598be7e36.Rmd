...
- **Keywords.de** `['stadtbaum', 'stadtbaume', 'strassenbaum', 'fallung', 'baum', 'geoportal', 'parkbaum', 'geodaten', 'baumersatzliste', 'baumersatz', 'punktdaten', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-04T01:07:15.912593`
