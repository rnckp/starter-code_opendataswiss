...
- **Keywords.de** `['fallung', 'stzh', 'parkbaum', 'baum', 'geoportal', 'stadtbaume', 'punktdaten', 'geodaten', 'baumersatzliste', 'vektordaten', 'baumersatz', 'strassenbaum', 'stadtbaum']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-06T01:13:28.295082`
