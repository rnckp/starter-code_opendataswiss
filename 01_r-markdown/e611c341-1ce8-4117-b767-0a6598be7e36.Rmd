...
- **Keywords.de** `['parkbaum', 'punktdaten', 'baumersatzliste', 'geoportal', 'baumersatz', 'fallung', 'stadtbaum', 'strassenbaum', 'geodaten', 'stadtbaume', 'baum', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-27T01:19:43.915825`
