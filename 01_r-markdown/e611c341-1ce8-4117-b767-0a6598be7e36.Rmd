...
- **Keywords.de** `['stzh', 'stadtbaum', 'baumersatzliste', 'vektordaten', 'baumersatz', 'strassenbaum', 'geodaten', 'parkbaum', 'fallung', 'punktdaten', 'geoportal', 'baum', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-26T01:49:10.198136`
