...
- **Keywords.de** `['vektordaten', 'geodaten', 'strassenbaum', 'parkbaum', 'baumersatzliste', 'stzh', 'baum', 'stadtbaum', 'baumersatz', 'fallung', 'geoportal', 'punktdaten', 'stadtbaume']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-28T00:59:05.670544`
