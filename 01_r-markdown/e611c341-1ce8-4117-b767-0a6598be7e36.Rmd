...
- **Keywords.de** `['stzh', 'baumersatz', 'vektordaten', 'fallung', 'geodaten', 'strassenbaum', 'parkbaum', 'stadtbaum', 'punktdaten', 'stadtbaume', 'baum', 'geoportal', 'baumersatzliste']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-03-21T01:01:18.976818`
