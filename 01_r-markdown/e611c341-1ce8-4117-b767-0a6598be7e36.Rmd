...
- **Keywords.de** `['geodaten', 'strassenbaum', 'parkbaum', 'stzh', 'punktdaten', 'baum', 'geoportal', 'fallung', 'baumersatzliste', 'stadtbaum', 'baumersatz', 'stadtbaume', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-05T01:19:22.351010`
