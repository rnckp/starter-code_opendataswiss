...
- **Keywords.de** `['parkbaum', 'punktdaten', 'stadtbaume', 'baum', 'vektordaten', 'stzh', 'stadtbaum', 'baumersatz', 'strassenbaum', 'fallung', 'geodaten', 'baumersatzliste', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-01-19T01:32:41.005818`
