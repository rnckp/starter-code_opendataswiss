...
- **Keywords.de** `['geodaten', 'stadtbaum', 'baumersatzliste', 'stzh', 'geoportal', 'strassenbaum', 'stadtbaume', 'baumersatz', 'parkbaum', 'baum', 'vektordaten', 'fallung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:11:04.620008`
- **Metadata_modified** `2023-02-24T00:52:05.504297`
