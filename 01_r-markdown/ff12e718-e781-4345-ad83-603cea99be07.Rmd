...
- **Keywords.de** `['denkmalschutzobjekte', 'geoportal', 'geodaten', 'kanton-zurich', 'amt-fur-stadtebau', 'vektordaten', 'inventar', 'stzh', 'zustandigkeit', 'denkmalpflege', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-03-10T03:14:40.604431`
