...
- **Keywords.de** `['kanton-zurich', 'geodaten', 'vektordaten', 'zustandigkeit', 'polygondaten', 'amt-fur-stadtebau', 'geoportal', 'stzh', 'inventar', 'denkmalschutzobjekte', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-20T05:06:14.969327`
