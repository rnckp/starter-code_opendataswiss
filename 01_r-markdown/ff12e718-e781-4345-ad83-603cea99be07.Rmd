...
- **Keywords.de** `['geodaten', 'geoportal', 'denkmalschutzobjekte', 'zustandigkeit', 'polygondaten', 'stzh', 'vektordaten', 'denkmalpflege', 'inventar', 'kanton-zurich', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-05T02:45:34.265974`
