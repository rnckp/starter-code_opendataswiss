...
- **Keywords.de** `['zustandigkeit', 'inventar', 'denkmalschutzobjekte', 'geodaten', 'vektordaten', 'polygondaten', 'geoportal', 'stzh', 'denkmalpflege', 'amt-fur-stadtebau', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-24T03:22:21.978026`
