...
- **Keywords.de** `['polygondaten', 'inventar', 'amt-fur-stadtebau', 'denkmalpflege', 'denkmalschutzobjekte', 'zustandigkeit', 'vektordaten', 'stzh', 'geodaten', 'kanton-zurich', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-24T01:58:41.768378`
