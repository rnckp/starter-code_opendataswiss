...
- **Keywords.de** `['kanton-zurich', 'zustandigkeit', 'geodaten', 'denkmalschutzobjekte', 'vektordaten', 'denkmalpflege', 'stzh', 'polygondaten', 'amt-fur-stadtebau', 'geoportal', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-22T03:32:57.447626`
