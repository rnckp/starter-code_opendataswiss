...
- **Keywords.de** `['polygondaten', 'stzh', 'kanton-zurich', 'amt-fur-stadtebau', 'denkmalpflege', 'zustandigkeit', 'geodaten', 'inventar', 'vektordaten', 'geoportal', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-27T03:06:33.861168`
