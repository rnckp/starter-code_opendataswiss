...
- **Keywords.de** `['polygondaten', 'inventar', 'denkmalschutzobjekte', 'stzh', 'geodaten', 'geoportal', 'kanton-zurich', 'denkmalpflege', 'amt-fur-stadtebau', 'vektordaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-14T03:05:27.137628`
