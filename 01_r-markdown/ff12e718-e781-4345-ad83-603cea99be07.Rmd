...
- **Keywords.de** `['denkmalpflege', 'geodaten', 'amt-fur-stadtebau', 'vektordaten', 'zustandigkeit', 'inventar', 'geoportal', 'stzh', 'denkmalschutzobjekte', 'polygondaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-28T03:50:53.916380`
