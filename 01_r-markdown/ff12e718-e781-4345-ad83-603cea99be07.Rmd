...
- **Keywords.de** `['inventar', 'stzh', 'kanton-zurich', 'geoportal', 'polygondaten', 'denkmalpflege', 'zustandigkeit', 'denkmalschutzobjekte', 'geodaten', 'amt-fur-stadtebau', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-04T03:20:44.193805`
