...
- **Keywords.de** `['kanton-zurich', 'zustandigkeit', 'vektordaten', 'stzh', 'geoportal', 'geodaten', 'polygondaten', 'amt-fur-stadtebau', 'inventar', 'denkmalschutzobjekte', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-03-02T03:16:58.965265`
