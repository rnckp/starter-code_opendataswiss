...
- **Keywords.de** `['zustandigkeit', 'vektordaten', 'geoportal', 'stzh', 'geodaten', 'kanton-zurich', 'denkmalpflege', 'polygondaten', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-28T03:03:37.859754`
