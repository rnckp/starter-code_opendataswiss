...
- **Keywords.de** `['geodaten', 'denkmalpflege', 'denkmalschutzobjekte', 'vektordaten', 'amt-fur-stadtebau', 'kanton-zurich', 'zustandigkeit', 'geoportal', 'inventar', 'polygondaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-18T04:07:43.831464`
