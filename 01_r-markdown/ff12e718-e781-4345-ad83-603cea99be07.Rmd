...
- **Keywords.de** `['kanton-zurich', 'amt-fur-stadtebau', 'denkmalpflege', 'inventar', 'denkmalschutzobjekte', 'zustandigkeit', 'stzh', 'polygondaten', 'vektordaten', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-29T02:34:31.601100`
