...
- **Keywords.de** `['denkmalpflege', 'denkmalschutzobjekte', 'vektordaten', 'amt-fur-stadtebau', 'stzh', 'zustandigkeit', 'geoportal', 'inventar', 'polygondaten', 'geodaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-03-04T03:58:02.525150`
