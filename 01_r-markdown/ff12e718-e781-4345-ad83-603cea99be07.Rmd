...
- **Keywords.de** `['vektordaten', 'amt-fur-stadtebau', 'kanton-zurich', 'geoportal', 'inventar', 'stzh', 'geodaten', 'denkmalschutzobjekte', 'polygondaten', 'denkmalpflege', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-29T03:02:15.454420`
