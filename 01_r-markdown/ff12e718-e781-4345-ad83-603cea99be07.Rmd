...
- **Keywords.de** `['inventar', 'denkmalpflege', 'kanton-zurich', 'vektordaten', 'stzh', 'denkmalschutzobjekte', 'geodaten', 'polygondaten', 'zustandigkeit', 'amt-fur-stadtebau', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-25T02:51:13.158901`
