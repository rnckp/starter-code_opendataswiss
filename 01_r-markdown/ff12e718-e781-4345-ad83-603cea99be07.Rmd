...
- **Keywords.de** `['kanton-zurich', 'denkmalschutzobjekte', 'vektordaten', 'geoportal', 'geodaten', 'amt-fur-stadtebau', 'polygondaten', 'zustandigkeit', 'denkmalpflege', 'stzh', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-21T02:39:39.005371`
