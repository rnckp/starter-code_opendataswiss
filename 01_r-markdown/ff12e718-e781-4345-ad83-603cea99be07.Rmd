...
- **Keywords.de** `['amt-fur-stadtebau', 'kanton-zurich', 'zustandigkeit', 'denkmalpflege', 'denkmalschutzobjekte', 'polygondaten', 'geodaten', 'stzh', 'vektordaten', 'inventar', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-03-17T03:16:24.376841`
