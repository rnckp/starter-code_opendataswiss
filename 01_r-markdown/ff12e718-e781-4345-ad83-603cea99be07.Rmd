...
- **Keywords.de** `['kanton-zurich', 'stzh', 'vektordaten', 'polygondaten', 'denkmalpflege', 'inventar', 'amt-fur-stadtebau', 'geoportal', 'denkmalschutzobjekte', 'zustandigkeit', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-03T03:16:35.574272`
