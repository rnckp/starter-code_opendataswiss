...
- **Keywords.de** `['denkmalschutzobjekte', 'denkmalpflege', 'amt-fur-stadtebau', 'kanton-zurich', 'inventar', 'polygondaten', 'zustandigkeit', 'geoportal', 'geodaten', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-20T03:19:56.555785`
