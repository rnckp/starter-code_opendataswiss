...
- **Keywords.de** `['denkmalschutzobjekte', 'vektordaten', 'denkmalpflege', 'inventar', 'zustandigkeit', 'stzh', 'geodaten', 'geoportal', 'polygondaten', 'amt-fur-stadtebau', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-05T02:53:05.838292`
