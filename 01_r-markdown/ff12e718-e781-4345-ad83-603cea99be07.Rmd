...
- **Keywords.de** `['geoportal', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'denkmalpflege', 'vektordaten', 'kanton-zurich', 'stzh', 'inventar', 'geodaten', 'zustandigkeit', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-19T02:08:29.500475`
