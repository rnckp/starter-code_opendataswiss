...
- **Keywords.de** `['amt-fur-stadtebau', 'polygondaten', 'denkmalpflege', 'geoportal', 'geodaten', 'vektordaten', 'kanton-zurich', 'stzh', 'zustandigkeit', 'inventar', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-18T02:55:58.942583`
