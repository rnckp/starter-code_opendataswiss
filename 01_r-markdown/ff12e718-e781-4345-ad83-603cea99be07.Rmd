...
- **Keywords.de** `['polygondaten', 'inventar', 'geoportal', 'stzh', 'denkmalpflege', 'kanton-zurich', 'vektordaten', 'denkmalschutzobjekte', 'geodaten', 'zustandigkeit', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-14T04:12:12.728103`
