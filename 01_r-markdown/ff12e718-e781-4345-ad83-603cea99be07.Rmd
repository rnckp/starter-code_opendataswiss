...
- **Keywords.de** `['kanton-zurich', 'denkmalpflege', 'zustandigkeit', 'amt-fur-stadtebau', 'polygondaten', 'geoportal', 'denkmalschutzobjekte', 'geodaten', 'vektordaten', 'inventar', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-10T03:33:53.918996`
