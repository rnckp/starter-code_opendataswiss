...
- **Keywords.de** `['denkmalschutzobjekte', 'polygondaten', 'kanton-zurich', 'geoportal', 'denkmalpflege', 'geodaten', 'amt-fur-stadtebau', 'zustandigkeit', 'stzh', 'inventar', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-08T03:14:05.821463`
