...
- **Keywords.de** `['geoportal', 'kanton-zurich', 'geodaten', 'amt-fur-stadtebau', 'inventar', 'polygondaten', 'vektordaten', 'stzh', 'zustandigkeit', 'denkmalschutzobjekte', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-26T03:12:25.393941`
