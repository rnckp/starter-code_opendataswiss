...
- **Keywords.de** `['stzh', 'geoportal', 'denkmalpflege', 'amt-fur-stadtebau', 'zustandigkeit', 'kanton-zurich', 'inventar', 'geodaten', 'denkmalschutzobjekte', 'vektordaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-26T04:58:31.827393`
