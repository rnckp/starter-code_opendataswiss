...
- **Keywords.de** `['vektordaten', 'denkmalschutzobjekte', 'inventar', 'geoportal', 'denkmalpflege', 'kanton-zurich', 'amt-fur-stadtebau', 'geodaten', 'polygondaten', 'stzh', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-27T03:16:32.761112`
