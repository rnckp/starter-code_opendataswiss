...
- **Keywords.de** `['denkmalpflege', 'geoportal', 'amt-fur-stadtebau', 'zustandigkeit', 'denkmalschutzobjekte', 'stzh', 'vektordaten', 'inventar', 'polygondaten', 'geodaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-21T03:56:26.814065`
