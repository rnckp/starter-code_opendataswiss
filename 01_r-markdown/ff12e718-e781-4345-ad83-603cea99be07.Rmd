...
- **Keywords.de** `['geodaten', 'vektordaten', 'stzh', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'inventar', 'kanton-zurich', 'zustandigkeit', 'denkmalpflege', 'polygondaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-09T03:17:52.473083`
