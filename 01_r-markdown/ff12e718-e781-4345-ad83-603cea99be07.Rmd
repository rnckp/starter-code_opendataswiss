...
- **Keywords.de** `['inventar', 'geoportal', 'polygondaten', 'stzh', 'kanton-zurich', 'geodaten', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'zustandigkeit', 'vektordaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-30T03:44:27.850300`
