...
- **Keywords.de** `['geodaten', 'vektordaten', 'geoportal', 'zustandigkeit', 'polygondaten', 'kanton-zurich', 'amt-fur-stadtebau', 'denkmalpflege', 'inventar', 'denkmalschutzobjekte', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-12T03:44:13.164331`
