...
- **Keywords.de** `['geodaten', 'kanton-zurich', 'geoportal', 'stzh', 'vektordaten', 'amt-fur-stadtebau', 'zustandigkeit', 'denkmalschutzobjekte', 'polygondaten', 'denkmalpflege', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-22T02:57:16.438850`
