...
- **Keywords.de** `['zustandigkeit', 'kanton-zurich', 'geodaten', 'denkmalpflege', 'vektordaten', 'stzh', 'polygondaten', 'denkmalschutzobjekte', 'geoportal', 'amt-fur-stadtebau', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-04T03:49:35.739446`
