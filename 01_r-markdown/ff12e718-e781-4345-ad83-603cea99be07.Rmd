...
- **Keywords.de** `['denkmalpflege', 'geoportal', 'stzh', 'zustandigkeit', 'amt-fur-stadtebau', 'polygondaten', 'inventar', 'vektordaten', 'kanton-zurich', 'denkmalschutzobjekte', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-13T03:30:45.265311`
