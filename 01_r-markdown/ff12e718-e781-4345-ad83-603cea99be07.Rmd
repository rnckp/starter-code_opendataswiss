...
- **Keywords.de** `['polygondaten', 'inventar', 'denkmalschutzobjekte', 'denkmalpflege', 'amt-fur-stadtebau', 'stzh', 'geodaten', 'zustandigkeit', 'kanton-zurich', 'vektordaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-12T03:13:36.186074`
