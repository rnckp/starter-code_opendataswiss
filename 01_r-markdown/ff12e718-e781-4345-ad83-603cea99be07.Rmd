...
- **Keywords.de** `['geodaten', 'geoportal', 'vektordaten', 'kanton-zurich', 'amt-fur-stadtebau', 'polygondaten', 'inventar', 'denkmalpflege', 'stzh', 'zustandigkeit', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-12T03:45:35.483905`
