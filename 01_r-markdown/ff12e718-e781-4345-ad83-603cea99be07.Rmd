...
- **Keywords.de** `['amt-fur-stadtebau', 'geoportal', 'vektordaten', 'kanton-zurich', 'geodaten', 'stzh', 'inventar', 'zustandigkeit', 'polygondaten', 'denkmalschutzobjekte', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-05T03:24:28.408315`
