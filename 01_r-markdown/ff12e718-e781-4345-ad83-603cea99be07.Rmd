...
- **Keywords.de** `['inventar', 'polygondaten', 'stzh', 'denkmalpflege', 'kanton-zurich', 'zustandigkeit', 'geodaten', 'denkmalschutzobjekte', 'geoportal', 'amt-fur-stadtebau', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-06T02:57:09.645343`
