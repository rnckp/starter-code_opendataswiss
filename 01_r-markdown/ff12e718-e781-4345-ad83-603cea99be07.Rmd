...
- **Keywords.de** `['denkmalpflege', 'stzh', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'geoportal', 'kanton-zurich', 'zustandigkeit', 'geodaten', 'polygondaten', 'inventar', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-15T02:56:58.532557`
