...
- **Keywords.de** `['polygondaten', 'stzh', 'kanton-zurich', 'vektordaten', 'geodaten', 'geoportal', 'inventar', 'denkmalschutzobjekte', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-02T03:19:18.267288`
