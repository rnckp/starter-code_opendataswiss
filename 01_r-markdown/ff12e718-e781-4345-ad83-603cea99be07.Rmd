...
- **Keywords.de** `['geoportal', 'polygondaten', 'denkmalpflege', 'amt-fur-stadtebau', 'kanton-zurich', 'stzh', 'denkmalschutzobjekte', 'geodaten', 'zustandigkeit', 'inventar', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-20T04:13:37.080230`
