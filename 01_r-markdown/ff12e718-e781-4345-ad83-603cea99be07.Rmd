...
- **Keywords.de** `['kanton-zurich', 'amt-fur-stadtebau', 'stzh', 'geoportal', 'denkmalschutzobjekte', 'vektordaten', 'zustandigkeit', 'geodaten', 'polygondaten', 'denkmalpflege', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-03-15T03:03:40.192047`
