...
- **Keywords.de** `['amt-fur-stadtebau', 'denkmalschutzobjekte', 'inventar', 'stzh', 'geoportal', 'geodaten', 'zustandigkeit', 'polygondaten', 'denkmalpflege', 'kanton-zurich', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-26T02:55:05.622781`
