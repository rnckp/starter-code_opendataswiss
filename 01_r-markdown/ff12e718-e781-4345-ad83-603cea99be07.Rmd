...
- **Keywords.de** `['denkmalschutzobjekte', 'amt-fur-stadtebau', 'kanton-zurich', 'denkmalpflege', 'vektordaten', 'inventar', 'geodaten', 'geoportal', 'polygondaten', 'zustandigkeit', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-02T02:50:05.710132`
