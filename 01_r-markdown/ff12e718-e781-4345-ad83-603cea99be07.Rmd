...
- **Keywords.de** `['denkmalschutzobjekte', 'inventar', 'vektordaten', 'polygondaten', 'zustandigkeit', 'geoportal', 'stzh', 'amt-fur-stadtebau', 'kanton-zurich', 'geodaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-04T04:38:05.735899`
