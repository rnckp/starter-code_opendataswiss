...
- **Keywords.de** `['zustandigkeit', 'geodaten', 'amt-fur-stadtebau', 'geoportal', 'denkmalpflege', 'polygondaten', 'denkmalschutzobjekte', 'stzh', 'vektordaten', 'kanton-zurich', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-29T02:55:55.018803`
