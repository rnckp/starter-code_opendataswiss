...
- **Keywords.de** `['denkmalschutzobjekte', 'inventar', 'polygondaten', 'geoportal', 'zustandigkeit', 'kanton-zurich', 'stzh', 'denkmalpflege', 'vektordaten', 'geodaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-04T03:20:27.136241`
