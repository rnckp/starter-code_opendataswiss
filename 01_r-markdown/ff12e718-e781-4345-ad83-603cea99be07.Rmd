...
- **Keywords.de** `['stzh', 'kanton-zurich', 'amt-fur-stadtebau', 'zustandigkeit', 'geoportal', 'geodaten', 'vektordaten', 'denkmalschutzobjekte', 'denkmalpflege', 'inventar', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-18T03:21:27.343070`
