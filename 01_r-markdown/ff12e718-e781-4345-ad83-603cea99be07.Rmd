...
- **Keywords.de** `['stzh', 'kanton-zurich', 'denkmalpflege', 'denkmalschutzobjekte', 'vektordaten', 'inventar', 'amt-fur-stadtebau', 'geoportal', 'geodaten', 'zustandigkeit', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-06T03:15:20.277731`
