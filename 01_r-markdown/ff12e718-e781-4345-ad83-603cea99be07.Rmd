...
- **Keywords.de** `['amt-fur-stadtebau', 'inventar', 'denkmalschutzobjekte', 'polygondaten', 'denkmalpflege', 'vektordaten', 'kanton-zurich', 'geoportal', 'geodaten', 'stzh', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-26T03:34:43.096681`
