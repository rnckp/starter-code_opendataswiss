...
- **Keywords.de** `['geodaten', 'amt-fur-stadtebau', 'inventar', 'geoportal', 'polygondaten', 'denkmalpflege', 'vektordaten', 'denkmalschutzobjekte', 'zustandigkeit', 'kanton-zurich', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-01T03:36:29.007450`
