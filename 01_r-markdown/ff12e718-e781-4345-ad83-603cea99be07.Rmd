...
- **Keywords.de** `['inventar', 'geoportal', 'stzh', 'zustandigkeit', 'kanton-zurich', 'polygondaten', 'denkmalschutzobjekte', 'geodaten', 'vektordaten', 'denkmalpflege', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-30T03:02:36.852259`
