...
- **Keywords.de** `['denkmalschutzobjekte', 'stzh', 'polygondaten', 'geoportal', 'geodaten', 'zustandigkeit', 'inventar', 'kanton-zurich', 'amt-fur-stadtebau', 'vektordaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-28T02:51:19.015453`
