...
- **Keywords.de** `['kanton-zurich', 'inventar', 'geodaten', 'stzh', 'vektordaten', 'denkmalschutzobjekte', 'polygondaten', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalpflege', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-27T04:43:46.494167`
