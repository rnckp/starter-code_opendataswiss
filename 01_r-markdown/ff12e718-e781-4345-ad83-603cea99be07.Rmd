...
- **Keywords.de** `['denkmalschutzobjekte', 'inventar', 'geoportal', 'stzh', 'vektordaten', 'zustandigkeit', 'denkmalpflege', 'geodaten', 'polygondaten', 'kanton-zurich', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-25T02:09:22.894493`
