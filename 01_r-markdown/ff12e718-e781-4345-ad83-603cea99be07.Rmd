...
- **Keywords.de** `['kanton-zurich', 'denkmalpflege', 'zustandigkeit', 'denkmalschutzobjekte', 'vektordaten', 'stzh', 'geodaten', 'inventar', 'geoportal', 'amt-fur-stadtebau', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-10T02:56:37.487156`
