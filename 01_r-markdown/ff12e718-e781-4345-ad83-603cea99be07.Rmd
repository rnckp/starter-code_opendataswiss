...
- **Keywords.de** `['zustandigkeit', 'amt-fur-stadtebau', 'denkmalpflege', 'kanton-zurich', 'stzh', 'polygondaten', 'denkmalschutzobjekte', 'inventar', 'geodaten', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-28T02:52:28.263724`
