...
- **Keywords.de** `['inventar', 'denkmalpflege', 'geoportal', 'kanton-zurich', 'polygondaten', 'geodaten', 'zustandigkeit', 'amt-fur-stadtebau', 'vektordaten', 'stzh', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-03T03:43:47.835195`
