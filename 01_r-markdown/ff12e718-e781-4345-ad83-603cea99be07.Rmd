...
- **Keywords.de** `['inventar', 'amt-fur-stadtebau', 'stzh', 'zustandigkeit', 'geoportal', 'vektordaten', 'denkmalpflege', 'kanton-zurich', 'polygondaten', 'geodaten', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-11T03:25:02.924714`
