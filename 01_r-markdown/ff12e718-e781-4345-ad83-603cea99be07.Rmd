...
- **Keywords.de** `['polygondaten', 'stzh', 'denkmalpflege', 'zustandigkeit', 'amt-fur-stadtebau', 'kanton-zurich', 'denkmalschutzobjekte', 'inventar', 'vektordaten', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-03-11T03:34:56.524565`
