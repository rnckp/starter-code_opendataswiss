...
- **Keywords.de** `['vektordaten', 'kanton-zurich', 'polygondaten', 'amt-fur-stadtebau', 'stzh', 'zustandigkeit', 'geodaten', 'inventar', 'denkmalpflege', 'geoportal', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-15T03:51:43.265192`
