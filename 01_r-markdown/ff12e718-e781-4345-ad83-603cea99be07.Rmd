...
- **Keywords.de** `['inventar', 'stzh', 'polygondaten', 'vektordaten', 'amt-fur-stadtebau', 'denkmalpflege', 'geoportal', 'kanton-zurich', 'denkmalschutzobjekte', 'zustandigkeit', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-28T04:42:07.862793`
