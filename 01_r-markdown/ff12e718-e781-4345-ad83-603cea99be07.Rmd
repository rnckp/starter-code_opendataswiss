...
- **Keywords.de** `['geoportal', 'zustandigkeit', 'kanton-zurich', 'denkmalschutzobjekte', 'denkmalpflege', 'geodaten', 'inventar', 'vektordaten', 'amt-fur-stadtebau', 'stzh', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-24T03:22:12.083276`
