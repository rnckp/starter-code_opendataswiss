...
- **Keywords.de** `['geodaten', 'denkmalpflege', 'kanton-zurich', 'stzh', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'inventar', 'geoportal', 'zustandigkeit', 'polygondaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-19T04:11:37.157130`
