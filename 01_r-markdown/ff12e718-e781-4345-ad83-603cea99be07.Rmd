...
- **Keywords.de** `['zustandigkeit', 'vektordaten', 'geodaten', 'amt-fur-stadtebau', 'kanton-zurich', 'denkmalschutzobjekte', 'denkmalpflege', 'polygondaten', 'inventar', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-04T03:14:22.316439`
