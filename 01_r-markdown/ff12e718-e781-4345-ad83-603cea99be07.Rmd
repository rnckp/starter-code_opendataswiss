...
- **Keywords.de** `['vektordaten', 'polygondaten', 'denkmalschutzobjekte', 'inventar', 'denkmalpflege', 'amt-fur-stadtebau', 'kanton-zurich', 'stzh', 'zustandigkeit', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-01T03:40:40.152620`
