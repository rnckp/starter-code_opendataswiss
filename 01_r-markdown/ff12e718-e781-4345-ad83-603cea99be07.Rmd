...
- **Keywords.de** `['denkmalpflege', 'zustandigkeit', 'polygondaten', 'inventar', 'amt-fur-stadtebau', 'kanton-zurich', 'denkmalschutzobjekte', 'geodaten', 'vektordaten', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-05T03:28:53.694162`
