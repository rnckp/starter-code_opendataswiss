...
- **Keywords.de** `['denkmalpflege', 'vektordaten', 'zustandigkeit', 'stzh', 'amt-fur-stadtebau', 'geoportal', 'kanton-zurich', 'geodaten', 'denkmalschutzobjekte', 'polygondaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-14T03:19:39.030149`
