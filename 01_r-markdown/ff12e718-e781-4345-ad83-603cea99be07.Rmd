...
- **Keywords.de** `['zustandigkeit', 'geoportal', 'kanton-zurich', 'polygondaten', 'inventar', 'stzh', 'amt-fur-stadtebau', 'denkmalpflege', 'geodaten', 'denkmalschutzobjekte', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-18T03:31:07.770541`
