...
- **Keywords.de** `['zustandigkeit', 'amt-fur-stadtebau', 'stzh', 'denkmalpflege', 'kanton-zurich', 'inventar', 'vektordaten', 'geodaten', 'polygondaten', 'denkmalschutzobjekte', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-23T02:52:09.956430`
