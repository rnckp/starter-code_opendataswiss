...
- **Keywords.de** `['denkmalpflege', 'geoportal', 'kanton-zurich', 'stzh', 'amt-fur-stadtebau', 'vektordaten', 'inventar', 'polygondaten', 'denkmalschutzobjekte', 'zustandigkeit', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-09T02:23:43.881110`
