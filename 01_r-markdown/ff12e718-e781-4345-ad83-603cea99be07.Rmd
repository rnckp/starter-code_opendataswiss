...
- **Keywords.de** `['denkmalschutzobjekte', 'kanton-zurich', 'geoportal', 'zustandigkeit', 'inventar', 'geodaten', 'amt-fur-stadtebau', 'polygondaten', 'stzh', 'vektordaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-21T02:56:13.854587`
