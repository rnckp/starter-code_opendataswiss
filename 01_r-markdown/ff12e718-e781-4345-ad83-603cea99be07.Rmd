...
- **Keywords.de** `['kanton-zurich', 'polygondaten', 'vektordaten', 'denkmalschutzobjekte', 'geodaten', 'inventar', 'stzh', 'denkmalpflege', 'geoportal', 'zustandigkeit', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-29T02:47:26.538364`
