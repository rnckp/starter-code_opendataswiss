...
- **Keywords.de** `['geoportal', 'kanton-zurich', 'denkmalschutzobjekte', 'stzh', 'vektordaten', 'geodaten', 'inventar', 'zustandigkeit', 'denkmalpflege', 'polygondaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-19T04:29:30.031895`
