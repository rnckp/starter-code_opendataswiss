...
- **Keywords.de** `['kanton-zurich', 'geoportal', 'stzh', 'denkmalpflege', 'amt-fur-stadtebau', 'polygondaten', 'inventar', 'geodaten', 'denkmalschutzobjekte', 'vektordaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-06T03:37:46.590310`
