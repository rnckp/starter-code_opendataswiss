...
- **Keywords.de** `['denkmalpflege', 'inventar', 'polygondaten', 'kanton-zurich', 'vektordaten', 'stzh', 'denkmalschutzobjekte', 'zustandigkeit', 'geodaten', 'amt-fur-stadtebau', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-17T03:32:33.087363`
