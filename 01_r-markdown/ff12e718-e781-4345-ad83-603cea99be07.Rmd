...
- **Keywords.de** `['polygondaten', 'geoportal', 'zustandigkeit', 'vektordaten', 'denkmalschutzobjekte', 'inventar', 'kanton-zurich', 'stzh', 'amt-fur-stadtebau', 'denkmalpflege', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-18T02:17:05.763796`
