...
- **Keywords.de** `['polygondaten', 'denkmalpflege', 'zustandigkeit', 'amt-fur-stadtebau', 'inventar', 'kanton-zurich', 'geoportal', 'denkmalschutzobjekte', 'geodaten', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-14T02:56:20.380623`
