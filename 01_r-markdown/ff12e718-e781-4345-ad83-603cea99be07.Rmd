...
- **Keywords.de** `['inventar', 'amt-fur-stadtebau', 'polygondaten', 'kanton-zurich', 'stzh', 'geoportal', 'geodaten', 'denkmalpflege', 'zustandigkeit', 'vektordaten', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-29T02:51:15.563579`
