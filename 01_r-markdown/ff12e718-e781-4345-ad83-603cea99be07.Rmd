...
- **Keywords.de** `['amt-fur-stadtebau', 'stzh', 'kanton-zurich', 'denkmalpflege', 'vektordaten', 'zustandigkeit', 'inventar', 'geoportal', 'polygondaten', 'denkmalschutzobjekte', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-04T03:26:12.597301`
