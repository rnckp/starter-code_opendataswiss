...
- **Keywords.de** `['denkmalschutzobjekte', 'geoportal', 'amt-fur-stadtebau', 'vektordaten', 'inventar', 'polygondaten', 'kanton-zurich', 'stzh', 'geodaten', 'zustandigkeit', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-11T03:33:28.150764`
