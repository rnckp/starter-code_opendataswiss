...
- **Keywords.de** `['kanton-zurich', 'denkmalpflege', 'polygondaten', 'vektordaten', 'geodaten', 'geoportal', 'amt-fur-stadtebau', 'inventar', 'denkmalschutzobjekte', 'stzh', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-03T03:33:11.785885`
