...
- **Keywords.de** `['inventar', 'denkmalpflege', 'geoportal', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'polygondaten', 'geodaten', 'kanton-zurich', 'stzh', 'vektordaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-02T03:02:40.499263`
