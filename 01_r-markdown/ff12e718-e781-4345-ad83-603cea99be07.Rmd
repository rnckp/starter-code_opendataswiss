...
- **Keywords.de** `['denkmalpflege', 'stzh', 'geoportal', 'denkmalschutzobjekte', 'vektordaten', 'kanton-zurich', 'geodaten', 'amt-fur-stadtebau', 'polygondaten', 'zustandigkeit', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-09T04:21:30.884006`
