...
- **Keywords.de** `['geodaten', 'geoportal', 'denkmalschutzobjekte', 'denkmalpflege', 'kanton-zurich', 'amt-fur-stadtebau', 'zustandigkeit', 'stzh', 'polygondaten', 'vektordaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-18T03:27:06.338697`
