...
- **Keywords.de** `['geodaten', 'vektordaten', 'amt-fur-stadtebau', 'zustandigkeit', 'kanton-zurich', 'inventar', 'denkmalschutzobjekte', 'geoportal', 'denkmalpflege', 'stzh', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-27T03:54:11.266629`
