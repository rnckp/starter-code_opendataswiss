...
- **Keywords.de** `['vektordaten', 'stzh', 'polygondaten', 'denkmalpflege', 'denkmalschutzobjekte', 'geodaten', 'inventar', 'amt-fur-stadtebau', 'geoportal', 'zustandigkeit', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-14T03:38:03.873893`
