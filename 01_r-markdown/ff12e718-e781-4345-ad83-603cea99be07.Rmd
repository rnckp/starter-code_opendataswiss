...
- **Keywords.de** `['zustandigkeit', 'vektordaten', 'polygondaten', 'geoportal', 'denkmalschutzobjekte', 'geodaten', 'amt-fur-stadtebau', 'denkmalpflege', 'kanton-zurich', 'stzh', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-18T03:08:35.072636`
