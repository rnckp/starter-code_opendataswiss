...
- **Keywords.de** `['denkmalschutzobjekte', 'vektordaten', 'zustandigkeit', 'polygondaten', 'geoportal', 'geodaten', 'stzh', 'denkmalpflege', 'amt-fur-stadtebau', 'kanton-zurich', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-16T03:08:01.484799`
