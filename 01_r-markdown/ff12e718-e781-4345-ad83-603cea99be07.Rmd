...
- **Keywords.de** `['amt-fur-stadtebau', 'geoportal', 'geodaten', 'denkmalschutzobjekte', 'vektordaten', 'kanton-zurich', 'denkmalpflege', 'inventar', 'zustandigkeit', 'polygondaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-25T03:11:31.484740`
