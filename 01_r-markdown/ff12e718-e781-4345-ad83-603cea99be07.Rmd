...
- **Keywords.de** `['polygondaten', 'geodaten', 'geoportal', 'zustandigkeit', 'denkmalschutzobjekte', 'inventar', 'stzh', 'amt-fur-stadtebau', 'denkmalpflege', 'vektordaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-24T02:56:42.179852`
