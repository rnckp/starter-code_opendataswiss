...
- **Keywords.de** `['inventar', 'geodaten', 'geoportal', 'vektordaten', 'polygondaten', 'kanton-zurich', 'amt-fur-stadtebau', 'stzh', 'denkmalschutzobjekte', 'denkmalpflege', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-01T03:09:14.237961`
