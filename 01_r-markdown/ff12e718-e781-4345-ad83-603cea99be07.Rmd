...
- **Keywords.de** `['stzh', 'denkmalschutzobjekte', 'inventar', 'geoportal', 'zustandigkeit', 'vektordaten', 'polygondaten', 'denkmalpflege', 'geodaten', 'amt-fur-stadtebau', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-07T04:34:14.165833`
