...
- **Keywords.de** `['denkmalschutzobjekte', 'geoportal', 'vektordaten', 'stzh', 'amt-fur-stadtebau', 'polygondaten', 'kanton-zurich', 'inventar', 'denkmalpflege', 'zustandigkeit', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-22T03:37:09.363206`
