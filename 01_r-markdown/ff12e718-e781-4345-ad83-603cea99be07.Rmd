...
- **Keywords.de** `['vektordaten', 'denkmalpflege', 'inventar', 'stzh', 'kanton-zurich', 'zustandigkeit', 'geoportal', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'polygondaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-30T03:13:42.483260`
