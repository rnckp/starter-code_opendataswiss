...
- **Keywords.de** `['kanton-zurich', 'inventar', 'polygondaten', 'geodaten', 'zustandigkeit', 'geoportal', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'vektordaten', 'stzh', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-20T03:13:31.732185`
