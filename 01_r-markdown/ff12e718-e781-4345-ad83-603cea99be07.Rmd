...
- **Keywords.de** `['denkmalschutzobjekte', 'amt-fur-stadtebau', 'denkmalpflege', 'polygondaten', 'kanton-zurich', 'stzh', 'geoportal', 'inventar', 'vektordaten', 'geodaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-23T03:25:20.773149`
