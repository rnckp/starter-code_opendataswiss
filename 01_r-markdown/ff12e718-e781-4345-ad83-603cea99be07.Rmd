...
- **Keywords.de** `['polygondaten', 'denkmalpflege', 'zustandigkeit', 'vektordaten', 'inventar', 'amt-fur-stadtebau', 'geodaten', 'kanton-zurich', 'geoportal', 'stzh', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-02T04:01:50.364732`
