...
- **Keywords.de** `['geoportal', 'geodaten', 'denkmalpflege', 'zustandigkeit', 'kanton-zurich', 'stzh', 'polygondaten', 'inventar', 'denkmalschutzobjekte', 'vektordaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-02T03:31:13.343705`
