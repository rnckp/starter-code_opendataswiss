...
- **Keywords.de** `['stzh', 'polygondaten', 'kanton-zurich', 'vektordaten', 'geoportal', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'inventar', 'zustandigkeit', 'denkmalpflege', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-24T04:09:09.761099`
