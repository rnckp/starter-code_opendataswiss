...
- **Keywords.de** `['amt-fur-stadtebau', 'inventar', 'geodaten', 'kanton-zurich', 'vektordaten', 'stzh', 'denkmalpflege', 'zustandigkeit', 'geoportal', 'polygondaten', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-08T03:26:04.432802`
