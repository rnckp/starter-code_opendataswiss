...
- **Keywords.de** `['denkmalschutzobjekte', 'amt-fur-stadtebau', 'geoportal', 'zustandigkeit', 'geodaten', 'vektordaten', 'inventar', 'kanton-zurich', 'denkmalpflege', 'polygondaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-25T03:09:03.585161`
