...
- **Keywords.de** `['amt-fur-stadtebau', 'denkmalschutzobjekte', 'denkmalpflege', 'stzh', 'geodaten', 'kanton-zurich', 'geoportal', 'vektordaten', 'zustandigkeit', 'polygondaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-06T04:44:02.572896`
