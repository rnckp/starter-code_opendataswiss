...
- **Keywords.de** `['zustandigkeit', 'denkmalschutzobjekte', 'vektordaten', 'geodaten', 'denkmalpflege', 'inventar', 'stzh', 'amt-fur-stadtebau', 'kanton-zurich', 'geoportal', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-24T03:46:42.537482`
