...
- **Keywords.de** `['stzh', 'kanton-zurich', 'inventar', 'vektordaten', 'geodaten', 'denkmalpflege', 'polygondaten', 'amt-fur-stadtebau', 'geoportal', 'denkmalschutzobjekte', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-22T03:04:52.475535`
