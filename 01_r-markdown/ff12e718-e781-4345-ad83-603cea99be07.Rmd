...
- **Keywords.de** `['denkmalschutzobjekte', 'stzh', 'kanton-zurich', 'denkmalpflege', 'polygondaten', 'geoportal', 'zustandigkeit', 'vektordaten', 'geodaten', 'inventar', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-03T03:29:13.329045`
