...
- **Keywords.de** `['kanton-zurich', 'vektordaten', 'polygondaten', 'amt-fur-stadtebau', 'stzh', 'denkmalpflege', 'geodaten', 'geoportal', 'zustandigkeit', 'denkmalschutzobjekte', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-14T03:31:43.105047`
