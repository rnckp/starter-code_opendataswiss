...
- **Keywords.de** `['inventar', 'vektordaten', 'denkmalpflege', 'geoportal', 'amt-fur-stadtebau', 'polygondaten', 'stzh', 'geodaten', 'zustandigkeit', 'denkmalschutzobjekte', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-25T03:50:53.909677`
