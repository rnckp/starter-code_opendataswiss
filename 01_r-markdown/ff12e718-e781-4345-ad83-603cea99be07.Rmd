...
- **Keywords.de** `['denkmalpflege', 'denkmalschutzobjekte', 'inventar', 'kanton-zurich', 'amt-fur-stadtebau', 'stzh', 'geodaten', 'geoportal', 'polygondaten', 'vektordaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-09T03:11:23.739071`
