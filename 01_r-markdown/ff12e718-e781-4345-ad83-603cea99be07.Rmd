...
- **Keywords.de** `['denkmalpflege', 'geoportal', 'polygondaten', 'amt-fur-stadtebau', 'vektordaten', 'geodaten', 'denkmalschutzobjekte', 'stzh', 'zustandigkeit', 'kanton-zurich', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-26T03:19:51.534056`
