...
- **Keywords.de** `['inventar', 'geodaten', 'denkmalschutzobjekte', 'denkmalpflege', 'amt-fur-stadtebau', 'stzh', 'kanton-zurich', 'geoportal', 'vektordaten', 'zustandigkeit', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-30T03:23:05.275355`
