...
- **Keywords.de** `['amt-fur-stadtebau', 'denkmalpflege', 'zustandigkeit', 'geodaten', 'denkmalschutzobjekte', 'stzh', 'vektordaten', 'geoportal', 'kanton-zurich', 'polygondaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-06T03:20:23.182503`
