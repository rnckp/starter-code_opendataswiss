...
- **Keywords.de** `['inventar', 'kanton-zurich', 'geoportal', 'zustandigkeit', 'polygondaten', 'stzh', 'geodaten', 'denkmalschutzobjekte', 'vektordaten', 'denkmalpflege', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-28T02:57:25.561011`
