...
- **Keywords.de** `['kanton-zurich', 'denkmalschutzobjekte', 'vektordaten', 'geoportal', 'denkmalpflege', 'stzh', 'inventar', 'zustandigkeit', 'polygondaten', 'geodaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-11T03:13:54.859096`
