...
- **Keywords.de** `['geodaten', 'denkmalpflege', 'vektordaten', 'polygondaten', 'geoportal', 'amt-fur-stadtebau', 'stzh', 'kanton-zurich', 'zustandigkeit', 'inventar', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-31T03:31:22.992876`
