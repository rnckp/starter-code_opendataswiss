...
- **Keywords.de** `['geoportal', 'denkmalpflege', 'inventar', 'zustandigkeit', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'vektordaten', 'stzh', 'kanton-zurich', 'geodaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-30T03:06:03.957852`
