...
- **Keywords.de** `['inventar', 'vektordaten', 'amt-fur-stadtebau', 'polygondaten', 'denkmalschutzobjekte', 'denkmalpflege', 'kanton-zurich', 'stzh', 'zustandigkeit', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-03T03:34:11.897735`
