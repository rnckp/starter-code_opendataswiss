...
- **Keywords.de** `['amt-fur-stadtebau', 'kanton-zurich', 'denkmalschutzobjekte', 'vektordaten', 'inventar', 'geoportal', 'stzh', 'denkmalpflege', 'zustandigkeit', 'polygondaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-06T03:26:42.402660`
