...
- **Keywords.de** `['kanton-zurich', 'geoportal', 'polygondaten', 'geodaten', 'denkmalpflege', 'denkmalschutzobjekte', 'stzh', 'amt-fur-stadtebau', 'inventar', 'zustandigkeit', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-02T02:57:03.072776`
