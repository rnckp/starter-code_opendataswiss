...
- **Keywords.de** `['stzh', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'inventar', 'geodaten', 'vektordaten', 'denkmalpflege', 'geoportal', 'kanton-zurich', 'polygondaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-20T03:03:30.632808`
