...
- **Keywords.de** `['denkmalschutzobjekte', 'kanton-zurich', 'geoportal', 'stzh', 'vektordaten', 'geodaten', 'denkmalpflege', 'inventar', 'amt-fur-stadtebau', 'polygondaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-17T03:00:11.870927`
