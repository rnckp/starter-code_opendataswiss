...
- **Keywords.de** `['inventar', 'denkmalpflege', 'polygondaten', 'geoportal', 'geodaten', 'stzh', 'kanton-zurich', 'amt-fur-stadtebau', 'vektordaten', 'denkmalschutzobjekte', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-15T05:09:31.191507`
