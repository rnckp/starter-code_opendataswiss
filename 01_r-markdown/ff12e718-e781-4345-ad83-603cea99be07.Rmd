...
- **Keywords.de** `['amt-fur-stadtebau', 'geoportal', 'polygondaten', 'vektordaten', 'kanton-zurich', 'denkmalpflege', 'inventar', 'stzh', 'denkmalschutzobjekte', 'geodaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-31T02:53:03.319482`
