...
- **Keywords.de** `['kanton-zurich', 'amt-fur-stadtebau', 'inventar', 'zustandigkeit', 'denkmalschutzobjekte', 'denkmalpflege', 'stzh', 'vektordaten', 'polygondaten', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-16T03:31:12.426534`
