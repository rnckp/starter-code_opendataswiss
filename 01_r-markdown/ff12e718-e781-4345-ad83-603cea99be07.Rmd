...
- **Keywords.de** `['vektordaten', 'zustandigkeit', 'geodaten', 'inventar', 'denkmalpflege', 'denkmalschutzobjekte', 'kanton-zurich', 'amt-fur-stadtebau', 'geoportal', 'stzh', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-04T03:36:57.568421`
