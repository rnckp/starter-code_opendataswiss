...
- **Keywords.de** `['denkmalschutzobjekte', 'stzh', 'geoportal', 'inventar', 'amt-fur-stadtebau', 'polygondaten', 'geodaten', 'zustandigkeit', 'denkmalpflege', 'vektordaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-13T03:29:49.373914`
