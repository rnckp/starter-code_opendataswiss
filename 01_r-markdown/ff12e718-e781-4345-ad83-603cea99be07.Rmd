...
- **Keywords.de** `['geoportal', 'denkmalschutzobjekte', 'vektordaten', 'zustandigkeit', 'inventar', 'amt-fur-stadtebau', 'geodaten', 'stzh', 'denkmalpflege', 'polygondaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-03-07T03:02:32.602296`
