...
- **Keywords.de** `['stzh', 'amt-fur-stadtebau', 'vektordaten', 'polygondaten', 'inventar', 'geoportal', 'zustandigkeit', 'denkmalschutzobjekte', 'geodaten', 'denkmalpflege', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-20T02:32:43.670275`
