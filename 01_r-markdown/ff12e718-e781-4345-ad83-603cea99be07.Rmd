...
- **Keywords.de** `['stzh', 'inventar', 'geoportal', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'vektordaten', 'kanton-zurich', 'polygondaten', 'zustandigkeit', 'geodaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-25T03:15:40.044454`
