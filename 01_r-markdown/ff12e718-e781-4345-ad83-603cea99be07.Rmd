...
- **Keywords.de** `['geodaten', 'kanton-zurich', 'stzh', 'inventar', 'geoportal', 'denkmalpflege', 'polygondaten', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'vektordaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-03T05:33:46.142147`
