...
- **Keywords.de** `['amt-fur-stadtebau', 'geoportal', 'kanton-zurich', 'zustandigkeit', 'vektordaten', 'denkmalpflege', 'inventar', 'stzh', 'polygondaten', 'denkmalschutzobjekte', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-03T02:53:48.205298`
