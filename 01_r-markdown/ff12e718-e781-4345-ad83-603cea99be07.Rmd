...
- **Keywords.de** `['geodaten', 'denkmalpflege', 'kanton-zurich', 'stzh', 'inventar', 'geoportal', 'zustandigkeit', 'denkmalschutzobjekte', 'vektordaten', 'polygondaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-04T03:21:25.052250`
