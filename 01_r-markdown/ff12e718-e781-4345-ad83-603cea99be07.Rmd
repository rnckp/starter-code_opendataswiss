...
- **Keywords.de** `['denkmalschutzobjekte', 'amt-fur-stadtebau', 'geodaten', 'denkmalpflege', 'zustandigkeit', 'polygondaten', 'geoportal', 'stzh', 'vektordaten', 'inventar', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-27T03:14:37.181767`
