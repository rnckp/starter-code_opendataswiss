...
- **Keywords.de** `['denkmalpflege', 'zustandigkeit', 'kanton-zurich', 'amt-fur-stadtebau', 'polygondaten', 'vektordaten', 'stzh', 'denkmalschutzobjekte', 'inventar', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-03T03:30:05.616271`
