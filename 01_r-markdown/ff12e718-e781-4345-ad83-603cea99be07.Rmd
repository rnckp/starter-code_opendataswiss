...
- **Keywords.de** `['amt-fur-stadtebau', 'geodaten', 'vektordaten', 'kanton-zurich', 'zustandigkeit', 'polygondaten', 'denkmalpflege', 'denkmalschutzobjekte', 'stzh', 'inventar', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-07T03:22:07.585424`
