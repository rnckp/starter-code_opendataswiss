...
- **Keywords.de** `['amt-fur-stadtebau', 'kanton-zurich', 'geodaten', 'stzh', 'zustandigkeit', 'polygondaten', 'denkmalpflege', 'vektordaten', 'inventar', 'denkmalschutzobjekte', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-17T03:48:08.710026`
