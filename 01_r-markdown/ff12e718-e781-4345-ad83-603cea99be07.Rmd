...
- **Keywords.de** `['geodaten', 'kanton-zurich', 'vektordaten', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'stzh', 'geoportal', 'denkmalpflege', 'polygondaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-19T04:04:16.919884`
