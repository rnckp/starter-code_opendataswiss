...
- **Keywords.de** `['polygondaten', 'denkmalschutzobjekte', 'geoportal', 'kanton-zurich', 'stzh', 'inventar', 'geodaten', 'denkmalpflege', 'vektordaten', 'amt-fur-stadtebau', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-25T03:16:57.320254`
