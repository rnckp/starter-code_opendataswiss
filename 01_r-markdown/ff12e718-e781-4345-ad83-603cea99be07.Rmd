...
- **Keywords.de** `['geoportal', 'polygondaten', 'denkmalpflege', 'stzh', 'zustandigkeit', 'inventar', 'vektordaten', 'geodaten', 'kanton-zurich', 'amt-fur-stadtebau', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-29T03:31:47.088765`
