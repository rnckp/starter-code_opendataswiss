...
- **Keywords.de** `['denkmalpflege', 'geodaten', 'geoportal', 'zustandigkeit', 'polygondaten', 'amt-fur-stadtebau', 'vektordaten', 'denkmalschutzobjekte', 'kanton-zurich', 'stzh', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-10T03:27:19.730003`
