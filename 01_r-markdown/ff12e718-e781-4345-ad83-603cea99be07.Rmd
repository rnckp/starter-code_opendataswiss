...
- **Keywords.de** `['denkmalschutzobjekte', 'geodaten', 'stzh', 'amt-fur-stadtebau', 'vektordaten', 'inventar', 'kanton-zurich', 'denkmalpflege', 'zustandigkeit', 'geoportal', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-14T03:10:37.199709`
