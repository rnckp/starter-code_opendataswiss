...
- **Keywords.de** `['geoportal', 'polygondaten', 'inventar', 'geodaten', 'denkmalschutzobjekte', 'kanton-zurich', 'stzh', 'amt-fur-stadtebau', 'zustandigkeit', 'vektordaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-16T03:13:38.428158`
