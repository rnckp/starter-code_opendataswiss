...
- **Keywords.de** `['denkmalschutzobjekte', 'stzh', 'polygondaten', 'zustandigkeit', 'amt-fur-stadtebau', 'geodaten', 'inventar', 'vektordaten', 'denkmalpflege', 'kanton-zurich', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-18T03:09:48.324928`
