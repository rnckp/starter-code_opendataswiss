...
- **Keywords.de** `['stzh', 'geodaten', 'geoportal', 'denkmalpflege', 'polygondaten', 'zustandigkeit', 'amt-fur-stadtebau', 'vektordaten', 'denkmalschutzobjekte', 'kanton-zurich', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-06T02:49:11.770807`
