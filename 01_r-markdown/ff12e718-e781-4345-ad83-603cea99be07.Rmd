...
- **Keywords.de** `['polygondaten', 'vektordaten', 'inventar', 'geodaten', 'geoportal', 'stzh', 'denkmalschutzobjekte', 'kanton-zurich', 'zustandigkeit', 'denkmalpflege', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-17T03:42:34.532196`
