...
- **Keywords.de** `['polygondaten', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalpflege', 'stzh', 'geodaten', 'inventar', 'vektordaten', 'denkmalschutzobjekte', 'kanton-zurich', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-16T03:26:54.828118`
