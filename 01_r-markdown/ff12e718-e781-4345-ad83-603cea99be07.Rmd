...
- **Keywords.de** `['amt-fur-stadtebau', 'geodaten', 'stzh', 'vektordaten', 'inventar', 'zustandigkeit', 'geoportal', 'denkmalpflege', 'denkmalschutzobjekte', 'polygondaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-10T03:14:03.015567`
