...
- **Keywords.de** `['denkmalschutzobjekte', 'kanton-zurich', 'geoportal', 'amt-fur-stadtebau', 'geodaten', 'zustandigkeit', 'vektordaten', 'stzh', 'polygondaten', 'denkmalpflege', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-01T03:57:35.855032`
