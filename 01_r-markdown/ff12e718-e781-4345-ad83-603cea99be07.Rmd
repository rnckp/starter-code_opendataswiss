...
- **Keywords.de** `['polygondaten', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'denkmalpflege', 'vektordaten', 'geodaten', 'inventar', 'geoportal', 'zustandigkeit', 'kanton-zurich', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-11T02:59:02.224598`
