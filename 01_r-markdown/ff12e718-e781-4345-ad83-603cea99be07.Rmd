...
- **Keywords.de** `['denkmalschutzobjekte', 'denkmalpflege', 'zustandigkeit', 'inventar', 'geodaten', 'stzh', 'kanton-zurich', 'geoportal', 'polygondaten', 'vektordaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-22T02:05:36.669699`
