...
- **Keywords.de** `['stzh', 'geoportal', 'denkmalpflege', 'geodaten', 'inventar', 'amt-fur-stadtebau', 'zustandigkeit', 'kanton-zurich', 'denkmalschutzobjekte', 'polygondaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-22T02:44:53.850858`
