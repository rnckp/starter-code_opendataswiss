...
- **Keywords.de** `['geoportal', 'zustandigkeit', 'stzh', 'inventar', 'denkmalschutzobjekte', 'vektordaten', 'geodaten', 'amt-fur-stadtebau', 'polygondaten', 'denkmalpflege', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-23T03:10:40.501209`
