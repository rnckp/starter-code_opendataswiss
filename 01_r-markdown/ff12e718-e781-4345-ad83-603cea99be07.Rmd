...
- **Keywords.de** `['amt-fur-stadtebau', 'inventar', 'kanton-zurich', 'geodaten', 'polygondaten', 'zustandigkeit', 'denkmalschutzobjekte', 'vektordaten', 'stzh', 'geoportal', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-17T02:46:12.491032`
