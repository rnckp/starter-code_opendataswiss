...
- **Keywords.de** `['denkmalschutzobjekte', 'amt-fur-stadtebau', 'inventar', 'kanton-zurich', 'geoportal', 'denkmalpflege', 'zustandigkeit', 'stzh', 'geodaten', 'vektordaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-15T03:35:57.931688`
