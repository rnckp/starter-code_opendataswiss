...
- **Keywords.de** `['geoportal', 'polygondaten', 'denkmalschutzobjekte', 'geodaten', 'stzh', 'inventar', 'denkmalpflege', 'kanton-zurich', 'zustandigkeit', 'amt-fur-stadtebau', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-08T02:47:10.519210`
