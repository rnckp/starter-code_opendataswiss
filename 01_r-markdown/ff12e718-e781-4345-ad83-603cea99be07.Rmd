...
- **Keywords.de** `['kanton-zurich', 'stzh', 'vektordaten', 'inventar', 'denkmalpflege', 'geodaten', 'zustandigkeit', 'denkmalschutzobjekte', 'geoportal', 'polygondaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-10T04:11:52.381483`
