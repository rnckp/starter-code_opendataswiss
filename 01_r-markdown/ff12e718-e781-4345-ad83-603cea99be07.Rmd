...
- **Keywords.de** `['polygondaten', 'geodaten', 'kanton-zurich', 'stzh', 'vektordaten', 'denkmalpflege', 'geoportal', 'inventar', 'zustandigkeit', 'denkmalschutzobjekte', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-20T02:48:46.547065`
