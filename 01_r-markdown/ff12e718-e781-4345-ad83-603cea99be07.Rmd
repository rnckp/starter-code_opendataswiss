...
- **Keywords.de** `['denkmalschutzobjekte', 'vektordaten', 'zustandigkeit', 'geoportal', 'geodaten', 'kanton-zurich', 'stzh', 'polygondaten', 'inventar', 'amt-fur-stadtebau', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-17T04:03:59.802692`
