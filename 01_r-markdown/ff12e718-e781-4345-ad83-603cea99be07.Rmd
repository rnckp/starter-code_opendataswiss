...
- **Keywords.de** `['vektordaten', 'geoportal', 'denkmalschutzobjekte', 'geodaten', 'zustandigkeit', 'kanton-zurich', 'stzh', 'amt-fur-stadtebau', 'polygondaten', 'denkmalpflege', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-29T03:33:55.948854`
