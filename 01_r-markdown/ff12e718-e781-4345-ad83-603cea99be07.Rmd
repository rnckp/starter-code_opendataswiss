...
- **Keywords.de** `['stzh', 'kanton-zurich', 'vektordaten', 'geoportal', 'polygondaten', 'zustandigkeit', 'inventar', 'amt-fur-stadtebau', 'geodaten', 'denkmalschutzobjekte', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-15T03:23:21.413010`
