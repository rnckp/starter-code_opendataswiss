...
- **Keywords.de** `['zustandigkeit', 'amt-fur-stadtebau', 'vektordaten', 'polygondaten', 'denkmalpflege', 'denkmalschutzobjekte', 'inventar', 'geodaten', 'kanton-zurich', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-14T03:11:50.679166`
