...
- **Keywords.de** `['geoportal', 'polygondaten', 'stzh', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'denkmalpflege', 'vektordaten', 'inventar', 'geodaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-14T03:25:24.632969`
