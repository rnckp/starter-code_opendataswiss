...
- **Keywords.de** `['inventar', 'geoportal', 'denkmalschutzobjekte', 'geodaten', 'vektordaten', 'amt-fur-stadtebau', 'zustandigkeit', 'kanton-zurich', 'stzh', 'denkmalpflege', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-30T03:22:13.151341`
