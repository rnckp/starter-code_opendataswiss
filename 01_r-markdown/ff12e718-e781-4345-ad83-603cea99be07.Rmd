...
- **Keywords.de** `['polygondaten', 'geoportal', 'vektordaten', 'denkmalpflege', 'denkmalschutzobjekte', 'zustandigkeit', 'amt-fur-stadtebau', 'stzh', 'geodaten', 'kanton-zurich', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-23T02:28:38.860006`
