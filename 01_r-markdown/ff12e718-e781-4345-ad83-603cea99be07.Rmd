...
- **Keywords.de** `['polygondaten', 'amt-fur-stadtebau', 'denkmalpflege', 'kanton-zurich', 'stzh', 'inventar', 'vektordaten', 'geoportal', 'zustandigkeit', 'denkmalschutzobjekte', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-03-03T03:08:12.668576`
