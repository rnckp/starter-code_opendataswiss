...
- **Keywords.de** `['stzh', 'geodaten', 'vektordaten', 'inventar', 'geoportal', 'denkmalpflege', 'denkmalschutzobjekte', 'zustandigkeit', 'amt-fur-stadtebau', 'polygondaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-09T03:13:29.909900`
