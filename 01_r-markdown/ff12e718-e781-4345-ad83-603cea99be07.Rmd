...
- **Keywords.de** `['zustandigkeit', 'geodaten', 'polygondaten', 'denkmalpflege', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'geoportal', 'inventar', 'stzh', 'kanton-zurich', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-01T04:01:16.393312`
