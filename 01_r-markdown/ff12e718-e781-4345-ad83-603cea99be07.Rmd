...
- **Keywords.de** `['geodaten', 'inventar', 'zustandigkeit', 'denkmalschutzobjekte', 'geoportal', 'polygondaten', 'vektordaten', 'denkmalpflege', 'kanton-zurich', 'amt-fur-stadtebau', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-09T03:24:22.829755`
