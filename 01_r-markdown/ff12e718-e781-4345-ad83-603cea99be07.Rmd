...
- **Keywords.de** `['denkmalschutzobjekte', 'zustandigkeit', 'denkmalpflege', 'inventar', 'kanton-zurich', 'geoportal', 'amt-fur-stadtebau', 'geodaten', 'vektordaten', 'stzh', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-31T03:30:13.162276`
