...
- **Keywords.de** `['amt-fur-stadtebau', 'kanton-zurich', 'stzh', 'denkmalschutzobjekte', 'denkmalpflege', 'vektordaten', 'geodaten', 'zustandigkeit', 'polygondaten', 'inventar', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-03-01T03:21:15.325795`
