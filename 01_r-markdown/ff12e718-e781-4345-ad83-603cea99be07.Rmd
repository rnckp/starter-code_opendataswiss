...
- **Keywords.de** `['kanton-zurich', 'denkmalpflege', 'geodaten', 'polygondaten', 'inventar', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'vektordaten', 'geoportal', 'zustandigkeit', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-22T03:21:11.417119`
