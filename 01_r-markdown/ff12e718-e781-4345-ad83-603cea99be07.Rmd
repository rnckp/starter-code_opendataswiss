...
- **Keywords.de** `['denkmalpflege', 'amt-fur-stadtebau', 'inventar', 'polygondaten', 'zustandigkeit', 'kanton-zurich', 'vektordaten', 'geodaten', 'geoportal', 'stzh', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-30T02:56:53.322333`
