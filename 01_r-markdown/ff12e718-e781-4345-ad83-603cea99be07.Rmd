...
- **Keywords.de** `['vektordaten', 'denkmalschutzobjekte', 'stzh', 'inventar', 'denkmalpflege', 'geodaten', 'polygondaten', 'amt-fur-stadtebau', 'kanton-zurich', 'zustandigkeit', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-13T02:42:46.837569`
