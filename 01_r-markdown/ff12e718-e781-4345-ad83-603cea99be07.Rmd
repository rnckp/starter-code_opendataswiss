...
- **Keywords.de** `['denkmalpflege', 'geoportal', 'stzh', 'geodaten', 'polygondaten', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'kanton-zurich', 'zustandigkeit', 'vektordaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-17T03:13:02.511208`
