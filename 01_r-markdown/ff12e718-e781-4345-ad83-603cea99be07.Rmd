...
- **Keywords.de** `['geodaten', 'vektordaten', 'polygondaten', 'inventar', 'geoportal', 'denkmalpflege', 'amt-fur-stadtebau', 'zustandigkeit', 'kanton-zurich', 'stzh', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-16T03:05:34.198563`
