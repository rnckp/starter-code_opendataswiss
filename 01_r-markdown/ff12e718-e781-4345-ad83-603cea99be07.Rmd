...
- **Keywords.de** `['polygondaten', 'denkmalschutzobjekte', 'denkmalpflege', 'vektordaten', 'geoportal', 'kanton-zurich', 'amt-fur-stadtebau', 'geodaten', 'zustandigkeit', 'stzh', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-01T02:46:03.835824`
