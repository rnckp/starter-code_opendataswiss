...
- **Keywords.de** `['denkmalpflege', 'zustandigkeit', 'vektordaten', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'kanton-zurich', 'geodaten', 'stzh', 'geoportal', 'polygondaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-15T03:11:10.379871`
