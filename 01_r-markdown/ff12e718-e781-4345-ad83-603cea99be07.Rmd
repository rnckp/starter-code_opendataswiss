...
- **Keywords.de** `['geoportal', 'polygondaten', 'stzh', 'kanton-zurich', 'geodaten', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalpflege', 'inventar', 'denkmalschutzobjekte', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-01T03:01:14.638017`
