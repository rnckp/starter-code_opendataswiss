...
- **Keywords.de** `['denkmalschutzobjekte', 'zustandigkeit', 'inventar', 'kanton-zurich', 'denkmalpflege', 'stzh', 'amt-fur-stadtebau', 'geoportal', 'vektordaten', 'geodaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-08T02:33:27.679279`
