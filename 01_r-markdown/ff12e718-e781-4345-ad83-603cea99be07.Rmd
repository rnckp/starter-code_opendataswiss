...
- **Keywords.de** `['kanton-zurich', 'stzh', 'amt-fur-stadtebau', 'zustandigkeit', 'polygondaten', 'geodaten', 'denkmalpflege', 'geoportal', 'vektordaten', 'denkmalschutzobjekte', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-26T02:57:59.417960`
