...
- **Keywords.de** `['inventar', 'stzh', 'geodaten', 'polygondaten', 'denkmalschutzobjekte', 'denkmalpflege', 'amt-fur-stadtebau', 'geoportal', 'zustandigkeit', 'vektordaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-26T03:19:49.899929`
