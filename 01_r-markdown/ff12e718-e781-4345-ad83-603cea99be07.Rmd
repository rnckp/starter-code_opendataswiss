...
- **Keywords.de** `['denkmalpflege', 'geoportal', 'kanton-zurich', 'vektordaten', 'stzh', 'denkmalschutzobjekte', 'inventar', 'amt-fur-stadtebau', 'zustandigkeit', 'polygondaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-30T03:07:40.971855`
