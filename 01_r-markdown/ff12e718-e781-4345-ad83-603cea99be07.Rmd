...
- **Keywords.de** `['denkmalschutzobjekte', 'vektordaten', 'geoportal', 'polygondaten', 'inventar', 'kanton-zurich', 'amt-fur-stadtebau', 'geodaten', 'zustandigkeit', 'stzh', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-03T04:05:49.148853`
