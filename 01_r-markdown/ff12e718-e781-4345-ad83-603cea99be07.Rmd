...
- **Keywords.de** `['polygondaten', 'amt-fur-stadtebau', 'vektordaten', 'denkmalschutzobjekte', 'denkmalpflege', 'stzh', 'inventar', 'kanton-zurich', 'geodaten', 'zustandigkeit', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-19T03:34:05.765034`
