...
- **Keywords.de** `['stzh', 'inventar', 'kanton-zurich', 'amt-fur-stadtebau', 'geoportal', 'vektordaten', 'zustandigkeit', 'denkmalpflege', 'geodaten', 'denkmalschutzobjekte', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-08T02:55:57.429009`
