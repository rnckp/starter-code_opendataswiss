...
- **Keywords.de** `['inventar', 'stzh', 'zustandigkeit', 'vektordaten', 'kanton-zurich', 'denkmalpflege', 'denkmalschutzobjekte', 'geoportal', 'geodaten', 'polygondaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-07T03:23:52.438128`
