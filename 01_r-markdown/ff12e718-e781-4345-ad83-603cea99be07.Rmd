...
- **Keywords.de** `['geodaten', 'geoportal', 'vektordaten', 'denkmalpflege', 'denkmalschutzobjekte', 'polygondaten', 'stzh', 'inventar', 'kanton-zurich', 'amt-fur-stadtebau', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-11T03:18:03.325361`
