...
- **Keywords.de** `['zustandigkeit', 'polygondaten', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'vektordaten', 'geodaten', 'kanton-zurich', 'stzh', 'inventar', 'geoportal', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-28T03:09:22.845694`
