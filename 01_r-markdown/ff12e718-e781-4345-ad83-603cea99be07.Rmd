...
- **Keywords.de** `['polygondaten', 'denkmalschutzobjekte', 'kanton-zurich', 'denkmalpflege', 'amt-fur-stadtebau', 'geoportal', 'zustandigkeit', 'geodaten', 'vektordaten', 'stzh', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-05T03:28:00.424743`
