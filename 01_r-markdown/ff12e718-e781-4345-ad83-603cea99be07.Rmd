...
- **Keywords.de** `['denkmalpflege', 'zustandigkeit', 'geoportal', 'denkmalschutzobjekte', 'polygondaten', 'amt-fur-stadtebau', 'stzh', 'vektordaten', 'inventar', 'geodaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-02T03:21:07.319944`
