...
- **Keywords.de** `['inventar', 'kanton-zurich', 'geodaten', 'geoportal', 'polygondaten', 'amt-fur-stadtebau', 'vektordaten', 'zustandigkeit', 'denkmalschutzobjekte', 'stzh', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-28T02:46:48.027750`
