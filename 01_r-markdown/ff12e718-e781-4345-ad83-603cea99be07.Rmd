...
- **Keywords.de** `['zustandigkeit', 'vektordaten', 'kanton-zurich', 'geoportal', 'denkmalpflege', 'amt-fur-stadtebau', 'geodaten', 'stzh', 'denkmalschutzobjekte', 'inventar', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-22T02:58:26.429207`
