...
- **Keywords.de** `['geodaten', 'denkmalpflege', 'denkmalschutzobjekte', 'vektordaten', 'zustandigkeit', 'polygondaten', 'inventar', 'geoportal', 'kanton-zurich', 'stzh', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-13T02:58:53.938425`
