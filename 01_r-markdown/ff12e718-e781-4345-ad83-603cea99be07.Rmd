...
- **Keywords.de** `['kanton-zurich', 'geodaten', 'stzh', 'vektordaten', 'geoportal', 'denkmalschutzobjekte', 'zustandigkeit', 'inventar', 'denkmalpflege', 'amt-fur-stadtebau', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-23T02:43:45.433446`
