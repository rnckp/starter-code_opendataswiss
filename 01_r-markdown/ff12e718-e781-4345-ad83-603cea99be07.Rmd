...
- **Keywords.de** `['inventar', 'geoportal', 'polygondaten', 'amt-fur-stadtebau', 'vektordaten', 'denkmalpflege', 'stzh', 'geodaten', 'zustandigkeit', 'denkmalschutzobjekte', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-31T03:35:35.483822`
