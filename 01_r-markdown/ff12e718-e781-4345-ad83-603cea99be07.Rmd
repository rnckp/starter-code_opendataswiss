...
- **Keywords.de** `['stzh', 'denkmalpflege', 'geoportal', 'kanton-zurich', 'polygondaten', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'inventar', 'vektordaten', 'geodaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-22T03:17:38.656703`
