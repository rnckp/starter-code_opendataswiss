...
- **Keywords.de** `['polygondaten', 'geoportal', 'inventar', 'denkmalschutzobjekte', 'kanton-zurich', 'denkmalpflege', 'stzh', 'zustandigkeit', 'vektordaten', 'amt-fur-stadtebau', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-21T03:44:38.928531`
