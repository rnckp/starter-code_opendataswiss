...
- **Keywords.de** `['vektordaten', 'amt-fur-stadtebau', 'kanton-zurich', 'denkmalschutzobjekte', 'geoportal', 'denkmalpflege', 'geodaten', 'zustandigkeit', 'polygondaten', 'inventar', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-23T03:19:27.115503`
