...
- **Keywords.de** `['zustandigkeit', 'kanton-zurich', 'amt-fur-stadtebau', 'geodaten', 'vektordaten', 'denkmalschutzobjekte', 'polygondaten', 'geoportal', 'denkmalpflege', 'inventar', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-06T04:05:33.122822`
