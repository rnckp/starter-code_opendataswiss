...
- **Keywords.de** `['kanton-zurich', 'geodaten', 'geoportal', 'denkmalpflege', 'amt-fur-stadtebau', 'polygondaten', 'zustandigkeit', 'stzh', 'denkmalschutzobjekte', 'vektordaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-08T03:12:40.403453`
