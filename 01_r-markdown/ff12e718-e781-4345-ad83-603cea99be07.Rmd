...
- **Keywords.de** `['geodaten', 'denkmalschutzobjekte', 'inventar', 'vektordaten', 'zustandigkeit', 'amt-fur-stadtebau', 'stzh', 'denkmalpflege', 'polygondaten', 'kanton-zurich', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-07T02:36:04.645075`
