...
- **Keywords.de** `['stzh', 'denkmalschutzobjekte', 'inventar', 'kanton-zurich', 'zustandigkeit', 'geoportal', 'geodaten', 'vektordaten', 'denkmalpflege', 'amt-fur-stadtebau', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-21T03:43:59.385914`
