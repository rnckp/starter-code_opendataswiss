...
- **Keywords.de** `['denkmalschutzobjekte', 'vektordaten', 'stzh', 'geoportal', 'zustandigkeit', 'polygondaten', 'denkmalpflege', 'kanton-zurich', 'inventar', 'amt-fur-stadtebau', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-20T03:36:08.612505`
