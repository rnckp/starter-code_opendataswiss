...
- **Keywords.de** `['stzh', 'geodaten', 'zustandigkeit', 'denkmalpflege', 'amt-fur-stadtebau', 'geoportal', 'inventar', 'denkmalschutzobjekte', 'vektordaten', 'polygondaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-12T03:11:56.390229`
