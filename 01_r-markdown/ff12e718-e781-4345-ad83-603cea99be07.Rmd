...
- **Keywords.de** `['polygondaten', 'zustandigkeit', 'denkmalpflege', 'vektordaten', 'stzh', 'amt-fur-stadtebau', 'geodaten', 'kanton-zurich', 'inventar', 'denkmalschutzobjekte', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-22T03:24:19.021009`
