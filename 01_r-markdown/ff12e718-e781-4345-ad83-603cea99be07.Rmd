...
- **Keywords.de** `['kanton-zurich', 'amt-fur-stadtebau', 'geodaten', 'geoportal', 'denkmalschutzobjekte', 'inventar', 'zustandigkeit', 'polygondaten', 'denkmalpflege', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-24T02:17:32.638285`
