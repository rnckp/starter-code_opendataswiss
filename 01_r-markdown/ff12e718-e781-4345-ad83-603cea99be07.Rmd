...
- **Keywords.de** `['kanton-zurich', 'stzh', 'geodaten', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'zustandigkeit', 'polygondaten', 'geoportal', 'denkmalpflege', 'vektordaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-21T03:26:43.129247`
