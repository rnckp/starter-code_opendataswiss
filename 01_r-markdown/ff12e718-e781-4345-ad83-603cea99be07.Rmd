...
- **Keywords.de** `['denkmalpflege', 'denkmalschutzobjekte', 'inventar', 'stzh', 'polygondaten', 'zustandigkeit', 'geoportal', 'amt-fur-stadtebau', 'kanton-zurich', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-24T03:55:49.407518`
