...
- **Keywords.de** `['stzh', 'denkmalschutzobjekte', 'inventar', 'geodaten', 'kanton-zurich', 'amt-fur-stadtebau', 'vektordaten', 'zustandigkeit', 'geoportal', 'denkmalpflege', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-12T02:52:37.303727`
