...
- **Keywords.de** `['vektordaten', 'geoportal', 'zustandigkeit', 'geodaten', 'amt-fur-stadtebau', 'denkmalpflege', 'denkmalschutzobjekte', 'polygondaten', 'inventar', 'stzh', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-26T02:41:23.729554`
