...
- **Keywords.de** `['vektordaten', 'kanton-zurich', 'zustandigkeit', 'geodaten', 'stzh', 'polygondaten', 'geoportal', 'amt-fur-stadtebau', 'inventar', 'denkmalpflege', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-03T03:14:31.501371`
