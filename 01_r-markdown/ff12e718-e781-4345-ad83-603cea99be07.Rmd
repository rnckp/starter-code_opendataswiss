...
- **Keywords.de** `['stzh', 'inventar', 'amt-fur-stadtebau', 'vektordaten', 'denkmalpflege', 'geodaten', 'polygondaten', 'zustandigkeit', 'kanton-zurich', 'denkmalschutzobjekte', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-07T04:20:25.496504`
