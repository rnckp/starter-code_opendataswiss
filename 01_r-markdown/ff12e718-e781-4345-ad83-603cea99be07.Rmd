...
- **Keywords.de** `['kanton-zurich', 'denkmalschutzobjekte', 'zustandigkeit', 'geoportal', 'polygondaten', 'inventar', 'amt-fur-stadtebau', 'vektordaten', 'geodaten', 'denkmalpflege', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-03T03:01:47.459438`
