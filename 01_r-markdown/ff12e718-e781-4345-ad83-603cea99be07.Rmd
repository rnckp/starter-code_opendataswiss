...
- **Keywords.de** `['geodaten', 'denkmalpflege', 'zustandigkeit', 'vektordaten', 'amt-fur-stadtebau', 'geoportal', 'stzh', 'polygondaten', 'inventar', 'kanton-zurich', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-10T03:11:52.565419`
