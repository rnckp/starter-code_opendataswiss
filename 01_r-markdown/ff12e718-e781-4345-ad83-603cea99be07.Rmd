...
- **Keywords.de** `['inventar', 'denkmalpflege', 'amt-fur-stadtebau', 'kanton-zurich', 'polygondaten', 'geoportal', 'zustandigkeit', 'stzh', 'geodaten', 'vektordaten', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-25T02:48:55.345549`
