...
- **Keywords.de** `['geoportal', 'polygondaten', 'denkmalpflege', 'vektordaten', 'denkmalschutzobjekte', 'zustandigkeit', 'amt-fur-stadtebau', 'stzh', 'inventar', 'geodaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-21T03:23:22.123288`
