...
- **Keywords.de** `['geoportal', 'amt-fur-stadtebau', 'zustandigkeit', 'stzh', 'polygondaten', 'inventar', 'denkmalschutzobjekte', 'vektordaten', 'denkmalpflege', 'geodaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-25T03:09:46.674256`
