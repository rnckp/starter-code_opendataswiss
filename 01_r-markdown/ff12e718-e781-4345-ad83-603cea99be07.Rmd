...
- **Keywords.de** `['vektordaten', 'inventar', 'denkmalpflege', 'amt-fur-stadtebau', 'kanton-zurich', 'denkmalschutzobjekte', 'zustandigkeit', 'geodaten', 'geoportal', 'stzh', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-27T02:57:17.832548`
