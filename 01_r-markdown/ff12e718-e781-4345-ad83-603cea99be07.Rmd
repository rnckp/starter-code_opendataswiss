...
- **Keywords.de** `['denkmalpflege', 'zustandigkeit', 'amt-fur-stadtebau', 'inventar', 'geoportal', 'kanton-zurich', 'vektordaten', 'polygondaten', 'geodaten', 'denkmalschutzobjekte', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-29T02:31:55.468536`
