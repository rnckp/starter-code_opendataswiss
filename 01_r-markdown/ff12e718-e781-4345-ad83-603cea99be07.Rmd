...
- **Keywords.de** `['geoportal', 'inventar', 'kanton-zurich', 'denkmalschutzobjekte', 'polygondaten', 'zustandigkeit', 'vektordaten', 'geodaten', 'amt-fur-stadtebau', 'denkmalpflege', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-19T03:18:00.728112`
