...
- **Keywords.de** `['kanton-zurich', 'polygondaten', 'geoportal', 'denkmalschutzobjekte', 'zustandigkeit', 'vektordaten', 'denkmalpflege', 'inventar', 'geodaten', 'amt-fur-stadtebau', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-20T02:43:58.133686`
