...
- **Keywords.de** `['amt-fur-stadtebau', 'vektordaten', 'zustandigkeit', 'denkmalschutzobjekte', 'kanton-zurich', 'geoportal', 'geodaten', 'stzh', 'denkmalpflege', 'polygondaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-23T03:09:11.358220`
