...
- **Keywords.de** `['zustandigkeit', 'kanton-zurich', 'stzh', 'geodaten', 'denkmalpflege', 'polygondaten', 'denkmalschutzobjekte', 'vektordaten', 'amt-fur-stadtebau', 'geoportal', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-27T03:02:05.761868`
