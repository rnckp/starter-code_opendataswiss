...
- **Keywords.de** `['stzh', 'geodaten', 'kanton-zurich', 'denkmalpflege', 'inventar', 'polygondaten', 'geoportal', 'amt-fur-stadtebau', 'vektordaten', 'denkmalschutzobjekte', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-11T03:27:28.853396`
