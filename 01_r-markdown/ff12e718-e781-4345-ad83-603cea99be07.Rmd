...
- **Keywords.de** `['inventar', 'polygondaten', 'geoportal', 'amt-fur-stadtebau', 'vektordaten', 'geodaten', 'kanton-zurich', 'denkmalpflege', 'stzh', 'zustandigkeit', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-23T03:30:27.693117`
