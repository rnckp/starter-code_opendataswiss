...
- **Keywords.de** `['denkmalpflege', 'stzh', 'zustandigkeit', 'geoportal', 'polygondaten', 'geodaten', 'inventar', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'kanton-zurich', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-21T02:13:05.564421`
