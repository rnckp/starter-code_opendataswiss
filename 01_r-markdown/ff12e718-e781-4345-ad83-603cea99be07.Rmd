...
- **Keywords.de** `['polygondaten', 'kanton-zurich', 'geodaten', 'stzh', 'geoportal', 'zustandigkeit', 'inventar', 'vektordaten', 'denkmalpflege', 'amt-fur-stadtebau', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-13T04:04:10.080862`
