...
- **Keywords.de** `['kanton-zurich', 'geoportal', 'polygondaten', 'zustandigkeit', 'denkmalschutzobjekte', 'stzh', 'vektordaten', 'denkmalpflege', 'amt-fur-stadtebau', 'geodaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-11T05:10:18.475499`
