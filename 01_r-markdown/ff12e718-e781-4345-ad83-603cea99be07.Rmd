...
- **Keywords.de** `['denkmalpflege', 'vektordaten', 'zustandigkeit', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'geoportal', 'inventar', 'kanton-zurich', 'geodaten', 'polygondaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-15T03:36:54.354774`
