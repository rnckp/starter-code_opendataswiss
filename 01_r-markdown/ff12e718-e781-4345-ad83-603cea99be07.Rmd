...
- **Keywords.de** `['denkmalschutzobjekte', 'denkmalpflege', 'stzh', 'geoportal', 'geodaten', 'vektordaten', 'amt-fur-stadtebau', 'kanton-zurich', 'zustandigkeit', 'inventar', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-19T03:14:59.416627`
