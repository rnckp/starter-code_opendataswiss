...
- **Keywords.de** `['kanton-zurich', 'denkmalschutzobjekte', 'vektordaten', 'denkmalpflege', 'geoportal', 'stzh', 'zustandigkeit', 'inventar', 'amt-fur-stadtebau', 'geodaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-21T03:12:47.260965`
