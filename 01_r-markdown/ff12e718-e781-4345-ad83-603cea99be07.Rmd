...
- **Keywords.de** `['zustandigkeit', 'geodaten', 'kanton-zurich', 'stzh', 'geoportal', 'inventar', 'amt-fur-stadtebau', 'vektordaten', 'denkmalschutzobjekte', 'polygondaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-08T03:53:28.366220`
