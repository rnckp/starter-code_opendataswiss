...
- **Keywords.de** `['inventar', 'geoportal', 'stzh', 'vektordaten', 'geodaten', 'zustandigkeit', 'denkmalpflege', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'polygondaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-01T02:54:13.223761`
