...
- **Keywords.de** `['denkmalschutzobjekte', 'polygondaten', 'geodaten', 'geoportal', 'stzh', 'denkmalpflege', 'zustandigkeit', 'kanton-zurich', 'vektordaten', 'amt-fur-stadtebau', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-07T03:31:14.335125`
