...
- **Keywords.de** `['vektordaten', 'amt-fur-stadtebau', 'geodaten', 'denkmalschutzobjekte', 'geoportal', 'denkmalpflege', 'stzh', 'kanton-zurich', 'inventar', 'polygondaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-27T03:08:36.323637`
