...
- **Keywords.de** `['stzh', 'denkmalschutzobjekte', 'geoportal', 'zustandigkeit', 'vektordaten', 'denkmalpflege', 'inventar', 'geodaten', 'polygondaten', 'kanton-zurich', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-21T03:34:47.763297`
