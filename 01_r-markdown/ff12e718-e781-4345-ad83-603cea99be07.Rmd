...
- **Keywords.de** `['kanton-zurich', 'polygondaten', 'denkmalschutzobjekte', 'vektordaten', 'inventar', 'stzh', 'zustandigkeit', 'geoportal', 'denkmalpflege', 'amt-fur-stadtebau', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-10T03:05:50.230728`
