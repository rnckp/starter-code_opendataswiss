...
- **Keywords.de** `['vektordaten', 'denkmalschutzobjekte', 'inventar', 'zustandigkeit', 'amt-fur-stadtebau', 'polygondaten', 'geoportal', 'denkmalpflege', 'stzh', 'kanton-zurich', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-20T03:50:24.653438`
