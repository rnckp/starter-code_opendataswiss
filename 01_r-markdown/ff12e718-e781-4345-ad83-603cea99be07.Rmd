...
- **Keywords.de** `['geodaten', 'amt-fur-stadtebau', 'zustandigkeit', 'geoportal', 'polygondaten', 'kanton-zurich', 'vektordaten', 'stzh', 'denkmalpflege', 'inventar', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-01T03:39:47.894689`
