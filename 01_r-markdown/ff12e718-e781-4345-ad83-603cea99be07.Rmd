...
- **Keywords.de** `['geodaten', 'denkmalpflege', 'polygondaten', 'zustandigkeit', 'amt-fur-stadtebau', 'inventar', 'stzh', 'kanton-zurich', 'vektordaten', 'denkmalschutzobjekte', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-29T03:06:19.938395`
