...
- **Keywords.de** `['stzh', 'zustandigkeit', 'denkmalschutzobjekte', 'denkmalpflege', 'polygondaten', 'vektordaten', 'kanton-zurich', 'inventar', 'amt-fur-stadtebau', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-17T03:30:07.925919`
