...
- **Keywords.de** `['denkmalschutzobjekte', 'stzh', 'polygondaten', 'vektordaten', 'amt-fur-stadtebau', 'kanton-zurich', 'geoportal', 'denkmalpflege', 'inventar', 'geodaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-16T03:20:24.534976`
