...
- **Keywords.de** `['geodaten', 'inventar', 'polygondaten', 'kanton-zurich', 'denkmalpflege', 'geoportal', 'zustandigkeit', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-17T02:45:49.358007`
