...
- **Keywords.de** `['geodaten', 'denkmalschutzobjekte', 'zustandigkeit', 'kanton-zurich', 'polygondaten', 'inventar', 'stzh', 'amt-fur-stadtebau', 'geoportal', 'denkmalpflege', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-17T02:27:26.705943`
