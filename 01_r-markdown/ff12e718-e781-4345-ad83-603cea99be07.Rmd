...
- **Keywords.de** `['geoportal', 'zustandigkeit', 'geodaten', 'denkmalpflege', 'polygondaten', 'kanton-zurich', 'vektordaten', 'amt-fur-stadtebau', 'stzh', 'denkmalschutzobjekte', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-11T03:23:50.322269`
