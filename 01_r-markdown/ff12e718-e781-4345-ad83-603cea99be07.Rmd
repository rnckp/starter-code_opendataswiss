...
- **Keywords.de** `['denkmalschutzobjekte', 'denkmalpflege', 'geodaten', 'inventar', 'kanton-zurich', 'geoportal', 'zustandigkeit', 'stzh', 'vektordaten', 'polygondaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-18T02:15:20.404974`
