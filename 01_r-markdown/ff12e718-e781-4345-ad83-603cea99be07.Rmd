...
- **Keywords.de** `['stzh', 'inventar', 'kanton-zurich', 'polygondaten', 'amt-fur-stadtebau', 'denkmalpflege', 'vektordaten', 'denkmalschutzobjekte', 'geoportal', 'geodaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-04T02:58:04.323949`
