...
- **Keywords.de** `['kanton-zurich', 'geoportal', 'vektordaten', 'denkmalpflege', 'inventar', 'geodaten', 'polygondaten', 'stzh', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-13T03:40:43.558059`
