...
- **Keywords.de** `['vektordaten', 'polygondaten', 'inventar', 'amt-fur-stadtebau', 'geoportal', 'geodaten', 'zustandigkeit', 'denkmalpflege', 'kanton-zurich', 'denkmalschutzobjekte', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-19T02:51:31.836700`
