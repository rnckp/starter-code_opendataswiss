...
- **Keywords.de** `['zustandigkeit', 'geoportal', 'denkmalschutzobjekte', 'kanton-zurich', 'inventar', 'geodaten', 'amt-fur-stadtebau', 'vektordaten', 'denkmalpflege', 'stzh', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-07T04:24:25.322914`
