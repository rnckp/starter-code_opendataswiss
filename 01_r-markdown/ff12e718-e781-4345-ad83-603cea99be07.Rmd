...
- **Keywords.de** `['denkmalschutzobjekte', 'inventar', 'geoportal', 'stzh', 'polygondaten', 'vektordaten', 'denkmalpflege', 'geodaten', 'amt-fur-stadtebau', 'zustandigkeit', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-12T02:58:45.132767`
