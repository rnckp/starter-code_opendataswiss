...
- **Keywords.de** `['geodaten', 'denkmalpflege', 'amt-fur-stadtebau', 'inventar', 'polygondaten', 'denkmalschutzobjekte', 'zustandigkeit', 'geoportal', 'kanton-zurich', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-18T03:29:11.680794`
