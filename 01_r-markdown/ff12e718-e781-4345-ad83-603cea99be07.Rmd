...
- **Keywords.de** `['amt-fur-stadtebau', 'geodaten', 'inventar', 'kanton-zurich', 'stzh', 'denkmalpflege', 'zustandigkeit', 'vektordaten', 'geoportal', 'denkmalschutzobjekte', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-11T03:17:29.671751`
