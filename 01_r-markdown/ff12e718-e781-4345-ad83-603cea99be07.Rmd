...
- **Keywords.de** `['amt-fur-stadtebau', 'geodaten', 'polygondaten', 'zustandigkeit', 'vektordaten', 'stzh', 'inventar', 'denkmalschutzobjekte', 'geoportal', 'kanton-zurich', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-14T03:42:17.583709`
