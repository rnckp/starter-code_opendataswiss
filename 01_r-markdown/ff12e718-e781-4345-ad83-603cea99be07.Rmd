...
- **Keywords.de** `['denkmalpflege', 'stzh', 'polygondaten', 'geoportal', 'kanton-zurich', 'vektordaten', 'zustandigkeit', 'amt-fur-stadtebau', 'inventar', 'geodaten', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-09T03:51:16.222316`
