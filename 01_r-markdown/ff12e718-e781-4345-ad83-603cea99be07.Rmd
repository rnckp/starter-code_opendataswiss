...
- **Keywords.de** `['polygondaten', 'denkmalschutzobjekte', 'zustandigkeit', 'geoportal', 'denkmalpflege', 'kanton-zurich', 'stzh', 'geodaten', 'inventar', 'amt-fur-stadtebau', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-06T03:13:58.052830`
