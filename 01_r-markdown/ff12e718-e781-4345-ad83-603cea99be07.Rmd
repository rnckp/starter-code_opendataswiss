...
- **Keywords.de** `['stzh', 'denkmalschutzobjekte', 'kanton-zurich', 'inventar', 'vektordaten', 'geoportal', 'geodaten', 'zustandigkeit', 'denkmalpflege', 'polygondaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-30T03:00:48.548090`
