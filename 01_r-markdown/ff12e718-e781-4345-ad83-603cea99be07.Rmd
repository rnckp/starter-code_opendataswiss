...
- **Keywords.de** `['zustandigkeit', 'denkmalpflege', 'denkmalschutzobjekte', 'vektordaten', 'amt-fur-stadtebau', 'stzh', 'polygondaten', 'inventar', 'geoportal', 'geodaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-04T03:55:49.860881`
