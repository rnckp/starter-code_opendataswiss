...
- **Keywords.de** `['geoportal', 'polygondaten', 'denkmalpflege', 'stzh', 'zustandigkeit', 'geodaten', 'inventar', 'vektordaten', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-07T03:23:25.934976`
