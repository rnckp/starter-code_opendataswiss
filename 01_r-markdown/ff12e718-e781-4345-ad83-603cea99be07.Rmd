...
- **Keywords.de** `['stzh', 'inventar', 'geodaten', 'polygondaten', 'denkmalpflege', 'kanton-zurich', 'denkmalschutzobjekte', 'zustandigkeit', 'vektordaten', 'geoportal', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-25T03:35:07.425551`
