...
- **Keywords.de** `['inventar', 'geodaten', 'kanton-zurich', 'zustandigkeit', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'stzh', 'denkmalpflege', 'geoportal', 'polygondaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-09T06:14:12.066885`
