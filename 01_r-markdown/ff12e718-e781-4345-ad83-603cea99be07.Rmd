...
- **Keywords.de** `['geodaten', 'stzh', 'denkmalpflege', 'geoportal', 'vektordaten', 'kanton-zurich', 'amt-fur-stadtebau', 'zustandigkeit', 'inventar', 'denkmalschutzobjekte', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-21T03:31:59.663474`
