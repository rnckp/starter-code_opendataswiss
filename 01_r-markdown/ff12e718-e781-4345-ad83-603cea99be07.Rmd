...
- **Keywords.de** `['inventar', 'geodaten', 'stzh', 'vektordaten', 'denkmalpflege', 'zustandigkeit', 'kanton-zurich', 'amt-fur-stadtebau', 'geoportal', 'polygondaten', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-28T03:33:44.711664`
