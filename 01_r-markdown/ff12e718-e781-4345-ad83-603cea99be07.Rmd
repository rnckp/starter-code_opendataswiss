...
- **Keywords.de** `['kanton-zurich', 'geoportal', 'inventar', 'vektordaten', 'geodaten', 'denkmalschutzobjekte', 'zustandigkeit', 'denkmalpflege', 'amt-fur-stadtebau', 'stzh', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-28T03:06:59.732018`
