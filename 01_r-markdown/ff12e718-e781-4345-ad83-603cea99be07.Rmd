...
- **Keywords.de** `['denkmalpflege', 'geodaten', 'vektordaten', 'geoportal', 'denkmalschutzobjekte', 'zustandigkeit', 'kanton-zurich', 'polygondaten', 'amt-fur-stadtebau', 'inventar', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-21T03:22:23.937486`
