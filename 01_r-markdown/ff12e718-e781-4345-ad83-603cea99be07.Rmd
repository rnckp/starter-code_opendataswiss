...
- **Keywords.de** `['kanton-zurich', 'zustandigkeit', 'denkmalpflege', 'geodaten', 'vektordaten', 'stzh', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'polygondaten', 'inventar', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-15T03:00:20.462708`
