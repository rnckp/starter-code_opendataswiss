...
- **Keywords.de** `['kanton-zurich', 'denkmalpflege', 'stzh', 'polygondaten', 'geoportal', 'geodaten', 'zustandigkeit', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'inventar', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-16T03:40:07.334836`
