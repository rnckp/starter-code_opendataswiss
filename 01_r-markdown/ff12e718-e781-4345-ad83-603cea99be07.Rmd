...
- **Keywords.de** `['zustandigkeit', 'polygondaten', 'geoportal', 'vektordaten', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'stzh', 'kanton-zurich', 'inventar', 'geodaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-27T03:08:42.080629`
