...
- **Keywords.de** `['inventar', 'denkmalschutzobjekte', 'denkmalpflege', 'polygondaten', 'zustandigkeit', 'geoportal', 'vektordaten', 'stzh', 'kanton-zurich', 'geodaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-23T04:49:19.179961`
