...
- **Keywords.de** `['polygondaten', 'vektordaten', 'inventar', 'geoportal', 'stzh', 'denkmalpflege', 'denkmalschutzobjekte', 'kanton-zurich', 'amt-fur-stadtebau', 'geodaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-12T03:17:15.740533`
