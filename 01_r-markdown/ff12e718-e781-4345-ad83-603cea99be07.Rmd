...
- **Keywords.de** `['zustandigkeit', 'stzh', 'polygondaten', 'geoportal', 'denkmalpflege', 'denkmalschutzobjekte', 'vektordaten', 'geodaten', 'amt-fur-stadtebau', 'inventar', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-24T02:49:19.535883`
