...
- **Keywords.de** `['stzh', 'inventar', 'denkmalpflege', 'polygondaten', 'vektordaten', 'geoportal', 'geodaten', 'kanton-zurich', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-16T03:20:40.343309`
