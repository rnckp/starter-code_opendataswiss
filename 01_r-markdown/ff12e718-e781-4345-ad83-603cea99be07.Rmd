...
- **Keywords.de** `['amt-fur-stadtebau', 'geoportal', 'denkmalpflege', 'kanton-zurich', 'inventar', 'stzh', 'vektordaten', 'geodaten', 'zustandigkeit', 'polygondaten', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-30T03:33:11.643819`
