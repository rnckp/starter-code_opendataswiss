...
- **Keywords.de** `['zustandigkeit', 'geodaten', 'vektordaten', 'kanton-zurich', 'denkmalpflege', 'stzh', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'polygondaten', 'geoportal', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-24T03:49:45.356707`
