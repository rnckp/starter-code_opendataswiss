...
- **Keywords.de** `['polygondaten', 'stzh', 'kanton-zurich', 'geoportal', 'zustandigkeit', 'vektordaten', 'inventar', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'denkmalpflege', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-13T03:08:25.201945`
