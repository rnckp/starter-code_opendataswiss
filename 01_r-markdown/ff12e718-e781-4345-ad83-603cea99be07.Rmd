...
- **Keywords.de** `['inventar', 'stzh', 'kanton-zurich', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'vektordaten', 'denkmalpflege', 'geodaten', 'polygondaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-08T03:49:30.802036`
