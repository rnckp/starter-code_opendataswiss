...
- **Keywords.de** `['kanton-zurich', 'denkmalpflege', 'stzh', 'polygondaten', 'zustandigkeit', 'vektordaten', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'geodaten', 'geoportal', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-03-06T03:09:07.086247`
