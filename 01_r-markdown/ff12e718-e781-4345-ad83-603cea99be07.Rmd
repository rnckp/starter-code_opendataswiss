...
- **Keywords.de** `['amt-fur-stadtebau', 'geodaten', 'zustandigkeit', 'polygondaten', 'stzh', 'denkmalschutzobjekte', 'vektordaten', 'denkmalpflege', 'geoportal', 'kanton-zurich', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-14T03:28:51.772571`
