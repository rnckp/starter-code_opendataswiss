...
- **Keywords.de** `['polygondaten', 'geoportal', 'zustandigkeit', 'stzh', 'denkmalschutzobjekte', 'kanton-zurich', 'denkmalpflege', 'vektordaten', 'amt-fur-stadtebau', 'geodaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-06T02:53:41.078604`
