...
- **Keywords.de** `['geoportal', 'vektordaten', 'zustandigkeit', 'stzh', 'kanton-zurich', 'inventar', 'geodaten', 'amt-fur-stadtebau', 'polygondaten', 'denkmalpflege', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-28T03:29:29.927846`
