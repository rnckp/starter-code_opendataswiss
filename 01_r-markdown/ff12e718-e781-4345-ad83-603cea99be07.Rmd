...
- **Keywords.de** `['denkmalschutzobjekte', 'polygondaten', 'amt-fur-stadtebau', 'denkmalpflege', 'geoportal', 'stzh', 'kanton-zurich', 'inventar', 'geodaten', 'zustandigkeit', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-27T03:10:12.953861`
