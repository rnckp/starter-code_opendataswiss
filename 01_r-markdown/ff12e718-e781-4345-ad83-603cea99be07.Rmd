...
- **Keywords.de** `['zustandigkeit', 'stzh', 'amt-fur-stadtebau', 'vektordaten', 'kanton-zurich', 'denkmalschutzobjekte', 'polygondaten', 'denkmalpflege', 'inventar', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-14T03:02:38.294922`
