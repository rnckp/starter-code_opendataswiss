...
- **Keywords.de** `['denkmalschutzobjekte', 'geoportal', 'zustandigkeit', 'stzh', 'kanton-zurich', 'geodaten', 'denkmalpflege', 'polygondaten', 'inventar', 'vektordaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-23T04:10:31.510553`
