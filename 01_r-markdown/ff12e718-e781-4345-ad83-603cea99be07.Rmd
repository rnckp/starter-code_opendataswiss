...
- **Keywords.de** `['geoportal', 'vektordaten', 'denkmalpflege', 'geodaten', 'inventar', 'denkmalschutzobjekte', 'kanton-zurich', 'zustandigkeit', 'stzh', 'polygondaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-22T03:09:17.242283`
