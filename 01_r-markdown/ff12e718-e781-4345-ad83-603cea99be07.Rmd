...
- **Keywords.de** `['polygondaten', 'zustandigkeit', 'stzh', 'amt-fur-stadtebau', 'vektordaten', 'inventar', 'geodaten', 'denkmalschutzobjekte', 'denkmalpflege', 'geoportal', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-12T03:10:49.711445`
