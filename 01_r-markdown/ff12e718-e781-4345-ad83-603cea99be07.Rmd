...
- **Keywords.de** `['polygondaten', 'stzh', 'denkmalschutzobjekte', 'inventar', 'vektordaten', 'geodaten', 'amt-fur-stadtebau', 'kanton-zurich', 'geoportal', 'denkmalpflege', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-05T03:05:30.393892`
