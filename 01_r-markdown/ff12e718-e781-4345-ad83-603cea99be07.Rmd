...
- **Keywords.de** `['zustandigkeit', 'amt-fur-stadtebau', 'denkmalpflege', 'kanton-zurich', 'geoportal', 'inventar', 'stzh', 'geodaten', 'polygondaten', 'denkmalschutzobjekte', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-22T03:39:27.398499`
