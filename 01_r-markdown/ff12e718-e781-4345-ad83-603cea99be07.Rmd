...
- **Keywords.de** `['stzh', 'vektordaten', 'polygondaten', 'amt-fur-stadtebau', 'geodaten', 'geoportal', 'zustandigkeit', 'denkmalpflege', 'denkmalschutzobjekte', 'kanton-zurich', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-01T03:43:11.389894`
