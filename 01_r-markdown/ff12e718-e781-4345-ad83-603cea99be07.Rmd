...
- **Keywords.de** `['geodaten', 'inventar', 'geoportal', 'stzh', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'denkmalpflege', 'kanton-zurich', 'vektordaten', 'zustandigkeit', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-26T03:35:45.068843`
