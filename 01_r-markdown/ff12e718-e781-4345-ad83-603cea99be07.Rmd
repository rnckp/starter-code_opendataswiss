...
- **Keywords.de** `['stzh', 'denkmalpflege', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'vektordaten', 'inventar', 'geodaten', 'kanton-zurich', 'zustandigkeit', 'geoportal', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-04T03:20:15.228876`
