...
- **Keywords.de** `['geodaten', 'geoportal', 'inventar', 'zustandigkeit', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'vektordaten', 'stzh', 'kanton-zurich', 'denkmalpflege', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-24T03:11:14.132020`
