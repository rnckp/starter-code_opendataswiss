...
- **Keywords.de** `['vektordaten', 'geodaten', 'denkmalschutzobjekte', 'geoportal', 'inventar', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalpflege', 'polygondaten', 'kanton-zurich', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-21T03:20:40.473510`
