...
- **Keywords.de** `['geoportal', 'stzh', 'kanton-zurich', 'denkmalpflege', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'inventar', 'polygondaten', 'zustandigkeit', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-17T02:52:16.652365`
