...
- **Keywords.de** `['stzh', 'amt-fur-stadtebau', 'geoportal', 'zustandigkeit', 'vektordaten', 'inventar', 'polygondaten', 'geodaten', 'denkmalschutzobjekte', 'kanton-zurich', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-21T03:17:43.253905`
