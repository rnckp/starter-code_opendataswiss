...
- **Keywords.de** `['inventar', 'geoportal', 'polygondaten', 'geodaten', 'zustandigkeit', 'kanton-zurich', 'stzh', 'denkmalschutzobjekte', 'denkmalpflege', 'vektordaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-24T03:10:03.646507`
