...
- **Keywords.de** `['vektordaten', 'inventar', 'amt-fur-stadtebau', 'stzh', 'geoportal', 'kanton-zurich', 'denkmalpflege', 'polygondaten', 'zustandigkeit', 'denkmalschutzobjekte', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-06T03:13:13.033589`
