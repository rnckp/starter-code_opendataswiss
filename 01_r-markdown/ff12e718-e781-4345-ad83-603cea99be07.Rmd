...
- **Keywords.de** `['inventar', 'kanton-zurich', 'geoportal', 'denkmalschutzobjekte', 'geodaten', 'stzh', 'zustandigkeit', 'denkmalpflege', 'vektordaten', 'amt-fur-stadtebau', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-12T02:59:06.257198`
