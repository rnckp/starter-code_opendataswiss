...
- **Keywords.de** `['amt-fur-stadtebau', 'denkmalpflege', 'denkmalschutzobjekte', 'stzh', 'zustandigkeit', 'kanton-zurich', 'geoportal', 'inventar', 'polygondaten', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-18T03:12:34.195161`
