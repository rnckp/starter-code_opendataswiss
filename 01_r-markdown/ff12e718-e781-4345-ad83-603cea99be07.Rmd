...
- **Keywords.de** `['geodaten', 'vektordaten', 'stzh', 'kanton-zurich', 'polygondaten', 'denkmalpflege', 'zustandigkeit', 'geoportal', 'inventar', 'amt-fur-stadtebau', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-01-26T03:27:37.168821`
