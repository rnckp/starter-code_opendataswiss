...
- **Keywords.de** `['polygondaten', 'inventar', 'zustandigkeit', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'geodaten', 'kanton-zurich', 'vektordaten', 'denkmalpflege', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-27T03:32:23.251973`
