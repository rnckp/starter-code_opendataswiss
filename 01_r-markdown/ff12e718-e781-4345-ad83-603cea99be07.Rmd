...
- **Keywords.de** `['stzh', 'denkmalschutzobjekte', 'geoportal', 'polygondaten', 'kanton-zurich', 'inventar', 'geodaten', 'denkmalpflege', 'amt-fur-stadtebau', 'zustandigkeit', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-04T04:29:35.793134`
