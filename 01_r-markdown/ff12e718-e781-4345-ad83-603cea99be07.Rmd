...
- **Keywords.de** `['vektordaten', 'geoportal', 'kanton-zurich', 'zustandigkeit', 'inventar', 'denkmalpflege', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'stzh', 'geodaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-26T03:44:18.658702`
