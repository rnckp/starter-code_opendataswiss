...
- **Keywords.de** `['inventar', 'geoportal', 'polygondaten', 'geodaten', 'stzh', 'amt-fur-stadtebau', 'vektordaten', 'zustandigkeit', 'denkmalpflege', 'denkmalschutzobjekte', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-26T02:46:38.286756`
