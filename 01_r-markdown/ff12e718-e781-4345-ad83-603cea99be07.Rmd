...
- **Keywords.de** `['inventar', 'denkmalschutzobjekte', 'zustandigkeit', 'geoportal', 'polygondaten', 'kanton-zurich', 'stzh', 'vektordaten', 'geodaten', 'denkmalpflege', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-23T03:04:47.406622`
