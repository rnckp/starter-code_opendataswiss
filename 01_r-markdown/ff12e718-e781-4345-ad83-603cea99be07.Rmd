...
- **Keywords.de** `['amt-fur-stadtebau', 'denkmalschutzobjekte', 'stzh', 'vektordaten', 'kanton-zurich', 'polygondaten', 'geodaten', 'zustandigkeit', 'denkmalpflege', 'geoportal', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-26T03:07:37.902888`
