...
- **Keywords.de** `['stzh', 'denkmalpflege', 'polygondaten', 'kanton-zurich', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'geoportal', 'geodaten', 'inventar', 'vektordaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-19T03:38:05.022112`
