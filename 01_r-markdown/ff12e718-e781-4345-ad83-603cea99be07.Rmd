...
- **Keywords.de** `['stzh', 'vektordaten', 'kanton-zurich', 'zustandigkeit', 'denkmalschutzobjekte', 'geodaten', 'geoportal', 'amt-fur-stadtebau', 'inventar', 'polygondaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-10T03:03:47.246794`
