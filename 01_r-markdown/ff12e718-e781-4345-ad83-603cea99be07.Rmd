...
- **Keywords.de** `['geoportal', 'inventar', 'denkmalpflege', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'stzh', 'kanton-zurich', 'geodaten', 'zustandigkeit', 'polygondaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-26T03:46:35.985886`
