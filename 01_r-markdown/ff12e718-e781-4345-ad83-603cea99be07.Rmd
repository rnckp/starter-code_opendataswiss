...
- **Keywords.de** `['inventar', 'zustandigkeit', 'polygondaten', 'kanton-zurich', 'amt-fur-stadtebau', 'geodaten', 'geoportal', 'stzh', 'denkmalpflege', 'denkmalschutzobjekte', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-17T01:57:57.459463`
