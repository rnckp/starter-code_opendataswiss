...
- **Keywords.de** `['stzh', 'polygondaten', 'geodaten', 'vektordaten', 'geoportal', 'inventar', 'zustandigkeit', 'denkmalpflege', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-20T02:52:07.258124`
