...
- **Keywords.de** `['stzh', 'kanton-zurich', 'inventar', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'zustandigkeit', 'denkmalpflege', 'polygondaten', 'vektordaten', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-05T02:55:47.181256`
