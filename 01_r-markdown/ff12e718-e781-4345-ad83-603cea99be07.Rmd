...
- **Keywords.de** `['inventar', 'denkmalschutzobjekte', 'kanton-zurich', 'stzh', 'geoportal', 'zustandigkeit', 'vektordaten', 'amt-fur-stadtebau', 'geodaten', 'polygondaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-20T02:15:15.686217`
