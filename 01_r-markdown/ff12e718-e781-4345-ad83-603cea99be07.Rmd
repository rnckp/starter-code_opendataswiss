...
- **Keywords.de** `['geodaten', 'denkmalschutzobjekte', 'inventar', 'zustandigkeit', 'denkmalpflege', 'stzh', 'geoportal', 'kanton-zurich', 'vektordaten', 'polygondaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-08T03:09:53.995833`
