...
- **Keywords.de** `['denkmalpflege', 'polygondaten', 'geodaten', 'stzh', 'inventar', 'kanton-zurich', 'vektordaten', 'geoportal', 'amt-fur-stadtebau', 'zustandigkeit', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-15T03:01:34.362922`
