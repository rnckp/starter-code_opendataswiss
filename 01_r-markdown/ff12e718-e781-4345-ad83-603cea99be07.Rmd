...
- **Keywords.de** `['polygondaten', 'inventar', 'vektordaten', 'stzh', 'geoportal', 'zustandigkeit', 'denkmalschutzobjekte', 'denkmalpflege', 'kanton-zurich', 'geodaten', 'amt-fur-stadtebau']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-08-07T03:31:08.320172`
