...
- **Keywords.de** `['stzh', 'geodaten', 'amt-fur-stadtebau', 'kanton-zurich', 'denkmalpflege', 'vektordaten', 'geoportal', 'zustandigkeit', 'polygondaten', 'inventar', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-12T03:16:53.109612`
