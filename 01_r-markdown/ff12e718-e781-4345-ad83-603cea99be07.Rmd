...
- **Keywords.de** `['polygondaten', 'amt-fur-stadtebau', 'denkmalpflege', 'stzh', 'inventar', 'denkmalschutzobjekte', 'vektordaten', 'geoportal', 'kanton-zurich', 'geodaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-25T03:25:34.874743`
