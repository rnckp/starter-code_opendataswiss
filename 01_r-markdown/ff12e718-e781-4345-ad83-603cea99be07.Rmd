...
- **Keywords.de** `['geoportal', 'denkmalpflege', 'geodaten', 'zustandigkeit', 'stzh', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'inventar', 'kanton-zurich', 'vektordaten', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-13T03:26:56.316279`
