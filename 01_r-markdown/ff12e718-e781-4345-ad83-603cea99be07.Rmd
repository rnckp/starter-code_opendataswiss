...
- **Keywords.de** `['polygondaten', 'stzh', 'amt-fur-stadtebau', 'denkmalpflege', 'vektordaten', 'denkmalschutzobjekte', 'zustandigkeit', 'geoportal', 'kanton-zurich', 'geodaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-09T03:29:56.666040`
