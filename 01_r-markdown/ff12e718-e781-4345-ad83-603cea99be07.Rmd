...
- **Keywords.de** `['stzh', 'inventar', 'vektordaten', 'geoportal', 'amt-fur-stadtebau', 'kanton-zurich', 'denkmalpflege', 'geodaten', 'zustandigkeit', 'denkmalschutzobjekte', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-13T02:33:54.135202`
