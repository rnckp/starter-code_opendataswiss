...
- **Keywords.de** `['geoportal', 'denkmalpflege', 'denkmalschutzobjekte', 'polygondaten', 'zustandigkeit', 'stzh', 'geodaten', 'kanton-zurich', 'vektordaten', 'amt-fur-stadtebau', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-25T03:47:57.591640`
