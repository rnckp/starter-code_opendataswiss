...
- **Keywords.de** `['geodaten', 'kanton-zurich', 'amt-fur-stadtebau', 'polygondaten', 'denkmalpflege', 'denkmalschutzobjekte', 'vektordaten', 'geoportal', 'stzh', 'inventar', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-23T03:19:34.499927`
