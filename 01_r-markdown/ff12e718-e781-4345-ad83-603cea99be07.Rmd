...
- **Keywords.de** `['geodaten', 'stzh', 'vektordaten', 'kanton-zurich', 'polygondaten', 'denkmalpflege', 'denkmalschutzobjekte', 'geoportal', 'amt-fur-stadtebau', 'zustandigkeit', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-01T03:23:35.186165`
