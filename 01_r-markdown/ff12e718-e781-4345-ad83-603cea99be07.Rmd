...
- **Keywords.de** `['amt-fur-stadtebau', 'stzh', 'kanton-zurich', 'denkmalschutzobjekte', 'vektordaten', 'denkmalpflege', 'geoportal', 'zustandigkeit', 'polygondaten', 'geodaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-11T03:03:41.917965`
