...
- **Keywords.de** `['geodaten', 'stzh', 'inventar', 'kanton-zurich', 'vektordaten', 'zustandigkeit', 'geoportal', 'amt-fur-stadtebau', 'polygondaten', 'denkmalschutzobjekte', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-08-09T03:26:09.688863`
