...
- **Keywords.de** `['polygondaten', 'denkmalpflege', 'geodaten', 'kanton-zurich', 'vektordaten', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'geoportal', 'stzh', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-10T03:34:14.391884`
