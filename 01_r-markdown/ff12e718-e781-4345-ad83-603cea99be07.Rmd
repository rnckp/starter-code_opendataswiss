...
- **Keywords.de** `['kanton-zurich', 'amt-fur-stadtebau', 'vektordaten', 'geoportal', 'polygondaten', 'stzh', 'inventar', 'denkmalschutzobjekte', 'zustandigkeit', 'geodaten', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-04T03:30:54.007779`
