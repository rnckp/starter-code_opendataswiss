...
- **Keywords.de** `['denkmalschutzobjekte', 'polygondaten', 'inventar', 'geoportal', 'vektordaten', 'amt-fur-stadtebau', 'kanton-zurich', 'denkmalpflege', 'stzh', 'geodaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-19T03:21:38.555812`
