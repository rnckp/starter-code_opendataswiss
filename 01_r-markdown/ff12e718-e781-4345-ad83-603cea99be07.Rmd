...
- **Keywords.de** `['denkmalpflege', 'inventar', 'amt-fur-stadtebau', 'kanton-zurich', 'zustandigkeit', 'stzh', 'denkmalschutzobjekte', 'polygondaten', 'geodaten', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-21T03:20:57.577050`
