...
- **Keywords.de** `['geodaten', 'vektordaten', 'denkmalpflege', 'inventar', 'kanton-zurich', 'zustandigkeit', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'stzh', 'geoportal', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-06-02T03:48:15.187976`
