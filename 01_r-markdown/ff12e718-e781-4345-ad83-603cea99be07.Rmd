...
- **Keywords.de** `['denkmalschutzobjekte', 'polygondaten', 'geoportal', 'zustandigkeit', 'inventar', 'geodaten', 'amt-fur-stadtebau', 'kanton-zurich', 'denkmalpflege', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-20T03:18:52.499469`
