...
- **Keywords.de** `['polygondaten', 'stzh', 'denkmalpflege', 'geodaten', 'vektordaten', 'amt-fur-stadtebau', 'kanton-zurich', 'denkmalschutzobjekte', 'inventar', 'zustandigkeit', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-03T02:41:10.958243`
