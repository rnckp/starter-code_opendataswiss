...
- **Keywords.de** `['denkmalschutzobjekte', 'amt-fur-stadtebau', 'stzh', 'vektordaten', 'geodaten', 'kanton-zurich', 'inventar', 'polygondaten', 'denkmalpflege', 'geoportal', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-04-14T03:52:22.461794`
