...
- **Keywords.de** `['geodaten', 'kanton-zurich', 'stzh', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'inventar', 'denkmalpflege', 'polygondaten', 'vektordaten', 'zustandigkeit', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-04T04:09:11.415856`
