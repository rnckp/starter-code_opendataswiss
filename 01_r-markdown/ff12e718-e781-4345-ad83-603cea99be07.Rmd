...
- **Keywords.de** `['stzh', 'vektordaten', 'polygondaten', 'denkmalpflege', 'zustandigkeit', 'kanton-zurich', 'denkmalschutzobjekte', 'geoportal', 'geodaten', 'amt-fur-stadtebau', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-07T02:47:18.431712`
