...
- **Keywords.de** `['zustandigkeit', 'stzh', 'geodaten', 'denkmalschutzobjekte', 'denkmalpflege', 'vektordaten', 'inventar', 'polygondaten', 'geoportal', 'amt-fur-stadtebau', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-02T03:06:30.825390`
