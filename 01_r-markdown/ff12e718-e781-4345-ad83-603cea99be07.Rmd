...
- **Keywords.de** `['stzh', 'inventar', 'zustandigkeit', 'kanton-zurich', 'denkmalschutzobjekte', 'geoportal', 'vektordaten', 'geodaten', 'amt-fur-stadtebau', 'denkmalpflege', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-27T03:59:07.053923`
