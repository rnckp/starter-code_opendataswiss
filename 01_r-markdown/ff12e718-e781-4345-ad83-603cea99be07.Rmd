...
- **Keywords.de** `['polygondaten', 'stzh', 'kanton-zurich', 'amt-fur-stadtebau', 'denkmalschutzobjekte', 'vektordaten', 'geodaten', 'inventar', 'geoportal', 'zustandigkeit', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-26T03:08:02.616520`
