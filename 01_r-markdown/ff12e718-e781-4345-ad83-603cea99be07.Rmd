...
- **Keywords.de** `['vektordaten', 'amt-fur-stadtebau', 'denkmalpflege', 'stzh', 'geodaten', 'denkmalschutzobjekte', 'kanton-zurich', 'inventar', 'polygondaten', 'geoportal', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-07-17T03:01:40.190245`
