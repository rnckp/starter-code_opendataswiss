...
- **Keywords.de** `['kanton-zurich', 'geodaten', 'denkmalpflege', 'vektordaten', 'amt-fur-stadtebau', 'geoportal', 'stzh', 'polygondaten', 'denkmalschutzobjekte', 'zustandigkeit', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-06-15T02:51:26.582885`
