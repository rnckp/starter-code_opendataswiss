...
- **Keywords.de** `['inventar', 'kanton-zurich', 'vektordaten', 'polygondaten', 'denkmalpflege', 'denkmalschutzobjekte', 'geoportal', 'stzh', 'zustandigkeit', 'amt-fur-stadtebau', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-12-28T03:56:36.470907`
