...
- **Keywords.de** `['denkmalschutzobjekte', 'stzh', 'vektordaten', 'geodaten', 'denkmalpflege', 'kanton-zurich', 'polygondaten', 'inventar', 'amt-fur-stadtebau', 'geoportal', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-27T03:29:41.634665`
