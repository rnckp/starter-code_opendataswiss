...
- **Keywords.de** `['stzh', 'amt-fur-stadtebau', 'zustandigkeit', 'inventar', 'polygondaten', 'denkmalpflege', 'vektordaten', 'denkmalschutzobjekte', 'geodaten', 'kanton-zurich', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-29T04:08:19.152157`
