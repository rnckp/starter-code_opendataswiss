...
- **Keywords.de** `['geoportal', 'amt-fur-stadtebau', 'vektordaten', 'polygondaten', 'inventar', 'geodaten', 'zustandigkeit', 'denkmalschutzobjekte', 'kanton-zurich', 'stzh', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-05-16T03:16:06.368039`
