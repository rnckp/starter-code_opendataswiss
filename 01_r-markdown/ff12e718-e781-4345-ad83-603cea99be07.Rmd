...
- **Keywords.de** `['zustandigkeit', 'stzh', 'kanton-zurich', 'polygondaten', 'denkmalschutzobjekte', 'denkmalpflege', 'amt-fur-stadtebau', 'inventar', 'geodaten', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-24T03:33:04.879088`
