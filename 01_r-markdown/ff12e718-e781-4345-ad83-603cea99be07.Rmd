...
- **Keywords.de** `['stzh', 'geodaten', 'zustandigkeit', 'amt-fur-stadtebau', 'vektordaten', 'inventar', 'polygondaten', 'denkmalpflege', 'denkmalschutzobjekte', 'geoportal', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-14T03:20:18.566608`
