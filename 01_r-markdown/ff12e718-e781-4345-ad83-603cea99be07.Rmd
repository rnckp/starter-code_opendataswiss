...
- **Keywords.de** `['amt-fur-stadtebau', 'inventar', 'zustandigkeit', 'stzh', 'denkmalschutzobjekte', 'denkmalpflege', 'geoportal', 'kanton-zurich', 'vektordaten', 'polygondaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-09-17T02:54:14.137801`
