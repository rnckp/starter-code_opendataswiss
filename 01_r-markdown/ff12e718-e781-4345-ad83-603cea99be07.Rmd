...
- **Keywords.de** `['vektordaten', 'geodaten', 'zustandigkeit', 'denkmalpflege', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'stzh', 'inventar', 'geoportal', 'polygondaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-11-19T03:16:03.473655`
