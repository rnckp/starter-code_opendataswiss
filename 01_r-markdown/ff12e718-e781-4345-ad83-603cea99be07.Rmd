...
- **Keywords.de** `['denkmalpflege', 'amt-fur-stadtebau', 'vektordaten', 'geoportal', 'denkmalschutzobjekte', 'geodaten', 'kanton-zurich', 'stzh', 'inventar', 'polygondaten', 'zustandigkeit']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-03T03:23:20.544765`
