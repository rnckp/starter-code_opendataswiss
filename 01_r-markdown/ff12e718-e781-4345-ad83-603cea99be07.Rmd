...
- **Keywords.de** `['vektordaten', 'amt-fur-stadtebau', 'zustandigkeit', 'polygondaten', 'stzh', 'geoportal', 'inventar', 'geodaten', 'denkmalschutzobjekte', 'kanton-zurich', 'denkmalpflege']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-30T04:07:47.120742`
