...
- **Keywords.de** `['polygondaten', 'vektordaten', 'zustandigkeit', 'stzh', 'kanton-zurich', 'denkmalpflege', 'denkmalschutzobjekte', 'amt-fur-stadtebau', 'geoportal', 'geodaten', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-02T04:26:53.226490`
