...
- **Keywords.de** `['zustandigkeit', 'denkmalschutzobjekte', 'inventar', 'amt-fur-stadtebau', 'geoportal', 'denkmalpflege', 'geodaten', 'polygondaten', 'stzh', 'kanton-zurich', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-03-13T04:19:52.415874`
