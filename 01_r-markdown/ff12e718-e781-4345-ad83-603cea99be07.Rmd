...
- **Keywords.de** `['denkmalpflege', 'kanton-zurich', 'geodaten', 'stzh', 'geoportal', 'vektordaten', 'polygondaten', 'zustandigkeit', 'amt-fur-stadtebau', 'inventar', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-07-16T03:45:28.210298`
