...
- **Keywords.de** `['kanton-zurich', 'stzh', 'denkmalschutzobjekte', 'denkmalpflege', 'amt-fur-stadtebau', 'polygondaten', 'vektordaten', 'zustandigkeit', 'geoportal', 'inventar', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-02-06T03:17:23.218286`
