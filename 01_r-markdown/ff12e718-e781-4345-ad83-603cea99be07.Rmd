...
- **Keywords.de** `['geodaten', 'stzh', 'vektordaten', 'denkmalpflege', 'amt-fur-stadtebau', 'inventar', 'geoportal', 'denkmalschutzobjekte', 'zustandigkeit', 'polygondaten', 'kanton-zurich']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-05-23T02:54:07.750753`
