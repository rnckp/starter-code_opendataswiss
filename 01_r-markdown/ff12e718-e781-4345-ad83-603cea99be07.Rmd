...
- **Keywords.de** `['geodaten', 'zustandigkeit', 'kanton-zurich', 'amt-fur-stadtebau', 'vektordaten', 'polygondaten', 'stzh', 'denkmalpflege', 'geoportal', 'denkmalschutzobjekte', 'inventar']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2024-10-31T03:22:32.034055`
