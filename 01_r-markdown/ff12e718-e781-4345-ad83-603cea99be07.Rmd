...
- **Keywords.de** `['amt-fur-stadtebau', 'denkmalschutzobjekte', 'polygondaten', 'inventar', 'zustandigkeit', 'denkmalpflege', 'geodaten', 'kanton-zurich', 'vektordaten', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-04-25T04:29:16.376402`
