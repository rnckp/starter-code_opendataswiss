...
- **Keywords.de** `['inventar', 'kanton-zurich', 'geoportal', 'amt-fur-stadtebau', 'zustandigkeit', 'polygondaten', 'denkmalpflege', 'stzh', 'vektordaten', 'geodaten', 'denkmalschutzobjekte']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-16T04:27:34.431078`
