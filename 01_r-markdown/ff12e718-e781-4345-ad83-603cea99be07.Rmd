...
- **Keywords.de** `['polygondaten', 'geoportal', 'amt-fur-stadtebau', 'stzh', 'denkmalschutzobjekte', 'denkmalpflege', 'zustandigkeit', 'geodaten', 'kanton-zurich', 'inventar', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:51:59.388240`
- **Metadata_modified** `2025-09-18T03:58:42.416388`
