...
- **Keywords.de** `['ungultig', 'wahlbeteiligung', 'partei', 'gemeindenummer', 'wahlzettel', 'prozent', 'wahlen', 'gultig', 'abstimmung', 'gemeinde', 'stimmen', 'nationalrat', 'standerat', 'bezirk']`
- **Issued** `2023-10-17T12:13:22+00:00`
- **Metadata_created** `2023-10-17T11:02:36.748512`
- **Metadata_modified** `2024-06-04T11:03:31.285711`
...
df <- read_delim('https://data.tg.ch/api/v2/catalog/datasets/sk-stat-125/exports/csv')
