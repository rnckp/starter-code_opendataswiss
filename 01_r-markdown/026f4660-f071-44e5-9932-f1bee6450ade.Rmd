...
- **Keywords.de** `['prozent', 'wahlzettel', 'bezirk', 'partei', 'standerat', 'nationalrat', 'wahlbeteiligung', 'wahlen', 'abstimmung', 'stimmen', 'gultig', 'gemeinde', 'gemeindenummer', 'ungultig']`
- **Issued** `2023-10-17T12:13:22+00:00`
- **Metadata_created** `2023-10-17T11:02:36.748512`
- **Metadata_modified** `2024-08-07T11:36:31.783919`
...
df <- read_delim('https://data.tg.ch/api/v2/catalog/datasets/sk-stat-125/exports/csv?use_labels=false')
