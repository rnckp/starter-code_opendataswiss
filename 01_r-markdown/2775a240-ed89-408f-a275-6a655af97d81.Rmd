...
- **Keywords.de** `['alter', 'partei', 'name', 'parlament', 'politische-parteien', 'wahltermin', 'geschlecht', 'panaschierstatistik', 'vorname']`
- **Issued** `2023-02-17T00:00:00`
- **Metadata_created** `2023-02-17T11:03:03.868234`
- **Metadata_modified** `2024-08-08T03:38:01.885529`
...
df <- read_delim('https://data.bl.ch/api/v2/catalog/datasets/11610/exports/csv?use_labels=false')
