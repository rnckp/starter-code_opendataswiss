...
- **Metadata_modified** `2023-12-08T11:41:15.376714`
...
df <- read_delim('https://dam-api.bfs.admin.ch/hub/api/dam/assets/27125924/master')
...
df <- read_delim('https://dam-api.bfs.admin.ch/hub/api/dam/assets/27125918/master')
...
df <- read_delim('https://dam-api.bfs.admin.ch/hub/api/dam/assets/27125917/master')
...
df <- read_delim('https://dam-api.bfs.admin.ch/hub/api/dam/assets/27125921/master')
