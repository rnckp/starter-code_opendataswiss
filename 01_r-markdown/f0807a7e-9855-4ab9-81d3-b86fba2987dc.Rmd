...
- **Keywords.de** `['name', 'partei', 'politische-parteien', 'kommunalwahlen', 'gemeindewahlen', 'parlament', 'geschlecht', 'vorname', 'wahltermin', 'alter']`
- **Issued** `2024-02-28T00:00:00`
- **Metadata_created** `2024-02-28T04:44:38.063286`
- **Metadata_modified** `2024-08-08T03:40:01.288180`
...
df <- read_delim('https://data.bl.ch/api/v2/catalog/datasets/10840/exports/csv?use_labels=false')
