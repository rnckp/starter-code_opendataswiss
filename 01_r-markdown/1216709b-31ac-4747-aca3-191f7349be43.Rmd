...
- **Publisher.name** `Stab Direktion, Liegenschaften Stadt Zürich, Finanzdepartement`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `Open Data Zürich`
- **Maintainer_email** `opendata@zuerich.ch`
- **Keywords.de** `['punktdaten', 'geodaten', 'geoportal', 'grundstucke', 'vektordaten', 'gebaude', 'stzh', 'stiftungen', 'polygondaten', 'wohnungen', 'liegenschaften']`
- **Issued** `nan`
- **Metadata_created** `2024-01-11T04:55:37.438861`
- **Metadata_modified** `2025-04-13T04:02:46.419534`
