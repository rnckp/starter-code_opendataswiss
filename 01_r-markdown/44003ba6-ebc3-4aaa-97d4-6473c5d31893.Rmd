...
Auto-generated R starter code for the dataset 45f279d5-0289-47b5-8762-a610365e55b6@bundesamt-fur-meteorologie-und-klimatologie-meteoschweiz.
...
- **Keywords.de** `['atmospharische-bedingungen', 'meteorologisch-geografische-kennwerte', 'klimatologie', 'meteorologie', 'luft-atmosphare', 'wetter', 'niederschlag', 'bgdi-bundesgeodaten-infrastruktur', 'opendata']`
- **Issued** `2025-05-20T00:00:00`
- **Metadata_created** `2025-05-20T03:07:41.423613`
- **Metadata_modified** `2026-01-30T00:22:26.763439`
...
df <- read_delim('https://data.geo.admin.ch/browser/index.html#/collections/ch.meteoschweiz.ogd-smn-precip')
