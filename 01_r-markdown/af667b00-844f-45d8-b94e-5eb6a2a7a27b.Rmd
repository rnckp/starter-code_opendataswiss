...
- **Publisher** `Präsidialdepartement/Kantons- und Stadtentwicklung/Fachstelle Stadtteilentwicklung`
- **Organization.display_name.de** `Kanton Basel-Stadt`
- **Organization.url** `https://www.opendata.bs.ch`
- **Maintainer** `None`
- **Maintainer_email** `None`
- **Keywords.de** `['anlass', 'party', 'raum', 'fest', 'niederschwellig', 'treffpunkt']`
- **Issued** `2019-11-06T00:00:00`
- **Metadata_created** `2022-06-09T08:38:06.748218`
- **Metadata_modified** `2023-03-10T00:35:10.462390`
