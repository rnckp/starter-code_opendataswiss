...
- **Keywords.de** `['berufsbildung', 'handwerk', 'bildung', 'grundbildung', 'prufung', 'beruf', 'attest', 'ausbildung', 'abschluss', 'abschlusse', 'repetent']`
- **Issued** `2023-04-27T08:00:23+00:00`
- **Metadata_created** `2023-05-06T11:02:06.856823`
- **Metadata_modified** `2024-01-17T11:04:24.719520`
...
df <- read_delim('https://data.tg.ch/api/v2/catalog/datasets/dek-abb-1/exports/csv')
