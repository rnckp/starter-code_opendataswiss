...
- **Keywords.de** `['punktdaten', 'verkauf', 'vektordaten', 'stzh', 'postauto', 'bus', 'tramlinien', 'strassenbahn', 'vbg', 'geoportal', 'vbz', 'geodaten', 'offentlicher-verkehr', 'tram', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-30T03:27:44.171550`
