...
- **Keywords.de** `['vbg', 'punktdaten', 'strassenbahn', 'buslinien', 'tram', 'vektordaten', 'vbz', 'bus', 'geoportal', 'tramlinien', 'offentlicher-verkehr', 'geodaten', 'verkauf', 'stzh', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-22T05:15:19.283726`
