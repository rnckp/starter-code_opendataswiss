...
- **Keywords.de** `['bus', 'postauto', 'tram', 'tramlinien', 'strassenbahn', 'buslinien', 'geodaten', 'verkauf', 'stzh', 'geoportal', 'vektordaten', 'offentlicher-verkehr', 'vbg', 'vbz', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-27T03:09:10.699295`
