...
- **Keywords.de** `['tram', 'tramlinien', 'geoportal', 'punktdaten', 'vektordaten', 'strassenbahn', 'verkauf', 'bus', 'geodaten', 'offentlicher-verkehr', 'buslinien', 'vbz', 'stzh', 'vbg', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-13T04:17:38.000063`
