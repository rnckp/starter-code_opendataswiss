...
- **Keywords.de** `['geoportal', 'tram', 'vbz', 'geodaten', 'strassenbahn', 'buslinien', 'offentlicher-verkehr', 'postauto', 'bus', 'punktdaten', 'verkauf', 'stzh', 'vbg', 'tramlinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-29T05:08:25.954598`
