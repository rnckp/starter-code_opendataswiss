...
- **Keywords.de** `['tramlinien', 'vbz', 'bus', 'buslinien', 'stzh', 'vbg', 'offentlicher-verkehr', 'geoportal', 'punktdaten', 'verkauf', 'geodaten', 'postauto', 'vektordaten', 'strassenbahn', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-15T02:36:11.394473`
