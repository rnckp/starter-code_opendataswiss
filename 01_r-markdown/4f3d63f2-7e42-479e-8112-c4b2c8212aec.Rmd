...
- **Keywords.de** `['vbz', 'punktdaten', 'geodaten', 'buslinien', 'stzh', 'strassenbahn', 'geoportal', 'offentlicher-verkehr', 'tram', 'postauto', 'vektordaten', 'vbg', 'tramlinien', 'bus', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-21T03:46:09.827046`
