...
- **Keywords.de** `['tram', 'geoportal', 'bus', 'stzh', 'geodaten', 'punktdaten', 'verkauf', 'tramlinien', 'strassenbahn', 'postauto', 'vbz', 'buslinien', 'vbg', 'vektordaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-27T03:58:29.579098`
