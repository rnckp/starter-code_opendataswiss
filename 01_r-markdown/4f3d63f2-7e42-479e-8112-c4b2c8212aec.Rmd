...
- **Keywords.de** `['vbz', 'strassenbahn', 'vektordaten', 'tramlinien', 'offentlicher-verkehr', 'tram', 'verkauf', 'stzh', 'geodaten', 'buslinien', 'bus', 'geoportal', 'vbg', 'postauto', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-28T03:07:51.770429`
