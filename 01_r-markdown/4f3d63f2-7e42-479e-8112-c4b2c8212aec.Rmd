...
- **Keywords.de** `['postauto', 'bus', 'vbg', 'vektordaten', 'geodaten', 'tram', 'vbz', 'tramlinien', 'geoportal', 'offentlicher-verkehr', 'strassenbahn', 'verkauf', 'punktdaten', 'buslinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-23T03:16:06.966824`
