...
- **Keywords.de** `['bus', 'tramlinien', 'tram', 'offentlicher-verkehr', 'geoportal', 'stzh', 'buslinien', 'verkauf', 'geodaten', 'vektordaten', 'vbg', 'punktdaten', 'vbz', 'postauto', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-20T02:41:05.840177`
