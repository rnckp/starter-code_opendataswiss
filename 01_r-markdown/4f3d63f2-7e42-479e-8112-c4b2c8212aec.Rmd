...
- **Keywords.de** `['geoportal', 'buslinien', 'offentlicher-verkehr', 'strassenbahn', 'bus', 'stzh', 'vbg', 'vektordaten', 'punktdaten', 'tramlinien', 'vbz', 'tram', 'postauto', 'geodaten', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-09T03:04:50.299065`
