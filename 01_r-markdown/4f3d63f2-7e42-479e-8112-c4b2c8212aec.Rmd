...
- **Keywords.de** `['geoportal', 'stzh', 'offentlicher-verkehr', 'geodaten', 'bus', 'tramlinien', 'vektordaten', 'tram', 'strassenbahn', 'buslinien', 'vbg', 'punktdaten', 'verkauf', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-20T03:01:14.093616`
