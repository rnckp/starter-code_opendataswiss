...
- **Keywords.de** `['buslinien', 'strassenbahn', 'postauto', 'tramlinien', 'vbg', 'bus', 'offentlicher-verkehr', 'verkauf', 'tram', 'geodaten', 'stzh', 'vektordaten', 'vbz', 'punktdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-16T02:55:46.872502`
