...
- **Keywords.de** `['stzh', 'geodaten', 'postauto', 'verkauf', 'vbz', 'bus', 'vbg', 'buslinien', 'punktdaten', 'vektordaten', 'geoportal', 'tramlinien', 'tram', 'strassenbahn', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-09T03:43:13.364949`
