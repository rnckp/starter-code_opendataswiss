...
- **Keywords.de** `['punktdaten', 'tramlinien', 'stzh', 'vektordaten', 'vbg', 'offentlicher-verkehr', 'vbz', 'tram', 'bus', 'postauto', 'strassenbahn', 'verkauf', 'buslinien', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-11T03:26:14.155979`
