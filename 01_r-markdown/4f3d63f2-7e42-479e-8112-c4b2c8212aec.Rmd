...
- **Keywords.de** `['stzh', 'postauto', 'offentlicher-verkehr', 'punktdaten', 'vbz', 'geodaten', 'bus', 'verkauf', 'vbg', 'tram', 'tramlinien', 'strassenbahn', 'vektordaten', 'geoportal', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-30T04:07:40.882435`
