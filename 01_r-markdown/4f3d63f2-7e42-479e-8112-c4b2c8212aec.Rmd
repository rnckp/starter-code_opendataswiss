...
- **Keywords.de** `['geodaten', 'vbz', 'geoportal', 'buslinien', 'postauto', 'tramlinien', 'vektordaten', 'verkauf', 'offentlicher-verkehr', 'punktdaten', 'stzh', 'tram', 'strassenbahn', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-11T03:28:48.278343`
