...
- **Keywords.de** `['verkauf', 'tram', 'geoportal', 'vbz', 'tramlinien', 'postauto', 'strassenbahn', 'offentlicher-verkehr', 'punktdaten', 'stzh', 'bus', 'vektordaten', 'buslinien', 'vbg', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-23T03:26:09.579390`
