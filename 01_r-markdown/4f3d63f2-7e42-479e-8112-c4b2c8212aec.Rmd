...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'vbg', 'strassenbahn', 'stzh', 'geodaten', 'tram', 'tramlinien', 'buslinien', 'geoportal', 'punktdaten', 'vbz', 'postauto', 'bus', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-03T03:25:49.706244`
