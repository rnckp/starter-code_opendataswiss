...
- **Keywords.de** `['buslinien', 'tramlinien', 'vbz', 'stzh', 'punktdaten', 'vbg', 'verkauf', 'offentlicher-verkehr', 'bus', 'vektordaten', 'strassenbahn', 'postauto', 'tram', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-29T04:09:29.268756`
