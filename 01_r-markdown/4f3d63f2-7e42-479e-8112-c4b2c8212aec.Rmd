...
- **Keywords.de** `['punktdaten', 'buslinien', 'geoportal', 'tram', 'vektordaten', 'stzh', 'geodaten', 'tramlinien', 'bus', 'postauto', 'strassenbahn', 'verkauf', 'offentlicher-verkehr', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-05T03:27:30.291791`
