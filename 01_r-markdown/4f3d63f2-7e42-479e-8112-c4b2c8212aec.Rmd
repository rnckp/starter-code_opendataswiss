...
- **Keywords.de** `['buslinien', 'strassenbahn', 'stzh', 'geoportal', 'geodaten', 'vektordaten', 'vbz', 'offentlicher-verkehr', 'tram', 'verkauf', 'punktdaten', 'tramlinien', 'postauto', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-13T03:38:10.546470`
