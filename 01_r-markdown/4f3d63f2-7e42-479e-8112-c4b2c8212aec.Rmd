...
- **Keywords.de** `['geoportal', 'vbg', 'bus', 'buslinien', 'punktdaten', 'stzh', 'postauto', 'offentlicher-verkehr', 'vektordaten', 'tram', 'tramlinien', 'verkauf', 'strassenbahn', 'geodaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-05T03:06:32.171560`
