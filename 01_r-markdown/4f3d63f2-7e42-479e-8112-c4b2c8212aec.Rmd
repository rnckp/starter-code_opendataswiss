...
- **Keywords.de** `['buslinien', 'geoportal', 'postauto', 'offentlicher-verkehr', 'tramlinien', 'tram', 'bus', 'vektordaten', 'strassenbahn', 'vbg', 'verkauf', 'stzh', 'punktdaten', 'geodaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-09T03:23:43.091983`
