...
- **Keywords.de** `['geodaten', 'vektordaten', 'buslinien', 'offentlicher-verkehr', 'tram', 'postauto', 'vbz', 'geoportal', 'verkauf', 'punktdaten', 'stzh', 'tramlinien', 'bus', 'strassenbahn', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-13T02:52:51.075575`
