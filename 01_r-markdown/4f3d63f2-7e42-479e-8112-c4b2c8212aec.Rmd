...
- **Keywords.de** `['buslinien', 'stzh', 'vektordaten', 'strassenbahn', 'tram', 'offentlicher-verkehr', 'punktdaten', 'verkauf', 'vbz', 'tramlinien', 'postauto', 'bus', 'geoportal', 'vbg', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-20T03:50:22.572607`
