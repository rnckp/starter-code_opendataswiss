...
- **Keywords.de** `['geoportal', 'stzh', 'vbz', 'strassenbahn', 'postauto', 'punktdaten', 'vbg', 'tramlinien', 'verkauf', 'offentlicher-verkehr', 'geodaten', 'vektordaten', 'buslinien', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-25T03:45:04.014532`
