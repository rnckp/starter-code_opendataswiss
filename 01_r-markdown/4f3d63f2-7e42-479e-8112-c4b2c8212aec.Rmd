...
- **Keywords.de** `['tram', 'bus', 'offentlicher-verkehr', 'vektordaten', 'strassenbahn', 'punktdaten', 'geoportal', 'postauto', 'vbz', 'stzh', 'geodaten', 'tramlinien', 'vbg', 'buslinien', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-31T02:49:47.600759`
