...
- **Keywords.de** `['vektordaten', 'geodaten', 'vbg', 'postauto', 'offentlicher-verkehr', 'bus', 'tram', 'verkauf', 'tramlinien', 'strassenbahn', 'vbz', 'stzh', 'punktdaten', 'buslinien', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-22T02:48:11.837989`
