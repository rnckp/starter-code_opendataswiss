...
- **Keywords.de** `['bus', 'geodaten', 'tramlinien', 'strassenbahn', 'offentlicher-verkehr', 'verkauf', 'vbg', 'vektordaten', 'stzh', 'geoportal', 'tram', 'postauto', 'buslinien', 'punktdaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-12T03:43:00.539003`
