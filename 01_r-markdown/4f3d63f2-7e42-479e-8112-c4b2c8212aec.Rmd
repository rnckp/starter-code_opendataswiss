...
- **Keywords.de** `['postauto', 'verkauf', 'stzh', 'tramlinien', 'geodaten', 'tram', 'vbg', 'strassenbahn', 'vbz', 'offentlicher-verkehr', 'bus', 'vektordaten', 'buslinien', 'punktdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-10T05:12:41.235842`
