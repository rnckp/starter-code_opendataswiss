...
- **Keywords.de** `['vbg', 'buslinien', 'strassenbahn', 'geodaten', 'postauto', 'punktdaten', 'offentlicher-verkehr', 'bus', 'tram', 'geoportal', 'vektordaten', 'tramlinien', 'vbz', 'stzh', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-07T04:28:55.568465`
