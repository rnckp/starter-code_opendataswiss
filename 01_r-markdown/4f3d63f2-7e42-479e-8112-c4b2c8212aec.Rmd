...
- **Keywords.de** `['geodaten', 'verkauf', 'vbz', 'postauto', 'punktdaten', 'tramlinien', 'bus', 'buslinien', 'tram', 'strassenbahn', 'vektordaten', 'geoportal', 'offentlicher-verkehr', 'vbg', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-11T03:42:04.474000`
