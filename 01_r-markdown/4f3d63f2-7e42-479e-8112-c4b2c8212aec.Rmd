...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'verkauf', 'offentlicher-verkehr', 'postauto', 'buslinien', 'stzh', 'tram', 'vbz', 'geodaten', 'bus', 'punktdaten', 'geoportal', 'vbg', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-03T03:23:16.734590`
