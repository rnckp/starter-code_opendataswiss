...
- **Keywords.de** `['vektordaten', 'geodaten', 'vbz', 'punktdaten', 'postauto', 'bus', 'geoportal', 'tramlinien', 'verkauf', 'tram', 'buslinien', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-10T05:54:53.225402`
