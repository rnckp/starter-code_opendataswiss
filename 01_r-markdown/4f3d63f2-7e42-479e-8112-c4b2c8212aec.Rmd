...
- **Keywords.de** `['geodaten', 'vbz', 'strassenbahn', 'offentlicher-verkehr', 'geoportal', 'vektordaten', 'vbg', 'punktdaten', 'bus', 'tram', 'buslinien', 'tramlinien', 'verkauf', 'postauto', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-02T02:30:05.096651`
