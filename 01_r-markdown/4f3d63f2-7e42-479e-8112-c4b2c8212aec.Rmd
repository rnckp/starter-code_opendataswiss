...
- **Keywords.de** `['verkauf', 'geodaten', 'tramlinien', 'stzh', 'tram', 'vbz', 'punktdaten', 'geoportal', 'postauto', 'strassenbahn', 'buslinien', 'bus', 'vbg', 'vektordaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-16T04:42:33.745714`
