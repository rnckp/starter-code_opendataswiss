...
- **Keywords.de** `['tram', 'bus', 'strassenbahn', 'vbz', 'vektordaten', 'stzh', 'buslinien', 'geoportal', 'punktdaten', 'tramlinien', 'vbg', 'verkauf', 'geodaten', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-07T02:33:40.483497`
