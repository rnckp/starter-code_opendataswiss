...
- **Keywords.de** `['stzh', 'tram', 'strassenbahn', 'geodaten', 'vbg', 'buslinien', 'vektordaten', 'postauto', 'vbz', 'punktdaten', 'verkauf', 'offentlicher-verkehr', 'geoportal', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-25T04:24:23.866202`
