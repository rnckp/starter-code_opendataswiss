...
- **Keywords.de** `['tram', 'tramlinien', 'bus', 'vektordaten', 'punktdaten', 'stzh', 'offentlicher-verkehr', 'vbg', 'verkauf', 'buslinien', 'postauto', 'strassenbahn', 'vbz', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-18T02:15:08.660516`
