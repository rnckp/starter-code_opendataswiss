...
- **Keywords.de** `['verkauf', 'punktdaten', 'vbg', 'bus', 'geoportal', 'tram', 'tramlinien', 'offentlicher-verkehr', 'geodaten', 'strassenbahn', 'postauto', 'vektordaten', 'stzh', 'buslinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-20T02:58:55.476786`
