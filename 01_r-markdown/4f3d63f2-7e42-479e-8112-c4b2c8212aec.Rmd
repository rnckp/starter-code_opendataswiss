...
- **Keywords.de** `['buslinien', 'verkauf', 'geodaten', 'tram', 'geoportal', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'postauto', 'tramlinien', 'vektordaten', 'vbz', 'punktdaten', 'stzh', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-26T02:46:40.465539`
