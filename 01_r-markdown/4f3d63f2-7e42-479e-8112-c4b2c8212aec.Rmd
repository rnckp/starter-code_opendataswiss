...
- **Keywords.de** `['verkauf', 'bus', 'tramlinien', 'geodaten', 'vbz', 'tram', 'punktdaten', 'postauto', 'geoportal', 'buslinien', 'vektordaten', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-29T03:01:30.759356`
