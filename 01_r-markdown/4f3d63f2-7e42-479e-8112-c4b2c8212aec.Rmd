...
- **Keywords.de** `['strassenbahn', 'buslinien', 'stzh', 'vbg', 'tram', 'vektordaten', 'punktdaten', 'verkauf', 'bus', 'geodaten', 'postauto', 'tramlinien', 'geoportal', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-25T03:23:51.270866`
