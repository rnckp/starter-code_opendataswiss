...
- **Keywords.de** `['offentlicher-verkehr', 'vbg', 'vektordaten', 'geoportal', 'buslinien', 'tram', 'verkauf', 'strassenbahn', 'bus', 'stzh', 'tramlinien', 'vbz', 'geodaten', 'punktdaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-17T03:25:51.590083`
