...
- **Keywords.de** `['punktdaten', 'vbg', 'postauto', 'bus', 'vbz', 'strassenbahn', 'geoportal', 'buslinien', 'stzh', 'vektordaten', 'geodaten', 'tram', 'offentlicher-verkehr', 'verkauf', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-07T03:01:42.478630`
