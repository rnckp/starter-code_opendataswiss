...
- **Keywords.de** `['geodaten', 'vektordaten', 'vbg', 'buslinien', 'punktdaten', 'strassenbahn', 'verkauf', 'bus', 'postauto', 'tramlinien', 'geoportal', 'vbz', 'offentlicher-verkehr', 'tram', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-21T03:22:22.796612`
