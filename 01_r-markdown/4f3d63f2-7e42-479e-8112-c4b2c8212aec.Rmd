...
- **Keywords.de** `['buslinien', 'vektordaten', 'tram', 'vbz', 'postauto', 'vbg', 'bus', 'tramlinien', 'verkauf', 'geodaten', 'strassenbahn', 'punktdaten', 'offentlicher-verkehr', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-02T03:16:20.790653`
