...
- **Keywords.de** `['vbz', 'postauto', 'bus', 'verkauf', 'offentlicher-verkehr', 'buslinien', 'geodaten', 'vektordaten', 'strassenbahn', 'punktdaten', 'tram', 'geoportal', 'tramlinien', 'vbg', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-04T03:42:40.550465`
