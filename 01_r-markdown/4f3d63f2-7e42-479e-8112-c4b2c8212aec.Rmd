...
- **Keywords.de** `['postauto', 'punktdaten', 'vbg', 'buslinien', 'strassenbahn', 'tramlinien', 'vektordaten', 'bus', 'geodaten', 'verkauf', 'stzh', 'offentlicher-verkehr', 'tram', 'vbz', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-24T03:07:54.258136`
