...
- **Keywords.de** `['strassenbahn', 'buslinien', 'geoportal', 'geodaten', 'offentlicher-verkehr', 'bus', 'vbg', 'verkauf', 'punktdaten', 'vektordaten', 'stzh', 'tram', 'vbz', 'tramlinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-19T02:43:55.707470`
