...
- **Keywords.de** `['geodaten', 'strassenbahn', 'stzh', 'geoportal', 'verkauf', 'vbg', 'tramlinien', 'bus', 'punktdaten', 'postauto', 'vbz', 'buslinien', 'offentlicher-verkehr', 'tram', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-26T03:23:32.221257`
