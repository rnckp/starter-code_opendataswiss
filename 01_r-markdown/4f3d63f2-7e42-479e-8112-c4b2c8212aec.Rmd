...
- **Keywords.de** `['geoportal', 'tram', 'geodaten', 'stzh', 'offentlicher-verkehr', 'vbg', 'bus', 'buslinien', 'postauto', 'strassenbahn', 'vektordaten', 'vbz', 'punktdaten', 'verkauf', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-16T03:39:51.332640`
