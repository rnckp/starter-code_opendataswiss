...
- **Keywords.de** `['geodaten', 'punktdaten', 'bus', 'postauto', 'vbg', 'tramlinien', 'offentlicher-verkehr', 'vbz', 'stzh', 'strassenbahn', 'tram', 'vektordaten', 'verkauf', 'buslinien', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-16T03:01:22.279632`
