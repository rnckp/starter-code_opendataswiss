...
- **Keywords.de** `['tram', 'geoportal', 'geodaten', 'stzh', 'postauto', 'tramlinien', 'verkauf', 'strassenbahn', 'punktdaten', 'vbz', 'vektordaten', 'bus', 'vbg', 'offentlicher-verkehr', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-14T02:56:49.332132`
