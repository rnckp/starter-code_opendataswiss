...
- **Keywords.de** `['vbg', 'offentlicher-verkehr', 'punktdaten', 'vektordaten', 'tramlinien', 'vbz', 'stzh', 'strassenbahn', 'tram', 'geoportal', 'geodaten', 'bus', 'postauto', 'buslinien', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-03T02:40:56.064249`
