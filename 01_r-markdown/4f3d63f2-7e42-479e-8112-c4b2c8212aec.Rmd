...
- **Keywords.de** `['vbg', 'postauto', 'punktdaten', 'geodaten', 'geoportal', 'tramlinien', 'verkauf', 'strassenbahn', 'vbz', 'vektordaten', 'stzh', 'buslinien', 'tram', 'offentlicher-verkehr', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-23T02:43:30.470369`
