...
- **Keywords.de** `['vektordaten', 'geoportal', 'strassenbahn', 'postauto', 'verkauf', 'offentlicher-verkehr', 'tram', 'stzh', 'vbg', 'geodaten', 'bus', 'vbz', 'punktdaten', 'tramlinien', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-19T03:21:54.556953`
