...
- **Keywords.de** `['verkauf', 'strassenbahn', 'bus', 'postauto', 'tram', 'vbz', 'offentlicher-verkehr', 'geodaten', 'buslinien', 'vbg', 'stzh', 'punktdaten', 'vektordaten', 'geoportal', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-03T03:29:02.859910`
