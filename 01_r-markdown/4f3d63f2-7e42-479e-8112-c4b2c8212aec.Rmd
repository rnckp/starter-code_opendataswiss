...
- **Keywords.de** `['punktdaten', 'vbz', 'tram', 'strassenbahn', 'verkauf', 'tramlinien', 'buslinien', 'vektordaten', 'offentlicher-verkehr', 'vbg', 'geoportal', 'stzh', 'bus', 'geodaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-08T03:08:39.539137`
