...
- **Keywords.de** `['geodaten', 'punktdaten', 'vbz', 'vektordaten', 'tramlinien', 'geoportal', 'bus', 'verkauf', 'offentlicher-verkehr', 'postauto', 'strassenbahn', 'stzh', 'buslinien', 'tram', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-09T03:15:59.013244`
