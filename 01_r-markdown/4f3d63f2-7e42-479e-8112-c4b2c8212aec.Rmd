...
- **Keywords.de** `['geodaten', 'punktdaten', 'verkauf', 'bus', 'stzh', 'geoportal', 'tramlinien', 'postauto', 'offentlicher-verkehr', 'strassenbahn', 'vbz', 'tram', 'vbg', 'buslinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-22T03:16:59.942525`
