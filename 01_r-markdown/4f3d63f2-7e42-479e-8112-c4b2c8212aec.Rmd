...
- **Keywords.de** `['verkauf', 'vbg', 'buslinien', 'vbz', 'stzh', 'postauto', 'vektordaten', 'tram', 'geodaten', 'offentlicher-verkehr', 'punktdaten', 'tramlinien', 'bus', 'geoportal', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-18T02:12:20.260540`
