...
- **Keywords.de** `['geodaten', 'postauto', 'verkauf', 'vbz', 'punktdaten', 'tramlinien', 'strassenbahn', 'offentlicher-verkehr', 'vbg', 'vektordaten', 'tram', 'geoportal', 'buslinien', 'stzh', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-08T03:08:24.477831`
