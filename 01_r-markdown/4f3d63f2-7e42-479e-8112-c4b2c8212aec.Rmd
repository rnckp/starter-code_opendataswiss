...
- **Keywords.de** `['bus', 'stzh', 'tram', 'buslinien', 'postauto', 'punktdaten', 'offentlicher-verkehr', 'geoportal', 'geodaten', 'verkauf', 'vbg', 'tramlinien', 'vbz', 'strassenbahn', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-22T03:16:54.589035`
