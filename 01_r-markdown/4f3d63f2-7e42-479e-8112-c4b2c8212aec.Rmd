...
- **Keywords.de** `['offentlicher-verkehr', 'verkauf', 'bus', 'postauto', 'tramlinien', 'geodaten', 'vbz', 'geoportal', 'strassenbahn', 'vbg', 'punktdaten', 'vektordaten', 'stzh', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-25T02:08:34.288004`
