...
- **Keywords.de** `['geoportal', 'geodaten', 'vbg', 'punktdaten', 'verkauf', 'bus', 'offentlicher-verkehr', 'vbz', 'tramlinien', 'buslinien', 'stzh', 'postauto', 'vektordaten', 'strassenbahn', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-26T03:18:58.229593`
