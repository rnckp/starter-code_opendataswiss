...
- **Keywords.de** `['stzh', 'bus', 'vbz', 'strassenbahn', 'geoportal', 'buslinien', 'geodaten', 'tramlinien', 'offentlicher-verkehr', 'tram', 'verkauf', 'punktdaten', 'postauto', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-11T03:15:43.242516`
