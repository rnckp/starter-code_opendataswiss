...
- **Keywords.de** `['buslinien', 'strassenbahn', 'geodaten', 'stzh', 'verkauf', 'postauto', 'vektordaten', 'punktdaten', 'vbg', 'geoportal', 'vbz', 'offentlicher-verkehr', 'tramlinien', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-28T03:33:59.626356`
