...
- **Keywords.de** `['offentlicher-verkehr', 'geoportal', 'tramlinien', 'vbz', 'vektordaten', 'bus', 'buslinien', 'verkauf', 'strassenbahn', 'geodaten', 'vbg', 'postauto', 'tram', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-18T03:32:15.230994`
