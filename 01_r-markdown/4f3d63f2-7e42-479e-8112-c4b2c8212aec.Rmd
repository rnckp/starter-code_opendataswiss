...
- **Keywords.de** `['vbz', 'strassenbahn', 'vektordaten', 'vbg', 'bus', 'buslinien', 'postauto', 'tramlinien', 'punktdaten', 'offentlicher-verkehr', 'geodaten', 'verkauf', 'tram', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-13T04:05:18.186349`
