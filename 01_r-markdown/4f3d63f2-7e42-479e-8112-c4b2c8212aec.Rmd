...
- **Keywords.de** `['strassenbahn', 'postauto', 'stzh', 'vbz', 'tram', 'vbg', 'geodaten', 'geoportal', 'vektordaten', 'buslinien', 'verkauf', 'offentlicher-verkehr', 'tramlinien', 'bus', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-02T10:17:34.357439`
