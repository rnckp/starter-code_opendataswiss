...
- **Keywords.de** `['punktdaten', 'geodaten', 'buslinien', 'bus', 'strassenbahn', 'vbz', 'stzh', 'offentlicher-verkehr', 'tramlinien', 'verkauf', 'tram', 'postauto', 'geoportal', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-29T03:27:55.371901`
