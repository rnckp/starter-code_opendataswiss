...
- **Keywords.de** `['tram', 'stzh', 'vektordaten', 'buslinien', 'verkauf', 'geodaten', 'tramlinien', 'geoportal', 'strassenbahn', 'bus', 'postauto', 'vbg', 'vbz', 'punktdaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-10T03:33:28.334861`
