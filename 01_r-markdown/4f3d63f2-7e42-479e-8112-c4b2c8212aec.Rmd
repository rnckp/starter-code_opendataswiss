...
- **Keywords.de** `['stzh', 'offentlicher-verkehr', 'tramlinien', 'tram', 'postauto', 'geodaten', 'buslinien', 'verkauf', 'vektordaten', 'vbg', 'punktdaten', 'bus', 'vbz', 'geoportal', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-21T02:54:04.483124`
