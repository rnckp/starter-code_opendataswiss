...
- **Keywords.de** `['verkauf', 'geodaten', 'bus', 'vektordaten', 'punktdaten', 'postauto', 'tram', 'tramlinien', 'strassenbahn', 'offentlicher-verkehr', 'geoportal', 'vbz', 'vbg', 'stzh', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-21T03:23:39.830744`
