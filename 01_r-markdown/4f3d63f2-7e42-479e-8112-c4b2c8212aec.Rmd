...
- **Keywords.de** `['geodaten', 'vbz', 'stzh', 'bus', 'punktdaten', 'verkauf', 'buslinien', 'tram', 'vektordaten', 'offentlicher-verkehr', 'vbg', 'strassenbahn', 'postauto', 'geoportal', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-04T04:07:29.476599`
