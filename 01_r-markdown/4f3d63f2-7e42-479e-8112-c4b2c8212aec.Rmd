...
- **Keywords.de** `['punktdaten', 'postauto', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'strassenbahn', 'vbg', 'geodaten', 'geoportal', 'vbz', 'buslinien', 'bus', 'tram', 'vektordaten', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-28T03:14:38.741878`
