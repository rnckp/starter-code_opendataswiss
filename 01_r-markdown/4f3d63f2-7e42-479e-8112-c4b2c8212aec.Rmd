...
- **Keywords.de** `['strassenbahn', 'vbz', 'postauto', 'stzh', 'vektordaten', 'bus', 'vbg', 'verkauf', 'tramlinien', 'buslinien', 'punktdaten', 'offentlicher-verkehr', 'geodaten', 'tram', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-15T03:34:36.788321`
