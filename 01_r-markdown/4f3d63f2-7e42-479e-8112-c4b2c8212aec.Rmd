...
- **Keywords.de** `['postauto', 'strassenbahn', 'tramlinien', 'buslinien', 'punktdaten', 'tram', 'vbz', 'verkauf', 'geoportal', 'vbg', 'bus', 'stzh', 'offentlicher-verkehr', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-25T03:40:44.170929`
