...
- **Keywords.de** `['vektordaten', 'stzh', 'offentlicher-verkehr', 'bus', 'verkauf', 'geodaten', 'tramlinien', 'vbg', 'vbz', 'strassenbahn', 'tram', 'geoportal', 'postauto', 'punktdaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-09T02:27:22.747324`
