...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'geoportal', 'punktdaten', 'strassenbahn', 'vbz', 'tramlinien', 'verkauf', 'tram', 'bus', 'postauto', 'vektordaten', 'geodaten', 'vbg', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-11T03:37:15.841168`
