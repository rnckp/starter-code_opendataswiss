...
- **Keywords.de** `['punktdaten', 'buslinien', 'vbg', 'geoportal', 'offentlicher-verkehr', 'stzh', 'strassenbahn', 'geodaten', 'vektordaten', 'vbz', 'tram', 'bus', 'tramlinien', 'postauto', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-09T03:28:48.345950`
