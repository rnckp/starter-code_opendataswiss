...
- **Keywords.de** `['stzh', 'geodaten', 'strassenbahn', 'punktdaten', 'offentlicher-verkehr', 'vektordaten', 'buslinien', 'postauto', 'vbz', 'verkauf', 'vbg', 'tramlinien', 'geoportal', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-07T03:32:10.363808`
