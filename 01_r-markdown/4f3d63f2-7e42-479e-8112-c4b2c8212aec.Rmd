...
- **Keywords.de** `['bus', 'tram', 'stzh', 'tramlinien', 'vektordaten', 'postauto', 'offentlicher-verkehr', 'vbg', 'vbz', 'verkauf', 'punktdaten', 'buslinien', 'geodaten', 'strassenbahn', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-10T03:05:38.528193`
