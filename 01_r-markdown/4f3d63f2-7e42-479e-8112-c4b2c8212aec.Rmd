...
- **Keywords.de** `['tram', 'bus', 'buslinien', 'geodaten', 'vektordaten', 'verkauf', 'stzh', 'vbz', 'vbg', 'postauto', 'tramlinien', 'strassenbahn', 'offentlicher-verkehr', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-24T03:29:19.559704`
