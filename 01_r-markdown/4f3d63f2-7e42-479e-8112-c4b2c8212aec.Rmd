...
- **Keywords.de** `['tramlinien', 'stzh', 'geoportal', 'offentlicher-verkehr', 'buslinien', 'vbz', 'tram', 'vektordaten', 'geodaten', 'punktdaten', 'verkauf', 'strassenbahn', 'vbg', 'postauto', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-09T04:10:18.326472`
