...
- **Keywords.de** `['postauto', 'vektordaten', 'offentlicher-verkehr', 'stzh', 'verkauf', 'vbz', 'bus', 'geodaten', 'strassenbahn', 'vbg', 'geoportal', 'buslinien', 'punktdaten', 'tram', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-04T03:18:45.041418`
