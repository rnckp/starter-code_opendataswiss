...
- **Keywords.de** `['geoportal', 'stzh', 'vbg', 'vektordaten', 'verkauf', 'punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien', 'tram', 'bus', 'geodaten', 'vbz', 'buslinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-03T05:31:48.789167`
