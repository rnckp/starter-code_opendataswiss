...
- **Keywords.de** `['stzh', 'punktdaten', 'vektordaten', 'tram', 'bus', 'verkauf', 'vbz', 'buslinien', 'postauto', 'geoportal', 'geodaten', 'offentlicher-verkehr', 'tramlinien', 'vbg', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-25T03:14:45.621315`
