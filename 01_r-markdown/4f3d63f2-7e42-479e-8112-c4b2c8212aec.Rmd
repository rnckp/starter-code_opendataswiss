...
- **Keywords.de** `['geoportal', 'stzh', 'vbg', 'buslinien', 'strassenbahn', 'vbz', 'punktdaten', 'postauto', 'tram', 'verkauf', 'tramlinien', 'geodaten', 'offentlicher-verkehr', 'vektordaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-20T03:46:09.060769`
