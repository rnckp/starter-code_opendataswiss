...
- **Keywords.de** `['vektordaten', 'postauto', 'tram', 'buslinien', 'bus', 'offentlicher-verkehr', 'punktdaten', 'tramlinien', 'vbg', 'geodaten', 'verkauf', 'vbz', 'stzh', 'strassenbahn', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-30T03:21:37.098876`
