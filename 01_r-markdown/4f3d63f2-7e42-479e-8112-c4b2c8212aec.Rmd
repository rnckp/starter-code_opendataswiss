...
- **Keywords.de** `['vbz', 'buslinien', 'vbg', 'vektordaten', 'strassenbahn', 'stzh', 'geodaten', 'tram', 'offentlicher-verkehr', 'punktdaten', 'verkauf', 'postauto', 'tramlinien', 'bus', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-04T03:29:20.413213`
