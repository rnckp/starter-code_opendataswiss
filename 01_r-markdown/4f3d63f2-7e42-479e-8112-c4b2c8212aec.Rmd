...
- **Keywords.de** `['buslinien', 'postauto', 'vbz', 'offentlicher-verkehr', 'geodaten', 'vektordaten', 'verkauf', 'bus', 'geoportal', 'tram', 'stzh', 'punktdaten', 'tramlinien', 'strassenbahn', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-05T02:52:42.041819`
