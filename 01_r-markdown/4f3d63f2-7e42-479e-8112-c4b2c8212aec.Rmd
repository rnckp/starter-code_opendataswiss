...
- **Keywords.de** `['buslinien', 'offentlicher-verkehr', 'vektordaten', 'vbz', 'stzh', 'tramlinien', 'punktdaten', 'vbg', 'strassenbahn', 'geoportal', 'tram', 'bus', 'geodaten', 'verkauf', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-03T04:07:29.815951`
