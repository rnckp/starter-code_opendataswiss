...
- **Keywords.de** `['vbg', 'strassenbahn', 'offentlicher-verkehr', 'geoportal', 'postauto', 'buslinien', 'stzh', 'punktdaten', 'bus', 'vbz', 'tram', 'tramlinien', 'geodaten', 'verkauf', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-11T03:24:55.933269`
