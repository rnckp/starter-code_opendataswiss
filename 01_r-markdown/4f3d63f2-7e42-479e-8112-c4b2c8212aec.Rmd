...
- **Keywords.de** `['vektordaten', 'geoportal', 'tram', 'punktdaten', 'tramlinien', 'bus', 'vbz', 'geodaten', 'offentlicher-verkehr', 'strassenbahn', 'verkauf', 'postauto', 'buslinien', 'vbg', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-24T02:50:06.667490`
