...
- **Keywords.de** `['vbg', 'geodaten', 'vbz', 'strassenbahn', 'buslinien', 'tramlinien', 'tram', 'bus', 'stzh', 'vektordaten', 'punktdaten', 'postauto', 'geoportal', 'verkauf', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-07T02:47:47.327291`
