...
- **Keywords.de** `['geoportal', 'tram', 'buslinien', 'postauto', 'vbg', 'vbz', 'bus', 'punktdaten', 'strassenbahn', 'tramlinien', 'vektordaten', 'verkauf', 'geodaten', 'stzh', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-15T03:43:45.797023`
