...
- **Keywords.de** `['postauto', 'strassenbahn', 'buslinien', 'vektordaten', 'verkauf', 'offentlicher-verkehr', 'geodaten', 'bus', 'geoportal', 'vbg', 'stzh', 'tramlinien', 'tram', 'punktdaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-30T03:22:00.231741`
