...
- **Keywords.de** `['postauto', 'offentlicher-verkehr', 'geoportal', 'bus', 'vektordaten', 'strassenbahn', 'tramlinien', 'tram', 'stzh', 'punktdaten', 'buslinien', 'vbg', 'vbz', 'verkauf', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-03T03:22:41.673115`
