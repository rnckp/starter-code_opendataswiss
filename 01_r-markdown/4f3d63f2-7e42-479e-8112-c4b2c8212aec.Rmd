...
- **Keywords.de** `['geodaten', 'tramlinien', 'offentlicher-verkehr', 'vbz', 'verkauf', 'punktdaten', 'vbg', 'stzh', 'vektordaten', 'strassenbahn', 'postauto', 'tram', 'geoportal', 'buslinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-04T02:57:42.199582`
