...
- **Keywords.de** `['vektordaten', 'vbg', 'offentlicher-verkehr', 'geodaten', 'stzh', 'postauto', 'bus', 'buslinien', 'vbz', 'tram', 'geoportal', 'verkauf', 'punktdaten', 'tramlinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-22T03:42:28.023236`
