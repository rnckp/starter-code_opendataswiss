...
- **Keywords.de** `['vbz', 'postauto', 'stzh', 'geoportal', 'tramlinien', 'verkauf', 'punktdaten', 'tram', 'bus', 'vektordaten', 'buslinien', 'strassenbahn', 'offentlicher-verkehr', 'vbg', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-07T03:25:28.823313`
