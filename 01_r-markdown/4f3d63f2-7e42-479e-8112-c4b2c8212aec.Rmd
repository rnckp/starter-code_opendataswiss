...
- **Keywords.de** `['bus', 'geoportal', 'strassenbahn', 'punktdaten', 'postauto', 'buslinien', 'verkauf', 'tram', 'offentlicher-verkehr', 'stzh', 'tramlinien', 'vbg', 'geodaten', 'vektordaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-17T02:25:49.593117`
