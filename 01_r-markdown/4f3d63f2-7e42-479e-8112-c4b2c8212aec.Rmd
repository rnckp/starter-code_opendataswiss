...
- **Keywords.de** `['geodaten', 'vbz', 'tramlinien', 'vektordaten', 'bus', 'stzh', 'strassenbahn', 'postauto', 'geoportal', 'verkauf', 'offentlicher-verkehr', 'punktdaten', 'buslinien', 'vbg', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-20T02:52:40.477630`
