...
- **Keywords.de** `['bus', 'tram', 'vektordaten', 'buslinien', 'postauto', 'stzh', 'offentlicher-verkehr', 'tramlinien', 'punktdaten', 'strassenbahn', 'geoportal', 'verkauf', 'vbz', 'geodaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-13T03:38:18.228926`
