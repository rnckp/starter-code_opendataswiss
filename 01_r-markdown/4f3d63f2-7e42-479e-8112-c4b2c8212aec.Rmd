...
- **Keywords.de** `['vbz', 'geodaten', 'tram', 'tramlinien', 'bus', 'stzh', 'offentlicher-verkehr', 'postauto', 'buslinien', 'geoportal', 'strassenbahn', 'vektordaten', 'verkauf', 'vbg', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-21T03:25:34.558996`
