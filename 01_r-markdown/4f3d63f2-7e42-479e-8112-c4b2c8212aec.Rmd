...
- **Keywords.de** `['offentlicher-verkehr', 'punktdaten', 'stzh', 'verkauf', 'vektordaten', 'strassenbahn', 'geodaten', 'vbz', 'tram', 'bus', 'geoportal', 'postauto', 'vbg', 'buslinien', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-04T03:26:45.631431`
