...
- **Keywords.de** `['bus', 'postauto', 'tramlinien', 'vektordaten', 'punktdaten', 'stzh', 'geoportal', 'verkauf', 'buslinien', 'strassenbahn', 'vbg', 'geodaten', 'vbz', 'offentlicher-verkehr', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-03T04:58:30.058738`
