...
- **Keywords.de** `['offentlicher-verkehr', 'bus', 'tram', 'vbz', 'tramlinien', 'verkauf', 'strassenbahn', 'buslinien', 'geoportal', 'vektordaten', 'stzh', 'punktdaten', 'vbg', 'geodaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-01T02:47:10.922963`
