...
- **Keywords.de** `['stzh', 'geodaten', 'vbg', 'offentlicher-verkehr', 'tramlinien', 'strassenbahn', 'postauto', 'vektordaten', 'geoportal', 'verkauf', 'buslinien', 'bus', 'vbz', 'tram', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-02T03:29:45.298138`
