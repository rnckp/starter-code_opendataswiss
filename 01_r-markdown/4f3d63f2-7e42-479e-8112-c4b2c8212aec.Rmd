...
- **Keywords.de** `['tram', 'geodaten', 'vbg', 'offentlicher-verkehr', 'tramlinien', 'punktdaten', 'buslinien', 'vektordaten', 'vbz', 'verkauf', 'postauto', 'stzh', 'geoportal', 'bus', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-08T03:25:59.422078`
