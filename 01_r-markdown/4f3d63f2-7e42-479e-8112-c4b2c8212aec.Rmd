...
- **Keywords.de** `['punktdaten', 'vektordaten', 'verkauf', 'tram', 'offentlicher-verkehr', 'vbz', 'bus', 'stzh', 'geodaten', 'tramlinien', 'strassenbahn', 'buslinien', 'geoportal', 'vbg', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-24T03:28:08.610796`
