...
- **Keywords.de** `['stzh', 'verkauf', 'geoportal', 'vbg', 'buslinien', 'bus', 'tram', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr', 'tramlinien', 'punktdaten', 'geodaten', 'postauto', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-28T04:39:00.551055`
