...
- **Keywords.de** `['buslinien', 'vbz', 'geodaten', 'vektordaten', 'vbg', 'strassenbahn', 'geoportal', 'postauto', 'tram', 'tramlinien', 'offentlicher-verkehr', 'verkauf', 'punktdaten', 'stzh', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-06T03:06:35.472840`
