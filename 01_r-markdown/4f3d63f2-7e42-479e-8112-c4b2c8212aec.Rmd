...
- **Keywords.de** `['vbg', 'stzh', 'buslinien', 'tramlinien', 'vektordaten', 'strassenbahn', 'vbz', 'geodaten', 'offentlicher-verkehr', 'bus', 'geoportal', 'punktdaten', 'postauto', 'tram', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-24T03:46:58.164063`
