...
- **Keywords.de** `['geodaten', 'buslinien', 'tramlinien', 'punktdaten', 'postauto', 'vbz', 'strassenbahn', 'bus', 'verkauf', 'vektordaten', 'offentlicher-verkehr', 'stzh', 'tram', 'geoportal', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-09T03:22:50.024274`
