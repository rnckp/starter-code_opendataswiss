...
- **Keywords.de** `['tramlinien', 'vektordaten', 'geoportal', 'verkauf', 'geodaten', 'strassenbahn', 'buslinien', 'bus', 'punktdaten', 'stzh', 'offentlicher-verkehr', 'vbz', 'tram', 'vbg', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-26T03:48:18.165817`
