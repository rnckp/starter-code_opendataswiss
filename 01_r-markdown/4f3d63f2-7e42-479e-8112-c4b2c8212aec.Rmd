...
- **Keywords.de** `['bus', 'vbg', 'geodaten', 'tram', 'vektordaten', 'strassenbahn', 'postauto', 'vbz', 'stzh', 'verkauf', 'offentlicher-verkehr', 'buslinien', 'punktdaten', 'geoportal', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-27T03:05:37.672863`
