...
- **Keywords.de** `['tram', 'buslinien', 'geodaten', 'punktdaten', 'geoportal', 'tramlinien', 'offentlicher-verkehr', 'verkauf', 'bus', 'strassenbahn', 'vbg', 'postauto', 'vektordaten', 'vbz', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-26T05:27:10.967845`
