...
- **Keywords.de** `['vbz', 'stzh', 'strassenbahn', 'bus', 'geodaten', 'tramlinien', 'punktdaten', 'offentlicher-verkehr', 'vektordaten', 'verkauf', 'tram', 'postauto', 'buslinien', 'vbg', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-17T04:02:04.617860`
