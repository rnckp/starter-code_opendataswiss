...
- **Keywords.de** `['buslinien', 'strassenbahn', 'punktdaten', 'tramlinien', 'geoportal', 'vbg', 'geodaten', 'vbz', 'offentlicher-verkehr', 'verkauf', 'stzh', 'bus', 'postauto', 'tram', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-19T03:36:26.522313`
