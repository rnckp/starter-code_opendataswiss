...
- **Keywords.de** `['stzh', 'verkauf', 'tramlinien', 'geoportal', 'vbg', 'strassenbahn', 'punktdaten', 'postauto', 'buslinien', 'tram', 'offentlicher-verkehr', 'bus', 'vbz', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-28T03:54:44.116394`
