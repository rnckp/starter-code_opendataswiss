...
- **Keywords.de** `['postauto', 'vbz', 'stzh', 'vbg', 'geodaten', 'vektordaten', 'bus', 'tramlinien', 'offentlicher-verkehr', 'tram', 'punktdaten', 'buslinien', 'verkauf', 'strassenbahn', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-13T04:00:53.891219`
