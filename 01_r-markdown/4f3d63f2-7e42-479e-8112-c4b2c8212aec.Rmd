...
- **Keywords.de** `['postauto', 'buslinien', 'vektordaten', 'verkauf', 'strassenbahn', 'vbz', 'vbg', 'tramlinien', 'offentlicher-verkehr', 'geoportal', 'punktdaten', 'stzh', 'bus', 'tram', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-04T04:04:44.970425`
