...
- **Keywords.de** `['punktdaten', 'buslinien', 'strassenbahn', 'vektordaten', 'bus', 'stzh', 'geodaten', 'verkauf', 'offentlicher-verkehr', 'vbg', 'tramlinien', 'tram', 'geoportal', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-09T03:14:59.425306`
