...
- **Keywords.de** `['punktdaten', 'vbg', 'vbz', 'vektordaten', 'tramlinien', 'bus', 'stzh', 'verkauf', 'geoportal', 'geodaten', 'tram', 'offentlicher-verkehr', 'postauto', 'buslinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-06T03:28:37.895392`
