...
- **Keywords.de** `['bus', 'strassenbahn', 'geodaten', 'postauto', 'geoportal', 'vektordaten', 'tramlinien', 'offentlicher-verkehr', 'buslinien', 'stzh', 'tram', 'vbz', 'punktdaten', 'vbg', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-24T02:52:08.677648`
