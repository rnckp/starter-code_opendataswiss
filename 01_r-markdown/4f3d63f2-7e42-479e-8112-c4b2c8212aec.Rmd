...
- **Keywords.de** `['tramlinien', 'punktdaten', 'buslinien', 'tram', 'verkauf', 'strassenbahn', 'vbz', 'geodaten', 'bus', 'vektordaten', 'offentlicher-verkehr', 'geoportal', 'stzh', 'postauto', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-04T03:21:33.209268`
