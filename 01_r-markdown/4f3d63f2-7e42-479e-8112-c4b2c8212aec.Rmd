...
- **Keywords.de** `['buslinien', 'verkauf', 'strassenbahn', 'postauto', 'stzh', 'vbg', 'vektordaten', 'geoportal', 'tram', 'punktdaten', 'bus', 'vbz', 'geodaten', 'tramlinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-25T03:24:57.407402`
