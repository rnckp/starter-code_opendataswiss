...
- **Keywords.de** `['verkauf', 'punktdaten', 'strassenbahn', 'buslinien', 'tramlinien', 'geodaten', 'vbg', 'geoportal', 'postauto', 'vbz', 'stzh', 'tram', 'vektordaten', 'offentlicher-verkehr', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-11T05:29:27.863848`
