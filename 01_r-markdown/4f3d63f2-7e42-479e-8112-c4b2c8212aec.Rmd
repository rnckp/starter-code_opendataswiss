...
- **Keywords.de** `['geoportal', 'geodaten', 'vbg', 'tram', 'punktdaten', 'tramlinien', 'verkauf', 'strassenbahn', 'stzh', 'offentlicher-verkehr', 'bus', 'buslinien', 'vektordaten', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-13T02:31:42.670143`
