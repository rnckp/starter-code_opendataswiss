...
- **Keywords.de** `['postauto', 'geoportal', 'vbz', 'tram', 'offentlicher-verkehr', 'geodaten', 'punktdaten', 'vektordaten', 'strassenbahn', 'stzh', 'vbg', 'verkauf', 'bus', 'buslinien', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-20T04:13:30.287410`
