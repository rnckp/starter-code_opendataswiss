...
- **Keywords.de** `['postauto', 'vektordaten', 'tramlinien', 'punktdaten', 'stzh', 'bus', 'strassenbahn', 'geoportal', 'vbz', 'vbg', 'verkauf', 'geodaten', 'offentlicher-verkehr', 'tram', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-06T02:50:08.752401`
