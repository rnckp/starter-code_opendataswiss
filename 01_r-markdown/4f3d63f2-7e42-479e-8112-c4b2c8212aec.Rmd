...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'bus', 'vbg', 'vbz', 'vektordaten', 'tramlinien', 'buslinien', 'punktdaten', 'verkauf', 'geodaten', 'geoportal', 'tram', 'strassenbahn', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-11T03:12:10.497634`
