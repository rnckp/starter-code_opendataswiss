...
- **Keywords.de** `['geoportal', 'vbz', 'geodaten', 'stzh', 'postauto', 'tram', 'offentlicher-verkehr', 'vbg', 'bus', 'buslinien', 'tramlinien', 'vektordaten', 'verkauf', 'punktdaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-27T03:12:52.291748`
