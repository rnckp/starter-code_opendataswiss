...
- **Keywords.de** `['verkauf', 'strassenbahn', 'stzh', 'vbz', 'vektordaten', 'buslinien', 'vbg', 'bus', 'tram', 'offentlicher-verkehr', 'punktdaten', 'tramlinien', 'geodaten', 'geoportal', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-09T04:21:01.810522`
