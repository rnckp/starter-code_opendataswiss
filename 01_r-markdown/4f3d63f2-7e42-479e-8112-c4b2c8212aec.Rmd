...
- **Keywords.de** `['geodaten', 'vektordaten', 'buslinien', 'vbz', 'tram', 'offentlicher-verkehr', 'geoportal', 'tramlinien', 'bus', 'verkauf', 'vbg', 'punktdaten', 'postauto', 'strassenbahn', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-10T03:32:20.845180`
