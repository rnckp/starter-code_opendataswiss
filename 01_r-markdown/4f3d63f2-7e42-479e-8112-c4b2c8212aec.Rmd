...
- **Keywords.de** `['verkauf', 'geoportal', 'vbz', 'tram', 'vbg', 'strassenbahn', 'punktdaten', 'stzh', 'buslinien', 'offentlicher-verkehr', 'postauto', 'vektordaten', 'bus', 'tramlinien', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-22T02:44:28.859148`
