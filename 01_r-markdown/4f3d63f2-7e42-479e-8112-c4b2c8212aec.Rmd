...
- **Keywords.de** `['bus', 'vektordaten', 'punktdaten', 'buslinien', 'stzh', 'geodaten', 'vbg', 'tramlinien', 'vbz', 'geoportal', 'tram', 'postauto', 'strassenbahn', 'offentlicher-verkehr', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-02T02:39:34.525281`
