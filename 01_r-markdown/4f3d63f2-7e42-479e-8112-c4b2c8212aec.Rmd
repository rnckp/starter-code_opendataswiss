...
- **Keywords.de** `['tram', 'vbz', 'vbg', 'geodaten', 'postauto', 'verkauf', 'punktdaten', 'buslinien', 'geoportal', 'offentlicher-verkehr', 'vektordaten', 'tramlinien', 'stzh', 'bus', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-18T03:35:20.239021`
