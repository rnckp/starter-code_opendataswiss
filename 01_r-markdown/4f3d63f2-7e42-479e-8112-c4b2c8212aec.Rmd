...
- **Keywords.de** `['vektordaten', 'vbz', 'tramlinien', 'stzh', 'geoportal', 'geodaten', 'punktdaten', 'tram', 'buslinien', 'offentlicher-verkehr', 'vbg', 'bus', 'postauto', 'verkauf', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-29T02:53:22.030172`
