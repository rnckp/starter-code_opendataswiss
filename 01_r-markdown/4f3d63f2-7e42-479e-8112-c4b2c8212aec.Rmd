...
- **Keywords.de** `['punktdaten', 'tram', 'tramlinien', 'vbg', 'geoportal', 'verkauf', 'geodaten', 'offentlicher-verkehr', 'postauto', 'strassenbahn', 'bus', 'buslinien', 'vbz', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-25T03:08:24.105478`
