...
- **Keywords.de** `['vbz', 'verkauf', 'tramlinien', 'stzh', 'bus', 'vbg', 'geodaten', 'punktdaten', 'tram', 'offentlicher-verkehr', 'postauto', 'strassenbahn', 'buslinien', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-14T03:15:55.377369`
