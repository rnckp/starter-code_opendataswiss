...
- **Keywords.de** `['offentlicher-verkehr', 'buslinien', 'punktdaten', 'geodaten', 'stzh', 'bus', 'tram', 'tramlinien', 'vbz', 'verkauf', 'vektordaten', 'vbg', 'geoportal', 'postauto', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-23T03:04:03.390966`
