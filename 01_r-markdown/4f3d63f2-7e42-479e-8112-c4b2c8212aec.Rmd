...
- **Keywords.de** `['buslinien', 'bus', 'verkauf', 'strassenbahn', 'vbz', 'offentlicher-verkehr', 'postauto', 'vbg', 'vektordaten', 'stzh', 'tramlinien', 'tram', 'punktdaten', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-07T03:26:17.029750`
