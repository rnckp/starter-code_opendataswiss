...
- **Keywords.de** `['vbg', 'bus', 'geodaten', 'postauto', 'verkauf', 'vbz', 'stzh', 'offentlicher-verkehr', 'geoportal', 'vektordaten', 'tram', 'tramlinien', 'punktdaten', 'strassenbahn', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-28T02:48:38.628983`
