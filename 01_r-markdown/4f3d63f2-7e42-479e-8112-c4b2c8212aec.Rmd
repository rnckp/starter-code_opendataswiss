...
- **Keywords.de** `['punktdaten', 'stzh', 'postauto', 'vbg', 'geoportal', 'strassenbahn', 'tram', 'tramlinien', 'bus', 'verkauf', 'buslinien', 'geodaten', 'vbz', 'offentlicher-verkehr', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-26T03:34:27.964822`
