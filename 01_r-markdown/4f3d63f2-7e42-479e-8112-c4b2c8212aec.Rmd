...
- **Keywords.de** `['punktdaten', 'geoportal', 'geodaten', 'bus', 'vbz', 'verkauf', 'tram', 'postauto', 'stzh', 'tramlinien', 'vektordaten', 'buslinien', 'strassenbahn', 'offentlicher-verkehr', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-30T03:03:46.204957`
