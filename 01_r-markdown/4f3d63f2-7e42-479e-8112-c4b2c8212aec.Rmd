...
- **Keywords.de** `['strassenbahn', 'tram', 'geodaten', 'vbz', 'tramlinien', 'vbg', 'bus', 'buslinien', 'geoportal', 'offentlicher-verkehr', 'vektordaten', 'stzh', 'postauto', 'verkauf', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-01T03:50:50.874860`
