...
- **Keywords.de** `['vbg', 'tram', 'bus', 'offentlicher-verkehr', 'verkauf', 'vektordaten', 'punktdaten', 'stzh', 'postauto', 'strassenbahn', 'vbz', 'tramlinien', 'geodaten', 'geoportal', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-17T03:08:19.055701`
