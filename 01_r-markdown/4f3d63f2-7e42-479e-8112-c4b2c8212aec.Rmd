...
- **Keywords.de** `['geoportal', 'vbz', 'tram', 'postauto', 'strassenbahn', 'geodaten', 'verkauf', 'punktdaten', 'stzh', 'buslinien', 'vektordaten', 'tramlinien', 'bus', 'vbg', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-04T07:05:55.032457`
