...
- **Keywords.de** `['vektordaten', 'tram', 'vbz', 'stzh', 'verkauf', 'geoportal', 'buslinien', 'tramlinien', 'postauto', 'offentlicher-verkehr', 'vbg', 'strassenbahn', 'punktdaten', 'geodaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-04T04:27:44.610538`
