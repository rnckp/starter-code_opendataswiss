...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'buslinien', 'vbz', 'geodaten', 'postauto', 'geoportal', 'tramlinien', 'vbg', 'tram', 'verkauf', 'punktdaten', 'bus', 'offentlicher-verkehr', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-13T03:27:05.119587`
