...
- **Keywords.de** `['strassenbahn', 'stzh', 'tram', 'buslinien', 'geoportal', 'vbg', 'postauto', 'vbz', 'verkauf', 'vektordaten', 'punktdaten', 'offentlicher-verkehr', 'geodaten', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-24T04:01:55.118600`
