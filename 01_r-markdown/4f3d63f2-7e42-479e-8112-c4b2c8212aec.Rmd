...
- **Keywords.de** `['vbg', 'geodaten', 'offentlicher-verkehr', 'verkauf', 'buslinien', 'tramlinien', 'strassenbahn', 'bus', 'stzh', 'vektordaten', 'vbz', 'punktdaten', 'postauto', 'geoportal', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-06T02:55:17.087625`
