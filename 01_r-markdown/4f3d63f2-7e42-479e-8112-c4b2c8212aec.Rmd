...
- **Keywords.de** `['vbz', 'geodaten', 'buslinien', 'strassenbahn', 'verkauf', 'vektordaten', 'offentlicher-verkehr', 'stzh', 'vbg', 'punktdaten', 'tramlinien', 'geoportal', 'tram', 'postauto', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-04T03:58:26.962503`
