...
- **Keywords.de** `['vektordaten', 'bus', 'strassenbahn', 'verkauf', 'stzh', 'vbz', 'buslinien', 'tramlinien', 'geodaten', 'postauto', 'punktdaten', 'geoportal', 'offentlicher-verkehr', 'vbg', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-18T02:53:49.144080`
