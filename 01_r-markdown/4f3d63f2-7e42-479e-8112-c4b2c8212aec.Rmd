...
- **Keywords.de** `['geoportal', 'vbz', 'tramlinien', 'punktdaten', 'verkauf', 'buslinien', 'geodaten', 'strassenbahn', 'tram', 'stzh', 'offentlicher-verkehr', 'postauto', 'vektordaten', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-25T03:32:05.584723`
