...
- **Keywords.de** `['postauto', 'tram', 'bus', 'tramlinien', 'punktdaten', 'vbz', 'vektordaten', 'verkauf', 'buslinien', 'strassenbahn', 'stzh', 'vbg', 'offentlicher-verkehr', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-15T03:05:54.608703`
