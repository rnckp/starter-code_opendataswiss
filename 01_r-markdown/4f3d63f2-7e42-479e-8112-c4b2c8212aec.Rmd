...
- **Keywords.de** `['verkauf', 'geoportal', 'offentlicher-verkehr', 'vbz', 'geodaten', 'buslinien', 'postauto', 'bus', 'vektordaten', 'tram', 'stzh', 'tramlinien', 'punktdaten', 'strassenbahn', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-17T02:51:03.026980`
