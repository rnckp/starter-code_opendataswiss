...
- **Keywords.de** `['strassenbahn', 'bus', 'vbz', 'punktdaten', 'postauto', 'tram', 'verkauf', 'vbg', 'offentlicher-verkehr', 'geoportal', 'buslinien', 'stzh', 'vektordaten', 'tramlinien', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-17T03:42:04.951300`
