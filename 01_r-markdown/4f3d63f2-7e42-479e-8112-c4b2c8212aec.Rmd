...
- **Keywords.de** `['vbg', 'bus', 'tram', 'vbz', 'vektordaten', 'offentlicher-verkehr', 'verkauf', 'buslinien', 'stzh', 'strassenbahn', 'geodaten', 'postauto', 'geoportal', 'tramlinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-15T02:53:59.167516`
