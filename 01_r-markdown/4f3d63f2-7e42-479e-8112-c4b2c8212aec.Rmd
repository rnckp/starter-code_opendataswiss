...
- **Keywords.de** `['vbz', 'buslinien', 'stzh', 'geoportal', 'tramlinien', 'punktdaten', 'vbg', 'verkauf', 'vektordaten', 'strassenbahn', 'geodaten', 'tram', 'postauto', 'bus', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-11T03:01:57.517968`
