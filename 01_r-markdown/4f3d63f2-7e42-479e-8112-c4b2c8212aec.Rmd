...
- **Keywords.de** `['strassenbahn', 'bus', 'offentlicher-verkehr', 'tram', 'vbz', 'punktdaten', 'geoportal', 'postauto', 'buslinien', 'verkauf', 'vektordaten', 'vbg', 'geodaten', 'stzh', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-14T03:08:22.089923`
