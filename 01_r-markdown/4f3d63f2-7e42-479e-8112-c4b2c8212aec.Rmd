...
- **Keywords.de** `['punktdaten', 'vbg', 'tramlinien', 'verkauf', 'geoportal', 'tram', 'bus', 'postauto', 'stzh', 'geodaten', 'strassenbahn', 'offentlicher-verkehr', 'vektordaten', 'buslinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-13T02:57:06.348290`
