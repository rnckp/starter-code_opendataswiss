...
- **Keywords.de** `['tramlinien', 'tram', 'strassenbahn', 'stzh', 'punktdaten', 'offentlicher-verkehr', 'vbz', 'vektordaten', 'vbg', 'bus', 'verkauf', 'geoportal', 'postauto', 'geodaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-10T02:54:29.181969`
