...
- **Keywords.de** `['offentlicher-verkehr', 'tram', 'punktdaten', 'postauto', 'stzh', 'vbg', 'geodaten', 'geoportal', 'bus', 'strassenbahn', 'vbz', 'buslinien', 'verkauf', 'tramlinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-17T01:51:18.418319`
