...
- **Keywords.de** `['postauto', 'bus', 'offentlicher-verkehr', 'buslinien', 'punktdaten', 'geodaten', 'tramlinien', 'vbz', 'geoportal', 'vbg', 'strassenbahn', 'tram', 'verkauf', 'stzh', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-08T05:34:56.851500`
