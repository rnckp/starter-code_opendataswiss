...
- **Keywords.de** `['geoportal', 'tramlinien', 'vektordaten', 'punktdaten', 'geodaten', 'bus', 'buslinien', 'tram', 'offentlicher-verkehr', 'postauto', 'stzh', 'verkauf', 'strassenbahn', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-26T03:07:40.515689`
