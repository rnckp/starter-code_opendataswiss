...
- **Keywords.de** `['offentlicher-verkehr', 'postauto', 'vbg', 'geodaten', 'buslinien', 'vbz', 'stzh', 'verkauf', 'tram', 'geoportal', 'tramlinien', 'vektordaten', 'strassenbahn', 'punktdaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-15T05:09:15.534776`
