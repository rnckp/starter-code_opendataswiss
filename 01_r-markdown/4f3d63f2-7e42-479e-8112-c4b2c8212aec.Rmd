...
- **Keywords.de** `['verkauf', 'vektordaten', 'strassenbahn', 'stzh', 'postauto', 'punktdaten', 'geodaten', 'bus', 'offentlicher-verkehr', 'vbz', 'vbg', 'geoportal', 'buslinien', 'tram', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-12T03:14:32.537220`
