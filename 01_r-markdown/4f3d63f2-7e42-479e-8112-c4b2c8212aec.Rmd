...
- **Keywords.de** `['geoportal', 'tram', 'verkauf', 'buslinien', 'stzh', 'offentlicher-verkehr', 'vbz', 'vbg', 'punktdaten', 'tramlinien', 'bus', 'geodaten', 'postauto', 'strassenbahn', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-29T03:24:02.039240`
