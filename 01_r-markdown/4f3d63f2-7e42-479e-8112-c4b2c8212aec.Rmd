...
- **Keywords.de** `['postauto', 'geodaten', 'tramlinien', 'bus', 'geoportal', 'buslinien', 'stzh', 'offentlicher-verkehr', 'vbz', 'tram', 'punktdaten', 'vektordaten', 'verkauf', 'vbg', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-02T03:04:47.706611`
