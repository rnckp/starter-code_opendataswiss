...
- **Keywords.de** `['geoportal', 'stzh', 'punktdaten', 'vbz', 'buslinien', 'geodaten', 'tramlinien', 'offentlicher-verkehr', 'tram', 'vbg', 'bus', 'strassenbahn', 'postauto', 'vektordaten', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-20T04:59:37.839266`
