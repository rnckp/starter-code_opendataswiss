...
- **Keywords.de** `['punktdaten', 'verkauf', 'stzh', 'postauto', 'geoportal', 'vbg', 'bus', 'tram', 'vektordaten', 'geodaten', 'vbz', 'buslinien', 'tramlinien', 'strassenbahn', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-02T02:57:50.258283`
