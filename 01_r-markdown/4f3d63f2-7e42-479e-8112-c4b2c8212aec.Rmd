...
- **Keywords.de** `['bus', 'punktdaten', 'vbz', 'geodaten', 'verkauf', 'vektordaten', 'geoportal', 'vbg', 'offentlicher-verkehr', 'tramlinien', 'buslinien', 'stzh', 'strassenbahn', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-08T03:35:13.487649`
