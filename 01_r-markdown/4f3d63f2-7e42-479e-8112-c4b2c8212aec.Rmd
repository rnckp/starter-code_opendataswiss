...
- **Keywords.de** `['tram', 'tramlinien', 'geoportal', 'bus', 'postauto', 'verkauf', 'vbg', 'offentlicher-verkehr', 'vektordaten', 'stzh', 'punktdaten', 'strassenbahn', 'geodaten', 'vbz', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-23T04:48:10.730191`
