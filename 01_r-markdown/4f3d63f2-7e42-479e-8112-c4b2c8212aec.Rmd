...
- **Keywords.de** `['punktdaten', 'strassenbahn', 'buslinien', 'vbg', 'geoportal', 'verkauf', 'bus', 'postauto', 'vbz', 'tramlinien', 'vektordaten', 'stzh', 'tram', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-05T03:44:56.509011`
