...
- **Keywords.de** `['verkauf', 'tramlinien', 'geodaten', 'vbg', 'strassenbahn', 'tram', 'geoportal', 'buslinien', 'punktdaten', 'offentlicher-verkehr', 'vektordaten', 'bus', 'vbz', 'stzh', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-02T03:17:06.700808`
