...
- **Keywords.de** `['verkauf', 'punktdaten', 'stzh', 'vbz', 'vbg', 'offentlicher-verkehr', 'geodaten', 'tram', 'vektordaten', 'strassenbahn', 'buslinien', 'geoportal', 'bus', 'tramlinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-01T03:21:55.418328`
