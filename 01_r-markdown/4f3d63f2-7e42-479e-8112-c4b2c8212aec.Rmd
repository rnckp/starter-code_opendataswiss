...
- **Keywords.de** `['punktdaten', 'geodaten', 'bus', 'postauto', 'buslinien', 'vbg', 'strassenbahn', 'tram', 'tramlinien', 'vbz', 'geoportal', 'vektordaten', 'stzh', 'verkauf', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-06T03:10:41.680294`
