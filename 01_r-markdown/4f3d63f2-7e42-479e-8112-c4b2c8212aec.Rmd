...
- **Keywords.de** `['punktdaten', 'verkauf', 'offentlicher-verkehr', 'geodaten', 'tram', 'geoportal', 'bus', 'strassenbahn', 'vbz', 'tramlinien', 'stzh', 'vektordaten', 'postauto', 'vbg', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-20T02:51:23.766061`
