...
- **Keywords.de** `['tramlinien', 'geoportal', 'bus', 'vbz', 'strassenbahn', 'offentlicher-verkehr', 'geodaten', 'punktdaten', 'verkauf', 'stzh', 'tram', 'vektordaten', 'buslinien', 'vbg', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-03T03:15:22.191383`
