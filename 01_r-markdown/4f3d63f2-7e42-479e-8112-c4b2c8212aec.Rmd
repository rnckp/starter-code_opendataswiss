...
- **Keywords.de** `['tram', 'vbg', 'offentlicher-verkehr', 'vektordaten', 'stzh', 'punktdaten', 'verkauf', 'tramlinien', 'strassenbahn', 'geodaten', 'bus', 'buslinien', 'geoportal', 'postauto', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-19T03:33:44.970127`
