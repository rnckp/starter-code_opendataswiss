...
- **Keywords.de** `['vbg', 'vektordaten', 'tram', 'stzh', 'offentlicher-verkehr', 'vbz', 'tramlinien', 'postauto', 'buslinien', 'punktdaten', 'geodaten', 'geoportal', 'verkauf', 'bus', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-14T02:50:34.417929`
