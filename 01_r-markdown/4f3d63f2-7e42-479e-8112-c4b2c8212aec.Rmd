...
- **Keywords.de** `['offentlicher-verkehr', 'tram', 'verkauf', 'buslinien', 'postauto', 'stzh', 'geoportal', 'vektordaten', 'bus', 'vbg', 'vbz', 'strassenbahn', 'punktdaten', 'geodaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-24T03:31:05.344004`
