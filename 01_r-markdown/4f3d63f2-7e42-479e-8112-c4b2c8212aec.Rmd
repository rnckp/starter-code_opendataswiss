...
- **Keywords.de** `['vbg', 'geoportal', 'vektordaten', 'bus', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'tramlinien', 'postauto', 'stzh', 'strassenbahn', 'buslinien', 'tram', 'vbz', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-01T03:35:04.007458`
