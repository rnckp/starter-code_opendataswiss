...
- **Keywords.de** `['punktdaten', 'vbz', 'vektordaten', 'tram', 'tramlinien', 'offentlicher-verkehr', 'strassenbahn', 'buslinien', 'geodaten', 'geoportal', 'bus', 'stzh', 'verkauf', 'postauto', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-12T03:44:32.629636`
