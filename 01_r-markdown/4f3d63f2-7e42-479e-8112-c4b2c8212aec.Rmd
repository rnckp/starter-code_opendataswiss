...
- **Keywords.de** `['tram', 'vbz', 'stzh', 'geodaten', 'offentlicher-verkehr', 'bus', 'verkauf', 'tramlinien', 'punktdaten', 'buslinien', 'geoportal', 'postauto', 'vektordaten', 'strassenbahn', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-16T03:16:15.153089`
