...
- **Keywords.de** `['stzh', 'tramlinien', 'vektordaten', 'offentlicher-verkehr', 'vbg', 'postauto', 'bus', 'geoportal', 'geodaten', 'tram', 'punktdaten', 'verkauf', 'vbz', 'strassenbahn', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-08T02:53:49.607474`
