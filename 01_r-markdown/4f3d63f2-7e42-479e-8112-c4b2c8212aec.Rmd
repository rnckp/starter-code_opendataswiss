...
- **Keywords.de** `['vbz', 'geodaten', 'punktdaten', 'buslinien', 'postauto', 'bus', 'strassenbahn', 'geoportal', 'tramlinien', 'vektordaten', 'tram', 'stzh', 'offentlicher-verkehr', 'vbg', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-17T02:55:39.356240`
