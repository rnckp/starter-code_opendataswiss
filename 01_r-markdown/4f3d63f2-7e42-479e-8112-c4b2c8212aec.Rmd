...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'buslinien', 'punktdaten', 'strassenbahn', 'verkauf', 'postauto', 'tram', 'stzh', 'geodaten', 'vbz', 'bus', 'vbg', 'tramlinien', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-16T03:05:08.263868`
