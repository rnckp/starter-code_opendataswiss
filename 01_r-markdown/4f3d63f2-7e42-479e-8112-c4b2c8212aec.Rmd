...
- **Keywords.de** `['postauto', 'geodaten', 'geoportal', 'vektordaten', 'vbz', 'tramlinien', 'bus', 'stzh', 'vbg', 'offentlicher-verkehr', 'tram', 'punktdaten', 'verkauf', 'buslinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-16T02:43:39.386074`
