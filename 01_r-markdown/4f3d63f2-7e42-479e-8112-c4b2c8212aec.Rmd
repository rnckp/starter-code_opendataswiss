...
- **Keywords.de** `['geoportal', 'buslinien', 'tram', 'vektordaten', 'stzh', 'verkauf', 'postauto', 'vbg', 'geodaten', 'strassenbahn', 'offentlicher-verkehr', 'tramlinien', 'vbz', 'bus', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-14T03:30:14.903244`
