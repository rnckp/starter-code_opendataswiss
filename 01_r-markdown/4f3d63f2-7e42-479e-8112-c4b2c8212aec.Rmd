...
- **Keywords.de** `['postauto', 'vbg', 'buslinien', 'tramlinien', 'vbz', 'strassenbahn', 'bus', 'offentlicher-verkehr', 'geodaten', 'punktdaten', 'tram', 'verkauf', 'vektordaten', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-31T03:20:52.773317`
