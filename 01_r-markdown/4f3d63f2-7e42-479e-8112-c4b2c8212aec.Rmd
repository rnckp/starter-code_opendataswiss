...
- **Keywords.de** `['tram', 'tramlinien', 'offentlicher-verkehr', 'geodaten', 'bus', 'verkauf', 'buslinien', 'stzh', 'strassenbahn', 'vektordaten', 'punktdaten', 'postauto', 'geoportal', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-17T03:32:19.788008`
