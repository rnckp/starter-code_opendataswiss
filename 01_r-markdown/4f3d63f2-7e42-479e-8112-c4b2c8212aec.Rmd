...
- **Keywords.de** `['punktdaten', 'strassenbahn', 'tram', 'bus', 'stzh', 'verkauf', 'offentlicher-verkehr', 'postauto', 'geodaten', 'vbz', 'tramlinien', 'buslinien', 'vbg', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-14T03:09:48.259076`
