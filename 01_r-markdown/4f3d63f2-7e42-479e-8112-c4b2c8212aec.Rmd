...
- **Keywords.de** `['geoportal', 'bus', 'geodaten', 'stzh', 'tram', 'vbg', 'vbz', 'buslinien', 'vektordaten', 'verkauf', 'punktdaten', 'tramlinien', 'strassenbahn', 'postauto', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-18T03:10:06.358862`
