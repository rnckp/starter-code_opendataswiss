...
- **Keywords.de** `['verkauf', 'vektordaten', 'tramlinien', 'strassenbahn', 'geodaten', 'vbz', 'vbg', 'offentlicher-verkehr', 'punktdaten', 'postauto', 'bus', 'geoportal', 'stzh', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-17T03:13:28.711987`
