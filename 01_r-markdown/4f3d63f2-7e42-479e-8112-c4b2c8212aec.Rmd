...
- **Keywords.de** `['verkauf', 'tram', 'stzh', 'strassenbahn', 'buslinien', 'bus', 'postauto', 'vektordaten', 'tramlinien', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'geoportal', 'vbz', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-26T03:42:50.910037`
