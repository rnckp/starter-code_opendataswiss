...
- **Keywords.de** `['postauto', 'tramlinien', 'vbz', 'verkauf', 'vektordaten', 'stzh', 'offentlicher-verkehr', 'buslinien', 'tram', 'geodaten', 'strassenbahn', 'geoportal', 'punktdaten', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-20T02:13:43.047764`
