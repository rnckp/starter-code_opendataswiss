...
- **Keywords.de** `['offentlicher-verkehr', 'tram', 'stzh', 'geodaten', 'buslinien', 'vbg', 'strassenbahn', 'verkauf', 'geoportal', 'postauto', 'tramlinien', 'vbz', 'vektordaten', 'punktdaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-20T03:28:21.296478`
