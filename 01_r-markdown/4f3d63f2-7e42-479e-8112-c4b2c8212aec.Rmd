...
- **Keywords.de** `['offentlicher-verkehr', 'geodaten', 'vektordaten', 'strassenbahn', 'verkauf', 'bus', 'vbg', 'buslinien', 'postauto', 'tram', 'tramlinien', 'geoportal', 'stzh', 'punktdaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-26T03:10:31.755442`
