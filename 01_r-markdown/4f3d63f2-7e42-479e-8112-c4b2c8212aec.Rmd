...
- **Keywords.de** `['tramlinien', 'stzh', 'verkauf', 'strassenbahn', 'buslinien', 'punktdaten', 'tram', 'vbg', 'postauto', 'vektordaten', 'geoportal', 'geodaten', 'vbz', 'offentlicher-verkehr', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-26T02:58:13.036268`
