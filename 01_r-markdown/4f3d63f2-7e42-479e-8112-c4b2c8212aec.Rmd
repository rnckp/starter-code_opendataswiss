...
- **Keywords.de** `['verkauf', 'punktdaten', 'stzh', 'geodaten', 'offentlicher-verkehr', 'strassenbahn', 'geoportal', 'postauto', 'tramlinien', 'tram', 'buslinien', 'vbg', 'vbz', 'bus', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-27T03:28:30.486684`
