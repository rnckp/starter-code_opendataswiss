...
- **Keywords.de** `['tram', 'tramlinien', 'strassenbahn', 'buslinien', 'punktdaten', 'vbz', 'geodaten', 'bus', 'geoportal', 'verkauf', 'postauto', 'vektordaten', 'stzh', 'offentlicher-verkehr', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-06T03:21:01.584395`
