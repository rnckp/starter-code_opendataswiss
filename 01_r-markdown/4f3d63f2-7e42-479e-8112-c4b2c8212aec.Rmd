...
- **Keywords.de** `['vektordaten', 'geoportal', 'verkauf', 'tram', 'vbg', 'tramlinien', 'offentlicher-verkehr', 'strassenbahn', 'postauto', 'punktdaten', 'bus', 'buslinien', 'geodaten', 'stzh', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-24T02:59:35.756124`
