...
- **Keywords.de** `['tram', 'verkauf', 'bus', 'stzh', 'geoportal', 'postauto', 'punktdaten', 'vektordaten', 'vbg', 'geodaten', 'buslinien', 'strassenbahn', 'vbz', 'tramlinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-23T03:28:21.956015`
