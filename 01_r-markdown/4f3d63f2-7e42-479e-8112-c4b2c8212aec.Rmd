...
- **Keywords.de** `['tram', 'vektordaten', 'geodaten', 'bus', 'buslinien', 'geoportal', 'verkauf', 'vbg', 'punktdaten', 'vbz', 'offentlicher-verkehr', 'tramlinien', 'strassenbahn', 'stzh', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-26T03:00:08.827850`
