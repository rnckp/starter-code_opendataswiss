...
- **Keywords.de** `['vbz', 'punktdaten', 'geoportal', 'verkauf', 'buslinien', 'offentlicher-verkehr', 'strassenbahn', 'postauto', 'stzh', 'vbg', 'geodaten', 'tramlinien', 'vektordaten', 'bus', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-19T02:06:40.694052`
