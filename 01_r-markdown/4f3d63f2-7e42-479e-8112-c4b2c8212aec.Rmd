...
- **Keywords.de** `['buslinien', 'tram', 'bus', 'geoportal', 'tramlinien', 'offentlicher-verkehr', 'verkauf', 'geodaten', 'vbg', 'stzh', 'vektordaten', 'postauto', 'vbz', 'strassenbahn', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-24T02:48:05.155139`
