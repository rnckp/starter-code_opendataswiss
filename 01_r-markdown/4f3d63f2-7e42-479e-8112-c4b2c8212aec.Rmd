...
- **Keywords.de** `['geoportal', 'tram', 'punktdaten', 'tramlinien', 'stzh', 'vbz', 'geodaten', 'postauto', 'verkauf', 'strassenbahn', 'offentlicher-verkehr', 'buslinien', 'bus', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-07T03:26:41.292107`
