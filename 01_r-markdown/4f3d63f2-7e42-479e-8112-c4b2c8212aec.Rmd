...
- **Keywords.de** `['vektordaten', 'vbz', 'tram', 'offentlicher-verkehr', 'verkauf', 'vbg', 'tramlinien', 'postauto', 'buslinien', 'punktdaten', 'geoportal', 'geodaten', 'bus', 'strassenbahn', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-10T02:47:36.046894`
