...
- **Keywords.de** `['vbz', 'geoportal', 'tram', 'punktdaten', 'postauto', 'vektordaten', 'bus', 'buslinien', 'geodaten', 'tramlinien', 'verkauf', 'offentlicher-verkehr', 'stzh', 'vbg', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-24T03:29:00.960029`
