...
- **Keywords.de** `['verkauf', 'buslinien', 'tram', 'geoportal', 'tramlinien', 'bus', 'punktdaten', 'offentlicher-verkehr', 'postauto', 'vbg', 'stzh', 'strassenbahn', 'geodaten', 'vektordaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-06T03:15:33.321165`
