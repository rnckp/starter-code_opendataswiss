...
- **Keywords.de** `['verkauf', 'bus', 'vbz', 'offentlicher-verkehr', 'buslinien', 'tram', 'stzh', 'punktdaten', 'postauto', 'geoportal', 'vektordaten', 'geodaten', 'strassenbahn', 'vbg', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-01T04:08:49.977621`
