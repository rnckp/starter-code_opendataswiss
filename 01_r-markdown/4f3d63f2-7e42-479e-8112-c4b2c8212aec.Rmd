...
- **Keywords.de** `['geodaten', 'tram', 'bus', 'tramlinien', 'stzh', 'buslinien', 'verkauf', 'postauto', 'punktdaten', 'vbz', 'strassenbahn', 'offentlicher-verkehr', 'geoportal', 'vektordaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-12T03:15:54.351223`
