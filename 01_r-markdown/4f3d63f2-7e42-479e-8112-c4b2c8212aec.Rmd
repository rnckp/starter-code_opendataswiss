...
- **Keywords.de** `['punktdaten', 'geodaten', 'tramlinien', 'stzh', 'geoportal', 'vektordaten', 'offentlicher-verkehr', 'postauto', 'strassenbahn', 'bus', 'buslinien', 'tram', 'vbg', 'verkauf', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-22T03:31:54.134354`
