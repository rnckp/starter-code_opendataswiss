...
- **Keywords.de** `['strassenbahn', 'punktdaten', 'vbg', 'tramlinien', 'tram', 'vbz', 'bus', 'verkauf', 'offentlicher-verkehr', 'geoportal', 'geodaten', 'postauto', 'vektordaten', 'buslinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-29T04:15:23.749144`
