...
- **Keywords.de** `['verkauf', 'offentlicher-verkehr', 'bus', 'tramlinien', 'punktdaten', 'geodaten', 'vbg', 'geoportal', 'postauto', 'vektordaten', 'strassenbahn', 'buslinien', 'stzh', 'tram', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-20T02:47:05.753129`
