...
- **Keywords.de** `['tramlinien', 'tram', 'offentlicher-verkehr', 'vbg', 'strassenbahn', 'vbz', 'geoportal', 'postauto', 'geodaten', 'vektordaten', 'bus', 'stzh', 'punktdaten', 'verkauf', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-13T03:39:56.847560`
