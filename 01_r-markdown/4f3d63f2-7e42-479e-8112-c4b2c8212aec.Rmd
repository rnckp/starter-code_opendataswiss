...
- **Keywords.de** `['punktdaten', 'tramlinien', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'tram', 'buslinien', 'verkauf', 'postauto', 'geodaten', 'stzh', 'geoportal', 'bus', 'vbz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-09T02:24:04.559589`
