...
- **Keywords.de** `['tramlinien', 'strassenbahn', 'offentlicher-verkehr', 'punktdaten', 'bus', 'postauto', 'tram', 'stzh', 'geoportal', 'vbz', 'vbg', 'buslinien', 'geodaten', 'vektordaten', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-10T03:14:54.263860`
