...
- **Keywords.de** `['postauto', 'offentlicher-verkehr', 'stzh', 'verkauf', 'vektordaten', 'tramlinien', 'vbg', 'bus', 'vbz', 'geodaten', 'tram', 'geoportal', 'buslinien', 'strassenbahn', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-26T02:52:30.368044`
