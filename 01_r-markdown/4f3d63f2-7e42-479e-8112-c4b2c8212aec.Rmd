...
- **Keywords.de** `['postauto', 'vbz', 'geoportal', 'verkauf', 'vektordaten', 'punktdaten', 'tramlinien', 'stzh', 'geodaten', 'offentlicher-verkehr', 'vbg', 'tram', 'bus', 'strassenbahn', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-15T03:33:45.232149`
