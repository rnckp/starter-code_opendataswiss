...
- **Keywords.de** `['tram', 'vbz', 'vbg', 'stzh', 'offentlicher-verkehr', 'buslinien', 'verkauf', 'vektordaten', 'strassenbahn', 'postauto', 'tramlinien', 'geodaten', 'geoportal', 'punktdaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-31T08:15:07.529212`
