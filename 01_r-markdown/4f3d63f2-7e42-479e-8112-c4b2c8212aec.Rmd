...
- **Keywords.de** `['stzh', 'vbg', 'vektordaten', 'tramlinien', 'postauto', 'offentlicher-verkehr', 'punktdaten', 'strassenbahn', 'verkauf', 'geodaten', 'vbz', 'geoportal', 'buslinien', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-30T03:02:17.525086`
