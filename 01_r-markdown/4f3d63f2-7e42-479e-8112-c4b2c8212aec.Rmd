...
- **Keywords.de** `['bus', 'stzh', 'tram', 'geoportal', 'vbg', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien', 'geodaten', 'buslinien', 'vektordaten', 'verkauf', 'vbz', 'punktdaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-20T03:42:23.596356`
