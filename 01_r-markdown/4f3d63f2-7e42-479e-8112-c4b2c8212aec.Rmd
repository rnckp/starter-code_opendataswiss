...
- **Keywords.de** `['punktdaten', 'strassenbahn', 'geodaten', 'vbg', 'tramlinien', 'vbz', 'buslinien', 'postauto', 'tram', 'stzh', 'vektordaten', 'verkauf', 'bus', 'offentlicher-verkehr', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-09T03:31:28.109408`
