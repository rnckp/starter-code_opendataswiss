...
- **Keywords.de** `['vektordaten', 'vbg', 'geoportal', 'bus', 'strassenbahn', 'geodaten', 'offentlicher-verkehr', 'verkauf', 'postauto', 'tram', 'buslinien', 'vbz', 'stzh', 'tramlinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-11T03:18:58.310918`
