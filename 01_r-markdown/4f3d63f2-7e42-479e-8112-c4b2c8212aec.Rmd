...
- **Keywords.de** `['tramlinien', 'geoportal', 'vbz', 'buslinien', 'verkauf', 'bus', 'punktdaten', 'strassenbahn', 'geodaten', 'tram', 'vektordaten', 'stzh', 'vbg', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-13T04:27:16.389821`
