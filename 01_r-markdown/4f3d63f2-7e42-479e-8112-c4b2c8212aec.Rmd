...
- **Keywords.de** `['vbz', 'geoportal', 'vbg', 'postauto', 'geodaten', 'buslinien', 'vektordaten', 'strassenbahn', 'offentlicher-verkehr', 'bus', 'verkauf', 'tramlinien', 'punktdaten', 'stzh', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-10T03:35:39.444432`
