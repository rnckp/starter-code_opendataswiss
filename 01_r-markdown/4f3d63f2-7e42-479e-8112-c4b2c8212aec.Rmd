...
- **Keywords.de** `['geodaten', 'tram', 'vbz', 'postauto', 'tramlinien', 'punktdaten', 'stzh', 'verkauf', 'vbg', 'geoportal', 'offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'buslinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-18T03:22:07.918915`
