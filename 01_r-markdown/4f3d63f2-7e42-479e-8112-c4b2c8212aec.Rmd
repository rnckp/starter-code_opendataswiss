...
- **Keywords.de** `['geodaten', 'stzh', 'tramlinien', 'strassenbahn', 'geoportal', 'offentlicher-verkehr', 'vektordaten', 'buslinien', 'verkauf', 'punktdaten', 'vbz', 'bus', 'vbg', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-23T02:47:48.174759`
