...
- **Keywords.de** `['vektordaten', 'postauto', 'tram', 'offentlicher-verkehr', 'verkauf', 'geoportal', 'tramlinien', 'bus', 'punktdaten', 'stzh', 'strassenbahn', 'vbg', 'buslinien', 'geodaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-09T02:59:49.960283`
