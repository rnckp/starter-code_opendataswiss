...
- **Keywords.de** `['vbz', 'punktdaten', 'strassenbahn', 'tram', 'bus', 'vektordaten', 'geoportal', 'postauto', 'offentlicher-verkehr', 'tramlinien', 'stzh', 'buslinien', 'vbg', 'verkauf', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-07T03:19:38.914661`
