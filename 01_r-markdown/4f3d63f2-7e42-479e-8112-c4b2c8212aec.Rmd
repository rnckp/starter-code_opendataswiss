...
- **Keywords.de** `['tram', 'geodaten', 'offentlicher-verkehr', 'tramlinien', 'verkauf', 'buslinien', 'bus', 'geoportal', 'strassenbahn', 'stzh', 'vektordaten', 'punktdaten', 'vbz', 'postauto', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-08T04:59:39.865503`
