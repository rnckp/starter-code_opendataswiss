...
- **Keywords.de** `['stzh', 'tramlinien', 'geodaten', 'geoportal', 'postauto', 'vektordaten', 'vbz', 'buslinien', 'tram', 'vbg', 'bus', 'punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-15T03:06:13.181667`
