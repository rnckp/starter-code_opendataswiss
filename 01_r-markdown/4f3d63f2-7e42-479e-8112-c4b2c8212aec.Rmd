...
- **Keywords.de** `['offentlicher-verkehr', 'tramlinien', 'bus', 'geoportal', 'stzh', 'vbz', 'vbg', 'verkauf', 'punktdaten', 'geodaten', 'postauto', 'buslinien', 'vektordaten', 'strassenbahn', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-07T03:41:23.265586`
