...
- **Keywords.de** `['geoportal', 'tram', 'geodaten', 'stzh', 'vektordaten', 'buslinien', 'strassenbahn', 'punktdaten', 'verkauf', 'offentlicher-verkehr', 'bus', 'vbz', 'postauto', 'tramlinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-25T02:48:45.751941`
