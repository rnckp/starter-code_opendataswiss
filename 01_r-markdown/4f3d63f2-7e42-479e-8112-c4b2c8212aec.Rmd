...
- **Keywords.de** `['vektordaten', 'verkauf', 'punktdaten', 'postauto', 'offentlicher-verkehr', 'vbg', 'vbz', 'tram', 'bus', 'geoportal', 'geodaten', 'strassenbahn', 'stzh', 'buslinien', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-05T04:17:15.555439`
