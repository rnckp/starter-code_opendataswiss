...
- **Keywords.de** `['strassenbahn', 'tram', 'punktdaten', 'vbg', 'geodaten', 'vbz', 'tramlinien', 'geoportal', 'bus', 'postauto', 'verkauf', 'vektordaten', 'offentlicher-verkehr', 'stzh', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-16T03:01:54.064731`
