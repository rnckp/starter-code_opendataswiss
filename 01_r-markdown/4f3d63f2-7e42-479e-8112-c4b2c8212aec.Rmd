...
- **Keywords.de** `['tram', 'buslinien', 'vbg', 'geoportal', 'tramlinien', 'punktdaten', 'bus', 'verkauf', 'stzh', 'geodaten', 'vbz', 'vektordaten', 'postauto', 'strassenbahn', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-07T04:22:05.574295`
