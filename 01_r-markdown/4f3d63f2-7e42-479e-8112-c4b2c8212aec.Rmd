...
- **Keywords.de** `['vbg', 'punktdaten', 'buslinien', 'vbz', 'geoportal', 'offentlicher-verkehr', 'bus', 'vektordaten', 'strassenbahn', 'verkauf', 'geodaten', 'tram', 'postauto', 'stzh', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-06T03:28:00.719365`
