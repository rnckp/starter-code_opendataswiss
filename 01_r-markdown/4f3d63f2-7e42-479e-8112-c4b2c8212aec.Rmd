...
- **Keywords.de** `['punktdaten', 'buslinien', 'vektordaten', 'bus', 'strassenbahn', 'vbz', 'offentlicher-verkehr', 'geoportal', 'tramlinien', 'tram', 'stzh', 'geodaten', 'verkauf', 'vbg', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-19T04:14:39.926889`
