...
- **Keywords.de** `['stzh', 'buslinien', 'strassenbahn', 'bus', 'offentlicher-verkehr', 'vbz', 'tram', 'verkauf', 'tramlinien', 'vbg', 'punktdaten', 'geodaten', 'vektordaten', 'postauto', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-01T03:32:35.202648`
