...
- **Keywords.de** `['verkauf', 'punktdaten', 'geodaten', 'strassenbahn', 'tram', 'stzh', 'tramlinien', 'bus', 'offentlicher-verkehr', 'vbg', 'vektordaten', 'buslinien', 'geoportal', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-18T03:32:21.590873`
