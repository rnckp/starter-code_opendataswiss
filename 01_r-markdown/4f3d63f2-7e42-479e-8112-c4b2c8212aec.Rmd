...
- **Keywords.de** `['vbz', 'stzh', 'offentlicher-verkehr', 'buslinien', 'strassenbahn', 'verkauf', 'geoportal', 'tramlinien', 'vektordaten', 'geodaten', 'postauto', 'bus', 'vbg', 'tram', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-13T03:28:00.111055`
