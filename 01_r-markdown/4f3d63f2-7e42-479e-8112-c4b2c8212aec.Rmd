...
- **Keywords.de** `['punktdaten', 'vbg', 'tram', 'vektordaten', 'tramlinien', 'vbz', 'strassenbahn', 'bus', 'postauto', 'offentlicher-verkehr', 'verkauf', 'stzh', 'buslinien', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-15T01:58:11.322791`
