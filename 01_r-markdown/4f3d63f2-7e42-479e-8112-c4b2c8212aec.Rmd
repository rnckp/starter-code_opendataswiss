...
- **Keywords.de** `['vbg', 'postauto', 'strassenbahn', 'geodaten', 'tramlinien', 'geoportal', 'tram', 'vektordaten', 'bus', 'verkauf', 'vbz', 'offentlicher-verkehr', 'stzh', 'buslinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-28T02:55:36.449271`
