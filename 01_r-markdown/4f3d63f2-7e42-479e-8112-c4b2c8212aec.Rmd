...
- **Keywords.de** `['bus', 'vektordaten', 'punktdaten', 'verkauf', 'tramlinien', 'geodaten', 'buslinien', 'postauto', 'stzh', 'geoportal', 'tram', 'vbg', 'offentlicher-verkehr', 'strassenbahn', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-17T02:58:44.297289`
