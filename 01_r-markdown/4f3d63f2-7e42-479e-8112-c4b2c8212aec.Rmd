...
- **Keywords.de** `['stzh', 'punktdaten', 'bus', 'geodaten', 'strassenbahn', 'geoportal', 'vbg', 'tram', 'verkauf', 'offentlicher-verkehr', 'buslinien', 'tramlinien', 'vbz', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-21T03:35:25.521043`
