...
- **Keywords.de** `['stzh', 'verkauf', 'strassenbahn', 'tramlinien', 'buslinien', 'geodaten', 'offentlicher-verkehr', 'geoportal', 'vbg', 'tram', 'vbz', 'postauto', 'bus', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-07T03:03:10.741892`
