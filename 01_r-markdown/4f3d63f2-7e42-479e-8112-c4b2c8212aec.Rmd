...
- **Keywords.de** `['tram', 'strassenbahn', 'geoportal', 'vbg', 'offentlicher-verkehr', 'postauto', 'punktdaten', 'bus', 'tramlinien', 'vektordaten', 'vbz', 'buslinien', 'geodaten', 'stzh', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-16T03:18:10.936703`
