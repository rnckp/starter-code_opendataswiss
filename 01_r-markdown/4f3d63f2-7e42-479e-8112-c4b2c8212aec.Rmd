...
- **Keywords.de** `['buslinien', 'postauto', 'punktdaten', 'stzh', 'tramlinien', 'geodaten', 'vbg', 'vektordaten', 'strassenbahn', 'tram', 'vbz', 'verkauf', 'geoportal', 'offentlicher-verkehr', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-05T04:20:22.327069`
