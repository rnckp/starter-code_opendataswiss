...
- **Keywords.de** `['tramlinien', 'punktdaten', 'stzh', 'verkauf', 'buslinien', 'geodaten', 'geoportal', 'bus', 'vbg', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'strassenbahn', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-13T03:33:17.670316`
