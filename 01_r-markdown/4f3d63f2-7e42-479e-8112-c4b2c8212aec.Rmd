...
- **Keywords.de** `['bus', 'vbg', 'stzh', 'strassenbahn', 'verkauf', 'buslinien', 'geodaten', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'geoportal', 'punktdaten', 'tram', 'tramlinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-17T03:25:46.514223`
