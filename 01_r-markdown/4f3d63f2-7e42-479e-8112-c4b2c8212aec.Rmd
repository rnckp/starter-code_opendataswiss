...
- **Keywords.de** `['tramlinien', 'vektordaten', 'vbg', 'stzh', 'tram', 'verkauf', 'strassenbahn', 'buslinien', 'geodaten', 'postauto', 'punktdaten', 'offentlicher-verkehr', 'bus', 'geoportal', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-29T03:30:46.018196`
