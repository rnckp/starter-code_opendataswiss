...
- **Keywords.de** `['vbz', 'verkauf', 'geoportal', 'vektordaten', 'geodaten', 'stzh', 'bus', 'buslinien', 'postauto', 'tram', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien', 'punktdaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-21T03:51:59.389564`
