...
- **Keywords.de** `['buslinien', 'offentlicher-verkehr', 'stzh', 'verkauf', 'vbg', 'geodaten', 'tramlinien', 'geoportal', 'vbz', 'postauto', 'bus', 'punktdaten', 'vektordaten', 'strassenbahn', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-10T04:09:40.063567`
