...
- **Keywords.de** `['verkauf', 'tramlinien', 'geodaten', 'tram', 'vbg', 'offentlicher-verkehr', 'punktdaten', 'bus', 'geoportal', 'vektordaten', 'buslinien', 'stzh', 'vbz', 'postauto', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-16T03:30:16.518239`
