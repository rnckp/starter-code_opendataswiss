...
- **Keywords.de** `['geodaten', 'vbz', 'verkauf', 'punktdaten', 'buslinien', 'geoportal', 'vektordaten', 'strassenbahn', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'vbg', 'postauto', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-24T01:57:15.015527`
