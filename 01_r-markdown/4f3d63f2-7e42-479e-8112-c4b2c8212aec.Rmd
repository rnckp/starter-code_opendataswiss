...
- **Keywords.de** `['punktdaten', 'bus', 'geodaten', 'verkauf', 'offentlicher-verkehr', 'tram', 'postauto', 'stzh', 'strassenbahn', 'tramlinien', 'vektordaten', 'vbg', 'geoportal', 'vbz', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-27T03:07:25.858673`
