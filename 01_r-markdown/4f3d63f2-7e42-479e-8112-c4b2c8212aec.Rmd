...
- **Keywords.de** `['strassenbahn', 'tram', 'buslinien', 'vektordaten', 'vbg', 'postauto', 'verkauf', 'bus', 'tramlinien', 'geoportal', 'offentlicher-verkehr', 'punktdaten', 'stzh', 'geodaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-10T03:08:50.214859`
