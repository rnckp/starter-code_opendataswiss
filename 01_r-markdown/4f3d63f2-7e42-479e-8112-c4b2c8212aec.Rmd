...
- **Keywords.de** `['tramlinien', 'verkauf', 'tram', 'postauto', 'strassenbahn', 'vektordaten', 'stzh', 'geoportal', 'vbg', 'buslinien', 'bus', 'punktdaten', 'geodaten', 'vbz', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-18T03:05:36.975334`
