...
- **Keywords.de** `['buslinien', 'verkauf', 'postauto', 'geodaten', 'vbz', 'vektordaten', 'punktdaten', 'stzh', 'geoportal', 'vbg', 'offentlicher-verkehr', 'tram', 'strassenbahn', 'bus', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-17T02:52:52.826828`
