...
- **Keywords.de** `['buslinien', 'vektordaten', 'vbz', 'geodaten', 'stzh', 'tramlinien', 'vbg', 'postauto', 'geoportal', 'verkauf', 'bus', 'strassenbahn', 'punktdaten', 'tram', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-28T03:28:21.770842`
