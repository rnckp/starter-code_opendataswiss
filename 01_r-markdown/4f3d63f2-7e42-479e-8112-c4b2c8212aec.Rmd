...
- **Keywords.de** `['bus', 'vektordaten', 'vbz', 'postauto', 'strassenbahn', 'vbg', 'tramlinien', 'tram', 'punktdaten', 'geodaten', 'stzh', 'buslinien', 'verkauf', 'geoportal', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-26T02:37:18.694693`
