...
- **Keywords.de** `['verkauf', 'tramlinien', 'bus', 'tram', 'stzh', 'geodaten', 'buslinien', 'vbg', 'strassenbahn', 'vektordaten', 'punktdaten', 'offentlicher-verkehr', 'geoportal', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-11T03:24:39.807317`
