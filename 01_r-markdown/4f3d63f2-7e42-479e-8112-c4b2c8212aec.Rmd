...
- **Keywords.de** `['vektordaten', 'offentlicher-verkehr', 'stzh', 'tram', 'bus', 'punktdaten', 'vbg', 'geoportal', 'postauto', 'verkauf', 'tramlinien', 'geodaten', 'strassenbahn', 'vbz', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-04T03:02:01.897613`
