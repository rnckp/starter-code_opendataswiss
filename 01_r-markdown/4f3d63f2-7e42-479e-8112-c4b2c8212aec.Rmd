...
- **Keywords.de** `['offentlicher-verkehr', 'vbz', 'tram', 'geodaten', 'postauto', 'vektordaten', 'punktdaten', 'vbg', 'verkauf', 'bus', 'tramlinien', 'buslinien', 'strassenbahn', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-04T04:34:10.576571`
