...
- **Keywords.de** `['tramlinien', 'geodaten', 'offentlicher-verkehr', 'punktdaten', 'geoportal', 'buslinien', 'vbg', 'vbz', 'bus', 'tram', 'strassenbahn', 'stzh', 'verkauf', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-07T03:45:22.077267`
