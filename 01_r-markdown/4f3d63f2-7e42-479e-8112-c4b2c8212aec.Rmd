...
- **Keywords.de** `['vektordaten', 'stzh', 'offentlicher-verkehr', 'postauto', 'strassenbahn', 'verkauf', 'tram', 'vbz', 'bus', 'buslinien', 'geodaten', 'punktdaten', 'tramlinien', 'geoportal', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-16T03:21:49.747309`
