...
- **Keywords.de** `['vbg', 'buslinien', 'postauto', 'offentlicher-verkehr', 'verkauf', 'bus', 'geoportal', 'vbz', 'stzh', 'punktdaten', 'tram', 'strassenbahn', 'geodaten', 'vektordaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-30T03:03:37.818322`
