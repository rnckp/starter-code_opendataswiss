...
- **Keywords.de** `['punktdaten', 'geoportal', 'stzh', 'geodaten', 'vbz', 'vektordaten', 'bus', 'tramlinien', 'buslinien', 'postauto', 'strassenbahn', 'tram', 'vbg', 'verkauf', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-24T03:22:55.475086`
