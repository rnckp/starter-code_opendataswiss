...
- **Keywords.de** `['tram', 'postauto', 'geoportal', 'verkauf', 'vektordaten', 'tramlinien', 'vbz', 'strassenbahn', 'offentlicher-verkehr', 'geodaten', 'buslinien', 'punktdaten', 'vbg', 'stzh', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-04T03:19:30.322395`
