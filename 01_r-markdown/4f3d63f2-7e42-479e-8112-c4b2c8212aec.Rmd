...
- **Keywords.de** `['postauto', 'bus', 'tramlinien', 'buslinien', 'offentlicher-verkehr', 'stzh', 'tram', 'geoportal', 'strassenbahn', 'verkauf', 'punktdaten', 'vbz', 'geodaten', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-18T04:05:54.260784`
