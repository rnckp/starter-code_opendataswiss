...
- **Keywords.de** `['vbg', 'offentlicher-verkehr', 'stzh', 'punktdaten', 'verkauf', 'vbz', 'geodaten', 'geoportal', 'bus', 'tramlinien', 'buslinien', 'vektordaten', 'tram', 'strassenbahn', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-02T03:30:52.869049`
