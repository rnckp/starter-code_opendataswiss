...
- **Keywords.de** `['verkauf', 'vektordaten', 'stzh', 'punktdaten', 'buslinien', 'vbg', 'tramlinien', 'offentlicher-verkehr', 'bus', 'geodaten', 'tram', 'vbz', 'strassenbahn', 'postauto', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-06T01:37:04.643907`
