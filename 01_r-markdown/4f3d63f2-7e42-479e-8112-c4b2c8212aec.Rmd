...
- **Keywords.de** `['strassenbahn', 'postauto', 'vbg', 'punktdaten', 'vbz', 'vektordaten', 'geoportal', 'bus', 'tramlinien', 'tram', 'verkauf', 'buslinien', 'stzh', 'geodaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-09T03:46:30.726787`
