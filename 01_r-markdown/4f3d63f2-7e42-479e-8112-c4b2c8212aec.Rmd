...
- **Keywords.de** `['stzh', 'tramlinien', 'vbg', 'postauto', 'buslinien', 'verkauf', 'bus', 'offentlicher-verkehr', 'punktdaten', 'tram', 'strassenbahn', 'geoportal', 'geodaten', 'vektordaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-25T03:23:28.897722`
