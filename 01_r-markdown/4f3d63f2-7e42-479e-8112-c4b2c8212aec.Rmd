...
- **Keywords.de** `['punktdaten', 'geodaten', 'postauto', 'vektordaten', 'verkauf', 'vbg', 'tram', 'stzh', 'geoportal', 'vbz', 'buslinien', 'strassenbahn', 'bus', 'tramlinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-26T02:53:24.547164`
