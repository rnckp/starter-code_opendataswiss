...
- **Keywords.de** `['vbz', 'geoportal', 'tram', 'vbg', 'offentlicher-verkehr', 'stzh', 'vektordaten', 'bus', 'postauto', 'buslinien', 'punktdaten', 'geodaten', 'strassenbahn', 'verkauf', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-22T03:07:48.065751`
