...
- **Keywords.de** `['punktdaten', 'geodaten', 'buslinien', 'stzh', 'verkauf', 'geoportal', 'tram', 'vbz', 'strassenbahn', 'postauto', 'offentlicher-verkehr', 'vbg', 'vektordaten', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-09T03:49:03.547186`
