...
- **Keywords.de** `['vbg', 'stzh', 'strassenbahn', 'vektordaten', 'punktdaten', 'bus', 'geoportal', 'tram', 'buslinien', 'tramlinien', 'postauto', 'vbz', 'offentlicher-verkehr', 'verkauf', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-06T03:13:29.423950`
