...
- **Keywords.de** `['stzh', 'vbg', 'strassenbahn', 'tramlinien', 'geodaten', 'postauto', 'buslinien', 'offentlicher-verkehr', 'bus', 'tram', 'vbz', 'vektordaten', 'punktdaten', 'geoportal', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-27T02:55:54.963293`
