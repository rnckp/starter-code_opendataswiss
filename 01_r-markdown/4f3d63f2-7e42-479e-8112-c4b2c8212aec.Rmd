...
- **Keywords.de** `['geodaten', 'punktdaten', 'vbg', 'stzh', 'geoportal', 'vektordaten', 'tramlinien', 'strassenbahn', 'postauto', 'buslinien', 'bus', 'verkauf', 'tram', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-01T02:53:00.033797`
