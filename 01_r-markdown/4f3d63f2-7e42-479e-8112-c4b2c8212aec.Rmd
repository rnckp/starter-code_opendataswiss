...
- **Keywords.de** `['postauto', 'tramlinien', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr', 'bus', 'geoportal', 'buslinien', 'geodaten', 'tram', 'vbg', 'punktdaten', 'stzh', 'vbz', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-24T03:36:01.903625`
