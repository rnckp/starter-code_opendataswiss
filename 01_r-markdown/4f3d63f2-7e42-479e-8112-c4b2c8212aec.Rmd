...
- **Keywords.de** `['vektordaten', 'vbg', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien', 'vbz', 'verkauf', 'bus', 'geoportal', 'buslinien', 'tram', 'punktdaten', 'postauto', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-04T03:36:15.520208`
