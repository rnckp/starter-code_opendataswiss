...
- **Keywords.de** `['vbz', 'vektordaten', 'stzh', 'geodaten', 'tramlinien', 'geoportal', 'vbg', 'strassenbahn', 'bus', 'postauto', 'offentlicher-verkehr', 'punktdaten', 'tram', 'buslinien', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-30T03:33:30.855587`
