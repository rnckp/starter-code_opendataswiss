...
- **Keywords.de** `['bus', 'postauto', 'geoportal', 'punktdaten', 'geodaten', 'tram', 'vbz', 'buslinien', 'offentlicher-verkehr', 'strassenbahn', 'verkauf', 'vektordaten', 'vbg', 'stzh', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-13T02:42:31.333101`
