...
- **Keywords.de** `['offentlicher-verkehr', 'strassenbahn', 'vbz', 'geodaten', 'tram', 'buslinien', 'vektordaten', 'punktdaten', 'bus', 'verkauf', 'stzh', 'geoportal', 'vbg', 'tramlinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-19T03:14:43.288563`
