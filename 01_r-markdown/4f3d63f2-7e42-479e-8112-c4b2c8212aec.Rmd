...
- **Keywords.de** `['postauto', 'verkauf', 'geoportal', 'stzh', 'punktdaten', 'vektordaten', 'bus', 'offentlicher-verkehr', 'buslinien', 'tramlinien', 'strassenbahn', 'vbg', 'vbz', 'geodaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-21T03:57:58.278741`
