...
- **Keywords.de** `['geoportal', 'bus', 'strassenbahn', 'vbz', 'tram', 'stzh', 'punktdaten', 'postauto', 'tramlinien', 'vektordaten', 'offentlicher-verkehr', 'geodaten', 'vbg', 'buslinien', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-19T03:18:07.326904`
