...
- **Keywords.de** `['geoportal', 'punktdaten', 'vektordaten', 'tram', 'buslinien', 'offentlicher-verkehr', 'geodaten', 'strassenbahn', 'bus', 'verkauf', 'tramlinien', 'postauto', 'stzh', 'vbz', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-22T03:04:31.740355`
