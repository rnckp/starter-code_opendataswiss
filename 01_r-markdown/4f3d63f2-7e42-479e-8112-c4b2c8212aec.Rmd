...
- **Keywords.de** `['offentlicher-verkehr', 'bus', 'verkauf', 'stzh', 'vektordaten', 'postauto', 'vbz', 'tram', 'buslinien', 'strassenbahn', 'geodaten', 'punktdaten', 'geoportal', 'vbg', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-17T03:50:19.450960`
