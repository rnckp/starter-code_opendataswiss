...
- **Keywords.de** `['punktdaten', 'geodaten', 'postauto', 'tram', 'stzh', 'vbz', 'offentlicher-verkehr', 'verkauf', 'tramlinien', 'vbg', 'bus', 'buslinien', 'geoportal', 'vektordaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-06T03:50:48.254537`
