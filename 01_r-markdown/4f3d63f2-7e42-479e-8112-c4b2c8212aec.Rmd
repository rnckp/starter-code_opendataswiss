...
- **Keywords.de** `['tramlinien', 'vbg', 'strassenbahn', 'postauto', 'geoportal', 'vektordaten', 'bus', 'verkauf', 'punktdaten', 'offentlicher-verkehr', 'geodaten', 'buslinien', 'stzh', 'vbz', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-18T02:58:46.339883`
