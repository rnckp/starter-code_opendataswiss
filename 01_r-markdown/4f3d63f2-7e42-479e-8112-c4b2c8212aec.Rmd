...
- **Keywords.de** `['vektordaten', 'postauto', 'geodaten', 'geoportal', 'tram', 'punktdaten', 'offentlicher-verkehr', 'stzh', 'buslinien', 'vbg', 'bus', 'tramlinien', 'vbz', 'verkauf', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-23T03:02:14.351005`
