...
- **Keywords.de** `['geodaten', 'postauto', 'tram', 'stzh', 'vbz', 'strassenbahn', 'vektordaten', 'vbg', 'buslinien', 'tramlinien', 'bus', 'geoportal', 'offentlicher-verkehr', 'verkauf', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-10T03:25:25.276178`
