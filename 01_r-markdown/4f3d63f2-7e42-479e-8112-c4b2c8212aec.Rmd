...
- **Keywords.de** `['tramlinien', 'bus', 'buslinien', 'geodaten', 'punktdaten', 'offentlicher-verkehr', 'verkauf', 'vektordaten', 'strassenbahn', 'vbg', 'stzh', 'vbz', 'geoportal', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-07T04:12:54.293416`
