...
- **Keywords.de** `['postauto', 'tram', 'geodaten', 'buslinien', 'verkauf', 'vektordaten', 'geoportal', 'bus', 'vbg', 'vbz', 'tramlinien', 'strassenbahn', 'offentlicher-verkehr', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-11T03:27:56.654499`
