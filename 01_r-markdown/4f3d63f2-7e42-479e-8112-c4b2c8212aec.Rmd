...
- **Keywords.de** `['geoportal', 'vbz', 'verkauf', 'offentlicher-verkehr', 'stzh', 'vbg', 'geodaten', 'vektordaten', 'strassenbahn', 'punktdaten', 'tramlinien', 'postauto', 'buslinien', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-12T02:46:49.611024`
