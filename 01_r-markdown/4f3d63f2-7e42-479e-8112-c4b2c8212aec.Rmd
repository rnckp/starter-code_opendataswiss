...
- **Keywords.de** `['geoportal', 'strassenbahn', 'geodaten', 'vbz', 'vektordaten', 'postauto', 'punktdaten', 'vbg', 'verkauf', 'offentlicher-verkehr', 'stzh', 'bus', 'tramlinien', 'tram', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-03T08:11:57.155657`
