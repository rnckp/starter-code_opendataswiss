...
- **Keywords.de** `['postauto', 'offentlicher-verkehr', 'bus', 'geodaten', 'vbz', 'verkauf', 'tram', 'buslinien', 'vektordaten', 'geoportal', 'strassenbahn', 'punktdaten', 'tramlinien', 'stzh', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-19T04:22:35.701092`
