...
- **Keywords.de** `['vbz', 'tramlinien', 'punktdaten', 'vbg', 'strassenbahn', 'tram', 'bus', 'geoportal', 'postauto', 'geodaten', 'verkauf', 'stzh', 'buslinien', 'vektordaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-17T02:46:32.634193`
