...
- **Keywords.de** `['strassenbahn', 'geoportal', 'vektordaten', 'tramlinien', 'postauto', 'offentlicher-verkehr', 'stzh', 'punktdaten', 'vbg', 'verkauf', 'vbz', 'buslinien', 'geodaten', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-29T03:06:40.000886`
