...
- **Keywords.de** `['tram', 'vbz', 'buslinien', 'punktdaten', 'bus', 'geodaten', 'geoportal', 'verkauf', 'offentlicher-verkehr', 'postauto', 'tramlinien', 'stzh', 'strassenbahn', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-19T02:57:12.157245`
