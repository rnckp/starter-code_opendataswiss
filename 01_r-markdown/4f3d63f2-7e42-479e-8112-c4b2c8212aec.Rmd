...
- **Keywords.de** `['vbg', 'bus', 'stzh', 'geoportal', 'offentlicher-verkehr', 'vektordaten', 'tramlinien', 'strassenbahn', 'verkauf', 'geodaten', 'buslinien', 'punktdaten', 'postauto', 'vbz', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-17T04:37:05.992100`
