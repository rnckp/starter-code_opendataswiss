...
- **Keywords.de** `['buslinien', 'geoportal', 'offentlicher-verkehr', 'postauto', 'tram', 'geodaten', 'vbz', 'vektordaten', 'vbg', 'verkauf', 'strassenbahn', 'punktdaten', 'stzh', 'bus', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-12T03:29:36.362813`
