...
- **Keywords.de** `['vektordaten', 'vbg', 'geodaten', 'geoportal', 'verkauf', 'strassenbahn', 'bus', 'tram', 'tramlinien', 'buslinien', 'punktdaten', 'offentlicher-verkehr', 'vbz', 'postauto', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-20T03:21:21.401099`
