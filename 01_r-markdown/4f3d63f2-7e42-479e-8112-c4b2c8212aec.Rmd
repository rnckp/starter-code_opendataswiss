...
- **Keywords.de** `['vbz', 'stzh', 'geodaten', 'vbg', 'offentlicher-verkehr', 'verkauf', 'strassenbahn', 'punktdaten', 'bus', 'tram', 'postauto', 'buslinien', 'tramlinien', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-02T03:20:26.040206`
