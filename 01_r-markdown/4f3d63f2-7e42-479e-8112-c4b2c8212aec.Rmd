...
- **Keywords.de** `['geoportal', 'strassenbahn', 'vbz', 'punktdaten', 'tram', 'tramlinien', 'offentlicher-verkehr', 'buslinien', 'postauto', 'vbg', 'geodaten', 'bus', 'vektordaten', 'verkauf', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-12T03:10:50.915182`
