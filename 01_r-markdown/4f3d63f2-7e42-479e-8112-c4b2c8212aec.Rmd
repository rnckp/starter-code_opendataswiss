...
- **Keywords.de** `['buslinien', 'tramlinien', 'geodaten', 'vbz', 'vbg', 'stzh', 'geoportal', 'vektordaten', 'tram', 'postauto', 'bus', 'offentlicher-verkehr', 'punktdaten', 'verkauf', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-26T03:18:44.048173`
