...
- **Keywords.de** `['verkauf', 'tram', 'tramlinien', 'buslinien', 'vbg', 'geodaten', 'vbz', 'punktdaten', 'stzh', 'vektordaten', 'postauto', 'geoportal', 'offentlicher-verkehr', 'bus', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-25T03:28:22.051514`
