...
- **Keywords.de** `['verkauf', 'tram', 'vbz', 'vbg', 'tramlinien', 'strassenbahn', 'bus', 'punktdaten', 'offentlicher-verkehr', 'geodaten', 'stzh', 'buslinien', 'postauto', 'vektordaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-13T04:10:33.572176`
