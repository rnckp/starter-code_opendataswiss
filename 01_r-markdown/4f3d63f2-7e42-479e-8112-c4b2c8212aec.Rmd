...
- **Keywords.de** `['stzh', 'buslinien', 'vbg', 'bus', 'postauto', 'geodaten', 'vektordaten', 'offentlicher-verkehr', 'tram', 'strassenbahn', 'vbz', 'verkauf', 'geoportal', 'punktdaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-19T03:14:16.856318`
