...
- **Keywords.de** `['bus', 'vbg', 'tramlinien', 'geodaten', 'strassenbahn', 'buslinien', 'geoportal', 'offentlicher-verkehr', 'vbz', 'postauto', 'vektordaten', 'tram', 'verkauf', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-02T02:48:53.180490`
