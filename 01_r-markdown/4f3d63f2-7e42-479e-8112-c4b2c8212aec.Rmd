...
- **Keywords.de** `['vektordaten', 'stzh', 'vbz', 'geodaten', 'postauto', 'tramlinien', 'strassenbahn', 'buslinien', 'geoportal', 'punktdaten', 'bus', 'vbg', 'verkauf', 'tram', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-13T04:02:29.809039`
