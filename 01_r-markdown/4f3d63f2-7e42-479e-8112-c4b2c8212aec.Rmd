...
- **Keywords.de** `['offentlicher-verkehr', 'geodaten', 'tramlinien', 'buslinien', 'vbz', 'tram', 'postauto', 'geoportal', 'punktdaten', 'vektordaten', 'vbg', 'verkauf', 'bus', 'strassenbahn', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-09T06:02:12.864556`
