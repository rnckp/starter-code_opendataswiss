...
- **Keywords.de** `['vbz', 'tram', 'geodaten', 'tramlinien', 'geoportal', 'offentlicher-verkehr', 'vektordaten', 'stzh', 'buslinien', 'vbg', 'punktdaten', 'verkauf', 'bus', 'postauto', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-08T03:41:02.775285`
