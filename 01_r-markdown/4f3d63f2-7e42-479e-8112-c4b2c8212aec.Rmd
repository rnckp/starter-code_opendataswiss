...
- **Keywords.de** `['strassenbahn', 'tramlinien', 'vbz', 'punktdaten', 'tram', 'vektordaten', 'offentlicher-verkehr', 'vbg', 'bus', 'geoportal', 'buslinien', 'stzh', 'verkauf', 'postauto', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-12T02:57:17.556667`
