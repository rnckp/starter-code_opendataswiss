...
- **Keywords.de** `['stzh', 'punktdaten', 'vektordaten', 'offentlicher-verkehr', 'geodaten', 'tram', 'verkauf', 'vbz', 'tramlinien', 'buslinien', 'vbg', 'geoportal', 'strassenbahn', 'postauto', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-14T03:01:22.492033`
