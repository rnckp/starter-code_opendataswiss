...
- **Keywords.de** `['stzh', 'tramlinien', 'bus', 'geodaten', 'verkauf', 'buslinien', 'geoportal', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'tram', 'vbz', 'vektordaten', 'postauto', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-30T03:11:22.155812`
