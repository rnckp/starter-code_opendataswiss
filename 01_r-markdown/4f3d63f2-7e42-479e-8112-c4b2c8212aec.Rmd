...
- **Keywords.de** `['punktdaten', 'tram', 'strassenbahn', 'geoportal', 'postauto', 'vektordaten', 'offentlicher-verkehr', 'tramlinien', 'geodaten', 'buslinien', 'bus', 'verkauf', 'vbz', 'stzh', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-06T04:06:07.058782`
