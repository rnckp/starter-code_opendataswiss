...
- **Keywords.de** `['vektordaten', 'buslinien', 'geoportal', 'strassenbahn', 'geodaten', 'tramlinien', 'vbg', 'offentlicher-verkehr', 'postauto', 'bus', 'stzh', 'verkauf', 'tram', 'punktdaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-05T02:45:35.644975`
