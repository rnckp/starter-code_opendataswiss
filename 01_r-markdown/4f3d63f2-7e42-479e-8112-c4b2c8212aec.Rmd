...
- **Keywords.de** `['verkauf', 'vbz', 'vektordaten', 'offentlicher-verkehr', 'bus', 'stzh', 'vbg', 'tramlinien', 'strassenbahn', 'postauto', 'geoportal', 'tram', 'punktdaten', 'geodaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-27T03:21:27.765729`
