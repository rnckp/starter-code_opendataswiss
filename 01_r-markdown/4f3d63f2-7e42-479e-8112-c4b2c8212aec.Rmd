...
- **Keywords.de** `['vbz', 'vektordaten', 'postauto', 'tram', 'punktdaten', 'geoportal', 'strassenbahn', 'verkauf', 'buslinien', 'geodaten', 'bus', 'stzh', 'offentlicher-verkehr', 'tramlinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-31T03:31:07.288102`
