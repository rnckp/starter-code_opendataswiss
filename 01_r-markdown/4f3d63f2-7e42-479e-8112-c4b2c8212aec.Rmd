...
- **Keywords.de** `['vbg', 'geoportal', 'verkauf', 'tram', 'vbz', 'geodaten', 'buslinien', 'bus', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'punktdaten', 'strassenbahn', 'postauto', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-06T03:24:22.199014`
