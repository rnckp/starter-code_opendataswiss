...
- **Keywords.de** `['verkauf', 'stzh', 'bus', 'vektordaten', 'vbg', 'vbz', 'offentlicher-verkehr', 'postauto', 'geodaten', 'punktdaten', 'tramlinien', 'tram', 'geoportal', 'buslinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-27T02:56:21.990709`
