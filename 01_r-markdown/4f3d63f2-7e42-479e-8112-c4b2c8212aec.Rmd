...
- **Keywords.de** `['vbz', 'tram', 'postauto', 'strassenbahn', 'verkauf', 'vektordaten', 'vbg', 'geoportal', 'punktdaten', 'buslinien', 'stzh', 'geodaten', 'tramlinien', 'offentlicher-verkehr', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-24T03:56:10.957597`
