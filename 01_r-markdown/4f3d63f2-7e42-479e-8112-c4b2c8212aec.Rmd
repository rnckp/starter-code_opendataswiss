...
- **Keywords.de** `['buslinien', 'stzh', 'strassenbahn', 'offentlicher-verkehr', 'punktdaten', 'bus', 'geoportal', 'tramlinien', 'vbg', 'postauto', 'geodaten', 'verkauf', 'vbz', 'tram', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-14T03:27:29.660691`
