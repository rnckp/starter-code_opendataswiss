...
- **Keywords.de** `['strassenbahn', 'vbg', 'tramlinien', 'verkauf', 'stzh', 'vektordaten', 'punktdaten', 'tram', 'vbz', 'geoportal', 'geodaten', 'postauto', 'buslinien', 'bus', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-09T03:12:55.633193`
