...
- **Keywords.de** `['vbz', 'offentlicher-verkehr', 'vektordaten', 'postauto', 'bus', 'punktdaten', 'tramlinien', 'strassenbahn', 'stzh', 'geodaten', 'vbg', 'verkauf', 'buslinien', 'geoportal', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-21T03:16:56.460281`
