...
- **Keywords.de** `['postauto', 'buslinien', 'vbg', 'strassenbahn', 'geodaten', 'geoportal', 'offentlicher-verkehr', 'tram', 'verkauf', 'vbz', 'vektordaten', 'bus', 'stzh', 'tramlinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-02T03:15:09.494028`
