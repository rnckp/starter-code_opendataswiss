...
- **Keywords.de** `['punktdaten', 'verkauf', 'vektordaten', 'bus', 'geoportal', 'buslinien', 'tramlinien', 'postauto', 'strassenbahn', 'geodaten', 'offentlicher-verkehr', 'tram', 'vbg', 'vbz', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-21T03:41:54.156922`
