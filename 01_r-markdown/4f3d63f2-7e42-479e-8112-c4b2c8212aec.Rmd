...
- **Keywords.de** `['punktdaten', 'vektordaten', 'tram', 'strassenbahn', 'bus', 'tramlinien', 'verkauf', 'buslinien', 'offentlicher-verkehr', 'vbg', 'geoportal', 'stzh', 'geodaten', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-25T03:15:03.370250`
