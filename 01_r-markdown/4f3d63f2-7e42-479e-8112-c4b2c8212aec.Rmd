...
- **Keywords.de** `['vbg', 'strassenbahn', 'buslinien', 'tram', 'vbz', 'geodaten', 'tramlinien', 'punktdaten', 'verkauf', 'bus', 'offentlicher-verkehr', 'postauto', 'stzh', 'vektordaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-16T03:41:35.899756`
