...
- **Keywords.de** `['stzh', 'vbg', 'geodaten', 'verkauf', 'geoportal', 'bus', 'strassenbahn', 'tramlinien', 'punktdaten', 'buslinien', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-21T03:32:23.137989`
