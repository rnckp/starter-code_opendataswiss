...
- **Keywords.de** `['stzh', 'vbg', 'geodaten', 'postauto', 'tramlinien', 'verkauf', 'buslinien', 'offentlicher-verkehr', 'strassenbahn', 'geoportal', 'tram', 'vbz', 'bus', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-17T03:19:25.471745`
