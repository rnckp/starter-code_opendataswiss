...
- **Keywords.de** `['bus', 'geoportal', 'stzh', 'vektordaten', 'strassenbahn', 'punktdaten', 'offentlicher-verkehr', 'tram', 'vbg', 'tramlinien', 'verkauf', 'vbz', 'buslinien', 'geodaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-12T03:11:06.051845`
