...
- **Keywords.de** `['postauto', 'verkauf', 'stzh', 'geodaten', 'vektordaten', 'geoportal', 'vbz', 'tramlinien', 'punktdaten', 'bus', 'strassenbahn', 'vbg', 'offentlicher-verkehr', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-18T03:43:10.161421`
