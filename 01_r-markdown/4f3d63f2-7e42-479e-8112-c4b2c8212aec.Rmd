...
- **Keywords.de** `['strassenbahn', 'stzh', 'postauto', 'offentlicher-verkehr', 'buslinien', 'punktdaten', 'geodaten', 'verkauf', 'geoportal', 'tram', 'vektordaten', 'vbz', 'vbg', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-29T02:49:17.161266`
