...
- **Keywords.de** `['bus', 'tram', 'strassenbahn', 'vbg', 'geoportal', 'postauto', 'stzh', 'verkauf', 'tramlinien', 'vbz', 'vektordaten', 'punktdaten', 'geodaten', 'buslinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-01T03:40:22.479126`
