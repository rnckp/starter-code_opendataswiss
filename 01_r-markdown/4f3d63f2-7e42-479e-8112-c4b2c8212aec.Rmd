...
- **Keywords.de** `['verkauf', 'geodaten', 'geoportal', 'postauto', 'punktdaten', 'tramlinien', 'vbg', 'strassenbahn', 'stzh', 'tram', 'offentlicher-verkehr', 'bus', 'vektordaten', 'buslinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-10T03:10:06.277875`
