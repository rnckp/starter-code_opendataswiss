...
- **Keywords.de** `['vbg', 'vbz', 'geoportal', 'punktdaten', 'verkauf', 'strassenbahn', 'tram', 'tramlinien', 'offentlicher-verkehr', 'vektordaten', 'geodaten', 'stzh', 'bus', 'buslinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-05T03:25:10.924746`
