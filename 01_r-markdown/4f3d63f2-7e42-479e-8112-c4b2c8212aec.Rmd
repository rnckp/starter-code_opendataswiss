...
- **Keywords.de** `['geodaten', 'offentlicher-verkehr', 'vbz', 'punktdaten', 'stzh', 'vbg', 'geoportal', 'tramlinien', 'tram', 'postauto', 'verkauf', 'vektordaten', 'strassenbahn', 'bus', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-30T03:45:31.258957`
