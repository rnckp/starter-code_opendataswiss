...
- **Keywords.de** `['postauto', 'tramlinien', 'vbg', 'punktdaten', 'geoportal', 'buslinien', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'strassenbahn', 'tram', 'stzh', 'verkauf', 'bus', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-08T03:12:28.983213`
