...
- **Keywords.de** `['geoportal', 'vbg', 'offentlicher-verkehr', 'stzh', 'verkauf', 'bus', 'postauto', 'strassenbahn', 'buslinien', 'geodaten', 'vbz', 'punktdaten', 'tramlinien', 'tram', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-04T03:20:42.117250`
