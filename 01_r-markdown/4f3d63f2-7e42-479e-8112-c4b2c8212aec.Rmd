...
- **Keywords.de** `['tramlinien', 'verkauf', 'vbz', 'strassenbahn', 'geodaten', 'postauto', 'vbg', 'stzh', 'buslinien', 'geoportal', 'bus', 'vektordaten', 'offentlicher-verkehr', 'tram', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-21T03:15:59.797684`
