...
- **Keywords.de** `['strassenbahn', 'vbz', 'buslinien', 'tramlinien', 'vektordaten', 'tram', 'stzh', 'geodaten', 'punktdaten', 'verkauf', 'bus', 'vbg', 'postauto', 'geoportal', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-07T03:10:17.696785`
