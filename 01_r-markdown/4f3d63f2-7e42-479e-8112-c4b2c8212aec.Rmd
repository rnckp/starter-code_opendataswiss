...
- **Keywords.de** `['stzh', 'vbg', 'vektordaten', 'offentlicher-verkehr', 'tramlinien', 'buslinien', 'punktdaten', 'tram', 'vbz', 'verkauf', 'geoportal', 'postauto', 'bus', 'strassenbahn', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-11T03:15:08.861824`
