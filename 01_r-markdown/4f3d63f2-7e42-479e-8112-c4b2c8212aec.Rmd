...
- **Keywords.de** `['stzh', 'bus', 'postauto', 'tramlinien', 'verkauf', 'strassenbahn', 'vektordaten', 'geodaten', 'geoportal', 'tram', 'vbz', 'punktdaten', 'vbg', 'buslinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-04T02:56:33.053510`
