...
- **Keywords.de** `['vbz', 'vbg', 'strassenbahn', 'vektordaten', 'punktdaten', 'offentlicher-verkehr', 'geodaten', 'buslinien', 'verkauf', 'geoportal', 'bus', 'postauto', 'tramlinien', 'stzh', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-31T03:10:58.345403`
