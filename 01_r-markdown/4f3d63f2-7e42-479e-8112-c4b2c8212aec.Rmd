...
- **Keywords.de** `['geoportal', 'offentlicher-verkehr', 'bus', 'punktdaten', 'verkauf', 'vektordaten', 'postauto', 'strassenbahn', 'buslinien', 'tram', 'geodaten', 'stzh', 'vbg', 'vbz', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-03T03:13:29.812564`
