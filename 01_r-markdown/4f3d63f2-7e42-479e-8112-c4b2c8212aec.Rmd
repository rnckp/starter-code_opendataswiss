...
- **Keywords.de** `['strassenbahn', 'punktdaten', 'geodaten', 'verkauf', 'tram', 'vektordaten', 'buslinien', 'stzh', 'tramlinien', 'geoportal', 'bus', 'vbz', 'postauto', 'offentlicher-verkehr', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-01T03:20:51.508830`
