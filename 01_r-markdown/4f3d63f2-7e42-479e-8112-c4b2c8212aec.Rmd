...
- **Keywords.de** `['strassenbahn', 'punktdaten', 'tramlinien', 'postauto', 'geoportal', 'vektordaten', 'geodaten', 'verkauf', 'bus', 'buslinien', 'tram', 'stzh', 'vbg', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-14T05:16:53.398924`
