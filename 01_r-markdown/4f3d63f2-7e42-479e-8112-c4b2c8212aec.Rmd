...
- **Keywords.de** `['punktdaten', 'postauto', 'buslinien', 'stzh', 'tram', 'tramlinien', 'vektordaten', 'verkauf', 'strassenbahn', 'vbg', 'geodaten', 'geoportal', 'vbz', 'offentlicher-verkehr', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-12T05:22:42.243205`
