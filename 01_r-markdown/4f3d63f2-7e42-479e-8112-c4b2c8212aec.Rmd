...
- **Keywords.de** `['vbz', 'strassenbahn', 'postauto', 'bus', 'punktdaten', 'verkauf', 'buslinien', 'vbg', 'offentlicher-verkehr', 'geoportal', 'tramlinien', 'vektordaten', 'stzh', 'tram', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-22T02:56:34.133956`
