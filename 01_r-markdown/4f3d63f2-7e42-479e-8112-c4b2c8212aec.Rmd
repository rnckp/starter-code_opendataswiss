...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'postauto', 'offentlicher-verkehr', 'stzh', 'geoportal', 'bus', 'verkauf', 'vbz', 'buslinien', 'tram', 'vbg', 'geodaten', 'tramlinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-21T02:38:19.629256`
