...
- **Keywords.de** `['offentlicher-verkehr', 'vbg', 'tramlinien', 'vektordaten', 'punktdaten', 'buslinien', 'postauto', 'tram', 'strassenbahn', 'verkauf', 'bus', 'stzh', 'vbz', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-29T03:19:45.566140`
