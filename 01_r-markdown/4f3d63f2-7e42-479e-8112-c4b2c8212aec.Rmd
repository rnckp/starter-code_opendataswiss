...
- **Keywords.de** `['tram', 'bus', 'postauto', 'offentlicher-verkehr', 'strassenbahn', 'verkauf', 'stzh', 'vektordaten', 'buslinien', 'geoportal', 'vbz', 'geodaten', 'tramlinien', 'vbg', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-12T03:31:17.270477`
