...
- **Keywords.de** `['punktdaten', 'strassenbahn', 'stzh', 'verkauf', 'vektordaten', 'vbg', 'geodaten', 'postauto', 'offentlicher-verkehr', 'buslinien', 'tram', 'vbz', 'tramlinien', 'bus', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-24T02:15:49.601518`
