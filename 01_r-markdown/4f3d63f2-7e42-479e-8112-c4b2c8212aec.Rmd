...
- **Keywords.de** `['strassenbahn', 'tram', 'vbg', 'vbz', 'stzh', 'geodaten', 'offentlicher-verkehr', 'tramlinien', 'postauto', 'verkauf', 'vektordaten', 'buslinien', 'bus', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-14T03:43:53.662769`
