...
- **Keywords.de** `['tramlinien', 'geoportal', 'vbg', 'vbz', 'stzh', 'vektordaten', 'geodaten', 'bus', 'buslinien', 'postauto', 'strassenbahn', 'verkauf', 'tram', 'punktdaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-26T03:01:12.797630`
