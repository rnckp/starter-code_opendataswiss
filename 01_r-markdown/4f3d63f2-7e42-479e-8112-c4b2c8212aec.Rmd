...
- **Keywords.de** `['geoportal', 'strassenbahn', 'tramlinien', 'punktdaten', 'vbz', 'vektordaten', 'bus', 'postauto', 'geodaten', 'offentlicher-verkehr', 'tram', 'vbg', 'verkauf', 'buslinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-22T03:38:04.707882`
