...
- **Keywords.de** `['stzh', 'tram', 'offentlicher-verkehr', 'vektordaten', 'verkauf', 'geoportal', 'buslinien', 'bus', 'tramlinien', 'punktdaten', 'vbg', 'vbz', 'strassenbahn', 'postauto', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-14T03:48:47.670752`
