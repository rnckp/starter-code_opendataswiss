...
- **Keywords.de** `['buslinien', 'stzh', 'geodaten', 'tramlinien', 'vektordaten', 'geoportal', 'postauto', 'vbz', 'offentlicher-verkehr', 'tram', 'verkauf', 'vbg', 'strassenbahn', 'bus', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-16T03:19:08.505003`
