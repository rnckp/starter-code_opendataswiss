...
- **Keywords.de** `['verkauf', 'punktdaten', 'geodaten', 'tram', 'postauto', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr', 'tramlinien', 'geoportal', 'bus', 'vbz', 'stzh', 'vbg', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-03T03:21:18.598350`
