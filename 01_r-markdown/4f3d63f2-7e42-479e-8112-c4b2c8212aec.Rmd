...
- **Keywords.de** `['vbg', 'geodaten', 'postauto', 'verkauf', 'tramlinien', 'buslinien', 'vbz', 'bus', 'strassenbahn', 'geoportal', 'punktdaten', 'offentlicher-verkehr', 'tram', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-17T02:44:29.945663`
