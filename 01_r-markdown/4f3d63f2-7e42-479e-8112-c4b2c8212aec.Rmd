...
- **Keywords.de** `['verkauf', 'stzh', 'punktdaten', 'vektordaten', 'vbz', 'offentlicher-verkehr', 'vbg', 'geoportal', 'buslinien', 'postauto', 'tram', 'strassenbahn', 'tramlinien', 'geodaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-18T03:25:06.985856`
