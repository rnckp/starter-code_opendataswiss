...
- **Keywords.de** `['verkauf', 'strassenbahn', 'geoportal', 'stzh', 'offentlicher-verkehr', 'punktdaten', 'postauto', 'tram', 'vektordaten', 'bus', 'tramlinien', 'vbg', 'vbz', 'buslinien', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-15T03:44:25.382911`
