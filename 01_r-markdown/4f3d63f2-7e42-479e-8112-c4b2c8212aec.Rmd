...
- **Keywords.de** `['vbg', 'buslinien', 'postauto', 'bus', 'punktdaten', 'tram', 'strassenbahn', 'stzh', 'vektordaten', 'tramlinien', 'verkauf', 'geodaten', 'offentlicher-verkehr', 'geoportal', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-18T03:19:09.579711`
