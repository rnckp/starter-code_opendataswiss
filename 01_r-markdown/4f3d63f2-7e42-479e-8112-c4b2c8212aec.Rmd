...
- **Keywords.de** `['buslinien', 'vbg', 'vektordaten', 'punktdaten', 'bus', 'postauto', 'strassenbahn', 'stzh', 'tramlinien', 'geodaten', 'offentlicher-verkehr', 'vbz', 'verkauf', 'tram', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-20T03:20:15.948447`
