...
- **Keywords.de** `['bus', 'buslinien', 'geodaten', 'vbg', 'strassenbahn', 'vektordaten', 'postauto', 'offentlicher-verkehr', 'tramlinien', 'vbz', 'verkauf', 'stzh', 'punktdaten', 'tram', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-19T04:04:10.231529`
