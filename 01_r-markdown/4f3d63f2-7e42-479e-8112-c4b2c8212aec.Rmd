...
- **Keywords.de** `['verkauf', 'punktdaten', 'stzh', 'vbg', 'vektordaten', 'offentlicher-verkehr', 'tram', 'vbz', 'buslinien', 'bus', 'strassenbahn', 'postauto', 'tramlinien', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-27T03:29:04.996930`
