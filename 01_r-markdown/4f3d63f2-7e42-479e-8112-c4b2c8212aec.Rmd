...
- **Keywords.de** `['geoportal', 'verkauf', 'offentlicher-verkehr', 'buslinien', 'tram', 'punktdaten', 'tramlinien', 'geodaten', 'postauto', 'vbz', 'stzh', 'vektordaten', 'vbg', 'strassenbahn', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-15T03:22:46.161817`
