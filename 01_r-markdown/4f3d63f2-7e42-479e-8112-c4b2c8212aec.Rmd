...
- **Keywords.de** `['vbz', 'punktdaten', 'bus', 'geodaten', 'vektordaten', 'vbg', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'postauto', 'buslinien', 'tram', 'strassenbahn', 'geoportal', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-14T02:59:47.826194`
