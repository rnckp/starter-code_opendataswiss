...
- **Keywords.de** `['tramlinien', 'punktdaten', 'verkauf', 'strassenbahn', 'geoportal', 'buslinien', 'geodaten', 'vbg', 'bus', 'stzh', 'vbz', 'postauto', 'tram', 'offentlicher-verkehr', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-02T03:25:43.762661`
