...
- **Keywords.de** `['tramlinien', 'verkauf', 'punktdaten', 'stzh', 'bus', 'tram', 'vektordaten', 'offentlicher-verkehr', 'strassenbahn', 'vbz', 'geoportal', 'vbg', 'geodaten', 'postauto', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-31T03:29:51.818155`
