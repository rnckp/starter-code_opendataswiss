...
- **Keywords.de** `['stzh', 'geodaten', 'offentlicher-verkehr', 'vbz', 'strassenbahn', 'tram', 'buslinien', 'postauto', 'tramlinien', 'geoportal', 'punktdaten', 'vbg', 'verkauf', 'bus', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-21T02:10:35.081946`
