...
- **Keywords.de** `['geoportal', 'postauto', 'geodaten', 'bus', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'buslinien', 'vbz', 'punktdaten', 'stzh', 'tramlinien', 'vektordaten', 'tram', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-11T03:33:08.506153`
