...
- **Keywords.de** `['postauto', 'stzh', 'geoportal', 'bus', 'tram', 'vbz', 'strassenbahn', 'punktdaten', 'tramlinien', 'geodaten', 'verkauf', 'vbg', 'offentlicher-verkehr', 'vektordaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-22T02:05:06.188971`
