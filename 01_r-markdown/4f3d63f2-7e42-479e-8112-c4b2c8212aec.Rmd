...
- **Keywords.de** `['stzh', 'offentlicher-verkehr', 'bus', 'tram', 'postauto', 'vbg', 'vbz', 'vektordaten', 'buslinien', 'strassenbahn', 'tramlinien', 'verkauf', 'geodaten', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-16T02:54:22.685200`
