...
- **Keywords.de** `['vektordaten', 'stzh', 'strassenbahn', 'postauto', 'punktdaten', 'offentlicher-verkehr', 'verkauf', 'geodaten', 'tramlinien', 'geoportal', 'buslinien', 'tram', 'vbz', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-12T03:22:32.876736`
