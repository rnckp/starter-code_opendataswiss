...
- **Keywords.de** `['geoportal', 'geodaten', 'vbg', 'punktdaten', 'bus', 'vektordaten', 'buslinien', 'tramlinien', 'verkauf', 'postauto', 'tram', 'strassenbahn', 'vbz', 'stzh', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-28T03:06:05.590880`
