...
- **Keywords.de** `['punktdaten', 'vektordaten', 'tram', 'geodaten', 'bus', 'verkauf', 'vbz', 'geoportal', 'buslinien', 'tramlinien', 'strassenbahn', 'stzh', 'vbg', 'postauto', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-31T03:30:43.509283`
