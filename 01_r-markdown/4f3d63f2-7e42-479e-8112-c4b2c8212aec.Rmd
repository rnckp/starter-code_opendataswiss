...
- **Keywords.de** `['buslinien', 'vbg', 'vektordaten', 'strassenbahn', 'tram', 'postauto', 'tramlinien', 'stzh', 'vbz', 'bus', 'verkauf', 'geoportal', 'offentlicher-verkehr', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-03T03:06:38.024940`
