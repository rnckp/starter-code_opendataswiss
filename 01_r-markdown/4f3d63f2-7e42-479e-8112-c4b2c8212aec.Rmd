...
- **Keywords.de** `['buslinien', 'tram', 'postauto', 'punktdaten', 'vbg', 'geodaten', 'bus', 'vbz', 'verkauf', 'strassenbahn', 'stzh', 'tramlinien', 'vektordaten', 'geoportal', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-01T03:55:52.860431`
