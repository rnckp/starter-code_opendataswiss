...
- **Keywords.de** `['verkauf', 'bus', 'tramlinien', 'postauto', 'geodaten', 'geoportal', 'stzh', 'strassenbahn', 'offentlicher-verkehr', 'vektordaten', 'buslinien', 'vbz', 'tram', 'punktdaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-16T03:27:03.236117`
