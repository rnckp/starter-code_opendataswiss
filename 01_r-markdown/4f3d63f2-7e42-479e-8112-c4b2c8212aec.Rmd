...
- **Keywords.de** `['vbz', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr', 'verkauf', 'geodaten', 'postauto', 'vbg', 'geoportal', 'tram', 'punktdaten', 'buslinien', 'bus', 'tramlinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-28T03:22:16.092729`
