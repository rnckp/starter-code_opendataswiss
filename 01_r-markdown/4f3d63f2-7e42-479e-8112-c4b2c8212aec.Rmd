...
- **Keywords.de** `['strassenbahn', 'vbz', 'bus', 'verkauf', 'tramlinien', 'buslinien', 'offentlicher-verkehr', 'tram', 'geoportal', 'punktdaten', 'vbg', 'stzh', 'geodaten', 'postauto', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-16T03:35:39.674347`
