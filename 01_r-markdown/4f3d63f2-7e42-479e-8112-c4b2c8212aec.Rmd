...
- **Keywords.de** `['tramlinien', 'tram', 'vbz', 'strassenbahn', 'verkauf', 'geodaten', 'bus', 'vektordaten', 'vbg', 'stzh', 'postauto', 'geoportal', 'punktdaten', 'buslinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-30T03:42:15.038161`
