...
- **Keywords.de** `['punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'vbz', 'bus', 'vbg', 'tramlinien', 'tram', 'postauto', 'stzh', 'verkauf', 'geodaten', 'geoportal', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-03T03:40:02.109173`
