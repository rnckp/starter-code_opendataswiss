...
- **Keywords.de** `['postauto', 'vbz', 'vbg', 'geodaten', 'stzh', 'verkauf', 'tram', 'tramlinien', 'offentlicher-verkehr', 'strassenbahn', 'geoportal', 'punktdaten', 'vektordaten', 'buslinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-24T03:12:07.464188`
