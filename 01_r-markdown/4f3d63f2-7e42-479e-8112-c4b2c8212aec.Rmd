...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'tramlinien', 'buslinien', 'vbg', 'bus', 'vbz', 'geoportal', 'geodaten', 'stzh', 'offentlicher-verkehr', 'verkauf', 'tram', 'postauto', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-27T03:26:55.684061`
