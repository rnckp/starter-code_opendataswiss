...
- **Keywords.de** `['vektordaten', 'geoportal', 'verkauf', 'tram', 'geodaten', 'offentlicher-verkehr', 'tramlinien', 'vbg', 'punktdaten', 'bus', 'stzh', 'strassenbahn', 'postauto', 'buslinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-30T03:00:16.235381`
