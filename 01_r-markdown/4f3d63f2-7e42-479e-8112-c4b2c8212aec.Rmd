...
- **Keywords.de** `['postauto', 'vektordaten', 'geoportal', 'tram', 'verkauf', 'offentlicher-verkehr', 'vbz', 'stzh', 'geodaten', 'strassenbahn', 'tramlinien', 'punktdaten', 'vbg', 'buslinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-08T03:50:44.570863`
