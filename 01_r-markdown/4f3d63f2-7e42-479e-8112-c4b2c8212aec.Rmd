...
- **Keywords.de** `['punktdaten', 'vektordaten', 'geodaten', 'tramlinien', 'vbg', 'buslinien', 'postauto', 'stzh', 'strassenbahn', 'tram', 'bus', 'offentlicher-verkehr', 'verkauf', 'geoportal', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-05T05:04:36.059051`
