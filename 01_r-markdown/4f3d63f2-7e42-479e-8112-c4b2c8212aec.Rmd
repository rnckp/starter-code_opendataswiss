...
- **Keywords.de** `['punktdaten', 'strassenbahn', 'vektordaten', 'offentlicher-verkehr', 'buslinien', 'postauto', 'geoportal', 'geodaten', 'verkauf', 'stzh', 'tram', 'vbz', 'vbg', 'bus', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-25T03:09:57.358335`
