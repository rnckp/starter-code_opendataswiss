...
- **Keywords.de** `['vbg', 'punktdaten', 'verkauf', 'tramlinien', 'vbz', 'vektordaten', 'buslinien', 'strassenbahn', 'tram', 'offentlicher-verkehr', 'geoportal', 'bus', 'stzh', 'geodaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-19T02:50:47.389734`
