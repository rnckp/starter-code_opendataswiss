...
- **Keywords.de** `['strassenbahn', 'stzh', 'postauto', 'punktdaten', 'tramlinien', 'vbz', 'geodaten', 'verkauf', 'vbg', 'geoportal', 'vektordaten', 'bus', 'offentlicher-verkehr', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-25T03:07:42.013890`
