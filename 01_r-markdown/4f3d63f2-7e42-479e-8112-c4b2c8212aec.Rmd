...
- **Keywords.de** `['tram', 'postauto', 'geodaten', 'bus', 'verkauf', 'offentlicher-verkehr', 'stzh', 'buslinien', 'vektordaten', 'geoportal', 'punktdaten', 'vbg', 'vbz', 'strassenbahn', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-12T03:41:04.249828`
