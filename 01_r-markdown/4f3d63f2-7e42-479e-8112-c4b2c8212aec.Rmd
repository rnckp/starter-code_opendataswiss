...
- **Keywords.de** `['postauto', 'bus', 'geodaten', 'vektordaten', 'geoportal', 'vbg', 'tramlinien', 'stzh', 'tram', 'punktdaten', 'vbz', 'offentlicher-verkehr', 'verkauf', 'strassenbahn', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-27T03:26:10.102746`
