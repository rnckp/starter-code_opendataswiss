...
- **Keywords.de** `['punktdaten', 'geodaten', 'bus', 'vbz', 'vbg', 'offentlicher-verkehr', 'geoportal', 'vektordaten', 'tramlinien', 'tram', 'stzh', 'strassenbahn', 'buslinien', 'verkauf', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-14T03:38:11.314705`
