...
- **Keywords.de** `['vbg', 'postauto', 'vbz', 'offentlicher-verkehr', 'geoportal', 'tram', 'stzh', 'tramlinien', 'geodaten', 'strassenbahn', 'bus', 'punktdaten', 'buslinien', 'verkauf', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-04T03:09:28.321744`
