...
- **Keywords.de** `['vbg', 'geoportal', 'vektordaten', 'tram', 'strassenbahn', 'postauto', 'bus', 'buslinien', 'offentlicher-verkehr', 'stzh', 'geodaten', 'punktdaten', 'tramlinien', 'verkauf', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-06T03:37:58.306356`
