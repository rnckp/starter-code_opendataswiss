...
- **Keywords.de** `['vbz', 'offentlicher-verkehr', 'tram', 'buslinien', 'geoportal', 'punktdaten', 'tramlinien', 'strassenbahn', 'geodaten', 'stzh', 'verkauf', 'vektordaten', 'vbg', 'bus', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-23T02:58:30.061771`
