...
- **Keywords.de** `['stzh', 'tramlinien', 'geodaten', 'punktdaten', 'geoportal', 'bus', 'postauto', 'offentlicher-verkehr', 'buslinien', 'strassenbahn', 'vbz', 'verkauf', 'tram', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-26T03:35:37.749548`
