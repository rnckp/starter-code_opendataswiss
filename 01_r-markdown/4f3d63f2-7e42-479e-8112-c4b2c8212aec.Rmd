...
- **Keywords.de** `['punktdaten', 'bus', 'tramlinien', 'strassenbahn', 'offentlicher-verkehr', 'tram', 'geoportal', 'stzh', 'buslinien', 'vbz', 'geodaten', 'postauto', 'vbg', 'verkauf', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-10T04:12:21.507530`
