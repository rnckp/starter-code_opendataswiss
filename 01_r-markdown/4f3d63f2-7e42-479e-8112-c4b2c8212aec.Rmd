...
- **Keywords.de** `['geodaten', 'strassenbahn', 'offentlicher-verkehr', 'postauto', 'punktdaten', 'vbz', 'tram', 'tramlinien', 'vbg', 'vektordaten', 'stzh', 'geoportal', 'bus', 'buslinien', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-08T02:56:56.828422`
