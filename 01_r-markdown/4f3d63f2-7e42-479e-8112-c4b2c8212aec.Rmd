...
- **Keywords.de** `['geoportal', 'postauto', 'vektordaten', 'tramlinien', 'tram', 'verkauf', 'vbz', 'vbg', 'geodaten', 'strassenbahn', 'stzh', 'offentlicher-verkehr', 'punktdaten', 'buslinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-27T03:08:22.748242`
