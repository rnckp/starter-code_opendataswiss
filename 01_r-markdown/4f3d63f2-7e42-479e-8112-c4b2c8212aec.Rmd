...
- **Keywords.de** `['geodaten', 'bus', 'vbz', 'geoportal', 'strassenbahn', 'verkauf', 'vektordaten', 'tramlinien', 'tram', 'postauto', 'stzh', 'vbg', 'buslinien', 'offentlicher-verkehr', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-14T03:03:33.262495`
