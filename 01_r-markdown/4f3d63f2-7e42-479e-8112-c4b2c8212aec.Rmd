...
- **Keywords.de** `['postauto', 'stzh', 'vbz', 'punktdaten', 'buslinien', 'offentlicher-verkehr', 'vbg', 'bus', 'tramlinien', 'tram', 'geodaten', 'strassenbahn', 'geoportal', 'verkauf', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-05T02:38:51.587791`
