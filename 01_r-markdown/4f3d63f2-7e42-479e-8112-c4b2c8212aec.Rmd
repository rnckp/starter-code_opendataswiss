...
- **Keywords.de** `['strassenbahn', 'vbz', 'geodaten', 'geoportal', 'vbg', 'offentlicher-verkehr', 'buslinien', 'bus', 'postauto', 'tram', 'stzh', 'vektordaten', 'punktdaten', 'verkauf', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-27T03:01:21.022175`
