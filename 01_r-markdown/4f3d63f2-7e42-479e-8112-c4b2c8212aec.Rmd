...
- **Keywords.de** `['vbz', 'geodaten', 'punktdaten', 'postauto', 'tram', 'geoportal', 'offentlicher-verkehr', 'vbg', 'bus', 'vektordaten', 'strassenbahn', 'verkauf', 'stzh', 'buslinien', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-05T02:40:23.444555`
