...
- **Keywords.de** `['buslinien', 'vbg', 'geoportal', 'vbz', 'punktdaten', 'bus', 'offentlicher-verkehr', 'verkauf', 'tramlinien', 'postauto', 'strassenbahn', 'geodaten', 'stzh', 'vektordaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-19T04:09:11.039639`
