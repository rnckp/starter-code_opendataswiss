...
- **Keywords.de** `['bus', 'postauto', 'verkauf', 'stzh', 'geoportal', 'vbg', 'vektordaten', 'punktdaten', 'strassenbahn', 'tramlinien', 'vbz', 'tram', 'buslinien', 'geodaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-13T03:06:47.692248`
