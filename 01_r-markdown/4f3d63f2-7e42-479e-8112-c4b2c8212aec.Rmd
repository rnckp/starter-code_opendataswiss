...
- **Keywords.de** `['bus', 'vbg', 'stzh', 'vbz', 'tramlinien', 'buslinien', 'tram', 'geoportal', 'postauto', 'geodaten', 'strassenbahn', 'verkauf', 'vektordaten', 'punktdaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-09T02:30:35.256664`
