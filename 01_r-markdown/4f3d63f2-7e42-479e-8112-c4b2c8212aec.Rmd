...
- **Keywords.de** `['vektordaten', 'bus', 'buslinien', 'offentlicher-verkehr', 'tram', 'verkauf', 'tramlinien', 'punktdaten', 'strassenbahn', 'stzh', 'geodaten', 'geoportal', 'postauto', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-24T03:22:16.175208`
