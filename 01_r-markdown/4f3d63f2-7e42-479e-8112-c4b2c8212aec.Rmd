...
- **Keywords.de** `['buslinien', 'bus', 'stzh', 'punktdaten', 'geoportal', 'vbg', 'offentlicher-verkehr', 'vektordaten', 'verkauf', 'postauto', 'vbz', 'strassenbahn', 'geodaten', 'tramlinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-21T03:22:35.264511`
