...
- **Keywords.de** `['vbz', 'buslinien', 'tram', 'offentlicher-verkehr', 'geoportal', 'verkauf', 'bus', 'punktdaten', 'tramlinien', 'geodaten', 'strassenbahn', 'vektordaten', 'vbg', 'postauto', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-02T04:25:43.729699`
