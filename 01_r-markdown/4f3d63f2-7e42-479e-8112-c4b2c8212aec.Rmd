...
- **Keywords.de** `['vbz', 'geodaten', 'tram', 'tramlinien', 'postauto', 'geoportal', 'vektordaten', 'bus', 'buslinien', 'stzh', 'strassenbahn', 'vbg', 'verkauf', 'punktdaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-15T03:45:54.699333`
