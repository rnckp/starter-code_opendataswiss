...
- **Keywords.de** `['tram', 'strassenbahn', 'vbz', 'punktdaten', 'vektordaten', 'geodaten', 'buslinien', 'geoportal', 'tramlinien', 'offentlicher-verkehr', 'postauto', 'vbg', 'bus', 'verkauf', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-17T02:02:06.426139`
