...
- **Keywords.de** `['vektordaten', 'verkauf', 'tram', 'offentlicher-verkehr', 'geodaten', 'tramlinien', 'buslinien', 'stzh', 'vbz', 'postauto', 'geoportal', 'vbg', 'punktdaten', 'bus', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-06T03:10:41.651730`
