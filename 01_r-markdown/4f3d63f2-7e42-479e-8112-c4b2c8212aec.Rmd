...
- **Keywords.de** `['vbz', 'tram', 'tramlinien', 'verkauf', 'offentlicher-verkehr', 'stzh', 'vbg', 'punktdaten', 'geodaten', 'vektordaten', 'buslinien', 'postauto', 'geoportal', 'bus', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-28T04:03:52.971571`
