...
- **Keywords.de** `['geodaten', 'tramlinien', 'verkauf', 'strassenbahn', 'stzh', 'vektordaten', 'tram', 'buslinien', 'bus', 'postauto', 'geoportal', 'punktdaten', 'vbg', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-06T04:39:18.634750`
