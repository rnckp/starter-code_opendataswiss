...
- **Keywords.de** `['tramlinien', 'vbg', 'buslinien', 'strassenbahn', 'vektordaten', 'stzh', 'tram', 'postauto', 'offentlicher-verkehr', 'bus', 'punktdaten', 'verkauf', 'vbz', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-27T03:15:21.982755`
