...
- **Keywords.de** `['vbz', 'verkauf', 'tram', 'geodaten', 'postauto', 'vektordaten', 'geoportal', 'punktdaten', 'offentlicher-verkehr', 'stzh', 'buslinien', 'tramlinien', 'vbg', 'strassenbahn', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-28T02:51:42.115649`
