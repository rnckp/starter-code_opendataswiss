...
- **Keywords.de** `['geodaten', 'tram', 'punktdaten', 'strassenbahn', 'geoportal', 'stzh', 'vektordaten', 'postauto', 'bus', 'verkauf', 'vbg', 'buslinien', 'tramlinien', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-13T03:48:57.586091`
