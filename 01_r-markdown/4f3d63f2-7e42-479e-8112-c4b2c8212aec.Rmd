...
- **Keywords.de** `['vbg', 'vektordaten', 'geodaten', 'geoportal', 'punktdaten', 'buslinien', 'tramlinien', 'offentlicher-verkehr', 'strassenbahn', 'postauto', 'verkauf', 'vbz', 'stzh', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-18T03:27:15.253617`
