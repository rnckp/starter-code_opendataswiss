...
- **Keywords.de** `['punktdaten', 'verkauf', 'offentlicher-verkehr', 'tramlinien', 'buslinien', 'vbg', 'vektordaten', 'geoportal', 'vbz', 'postauto', 'stzh', 'strassenbahn', 'tram', 'geodaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-08T03:28:19.343633`
