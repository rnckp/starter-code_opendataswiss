...
- **Keywords.de** `['offentlicher-verkehr', 'postauto', 'tramlinien', 'buslinien', 'vbg', 'verkauf', 'stzh', 'tram', 'strassenbahn', 'punktdaten', 'geodaten', 'vektordaten', 'bus', 'vbz', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-31T03:42:23.671109`
