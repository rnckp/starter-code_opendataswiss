...
- **Keywords.de** `['vektordaten', 'vbz', 'offentlicher-verkehr', 'vbg', 'bus', 'tram', 'geoportal', 'strassenbahn', 'buslinien', 'geodaten', 'verkauf', 'tramlinien', 'postauto', 'punktdaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-09T06:11:55.111382`
