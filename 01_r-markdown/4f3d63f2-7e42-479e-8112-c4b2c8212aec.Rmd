...
- **Keywords.de** `['vektordaten', 'vbg', 'strassenbahn', 'bus', 'geodaten', 'tram', 'offentlicher-verkehr', 'stzh', 'buslinien', 'punktdaten', 'geoportal', 'postauto', 'tramlinien', 'verkauf', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-10T03:33:49.725845`
