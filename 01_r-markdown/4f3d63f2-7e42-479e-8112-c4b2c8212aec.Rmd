...
- **Keywords.de** `['geoportal', 'offentlicher-verkehr', 'punktdaten', 'vektordaten', 'stzh', 'strassenbahn', 'postauto', 'vbg', 'tram', 'bus', 'buslinien', 'verkauf', 'vbz', 'tramlinien', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-30T03:21:06.220252`
