...
- **Keywords.de** `['tram', 'geoportal', 'strassenbahn', 'geodaten', 'bus', 'vbg', 'vektordaten', 'buslinien', 'tramlinien', 'vbz', 'verkauf', 'stzh', 'punktdaten', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-12T03:10:42.720847`
