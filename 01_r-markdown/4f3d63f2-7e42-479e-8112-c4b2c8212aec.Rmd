...
- **Keywords.de** `['tramlinien', 'vbz', 'offentlicher-verkehr', 'geodaten', 'vektordaten', 'postauto', 'punktdaten', 'geoportal', 'verkauf', 'vbg', 'buslinien', 'bus', 'tram', 'stzh', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-21T03:10:22.957476`
