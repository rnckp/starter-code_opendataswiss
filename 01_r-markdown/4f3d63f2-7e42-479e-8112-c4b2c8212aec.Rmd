...
- **Keywords.de** `['offentlicher-verkehr', 'punktdaten', 'bus', 'vbz', 'vbg', 'tram', 'vektordaten', 'geoportal', 'strassenbahn', 'buslinien', 'stzh', 'postauto', 'tramlinien', 'verkauf', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-14T03:15:45.311671`
