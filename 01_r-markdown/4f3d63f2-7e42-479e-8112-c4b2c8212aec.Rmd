...
- **Keywords.de** `['vektordaten', 'postauto', 'verkauf', 'offentlicher-verkehr', 'bus', 'stzh', 'vbg', 'buslinien', 'tram', 'geoportal', 'geodaten', 'vbz', 'strassenbahn', 'punktdaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-13T02:32:20.782374`
