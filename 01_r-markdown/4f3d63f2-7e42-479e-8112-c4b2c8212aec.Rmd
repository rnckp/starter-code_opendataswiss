...
- **Keywords.de** `['punktdaten', 'buslinien', 'stzh', 'vbg', 'tram', 'vektordaten', 'verkauf', 'offentlicher-verkehr', 'tramlinien', 'strassenbahn', 'vbz', 'geodaten', 'postauto', 'geoportal', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-03T02:30:53.785928`
