...
- **Keywords.de** `['postauto', 'strassenbahn', 'tram', 'vektordaten', 'geodaten', 'offentlicher-verkehr', 'vbz', 'geoportal', 'buslinien', 'tramlinien', 'stzh', 'verkauf', 'bus', 'vbg', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-06T05:56:58.639559`
