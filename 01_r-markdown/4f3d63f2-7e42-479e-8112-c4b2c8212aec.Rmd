...
- **Keywords.de** `['buslinien', 'stzh', 'punktdaten', 'postauto', 'vbg', 'bus', 'strassenbahn', 'vektordaten', 'tram', 'tramlinien', 'geoportal', 'verkauf', 'geodaten', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-26T03:26:36.239469`
