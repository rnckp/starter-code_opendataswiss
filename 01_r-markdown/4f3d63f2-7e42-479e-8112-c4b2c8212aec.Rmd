...
- **Keywords.de** `['punktdaten', 'stzh', 'offentlicher-verkehr', 'strassenbahn', 'bus', 'tram', 'verkauf', 'buslinien', 'vbg', 'vektordaten', 'geodaten', 'postauto', 'tramlinien', 'vbz', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-15T03:10:41.597981`
