...
- **Keywords.de** `['postauto', 'tramlinien', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'bus', 'vbz', 'punktdaten', 'tram', 'stzh', 'buslinien', 'geoportal', 'vektordaten', 'geodaten', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-18T03:07:40.722487`
