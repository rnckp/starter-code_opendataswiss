...
- **Keywords.de** `['bus', 'geodaten', 'geoportal', 'punktdaten', 'vbg', 'offentlicher-verkehr', 'strassenbahn', 'verkauf', 'stzh', 'vektordaten', 'vbz', 'tramlinien', 'tram', 'postauto', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-14T02:33:00.069713`
