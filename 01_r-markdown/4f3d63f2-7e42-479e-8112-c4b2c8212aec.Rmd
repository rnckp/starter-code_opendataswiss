...
- **Keywords.de** `['offentlicher-verkehr', 'vektordaten', 'geoportal', 'vbg', 'postauto', 'punktdaten', 'vbz', 'tramlinien', 'verkauf', 'tram', 'bus', 'strassenbahn', 'buslinien', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-17T03:16:07.913150`
