...
- **Keywords.de** `['offentlicher-verkehr', 'tram', 'stzh', 'geodaten', 'vbz', 'bus', 'buslinien', 'postauto', 'verkauf', 'geoportal', 'tramlinien', 'strassenbahn', 'punktdaten', 'vektordaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-03T03:08:24.661800`
