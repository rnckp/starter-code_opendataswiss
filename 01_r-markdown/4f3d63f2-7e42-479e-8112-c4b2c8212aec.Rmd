...
- **Keywords.de** `['punktdaten', 'postauto', 'tramlinien', 'tram', 'bus', 'buslinien', 'vbz', 'geodaten', 'offentlicher-verkehr', 'vektordaten', 'vbg', 'strassenbahn', 'verkauf', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-06T02:51:30.775146`
