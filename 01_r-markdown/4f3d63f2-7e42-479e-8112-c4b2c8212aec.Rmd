...
- **Keywords.de** `['verkauf', 'punktdaten', 'buslinien', 'vbg', 'bus', 'geoportal', 'vbz', 'vektordaten', 'offentlicher-verkehr', 'postauto', 'stzh', 'strassenbahn', 'geodaten', 'tramlinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-20T02:30:48.127976`
