...
- **Keywords.de** `['strassenbahn', 'geoportal', 'bus', 'vektordaten', 'vbg', 'punktdaten', 'geodaten', 'offentlicher-verkehr', 'tramlinien', 'buslinien', 'verkauf', 'tram', 'vbz', 'stzh', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-11T03:38:20.259797`
