...
- **Keywords.de** `['geodaten', 'postauto', 'buslinien', 'stzh', 'tramlinien', 'vbg', 'tram', 'offentlicher-verkehr', 'vbz', 'geoportal', 'strassenbahn', 'verkauf', 'bus', 'punktdaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-03T02:52:14.909938`
