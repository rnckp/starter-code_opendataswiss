...
- **Keywords.de** `['vbg', 'geodaten', 'vektordaten', 'tram', 'bus', 'verkauf', 'stzh', 'strassenbahn', 'tramlinien', 'postauto', 'offentlicher-verkehr', 'buslinien', 'punktdaten', 'geoportal', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-08T02:36:57.710541`
