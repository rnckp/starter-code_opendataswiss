...
- **Keywords.de** `['geodaten', 'vektordaten', 'tramlinien', 'vbg', 'tram', 'verkauf', 'punktdaten', 'bus', 'offentlicher-verkehr', 'geoportal', 'postauto', 'stzh', 'strassenbahn', 'vbz', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-09T05:02:27.537232`
