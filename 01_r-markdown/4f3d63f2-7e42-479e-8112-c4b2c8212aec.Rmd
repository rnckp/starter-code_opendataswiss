...
- **Keywords.de** `['offentlicher-verkehr', 'vbg', 'geodaten', 'tram', 'buslinien', 'tramlinien', 'postauto', 'vektordaten', 'stzh', 'vbz', 'bus', 'strassenbahn', 'verkauf', 'punktdaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-04T03:56:43.457986`
