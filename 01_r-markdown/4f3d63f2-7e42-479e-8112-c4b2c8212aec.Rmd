...
- **Keywords.de** `['stzh', 'tram', 'vbz', 'bus', 'strassenbahn', 'vbg', 'buslinien', 'punktdaten', 'geoportal', 'offentlicher-verkehr', 'tramlinien', 'vektordaten', 'verkauf', 'postauto', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-14T04:07:54.328067`
