...
- **Keywords.de** `['punktdaten', 'tram', 'verkauf', 'tramlinien', 'stzh', 'vbg', 'geoportal', 'vektordaten', 'geodaten', 'buslinien', 'strassenbahn', 'offentlicher-verkehr', 'bus', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-23T03:19:15.793195`
