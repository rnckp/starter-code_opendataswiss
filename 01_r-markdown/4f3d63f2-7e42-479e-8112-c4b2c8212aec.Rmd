...
- **Keywords.de** `['vbz', 'bus', 'tram', 'offentlicher-verkehr', 'postauto', 'buslinien', 'geodaten', 'vektordaten', 'verkauf', 'vbg', 'geoportal', 'stzh', 'strassenbahn', 'punktdaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-11T03:35:52.993586`
