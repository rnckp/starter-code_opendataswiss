...
- **Keywords.de** `['geodaten', 'bus', 'buslinien', 'strassenbahn', 'tram', 'stzh', 'vbz', 'geoportal', 'verkauf', 'punktdaten', 'tramlinien', 'vektordaten', 'vbg', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-01T03:00:07.838145`
