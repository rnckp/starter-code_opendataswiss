...
- **Keywords.de** `['punktdaten', 'tram', 'vektordaten', 'geoportal', 'strassenbahn', 'offentlicher-verkehr', 'verkauf', 'geodaten', 'vbz', 'tramlinien', 'bus', 'buslinien', 'postauto', 'stzh', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-16T03:14:50.848119`
