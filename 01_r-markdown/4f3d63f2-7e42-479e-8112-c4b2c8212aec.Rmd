...
- **Keywords.de** `['postauto', 'tramlinien', 'verkauf', 'vbg', 'bus', 'punktdaten', 'buslinien', 'tram', 'geodaten', 'strassenbahn', 'vektordaten', 'vbz', 'geoportal', 'stzh', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-15T02:59:48.340515`
