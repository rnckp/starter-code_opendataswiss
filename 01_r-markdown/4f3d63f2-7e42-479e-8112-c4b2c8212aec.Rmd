...
- **Keywords.de** `['bus', 'postauto', 'verkauf', 'vbg', 'vbz', 'offentlicher-verkehr', 'stzh', 'buslinien', 'punktdaten', 'geoportal', 'strassenbahn', 'geodaten', 'tram', 'vektordaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-02T03:47:33.520869`
