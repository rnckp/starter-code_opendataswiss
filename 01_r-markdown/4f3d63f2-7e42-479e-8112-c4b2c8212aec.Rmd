...
- **Keywords.de** `['postauto', 'geoportal', 'stzh', 'offentlicher-verkehr', 'vektordaten', 'tramlinien', 'tram', 'buslinien', 'strassenbahn', 'punktdaten', 'bus', 'geodaten', 'verkauf', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-22T03:11:58.561961`
