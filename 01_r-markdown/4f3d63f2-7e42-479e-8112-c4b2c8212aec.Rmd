...
- **Keywords.de** `['verkauf', 'offentlicher-verkehr', 'bus', 'vektordaten', 'postauto', 'buslinien', 'geodaten', 'punktdaten', 'vbz', 'geoportal', 'stzh', 'tramlinien', 'strassenbahn', 'tram', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-18T04:05:25.196011`
