...
- **Keywords.de** `['stzh', 'bus', 'punktdaten', 'offentlicher-verkehr', 'postauto', 'verkauf', 'vbz', 'vbg', 'geoportal', 'strassenbahn', 'tram', 'vektordaten', 'tramlinien', 'buslinien', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-01T03:36:24.936465`
