...
- **Keywords.de** `['geodaten', 'offentlicher-verkehr', 'tramlinien', 'stzh', 'vektordaten', 'tram', 'vbz', 'bus', 'strassenbahn', 'buslinien', 'postauto', 'geoportal', 'punktdaten', 'verkauf', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-13T03:23:55.041669`
