...
- **Keywords.de** `['punktdaten', 'bus', 'vektordaten', 'tramlinien', 'geodaten', 'offentlicher-verkehr', 'tram', 'vbg', 'vbz', 'buslinien', 'stzh', 'strassenbahn', 'postauto', 'geoportal', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-23T02:52:53.057158`
