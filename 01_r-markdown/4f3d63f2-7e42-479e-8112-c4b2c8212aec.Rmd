...
- **Keywords.de** `['stzh', 'vbz', 'geodaten', 'vektordaten', 'bus', 'verkauf', 'offentlicher-verkehr', 'postauto', 'geoportal', 'buslinien', 'punktdaten', 'strassenbahn', 'tramlinien', 'tram', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-28T02:46:40.574743`
