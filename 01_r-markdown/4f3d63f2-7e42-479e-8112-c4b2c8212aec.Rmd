...
- **Keywords.de** `['stzh', 'tramlinien', 'vbg', 'buslinien', 'vbz', 'vektordaten', 'bus', 'postauto', 'verkauf', 'geoportal', 'offentlicher-verkehr', 'strassenbahn', 'punktdaten', 'geodaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-08T02:45:44.388335`
