...
- **Keywords.de** `['verkauf', 'stzh', 'vbg', 'geoportal', 'offentlicher-verkehr', 'punktdaten', 'vbz', 'geodaten', 'postauto', 'bus', 'tram', 'vektordaten', 'tramlinien', 'strassenbahn', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-08T03:31:55.277061`
