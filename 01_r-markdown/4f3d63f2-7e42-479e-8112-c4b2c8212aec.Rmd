...
- **Keywords.de** `['postauto', 'bus', 'buslinien', 'punktdaten', 'offentlicher-verkehr', 'tram', 'geoportal', 'verkauf', 'vbg', 'tramlinien', 'stzh', 'vektordaten', 'strassenbahn', 'vbz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-10T03:06:22.351507`
