...
- **Keywords.de** `['geoportal', 'strassenbahn', 'tramlinien', 'verkauf', 'offentlicher-verkehr', 'vbz', 'postauto', 'buslinien', 'stzh', 'punktdaten', 'vbg', 'tram', 'bus', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-01T02:48:23.896231`
