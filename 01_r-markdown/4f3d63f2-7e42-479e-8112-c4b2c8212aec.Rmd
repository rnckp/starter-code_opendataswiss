...
- **Keywords.de** `['vbz', 'verkauf', 'postauto', 'vektordaten', 'tramlinien', 'tram', 'offentlicher-verkehr', 'punktdaten', 'bus', 'buslinien', 'vbg', 'geodaten', 'stzh', 'strassenbahn', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-12T02:57:05.956419`
