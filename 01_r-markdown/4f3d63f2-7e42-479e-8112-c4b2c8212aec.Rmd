...
- **Keywords.de** `['stzh', 'strassenbahn', 'bus', 'verkauf', 'geoportal', 'postauto', 'vbg', 'geodaten', 'vektordaten', 'tramlinien', 'punktdaten', 'offentlicher-verkehr', 'buslinien', 'vbz', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-26T03:47:21.445356`
