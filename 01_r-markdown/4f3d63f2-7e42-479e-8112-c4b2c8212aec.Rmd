...
- **Keywords.de** `['vbg', 'buslinien', 'tramlinien', 'verkauf', 'strassenbahn', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'postauto', 'geoportal', 'tram', 'bus', 'vbz', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-02T04:21:01.249803`
