...
- **Keywords.de** `['stzh', 'geodaten', 'postauto', 'tram', 'buslinien', 'bus', 'tramlinien', 'strassenbahn', 'offentlicher-verkehr', 'geoportal', 'vbz', 'verkauf', 'punktdaten', 'vektordaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-01T08:50:47.529262`
