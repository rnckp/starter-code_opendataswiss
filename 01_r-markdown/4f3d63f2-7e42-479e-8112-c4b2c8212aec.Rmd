...
- **Keywords.de** `['vbz', 'verkauf', 'buslinien', 'tramlinien', 'postauto', 'geodaten', 'offentlicher-verkehr', 'vektordaten', 'tram', 'punktdaten', 'strassenbahn', 'bus', 'vbg', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-20T03:11:09.615361`
