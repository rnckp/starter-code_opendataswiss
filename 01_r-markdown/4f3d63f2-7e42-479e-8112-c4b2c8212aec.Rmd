...
- **Keywords.de** `['postauto', 'vbg', 'bus', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'verkauf', 'tramlinien', 'strassenbahn', 'punktdaten', 'geodaten', 'stzh', 'geoportal', 'tram', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-12T03:16:58.544280`
