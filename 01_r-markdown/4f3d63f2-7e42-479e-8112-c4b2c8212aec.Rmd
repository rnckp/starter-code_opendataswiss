...
- **Keywords.de** `['geodaten', 'vektordaten', 'stzh', 'punktdaten', 'strassenbahn', 'bus', 'tramlinien', 'geoportal', 'buslinien', 'postauto', 'vbg', 'vbz', 'offentlicher-verkehr', 'tram', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-09-16T04:18:45.387482`
