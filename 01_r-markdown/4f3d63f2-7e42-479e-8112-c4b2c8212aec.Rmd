...
- **Keywords.de** `['offentlicher-verkehr', 'vbg', 'strassenbahn', 'buslinien', 'geoportal', 'postauto', 'verkauf', 'vektordaten', 'tram', 'geodaten', 'bus', 'tramlinien', 'punktdaten', 'stzh', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-17T02:56:32.762834`
