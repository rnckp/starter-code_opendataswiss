...
- **Keywords.de** `['strassenbahn', 'stzh', 'bus', 'offentlicher-verkehr', 'verkauf', 'geodaten', 'tram', 'vbz', 'tramlinien', 'punktdaten', 'vbg', 'geoportal', 'buslinien', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-23T03:07:30.419031`
