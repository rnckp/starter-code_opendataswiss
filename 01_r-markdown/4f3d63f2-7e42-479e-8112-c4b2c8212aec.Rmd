...
- **Keywords.de** `['verkauf', 'stzh', 'strassenbahn', 'vbg', 'buslinien', 'tram', 'tramlinien', 'geoportal', 'postauto', 'bus', 'offentlicher-verkehr', 'geodaten', 'punktdaten', 'vbz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-07T04:31:33.845820`
