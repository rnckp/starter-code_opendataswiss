...
- **Keywords.de** `['vbg', 'vektordaten', 'tram', 'bus', 'punktdaten', 'buslinien', 'stzh', 'strassenbahn', 'tramlinien', 'postauto', 'vbz', 'offentlicher-verkehr', 'geoportal', 'geodaten', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-23T02:26:59.932038`
