...
- **Keywords.de** `['stzh', 'punktdaten', 'vbz', 'vektordaten', 'postauto', 'geoportal', 'geodaten', 'vbg', 'tram', 'bus', 'offentlicher-verkehr', 'verkauf', 'strassenbahn', 'tramlinien', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-29T02:34:50.639503`
