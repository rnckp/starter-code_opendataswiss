...
- **Keywords.de** `['punktdaten', 'tram', 'buslinien', 'bus', 'stzh', 'vektordaten', 'geoportal', 'offentlicher-verkehr', 'verkauf', 'tramlinien', 'vbg', 'strassenbahn', 'geodaten', 'postauto', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-01T03:42:00.752114`
