...
- **Keywords.de** `['bus', 'postauto', 'buslinien', 'vektordaten', 'tramlinien', 'vbg', 'vbz', 'stzh', 'geoportal', 'strassenbahn', 'offentlicher-verkehr', 'verkauf', 'geodaten', 'punktdaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-28T03:08:12.640024`
