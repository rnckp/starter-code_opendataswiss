...
- **Keywords.de** `['punktdaten', 'verkauf', 'geoportal', 'strassenbahn', 'vektordaten', 'bus', 'tram', 'postauto', 'tramlinien', 'stzh', 'buslinien', 'vbz', 'geodaten', 'vbg', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-22T03:21:45.117513`
