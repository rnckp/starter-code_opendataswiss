...
- **Keywords.de** `['bus', 'tramlinien', 'tram', 'punktdaten', 'geodaten', 'verkauf', 'buslinien', 'geoportal', 'strassenbahn', 'stzh', 'postauto', 'vbg', 'vektordaten', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-11-21T02:42:45.119648`
