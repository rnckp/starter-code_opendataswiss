...
- **Keywords.de** `['bus', 'stzh', 'buslinien', 'punktdaten', 'geodaten', 'vektordaten', 'postauto', 'geoportal', 'vbg', 'strassenbahn', 'verkauf', 'tramlinien', 'tram', 'vbz', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-30T03:04:57.539307`
