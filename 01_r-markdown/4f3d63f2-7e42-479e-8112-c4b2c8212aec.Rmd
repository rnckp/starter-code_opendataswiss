...
- **Keywords.de** `['geodaten', 'tram', 'bus', 'verkauf', 'punktdaten', 'postauto', 'vbg', 'vbz', 'buslinien', 'tramlinien', 'stzh', 'vektordaten', 'strassenbahn', 'offentlicher-verkehr', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-06-14T03:32:56.735069`
