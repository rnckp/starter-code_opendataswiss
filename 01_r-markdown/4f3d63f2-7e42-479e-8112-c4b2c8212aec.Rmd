...
- **Keywords.de** `['postauto', 'bus', 'strassenbahn', 'vbz', 'vbg', 'tram', 'offentlicher-verkehr', 'stzh', 'geodaten', 'vektordaten', 'geoportal', 'verkauf', 'tramlinien', 'punktdaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-26T03:22:33.745807`
