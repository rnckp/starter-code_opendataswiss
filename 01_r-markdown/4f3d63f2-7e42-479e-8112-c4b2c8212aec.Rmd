...
- **Keywords.de** `['offentlicher-verkehr', 'postauto', 'vbz', 'vbg', 'geoportal', 'bus', 'stzh', 'tramlinien', 'geodaten', 'strassenbahn', 'verkauf', 'punktdaten', 'tram', 'buslinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-03T02:59:24.447648`
