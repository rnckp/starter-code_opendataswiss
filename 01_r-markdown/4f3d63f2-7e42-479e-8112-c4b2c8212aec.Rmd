...
- **Keywords.de** `['offentlicher-verkehr', 'tramlinien', 'vektordaten', 'buslinien', 'vbg', 'strassenbahn', 'geodaten', 'tram', 'postauto', 'vbz', 'stzh', 'verkauf', 'punktdaten', 'bus', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-11T03:11:36.383501`
