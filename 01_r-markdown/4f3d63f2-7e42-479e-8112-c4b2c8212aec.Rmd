...
- **Keywords.de** `['stzh', 'geoportal', 'tramlinien', 'punktdaten', 'postauto', 'verkauf', 'bus', 'vektordaten', 'strassenbahn', 'vbz', 'offentlicher-verkehr', 'geodaten', 'buslinien', 'tram', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-08T03:54:39.884546`
