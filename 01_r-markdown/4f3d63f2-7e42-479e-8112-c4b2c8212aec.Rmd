...
- **Keywords.de** `['vektordaten', 'tramlinien', 'punktdaten', 'vbz', 'bus', 'verkauf', 'buslinien', 'tram', 'offentlicher-verkehr', 'stzh', 'geodaten', 'postauto', 'strassenbahn', 'geoportal', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-28T03:32:52.349551`
