...
- **Keywords.de** `['tramlinien', 'strassenbahn', 'bus', 'tram', 'buslinien', 'verkauf', 'offentlicher-verkehr', 'vektordaten', 'vbz', 'punktdaten', 'geodaten', 'geoportal', 'vbg', 'stzh', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-20T02:43:35.230616`
