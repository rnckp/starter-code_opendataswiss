...
- **Keywords.de** `['tramlinien', 'punktdaten', 'tram', 'strassenbahn', 'offentlicher-verkehr', 'stzh', 'verkauf', 'postauto', 'vbz', 'bus', 'vektordaten', 'buslinien', 'geodaten', 'vbg', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-24T03:46:33.829826`
