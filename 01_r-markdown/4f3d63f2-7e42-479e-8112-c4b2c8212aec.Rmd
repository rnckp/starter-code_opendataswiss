...
- **Keywords.de** `['geodaten', 'verkauf', 'strassenbahn', 'punktdaten', 'geoportal', 'tram', 'bus', 'vbz', 'vbg', 'stzh', 'buslinien', 'postauto', 'tramlinien', 'vektordaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-15T02:50:49.286705`
