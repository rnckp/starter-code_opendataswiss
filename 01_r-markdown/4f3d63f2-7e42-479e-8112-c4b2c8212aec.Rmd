...
- **Keywords.de** `['offentlicher-verkehr', 'tramlinien', 'vbg', 'geoportal', 'geodaten', 'verkauf', 'strassenbahn', 'bus', 'tram', 'punktdaten', 'vbz', 'postauto', 'buslinien', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-17T03:13:41.703007`
