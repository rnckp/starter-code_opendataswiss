...
- **Keywords.de** `['punktdaten', 'postauto', 'offentlicher-verkehr', 'vektordaten', 'bus', 'vbg', 'tramlinien', 'vbz', 'strassenbahn', 'geoportal', 'stzh', 'verkauf', 'buslinien', 'tram', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-02T03:01:11.437266`
