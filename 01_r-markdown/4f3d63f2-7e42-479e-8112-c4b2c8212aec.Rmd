...
- **Keywords.de** `['postauto', 'verkauf', 'vbz', 'offentlicher-verkehr', 'vektordaten', 'tram', 'strassenbahn', 'buslinien', 'stzh', 'punktdaten', 'vbg', 'tramlinien', 'bus', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-03-03T03:15:20.758854`
