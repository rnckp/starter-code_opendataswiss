...
- **Keywords.de** `['vbg', 'geoportal', 'geodaten', 'bus', 'postauto', 'vbz', 'offentlicher-verkehr', 'punktdaten', 'buslinien', 'strassenbahn', 'vektordaten', 'tramlinien', 'tram', 'verkauf', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-02-23T03:11:28.519339`
