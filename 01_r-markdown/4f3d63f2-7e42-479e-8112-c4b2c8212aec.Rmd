...
- **Keywords.de** `['punktdaten', 'buslinien', 'vbg', 'stzh', 'geoportal', 'tramlinien', 'bus', 'strassenbahn', 'offentlicher-verkehr', 'tram', 'verkauf', 'geodaten', 'postauto', 'vbz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-04T04:05:05.739494`
