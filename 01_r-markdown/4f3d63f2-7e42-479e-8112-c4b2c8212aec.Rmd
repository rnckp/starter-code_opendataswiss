...
- **Keywords.de** `['geodaten', 'tramlinien', 'postauto', 'stzh', 'geoportal', 'tram', 'buslinien', 'punktdaten', 'vbg', 'vektordaten', 'vbz', 'verkauf', 'offentlicher-verkehr', 'strassenbahn', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-15T03:04:28.418796`
