...
- **Keywords.de** `['tramlinien', 'punktdaten', 'vbz', 'vektordaten', 'bus', 'verkauf', 'vbg', 'postauto', 'buslinien', 'geodaten', 'offentlicher-verkehr', 'geoportal', 'stzh', 'tram', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-26T04:52:28.331170`
