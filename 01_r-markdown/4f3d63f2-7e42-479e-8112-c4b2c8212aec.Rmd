...
- **Keywords.de** `['punktdaten', 'strassenbahn', 'bus', 'geodaten', 'geoportal', 'verkauf', 'vbz', 'vbg', 'stzh', 'offentlicher-verkehr', 'buslinien', 'postauto', 'vektordaten', 'tramlinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-27T03:47:56.463144`
