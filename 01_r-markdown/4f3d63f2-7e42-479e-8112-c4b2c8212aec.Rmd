...
- **Keywords.de** `['tramlinien', 'vbg', 'bus', 'geodaten', 'offentlicher-verkehr', 'verkauf', 'vbz', 'vektordaten', 'tram', 'punktdaten', 'stzh', 'geoportal', 'buslinien', 'strassenbahn', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-01T03:11:06.038246`
