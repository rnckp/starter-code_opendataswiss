...
- **Keywords.de** `['strassenbahn', 'buslinien', 'tramlinien', 'geoportal', 'bus', 'vbz', 'punktdaten', 'vektordaten', 'tram', 'offentlicher-verkehr', 'verkauf', 'postauto', 'vbg', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-19T03:30:58.405045`
