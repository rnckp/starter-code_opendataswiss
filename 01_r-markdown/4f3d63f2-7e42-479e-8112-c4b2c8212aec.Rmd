...
- **Keywords.de** `['geodaten', 'bus', 'stzh', 'vbg', 'tramlinien', 'tram', 'offentlicher-verkehr', 'postauto', 'buslinien', 'geoportal', 'vektordaten', 'vbz', 'verkauf', 'strassenbahn', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-05-19T03:20:38.124436`
