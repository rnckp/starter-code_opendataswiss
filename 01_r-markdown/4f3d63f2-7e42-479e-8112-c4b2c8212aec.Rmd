...
- **Keywords.de** `['stzh', 'vbz', 'strassenbahn', 'tram', 'vektordaten', 'verkauf', 'offentlicher-verkehr', 'punktdaten', 'buslinien', 'tramlinien', 'bus', 'vbg', 'postauto', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-23T04:10:47.105407`
