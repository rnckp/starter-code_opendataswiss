...
- **Keywords.de** `['vektordaten', 'postauto', 'punktdaten', 'buslinien', 'offentlicher-verkehr', 'vbz', 'vbg', 'geodaten', 'stzh', 'tramlinien', 'bus', 'verkauf', 'geoportal', 'strassenbahn', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-22T02:54:04.208356`
