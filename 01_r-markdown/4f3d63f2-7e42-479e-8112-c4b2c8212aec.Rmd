...
- **Keywords.de** `['tram', 'verkauf', 'strassenbahn', 'offentlicher-verkehr', 'stzh', 'geodaten', 'buslinien', 'bus', 'punktdaten', 'geoportal', 'vektordaten', 'vbg', 'tramlinien', 'postauto', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-14T03:44:36.712111`
