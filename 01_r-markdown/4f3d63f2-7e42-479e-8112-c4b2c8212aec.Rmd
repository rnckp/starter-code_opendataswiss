...
- **Keywords.de** `['tramlinien', 'vbz', 'verkauf', 'buslinien', 'vektordaten', 'postauto', 'offentlicher-verkehr', 'vbg', 'geoportal', 'punktdaten', 'stzh', 'strassenbahn', 'tram', 'bus', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-29T02:30:31.547896`
