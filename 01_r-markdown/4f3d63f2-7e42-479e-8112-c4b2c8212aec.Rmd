...
- **Keywords.de** `['geodaten', 'vbz', 'punktdaten', 'postauto', 'strassenbahn', 'stzh', 'offentlicher-verkehr', 'verkauf', 'vektordaten', 'tramlinien', 'bus', 'buslinien', 'tram', 'vbg', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-20T03:33:09.096395`
