...
- **Keywords.de** `['bus', 'postauto', 'buslinien', 'verkauf', 'stzh', 'tram', 'vektordaten', 'geodaten', 'punktdaten', 'offentlicher-verkehr', 'vbz', 'tramlinien', 'strassenbahn', 'geoportal', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-03-08T03:11:58.970021`
