...
- **Keywords.de** `['geodaten', 'postauto', 'strassenbahn', 'vbz', 'offentlicher-verkehr', 'verkauf', 'vbg', 'geoportal', 'punktdaten', 'stzh', 'tram', 'tramlinien', 'bus', 'vektordaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-07-24T03:03:15.934422`
