...
- **Keywords.de** `['strassenbahn', 'vbz', 'bus', 'vektordaten', 'offentlicher-verkehr', 'geoportal', 'tram', 'tramlinien', 'stzh', 'verkauf', 'punktdaten', 'geodaten', 'vbg', 'postauto', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-28T03:32:01.900612`
