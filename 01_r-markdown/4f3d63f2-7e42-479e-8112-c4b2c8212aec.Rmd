...
- **Keywords.de** `['tramlinien', 'buslinien', 'strassenbahn', 'verkauf', 'vektordaten', 'stzh', 'tram', 'bus', 'geodaten', 'offentlicher-verkehr', 'vbg', 'geoportal', 'punktdaten', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-22T02:57:41.642816`
