...
- **Keywords.de** `['tram', 'verkauf', 'geoportal', 'geodaten', 'vbz', 'tramlinien', 'bus', 'stzh', 'offentlicher-verkehr', 'vbg', 'postauto', 'vektordaten', 'punktdaten', 'strassenbahn', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-22T03:17:29.562549`
