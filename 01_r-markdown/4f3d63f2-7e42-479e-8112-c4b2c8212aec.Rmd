...
- **Keywords.de** `['geodaten', 'vbz', 'strassenbahn', 'stzh', 'punktdaten', 'vbg', 'verkauf', 'tram', 'buslinien', 'bus', 'tramlinien', 'postauto', 'vektordaten', 'offentlicher-verkehr', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-25T03:22:48.770824`
