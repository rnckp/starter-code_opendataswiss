...
- **Keywords.de** `['vektordaten', 'postauto', 'offentlicher-verkehr', 'bus', 'geoportal', 'verkauf', 'strassenbahn', 'tram', 'stzh', 'punktdaten', 'vbz', 'tramlinien', 'vbg', 'geodaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-01-21T02:31:54.656150`
