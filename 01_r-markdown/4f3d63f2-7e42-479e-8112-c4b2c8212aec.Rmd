...
- **Keywords.de** `['vektordaten', 'verkauf', 'vbz', 'geodaten', 'offentlicher-verkehr', 'punktdaten', 'stzh', 'tramlinien', 'strassenbahn', 'geoportal', 'postauto', 'bus', 'vbg', 'tram', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-19T03:17:40.190112`
