...
- **Keywords.de** `['strassenbahn', 'bus', 'verkauf', 'geoportal', 'tram', 'stzh', 'vektordaten', 'geodaten', 'vbg', 'vbz', 'punktdaten', 'tramlinien', 'buslinien', 'postauto', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-04-05T03:26:12.333850`
