...
- **Keywords.de** `['stzh', 'strassenbahn', 'bus', 'tramlinien', 'geoportal', 'punktdaten', 'buslinien', 'vektordaten', 'postauto', 'vbg', 'geodaten', 'tram', 'offentlicher-verkehr', 'vbz', 'verkauf']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-05T03:00:44.274234`
