...
- **Keywords.de** `['stzh', 'buslinien', 'strassenbahn', 'verkauf', 'geoportal', 'tramlinien', 'vbz', 'punktdaten', 'vbg', 'offentlicher-verkehr', 'postauto', 'bus', 'geodaten', 'tram', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-28T03:44:54.663848`
