...
- **Keywords.de** `['buslinien', 'verkauf', 'bus', 'offentlicher-verkehr', 'tramlinien', 'postauto', 'tram', 'strassenbahn', 'geoportal', 'punktdaten', 'vektordaten', 'stzh', 'geodaten', 'vbz', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-30T03:25:52.569365`
