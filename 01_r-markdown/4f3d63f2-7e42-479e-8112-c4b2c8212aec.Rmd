...
- **Keywords.de** `['punktdaten', 'bus', 'offentlicher-verkehr', 'stzh', 'vektordaten', 'strassenbahn', 'geoportal', 'vbg', 'postauto', 'tram', 'tramlinien', 'verkauf', 'buslinien', 'vbz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-02-08T04:36:37.238834`
