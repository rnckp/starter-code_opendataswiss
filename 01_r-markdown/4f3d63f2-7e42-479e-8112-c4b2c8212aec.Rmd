...
- **Keywords.de** `['punktdaten', 'tramlinien', 'stzh', 'vbg', 'strassenbahn', 'vektordaten', 'geodaten', 'postauto', 'tram', 'offentlicher-verkehr', 'bus', 'geoportal', 'verkauf', 'buslinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-11-23T03:16:50.903766`
