...
- **Keywords.de** `['geodaten', 'buslinien', 'tram', 'stzh', 'bus', 'tramlinien', 'offentlicher-verkehr', 'strassenbahn', 'geoportal', 'verkauf', 'postauto', 'vbg', 'vektordaten', 'punktdaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-04-02T05:14:56.794237`
