...
- **Keywords.de** `['bus', 'buslinien', 'offentlicher-verkehr', 'tram', 'vbz', 'verkauf', 'stzh', 'postauto', 'punktdaten', 'vbg', 'strassenbahn', 'vektordaten', 'geodaten', 'geoportal', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-30T02:58:09.640606`
