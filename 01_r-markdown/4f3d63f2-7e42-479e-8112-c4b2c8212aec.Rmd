...
- **Keywords.de** `['buslinien', 'verkauf', 'punktdaten', 'strassenbahn', 'tramlinien', 'tram', 'vektordaten', 'offentlicher-verkehr', 'geoportal', 'geodaten', 'postauto', 'bus', 'stzh', 'vbz', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-02T04:01:26.223827`
