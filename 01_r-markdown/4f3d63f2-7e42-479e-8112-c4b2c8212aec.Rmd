...
- **Keywords.de** `['offentlicher-verkehr', 'punktdaten', 'vektordaten', 'strassenbahn', 'buslinien', 'tramlinien', 'geoportal', 'geodaten', 'bus', 'verkauf', 'vbg', 'stzh', 'vbz', 'postauto', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2023-12-30T08:42:18.834272`
