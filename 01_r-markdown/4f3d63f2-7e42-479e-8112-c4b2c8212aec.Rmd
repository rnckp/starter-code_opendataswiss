...
- **Keywords.de** `['vbg', 'geoportal', 'punktdaten', 'tramlinien', 'tram', 'offentlicher-verkehr', 'postauto', 'buslinien', 'verkauf', 'bus', 'stzh', 'vbz', 'geodaten', 'vektordaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-06T03:20:07.068355`
