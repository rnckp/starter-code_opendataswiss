...
- **Keywords.de** `['offentlicher-verkehr', 'vbg', 'geoportal', 'strassenbahn', 'vbz', 'bus', 'vektordaten', 'geodaten', 'postauto', 'verkauf', 'stzh', 'punktdaten', 'tramlinien', 'tram', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-29T02:50:10.444997`
