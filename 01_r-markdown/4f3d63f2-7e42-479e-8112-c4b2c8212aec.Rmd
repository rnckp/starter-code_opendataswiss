...
- **Keywords.de** `['buslinien', 'tramlinien', 'vbz', 'punktdaten', 'strassenbahn', 'vbg', 'bus', 'postauto', 'vektordaten', 'offentlicher-verkehr', 'verkauf', 'geoportal', 'geodaten', 'tram', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-09-01T03:14:07.744313`
