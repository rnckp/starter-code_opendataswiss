...
- **Keywords.de** `['stzh', 'geodaten', 'verkauf', 'geoportal', 'buslinien', 'strassenbahn', 'punktdaten', 'bus', 'offentlicher-verkehr', 'vbg', 'vektordaten', 'tram', 'vbz', 'postauto', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-05-07T03:22:30.190120`
