...
- **Keywords.de** `['punktdaten', 'vbz', 'geodaten', 'buslinien', 'tram', 'offentlicher-verkehr', 'stzh', 'geoportal', 'postauto', 'vbg', 'verkauf', 'vektordaten', 'tramlinien', 'strassenbahn', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-01-14T03:47:26.412670`
