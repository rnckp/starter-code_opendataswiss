...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'vbg', 'vbz', 'geoportal', 'tram', 'vektordaten', 'bus', 'geodaten', 'postauto', 'tramlinien', 'verkauf', 'punktdaten', 'strassenbahn', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-07-07T03:19:04.634319`
