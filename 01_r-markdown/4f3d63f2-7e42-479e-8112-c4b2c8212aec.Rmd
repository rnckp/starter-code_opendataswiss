...
- **Keywords.de** `['geoportal', 'geodaten', 'vektordaten', 'strassenbahn', 'buslinien', 'tram', 'tramlinien', 'punktdaten', 'verkauf', 'vbz', 'vbg', 'bus', 'offentlicher-verkehr', 'postauto', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-08-25T02:50:28.835653`
