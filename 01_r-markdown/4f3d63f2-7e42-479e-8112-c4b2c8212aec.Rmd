...
- **Keywords.de** `['tram', 'bus', 'vbg', 'vbz', 'postauto', 'verkauf', 'strassenbahn', 'tramlinien', 'punktdaten', 'stzh', 'buslinien', 'geoportal', 'offentlicher-verkehr', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2025-08-06T02:46:12.318009`
