...
- **Keywords.de** `['geodaten', 'strassenbahn', 'buslinien', 'tramlinien', 'geoportal', 'vbz', 'offentlicher-verkehr', 'vbg', 'verkauf', 'bus', 'vektordaten', 'tram', 'punktdaten', 'postauto', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-10-15T03:01:18.810262`
