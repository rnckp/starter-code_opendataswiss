...
- **Keywords.de** `['vbz', 'tramlinien', 'stzh', 'verkauf', 'vbg', 'geoportal', 'bus', 'offentlicher-verkehr', 'buslinien', 'vektordaten', 'punktdaten', 'postauto', 'tram', 'strassenbahn', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-12-28T03:55:06.319229`
