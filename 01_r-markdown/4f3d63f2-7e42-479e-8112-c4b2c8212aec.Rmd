...
- **Keywords.de** `['postauto', 'geoportal', 'buslinien', 'strassenbahn', 'tram', 'vektordaten', 'punktdaten', 'offentlicher-verkehr', 'stzh', 'vbz', 'bus', 'verkauf', 'vbg', 'tramlinien', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:42:35.815004`
- **Metadata_modified** `2024-06-16T03:21:59.432890`
