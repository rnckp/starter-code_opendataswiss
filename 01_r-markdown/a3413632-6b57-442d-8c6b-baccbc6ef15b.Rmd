...
- **Keywords.de** `['trinken', 'stzh', 'geodaten', 'gastro', 'sachdaten', 'adressen', 'punktdaten', 'essen', 'vektordaten', 'gastronomie', 'ausgang', 'standort', 'geoportal', 'bar']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-08-03T01:25:55.850793`
