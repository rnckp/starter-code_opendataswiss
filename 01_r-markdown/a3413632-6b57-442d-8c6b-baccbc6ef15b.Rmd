...
- **Keywords.de** `['essen', 'stzh', 'geodaten', 'bar', 'trinken', 'gastronomie', 'ausgang', 'sachdaten', 'adressen', 'geoportal', 'vektordaten', 'standort', 'punktdaten', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-03-07T01:02:43.830832`
