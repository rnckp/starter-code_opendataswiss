...
- **Keywords.de** `['geodaten', 'bar', 'essen', 'geoportal', 'punktdaten', 'ausgang', 'stzh', 'trinken', 'vektordaten', 'gastronomie', 'sachdaten', 'gastro', 'standort', 'adressen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-05-28T01:05:57.108402`
