...
- **Keywords.de** `['trinken', 'sachdaten', 'gastronomie', 'ausgang', 'geoportal', 'geodaten', 'stzh', 'adressen', 'punktdaten', 'essen', 'standort', 'bar', 'vektordaten', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-03-24T01:19:15.480236`
