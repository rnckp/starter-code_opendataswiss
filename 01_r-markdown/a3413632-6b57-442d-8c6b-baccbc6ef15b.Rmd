...
- **Keywords.de** `['ausgang', 'sachdaten', 'vektordaten', 'punktdaten', 'gastro', 'standort', 'essen', 'gastronomie', 'trinken', 'adressen', 'stzh', 'geodaten', 'geoportal', 'bar']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-06-03T01:18:54.564142`
