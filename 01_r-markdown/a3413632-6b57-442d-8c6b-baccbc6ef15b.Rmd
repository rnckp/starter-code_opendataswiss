...
- **Keywords.de** `['geodaten', 'trinken', 'sachdaten', 'vektordaten', 'gastronomie', 'essen', 'stzh', 'standort', 'gastro', 'punktdaten', 'geoportal', 'adressen', 'bar', 'ausgang']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-06-30T01:25:22.461930`
