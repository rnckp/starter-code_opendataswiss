...
- **Keywords.de** `['standort', 'stzh', 'essen', 'vektordaten', 'adressen', 'ausgang', 'punktdaten', 'sachdaten', 'bar', 'trinken', 'geoportal', 'gastronomie', 'geodaten', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-04-18T01:16:46.605921`
