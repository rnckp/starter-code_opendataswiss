...
- **Keywords.de** `['standort', 'trinken', 'vektordaten', 'essen', 'gastronomie', 'bar', 'ausgang', 'geoportal', 'geodaten', 'stzh', 'gastro', 'punktdaten', 'sachdaten', 'adressen']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-05-12T01:25:39.626366`
