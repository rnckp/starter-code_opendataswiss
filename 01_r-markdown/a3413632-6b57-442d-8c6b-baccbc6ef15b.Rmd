...
- **Keywords.de** `['punktdaten', 'essen', 'standort', 'bar', 'stzh', 'ausgang', 'adressen', 'sachdaten', 'gastronomie', 'gastro', 'vektordaten', 'geoportal', 'trinken', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-04-17T01:17:21.793333`
