...
- **Keywords.de** `['geoportal', 'essen', 'sachdaten', 'bar', 'adressen', 'gastronomie', 'vektordaten', 'gastro', 'trinken', 'ausgang', 'punktdaten', 'standort', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-07-26T01:47:53.118769`
