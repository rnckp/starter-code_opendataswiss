...
- **Keywords.de** `['geoportal', 'trinken', 'essen', 'stzh', 'bar', 'adressen', 'geodaten', 'punktdaten', 'sachdaten', 'standort', 'vektordaten', 'gastronomie', 'ausgang', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-08-26T01:16:59.219051`
