...
- **Keywords.de** `['stzh', 'essen', 'geodaten', 'standort', 'gastro', 'vektordaten', 'sachdaten', 'geoportal', 'adressen', 'punktdaten', 'gastronomie', 'ausgang', 'trinken', 'bar']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-02-09T01:09:30.327951`
