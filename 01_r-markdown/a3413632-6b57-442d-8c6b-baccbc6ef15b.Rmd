...
- **Keywords.de** `['gastronomie', 'geoportal', 'adressen', 'sachdaten', 'punktdaten', 'vektordaten', 'essen', 'geodaten', 'ausgang', 'bar', 'standort', 'stzh', 'gastro', 'trinken']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-02-28T01:00:02.338892`
