...
- **Keywords.de** `['sachdaten', 'punktdaten', 'gastronomie', 'standort', 'trinken', 'adressen', 'geoportal', 'geodaten', 'stzh', 'vektordaten', 'gastro', 'essen', 'bar', 'ausgang']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-06-09T01:19:40.120162`
