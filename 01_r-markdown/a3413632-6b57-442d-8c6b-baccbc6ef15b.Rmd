...
- **Keywords.de** `['stzh', 'adressen', 'gastronomie', 'vektordaten', 'punktdaten', 'gastro', 'sachdaten', 'essen', 'bar', 'trinken', 'standort', 'ausgang', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-05-03T00:59:37.002072`
