...
- **Keywords.de** `['stzh', 'bar', 'geodaten', 'adressen', 'ausgang', 'gastronomie', 'essen', 'vektordaten', 'geoportal', 'trinken', 'punktdaten', 'standort', 'sachdaten', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-04-16T01:02:13.503669`
