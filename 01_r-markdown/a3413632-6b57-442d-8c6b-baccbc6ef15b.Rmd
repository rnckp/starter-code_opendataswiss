...
- **Keywords.de** `['essen', 'standort', 'stzh', 'ausgang', 'sachdaten', 'geoportal', 'adressen', 'geodaten', 'gastro', 'punktdaten', 'trinken', 'gastronomie', 'vektordaten', 'bar']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-02-16T01:17:16.234082`
