...
- **Keywords.de** `['adressen', 'sachdaten', 'geodaten', 'stzh', 'standort', 'vektordaten', 'trinken', 'bar', 'geoportal', 'ausgang', 'essen', 'punktdaten', 'gastronomie', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-10-23T01:58:57.645261`
