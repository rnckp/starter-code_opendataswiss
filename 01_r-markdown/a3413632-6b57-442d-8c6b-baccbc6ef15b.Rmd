...
- **Keywords.de** `['punktdaten', 'vektordaten', 'geoportal', 'bar', 'trinken', 'ausgang', 'standort', 'gastronomie', 'adressen', 'stzh', 'geodaten', 'essen', 'sachdaten', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-05-18T01:26:51.490823`
