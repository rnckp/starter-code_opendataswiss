...
- **Keywords.de** `['stzh', 'ausgang', 'vektordaten', 'geoportal', 'bar', 'trinken', 'adressen', 'sachdaten', 'geodaten', 'essen', 'gastronomie', 'gastro', 'punktdaten', 'standort']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-05-16T01:02:55.199974`
