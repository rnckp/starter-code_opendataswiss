...
- **Keywords.de** `['geodaten', 'sachdaten', 'gastronomie', 'trinken', 'punktdaten', 'bar', 'stzh', 'ausgang', 'geoportal', 'vektordaten', 'essen', 'standort', 'adressen', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-04-14T01:00:48.444816`
