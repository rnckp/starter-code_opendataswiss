...
- **Keywords.de** `['trinken', 'sachdaten', 'geoportal', 'geodaten', 'punktdaten', 'ausgang', 'vektordaten', 'adressen', 'standort', 'essen', 'gastronomie', 'bar', 'gastro', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-04-26T01:19:05.271546`
