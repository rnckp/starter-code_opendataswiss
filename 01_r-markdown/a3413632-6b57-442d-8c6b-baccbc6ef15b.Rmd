...
- **Keywords.de** `['trinken', 'essen', 'geodaten', 'bar', 'sachdaten', 'punktdaten', 'gastronomie', 'ausgang', 'adressen', 'standort', 'geoportal', 'stzh', 'gastro', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-06-26T01:45:43.095376`
