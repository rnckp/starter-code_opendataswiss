...
- **Keywords.de** `['trinken', 'bar', 'adressen', 'gastro', 'geoportal', 'vektordaten', 'standort', 'essen', 'punktdaten', 'gastronomie', 'geodaten', 'sachdaten', 'ausgang', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:08:35.620237`
- **Metadata_modified** `2023-10-26T01:24:53.583266`
