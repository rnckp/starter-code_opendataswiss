...
- **Keywords.de** `['pcr-test', 'covid-19-tests', 'pool-test', 'corona-virus', 'covid-19-falle', 'statistikdaten']`
- **Issued** `2023-03-02T00:00:00`
- **Metadata_created** `2023-03-15T01:53:08.399365`
- **Metadata_modified** `2024-08-08T03:38:22.809041`
...
df <- read_delim('https://data.bl.ch/api/v2/catalog/datasets/11960/exports/csv?use_labels=false')
