...
Auto-generated R starter code for the dataset opendata-BS-Publikationen@kanton-basel-stadt.
...
df <- read_delim('http://morpho.datalets.ch/kanton-basel-stadt-pdf-publikationen/data.csv')
