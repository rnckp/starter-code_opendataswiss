...
- **Keywords.de** `['hitze', 'wind', 'regendauer', 'niederschlag', 'global-strahlung', 'p_', 'meteo', 'lufttemperatur', 'feuchte', 'luftdruck', 'wetter', 'tabelle', 'messwerte', 'temperatur', 'windgeschwindigkeit', 't_', 'wv', 'echtzeit', 'sachdaten', 'luft', 'hr', 'luftfeuchte', 'umweltdaten', 'windrichtung', 'zeitreihe', 'kalte', 'regen', 'wd']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-04-23T01:07:23.460622`
