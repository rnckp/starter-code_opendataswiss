...
- **Keywords.de** `['feuchte', 'umweltdaten', 'regendauer', 'hitze', 'echtzeit', 'lufttemperatur', 'luft', 'wind', 'temperatur', 'global-strahlung', 'niederschlag', 'meteo', 'p_', 'kalte', 'luftfeuchte', 'wetter', 'sachdaten', 'messwerte', 'zeitreihe', 'windrichtung', 'tabelle', 'wd', 'wv', 'luftdruck', 'hr', 't_', 'windgeschwindigkeit', 'regen']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-02-18T01:16:08.327763`
