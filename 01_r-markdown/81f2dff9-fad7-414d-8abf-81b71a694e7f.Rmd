...
- **Keywords.de** `['wetter', 'feuchte', 'luftdruck', 'tabelle', 'sachdaten', 'hitze', 'lufttemperatur', 'windrichtung', 'meteo', 'niederschlag', 'temperatur', 'messwerte', 'wd', 'wv', 'kalte', 'wind', 'hr', 'global-strahlung', 'luftfeuchte', 'zeitreihe', 'luft', 't_', 'windgeschwindigkeit', 'regen', 'p_', 'regendauer', 'umweltdaten', 'echtzeit']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-03-11T01:08:57.895312`
