...
- **Keywords.de** `['regen', 'tabelle', 'luft', 'luftfeuchte', 'niederschlag', 'wind', 'feuchte', 'meteo', 'temperatur', 'zeitreihe', 'wetter', 'messwerte', 'sachdaten', 'wd', 'global-strahlung', 'luftdruck', 'lufttemperatur', 'regendauer', 'windgeschwindigkeit', 'hitze', 'windrichtung', 'wv', 'kalte', 'p_', 't_', 'hr', 'umweltdaten', 'echtzeit']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-03-05T01:13:15.572782`
