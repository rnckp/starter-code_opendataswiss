...
- **Keywords.de** `['regendauer', 'hr', 'messwerte', 'meteo', 'p_', 't_', 'lufttemperatur', 'umweltdaten', 'luftfeuchte', 'global-strahlung', 'zeitreihe', 'wd', 'wv', 'hitze', 'windrichtung', 'tabelle', 'temperatur', 'echtzeit', 'sachdaten', 'wetter', 'luftdruck', 'kalte', 'luft', 'regen', 'windgeschwindigkeit', 'feuchte', 'niederschlag', 'wind']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-04-30T01:20:17.996197`
