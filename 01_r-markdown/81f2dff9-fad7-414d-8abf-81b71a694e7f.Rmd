...
- **Keywords.de** `['global-strahlung', 'umweltdaten', 'echtzeit', 'tabelle', 'regendauer', 'luftdruck', 'messwerte', 'meteo', 'p_', 'feuchte', 'lufttemperatur', 'luft', 'hitze', 't_', 'wetter', 'wd', 'luftfeuchte', 'zeitreihe', 'wv', 'temperatur', 'regen', 'windrichtung', 'hr', 'sachdaten', 'niederschlag', 'wind', 'kalte', 'windgeschwindigkeit']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-02-17T01:07:11.638546`
