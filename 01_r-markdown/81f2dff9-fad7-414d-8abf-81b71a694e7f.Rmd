...
- **Keywords.de** `['echtzeit', 'windrichtung', 'regen', 'luftfeuchte', 'windgeschwindigkeit', 'tabelle', 'luftdruck', 'messwerte', 'temperatur', 'niederschlag', 'wind', 'regendauer', 'p_', 'lufttemperatur', 'zeitreihe', 'hitze', 'wv', 'umweltdaten', 'feuchte', 'meteo', 'luft', 'wetter', 'wd', 't_', 'kalte', 'sachdaten', 'global-strahlung', 'hr']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-05-06T01:14:59.903408`
