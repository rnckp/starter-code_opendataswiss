...
- **Keywords.de** `['kalte', 'windrichtung', 'zeitreihe', 'umweltdaten', 'regendauer', 'global-strahlung', 'luftdruck', 'windgeschwindigkeit', 'wetter', 'luft', 'feuchte', 'meteo', 'messwerte', 'regen', 'p_', 'echtzeit', 'wv', 'hitze', 't_', 'wd', 'luftfeuchte', 'temperatur', 'lufttemperatur', 'hr', 'sachdaten', 'wind', 'niederschlag', 'tabelle']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-02-03T01:05:50.807683`
