...
- **Keywords.de** `['p_', 'wd', 'echtzeit', 'windgeschwindigkeit', 'meteo', 'niederschlag', 'luftdruck', 'global-strahlung', 'sachdaten', 'luftfeuchte', 'hr', 'regendauer', 'wetter', 'tabelle', 'feuchte', 'kalte', 'messwerte', 'luft', 'wv', 't_', 'windrichtung', 'regen', 'temperatur', 'hitze', 'wind', 'umweltdaten', 'zeitreihe', 'lufttemperatur']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-01-31T00:59:28.545862`
