...
- **Keywords.de** `['kalte', 'hr', 'p_', 'meteo', 'wetter', 'global-strahlung', 'echtzeit', 'niederschlag', 'lufttemperatur', 'tabelle', 'sachdaten', 'temperatur', 'wd', 'windgeschwindigkeit', 'umweltdaten', 'windrichtung', 'regendauer', 'luft', 'luftfeuchte', 'feuchte', 'regen', 'wind', 'hitze', 'wv', 'messwerte', 'zeitreihe', 't_', 'luftdruck']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-05-11T01:18:14.423609`
