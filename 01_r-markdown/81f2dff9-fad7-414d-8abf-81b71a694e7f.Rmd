...
- **Keywords.de** `['sachdaten', 'feuchte', 'wetter', 'wv', 'lufttemperatur', 'kalte', 'temperatur', 'luft', 'umweltdaten', 'windrichtung', 'niederschlag', 'wind', 'p_', 'wd', 'global-strahlung', 'hr', 'luftfeuchte', 'hitze', 'zeitreihe', 'luftdruck', 'tabelle', 'echtzeit', 'windgeschwindigkeit', 'regendauer', 't_', 'meteo', 'regen', 'messwerte']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-04-24T01:03:46.369973`
