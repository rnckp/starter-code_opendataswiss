...
- **Keywords.de** `['luftdruck', 'regen', 'p_', 'global-strahlung', 'meteo', 'zeitreihe', 'wv', 'tabelle', 'regendauer', 'windgeschwindigkeit', 'wind', 'niederschlag', 'feuchte', 'lufttemperatur', 'umweltdaten', 'windrichtung', 'wd', 'wetter', 't_', 'luft', 'temperatur', 'hr', 'messwerte', 'echtzeit', 'hitze', 'kalte', 'sachdaten', 'luftfeuchte']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-02-26T01:45:48.706069`
