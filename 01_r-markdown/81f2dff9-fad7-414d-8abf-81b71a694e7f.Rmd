...
- **Keywords.de** `['t_', 'messwerte', 'echtzeit', 'windgeschwindigkeit', 'luftdruck', 'wind', 'meteo', 'tabelle', 'regendauer', 'niederschlag', 'kalte', 'global-strahlung', 'umweltdaten', 'p_', 'lufttemperatur', 'windrichtung', 'wv', 'hr', 'sachdaten', 'temperatur', 'feuchte', 'zeitreihe', 'hitze', 'wd', 'regen', 'luftfeuchte', 'wetter', 'luft']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-03-06T01:06:14.605892`
