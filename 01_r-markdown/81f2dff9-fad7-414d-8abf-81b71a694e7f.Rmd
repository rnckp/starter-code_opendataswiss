...
- **Keywords.de** `['temperatur', 'kalte', 'feuchte', 'luftdruck', 'windgeschwindigkeit', 'sachdaten', 'lufttemperatur', 'niederschlag', 'global-strahlung', 'regen', 'wd', 'p_', 'regendauer', 'wv', 'wetter', 'windrichtung', 'wind', 'meteo', 'zeitreihe', 'luft', 'luftfeuchte', 'messwerte', 'hitze', 'umweltdaten', 'tabelle', 'hr', 'echtzeit', 't_']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-01-19T01:29:12.308861`
