...
- **Keywords.de** `['global-strahlung', 'lufttemperatur', 'hr', 'wind', 'meteo', 'luftdruck', 'regen', 'tabelle', 'hitze', 'wv', 'sachdaten', 'zeitreihe', 'p_', 'niederschlag', 'windrichtung', 'regendauer', 'umweltdaten', 'windgeschwindigkeit', 'temperatur', 'luftfeuchte', 'wetter', 'wd', 't_', 'luft', 'feuchte', 'messwerte', 'echtzeit', 'kalte']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-03-23T01:06:07.741797`
