...
- **Keywords.de** `['feuchte', 'wetter', 'p_', 'wind', 'hitze', 'umweltdaten', 'zeitreihe', 'regendauer', 'windgeschwindigkeit', 'hr', 'niederschlag', 'wd', 'meteo', 'echtzeit', 'messwerte', 'temperatur', 'luft', 'windrichtung', 'kalte', 't_', 'luftdruck', 'lufttemperatur', 'wv', 'sachdaten', 'regen', 'luftfeuchte', 'tabelle', 'global-strahlung']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-04-25T01:15:18.566053`
