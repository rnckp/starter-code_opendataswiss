...
- **Keywords.de** `['lufttemperatur', 'temperatur', 'luft', 'windrichtung', 'p_', 'luftfeuchte', 'windgeschwindigkeit', 'hitze', 'sachdaten', 'hr', 'wd', 'global-strahlung', 'luftdruck', 'meteo', 't_', 'niederschlag', 'feuchte', 'umweltdaten', 'wv', 'zeitreihe', 'messwerte', 'wetter', 'kalte', 'regendauer', 'wind', 'regen', 'tabelle', 'echtzeit']`
- **Issued** `nan`
- **Metadata_created** `2022-12-20T00:47:52.287831`
- **Metadata_modified** `2023-01-25T01:07:40.439167`
