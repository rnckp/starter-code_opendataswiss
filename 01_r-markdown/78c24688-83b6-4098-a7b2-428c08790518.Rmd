...
- **Keywords.de** `['passanten', 'langsamverkehr', 'zahlstellen', 'fussverkehr', 'fussganger', 'zahlung', 'verkehr']`
- **Issued** `2021-06-21T00:00:00`
- **Metadata_created** `2023-12-21T12:48:18.962051`
- **Metadata_modified** `2024-04-26T05:00:39.961420`
...
df <- read_delim('https://daten.stadt.sg.ch/api/v2/catalog/datasets/fussgangerzahlungen-stadt-stgallen-temporare-und-periodische-zahlungen/exports/csv')
