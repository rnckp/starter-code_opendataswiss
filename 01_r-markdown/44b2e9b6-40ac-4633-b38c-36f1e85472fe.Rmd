...
- **Keywords.de** `['polygondaten', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'klarwerk', 'geoportal', 'stzh', 'holzheizkraftwerk', 'geodaten', 'energieplankarte', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'heizen', 'energieversorgung', 'netto-null', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'kalteversorgung', 'energie', 'energieplanung', 'vektordaten', 'punktdaten', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-04-07T04:30:43.563174`
