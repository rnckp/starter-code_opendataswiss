...
- **Keywords.de** `['kalteversorgung', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'punktdaten', 'erneuerbar-heizen', 'energie', 'klarwerk', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'kehrichtheizkraftwerk', 'liniendaten', 'energieplankarte', 'netto-null', 'stzh', 'fernwarmeversorgung', 'warmeversorgung', 'heizen', 'holzheizkraftwerk', 'vektordaten', 'geoportal', 'polygondaten', 'geodaten', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-12T03:12:44.584592`
