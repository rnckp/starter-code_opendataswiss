...
- **Keywords.de** `['erneuerbar-heizen', 'fernwarme', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'energie', 'holzheizkraftwerk', 'polygondaten', 'warmeversorgung', 'heizen', 'liniendaten', 'kalteversorgung', 'geoportal', 'energieversorgung', 'energieplanung', 'energieplankarte', 'klarwerk', 'punktdaten', 'netto-null', 'kehrichtheizkraftwerk', 'geodaten', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-08T04:46:10.639737`
