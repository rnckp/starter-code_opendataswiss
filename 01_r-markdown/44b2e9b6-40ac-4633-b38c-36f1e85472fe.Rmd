...
- **Keywords.de** `['energie', 'fernwarme', 'polygondaten', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'heizen', 'kehrichtheizkraftwerk', 'stzh', 'geodaten', 'vektordaten', 'warmeversorgung', 'geoportal', 'energieplankarte', 'liniendaten', 'fernwarmeversorgung', 'klarwerk', 'energieplanung', 'energieversorgung', 'punktdaten', 'kalteversorgung', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-14T02:41:07.982413`
