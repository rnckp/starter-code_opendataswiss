...
- **Keywords.de** `['erneuerbar-heizen', 'geoportal', 'vektordaten', 'energieplankarte', 'liniendaten', 'kehrichtheizkraftwerk', 'heizen', 'energieplanung', 'warmeversorgung', 'geodaten', 'punktdaten', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'stzh', 'fernwarme', 'klarwerk', 'energie', 'energieversorgung', 'fernwarmeversorgung', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'netto-null', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-28T03:09:48.356767`
