...
- **Keywords.de** `['energieplankarte', 'fernwarme', 'kehrichtheizkraftwerk', 'netto-null', 'heizen', 'erneuerbar-heizen', 'fernwarmeversorgung', 'stzh', 'warmeversorgung', 'vektordaten', 'polygondaten', 'holzheizkraftwerk', 'geodaten', 'energie', 'kalteversorgung', 'punktdaten', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'geoportal', 'energieplanung', 'energieversorgung', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-28T04:05:16.049687`
