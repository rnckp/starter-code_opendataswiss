...
- **Keywords.de** `['klarwerk', 'polygondaten', 'liniendaten', 'fernwarme', 'stzh', 'energieplanung', 'energieplankarte', 'geoportal', 'holzheizkraftwerk', 'punktdaten', 'erneuerbar-heizen', 'warmeversorgung', 'netto-null', 'energie', 'geodaten', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'heizen', 'energieversorgung', 'kalteversorgung', 'kehrichtheizkraftwerk', 'vektordaten', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-15T03:08:25.115767`
