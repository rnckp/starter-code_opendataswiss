...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'klarwerk', 'energie', 'fernwarme', 'holzheizkraftwerk', 'energieplankarte', 'liniendaten', 'energieplanung', 'polygondaten', 'fernwarmeversorgung', 'netto-null', 'kalteversorgung', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'kehrichtheizkraftwerk', 'heizen', 'geoportal', 'vektordaten', 'energieversorgung', 'stzh', 'erneuerbar-heizen', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-19T02:51:11.432254`
