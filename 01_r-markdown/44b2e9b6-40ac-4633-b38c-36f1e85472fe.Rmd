...
- **Keywords.de** `['netto-null', 'holzheizkraftwerk', 'liniendaten', 'vektordaten', 'polygondaten', 'kalteversorgung', 'fernwarme', 'stzh', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'energie', 'leitungsgebundene-energieversorgung', 'geoportal', 'punktdaten', 'geodaten', 'fernwarmeversorgung', 'energieplankarte', 'erneuerbar-heizen', 'energieplanung', 'kehrichtheizkraftwerk', 'energieversorgung', 'klarwerk', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-13T02:54:05.621507`
