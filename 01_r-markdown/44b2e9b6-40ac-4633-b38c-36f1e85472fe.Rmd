...
- **Keywords.de** `['holzheizkraftwerk', 'energieplankarte', 'liniendaten', 'klarwerk', 'fernwarmeversorgung', 'vektordaten', 'geodaten', 'punktdaten', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'kalteversorgung', 'netto-null', 'fernwarme', 'geoportal', 'polygondaten', 'energie', 'kehrichtheizkraftwerk', 'stzh', 'heizen', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-01T02:47:31.926390`
