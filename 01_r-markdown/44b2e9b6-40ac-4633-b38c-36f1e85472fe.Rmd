...
- **Keywords.de** `['klarwerk', 'holzheizkraftwerk', 'energieplankarte', 'kehrichtheizkraftwerk', 'geodaten', 'erneuerbar-heizen', 'heizen', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'vektordaten', 'netto-null', 'geoportal', 'polygondaten', 'fernwarme', 'punktdaten', 'stzh', 'leitungsgebundene-energieversorgung', 'energieplanung', 'warmeversorgung', 'fernwarmeversorgung', 'energieversorgung', 'energie', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-07T03:43:15.383937`
