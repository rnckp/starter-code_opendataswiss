...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'energieplankarte', 'erneuerbar-heizen', 'fernwarmeversorgung', 'energieplanung', 'stzh', 'fernwarme', 'netto-null', 'heizen', 'liniendaten', 'vektordaten', 'punktdaten', 'energieversorgung', 'polygondaten', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'energie', 'geoportal', 'geodaten', 'warmeversorgung', 'kalteversorgung', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-03T03:07:58.145709`
