...
- **Keywords.de** `['klarwerk', 'warmeversorgung', 'polygondaten', 'netto-null', 'geoportal', 'heizen', 'erneuerbar-heizen', 'liniendaten', 'energieplankarte', 'stzh', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'vektordaten', 'fernwarme', 'kehrichtheizkraftwerk', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'geodaten', 'energie', 'punktdaten', 'holzheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-14T03:00:23.424731`
