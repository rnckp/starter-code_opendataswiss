...
- **Keywords.de** `['fernwarmeversorgung', 'punktdaten', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'energieplankarte', 'fernwarme', 'polygondaten', 'erneuerbar-heizen', 'stzh', 'energieplanung', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'heizen', 'geodaten', 'netto-null', 'holzheizkraftwerk', 'warmeversorgung', 'energie', 'energieversorgung', 'geoportal', 'klarwerk', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-18T03:38:06.546946`
