...
- **Keywords.de** `['liniendaten', 'kehrichtheizkraftwerk', 'stzh', 'netto-null', 'leitungsgebundene-energieversorgung', 'klarwerk', 'energieversorgung', 'warmeversorgung', 'polygondaten', 'punktdaten', 'energieplankarte', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'geodaten', 'kalteversorgung', 'energieplanung', 'fernwarme', 'vektordaten', 'fernwarmeversorgung', 'geoportal', 'energie', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-02T03:20:02.687650`
