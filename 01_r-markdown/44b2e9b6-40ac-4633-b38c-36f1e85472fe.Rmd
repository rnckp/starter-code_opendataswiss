...
- **Keywords.de** `['holzheizkraftwerk', 'energie', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'geoportal', 'vektordaten', 'erneuerbar-heizen', 'energieversorgung', 'kehrichtheizkraftwerk', 'polygondaten', 'stzh', 'klarwerk', 'warmeversorgung', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'punktdaten', 'liniendaten', 'netto-null', 'geodaten', 'fernwarmeversorgung', 'heizen', 'fernwarme', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-10T03:36:09.003119`
