...
- **Keywords.de** `['kehrichtheizkraftwerk', 'holzheizkraftwerk', 'geodaten', 'geoportal', 'erneuerbar-heizen', 'polygondaten', 'vektordaten', 'energieplanung', 'heizen', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'fernwarme', 'kalteversorgung', 'netto-null', 'fernwarmeversorgung', 'punktdaten', 'leitungsgebundene-energieversorgung', 'energie', 'energieversorgung', 'stzh', 'warmeversorgung', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-16T03:04:49.384187`
