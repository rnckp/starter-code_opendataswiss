...
- **Keywords.de** `['energie', 'netto-null', 'energieplanung', 'warmeversorgung', 'erneuerbar-heizen', 'geoportal', 'fernwarme', 'fernwarmeversorgung', 'klarwerk', 'geodaten', 'liniendaten', 'energieversorgung', 'vektordaten', 'heizen', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'holzheizkraftwerk', 'polygondaten', 'energieplankarte', 'punktdaten', 'stzh', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-15T02:38:46.453476`
