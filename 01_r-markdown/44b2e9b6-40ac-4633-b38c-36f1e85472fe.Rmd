...
- **Keywords.de** `['punktdaten', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'fernwarmeversorgung', 'energieplankarte', 'liniendaten', 'leitungsgebundene-energieversorgung', 'netto-null', 'heizen', 'klarwerk', 'energieversorgung', 'kalteversorgung', 'geoportal', 'geodaten', 'holzheizkraftwerk', 'energieplanung', 'stzh', 'kehrichtheizkraftwerk', 'polygondaten', 'erneuerbar-heizen', 'fernwarme', 'energie', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-06T02:52:54.992905`
