...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'klarwerk', 'kalteversorgung', 'energieversorgung', 'liniendaten', 'punktdaten', 'energieplankarte', 'warmeversorgung', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'netto-null', 'kehrichtheizkraftwerk', 'heizen', 'fernwarme', 'erneuerbar-heizen', 'energieplanung', 'stzh', 'energie', 'geodaten', 'fernwarmeversorgung', 'geoportal', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-25T03:44:08.362521`
