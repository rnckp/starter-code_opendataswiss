...
- **Keywords.de** `['stzh', 'energieversorgung', 'geoportal', 'holzheizkraftwerk', 'punktdaten', 'energie', 'polygondaten', 'netto-null', 'heizen', 'vektordaten', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'energieplankarte', 'warmeversorgung', 'fernwarmeversorgung', 'liniendaten', 'klarwerk', 'kalteversorgung', 'geodaten', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energieplanung', 'energie-aus-gereinigtem-abwasser']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-18T03:17:19.942634`
