...
- **Keywords.de** `['heizen', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'vektordaten', 'klarwerk', 'fernwarme', 'erneuerbar-heizen', 'energie', 'punktdaten', 'netto-null', 'geoportal', 'polygondaten', 'energieplanung', 'liniendaten', 'fernwarmeversorgung', 'geodaten', 'stzh', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'kalteversorgung', 'energieversorgung', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-26T03:22:52.935104`
