...
- **Keywords.de** `['fernwarme', 'energieplankarte', 'klarwerk', 'kehrichtheizkraftwerk', 'vektordaten', 'fernwarmeversorgung', 'stzh', 'liniendaten', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'kalteversorgung', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'geodaten', 'holzheizkraftwerk', 'polygondaten', 'energie', 'netto-null', 'geoportal', 'energieplanung', 'heizen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-30T08:42:24.850845`
