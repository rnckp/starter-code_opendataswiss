...
- **Keywords.de** `['erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'heizen', 'geodaten', 'liniendaten', 'punktdaten', 'energieversorgung', 'vektordaten', 'polygondaten', 'stzh', 'fernwarmeversorgung', 'energie', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'netto-null', 'energieplanung', 'kehrichtheizkraftwerk', 'fernwarme', 'warmeversorgung', 'klarwerk', 'holzheizkraftwerk', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-04-01T04:13:58.831737`
