...
- **Keywords.de** `['warmeversorgung', 'energieplanung', 'kehrichtheizkraftwerk', 'punktdaten', 'vektordaten', 'stzh', 'energieversorgung', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'heizen', 'netto-null', 'polygondaten', 'energie', 'klarwerk', 'liniendaten', 'geodaten', 'fernwarmeversorgung', 'fernwarme', 'kalteversorgung', 'erneuerbar-heizen', 'geoportal', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-14T03:16:43.993473`
