...
- **Keywords.de** `['punktdaten', 'energieversorgung', 'erneuerbar-heizen', 'heizen', 'klarwerk', 'kalteversorgung', 'polygondaten', 'fernwarmeversorgung', 'energie', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'geodaten', 'energieplanung', 'stzh', 'kehrichtheizkraftwerk', 'energieplankarte', 'geoportal', 'netto-null', 'vektordaten', 'warmeversorgung', 'holzheizkraftwerk', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-22T05:18:10.947488`
