...
- **Keywords.de** `['fernwarmeversorgung', 'warmeversorgung', 'liniendaten', 'vektordaten', 'erneuerbar-heizen', 'kalteversorgung', 'geodaten', 'punktdaten', 'heizen', 'energieplankarte', 'energie', 'energieplanung', 'leitungsgebundene-energieversorgung', 'polygondaten', 'klarwerk', 'holzheizkraftwerk', 'geoportal', 'kehrichtheizkraftwerk', 'stzh', 'fernwarme', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-04T02:58:24.749501`
