...
- **Keywords.de** `['netto-null', 'vektordaten', 'fernwarme', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'kehrichtheizkraftwerk', 'geoportal', 'energieplanung', 'leitungsgebundene-energieversorgung', 'stzh', 'energieplankarte', 'holzheizkraftwerk', 'klarwerk', 'energieversorgung', 'liniendaten', 'polygondaten', 'punktdaten', 'warmeversorgung', 'fernwarmeversorgung', 'erneuerbar-heizen', 'heizen', 'kalteversorgung', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-04-04T04:06:03.970208`
