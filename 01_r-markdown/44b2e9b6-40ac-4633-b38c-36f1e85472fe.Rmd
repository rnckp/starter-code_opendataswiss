...
- **Keywords.de** `['energieversorgung', 'geoportal', 'fernwarme', 'polygondaten', 'kehrichtheizkraftwerk', 'kalteversorgung', 'erneuerbar-heizen', 'vektordaten', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'geodaten', 'holzheizkraftwerk', 'energieplanung', 'netto-null', 'heizen', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'energie', 'punktdaten', 'liniendaten', 'stzh', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-11T03:17:40.894506`
