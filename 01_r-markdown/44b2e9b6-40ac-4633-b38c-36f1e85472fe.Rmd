...
- **Keywords.de** `['vektordaten', 'liniendaten', 'kehrichtheizkraftwerk', 'fernwarme', 'polygondaten', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'energie', 'holzheizkraftwerk', 'erneuerbar-heizen', 'netto-null', 'stzh', 'kalteversorgung', 'fernwarmeversorgung', 'geoportal', 'energieplankarte', 'punktdaten', 'geodaten', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'heizen', 'energieplanung', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-31T03:47:17.073245`
