...
- **Keywords.de** `['geodaten', 'leitungsgebundene-energieversorgung', 'stzh', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'energieplankarte', 'polygondaten', 'punktdaten', 'vektordaten', 'liniendaten', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'kalteversorgung', 'energieversorgung', 'heizen', 'warmeversorgung', 'holzheizkraftwerk', 'energieplanung', 'energie', 'fernwarme', 'erneuerbar-heizen', 'klarwerk', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-25T03:28:39.478152`
