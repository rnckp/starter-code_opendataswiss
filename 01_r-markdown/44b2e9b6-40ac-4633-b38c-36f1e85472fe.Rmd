...
- **Keywords.de** `['energieplankarte', 'geoportal', 'fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'heizen', 'punktdaten', 'energieplanung', 'klarwerk', 'polygondaten', 'erneuerbar-heizen', 'energieversorgung', 'geodaten', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'energie', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'stzh', 'fernwarme', 'kalteversorgung', 'liniendaten', 'warmeversorgung', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-09T02:33:29.202152`
