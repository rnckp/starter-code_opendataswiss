...
- **Keywords.de** `['energieplanung', 'netto-null', 'kalteversorgung', 'liniendaten', 'warmeversorgung', 'kehrichtheizkraftwerk', 'energie', 'geoportal', 'erneuerbar-heizen', 'energieplankarte', 'fernwarmeversorgung', 'fernwarme', 'stzh', 'punktdaten', 'klarwerk', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'geodaten', 'heizen', 'polygondaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-04-03T04:59:55.635596`
