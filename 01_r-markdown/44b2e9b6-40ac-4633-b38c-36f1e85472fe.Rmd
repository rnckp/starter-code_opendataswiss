...
- **Keywords.de** `['polygondaten', 'erneuerbar-heizen', 'liniendaten', 'holzheizkraftwerk', 'stzh', 'warmeversorgung', 'kalteversorgung', 'energieversorgung', 'energieplankarte', 'kehrichtheizkraftwerk', 'netto-null', 'heizen', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'klarwerk', 'leitungsgebundene-energieversorgung', 'vektordaten', 'fernwarme', 'energieplanung', 'fernwarmeversorgung', 'energie', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-26T03:30:40.263150`
