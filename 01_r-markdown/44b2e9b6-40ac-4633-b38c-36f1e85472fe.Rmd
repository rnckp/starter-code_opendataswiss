...
- **Keywords.de** `['energieplanung', 'energieversorgung', 'punktdaten', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'vektordaten', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'heizen', 'netto-null', 'liniendaten', 'kalteversorgung', 'polygondaten', 'kehrichtheizkraftwerk', 'geoportal', 'holzheizkraftwerk', 'stzh', 'fernwarmeversorgung', 'geodaten', 'energie', 'erneuerbar-heizen', 'energieplankarte', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-25T03:23:32.675338`
