...
- **Keywords.de** `['fernwarmeversorgung', 'polygondaten', 'erneuerbar-heizen', 'fernwarme', 'klarwerk', 'energieversorgung', 'heizen', 'energieplanung', 'punktdaten', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'warmeversorgung', 'energie', 'vektordaten', 'netto-null', 'geoportal', 'kehrichtheizkraftwerk', 'liniendaten', 'stzh', 'kalteversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-06T05:57:59.128721`
