...
- **Keywords.de** `['punktdaten', 'warmeversorgung', 'erneuerbar-heizen', 'vektordaten', 'polygondaten', 'heizen', 'holzheizkraftwerk', 'geodaten', 'geoportal', 'stzh', 'energieplanung', 'energieplankarte', 'fernwarme', 'fernwarmeversorgung', 'netto-null', 'kehrichtheizkraftwerk', 'klarwerk', 'leitungsgebundene-energieversorgung', 'energie-aus-gereinigtem-abwasser', 'energie', 'liniendaten', 'kalteversorgung', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-23T03:07:02.932725`
