...
- **Keywords.de** `['energieplanung', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'geodaten', 'polygondaten', 'vektordaten', 'geoportal', 'fernwarme', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'heizen', 'energie', 'stzh', 'energieplankarte', 'fernwarmeversorgung', 'netto-null', 'punktdaten', 'warmeversorgung', 'liniendaten', 'klarwerk', 'kalteversorgung', 'energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-09T02:30:59.193359`
