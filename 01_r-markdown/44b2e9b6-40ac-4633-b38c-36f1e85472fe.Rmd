...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'geodaten', 'holzheizkraftwerk', 'punktdaten', 'netto-null', 'klarwerk', 'energie', 'polygondaten', 'liniendaten', 'stzh', 'heizen', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'geoportal', 'erneuerbar-heizen', 'energieplankarte', 'energieplanung', 'fernwarme', 'fernwarmeversorgung', 'kalteversorgung', 'kehrichtheizkraftwerk', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-03T03:20:13.298851`
