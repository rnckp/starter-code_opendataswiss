...
- **Keywords.de** `['liniendaten', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'stzh', 'energieplanung', 'energie', 'fernwarme', 'kalteversorgung', 'kehrichtheizkraftwerk', 'vektordaten', 'geodaten', 'netto-null', 'geoportal', 'energieplankarte', 'heizen', 'polygondaten', 'klarwerk', 'warmeversorgung', 'energieversorgung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-16T02:56:57.568820`
