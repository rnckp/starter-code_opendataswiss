...
- **Keywords.de** `['fernwarme', 'warmeversorgung', 'fernwarmeversorgung', 'holzheizkraftwerk', 'liniendaten', 'energieplankarte', 'energie', 'heizen', 'erneuerbar-heizen', 'vektordaten', 'stzh', 'geodaten', 'leitungsgebundene-energieversorgung', 'netto-null', 'polygondaten', 'klarwerk', 'geoportal', 'kehrichtheizkraftwerk', 'energieversorgung', 'kalteversorgung', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-12T03:30:58.083114`
