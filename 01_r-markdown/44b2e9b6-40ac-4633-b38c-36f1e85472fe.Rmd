...
- **Keywords.de** `['punktdaten', 'stzh', 'heizen', 'energie', 'klarwerk', 'energieplankarte', 'netto-null', 'geodaten', 'liniendaten', 'vektordaten', 'leitungsgebundene-energieversorgung', 'fernwarme', 'energieplanung', 'erneuerbar-heizen', 'polygondaten', 'energieversorgung', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'kehrichtheizkraftwerk', 'kalteversorgung', 'warmeversorgung', 'fernwarmeversorgung', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-22T02:54:14.699182`
