...
- **Keywords.de** `['holzheizkraftwerk', 'energieversorgung', 'energieplanung', 'stzh', 'vektordaten', 'kalteversorgung', 'fernwarmeversorgung', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'fernwarme', 'heizen', 'leitungsgebundene-energieversorgung', 'kehrichtheizkraftwerk', 'netto-null', 'klarwerk', 'liniendaten', 'erneuerbar-heizen', 'warmeversorgung', 'polygondaten', 'punktdaten', 'energieplankarte', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-23T02:49:51.797762`
