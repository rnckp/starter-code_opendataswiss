...
- **Keywords.de** `['kehrichtheizkraftwerk', 'erneuerbar-heizen', 'geodaten', 'vektordaten', 'geoportal', 'energieplanung', 'energieversorgung', 'energie', 'warmeversorgung', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'kalteversorgung', 'polygondaten', 'klarwerk', 'liniendaten', 'energieplankarte', 'holzheizkraftwerk', 'stzh', 'netto-null', 'heizen', 'leitungsgebundene-energieversorgung', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-29T04:17:18.183196`
