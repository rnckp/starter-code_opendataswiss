...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'polygondaten', 'erneuerbar-heizen', 'energieplankarte', 'energie-aus-gereinigtem-abwasser', 'netto-null', 'vektordaten', 'energieversorgung', 'klarwerk', 'energieplanung', 'punktdaten', 'fernwarme', 'liniendaten', 'geodaten', 'geoportal', 'stzh', 'fernwarmeversorgung', 'heizen', 'kehrichtheizkraftwerk', 'kalteversorgung', 'warmeversorgung', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-18T02:59:05.741691`
