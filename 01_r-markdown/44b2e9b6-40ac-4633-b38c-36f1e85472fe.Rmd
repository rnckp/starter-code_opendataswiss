...
- **Keywords.de** `['energieplankarte', 'holzheizkraftwerk', 'kalteversorgung', 'heizen', 'stzh', 'energieversorgung', 'geoportal', 'klarwerk', 'liniendaten', 'vektordaten', 'leitungsgebundene-energieversorgung', 'fernwarme', 'erneuerbar-heizen', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'energie', 'energieplanung', 'polygondaten', 'geodaten', 'kehrichtheizkraftwerk', 'netto-null', 'fernwarmeversorgung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-29T05:09:40.989504`
