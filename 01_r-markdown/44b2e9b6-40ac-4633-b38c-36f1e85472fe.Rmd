...
- **Keywords.de** `['holzheizkraftwerk', 'energieplankarte', 'kehrichtheizkraftwerk', 'klarwerk', 'erneuerbar-heizen', 'punktdaten', 'fernwarmeversorgung', 'energieplanung', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'fernwarme', 'kalteversorgung', 'geoportal', 'energieversorgung', 'heizen', 'energie', 'vektordaten', 'leitungsgebundene-energieversorgung', 'stzh', 'liniendaten', 'geodaten', 'netto-null']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-13T02:35:09.103686`
