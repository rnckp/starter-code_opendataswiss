...
- **Keywords.de** `['klarwerk', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'holzheizkraftwerk', 'erneuerbar-heizen', 'polygondaten', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'heizen', 'netto-null', 'geoportal', 'punktdaten', 'energieplanung', 'energieplankarte', 'stzh', 'vektordaten', 'energieversorgung', 'liniendaten', 'kehrichtheizkraftwerk', 'kalteversorgung', 'fernwarme', 'warmeversorgung', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-21T02:45:39.385824`
