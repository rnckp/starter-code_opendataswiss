...
- **Keywords.de** `['leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'fernwarmeversorgung', 'energie', 'energieversorgung', 'kehrichtheizkraftwerk', 'heizen', 'geodaten', 'fernwarme', 'geoportal', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'energieplankarte', 'kalteversorgung', 'punktdaten', 'vektordaten', 'holzheizkraftwerk', 'netto-null', 'stzh', 'energieplanung', 'liniendaten', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-29T03:22:08.326972`
