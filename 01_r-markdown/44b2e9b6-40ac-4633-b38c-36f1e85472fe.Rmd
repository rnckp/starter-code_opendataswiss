...
- **Keywords.de** `['warmeversorgung', 'netto-null', 'erneuerbar-heizen', 'heizen', 'geoportal', 'polygondaten', 'holzheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'energie', 'energieplanung', 'stzh', 'klarwerk', 'punktdaten', 'fernwarme', 'liniendaten', 'energieplankarte', 'fernwarmeversorgung', 'energieversorgung', 'geodaten', 'vektordaten', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-20T02:47:33.520178`
