...
- **Keywords.de** `['klarwerk', 'erneuerbar-heizen', 'punktdaten', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'heizen', 'fernwarmeversorgung', 'energie', 'kalteversorgung', 'stzh', 'vektordaten', 'netto-null', 'geodaten', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'liniendaten', 'kehrichtheizkraftwerk', 'fernwarme', 'energieplanung', 'geoportal', 'polygondaten', 'holzheizkraftwerk', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-14T05:17:50.085663`
