...
- **Keywords.de** `['energie', 'netto-null', 'energieplankarte', 'geoportal', 'kehrichtheizkraftwerk', 'energieplanung', 'kalteversorgung', 'fernwarmeversorgung', 'punktdaten', 'liniendaten', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'warmeversorgung', 'stzh', 'polygondaten', 'holzheizkraftwerk', 'vektordaten', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'klarwerk', 'energieversorgung', 'heizen', 'fernwarme']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-11T05:35:50.734765`
