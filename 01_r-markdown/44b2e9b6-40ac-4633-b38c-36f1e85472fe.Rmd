...
- **Keywords.de** `['energieversorgung', 'erneuerbar-heizen', 'geoportal', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'geodaten', 'stzh', 'energieplanung', 'fernwarme', 'kalteversorgung', 'punktdaten', 'vektordaten', 'klarwerk', 'liniendaten', 'kehrichtheizkraftwerk', 'warmeversorgung', 'fernwarmeversorgung', 'holzheizkraftwerk', 'energieplankarte', 'heizen', 'energie', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-22T02:54:52.270048`
