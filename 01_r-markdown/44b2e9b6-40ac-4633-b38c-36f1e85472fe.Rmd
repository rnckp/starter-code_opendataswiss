...
- **Keywords.de** `['punktdaten', 'energie', 'vektordaten', 'heizen', 'geoportal', 'geodaten', 'klarwerk', 'energieplankarte', 'stzh', 'holzheizkraftwerk', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'kehrichtheizkraftwerk', 'netto-null', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'energieplanung', 'polygondaten', 'fernwarme', 'erneuerbar-heizen', 'liniendaten', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-04-06T03:53:26.556839`
