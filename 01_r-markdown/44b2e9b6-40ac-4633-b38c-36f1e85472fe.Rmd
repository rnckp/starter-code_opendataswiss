...
- **Keywords.de** `['punktdaten', 'energieplankarte', 'vektordaten', 'holzheizkraftwerk', 'geodaten', 'netto-null', 'kehrichtheizkraftwerk', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'polygondaten', 'erneuerbar-heizen', 'leitungsgebundene-energieversorgung', 'fernwarmeversorgung', 'energie', 'stzh', 'heizen', 'klarwerk', 'fernwarme', 'geoportal', 'kalteversorgung', 'energieversorgung', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-20T03:45:06.588687`
