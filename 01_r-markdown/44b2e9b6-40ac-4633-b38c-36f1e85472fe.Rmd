...
- **Keywords.de** `['stzh', 'polygondaten', 'holzheizkraftwerk', 'energieplankarte', 'kehrichtheizkraftwerk', 'energieplanung', 'geodaten', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'heizen', 'punktdaten', 'fernwarme', 'fernwarmeversorgung', 'vektordaten', 'klarwerk', 'liniendaten', 'erneuerbar-heizen', 'kalteversorgung', 'leitungsgebundene-energieversorgung', 'warmeversorgung', 'netto-null', 'energieversorgung', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-30T03:29:21.578609`
