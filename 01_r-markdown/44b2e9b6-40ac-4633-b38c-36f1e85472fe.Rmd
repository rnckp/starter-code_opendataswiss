...
- **Keywords.de** `['warmeversorgung', 'netto-null', 'energieplanung', 'energie', 'energieversorgung', 'liniendaten', 'fernwarmeversorgung', 'kalteversorgung', 'geoportal', 'leitungsgebundene-energieversorgung', 'erneuerbar-heizen', 'holzheizkraftwerk', 'stzh', 'energieplankarte', 'geodaten', 'fernwarme', 'heizen', 'vektordaten', 'kehrichtheizkraftwerk', 'punktdaten', 'polygondaten', 'energie-aus-gereinigtem-abwasser', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-17T03:12:42.110896`
