...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'fernwarmeversorgung', 'energieversorgung', 'stzh', 'geodaten', 'punktdaten', 'netto-null', 'geoportal', 'energieplankarte', 'leitungsgebundene-energieversorgung', 'liniendaten', 'fernwarme', 'warmeversorgung', 'energie', 'vektordaten', 'heizen', 'erneuerbar-heizen', 'holzheizkraftwerk', 'kehrichtheizkraftwerk', 'kalteversorgung', 'polygondaten', 'energieplanung', 'klarwerk']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-08T03:29:54.930972`
