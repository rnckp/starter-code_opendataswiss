...
- **Keywords.de** `['erneuerbar-heizen', 'stzh', 'energieplanung', 'kehrichtheizkraftwerk', 'vektordaten', 'geodaten', 'energieplankarte', 'fernwarme', 'geoportal', 'polygondaten', 'energieversorgung', 'energie-aus-gereinigtem-abwasser', 'liniendaten', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'heizen', 'warmeversorgung', 'holzheizkraftwerk', 'klarwerk', 'energie', 'punktdaten', 'netto-null', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-27T03:27:19.261697`
