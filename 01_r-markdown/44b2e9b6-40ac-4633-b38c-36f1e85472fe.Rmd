...
- **Keywords.de** `['energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'liniendaten', 'geodaten', 'energieplanung', 'netto-null', 'stzh', 'energieversorgung', 'fernwarme', 'kalteversorgung', 'warmeversorgung', 'punktdaten', 'fernwarmeversorgung', 'holzheizkraftwerk', 'klarwerk', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'polygondaten', 'kehrichtheizkraftwerk', 'heizen', 'vektordaten', 'geoportal', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-19T03:23:12.112598`
