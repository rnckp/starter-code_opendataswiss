...
- **Keywords.de** `['stzh', 'energieplankarte', 'fernwarmeversorgung', 'liniendaten', 'energieversorgung', 'warmeversorgung', 'energie-aus-gereinigtem-abwasser', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'kalteversorgung', 'kehrichtheizkraftwerk', 'energieplanung', 'erneuerbar-heizen', 'energie', 'klarwerk', 'fernwarme', 'punktdaten', 'netto-null', 'heizen', 'polygondaten', 'geodaten', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-01T08:50:25.040717`
