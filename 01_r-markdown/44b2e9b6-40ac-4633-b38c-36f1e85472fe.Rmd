...
- **Keywords.de** `['fernwarme', 'energie-aus-gereinigtem-abwasser', 'erneuerbar-heizen', 'stzh', 'polygondaten', 'energieplankarte', 'geoportal', 'netto-null', 'klarwerk', 'energieplanung', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'warmeversorgung', 'leitungsgebundene-energieversorgung', 'vektordaten', 'punktdaten', 'energieversorgung', 'geodaten', 'heizen', 'energie', 'fernwarmeversorgung', 'kalteversorgung', 'liniendaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-08T02:57:24.679374`
