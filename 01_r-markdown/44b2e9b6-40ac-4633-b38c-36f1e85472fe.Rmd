...
- **Keywords.de** `['geoportal', 'fernwarme', 'polygondaten', 'kalteversorgung', 'netto-null', 'vektordaten', 'geodaten', 'kehrichtheizkraftwerk', 'warmeversorgung', 'liniendaten', 'energie-aus-gereinigtem-abwasser', 'energieplanung', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'punktdaten', 'klarwerk', 'heizen', 'energieplankarte', 'erneuerbar-heizen', 'stzh', 'fernwarmeversorgung', 'energieversorgung', 'energie']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-24T03:29:24.546699`
