...
- **Keywords.de** `['stzh', 'liniendaten', 'netto-null', 'energieplankarte', 'punktdaten', 'klarwerk', 'kalteversorgung', 'kehrichtheizkraftwerk', 'vektordaten', 'energie', 'geodaten', 'polygondaten', 'warmeversorgung', 'holzheizkraftwerk', 'fernwarme', 'leitungsgebundene-energieversorgung', 'energieplanung', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'erneuerbar-heizen', 'geoportal', 'heizen', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-24T02:51:17.970479`
