...
- **Keywords.de** `['holzheizkraftwerk', 'klarwerk', 'energie', 'vektordaten', 'kalteversorgung', 'energieplanung', 'geodaten', 'heizen', 'stzh', 'geoportal', 'netto-null', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'fernwarme', 'warmeversorgung', 'energieversorgung', 'energieplankarte', 'punktdaten', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'liniendaten', 'polygondaten', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-20T03:48:08.175271`
