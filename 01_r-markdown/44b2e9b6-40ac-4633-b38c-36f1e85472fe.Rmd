...
- **Keywords.de** `['punktdaten', 'kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'geodaten', 'fernwarmeversorgung', 'energieversorgung', 'liniendaten', 'kalteversorgung', 'warmeversorgung', 'stzh', 'energieplankarte', 'polygondaten', 'erneuerbar-heizen', 'klarwerk', 'heizen', 'holzheizkraftwerk', 'vektordaten', 'energieplanung', 'energie', 'geoportal', 'netto-null', 'fernwarme', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-17T03:13:35.545439`
