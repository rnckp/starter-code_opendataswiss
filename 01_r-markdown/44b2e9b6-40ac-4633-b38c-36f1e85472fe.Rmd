...
- **Keywords.de** `['fernwarmeversorgung', 'leitungsgebundene-energieversorgung', 'vektordaten', 'stzh', 'polygondaten', 'energieversorgung', 'geoportal', 'holzheizkraftwerk', 'erneuerbar-heizen', 'warmeversorgung', 'klarwerk', 'netto-null', 'kehrichtheizkraftwerk', 'geodaten', 'energie', 'fernwarme', 'punktdaten', 'heizen', 'energie-aus-gereinigtem-abwasser', 'kalteversorgung', 'liniendaten', 'energieplankarte', 'energieplanung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-04T04:05:59.648196`
