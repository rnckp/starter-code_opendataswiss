...
- **Keywords.de** `['polygondaten', 'energie', 'vektordaten', 'liniendaten', 'warmeversorgung', 'fernwarme', 'heizen', 'energieplankarte', 'geoportal', 'energieplanung', 'leitungsgebundene-energieversorgung', 'klarwerk', 'energie-aus-gereinigtem-abwasser', 'energieversorgung', 'punktdaten', 'holzheizkraftwerk', 'kalteversorgung', 'geodaten', 'fernwarmeversorgung', 'stzh', 'erneuerbar-heizen', 'netto-null', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-30T03:04:29.303220`
