...
- **Keywords.de** `['kehrichtheizkraftwerk', 'energie-aus-gereinigtem-abwasser', 'klarwerk', 'liniendaten', 'punktdaten', 'energieplanung', 'warmeversorgung', 'netto-null', 'kalteversorgung', 'geoportal', 'leitungsgebundene-energieversorgung', 'energie', 'holzheizkraftwerk', 'stzh', 'fernwarme', 'vektordaten', 'erneuerbar-heizen', 'geodaten', 'energieplankarte', 'polygondaten', 'heizen', 'energieversorgung', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-17T02:58:06.778016`
