...
- **Keywords.de** `['warmeversorgung', 'leitungsgebundene-energieversorgung', 'geodaten', 'energie', 'erneuerbar-heizen', 'kalteversorgung', 'fernwarme', 'stzh', 'energieplanung', 'punktdaten', 'klarwerk', 'heizen', 'liniendaten', 'vektordaten', 'netto-null', 'geoportal', 'energie-aus-gereinigtem-abwasser', 'energieplankarte', 'holzheizkraftwerk', 'polygondaten', 'kehrichtheizkraftwerk', 'energieversorgung', 'fernwarmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-21T04:02:13.676077`
