...
- **Keywords.de** `['heizen', 'kalteversorgung', 'energieplanung', 'stzh', 'geoportal', 'polygondaten', 'erneuerbar-heizen', 'energie-aus-gereinigtem-abwasser', 'punktdaten', 'klarwerk', 'warmeversorgung', 'energie', 'geodaten', 'vektordaten', 'energieversorgung', 'leitungsgebundene-energieversorgung', 'holzheizkraftwerk', 'netto-null', 'energieplankarte', 'liniendaten', 'fernwarme', 'fernwarmeversorgung', 'kehrichtheizkraftwerk']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-02-28T03:37:02.237512`
