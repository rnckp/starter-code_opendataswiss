...
- **Keywords.de** `['energie', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'geodaten', 'energieversorgung', 'liniendaten', 'energieplanung', 'stzh', 'erneuerbar-heizen', 'kehrichtheizkraftwerk', 'klarwerk', 'kalteversorgung', 'polygondaten', 'warmeversorgung', 'punktdaten', 'geoportal', 'heizen', 'fernwarmeversorgung', 'fernwarme', 'leitungsgebundene-energieversorgung', 'netto-null', 'energieplankarte']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-11-29T03:27:14.328007`
