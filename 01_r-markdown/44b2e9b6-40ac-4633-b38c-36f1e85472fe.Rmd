...
- **Keywords.de** `['stzh', 'fernwarmeversorgung', 'kehrichtheizkraftwerk', 'holzheizkraftwerk', 'fernwarme', 'warmeversorgung', 'heizen', 'energieplankarte', 'geoportal', 'liniendaten', 'vektordaten', 'energie-aus-gereinigtem-abwasser', 'polygondaten', 'energieversorgung', 'energieplanung', 'geodaten', 'klarwerk', 'erneuerbar-heizen', 'energie', 'netto-null', 'leitungsgebundene-energieversorgung', 'kalteversorgung', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-04-11T03:43:18.849797`
