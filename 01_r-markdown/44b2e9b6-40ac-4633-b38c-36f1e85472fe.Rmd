...
- **Keywords.de** `['heizen', 'energie', 'vektordaten', 'punktdaten', 'klarwerk', 'fernwarme', 'erneuerbar-heizen', 'polygondaten', 'netto-null', 'stzh', 'fernwarmeversorgung', 'liniendaten', 'geodaten', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'energieversorgung', 'energieplankarte', 'kehrichtheizkraftwerk', 'energieplanung', 'holzheizkraftwerk', 'kalteversorgung', 'warmeversorgung', 'leitungsgebundene-energieversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-03-05T05:07:16.163542`
