...
- **Keywords.de** `['kehrichtheizkraftwerk', 'holzheizkraftwerk', 'warmeversorgung', 'geoportal', 'fernwarme', 'fernwarmeversorgung', 'kalteversorgung', 'klarwerk', 'energie', 'energie-aus-gereinigtem-abwasser', 'vektordaten', 'energieplankarte', 'energieplanung', 'leitungsgebundene-energieversorgung', 'energieversorgung', 'polygondaten', 'geodaten', 'heizen', 'erneuerbar-heizen', 'netto-null', 'stzh', 'liniendaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2023-12-24T03:32:29.553136`
