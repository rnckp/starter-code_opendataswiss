...
- **Keywords.de** `['kalteversorgung', 'kehrichtheizkraftwerk', 'leitungsgebundene-energieversorgung', 'energieplankarte', 'netto-null', 'energie-aus-gereinigtem-abwasser', 'geoportal', 'geodaten', 'liniendaten', 'energieplanung', 'vektordaten', 'holzheizkraftwerk', 'punktdaten', 'klarwerk', 'energieversorgung', 'fernwarme', 'polygondaten', 'heizen', 'erneuerbar-heizen', 'energie', 'fernwarmeversorgung', 'stzh', 'warmeversorgung']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-22T03:18:49.700009`
