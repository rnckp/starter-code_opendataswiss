...
- **Keywords.de** `['kehrichtheizkraftwerk', 'netto-null', 'stzh', 'polygondaten', 'fernwarmeversorgung', 'energie-aus-gereinigtem-abwasser', 'holzheizkraftwerk', 'leitungsgebundene-energieversorgung', 'geoportal', 'energieplankarte', 'erneuerbar-heizen', 'geodaten', 'klarwerk', 'energie', 'warmeversorgung', 'energieversorgung', 'energieplanung', 'kalteversorgung', 'heizen', 'liniendaten', 'punktdaten', 'fernwarme', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:06.952817`
- **Metadata_modified** `2024-01-25T03:25:32.819263`
