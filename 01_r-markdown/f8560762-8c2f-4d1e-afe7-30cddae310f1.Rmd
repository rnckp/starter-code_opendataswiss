...
- **Publisher** `Baubewilligungen II/4, Amt für Baubewilligungen, Hochbaudepartement`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `Open Data Zürich`
- **Maintainer_email** `opendata@zuerich.ch`
- **Keywords.de** `['geschossuberschreitung', 'vektordaten', 'polygondaten', 'stzh', 'geoportal', 'gesamtuberbauungen', 'arealuberbauungen', 'mehrausnutzung', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:34.319636`
- **Metadata_modified** `2023-07-14T01:20:37.351914`
...
# Description              : 
# Issued                   : 2022-05-09T03:08:13.617308
# Modified                 : None
