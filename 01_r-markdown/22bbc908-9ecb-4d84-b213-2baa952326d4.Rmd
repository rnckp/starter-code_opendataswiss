...
- **Keywords.de** `['trinken', 'essen', 'vektordaten', 'stzh', 'sachdaten', 'standort', 'geoportal', 'ausgang', 'bar', 'gastronomie', 'geodaten', 'punktdaten', 'gastro', 'adressen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-11-21T03:17:13.102263`
