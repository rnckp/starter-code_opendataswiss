...
- **Keywords.de** `['stzh', 'gastronomie', 'adressen', 'geoportal', 'vektordaten', 'ausgang', 'standort', 'geodaten', 'bar', 'sachdaten', 'punktdaten', 'essen', 'trinken', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-09-27T03:05:28.127902`
