...
- **Keywords.de** `['ausgang', 'bar', 'vektordaten', 'gastro', 'essen', 'adressen', 'punktdaten', 'sachdaten', 'trinken', 'gastronomie', 'geoportal', 'standort', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-11-17T01:57:54.294723`
