...
- **Keywords.de** `['punktdaten', 'vektordaten', 'trinken', 'sachdaten', 'standort', 'bar', 'geoportal', 'gastro', 'adressen', 'geodaten', 'gastronomie', 'essen', 'stzh', 'ausgang']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2025-04-28T04:39:09.147003`
