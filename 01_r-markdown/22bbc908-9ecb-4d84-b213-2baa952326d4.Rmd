...
- **Keywords.de** `['punktdaten', 'geoportal', 'trinken', 'stzh', 'sachdaten', 'standort', 'gastronomie', 'gastro', 'essen', 'geodaten', 'bar', 'vektordaten', 'adressen', 'ausgang']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2023-12-17T03:13:38.880736`
