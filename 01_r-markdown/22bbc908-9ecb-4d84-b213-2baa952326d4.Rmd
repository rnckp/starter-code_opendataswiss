...
- **Keywords.de** `['standort', 'gastronomie', 'sachdaten', 'adressen', 'geodaten', 'ausgang', 'punktdaten', 'bar', 'vektordaten', 'gastro', 'trinken', 'essen', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-11-27T03:09:01.660128`
