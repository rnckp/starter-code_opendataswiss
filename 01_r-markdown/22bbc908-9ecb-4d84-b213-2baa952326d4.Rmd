...
- **Keywords.de** `['geodaten', 'adressen', 'trinken', 'essen', 'sachdaten', 'stzh', 'ausgang', 'vektordaten', 'standort', 'gastronomie', 'gastro', 'geoportal', 'bar', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-11-14T03:10:39.988849`
