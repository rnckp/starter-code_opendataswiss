...
- **Keywords.de** `['ausgang', 'gastronomie', 'vektordaten', 'standort', 'essen', 'gastro', 'bar', 'stzh', 'geodaten', 'trinken', 'adressen', 'geoportal', 'punktdaten', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2025-08-26T04:52:55.147751`
