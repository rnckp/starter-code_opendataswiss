...
- **Keywords.de** `['gastronomie', 'standort', 'stzh', 'gastro', 'adressen', 'geoportal', 'essen', 'trinken', 'geodaten', 'sachdaten', 'punktdaten', 'vektordaten', 'bar', 'ausgang']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2025-02-26T03:37:12.264268`
