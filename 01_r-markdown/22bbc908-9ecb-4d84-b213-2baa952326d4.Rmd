...
- **Keywords.de** `['gastronomie', 'standort', 'essen', 'sachdaten', 'geodaten', 'punktdaten', 'geoportal', 'vektordaten', 'adressen', 'trinken', 'gastro', 'stzh', 'ausgang', 'bar']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-01-17T03:10:00.574547`
