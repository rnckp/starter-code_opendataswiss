...
- **Keywords.de** `['punktdaten', 'essen', 'geodaten', 'geoportal', 'trinken', 'bar', 'standort', 'gastronomie', 'adressen', 'ausgang', 'gastro', 'vektordaten', 'stzh', 'sachdaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2025-04-07T04:32:44.555249`
