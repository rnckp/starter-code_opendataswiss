...
- **Keywords.de** `['adressen', 'bar', 'gastronomie', 'trinken', 'stzh', 'standort', 'ausgang', 'punktdaten', 'vektordaten', 'sachdaten', 'gastro', 'essen', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-11-26T03:08:49.292193`
