...
- **Keywords.de** `['trinken', 'essen', 'geoportal', 'punktdaten', 'ausgang', 'geodaten', 'gastro', 'vektordaten', 'stzh', 'standort', 'adressen', 'sachdaten', 'gastronomie', 'bar']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-05-14T03:05:24.660853`
