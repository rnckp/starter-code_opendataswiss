...
- **Keywords.de** `['trinken', 'standort', 'gastronomie', 'geoportal', 'gastro', 'punktdaten', 'bar', 'sachdaten', 'geodaten', 'ausgang', 'stzh', 'vektordaten', 'essen', 'adressen']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-03-16T04:47:53.260823`
