...
- **Keywords.de** `['essen', 'punktdaten', 'ausgang', 'vektordaten', 'geoportal', 'trinken', 'stzh', 'adressen', 'gastronomie', 'standort', 'bar', 'sachdaten', 'geodaten', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-10-02T02:48:42.001643`
