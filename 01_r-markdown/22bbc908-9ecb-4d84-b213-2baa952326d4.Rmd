...
- **Keywords.de** `['standort', 'trinken', 'vektordaten', 'punktdaten', 'ausgang', 'gastronomie', 'stzh', 'geoportal', 'adressen', 'gastro', 'essen', 'sachdaten', 'geodaten', 'bar']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-09-16T03:12:14.823515`
