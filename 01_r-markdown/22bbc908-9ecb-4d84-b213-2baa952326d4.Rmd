...
- **Keywords.de** `['essen', 'vektordaten', 'punktdaten', 'sachdaten', 'geodaten', 'ausgang', 'gastronomie', 'geoportal', 'standort', 'gastro', 'adressen', 'stzh', 'trinken', 'bar']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2025-04-26T03:45:28.453374`
