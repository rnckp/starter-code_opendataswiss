...
- **Keywords.de** `['trinken', 'bar', 'punktdaten', 'sachdaten', 'standort', 'vektordaten', 'geodaten', 'adressen', 'geoportal', 'essen', 'ausgang', 'stzh', 'gastronomie', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-06-30T03:02:56.324825`
