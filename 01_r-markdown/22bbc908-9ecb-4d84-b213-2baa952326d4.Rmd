...
- **Keywords.de** `['stzh', 'trinken', 'gastronomie', 'essen', 'adressen', 'sachdaten', 'geodaten', 'geoportal', 'punktdaten', 'gastro', 'bar', 'vektordaten', 'standort', 'ausgang']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2023-11-29T03:26:26.757559`
