...
- **Keywords.de** `['standort', 'gastronomie', 'punktdaten', 'stzh', 'vektordaten', 'essen', 'adressen', 'geoportal', 'sachdaten', 'ausgang', 'geodaten', 'gastro', 'trinken', 'bar']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2025-05-14T03:40:18.823759`
