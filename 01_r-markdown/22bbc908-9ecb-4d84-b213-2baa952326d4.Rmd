...
- **Keywords.de** `['geodaten', 'adressen', 'trinken', 'gastronomie', 'punktdaten', 'stzh', 'geoportal', 'bar', 'gastro', 'sachdaten', 'essen', 'standort', 'ausgang', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-01-27T03:26:58.531144`
