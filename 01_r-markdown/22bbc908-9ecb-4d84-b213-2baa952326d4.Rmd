...
- **Keywords.de** `['punktdaten', 'gastronomie', 'adressen', 'geoportal', 'bar', 'sachdaten', 'geodaten', 'vektordaten', 'trinken', 'essen', 'ausgang', 'standort', 'gastro', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-04-06T03:52:50.580351`
