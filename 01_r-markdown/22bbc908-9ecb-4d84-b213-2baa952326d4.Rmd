...
- **Keywords.de** `['adressen', 'standort', 'gastronomie', 'punktdaten', 'geodaten', 'gastro', 'vektordaten', 'geoportal', 'trinken', 'stzh', 'ausgang', 'sachdaten', 'essen', 'bar']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2023-11-13T02:53:48.384373`
