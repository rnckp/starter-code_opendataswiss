...
- **Keywords.de** `['geodaten', 'gastro', 'punktdaten', 'ausgang', 'sachdaten', 'trinken', 'geoportal', 'stzh', 'bar', 'essen', 'adressen', 'gastronomie', 'standort', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-02-21T04:03:12.584178`
