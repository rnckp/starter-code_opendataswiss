...
- **Keywords.de** `['punktdaten', 'ausgang', 'adressen', 'geoportal', 'trinken', 'standort', 'bar', 'geodaten', 'essen', 'gastronomie', 'stzh', 'vektordaten', 'sachdaten', 'gastro']`
- **Issued** `nan`
- **Metadata_created** `2023-11-07T03:44:45.681842`
- **Metadata_modified** `2024-04-29T02:31:12.668746`
