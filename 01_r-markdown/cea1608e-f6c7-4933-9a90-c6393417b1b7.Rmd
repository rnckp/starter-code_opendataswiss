...
- **Keywords.de** `['erfolg', 'haben', 'verlust', 'investition', 'gewinn', 'buchung', 'bilanz', 'konto', 'soll']`
- **Issued** `2023-07-13T09:49:19+00:00`
- **Metadata_created** `2023-07-13T11:02:19.147288`
- **Metadata_modified** `2023-09-22T11:01:46.701219`
...
df <- read_delim('https://data.tg.ch/api/v2/catalog/datasets/dfs-fv-21/exports/csv')
