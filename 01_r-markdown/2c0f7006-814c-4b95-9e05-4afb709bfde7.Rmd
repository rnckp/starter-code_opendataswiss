...
- **Keywords.de** `['buslinien', 'geodaten', 'vektordaten', 'strassenbahn', 'geoportal', 'stzh', 'tramlinien', 'bus', 'offentlicher-verkehr', 'fundburo', 'postauto', 'vbz', 'punktdaten', 'vbg', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-21T01:03:47.216516`
