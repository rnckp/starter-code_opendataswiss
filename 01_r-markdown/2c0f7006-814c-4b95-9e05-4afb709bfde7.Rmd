...
- **Keywords.de** `['offentlicher-verkehr', 'geoportal', 'fundburo', 'strassenbahn', 'bus', 'stzh', 'punktdaten', 'vbz', 'vbg', 'buslinien', 'geodaten', 'postauto', 'tram', 'vektordaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-23T00:56:00.285929`
