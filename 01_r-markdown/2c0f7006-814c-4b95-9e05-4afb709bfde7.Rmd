...
- **Keywords.de** `['stzh', 'bus', 'tramlinien', 'postauto', 'vbz', 'geodaten', 'punktdaten', 'offentlicher-verkehr', 'tram', 'buslinien', 'fundburo', 'vbg', 'geoportal', 'strassenbahn', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-31T01:19:05.565571`
