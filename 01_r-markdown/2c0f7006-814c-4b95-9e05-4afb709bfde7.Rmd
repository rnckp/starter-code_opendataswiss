...
- **Keywords.de** `['vbz', 'bus', 'postauto', 'geoportal', 'geodaten', 'tramlinien', 'punktdaten', 'vbg', 'fundburo', 'strassenbahn', 'stzh', 'buslinien', 'vektordaten', 'offentlicher-verkehr', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-11T01:30:03.206450`
