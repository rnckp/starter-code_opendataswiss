...
- **Keywords.de** `['fundburo', 'vbz', 'bus', 'punktdaten', 'postauto', 'stzh', 'tram', 'geoportal', 'vektordaten', 'geodaten', 'buslinien', 'tramlinien', 'vbg', 'strassenbahn', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-06T01:33:11.874390`
