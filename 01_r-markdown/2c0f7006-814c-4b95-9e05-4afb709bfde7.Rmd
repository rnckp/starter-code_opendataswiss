...
- **Keywords.de** `['vbz', 'geoportal', 'geodaten', 'buslinien', 'bus', 'postauto', 'offentlicher-verkehr', 'fundburo', 'tram', 'strassenbahn', 'vbg', 'tramlinien', 'punktdaten', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-04T01:04:53.549602`
