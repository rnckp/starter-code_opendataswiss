...
- **Keywords.de** `['bus', 'buslinien', 'geoportal', 'stzh', 'postauto', 'offentlicher-verkehr', 'geodaten', 'tram', 'punktdaten', 'vbz', 'tramlinien', 'vbg', 'fundburo', 'vektordaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-13T01:25:28.267727`
