...
- **Keywords.de** `['tram', 'bus', 'buslinien', 'postauto', 'stzh', 'geodaten', 'strassenbahn', 'vbz', 'fundburo', 'vbg', 'vektordaten', 'tramlinien', 'offentlicher-verkehr', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-28T01:47:12.710692`
