...
- **Keywords.de** `['geodaten', 'postauto', 'vbz', 'punktdaten', 'vektordaten', 'offentlicher-verkehr', 'bus', 'tramlinien', 'buslinien', 'stzh', 'vbg', 'tram', 'strassenbahn', 'geoportal', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-19T01:31:25.818068`
