...
- **Keywords.de** `['postauto', 'strassenbahn', 'tram', 'bus', 'buslinien', 'vbg', 'tramlinien', 'fundburo', 'geoportal', 'stzh', 'vbz', 'geodaten', 'offentlicher-verkehr', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-28T01:21:23.359658`
