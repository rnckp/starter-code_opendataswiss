...
- **Keywords.de** `['geoportal', 'offentlicher-verkehr', 'tram', 'tramlinien', 'geodaten', 'vbg', 'fundburo', 'punktdaten', 'vektordaten', 'vbz', 'buslinien', 'strassenbahn', 'bus', 'postauto', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-28T01:30:16.081185`
