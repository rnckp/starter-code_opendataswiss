...
- **Keywords.de** `['tram', 'stzh', 'punktdaten', 'vektordaten', 'vbg', 'geoportal', 'postauto', 'tramlinien', 'buslinien', 'strassenbahn', 'fundburo', 'bus', 'offentlicher-verkehr', 'vbz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-30T01:47:17.943718`
