...
- **Keywords.de** `['tramlinien', 'bus', 'stzh', 'postauto', 'tram', 'punktdaten', 'geoportal', 'offentlicher-verkehr', 'vbz', 'buslinien', 'strassenbahn', 'vbg', 'fundburo', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-10T01:25:06.323634`
