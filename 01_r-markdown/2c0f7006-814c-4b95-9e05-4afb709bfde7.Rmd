...
- **Keywords.de** `['stzh', 'tramlinien', 'fundburo', 'offentlicher-verkehr', 'tram', 'geodaten', 'geoportal', 'postauto', 'vbz', 'punktdaten', 'strassenbahn', 'vektordaten', 'buslinien', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-11-05T02:56:25.880559`
