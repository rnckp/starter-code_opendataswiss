...
- **Keywords.de** `['geodaten', 'bus', 'stzh', 'tramlinien', 'postauto', 'vektordaten', 'punktdaten', 'strassenbahn', 'geoportal', 'tram', 'buslinien', 'fundburo', 'vbz', 'vbg', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-17T01:44:55.036808`
