...
- **Keywords.de** `['postauto', 'punktdaten', 'geodaten', 'stzh', 'vbg', 'geoportal', 'vektordaten', 'strassenbahn', 'offentlicher-verkehr', 'tram', 'fundburo', 'tramlinien', 'buslinien', 'bus', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-16T01:19:00.964576`
