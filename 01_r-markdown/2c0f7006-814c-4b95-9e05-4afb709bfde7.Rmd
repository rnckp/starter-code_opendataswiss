...
- **Keywords.de** `['stzh', 'strassenbahn', 'tramlinien', 'geodaten', 'offentlicher-verkehr', 'punktdaten', 'postauto', 'vbz', 'tram', 'geoportal', 'vbg', 'buslinien', 'vektordaten', 'bus', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-27T01:40:34.504106`
