...
- **Keywords.de** `['buslinien', 'postauto', 'tramlinien', 'vbg', 'punktdaten', 'offentlicher-verkehr', 'geodaten', 'geoportal', 'stzh', 'fundburo', 'tram', 'vektordaten', 'bus', 'vbz', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-28T01:05:41.759382`
