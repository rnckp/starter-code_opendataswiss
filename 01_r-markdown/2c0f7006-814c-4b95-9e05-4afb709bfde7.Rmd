...
- **Keywords.de** `['buslinien', 'geodaten', 'tramlinien', 'vbg', 'strassenbahn', 'fundburo', 'postauto', 'stzh', 'geoportal', 'tram', 'punktdaten', 'vektordaten', 'bus', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-21T01:02:38.980536`
