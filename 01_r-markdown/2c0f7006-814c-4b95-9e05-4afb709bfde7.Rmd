...
- **Keywords.de** `['punktdaten', 'stzh', 'vektordaten', 'fundburo', 'geoportal', 'strassenbahn', 'tram', 'offentlicher-verkehr', 'tramlinien', 'vbz', 'vbg', 'geodaten', 'bus', 'buslinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-31T01:11:05.515808`
