...
- **Keywords.de** `['bus', 'vektordaten', 'punktdaten', 'vbg', 'geoportal', 'geodaten', 'vbz', 'postauto', 'tram', 'stzh', 'strassenbahn', 'offentlicher-verkehr', 'buslinien', 'fundburo', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-04T01:20:16.159050`
