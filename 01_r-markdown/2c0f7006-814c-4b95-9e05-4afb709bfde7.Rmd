...
- **Keywords.de** `['fundburo', 'vektordaten', 'vbz', 'stzh', 'offentlicher-verkehr', 'buslinien', 'strassenbahn', 'punktdaten', 'geoportal', 'postauto', 'geodaten', 'vbg', 'tramlinien', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-17T01:13:18.012562`
