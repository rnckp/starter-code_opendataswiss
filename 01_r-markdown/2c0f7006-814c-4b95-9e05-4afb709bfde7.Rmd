...
- **Keywords.de** `['strassenbahn', 'tram', 'vektordaten', 'buslinien', 'tramlinien', 'fundburo', 'vbg', 'postauto', 'vbz', 'geodaten', 'stzh', 'bus', 'geoportal', 'offentlicher-verkehr', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-18T02:05:51.046818`
