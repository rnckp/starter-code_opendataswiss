...
- **Keywords.de** `['vbg', 'bus', 'tram', 'fundburo', 'tramlinien', 'vektordaten', 'punktdaten', 'geoportal', 'offentlicher-verkehr', 'vbz', 'geodaten', 'strassenbahn', 'stzh', 'postauto', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-11-02T02:48:01.176970`
