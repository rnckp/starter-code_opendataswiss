...
- **Keywords.de** `['bus', 'postauto', 'strassenbahn', 'tram', 'vbz', 'tramlinien', 'vektordaten', 'geodaten', 'fundburo', 'buslinien', 'offentlicher-verkehr', 'punktdaten', 'vbg', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-05T01:15:34.568150`
