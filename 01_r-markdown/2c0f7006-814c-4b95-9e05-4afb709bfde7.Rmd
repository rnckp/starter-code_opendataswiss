...
- **Keywords.de** `['vbg', 'vektordaten', 'strassenbahn', 'postauto', 'stzh', 'geoportal', 'tram', 'punktdaten', 'fundburo', 'buslinien', 'offentlicher-verkehr', 'bus', 'vbz', 'geodaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-30T01:22:43.580396`
