...
- **Keywords.de** `['geoportal', 'vbz', 'bus', 'geodaten', 'tramlinien', 'vektordaten', 'vbg', 'punktdaten', 'buslinien', 'fundburo', 'stzh', 'strassenbahn', 'tram', 'postauto', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-23T01:20:13.143036`
