...
- **Keywords.de** `['offentlicher-verkehr', 'stzh', 'vbg', 'bus', 'tram', 'punktdaten', 'geodaten', 'vektordaten', 'fundburo', 'postauto', 'tramlinien', 'buslinien', 'vbz', 'strassenbahn', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-15T01:34:41.465180`
