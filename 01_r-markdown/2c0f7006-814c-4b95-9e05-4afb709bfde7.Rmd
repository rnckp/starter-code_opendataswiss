...
- **Keywords.de** `['buslinien', 'vbz', 'punktdaten', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'geodaten', 'vektordaten', 'postauto', 'tram', 'geoportal', 'bus', 'tramlinien', 'stzh', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-08T01:26:50.847126`
