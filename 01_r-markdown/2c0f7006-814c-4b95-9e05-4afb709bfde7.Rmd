...
- **Keywords.de** `['fundburo', 'geoportal', 'vbg', 'tramlinien', 'bus', 'punktdaten', 'vbz', 'stzh', 'strassenbahn', 'tram', 'vektordaten', 'buslinien', 'postauto', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-27T01:32:07.469957`
