...
- **Keywords.de** `['stzh', 'postauto', 'offentlicher-verkehr', 'vbz', 'bus', 'tramlinien', 'punktdaten', 'tram', 'fundburo', 'buslinien', 'geoportal', 'vbg', 'vektordaten', 'geodaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-03T01:17:14.155830`
