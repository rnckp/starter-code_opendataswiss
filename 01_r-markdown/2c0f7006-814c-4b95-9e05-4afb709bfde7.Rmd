...
- **Keywords.de** `['vbg', 'vbz', 'fundburo', 'geodaten', 'punktdaten', 'tram', 'vektordaten', 'stzh', 'tramlinien', 'geoportal', 'buslinien', 'offentlicher-verkehr', 'postauto', 'bus', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-29T01:16:13.086405`
