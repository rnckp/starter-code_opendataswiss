...
- **Keywords.de** `['strassenbahn', 'bus', 'vektordaten', 'tram', 'stzh', 'punktdaten', 'geodaten', 'tramlinien', 'fundburo', 'vbz', 'geoportal', 'buslinien', 'postauto', 'offentlicher-verkehr', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-01T01:08:23.254070`
