...
- **Keywords.de** `['tramlinien', 'vektordaten', 'buslinien', 'fundburo', 'strassenbahn', 'tram', 'vbg', 'stzh', 'punktdaten', 'postauto', 'bus', 'vbz', 'offentlicher-verkehr', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-31T01:34:04.969525`
