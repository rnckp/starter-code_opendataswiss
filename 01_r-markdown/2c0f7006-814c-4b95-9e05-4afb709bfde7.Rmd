...
- **Keywords.de** `['punktdaten', 'buslinien', 'offentlicher-verkehr', 'postauto', 'geoportal', 'fundburo', 'geodaten', 'vektordaten', 'tramlinien', 'strassenbahn', 'bus', 'vbg', 'stzh', 'tram', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-09T01:36:19.362086`
