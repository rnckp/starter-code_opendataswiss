...
- **Keywords.de** `['geoportal', 'geodaten', 'postauto', 'strassenbahn', 'vbg', 'bus', 'tramlinien', 'tram', 'vbz', 'stzh', 'buslinien', 'offentlicher-verkehr', 'punktdaten', 'vektordaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-08T01:17:16.741377`
