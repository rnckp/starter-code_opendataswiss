...
- **Keywords.de** `['tramlinien', 'vektordaten', 'vbg', 'geodaten', 'fundburo', 'strassenbahn', 'buslinien', 'vbz', 'punktdaten', 'tram', 'bus', 'offentlicher-verkehr', 'postauto', 'stzh', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-06T01:30:56.908984`
