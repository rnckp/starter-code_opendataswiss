...
- **Keywords.de** `['vbz', 'strassenbahn', 'vbg', 'stzh', 'geodaten', 'punktdaten', 'fundburo', 'offentlicher-verkehr', 'geoportal', 'bus', 'buslinien', 'vektordaten', 'tram', 'postauto', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-19T01:50:37.175190`
