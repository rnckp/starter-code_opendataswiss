...
- **Keywords.de** `['offentlicher-verkehr', 'buslinien', 'postauto', 'geoportal', 'strassenbahn', 'bus', 'tram', 'stzh', 'vbg', 'vbz', 'geodaten', 'tramlinien', 'punktdaten', 'vektordaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-10T01:43:33.020263`
