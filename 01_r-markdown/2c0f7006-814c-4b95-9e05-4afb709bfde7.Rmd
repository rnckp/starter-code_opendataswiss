...
- **Keywords.de** `['fundburo', 'tramlinien', 'stzh', 'vektordaten', 'postauto', 'tram', 'vbg', 'geodaten', 'punktdaten', 'vbz', 'bus', 'buslinien', 'geoportal', 'strassenbahn', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-17T01:04:30.208437`
