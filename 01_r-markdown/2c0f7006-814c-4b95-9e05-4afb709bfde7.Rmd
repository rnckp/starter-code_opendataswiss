...
- **Keywords.de** `['bus', 'tramlinien', 'punktdaten', 'geoportal', 'offentlicher-verkehr', 'stzh', 'buslinien', 'strassenbahn', 'tram', 'vbz', 'vbg', 'fundburo', 'postauto', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-10T01:13:48.026270`
