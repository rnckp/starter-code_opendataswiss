...
- **Keywords.de** `['strassenbahn', 'vbg', 'stzh', 'tram', 'postauto', 'geodaten', 'tramlinien', 'offentlicher-verkehr', 'bus', 'vbz', 'fundburo', 'punktdaten', 'geoportal', 'vektordaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-11T01:13:03.898530`
