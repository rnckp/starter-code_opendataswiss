...
- **Keywords.de** `['postauto', 'tramlinien', 'vbg', 'buslinien', 'tram', 'punktdaten', 'bus', 'strassenbahn', 'fundburo', 'stzh', 'vbz', 'geodaten', 'vektordaten', 'offentlicher-verkehr', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-22T01:13:13.684269`
