...
- **Keywords.de** `['postauto', 'bus', 'strassenbahn', 'tram', 'geodaten', 'vbz', 'punktdaten', 'tramlinien', 'fundburo', 'stzh', 'geoportal', 'buslinien', 'vektordaten', 'vbg', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-31T02:48:01.411597`
