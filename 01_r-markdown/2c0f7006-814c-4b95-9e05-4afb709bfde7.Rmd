...
- **Keywords.de** `['offentlicher-verkehr', 'buslinien', 'fundburo', 'geodaten', 'strassenbahn', 'vbg', 'postauto', 'tram', 'bus', 'tramlinien', 'stzh', 'punktdaten', 'geoportal', 'vektordaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-15T01:09:27.057338`
