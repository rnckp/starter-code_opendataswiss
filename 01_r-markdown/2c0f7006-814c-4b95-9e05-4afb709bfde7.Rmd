...
- **Keywords.de** `['buslinien', 'offentlicher-verkehr', 'vbg', 'tramlinien', 'strassenbahn', 'geoportal', 'vbz', 'vektordaten', 'postauto', 'tram', 'punktdaten', 'stzh', 'fundburo', 'geodaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-04T01:44:24.077348`
