...
- **Keywords.de** `['fundburo', 'punktdaten', 'offentlicher-verkehr', 'tramlinien', 'vbg', 'geodaten', 'geoportal', 'stzh', 'vektordaten', 'buslinien', 'postauto', 'strassenbahn', 'vbz', 'tram', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-24T01:46:19.865606`
