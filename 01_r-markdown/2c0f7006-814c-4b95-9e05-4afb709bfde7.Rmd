...
- **Keywords.de** `['geodaten', 'tramlinien', 'offentlicher-verkehr', 'vbg', 'fundburo', 'bus', 'punktdaten', 'geoportal', 'buslinien', 'vektordaten', 'postauto', 'strassenbahn', 'stzh', 'tram', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-13T01:25:16.080101`
