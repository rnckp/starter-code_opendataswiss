...
- **Keywords.de** `['postauto', 'tramlinien', 'strassenbahn', 'tram', 'bus', 'fundburo', 'buslinien', 'vektordaten', 'geodaten', 'offentlicher-verkehr', 'geoportal', 'stzh', 'vbz', 'vbg', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-22T01:13:56.604927`
