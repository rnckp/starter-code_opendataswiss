...
- **Keywords.de** `['vbg', 'buslinien', 'vbz', 'punktdaten', 'postauto', 'strassenbahn', 'bus', 'offentlicher-verkehr', 'fundburo', 'stzh', 'geoportal', 'vektordaten', 'tramlinien', 'tram', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-10T01:13:12.613362`
