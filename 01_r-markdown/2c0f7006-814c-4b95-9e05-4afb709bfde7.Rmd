...
- **Keywords.de** `['postauto', 'tram', 'geoportal', 'strassenbahn', 'fundburo', 'bus', 'offentlicher-verkehr', 'vektordaten', 'vbz', 'vbg', 'punktdaten', 'geodaten', 'buslinien', 'tramlinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-10T01:03:12.354932`
