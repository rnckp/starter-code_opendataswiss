...
- **Keywords.de** `['geoportal', 'tramlinien', 'vektordaten', 'vbg', 'bus', 'vbz', 'punktdaten', 'fundburo', 'buslinien', 'stzh', 'tram', 'geodaten', 'postauto', 'offentlicher-verkehr', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-17T01:18:48.778949`
