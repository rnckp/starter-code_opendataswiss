...
- **Keywords.de** `['geoportal', 'geodaten', 'punktdaten', 'vektordaten', 'fundburo', 'vbz', 'tram', 'buslinien', 'bus', 'tramlinien', 'postauto', 'strassenbahn', 'offentlicher-verkehr', 'stzh', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-24T01:05:28.012500`
