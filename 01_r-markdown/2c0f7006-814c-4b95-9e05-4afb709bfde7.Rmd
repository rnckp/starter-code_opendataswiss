...
- **Keywords.de** `['geodaten', 'stzh', 'fundburo', 'tram', 'strassenbahn', 'punktdaten', 'vektordaten', 'bus', 'tramlinien', 'vbz', 'offentlicher-verkehr', 'vbg', 'postauto', 'geoportal', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-14T01:23:22.450024`
