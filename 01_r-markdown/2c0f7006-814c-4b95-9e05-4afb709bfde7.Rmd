...
- **Keywords.de** `['offentlicher-verkehr', 'geoportal', 'tramlinien', 'stzh', 'fundburo', 'punktdaten', 'vektordaten', 'geodaten', 'buslinien', 'tram', 'bus', 'postauto', 'vbg', 'vbz', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-25T01:14:35.145260`
