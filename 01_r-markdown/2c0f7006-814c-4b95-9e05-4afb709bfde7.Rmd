...
- **Keywords.de** `['vbz', 'punktdaten', 'vbg', 'vektordaten', 'tram', 'bus', 'strassenbahn', 'offentlicher-verkehr', 'fundburo', 'postauto', 'geodaten', 'stzh', 'tramlinien', 'buslinien', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-12T02:04:40.120330`
