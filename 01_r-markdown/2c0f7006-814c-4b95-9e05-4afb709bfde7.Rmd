...
- **Keywords.de** `['tram', 'vbz', 'buslinien', 'fundburo', 'tramlinien', 'strassenbahn', 'geoportal', 'offentlicher-verkehr', 'vbg', 'stzh', 'bus', 'postauto', 'geodaten', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-16T01:07:46.214730`
