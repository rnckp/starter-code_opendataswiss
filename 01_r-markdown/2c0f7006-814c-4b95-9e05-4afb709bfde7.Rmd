...
- **Keywords.de** `['strassenbahn', 'geoportal', 'stzh', 'postauto', 'tram', 'geodaten', 'tramlinien', 'offentlicher-verkehr', 'bus', 'vbg', 'punktdaten', 'buslinien', 'fundburo', 'vbz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-01T01:24:56.183481`
