...
- **Keywords.de** `['strassenbahn', 'fundburo', 'postauto', 'tram', 'geoportal', 'vbz', 'vektordaten', 'geodaten', 'tramlinien', 'buslinien', 'vbg', 'offentlicher-verkehr', 'stzh', 'bus', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-08T01:14:33.404588`
