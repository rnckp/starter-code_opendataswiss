...
- **Keywords.de** `['postauto', 'geoportal', 'tramlinien', 'tram', 'offentlicher-verkehr', 'vbg', 'stzh', 'geodaten', 'vektordaten', 'vbz', 'fundburo', 'strassenbahn', 'bus', 'buslinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-12T01:30:30.465263`
