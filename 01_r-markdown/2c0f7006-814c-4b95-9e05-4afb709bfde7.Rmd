...
- **Keywords.de** `['fundburo', 'postauto', 'stzh', 'buslinien', 'tram', 'geodaten', 'geoportal', 'vbz', 'tramlinien', 'bus', 'vektordaten', 'strassenbahn', 'vbg', 'punktdaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-07T01:27:17.449056`
