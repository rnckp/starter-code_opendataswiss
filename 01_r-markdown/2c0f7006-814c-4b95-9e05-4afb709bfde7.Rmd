...
- **Keywords.de** `['offentlicher-verkehr', 'postauto', 'fundburo', 'buslinien', 'geodaten', 'vbg', 'vektordaten', 'vbz', 'bus', 'punktdaten', 'geoportal', 'stzh', 'strassenbahn', 'tramlinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-18T01:30:29.906423`
