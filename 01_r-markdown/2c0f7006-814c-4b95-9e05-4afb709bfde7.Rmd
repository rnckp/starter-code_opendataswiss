...
- **Keywords.de** `['fundburo', 'offentlicher-verkehr', 'vbg', 'geoportal', 'bus', 'geodaten', 'vbz', 'postauto', 'buslinien', 'tram', 'strassenbahn', 'vektordaten', 'stzh', 'punktdaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-11T01:48:12.530428`
