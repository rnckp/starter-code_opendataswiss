...
- **Keywords.de** `['offentlicher-verkehr', 'buslinien', 'tramlinien', 'stzh', 'postauto', 'vbg', 'punktdaten', 'vbz', 'tram', 'fundburo', 'bus', 'vektordaten', 'strassenbahn', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-07T01:26:57.117830`
