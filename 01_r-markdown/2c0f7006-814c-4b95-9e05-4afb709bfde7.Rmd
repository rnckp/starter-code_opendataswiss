...
- **Keywords.de** `['tramlinien', 'tram', 'punktdaten', 'postauto', 'geodaten', 'vbz', 'buslinien', 'fundburo', 'strassenbahn', 'vbg', 'offentlicher-verkehr', 'vektordaten', 'geoportal', 'bus', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-02T01:48:37.680465`
