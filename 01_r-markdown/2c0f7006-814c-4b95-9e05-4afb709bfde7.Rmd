...
- **Keywords.de** `['stzh', 'punktdaten', 'geoportal', 'tram', 'tramlinien', 'vbz', 'buslinien', 'offentlicher-verkehr', 'strassenbahn', 'fundburo', 'vektordaten', 'geodaten', 'vbg', 'bus', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-25T01:42:23.995479`
