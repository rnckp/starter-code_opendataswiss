...
- **Keywords.de** `['geoportal', 'bus', 'stzh', 'geodaten', 'punktdaten', 'buslinien', 'tramlinien', 'tram', 'offentlicher-verkehr', 'strassenbahn', 'vbz', 'postauto', 'vektordaten', 'vbg', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-07T01:41:34.923747`
