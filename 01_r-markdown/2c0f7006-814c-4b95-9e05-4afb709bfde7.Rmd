...
- **Keywords.de** `['buslinien', 'geoportal', 'offentlicher-verkehr', 'tramlinien', 'stzh', 'vektordaten', 'tram', 'fundburo', 'bus', 'geodaten', 'postauto', 'vbg', 'punktdaten', 'vbz', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-01T01:06:26.934501`
