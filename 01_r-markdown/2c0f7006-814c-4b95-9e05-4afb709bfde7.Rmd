...
- **Keywords.de** `['offentlicher-verkehr', 'geodaten', 'geoportal', 'punktdaten', 'vbz', 'bus', 'vektordaten', 'fundburo', 'postauto', 'buslinien', 'vbg', 'stzh', 'tramlinien', 'tram', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-11T01:27:42.148622`
