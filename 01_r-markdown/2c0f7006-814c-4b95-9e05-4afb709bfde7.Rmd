...
- **Keywords.de** `['geoportal', 'fundburo', 'vbg', 'strassenbahn', 'postauto', 'vektordaten', 'geodaten', 'tram', 'vbz', 'bus', 'offentlicher-verkehr', 'stzh', 'punktdaten', 'buslinien', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-30T01:34:55.885445`
