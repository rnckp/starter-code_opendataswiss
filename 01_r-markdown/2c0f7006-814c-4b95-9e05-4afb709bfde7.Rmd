...
- **Keywords.de** `['geodaten', 'strassenbahn', 'geoportal', 'stzh', 'buslinien', 'postauto', 'offentlicher-verkehr', 'vektordaten', 'fundburo', 'bus', 'tram', 'punktdaten', 'vbz', 'vbg', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-13T01:06:37.178832`
