...
- **Keywords.de** `['strassenbahn', 'punktdaten', 'postauto', 'tramlinien', 'offentlicher-verkehr', 'vbz', 'buslinien', 'tram', 'geodaten', 'vbg', 'geoportal', 'fundburo', 'bus', 'vektordaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-13T00:59:40.910626`
