...
- **Keywords.de** `['stzh', 'tramlinien', 'vbz', 'bus', 'buslinien', 'tram', 'punktdaten', 'postauto', 'strassenbahn', 'fundburo', 'vbg', 'geoportal', 'vektordaten', 'geodaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-04T01:04:02.407822`
