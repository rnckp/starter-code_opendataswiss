...
- **Keywords.de** `['geoportal', 'punktdaten', 'bus', 'vbz', 'offentlicher-verkehr', 'stzh', 'postauto', 'buslinien', 'vektordaten', 'vbg', 'tramlinien', 'tram', 'geodaten', 'fundburo', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-28T01:04:48.909428`
