...
- **Keywords.de** `['punktdaten', 'postauto', 'offentlicher-verkehr', 'bus', 'stzh', 'vbg', 'geoportal', 'buslinien', 'geodaten', 'strassenbahn', 'tram', 'fundburo', 'tramlinien', 'vektordaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-06T01:45:30.044809`
