...
- **Keywords.de** `['vbg', 'fundburo', 'buslinien', 'stzh', 'strassenbahn', 'geodaten', 'tramlinien', 'punktdaten', 'tram', 'geoportal', 'vektordaten', 'bus', 'vbz', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-05T01:28:49.519579`
