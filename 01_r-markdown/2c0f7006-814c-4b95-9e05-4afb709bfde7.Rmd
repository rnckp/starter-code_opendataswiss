...
- **Keywords.de** `['buslinien', 'stzh', 'postauto', 'geoportal', 'vbz', 'vektordaten', 'tramlinien', 'fundburo', 'punktdaten', 'vbg', 'tram', 'geodaten', 'strassenbahn', 'bus', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-07T01:13:38.255802`
