...
- **Keywords.de** `['punktdaten', 'tram', 'fundburo', 'tramlinien', 'geodaten', 'bus', 'vbg', 'vbz', 'vektordaten', 'geoportal', 'strassenbahn', 'offentlicher-verkehr', 'postauto', 'stzh', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-24T01:05:53.939418`
