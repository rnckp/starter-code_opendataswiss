...
- **Keywords.de** `['postauto', 'geoportal', 'tramlinien', 'buslinien', 'vbg', 'tram', 'offentlicher-verkehr', 'fundburo', 'vektordaten', 'punktdaten', 'strassenbahn', 'geodaten', 'bus', 'stzh', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-05T01:24:05.940270`
