...
- **Keywords.de** `['buslinien', 'stzh', 'bus', 'postauto', 'vbg', 'fundburo', 'tram', 'strassenbahn', 'vbz', 'tramlinien', 'geodaten', 'vektordaten', 'offentlicher-verkehr', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-23T01:21:06.117431`
