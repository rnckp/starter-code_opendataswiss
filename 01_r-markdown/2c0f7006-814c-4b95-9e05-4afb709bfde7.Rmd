...
- **Keywords.de** `['tram', 'vbz', 'geoportal', 'bus', 'vektordaten', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'stzh', 'strassenbahn', 'fundburo', 'postauto', 'tramlinien', 'buslinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-27T01:43:57.155553`
