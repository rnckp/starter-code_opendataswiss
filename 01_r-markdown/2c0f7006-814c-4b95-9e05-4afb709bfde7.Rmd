...
- **Keywords.de** `['bus', 'offentlicher-verkehr', 'buslinien', 'vektordaten', 'punktdaten', 'vbg', 'stzh', 'postauto', 'tram', 'strassenbahn', 'geodaten', 'geoportal', 'fundburo', 'vbz', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-26T01:50:12.253220`
