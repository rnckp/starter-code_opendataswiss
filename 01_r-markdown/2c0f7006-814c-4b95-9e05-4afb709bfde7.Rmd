...
- **Keywords.de** `['buslinien', 'vbz', 'bus', 'punktdaten', 'vektordaten', 'geodaten', 'geoportal', 'tram', 'stzh', 'offentlicher-verkehr', 'vbg', 'tramlinien', 'strassenbahn', 'fundburo', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-27T01:34:19.880750`
