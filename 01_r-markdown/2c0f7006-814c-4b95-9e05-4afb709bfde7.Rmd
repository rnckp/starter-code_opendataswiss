...
- **Keywords.de** `['geodaten', 'punktdaten', 'stzh', 'buslinien', 'vbg', 'geoportal', 'postauto', 'bus', 'tramlinien', 'vektordaten', 'tram', 'strassenbahn', 'fundburo', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-03T01:16:45.067697`
