...
- **Keywords.de** `['bus', 'stzh', 'vbz', 'tram', 'vektordaten', 'postauto', 'tramlinien', 'fundburo', 'geodaten', 'buslinien', 'offentlicher-verkehr', 'geoportal', 'punktdaten', 'strassenbahn', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-24T01:22:49.514934`
