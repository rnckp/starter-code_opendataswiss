...
- **Keywords.de** `['vbz', 'stzh', 'fundburo', 'postauto', 'vbg', 'buslinien', 'bus', 'offentlicher-verkehr', 'vektordaten', 'geodaten', 'tramlinien', 'tram', 'strassenbahn', 'geoportal', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-10T01:23:15.511400`
