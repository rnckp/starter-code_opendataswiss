...
- **Keywords.de** `['fundburo', 'punktdaten', 'postauto', 'tramlinien', 'offentlicher-verkehr', 'tram', 'vbz', 'vektordaten', 'stzh', 'bus', 'vbg', 'strassenbahn', 'geoportal', 'geodaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-21T01:15:54.386773`
