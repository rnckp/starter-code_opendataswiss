...
- **Keywords.de** `['geodaten', 'fundburo', 'vbz', 'offentlicher-verkehr', 'strassenbahn', 'punktdaten', 'tram', 'tramlinien', 'geoportal', 'postauto', 'bus', 'stzh', 'vbg', 'vektordaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-14T01:22:15.673113`
