...
- **Keywords.de** `['vektordaten', 'geodaten', 'stzh', 'fundburo', 'vbg', 'postauto', 'punktdaten', 'strassenbahn', 'tramlinien', 'tram', 'bus', 'vbz', 'buslinien', 'geoportal', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-26T01:19:52.113374`
