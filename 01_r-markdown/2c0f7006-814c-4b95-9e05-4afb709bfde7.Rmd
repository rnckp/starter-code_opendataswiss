...
- **Keywords.de** `['offentlicher-verkehr', 'geoportal', 'buslinien', 'postauto', 'vbg', 'strassenbahn', 'geodaten', 'vektordaten', 'stzh', 'tramlinien', 'bus', 'punktdaten', 'vbz', 'tram', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-29T01:40:16.506769`
