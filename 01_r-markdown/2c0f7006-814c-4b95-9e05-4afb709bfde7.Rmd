...
- **Keywords.de** `['geodaten', 'strassenbahn', 'tramlinien', 'stzh', 'punktdaten', 'postauto', 'bus', 'fundburo', 'tram', 'geoportal', 'vbg', 'vbz', 'vektordaten', 'offentlicher-verkehr', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-08T01:49:58.821671`
