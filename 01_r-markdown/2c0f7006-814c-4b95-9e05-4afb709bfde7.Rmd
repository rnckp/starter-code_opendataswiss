...
- **Keywords.de** `['vbz', 'tram', 'strassenbahn', 'buslinien', 'geoportal', 'geodaten', 'postauto', 'stzh', 'vbg', 'fundburo', 'vektordaten', 'punktdaten', 'bus', 'tramlinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-15T01:24:05.126684`
