...
- **Keywords.de** `['offentlicher-verkehr', 'bus', 'geoportal', 'tram', 'tramlinien', 'vbg', 'geodaten', 'fundburo', 'buslinien', 'vektordaten', 'punktdaten', 'postauto', 'strassenbahn', 'vbz', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-21T01:36:16.587474`
