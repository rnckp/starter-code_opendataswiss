...
- **Keywords.de** `['offentlicher-verkehr', 'strassenbahn', 'geoportal', 'bus', 'postauto', 'vektordaten', 'geodaten', 'punktdaten', 'buslinien', 'fundburo', 'vbg', 'vbz', 'tramlinien', 'tram', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-13T01:16:03.980862`
