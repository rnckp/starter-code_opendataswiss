...
- **Keywords.de** `['tram', 'vbz', 'tramlinien', 'vektordaten', 'buslinien', 'punktdaten', 'vbg', 'bus', 'stzh', 'offentlicher-verkehr', 'geoportal', 'postauto', 'strassenbahn', 'fundburo', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-27T01:22:19.105632`
