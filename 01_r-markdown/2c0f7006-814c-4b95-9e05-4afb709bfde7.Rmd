...
- **Keywords.de** `['punktdaten', 'geoportal', 'strassenbahn', 'geodaten', 'tramlinien', 'fundburo', 'postauto', 'buslinien', 'stzh', 'vbg', 'bus', 'offentlicher-verkehr', 'tram', 'vbz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-15T01:38:29.698293`
