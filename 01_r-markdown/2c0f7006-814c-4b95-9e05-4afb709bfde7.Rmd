...
- **Keywords.de** `['geoportal', 'buslinien', 'strassenbahn', 'vbz', 'offentlicher-verkehr', 'vektordaten', 'stzh', 'tram', 'geodaten', 'fundburo', 'punktdaten', 'vbg', 'bus', 'tramlinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-22T01:20:50.332579`
