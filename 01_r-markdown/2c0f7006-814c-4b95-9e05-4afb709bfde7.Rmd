...
- **Keywords.de** `['tramlinien', 'fundburo', 'geoportal', 'punktdaten', 'vbz', 'stzh', 'vbg', 'postauto', 'offentlicher-verkehr', 'buslinien', 'tram', 'strassenbahn', 'geodaten', 'vektordaten', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-10T01:42:51.151747`
