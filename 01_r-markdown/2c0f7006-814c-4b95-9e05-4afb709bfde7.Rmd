...
- **Keywords.de** `['buslinien', 'geoportal', 'tramlinien', 'offentlicher-verkehr', 'vbz', 'geodaten', 'stzh', 'vektordaten', 'bus', 'vbg', 'postauto', 'tram', 'fundburo', 'punktdaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-03T01:25:49.911374`
