...
- **Keywords.de** `['vbg', 'fundburo', 'strassenbahn', 'buslinien', 'punktdaten', 'geoportal', 'vbz', 'bus', 'postauto', 'vektordaten', 'tram', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-04T01:16:25.148038`
