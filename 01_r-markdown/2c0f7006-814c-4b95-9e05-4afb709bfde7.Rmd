...
- **Keywords.de** `['geodaten', 'tram', 'geoportal', 'vbg', 'vektordaten', 'tramlinien', 'punktdaten', 'buslinien', 'offentlicher-verkehr', 'vbz', 'bus', 'strassenbahn', 'postauto', 'stzh', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-12T01:20:59.906797`
