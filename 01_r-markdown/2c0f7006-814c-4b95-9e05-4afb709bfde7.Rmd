...
- **Keywords.de** `['strassenbahn', 'buslinien', 'punktdaten', 'tramlinien', 'vektordaten', 'geoportal', 'geodaten', 'stzh', 'postauto', 'vbg', 'vbz', 'tram', 'offentlicher-verkehr', 'bus', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-22T01:12:31.352642`
