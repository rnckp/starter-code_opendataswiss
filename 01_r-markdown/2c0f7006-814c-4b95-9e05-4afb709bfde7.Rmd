...
- **Keywords.de** `['buslinien', 'geodaten', 'bus', 'geoportal', 'vbz', 'tramlinien', 'stzh', 'postauto', 'offentlicher-verkehr', 'punktdaten', 'vbg', 'strassenbahn', 'vektordaten', 'fundburo', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-16T01:23:49.458626`
