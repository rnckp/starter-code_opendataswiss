...
- **Keywords.de** `['buslinien', 'punktdaten', 'vbz', 'postauto', 'strassenbahn', 'geodaten', 'vbg', 'stzh', 'bus', 'vektordaten', 'geoportal', 'fundburo', 'offentlicher-verkehr', 'tram', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-11T01:15:25.575376`
