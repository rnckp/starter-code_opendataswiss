...
- **Keywords.de** `['vbg', 'strassenbahn', 'buslinien', 'stzh', 'tramlinien', 'postauto', 'vbz', 'vektordaten', 'punktdaten', 'geoportal', 'offentlicher-verkehr', 'fundburo', 'tram', 'bus', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-09T01:28:27.888579`
