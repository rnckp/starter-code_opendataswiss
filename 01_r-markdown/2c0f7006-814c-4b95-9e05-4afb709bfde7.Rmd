...
- **Keywords.de** `['postauto', 'offentlicher-verkehr', 'buslinien', 'geoportal', 'stzh', 'tram', 'vektordaten', 'tramlinien', 'vbz', 'geodaten', 'fundburo', 'bus', 'punktdaten', 'strassenbahn', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-12T01:15:46.274948`
