...
- **Keywords.de** `['punktdaten', 'buslinien', 'postauto', 'tramlinien', 'vbg', 'fundburo', 'geoportal', 'geodaten', 'stzh', 'offentlicher-verkehr', 'tram', 'vektordaten', 'strassenbahn', 'vbz', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-31T01:39:24.378291`
