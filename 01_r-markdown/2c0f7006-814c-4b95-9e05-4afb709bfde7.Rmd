...
- **Keywords.de** `['postauto', 'punktdaten', 'buslinien', 'geodaten', 'fundburo', 'bus', 'tramlinien', 'strassenbahn', 'tram', 'offentlicher-verkehr', 'vektordaten', 'vbg', 'stzh', 'vbz', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-17T01:35:41.166103`
