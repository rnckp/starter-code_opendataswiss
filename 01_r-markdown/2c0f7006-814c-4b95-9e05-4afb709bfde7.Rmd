...
- **Keywords.de** `['tram', 'geoportal', 'punktdaten', 'postauto', 'geodaten', 'bus', 'vbz', 'buslinien', 'stzh', 'fundburo', 'vbg', 'offentlicher-verkehr', 'tramlinien', 'vektordaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-26T01:21:22.977892`
