...
- **Keywords.de** `['tramlinien', 'bus', 'punktdaten', 'stzh', 'strassenbahn', 'vbg', 'offentlicher-verkehr', 'geoportal', 'buslinien', 'geodaten', 'tram', 'fundburo', 'vektordaten', 'vbz', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-19T01:06:49.175497`
