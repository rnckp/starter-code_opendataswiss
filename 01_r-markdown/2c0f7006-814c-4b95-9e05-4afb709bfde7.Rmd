...
- **Keywords.de** `['stzh', 'vbg', 'geoportal', 'buslinien', 'fundburo', 'bus', 'offentlicher-verkehr', 'vbz', 'vektordaten', 'punktdaten', 'postauto', 'strassenbahn', 'geodaten', 'tram', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-25T00:55:18.382276`
