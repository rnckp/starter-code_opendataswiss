...
- **Keywords.de** `['tram', 'postauto', 'vbg', 'vbz', 'fundburo', 'tramlinien', 'geoportal', 'offentlicher-verkehr', 'buslinien', 'strassenbahn', 'bus', 'punktdaten', 'vektordaten', 'stzh', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-08T01:51:25.067375`
