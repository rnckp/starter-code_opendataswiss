...
- **Keywords.de** `['tram', 'strassenbahn', 'vbg', 'offentlicher-verkehr', 'postauto', 'geoportal', 'stzh', 'geodaten', 'buslinien', 'fundburo', 'vbz', 'bus', 'vektordaten', 'punktdaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-20T02:07:36.239092`
