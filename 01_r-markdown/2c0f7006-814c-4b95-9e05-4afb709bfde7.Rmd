...
- **Keywords.de** `['geoportal', 'vbz', 'offentlicher-verkehr', 'buslinien', 'postauto', 'fundburo', 'tram', 'punktdaten', 'bus', 'stzh', 'tramlinien', 'strassenbahn', 'vbg', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-26T01:22:26.933258`
