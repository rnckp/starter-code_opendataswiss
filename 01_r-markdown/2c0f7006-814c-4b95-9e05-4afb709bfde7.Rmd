...
- **Keywords.de** `['fundburo', 'bus', 'stzh', 'buslinien', 'punktdaten', 'vbg', 'strassenbahn', 'tram', 'geoportal', 'tramlinien', 'vbz', 'postauto', 'offentlicher-verkehr', 'vektordaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-21T01:18:12.252616`
