...
- **Keywords.de** `['punktdaten', 'fundburo', 'buslinien', 'postauto', 'tram', 'geodaten', 'bus', 'vektordaten', 'geoportal', 'vbz', 'offentlicher-verkehr', 'strassenbahn', 'stzh', 'tramlinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-23T01:12:55.331679`
