...
- **Keywords.de** `['strassenbahn', 'tramlinien', 'bus', 'offentlicher-verkehr', 'stzh', 'vbg', 'punktdaten', 'vektordaten', 'geodaten', 'buslinien', 'vbz', 'fundburo', 'postauto', 'tram', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-14T01:01:46.110462`
