...
- **Keywords.de** `['strassenbahn', 'offentlicher-verkehr', 'stzh', 'fundburo', 'tramlinien', 'tram', 'vektordaten', 'geoportal', 'punktdaten', 'postauto', 'buslinien', 'bus', 'vbg', 'geodaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-28T01:03:32.318290`
