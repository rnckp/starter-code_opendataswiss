...
- **Keywords.de** `['fundburo', 'vektordaten', 'vbg', 'geodaten', 'bus', 'tramlinien', 'offentlicher-verkehr', 'postauto', 'stzh', 'geoportal', 'tram', 'punktdaten', 'strassenbahn', 'buslinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-15T01:18:34.296050`
