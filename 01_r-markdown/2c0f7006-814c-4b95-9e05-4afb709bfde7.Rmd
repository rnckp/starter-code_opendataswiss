...
- **Keywords.de** `['vbz', 'stzh', 'vektordaten', 'postauto', 'tramlinien', 'buslinien', 'offentlicher-verkehr', 'punktdaten', 'bus', 'geoportal', 'strassenbahn', 'tram', 'vbg', 'geodaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-06T01:44:11.285261`
