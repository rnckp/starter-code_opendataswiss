...
- **Keywords.de** `['vbg', 'geoportal', 'strassenbahn', 'fundburo', 'tram', 'offentlicher-verkehr', 'punktdaten', 'vbz', 'tramlinien', 'buslinien', 'geodaten', 'vektordaten', 'postauto', 'bus', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-23T02:00:33.275746`
