...
- **Keywords.de** `['tram', 'strassenbahn', 'buslinien', 'stzh', 'punktdaten', 'tramlinien', 'postauto', 'fundburo', 'bus', 'offentlicher-verkehr', 'vbg', 'vektordaten', 'geoportal', 'vbz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-30T01:08:28.331774`
