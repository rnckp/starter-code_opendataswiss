...
- **Keywords.de** `['stzh', 'buslinien', 'offentlicher-verkehr', 'vektordaten', 'geodaten', 'vbg', 'tram', 'strassenbahn', 'bus', 'tramlinien', 'geoportal', 'postauto', 'vbz', 'punktdaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-24T01:55:52.356935`
