...
- **Keywords.de** `['geodaten', 'vbg', 'stzh', 'geoportal', 'fundburo', 'strassenbahn', 'punktdaten', 'vbz', 'tramlinien', 'vektordaten', 'bus', 'buslinien', 'tram', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-17T00:50:44.949042`
