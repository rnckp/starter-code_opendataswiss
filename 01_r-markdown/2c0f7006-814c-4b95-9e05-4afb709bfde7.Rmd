...
- **Keywords.de** `['vbg', 'bus', 'fundburo', 'stzh', 'tramlinien', 'postauto', 'geodaten', 'vbz', 'tram', 'geoportal', 'strassenbahn', 'punktdaten', 'vektordaten', 'buslinien', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-25T01:25:06.704069`
