...
- **Keywords.de** `['punktdaten', 'tramlinien', 'vbz', 'postauto', 'offentlicher-verkehr', 'vbg', 'stzh', 'bus', 'tram', 'geodaten', 'geoportal', 'fundburo', 'strassenbahn', 'buslinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-20T01:30:16.197653`
