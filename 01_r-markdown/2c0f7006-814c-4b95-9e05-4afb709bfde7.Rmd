...
- **Keywords.de** `['vbg', 'tramlinien', 'strassenbahn', 'punktdaten', 'geoportal', 'postauto', 'vektordaten', 'tram', 'stzh', 'vbz', 'offentlicher-verkehr', 'fundburo', 'geodaten', 'bus', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-04T01:40:54.934920`
