...
- **Keywords.de** `['tramlinien', 'postauto', 'geoportal', 'vektordaten', 'stzh', 'bus', 'vbg', 'fundburo', 'punktdaten', 'vbz', 'strassenbahn', 'geodaten', 'tram', 'offentlicher-verkehr', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-03T01:16:56.479648`
