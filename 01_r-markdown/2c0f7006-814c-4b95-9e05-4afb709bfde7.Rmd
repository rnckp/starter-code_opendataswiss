...
- **Keywords.de** `['geodaten', 'punktdaten', 'vbz', 'stzh', 'buslinien', 'bus', 'tram', 'offentlicher-verkehr', 'postauto', 'vbg', 'geoportal', 'vektordaten', 'fundburo', 'tramlinien', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-07T01:06:06.496468`
