...
- **Keywords.de** `['bus', 'vbg', 'stzh', 'postauto', 'geodaten', 'fundburo', 'offentlicher-verkehr', 'punktdaten', 'vektordaten', 'geoportal', 'tramlinien', 'buslinien', 'vbz', 'tram', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-20T01:14:33.290230`
