...
- **Keywords.de** `['geodaten', 'punktdaten', 'tram', 'tramlinien', 'stzh', 'bus', 'offentlicher-verkehr', 'buslinien', 'vbg', 'geoportal', 'strassenbahn', 'vbz', 'vektordaten', 'fundburo', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-03T01:17:40.379324`
