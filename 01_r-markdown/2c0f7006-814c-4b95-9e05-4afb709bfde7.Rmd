...
- **Keywords.de** `['vbz', 'tramlinien', 'bus', 'buslinien', 'vektordaten', 'strassenbahn', 'geoportal', 'punktdaten', 'geodaten', 'vbg', 'postauto', 'fundburo', 'stzh', 'tram', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-30T01:58:23.806616`
