...
- **Keywords.de** `['vbz', 'postauto', 'offentlicher-verkehr', 'geoportal', 'buslinien', 'stzh', 'tram', 'strassenbahn', 'vbg', 'vektordaten', 'bus', 'punktdaten', 'tramlinien', 'fundburo', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-19T01:39:25.464091`
