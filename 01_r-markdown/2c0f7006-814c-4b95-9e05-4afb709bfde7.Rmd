...
- **Keywords.de** `['geodaten', 'strassenbahn', 'bus', 'buslinien', 'punktdaten', 'vektordaten', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'vbz', 'vbg', 'geoportal', 'fundburo', 'tram', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-26T01:15:25.448531`
