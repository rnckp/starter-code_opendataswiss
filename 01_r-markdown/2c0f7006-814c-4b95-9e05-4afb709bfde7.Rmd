...
- **Keywords.de** `['punktdaten', 'stzh', 'vbz', 'vbg', 'geoportal', 'postauto', 'fundburo', 'bus', 'strassenbahn', 'tramlinien', 'offentlicher-verkehr', 'geodaten', 'vektordaten', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-20T01:22:35.518891`
