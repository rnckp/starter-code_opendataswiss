...
- **Keywords.de** `['vbz', 'offentlicher-verkehr', 'vbg', 'bus', 'postauto', 'stzh', 'tram', 'strassenbahn', 'vektordaten', 'geoportal', 'geodaten', 'tramlinien', 'fundburo', 'buslinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-05T01:19:58.682345`
