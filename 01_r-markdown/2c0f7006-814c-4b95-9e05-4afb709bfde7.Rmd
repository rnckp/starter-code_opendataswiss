...
- **Keywords.de** `['bus', 'vbg', 'punktdaten', 'geodaten', 'postauto', 'tramlinien', 'stzh', 'buslinien', 'geoportal', 'vektordaten', 'strassenbahn', 'tram', 'offentlicher-verkehr', 'vbz', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-17T02:27:04.571662`
