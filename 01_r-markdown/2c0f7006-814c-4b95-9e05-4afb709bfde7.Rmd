...
- **Keywords.de** `['vbg', 'postauto', 'vbz', 'tram', 'stzh', 'geoportal', 'vektordaten', 'offentlicher-verkehr', 'punktdaten', 'buslinien', 'bus', 'fundburo', 'tramlinien', 'strassenbahn', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-28T01:35:54.049857`
