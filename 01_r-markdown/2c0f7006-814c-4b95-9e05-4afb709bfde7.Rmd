...
- **Keywords.de** `['buslinien', 'vektordaten', 'geoportal', 'punktdaten', 'fundburo', 'geodaten', 'tram', 'stzh', 'postauto', 'offentlicher-verkehr', 'vbz', 'vbg', 'strassenbahn', 'bus', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-14T01:44:49.310120`
