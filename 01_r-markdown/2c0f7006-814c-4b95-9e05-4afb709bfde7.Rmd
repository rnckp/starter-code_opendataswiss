...
- **Keywords.de** `['tram', 'punktdaten', 'vbz', 'geoportal', 'buslinien', 'stzh', 'offentlicher-verkehr', 'fundburo', 'vektordaten', 'bus', 'geodaten', 'tramlinien', 'postauto', 'vbg', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-03T00:58:02.672726`
