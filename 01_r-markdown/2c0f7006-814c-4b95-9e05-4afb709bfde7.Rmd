...
- **Keywords.de** `['strassenbahn', 'geodaten', 'buslinien', 'stzh', 'vektordaten', 'punktdaten', 'vbg', 'vbz', 'tramlinien', 'fundburo', 'geoportal', 'postauto', 'tram', 'bus', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-12T01:36:51.703818`
