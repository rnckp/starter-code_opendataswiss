...
- **Keywords.de** `['postauto', 'vbz', 'fundburo', 'vektordaten', 'tramlinien', 'punktdaten', 'buslinien', 'geodaten', 'tram', 'stzh', 'geoportal', 'strassenbahn', 'vbg', 'offentlicher-verkehr', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-04T01:20:37.835013`
