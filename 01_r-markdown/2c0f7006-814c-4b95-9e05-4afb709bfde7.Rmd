...
- **Keywords.de** `['stzh', 'vbg', 'postauto', 'bus', 'fundburo', 'buslinien', 'tramlinien', 'tram', 'vbz', 'offentlicher-verkehr', 'geodaten', 'geoportal', 'strassenbahn', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-05T01:19:53.742389`
