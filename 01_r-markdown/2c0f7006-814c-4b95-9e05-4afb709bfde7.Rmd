...
- **Keywords.de** `['vbz', 'geoportal', 'offentlicher-verkehr', 'buslinien', 'vektordaten', 'strassenbahn', 'punktdaten', 'tramlinien', 'fundburo', 'stzh', 'tram', 'geodaten', 'bus', 'vbg', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-22T01:10:33.950537`
