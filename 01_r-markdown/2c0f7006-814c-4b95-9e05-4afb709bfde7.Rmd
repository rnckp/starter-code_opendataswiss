...
- **Keywords.de** `['buslinien', 'vbg', 'geoportal', 'offentlicher-verkehr', 'vektordaten', 'postauto', 'vbz', 'stzh', 'geodaten', 'strassenbahn', 'bus', 'tramlinien', 'tram', 'punktdaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-28T01:52:21.110552`
