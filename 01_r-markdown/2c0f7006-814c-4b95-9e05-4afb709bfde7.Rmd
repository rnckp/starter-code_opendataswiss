...
- **Keywords.de** `['vektordaten', 'stzh', 'strassenbahn', 'postauto', 'vbg', 'buslinien', 'tram', 'fundburo', 'bus', 'tramlinien', 'geodaten', 'geoportal', 'punktdaten', 'vbz', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-26T01:48:46.367216`
