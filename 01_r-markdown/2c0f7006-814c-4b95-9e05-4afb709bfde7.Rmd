...
- **Keywords.de** `['fundburo', 'offentlicher-verkehr', 'vektordaten', 'geodaten', 'tramlinien', 'vbg', 'punktdaten', 'stzh', 'buslinien', 'geoportal', 'postauto', 'strassenbahn', 'bus', 'tram', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-29T01:49:36.544358`
