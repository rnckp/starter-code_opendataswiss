...
- **Keywords.de** `['strassenbahn', 'vektordaten', 'vbg', 'bus', 'geodaten', 'buslinien', 'postauto', 'fundburo', 'tram', 'geoportal', 'punktdaten', 'stzh', 'tramlinien', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-18T00:57:44.483896`
