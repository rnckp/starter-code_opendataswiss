...
- **Keywords.de** `['offentlicher-verkehr', 'fundburo', 'vbz', 'tramlinien', 'buslinien', 'stzh', 'vektordaten', 'postauto', 'geoportal', 'strassenbahn', 'bus', 'vbg', 'tram', 'geodaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-13T01:22:04.186707`
