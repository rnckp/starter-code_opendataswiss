...
- **Keywords.de** `['tramlinien', 'fundburo', 'bus', 'postauto', 'offentlicher-verkehr', 'punktdaten', 'strassenbahn', 'geoportal', 'vbg', 'tram', 'geodaten', 'stzh', 'vbz', 'buslinien', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-19T01:32:48.059799`
