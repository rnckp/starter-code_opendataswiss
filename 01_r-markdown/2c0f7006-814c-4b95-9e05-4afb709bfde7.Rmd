...
- **Keywords.de** `['postauto', 'bus', 'vbz', 'tramlinien', 'vbg', 'fundburo', 'stzh', 'strassenbahn', 'buslinien', 'geoportal', 'geodaten', 'tram', 'offentlicher-verkehr', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-29T01:21:50.265058`
