...
- **Keywords.de** `['postauto', 'tram', 'vbz', 'offentlicher-verkehr', 'bus', 'punktdaten', 'vektordaten', 'tramlinien', 'buslinien', 'stzh', 'fundburo', 'geodaten', 'strassenbahn', 'vbg', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-10T01:11:22.185819`
