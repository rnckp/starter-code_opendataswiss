...
- **Keywords.de** `['buslinien', 'tram', 'punktdaten', 'geodaten', 'postauto', 'bus', 'vbz', 'strassenbahn', 'fundburo', 'offentlicher-verkehr', 'vektordaten', 'stzh', 'tramlinien', 'vbg', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-18T01:14:35.568917`
