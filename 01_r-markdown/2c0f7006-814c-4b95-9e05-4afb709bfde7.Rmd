...
- **Keywords.de** `['punktdaten', 'offentlicher-verkehr', 'geodaten', 'postauto', 'tramlinien', 'stzh', 'vbg', 'geoportal', 'buslinien', 'bus', 'strassenbahn', 'vbz', 'vektordaten', 'tram', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-26T01:17:27.355921`
