...
- **Keywords.de** `['geoportal', 'vbg', 'tramlinien', 'vbz', 'tram', 'punktdaten', 'buslinien', 'bus', 'strassenbahn', 'offentlicher-verkehr', 'stzh', 'vektordaten', 'postauto', 'fundburo', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-18T01:13:40.520913`
