...
- **Keywords.de** `['vektordaten', 'punktdaten', 'buslinien', 'stzh', 'bus', 'vbz', 'tramlinien', 'postauto', 'tram', 'geoportal', 'geodaten', 'vbg', 'strassenbahn', 'offentlicher-verkehr', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-20T01:19:00.863343`
