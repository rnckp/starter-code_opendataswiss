...
- **Keywords.de** `['geoportal', 'geodaten', 'stzh', 'vbg', 'bus', 'postauto', 'tramlinien', 'buslinien', 'fundburo', 'punktdaten', 'vbz', 'strassenbahn', 'offentlicher-verkehr', 'tram', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-09T01:11:23.584293`
