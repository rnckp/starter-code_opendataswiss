...
- **Keywords.de** `['bus', 'tramlinien', 'geoportal', 'fundburo', 'strassenbahn', 'offentlicher-verkehr', 'stzh', 'geodaten', 'tram', 'postauto', 'punktdaten', 'vbz', 'vektordaten', 'buslinien', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-09T01:21:52.351917`
