...
- **Keywords.de** `['strassenbahn', 'stzh', 'geoportal', 'bus', 'vbz', 'punktdaten', 'buslinien', 'tram', 'geodaten', 'fundburo', 'offentlicher-verkehr', 'postauto', 'tramlinien', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-06T01:25:29.444807`
