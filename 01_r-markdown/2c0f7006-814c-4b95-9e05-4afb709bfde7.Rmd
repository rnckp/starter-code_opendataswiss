...
- **Keywords.de** `['buslinien', 'vbg', 'geoportal', 'postauto', 'offentlicher-verkehr', 'vbz', 'bus', 'vektordaten', 'geodaten', 'punktdaten', 'fundburo', 'tram', 'tramlinien', 'stzh', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-06T01:27:07.714881`
