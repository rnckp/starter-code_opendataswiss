...
- **Keywords.de** `['stzh', 'offentlicher-verkehr', 'fundburo', 'bus', 'vbz', 'tramlinien', 'geodaten', 'vbg', 'geoportal', 'buslinien', 'tram', 'punktdaten', 'vektordaten', 'postauto', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-01T01:36:00.013094`
