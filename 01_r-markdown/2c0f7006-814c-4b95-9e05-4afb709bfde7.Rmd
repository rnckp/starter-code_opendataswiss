...
- **Keywords.de** `['tram', 'punktdaten', 'vektordaten', 'offentlicher-verkehr', 'geodaten', 'buslinien', 'tramlinien', 'bus', 'vbg', 'fundburo', 'stzh', 'vbz', 'strassenbahn', 'geoportal', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-27T01:18:28.614847`
