...
- **Keywords.de** `['punktdaten', 'vbg', 'geodaten', 'tramlinien', 'tram', 'bus', 'geoportal', 'vektordaten', 'buslinien', 'fundburo', 'postauto', 'offentlicher-verkehr', 'stzh', 'strassenbahn', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-24T01:44:12.571515`
