...
- **Keywords.de** `['vbz', 'strassenbahn', 'tram', 'geoportal', 'buslinien', 'vbg', 'stzh', 'geodaten', 'postauto', 'bus', 'fundburo', 'punktdaten', 'tramlinien', 'offentlicher-verkehr', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-30T01:32:12.066719`
