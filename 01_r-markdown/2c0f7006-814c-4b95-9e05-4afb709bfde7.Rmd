...
- **Keywords.de** `['offentlicher-verkehr', 'strassenbahn', 'vektordaten', 'tram', 'stzh', 'buslinien', 'tramlinien', 'punktdaten', 'postauto', 'fundburo', 'geoportal', 'vbg', 'bus', 'vbz', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-12T01:17:18.561365`
