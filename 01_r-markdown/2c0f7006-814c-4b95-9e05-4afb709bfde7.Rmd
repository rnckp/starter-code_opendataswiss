...
- **Keywords.de** `['tram', 'offentlicher-verkehr', 'tramlinien', 'stzh', 'buslinien', 'fundburo', 'punktdaten', 'geoportal', 'vbg', 'vektordaten', 'geodaten', 'vbz', 'bus', 'postauto', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-22T00:56:16.248824`
