...
- **Keywords.de** `['geoportal', 'stzh', 'punktdaten', 'tramlinien', 'offentlicher-verkehr', 'strassenbahn', 'tram', 'vektordaten', 'fundburo', 'vbz', 'postauto', 'geodaten', 'bus', 'vbg', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-01T02:22:13.458673`
