...
- **Keywords.de** `['punktdaten', 'vbg', 'geoportal', 'postauto', 'bus', 'tramlinien', 'geodaten', 'fundburo', 'stzh', 'offentlicher-verkehr', 'buslinien', 'tram', 'vbz', 'vektordaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-07T02:05:03.847729`
