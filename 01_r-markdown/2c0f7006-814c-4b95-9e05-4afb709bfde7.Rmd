...
- **Keywords.de** `['strassenbahn', 'tramlinien', 'bus', 'postauto', 'buslinien', 'stzh', 'vbz', 'fundburo', 'geodaten', 'geoportal', 'punktdaten', 'vektordaten', 'offentlicher-verkehr', 'tram', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-19T01:19:59.823240`
