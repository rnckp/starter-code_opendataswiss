...
- **Keywords.de** `['buslinien', 'stzh', 'vbg', 'tram', 'vektordaten', 'strassenbahn', 'geodaten', 'offentlicher-verkehr', 'fundburo', 'geoportal', 'postauto', 'bus', 'punktdaten', 'vbz', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-12T01:54:00.647484`
