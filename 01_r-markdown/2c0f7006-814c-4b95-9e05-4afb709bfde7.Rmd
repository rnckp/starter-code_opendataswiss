...
- **Keywords.de** `['strassenbahn', 'stzh', 'geodaten', 'buslinien', 'bus', 'vektordaten', 'vbz', 'fundburo', 'tram', 'tramlinien', 'vbg', 'punktdaten', 'offentlicher-verkehr', 'postauto', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-24T01:07:46.780575`
