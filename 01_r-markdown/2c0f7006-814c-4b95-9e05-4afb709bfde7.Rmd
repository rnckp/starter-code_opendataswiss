...
- **Keywords.de** `['offentlicher-verkehr', 'bus', 'postauto', 'vektordaten', 'vbg', 'geoportal', 'tramlinien', 'buslinien', 'fundburo', 'vbz', 'geodaten', 'tram', 'strassenbahn', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-20T01:19:10.210080`
