...
- **Keywords.de** `['buslinien', 'strassenbahn', 'vbg', 'stzh', 'geodaten', 'bus', 'offentlicher-verkehr', 'postauto', 'vbz', 'tramlinien', 'fundburo', 'punktdaten', 'tram', 'vektordaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-08T02:48:56.804433`
