...
- **Keywords.de** `['stzh', 'vektordaten', 'strassenbahn', 'vbz', 'tramlinien', 'buslinien', 'postauto', 'tram', 'geodaten', 'fundburo', 'punktdaten', 'vbg', 'offentlicher-verkehr', 'bus', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-23T01:19:55.768454`
