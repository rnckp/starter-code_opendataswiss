...
- **Keywords.de** `['strassenbahn', 'tram', 'geodaten', 'bus', 'geoportal', 'buslinien', 'stzh', 'tramlinien', 'punktdaten', 'fundburo', 'postauto', 'offentlicher-verkehr', 'vektordaten', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-03T02:06:20.255354`
