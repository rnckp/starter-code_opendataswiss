...
- **Keywords.de** `['postauto', 'offentlicher-verkehr', 'stzh', 'strassenbahn', 'tram', 'geoportal', 'bus', 'punktdaten', 'geodaten', 'vbz', 'fundburo', 'buslinien', 'vbg', 'vektordaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-22T02:34:59.650205`
