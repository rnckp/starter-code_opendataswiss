...
- **Keywords.de** `['fundburo', 'geoportal', 'bus', 'offentlicher-verkehr', 'postauto', 'vbg', 'tram', 'vbz', 'stzh', 'tramlinien', 'buslinien', 'punktdaten', 'strassenbahn', 'geodaten', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-20T01:15:29.201772`
