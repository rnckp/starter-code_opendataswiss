...
- **Keywords.de** `['fundburo', 'vbz', 'bus', 'geoportal', 'postauto', 'buslinien', 'stzh', 'tramlinien', 'tram', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'vektordaten', 'vbg', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-05T01:44:49.477718`
