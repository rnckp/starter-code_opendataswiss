...
- **Keywords.de** `['geodaten', 'geoportal', 'postauto', 'bus', 'strassenbahn', 'offentlicher-verkehr', 'vektordaten', 'vbg', 'tramlinien', 'punktdaten', 'buslinien', 'vbz', 'stzh', 'tram', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-21T00:56:25.851363`
