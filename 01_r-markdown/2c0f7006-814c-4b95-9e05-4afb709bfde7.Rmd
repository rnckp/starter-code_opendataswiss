...
- **Keywords.de** `['fundburo', 'tramlinien', 'vbg', 'postauto', 'stzh', 'strassenbahn', 'bus', 'punktdaten', 'vbz', 'buslinien', 'geodaten', 'offentlicher-verkehr', 'geoportal', 'vektordaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-08T01:22:24.422005`
