...
- **Keywords.de** `['vektordaten', 'tramlinien', 'vbg', 'vbz', 'fundburo', 'punktdaten', 'geoportal', 'strassenbahn', 'bus', 'offentlicher-verkehr', 'buslinien', 'postauto', 'stzh', 'geodaten', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-16T01:04:21.759377`
