...
- **Keywords.de** `['buslinien', 'vbg', 'tramlinien', 'fundburo', 'stzh', 'vbz', 'tram', 'offentlicher-verkehr', 'punktdaten', 'strassenbahn', 'geoportal', 'bus', 'geodaten', 'vektordaten', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-19T01:50:57.616558`
