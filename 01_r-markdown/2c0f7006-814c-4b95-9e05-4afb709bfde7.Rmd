...
- **Keywords.de** `['offentlicher-verkehr', 'strassenbahn', 'buslinien', 'stzh', 'geoportal', 'vbg', 'fundburo', 'postauto', 'vektordaten', 'tramlinien', 'bus', 'punktdaten', 'geodaten', 'tram', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-14T01:05:58.724718`
