...
- **Keywords.de** `['buslinien', 'vbz', 'bus', 'vektordaten', 'punktdaten', 'geodaten', 'geoportal', 'vbg', 'postauto', 'tramlinien', 'strassenbahn', 'fundburo', 'stzh', 'offentlicher-verkehr', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-02T01:24:38.445586`
