...
- **Keywords.de** `['bus', 'buslinien', 'punktdaten', 'geoportal', 'offentlicher-verkehr', 'postauto', 'vektordaten', 'geodaten', 'tram', 'vbz', 'tramlinien', 'fundburo', 'vbg', 'stzh', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-04T01:09:40.344942`
