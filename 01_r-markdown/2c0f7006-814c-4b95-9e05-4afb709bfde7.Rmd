...
- **Keywords.de** `['bus', 'geodaten', 'fundburo', 'vektordaten', 'postauto', 'punktdaten', 'vbg', 'stzh', 'tramlinien', 'tram', 'vbz', 'strassenbahn', 'buslinien', 'offentlicher-verkehr', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-17T01:32:30.542650`
