...
- **Keywords.de** `['geoportal', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'vbg', 'vektordaten', 'vbz', 'strassenbahn', 'fundburo', 'stzh', 'bus', 'tram', 'tramlinien', 'buslinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-03T01:24:04.565200`
