...
- **Keywords.de** `['strassenbahn', 'postauto', 'punktdaten', 'buslinien', 'geodaten', 'tramlinien', 'tram', 'geoportal', 'bus', 'vektordaten', 'offentlicher-verkehr', 'fundburo', 'stzh', 'vbz', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-23T01:16:18.089977`
