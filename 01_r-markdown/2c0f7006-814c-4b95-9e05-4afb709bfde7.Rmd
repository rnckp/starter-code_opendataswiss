...
- **Keywords.de** `['buslinien', 'vektordaten', 'vbg', 'stzh', 'tram', 'postauto', 'geodaten', 'geoportal', 'fundburo', 'tramlinien', 'punktdaten', 'bus', 'offentlicher-verkehr', 'strassenbahn', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-23T01:22:00.477372`
