...
- **Keywords.de** `['geodaten', 'tramlinien', 'stzh', 'fundburo', 'geoportal', 'vektordaten', 'punktdaten', 'vbz', 'tram', 'bus', 'strassenbahn', 'vbg', 'buslinien', 'offentlicher-verkehr', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-18T01:43:02.280634`
