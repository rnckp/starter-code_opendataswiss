...
- **Keywords.de** `['strassenbahn', 'bus', 'offentlicher-verkehr', 'vektordaten', 'postauto', 'vbg', 'vbz', 'geoportal', 'tram', 'buslinien', 'tramlinien', 'fundburo', 'punktdaten', 'geodaten', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-09T01:51:19.079750`
