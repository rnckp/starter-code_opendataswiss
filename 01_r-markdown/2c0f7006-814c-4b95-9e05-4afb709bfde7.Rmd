...
- **Keywords.de** `['vektordaten', 'bus', 'punktdaten', 'buslinien', 'strassenbahn', 'offentlicher-verkehr', 'geoportal', 'vbz', 'geodaten', 'stzh', 'postauto', 'tramlinien', 'fundburo', 'vbg', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-16T01:04:38.199670`
