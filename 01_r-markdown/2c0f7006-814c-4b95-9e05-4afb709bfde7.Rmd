...
- **Keywords.de** `['geodaten', 'stzh', 'fundburo', 'vbz', 'tram', 'tramlinien', 'strassenbahn', 'postauto', 'geoportal', 'vbg', 'vektordaten', 'bus', 'buslinien', 'punktdaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-11T01:40:05.345808`
