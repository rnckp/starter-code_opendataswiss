...
- **Keywords.de** `['geoportal', 'geodaten', 'vbz', 'punktdaten', 'postauto', 'strassenbahn', 'tram', 'fundburo', 'offentlicher-verkehr', 'buslinien', 'vektordaten', 'vbg', 'bus', 'stzh', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-16T01:22:18.968368`
