...
- **Keywords.de** `['vektordaten', 'offentlicher-verkehr', 'postauto', 'punktdaten', 'tramlinien', 'stzh', 'tram', 'fundburo', 'strassenbahn', 'geodaten', 'geoportal', 'bus', 'vbg', 'vbz', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-02T01:28:15.740071`
