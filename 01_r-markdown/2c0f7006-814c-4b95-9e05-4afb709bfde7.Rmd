...
- **Keywords.de** `['vbz', 'buslinien', 'bus', 'punktdaten', 'offentlicher-verkehr', 'strassenbahn', 'tramlinien', 'fundburo', 'tram', 'postauto', 'geodaten', 'geoportal', 'stzh', 'vbg', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-18T01:03:46.612071`
