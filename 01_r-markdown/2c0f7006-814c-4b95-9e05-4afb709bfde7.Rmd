...
- **Keywords.de** `['buslinien', 'vektordaten', 'bus', 'postauto', 'fundburo', 'vbz', 'tramlinien', 'geoportal', 'geodaten', 'stzh', 'strassenbahn', 'tram', 'offentlicher-verkehr', 'punktdaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-26T01:42:46.372304`
