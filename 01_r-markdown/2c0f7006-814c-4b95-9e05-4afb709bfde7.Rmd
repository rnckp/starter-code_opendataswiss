...
- **Keywords.de** `['tramlinien', 'vbz', 'geodaten', 'punktdaten', 'bus', 'geoportal', 'strassenbahn', 'vektordaten', 'stzh', 'buslinien', 'offentlicher-verkehr', 'postauto', 'fundburo', 'vbg', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-29T01:02:25.542719`
