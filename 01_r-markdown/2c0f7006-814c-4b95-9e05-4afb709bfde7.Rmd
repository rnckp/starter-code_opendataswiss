...
- **Keywords.de** `['stzh', 'bus', 'offentlicher-verkehr', 'buslinien', 'punktdaten', 'fundburo', 'postauto', 'strassenbahn', 'vektordaten', 'vbg', 'tram', 'vbz', 'geoportal', 'geodaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-02T01:25:04.320025`
