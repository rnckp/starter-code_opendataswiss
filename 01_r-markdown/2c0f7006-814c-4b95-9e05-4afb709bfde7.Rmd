...
- **Keywords.de** `['tram', 'offentlicher-verkehr', 'vektordaten', 'bus', 'geodaten', 'stzh', 'strassenbahn', 'tramlinien', 'geoportal', 'buslinien', 'postauto', 'punktdaten', 'vbz', 'vbg', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-04T01:12:23.060333`
