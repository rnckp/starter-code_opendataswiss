...
- **Keywords.de** `['punktdaten', 'geoportal', 'vektordaten', 'bus', 'strassenbahn', 'offentlicher-verkehr', 'fundburo', 'stzh', 'vbg', 'postauto', 'geodaten', 'tramlinien', 'tram', 'vbz', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-09T01:18:41.959499`
