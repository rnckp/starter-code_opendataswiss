...
- **Keywords.de** `['offentlicher-verkehr', 'punktdaten', 'vbg', 'stzh', 'buslinien', 'vektordaten', 'postauto', 'tramlinien', 'fundburo', 'bus', 'strassenbahn', 'geodaten', 'tram', 'geoportal', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-19T01:41:01.830831`
