...
- **Keywords.de** `['buslinien', 'offentlicher-verkehr', 'fundburo', 'tram', 'vbg', 'geodaten', 'geoportal', 'punktdaten', 'bus', 'stzh', 'vektordaten', 'strassenbahn', 'vbz', 'tramlinien', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-11T01:30:33.719639`
