...
- **Keywords.de** `['vbg', 'offentlicher-verkehr', 'stzh', 'vbz', 'bus', 'tram', 'geodaten', 'geoportal', 'punktdaten', 'tramlinien', 'postauto', 'vektordaten', 'strassenbahn', 'buslinien', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-28T01:22:15.955912`
