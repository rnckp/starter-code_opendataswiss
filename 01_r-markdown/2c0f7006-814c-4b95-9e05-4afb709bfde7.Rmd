...
- **Keywords.de** `['fundburo', 'strassenbahn', 'punktdaten', 'tramlinien', 'tram', 'vbg', 'bus', 'buslinien', 'offentlicher-verkehr', 'geoportal', 'stzh', 'geodaten', 'postauto', 'vbz', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-13T01:19:46.070601`
