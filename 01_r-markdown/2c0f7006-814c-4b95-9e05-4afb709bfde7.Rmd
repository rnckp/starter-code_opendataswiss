...
- **Keywords.de** `['vektordaten', 'tramlinien', 'geoportal', 'punktdaten', 'bus', 'tram', 'stzh', 'vbg', 'postauto', 'buslinien', 'strassenbahn', 'vbz', 'geodaten', 'fundburo', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-12T01:09:33.592318`
