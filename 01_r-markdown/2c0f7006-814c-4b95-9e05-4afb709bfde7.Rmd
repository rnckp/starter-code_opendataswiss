...
- **Keywords.de** `['geoportal', 'tram', 'offentlicher-verkehr', 'buslinien', 'tramlinien', 'stzh', 'vektordaten', 'punktdaten', 'postauto', 'vbz', 'strassenbahn', 'fundburo', 'geodaten', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-14T01:02:52.914997`
