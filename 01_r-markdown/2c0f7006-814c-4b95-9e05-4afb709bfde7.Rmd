...
- **Keywords.de** `['geoportal', 'bus', 'vektordaten', 'strassenbahn', 'fundburo', 'stzh', 'tramlinien', 'buslinien', 'vbg', 'geodaten', 'tram', 'vbz', 'offentlicher-verkehr', 'postauto', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-25T01:41:38.736542`
