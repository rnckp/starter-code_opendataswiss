...
- **Keywords.de** `['punktdaten', 'buslinien', 'tram', 'tramlinien', 'vektordaten', 'vbz', 'bus', 'stzh', 'postauto', 'offentlicher-verkehr', 'strassenbahn', 'fundburo', 'geoportal', 'geodaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-02T01:13:42.062550`
