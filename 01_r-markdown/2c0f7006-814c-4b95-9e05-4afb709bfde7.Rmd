...
- **Keywords.de** `['punktdaten', 'tramlinien', 'buslinien', 'vektordaten', 'strassenbahn', 'postauto', 'fundburo', 'geoportal', 'tram', 'bus', 'offentlicher-verkehr', 'vbg', 'geodaten', 'vbz', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-18T01:46:38.212378`
