...
- **Keywords.de** `['buslinien', 'geoportal', 'fundburo', 'tram', 'offentlicher-verkehr', 'vbz', 'geodaten', 'bus', 'vektordaten', 'tramlinien', 'stzh', 'strassenbahn', 'punktdaten', 'vbg', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-17T01:27:10.206491`
