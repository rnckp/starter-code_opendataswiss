...
- **Keywords.de** `['buslinien', 'geoportal', 'bus', 'vbg', 'geodaten', 'strassenbahn', 'stzh', 'vektordaten', 'offentlicher-verkehr', 'fundburo', 'postauto', 'vbz', 'tram', 'punktdaten', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-29T01:20:10.111188`
