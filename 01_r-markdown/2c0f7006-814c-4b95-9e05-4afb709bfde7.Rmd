...
- **Keywords.de** `['geodaten', 'buslinien', 'vbz', 'punktdaten', 'fundburo', 'geoportal', 'bus', 'stzh', 'strassenbahn', 'tramlinien', 'vektordaten', 'offentlicher-verkehr', 'vbg', 'tram', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-27T01:04:51.274953`
