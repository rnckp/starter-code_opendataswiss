...
- **Keywords.de** `['vbz', 'geodaten', 'offentlicher-verkehr', 'vbg', 'stzh', 'bus', 'vektordaten', 'postauto', 'strassenbahn', 'fundburo', 'punktdaten', 'tramlinien', 'buslinien', 'geoportal', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-16T01:21:23.128863`
