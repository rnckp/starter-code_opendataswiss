...
- **Keywords.de** `['tramlinien', 'tram', 'stzh', 'offentlicher-verkehr', 'vbg', 'strassenbahn', 'vektordaten', 'geodaten', 'postauto', 'bus', 'geoportal', 'fundburo', 'vbz', 'punktdaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-03T01:03:02.524643`
