...
- **Keywords.de** `['vbg', 'bus', 'strassenbahn', 'buslinien', 'vektordaten', 'postauto', 'tramlinien', 'geoportal', 'punktdaten', 'fundburo', 'offentlicher-verkehr', 'vbz', 'stzh', 'tram', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-02T01:20:50.243748`
