...
- **Keywords.de** `['vbz', 'vektordaten', 'geodaten', 'stzh', 'vbg', 'geoportal', 'strassenbahn', 'postauto', 'offentlicher-verkehr', 'bus', 'buslinien', 'tram', 'fundburo', 'tramlinien', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-01T01:30:16.179196`
