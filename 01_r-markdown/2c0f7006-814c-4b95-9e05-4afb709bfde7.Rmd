...
- **Keywords.de** `['buslinien', 'punktdaten', 'tramlinien', 'tram', 'fundburo', 'geoportal', 'geodaten', 'stzh', 'vbz', 'vektordaten', 'offentlicher-verkehr', 'vbg', 'bus', 'postauto', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-14T01:03:58.184947`
