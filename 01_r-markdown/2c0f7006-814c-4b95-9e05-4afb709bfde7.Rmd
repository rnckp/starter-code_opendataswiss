...
- **Keywords.de** `['stzh', 'buslinien', 'punktdaten', 'vektordaten', 'strassenbahn', 'tram', 'fundburo', 'geoportal', 'bus', 'offentlicher-verkehr', 'tramlinien', 'geodaten', 'vbg', 'postauto', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-18T01:23:21.909851`
