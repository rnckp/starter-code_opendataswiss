...
- **Keywords.de** `['postauto', 'strassenbahn', 'offentlicher-verkehr', 'geoportal', 'tramlinien', 'fundburo', 'buslinien', 'tram', 'stzh', 'vbz', 'geodaten', 'vbg', 'bus', 'vektordaten', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-11T01:18:24.681974`
