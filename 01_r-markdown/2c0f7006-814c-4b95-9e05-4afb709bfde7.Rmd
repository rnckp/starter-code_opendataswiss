...
- **Keywords.de** `['bus', 'strassenbahn', 'stzh', 'postauto', 'geodaten', 'fundburo', 'punktdaten', 'buslinien', 'tram', 'offentlicher-verkehr', 'vektordaten', 'tramlinien', 'vbz', 'vbg', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-25T01:23:47.180672`
