...
- **Keywords.de** `['punktdaten', 'bus', 'geodaten', 'postauto', 'stzh', 'offentlicher-verkehr', 'vbg', 'tram', 'vbz', 'buslinien', 'strassenbahn', 'fundburo', 'tramlinien', 'geoportal', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-05T01:24:23.316596`
