...
- **Keywords.de** `['tramlinien', 'geodaten', 'offentlicher-verkehr', 'strassenbahn', 'postauto', 'punktdaten', 'vbg', 'tram', 'stzh', 'vbz', 'buslinien', 'geoportal', 'fundburo', 'bus', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-06T01:22:45.435404`
