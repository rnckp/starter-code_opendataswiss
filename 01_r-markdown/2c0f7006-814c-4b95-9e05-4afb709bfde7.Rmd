...
- **Keywords.de** `['punktdaten', 'tram', 'vbz', 'geodaten', 'tramlinien', 'postauto', 'buslinien', 'vbg', 'strassenbahn', 'fundburo', 'stzh', 'bus', 'geoportal', 'offentlicher-verkehr', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-22T01:14:17.752225`
