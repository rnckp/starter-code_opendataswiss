...
- **Keywords.de** `['buslinien', 'fundburo', 'vbg', 'bus', 'offentlicher-verkehr', 'vektordaten', 'geoportal', 'tram', 'stzh', 'postauto', 'strassenbahn', 'tramlinien', 'geodaten', 'punktdaten', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-11-01T01:48:39.219037`
