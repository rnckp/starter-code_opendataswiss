...
- **Keywords.de** `['postauto', 'stzh', 'tramlinien', 'buslinien', 'geodaten', 'strassenbahn', 'tram', 'vbg', 'vbz', 'geoportal', 'offentlicher-verkehr', 'punktdaten', 'fundburo', 'bus', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-24T01:36:11.554393`
