...
- **Keywords.de** `['geodaten', 'vektordaten', 'stzh', 'punktdaten', 'buslinien', 'tram', 'tramlinien', 'vbz', 'bus', 'postauto', 'geoportal', 'offentlicher-verkehr', 'strassenbahn', 'fundburo', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-08T01:02:31.610031`
