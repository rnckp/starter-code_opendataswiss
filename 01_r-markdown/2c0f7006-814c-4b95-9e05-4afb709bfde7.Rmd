...
- **Keywords.de** `['vbz', 'vbg', 'postauto', 'vektordaten', 'tramlinien', 'geoportal', 'fundburo', 'buslinien', 'stzh', 'offentlicher-verkehr', 'strassenbahn', 'punktdaten', 'bus', 'tram', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-24T01:27:08.668401`
