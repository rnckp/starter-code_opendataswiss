...
- **Keywords.de** `['punktdaten', 'stzh', 'vbz', 'strassenbahn', 'vbg', 'tram', 'geoportal', 'postauto', 'bus', 'buslinien', 'tramlinien', 'vektordaten', 'offentlicher-verkehr', 'geodaten', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-01T01:35:57.123407`
