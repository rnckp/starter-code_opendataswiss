...
- **Keywords.de** `['postauto', 'vbz', 'geoportal', 'strassenbahn', 'offentlicher-verkehr', 'geodaten', 'bus', 'tramlinien', 'buslinien', 'fundburo', 'punktdaten', 'vbg', 'stzh', 'tram', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-06T01:15:23.363865`
