...
- **Keywords.de** `['punktdaten', 'postauto', 'tramlinien', 'vektordaten', 'tram', 'geodaten', 'geoportal', 'offentlicher-verkehr', 'buslinien', 'stzh', 'strassenbahn', 'bus', 'vbg', 'fundburo', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-10T01:08:10.049927`
