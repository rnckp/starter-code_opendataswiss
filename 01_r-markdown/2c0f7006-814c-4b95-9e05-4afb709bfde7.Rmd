...
- **Keywords.de** `['tramlinien', 'geodaten', 'geoportal', 'postauto', 'vbg', 'vbz', 'bus', 'offentlicher-verkehr', 'punktdaten', 'tram', 'fundburo', 'vektordaten', 'buslinien', 'stzh', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-15T01:34:34.326047`
