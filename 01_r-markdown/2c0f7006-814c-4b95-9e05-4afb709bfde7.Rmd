...
- **Keywords.de** `['postauto', 'strassenbahn', 'tramlinien', 'buslinien', 'tram', 'offentlicher-verkehr', 'geodaten', 'vektordaten', 'fundburo', 'stzh', 'bus', 'punktdaten', 'vbg', 'geoportal', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-26T01:25:47.232417`
