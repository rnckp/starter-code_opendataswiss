...
- **Keywords.de** `['tramlinien', 'stzh', 'vektordaten', 'postauto', 'vbg', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'tram', 'bus', 'geoportal', 'vbz', 'strassenbahn', 'buslinien', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-09T01:01:12.780039`
