...
- **Keywords.de** `['geodaten', 'strassenbahn', 'fundburo', 'vektordaten', 'vbg', 'postauto', 'punktdaten', 'stzh', 'bus', 'tramlinien', 'vbz', 'buslinien', 'tram', 'offentlicher-verkehr', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-27T01:42:01.680502`
