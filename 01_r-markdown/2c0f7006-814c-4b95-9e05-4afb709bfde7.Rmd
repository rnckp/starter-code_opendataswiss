...
- **Keywords.de** `['vbz', 'postauto', 'tramlinien', 'bus', 'punktdaten', 'fundburo', 'stzh', 'vektordaten', 'vbg', 'geodaten', 'strassenbahn', 'offentlicher-verkehr', 'geoportal', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-29T02:13:45.224560`
