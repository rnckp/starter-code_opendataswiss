...
- **Keywords.de** `['stzh', 'fundburo', 'buslinien', 'vektordaten', 'offentlicher-verkehr', 'geoportal', 'strassenbahn', 'tram', 'geodaten', 'punktdaten', 'tramlinien', 'bus', 'postauto', 'vbg', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-11-03T02:41:42.759273`
