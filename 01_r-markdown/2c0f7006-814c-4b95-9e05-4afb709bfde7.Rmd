...
- **Keywords.de** `['stzh', 'bus', 'postauto', 'fundburo', 'geodaten', 'geoportal', 'buslinien', 'strassenbahn', 'offentlicher-verkehr', 'vbg', 'tram', 'tramlinien', 'vektordaten', 'vbz', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-15T01:15:26.913531`
