...
- **Keywords.de** `['postauto', 'bus', 'tram', 'strassenbahn', 'vbg', 'buslinien', 'geodaten', 'stzh', 'vektordaten', 'offentlicher-verkehr', 'punktdaten', 'fundburo', 'vbz', 'geoportal', 'tramlinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-22T01:27:29.155847`
