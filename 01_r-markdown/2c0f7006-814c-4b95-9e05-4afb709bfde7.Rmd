...
- **Keywords.de** `['stzh', 'punktdaten', 'bus', 'strassenbahn', 'fundburo', 'buslinien', 'postauto', 'geodaten', 'vbz', 'tram', 'vektordaten', 'tramlinien', 'offentlicher-verkehr', 'geoportal', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-13T01:07:34.928297`
