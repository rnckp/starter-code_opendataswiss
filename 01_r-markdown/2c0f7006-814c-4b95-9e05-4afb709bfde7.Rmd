...
- **Keywords.de** `['punktdaten', 'vbg', 'vbz', 'buslinien', 'strassenbahn', 'geoportal', 'stzh', 'postauto', 'offentlicher-verkehr', 'tram', 'bus', 'fundburo', 'vektordaten', 'tramlinien', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-25T01:13:06.138873`
