...
- **Keywords.de** `['punktdaten', 'fundburo', 'vektordaten', 'strassenbahn', 'tramlinien', 'bus', 'postauto', 'vbz', 'geoportal', 'vbg', 'tram', 'stzh', 'buslinien', 'geodaten', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-20T01:22:51.354162`
