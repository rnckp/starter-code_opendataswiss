...
- **Keywords.de** `['fundburo', 'tramlinien', 'stzh', 'vektordaten', 'postauto', 'geoportal', 'buslinien', 'geodaten', 'tram', 'vbz', 'strassenbahn', 'punktdaten', 'bus', 'offentlicher-verkehr', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-24T00:54:11.764706`
