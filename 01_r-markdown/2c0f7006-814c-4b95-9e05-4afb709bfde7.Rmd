...
- **Keywords.de** `['stzh', 'vbz', 'geoportal', 'geodaten', 'punktdaten', 'vbg', 'postauto', 'fundburo', 'strassenbahn', 'tramlinien', 'vektordaten', 'bus', 'offentlicher-verkehr', 'buslinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-01T01:14:57.489665`
