...
- **Keywords.de** `['stzh', 'tram', 'fundburo', 'punktdaten', 'vbg', 'postauto', 'bus', 'buslinien', 'geoportal', 'offentlicher-verkehr', 'tramlinien', 'geodaten', 'vektordaten', 'vbz', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-02T01:19:16.051997`
