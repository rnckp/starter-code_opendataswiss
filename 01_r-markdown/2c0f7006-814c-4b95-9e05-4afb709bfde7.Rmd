...
- **Keywords.de** `['vbz', 'tramlinien', 'postauto', 'strassenbahn', 'tram', 'punktdaten', 'stzh', 'bus', 'vektordaten', 'vbg', 'geodaten', 'buslinien', 'offentlicher-verkehr', 'fundburo', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-20T01:26:31.131917`
