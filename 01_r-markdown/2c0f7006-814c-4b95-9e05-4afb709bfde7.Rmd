...
- **Keywords.de** `['stzh', 'bus', 'fundburo', 'vbz', 'strassenbahn', 'geoportal', 'buslinien', 'geodaten', 'postauto', 'tramlinien', 'vektordaten', 'tram', 'vbg', 'offentlicher-verkehr', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-30T01:17:51.848208`
