...
- **Keywords.de** `['stzh', 'vektordaten', 'vbg', 'vbz', 'geoportal', 'tramlinien', 'bus', 'tram', 'postauto', 'punktdaten', 'buslinien', 'strassenbahn', 'fundburo', 'offentlicher-verkehr', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-02T01:18:47.546402`
