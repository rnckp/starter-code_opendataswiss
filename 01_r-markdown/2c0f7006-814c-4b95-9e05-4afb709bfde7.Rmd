...
- **Keywords.de** `['fundburo', 'strassenbahn', 'tram', 'geoportal', 'offentlicher-verkehr', 'buslinien', 'postauto', 'vbz', 'punktdaten', 'vbg', 'stzh', 'geodaten', 'vektordaten', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-02T01:18:16.744752`
