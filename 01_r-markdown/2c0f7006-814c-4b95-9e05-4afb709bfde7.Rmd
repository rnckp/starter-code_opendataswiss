...
- **Keywords.de** `['fundburo', 'vektordaten', 'strassenbahn', 'tramlinien', 'vbz', 'stzh', 'buslinien', 'tram', 'offentlicher-verkehr', 'postauto', 'geodaten', 'punktdaten', 'geoportal', 'bus', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-25T01:17:37.185993`
