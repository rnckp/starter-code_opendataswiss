...
- **Keywords.de** `['vbg', 'geodaten', 'strassenbahn', 'geoportal', 'bus', 'tramlinien', 'stzh', 'punktdaten', 'fundburo', 'buslinien', 'vektordaten', 'postauto', 'tram', 'offentlicher-verkehr', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-06T01:41:30.866261`
