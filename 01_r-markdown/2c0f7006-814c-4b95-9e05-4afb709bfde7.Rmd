...
- **Keywords.de** `['geoportal', 'postauto', 'stzh', 'punktdaten', 'strassenbahn', 'offentlicher-verkehr', 'tram', 'tramlinien', 'geodaten', 'bus', 'vbg', 'vektordaten', 'fundburo', 'vbz', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-02-09T01:13:56.851367`
