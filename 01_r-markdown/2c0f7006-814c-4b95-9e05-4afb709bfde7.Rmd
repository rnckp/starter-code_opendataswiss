...
- **Keywords.de** `['stzh', 'geoportal', 'bus', 'postauto', 'punktdaten', 'vektordaten', 'vbg', 'fundburo', 'tram', 'tramlinien', 'offentlicher-verkehr', 'geodaten', 'strassenbahn', 'buslinien', 'vbz']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-21T01:25:06.153616`
