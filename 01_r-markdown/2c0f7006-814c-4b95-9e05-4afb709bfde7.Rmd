...
- **Keywords.de** `['geodaten', 'tram', 'postauto', 'vektordaten', 'vbg', 'punktdaten', 'fundburo', 'offentlicher-verkehr', 'tramlinien', 'buslinien', 'vbz', 'strassenbahn', 'bus', 'geoportal', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-30T01:13:05.943997`
