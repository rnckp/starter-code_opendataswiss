...
- **Keywords.de** `['bus', 'vbz', 'offentlicher-verkehr', 'tram', 'geoportal', 'stzh', 'fundburo', 'buslinien', 'vbg', 'postauto', 'tramlinien', 'vektordaten', 'geodaten', 'strassenbahn', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-21T01:06:01.750210`
