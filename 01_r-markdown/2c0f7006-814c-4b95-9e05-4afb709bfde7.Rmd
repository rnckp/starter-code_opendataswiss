...
- **Keywords.de** `['strassenbahn', 'stzh', 'geoportal', 'postauto', 'fundburo', 'tramlinien', 'tram', 'buslinien', 'vektordaten', 'vbz', 'punktdaten', 'bus', 'offentlicher-verkehr', 'geodaten', 'vbg']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-15T01:24:16.419466`
