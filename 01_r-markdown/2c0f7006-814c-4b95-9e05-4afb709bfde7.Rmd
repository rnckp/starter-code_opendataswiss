...
- **Keywords.de** `['geodaten', 'buslinien', 'tram', 'punktdaten', 'vbg', 'vektordaten', 'stzh', 'postauto', 'strassenbahn', 'offentlicher-verkehr', 'vbz', 'bus', 'geoportal', 'tramlinien', 'fundburo']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-27T01:41:31.786456`
