...
- **Keywords.de** `['fundburo', 'punktdaten', 'vektordaten', 'tram', 'vbz', 'tramlinien', 'vbg', 'geodaten', 'bus', 'stzh', 'offentlicher-verkehr', 'strassenbahn', 'geoportal', 'postauto', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-07T01:06:20.251617`
