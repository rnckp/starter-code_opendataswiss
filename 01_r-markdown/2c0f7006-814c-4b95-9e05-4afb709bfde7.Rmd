...
- **Keywords.de** `['vektordaten', 'bus', 'vbg', 'buslinien', 'geoportal', 'tramlinien', 'fundburo', 'tram', 'vbz', 'geodaten', 'offentlicher-verkehr', 'postauto', 'strassenbahn', 'stzh', 'punktdaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-27T01:17:10.073782`
