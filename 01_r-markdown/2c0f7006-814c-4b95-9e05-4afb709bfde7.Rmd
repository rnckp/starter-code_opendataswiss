...
- **Keywords.de** `['stzh', 'postauto', 'vbg', 'punktdaten', 'geodaten', 'strassenbahn', 'fundburo', 'geoportal', 'buslinien', 'vektordaten', 'tram', 'vbz', 'offentlicher-verkehr', 'tramlinien', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-08-08T01:41:18.129779`
