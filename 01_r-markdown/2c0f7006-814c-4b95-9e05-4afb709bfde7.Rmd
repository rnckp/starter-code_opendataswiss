...
- **Keywords.de** `['postauto', 'punktdaten', 'tramlinien', 'strassenbahn', 'bus', 'vektordaten', 'fundburo', 'offentlicher-verkehr', 'buslinien', 'tram', 'vbg', 'vbz', 'stzh', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-30T02:25:24.635506`
