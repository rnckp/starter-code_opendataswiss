...
- **Keywords.de** `['strassenbahn', 'buslinien', 'postauto', 'tram', 'stzh', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'fundburo', 'geodaten', 'geoportal', 'punktdaten', 'tramlinien', 'vbg', 'bus']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-29T01:21:35.409541`
