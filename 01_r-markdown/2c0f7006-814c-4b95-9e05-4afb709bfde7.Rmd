...
- **Keywords.de** `['strassenbahn', 'fundburo', 'stzh', 'punktdaten', 'geodaten', 'bus', 'offentlicher-verkehr', 'vbg', 'geoportal', 'buslinien', 'postauto', 'vektordaten', 'vbz', 'tramlinien', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-03-29T01:14:55.778403`
