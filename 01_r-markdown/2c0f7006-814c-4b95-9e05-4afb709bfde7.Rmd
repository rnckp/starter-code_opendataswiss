...
- **Keywords.de** `['bus', 'geoportal', 'tramlinien', 'vbz', 'fundburo', 'vektordaten', 'strassenbahn', 'vbg', 'stzh', 'offentlicher-verkehr', 'geodaten', 'punktdaten', 'buslinien', 'tram', 'postauto']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-07T01:15:47.494658`
