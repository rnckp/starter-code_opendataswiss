...
- **Keywords.de** `['bus', 'postauto', 'stzh', 'punktdaten', 'tramlinien', 'fundburo', 'vbz', 'vektordaten', 'offentlicher-verkehr', 'geoportal', 'vbg', 'buslinien', 'tram', 'geodaten', 'strassenbahn']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-26T01:18:29.863169`
