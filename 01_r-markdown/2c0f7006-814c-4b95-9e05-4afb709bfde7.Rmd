...
- **Keywords.de** `['postauto', 'geoportal', 'fundburo', 'punktdaten', 'stzh', 'tramlinien', 'vbg', 'tram', 'vektordaten', 'offentlicher-verkehr', 'vbz', 'bus', 'strassenbahn', 'geodaten', 'buslinien']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-25T01:22:48.355466`
