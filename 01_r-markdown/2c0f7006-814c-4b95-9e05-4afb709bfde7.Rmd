...
- **Keywords.de** `['vbz', 'postauto', 'buslinien', 'tramlinien', 'geoportal', 'fundburo', 'vbg', 'offentlicher-verkehr', 'punktdaten', 'geodaten', 'bus', 'vektordaten', 'strassenbahn', 'stzh', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-09-21T01:20:39.973189`
