...
- **Keywords.de** `['punktdaten', 'postauto', 'tramlinien', 'geoportal', 'geodaten', 'vbz', 'vektordaten', 'fundburo', 'buslinien', 'vbg', 'strassenbahn', 'stzh', 'offentlicher-verkehr', 'bus', 'tram']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-05T01:07:26.194910`
