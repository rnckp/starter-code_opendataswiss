...
- **Keywords.de** `['postauto', 'tram', 'vbg', 'punktdaten', 'offentlicher-verkehr', 'tramlinien', 'bus', 'buslinien', 'stzh', 'strassenbahn', 'vbz', 'vektordaten', 'fundburo', 'geoportal', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-06-09T01:17:57.443632`
