...
- **Keywords.de** `['buslinien', 'vektordaten', 'fundburo', 'vbz', 'geoportal', 'geodaten', 'tram', 'strassenbahn', 'offentlicher-verkehr', 'vbg', 'postauto', 'punktdaten', 'bus', 'tramlinien', 'stzh']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-05-31T01:11:18.423903`
