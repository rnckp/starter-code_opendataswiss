...
- **Keywords.de** `['strassenbahn', 'postauto', 'vektordaten', 'buslinien', 'stzh', 'tramlinien', 'fundburo', 'vbg', 'punktdaten', 'vbz', 'tram', 'bus', 'geodaten', 'geoportal', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-10-28T01:54:03.142622`
