...
- **Keywords.de** `['vbg', 'bus', 'buslinien', 'strassenbahn', 'geoportal', 'punktdaten', 'postauto', 'tram', 'stzh', 'vbz', 'tramlinien', 'vektordaten', 'geodaten', 'fundburo', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-01-23T01:05:01.323235`
