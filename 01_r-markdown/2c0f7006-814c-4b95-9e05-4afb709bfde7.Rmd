...
- **Keywords.de** `['geoportal', 'strassenbahn', 'punktdaten', 'tram', 'fundburo', 'stzh', 'tramlinien', 'vbg', 'vbz', 'buslinien', 'bus', 'postauto', 'geodaten', 'offentlicher-verkehr', 'vektordaten']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-05T01:39:12.039042`
