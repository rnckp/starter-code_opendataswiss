...
- **Keywords.de** `['postauto', 'strassenbahn', 'bus', 'buslinien', 'punktdaten', 'tramlinien', 'offentlicher-verkehr', 'fundburo', 'tram', 'stzh', 'vbz', 'vbg', 'vektordaten', 'geodaten', 'geoportal']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-04-01T01:24:49.880265`
