...
- **Keywords.de** `['vektordaten', 'strassenbahn', 'vbg', 'postauto', 'vbz', 'geodaten', 'tram', 'fundburo', 'buslinien', 'punktdaten', 'bus', 'tramlinien', 'stzh', 'geoportal', 'offentlicher-verkehr']`
- **Issued** `nan`
- **Metadata_created** `2022-05-10T01:07:52.545719`
- **Metadata_modified** `2023-07-23T01:21:32.224790`
