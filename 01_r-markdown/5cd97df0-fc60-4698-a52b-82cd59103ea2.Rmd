...
- **Publisher** `Bau- und Verkehrsdepartement/Tiefbauamt/Allmendverwaltung`
- **Organization.display_name.de** `Kanton Basel-Stadt`
- **Organization.url** `https://www.opendata.bs.ch`
- **Maintainer** `None`
- **Maintainer_email** `None`
- **Keywords.de** `['plakat', 'fest', 'anlass', 'umleitung', 'baustelle', 'party']`
- **Issued** `2019-11-06T00:00:00`
- **Metadata_created** `2022-06-09T08:37:44.262709`
- **Metadata_modified** `2023-03-21T00:27:37.180129`
