...
Zusätzlich zu den manuellen Niederschlagsmessungen betreibt MeteoSchweiz ein Niederschlagsmessnetz mit 60 Totalisatoren. Hier werden einmal pro Jahr Messungen vorgenommen. Der Datensatz enthält pro Station Messwerte zu Niederschlag jährlicher Auflösung ('y'). Es gibt aktualisierte Datensätze seit Messbeginn.
...
Auto-generated R starter code for the dataset 8d71c94a-d2ba-431d-8913-772753b71e9e@bundesamt-fur-meteorologie-und-klimatologie-meteoschweiz.
...
- **Metadata_modified** `2026-01-30T00:22:26.140460`
...
df <- read_delim('https://data.geo.admin.ch/browser/index.html#/collections/ch.meteoschweiz.ogd-tot')
