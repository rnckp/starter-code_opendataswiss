...
- **Publisher.name** `Daten, Statistik Stadt Zürich, Präsidialdepartement`
- **Organization.display_name.de** `Stadt Zürich`
- **Organization.url** `http://www.stadt-zuerich.ch/opendata`
- **Maintainer** `Open Data Zürich`
- **Maintainer_email** `opendata@zuerich.ch`
- **Keywords.de** `['vektordaten', 'gebietseinteilungen', 'stadtquartiere', 'punktdaten', 'quartiere', 'geoportal', 'stzh', 'polygondaten', 'geodaten']`
- **Issued** `nan`
- **Metadata_created** `2024-04-13T04:52:58.078367`
- **Metadata_modified** `2025-05-08T02:36:03.102287`
