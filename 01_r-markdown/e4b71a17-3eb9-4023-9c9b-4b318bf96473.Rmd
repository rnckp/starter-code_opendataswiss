...
- **Publisher** `Erziehungsdepartement/Jugend, Familie und Sport/Jugend- und Familienförderung`
- **Organization.display_name.de** `Kanton Basel-Stadt`
- **Organization.url** `https://www.opendata.bs.ch`
- **Maintainer** `Fachstelle für OGD Basel-Stadt`
- **Maintainer_email** `opendata@bs.ch`
- **Keywords.de** `['turnen', 'freizeit', 'sport', 'jugenarbeit', 'treffpunkt']`
- **Issued** `2019-11-06T00:00:00`
- **Metadata_created** `2022-06-09T08:39:23.074680`
- **Metadata_modified** `2023-03-29T00:29:07.853145`
