...
- **Keywords.de** `['bus', 'verspatung', 'zug', 'prognose', 'passagier', 'ist-daten', 'embag', 'punktlichkeit', 'proprietar', 'daten']`
- **Issued** `2016-12-01T12:00:00`
- **Metadata_created** `2017-03-02T09:12:01.220199`
- **Metadata_modified** `2024-08-20T02:21:33.394634`
...
# Issued                   : 2024-08-16T09:52:00.404216
# Modified                 : 2024-08-16T09:52:00.404216
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/bf9de506-08a8-4172-b9fd-105e7917a2ef/download/2024-08-13_istdaten.csv')
...
# Package_id               : 81f884db-c99b-4bfd-8cdd-598f75b74285
# Description              : The actual service provided is displayed. The final forecast is used where no actual data are available.
# Issued                   : 2024-08-20T00:47:13.876573
# Modified                 : 2024-08-20T00:47:13.876573
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/8892ce40-1184-4ae1-842a-dafc62005987/download/2024-08-19_istdaten.csv')
...
# Package_id               : 81f884db-c99b-4bfd-8cdd-598f75b74285
# Description              : The actual service provided is displayed. The final forecast is used where no actual data are available.
# Issued                   : 2024-08-16T09:49:48.842703
# Modified                 : 2024-08-16T09:49:48.842703
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/4b86f961-d597-4b08-868b-aff7403c2f6f/download/2024-08-12_istdaten.csv')

# Distribution 7
# Package_id               : 81f884db-c99b-4bfd-8cdd-598f75b74285
# Description              : The actual service provided is displayed. The final forecast is used where no actual data are available.
# Issued                   : 2024-08-18T01:16:53.632218
# Modified                 : 2024-08-18T01:16:53.632218
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/ec0f9565-b321-434e-a0eb-d08dc88ef2ac/download/2024-08-17_istdaten.csv')

# Distribution 8
# Package_id               : 81f884db-c99b-4bfd-8cdd-598f75b74285
# Description              : The actual service provided is displayed. The final forecast is used where no actual data are available.
# Issued                   : 2024-08-16T09:46:12.943929
# Modified                 : 2024-08-16T09:46:12.943929
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/03f53770-4618-40e4-8118-2e8921191a1d/download/2024-08-10_istdaten.csv')
...
# Package_id               : 81f884db-c99b-4bfd-8cdd-598f75b74285
# Description              : The actual service provided is displayed. The final forecast is used where no actual data are available.
# Issued                   : 2024-08-17T01:37:21.386476
# Modified                 : 2024-08-17T01:37:21.386476
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/442e3730-386d-4c5a-a88a-134d36084f54/download/2024-08-16_istdaten.csv')
...
# Package_id               : 81f884db-c99b-4bfd-8cdd-598f75b74285
# Description              : The actual service provided is displayed. The final forecast is used where no actual data are available.
# Issued                   : 2024-08-16T09:44:24.699180
# Modified                 : 2024-08-16T09:44:24.699180
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/6291730d-4201-4fdf-b1fc-b8022c7d9bc9/download/2024-08-09_istdaten.csv')
...
# Package_id               : 81f884db-c99b-4bfd-8cdd-598f75b74285
# Description              : The actual service provided is displayed. The final forecast is used where no actual data are available.
# Issued                   : 2024-08-16T09:47:35.288194
# Modified                 : 2024-08-16T09:47:35.288194
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/f570628a-757b-4124-ab20-c3c33be90daf/download/2024-08-11_istdaten.csv')
...
# Package_id               : 81f884db-c99b-4bfd-8cdd-598f75b74285
# Description              : The actual service provided is displayed. The final forecast is used where no actual data are available.
# Issued                   : 2024-08-16T09:56:14.356878
# Modified                 : 2024-08-16T09:56:14.356878
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/9c9f298b-7708-4465-9251-7c99a64579bb/download/2024-08-15_istdaten.csv')
...
# Package_id               : 81f884db-c99b-4bfd-8cdd-598f75b74285
# Description              : The actual service provided is displayed. The final forecast is used where no actual data are available.
# Issued                   : 2024-08-19T01:06:50.134352
# Modified                 : 2024-08-19T01:06:50.134352
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/f5065829-64a1-40a9-94aa-b5ae3faec6e9/download/2024-08-18_istdaten.csv')
...
# Package_id               : 81f884db-c99b-4bfd-8cdd-598f75b74285
# Description              : The actual service provided is displayed. The final forecast is used where no actual data are available.
# Issued                   : 2024-08-16T09:54:11.294600
# Modified                 : 2024-08-16T09:54:11.294600
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/4e784cdf-da7d-4887-9028-c2913e409b01/download/2024-08-14_istdaten.csv')
...
# Package_id               : 81f884db-c99b-4bfd-8cdd-598f75b74285
# Description              : The actual service provided is displayed. The final forecast is used where no actual data are available.
# Issued                   : 2024-08-16T09:42:14.539097
# Modified                 : 2024-08-16T09:42:14.539097
# Rights                   : NonCommercialAllowed-CommercialAllowed-ReferenceRequired

df <- read_delim('https://opentransportdata.swiss/dataset/0edc74a3-ad4d-486e-8657-f8f3b34a0979/resource/6079c42e-1fdc-4d34-875a-cafda525cff8/download/2024-08-08_istdaten.csv')
